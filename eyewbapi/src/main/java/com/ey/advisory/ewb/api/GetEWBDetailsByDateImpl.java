 ...
 *
 */
@Component("GetEWBDetailsByDateImpl")
public class GetEWBDetailsByDateImpl implements GetEWBDetailsByDate {
	...
	@Override
	public APIResponse getEWBDetailsByDate(String date, String gstin) {
		KeyValuePair<String, String> apiParam1 = new KeyValuePair<>(
				APIReqParamConstants.GET_OTHERPARTY_EWBS_DATE, date);
		...
		APIParams apiParams = new APIParams(APIProviderEnum.EWB,
				APIIdentifiers.GET_EWB_BY_DATE,"v1.03", apiParam1, apiParam2);
