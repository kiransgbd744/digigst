...
@Slf4j
@Component("MonitorAndChunkGenEwbByIrnInvProcessor")
public class MonitorAndChunkGenEwbByIrnInvProcessor
	...
	final List<String> apiType = ImmutableList
			.of(BusinessCriticalConstants.GENEWB_IRN_V3);
	...
	public void executeForGroup(Group group, Message message,
		...
		try {
			...
			monCommUtility.postCanorGenEwbJob(apiType, group,
					"auto.drafting.chunkSize.genewbbyirn");
