...
@RestController
@Slf4j
public class Gstr1ASectionWiseReportDownloadController {
	...
	@RequestMapping(value = "/ui/downloadGstr1ASectionWiseReports", method = RequestMethod.POST, produces = {
	...
	public ResponseEntity<String> downloadreviewSummReport(
		...
		try {
			...
			if (criteria.getTaxDocType() != null && criteria.getTaxDocType()
				...
				criteria.setReportType("GSTR1A_B2B");
			...
			if (criteria.getTaxDocType() != null && criteria.getTaxDocType()
				...
				criteria.setReportType("GSTR1A_B2BA");
			...
			if (criteria.getTaxDocType() != null && criteria.getTaxDocType()
				...
				criteria.setReportType("GSTR1A_B2CL");
			...
			if (criteria.getTaxDocType() != null && criteria.getTaxDocType()
				...
				criteria.setReportType("GSTR1A_B2CLA");
			...
			if (criteria.getTaxDocType() != null && criteria.getTaxDocType()
				...
				criteria.setReportType("GSTR1A_EXPORTS");
			...
			if (criteria.getTaxDocType() != null && criteria.getTaxDocType()
				...
				criteria.setReportType("GSTR1A_EXPORTA");
			...
			if (criteria.getTaxDocType() != null && criteria.getTaxDocType()
				...
				criteria.setReportType("GSTR1A_CDNR");
			...
			if (criteria.getTaxDocType() != null && criteria.getTaxDocType()
				...
				criteria.setReportType("GSTR1A_CDNRA");
			...
			if (criteria.getTaxDocType() != null && criteria.getTaxDocType()
				...
				criteria.setReportType("GSTR1A_CDNUR");
			...
			if (criteria.getTaxDocType() != null && criteria.getTaxDocType()
				...
				criteria.setReportType("GSTR1A_CDNURA");
			...
			if (criteria.getTaxDocType() != null && criteria.getTaxDocType()
				...
				criteria.setReportType("GSTR1A_B2CS");
			...
			if (criteria.getTaxDocType() != null && criteria.getTaxDocType()
				...
				criteria.setReportType("GSTR1A_B2CSA");
	...
	private JsonObject getResponse(Gstr1ReviwSummReportsReqDto criteria,String reportType){
		...
		setDataSecurity.setDataType("Outward_1A");
		...
		asyncJobsService.createJob(groupCode,
				JobConstants.GSTR1A_SectionWise_Report, jobParams.toString(),
