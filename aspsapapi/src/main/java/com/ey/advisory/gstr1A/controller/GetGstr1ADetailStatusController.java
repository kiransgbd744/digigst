...
import com.ey.advisory.app.data.services.Gstr1A.GetGstr1ADetailStatusService;
...
import com.ey.advisory.app.services.daos.get2a.GetGstr1DetailStatusService;
import com.ey.advisory.common.GsonUtil;
import com.ey.advisory.controllers.anexure2.GetAnx2DetailStatusController;
...
@RestController
public class GetGstr1ADetailStatusController {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(GetAnx2DetailStatusController.class);

	@Autowired
	@Qualifier("GetGstr1ADetailStatusService")
	private GetGstr1ADetailStatusService getGstr1DetailStatusService;

	@PostMapping(value = "/ui/getGstr1ADetailStatus", produces = {
			MediaType.APPLICATION_JSON_VALUE })
	public ResponseEntity<String> getGstr1DetailStatus(
		...
		try {
			...
			GetGstr6DetailStatusMainDetailsRespDto summaryList = getGstr1DetailStatusService
