...
@RestController
public class Gstr1ASectionWiseReportsController {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(Gstr1ASectionWiseReportsController.class);

	@Autowired
	@Qualifier("Gstr1AB2BSectionReportHandler")
	Gstr1AB2BSectionReportHandler gstr1B2BSectionReportHandler;
	...
	@RequestMapping(value = "/ui/downloadGstr1ASecReports", method = RequestMethod.POST, produces = {
