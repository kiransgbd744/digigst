...
import com.ey.advisory.controllers.anexure1.Gstr1NilExmpNonGstStautsController;
 ...
 */
@RestController
public class Gstr1ANilExmpNonGstStautsController {
...
/*
	@Autowired
	@Qualifier("NilAAndHsnProcedureCallRepositoryImpl")
	...
	@RequestMapping(value = "/ui/gstr1ANilExmpNonGstStauts", method = RequestMethod.POST, produces = {
	...
	@RequestMapping(value = "/ui/gstr1ANilExmpNonGstSave", method = RequestMethod.POST, produces = {
			MediaType.APPLICATION_JSON_VALUE })
	public ResponseEntity<String> gstr1NilExmpNonGstSave(
		...
		try {
			...
			gstr1NilExmpNonGstStautsService.saveGstr1ANilExmpNonGstStauts(reqDtos);
	...
	@PostMapping(value = "/ui/nilGstr1AExmpNonVerticalDelete", produces = {
			MediaType.APPLICATION_JSON_VALUE })
	...
	@RequestMapping(value = "/ui/gstr1ANilExmpNonVerticalSave", method = RequestMethod.POST, produces = {
			MediaType.APPLICATION_JSON_VALUE })
		...
		try {
			...
			if (!reqDtos.isEmpty()) {
				...
				gstr1NilExmpNonGstStautsService
						.saveGstr1ANilExmpNonVerticalStauts(reqDtos);
