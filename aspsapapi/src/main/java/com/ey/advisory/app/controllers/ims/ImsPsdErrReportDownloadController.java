...
@RestController
@Slf4j
public class ImsPsdErrReportDownloadController {
	...
	@PostMapping(value = "/ui/getImsReportGenerate")
	public ResponseEntity<String> getImsReportGenerate(@RequestBody String jsonParams) {

		if (LOGGER.isDebugEnabled()) {
			String msg = "Inside ImsPsdErrReportDownloadController";
			LOGGER.debug(msg);
		}
		...
		if (LOGGER.isDebugEnabled()) {
			String msg = String.format(
					"Request for Download Ims Report Controller: %s",
					json.toString());
			LOGGER.debug(msg);
		}
...

		{
			...
			asyncJobsService.createJob(TenantContext.getTenantId(),
					JobConstants.FILE_STATUS_IMS_DOWNLOAD, 
			...
			String msg = "Error Occured in "
					+ "ImsPsdErrReportDownloadController";
