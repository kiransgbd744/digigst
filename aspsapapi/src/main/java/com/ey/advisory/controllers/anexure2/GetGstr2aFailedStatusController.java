...
import com.ey.advisory.app.services.daos.get2a.GetGstr2aFailedStatusService;
...
@RestController
public class GetGstr2aFailedStatusController {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(GetGstr2aDetailStatusController.class);

	@Autowired
	@Qualifier("GetGstr2aFailedStatusService")
	private GetGstr2aFailedStatusService getGstr2aFailedStatusService;

	@PostMapping(value = "/ui/getGstr2aFailedStatus", produces = {
	...
	public ResponseEntity<String> getGstr2aDetailStatus(
		...
		try {
			...
			List<GetGstr2aDetailStatusRespDto> summaryList = getGstr2aFailedStatusService
