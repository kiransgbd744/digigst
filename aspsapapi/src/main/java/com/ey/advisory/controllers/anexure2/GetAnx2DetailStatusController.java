...
import com.ey.advisory.app.services.daos.get2a.GetAnx2DetailStatusService;
...
@RestController
public class GetAnx2DetailStatusController {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(GetAnx2DetailStatusController.class);

	@Autowired
	@Qualifier("GetAnx2DetailStatusService")
	private GetAnx2DetailStatusService getAnx2DetailStatusService;

	@PostMapping(value = "/ui/getAnx2DetailStatus", produces = {
	...
	public ResponseEntity<String> getAnx2DetailStatus(
		...
		try {
			...
			GetAnx2DetailStatusMainDetailsRespDto summaryList = getAnx2DetailStatusService
