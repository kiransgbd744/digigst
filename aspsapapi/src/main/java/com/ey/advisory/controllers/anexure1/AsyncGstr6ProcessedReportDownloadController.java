 ...
 */
	...
	@RestController
	@Slf4j
	public class AsyncGstr6ProcessedReportDownloadController {
		...
		@Autowired
		@Qualifier("AsyncGstr6ReportHandlerImpl")
		AsyncReportHandler asyncFileStatusReportHandler;

		@PostMapping(value = "/ui/downloadgstr6ProcessedCsvReports")
		public ResponseEntity<String> ReportProcess(
			...
			try {
				...
				if ("INWARD".equalsIgnoreCase(entity.getDataType())) {
								if("gstr6Process".equalsIgnoreCase(reqDto.getType())) {
									asyncJobsService.createJob(groupCode,
											JobConstants.GSTR6_PROCESSED, jobParams.toString(),
		...
		@GetMapping(value = "/ui/Gstr6ProcessedDownloadDocument")
