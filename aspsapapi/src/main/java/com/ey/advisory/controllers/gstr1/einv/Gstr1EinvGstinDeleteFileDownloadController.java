...
import com.ey.advisory.app.gstr1.einv.Gstr1GSTINDeleteDataReportService;
...
@RestController
@Slf4j
public class Gstr1EinvGstinDeleteFileDownloadController {

	@Autowired
	@Qualifier("Gstr1GSTINDeleteDataReportService")
	private Gstr1GSTINDeleteDataReportService downloadService;

	@RequestMapping(value = "/ui/gstr1EinvGstinDeleteFileDownload", method = RequestMethod.POST, produces = {
	...
	public void fileDownloads(@RequestBody String jsonString,
		...
		LOGGER.debug("inside fileDownloads method and file type is {} ",
				"Gstr1EinvGstinDeleteFileDownloadController");
