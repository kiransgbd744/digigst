...
import com.ey.advisory.app.services.daos.prsummary.Anx2PRSProcessedDataService;
...
@RestController
public class Anx2PRSProcessedDataController {
...
private static final Logger LOGGER = LoggerFactory
		.getLogger(Anx2PRSProcessedDataController.class);

@RequestMapping(value = "/ui/getPRSProcessedData", method = RequestMethod.POST, produces = {
		MediaType.APPLICATION_JSON_VALUE })
public ResponseEntity<String> getPRSProcessedData(
	...
	try {
		...
		List<Anx2PRSProcessedResponseDto> recResponse = anx2PRSProcessedDataService
				.getAnx2PRSProcessedRecords(setDataSecurity);
