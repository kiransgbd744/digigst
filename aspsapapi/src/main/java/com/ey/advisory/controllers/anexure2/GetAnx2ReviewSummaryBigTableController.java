...
import com.ey.advisory.app.services.daos.initiaterecon.Anx2BigTableReviewSummeryService;
 ...
 */
@RestController
public class GetAnx2ReviewSummaryBigTableController {

	
	@Autowired
	@Qualifier("Anx2BigTableReviewSummeryService")
	private Anx2BigTableReviewSummeryService anx2BigTableReviewSummeryService;
	...
	@RequestMapping(value = "/ui/getanx2reviewSummary", method = RequestMethod.POST,
	...
	public ResponseEntity<String> getanx2reviewSummary(
		...
		try {
			...
			List<Object> recResponse=anx2BigTableReviewSummeryService.find(criteria);
