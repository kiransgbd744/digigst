...
import com.ey.advisory.app.services.daos.get2a.GetGstr6DetailStatusService;
...
@RestController
public class GetGstr6DetailStatusController {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(GetGstr6DetailStatusController.class);

	@Autowired
	@Qualifier("GetGstr6DetailStatusService")
	private GetGstr6DetailStatusService getGstr6DetailStatusService;

	@PostMapping(value = "/ui/getGstr6DetailStatus", produces = {
	...
	public ResponseEntity<String> getAnx2DetailStatus(
		...
		try {
			...
			GetGstr6DetailStatusMainDetailsRespDto summaryList = getGstr6DetailStatusService
