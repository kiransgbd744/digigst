...
import com.ey.advisory.app.data.services.anx1.Gstr8ProcessedRecordsFetchService;
...
@Slf4j
@RestController
public class Gstr8ProcessedController {

	@Autowired
	@Qualifier("Gstr8ProcessedRecordsFetchService")
	Gstr8ProcessedRecordsFetchService gstr8ProcessedRecordsFetchService;

	@RequestMapping(value = "/ui/getGstr8ProcessSummary", method = RequestMethod.POST, produces = {
	...
	public ResponseEntity<String> getProcessedRecords(
		...
		try {
			...
			List<Gstr8ProcessedRecordsRespDto> response = gstr8ProcessedRecordsFetchService
