...
@RestController
@Slf4j
public class AsyncReportIsdDownloadController {
	...
	@PostMapping(value = "/ui/downloadIsdFileReports")
	public ResponseEntity<String> ReportProcess(
		...
		try {
			...
			jobParams.addProperty("source", reqDto.getReportCateg());
			asyncJobsService.createJob(groupCode,
					JobConstants.ISD_RECON, jobParams.toString(),
