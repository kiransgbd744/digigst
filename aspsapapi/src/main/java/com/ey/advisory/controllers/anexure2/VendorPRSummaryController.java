...
import com.ey.advisory.app.services.search.anx2.VendorPRSummaryService;
 ...
 */
@RestController
public class VendorPRSummaryController {
	
	private static final Logger LOGGER = LoggerFactory
			.getLogger(VendorPRSummaryController.class);
	
	@Autowired
	@Qualifier("VendorPRSummaryService")
	VendorPRSummaryService service;
		
	@RequestMapping(value = "/ui/getVenorPRSumary", method = 
			RequestMethod.POST, produces = {
			MediaType.APPLICATION_JSON_VALUE })
	public ResponseEntity<String> getVendorPRSummary(
