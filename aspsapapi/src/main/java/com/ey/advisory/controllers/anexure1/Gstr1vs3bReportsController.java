...
@RestController
@Slf4j
public class Gstr1vs3bReportsController {
    @Autowired
    ...
    @RequestMapping(value = "/ui/gstr1vs3bReviewSummaryDownload", method = RequestMethod.POST, produces = {
    ...
    public void downloadreviewSummReport(@RequestBody String jsonString,
        ...
        try {
            ...
            List<String> selectedGstins = reqDto.getDataSecAttrs()
