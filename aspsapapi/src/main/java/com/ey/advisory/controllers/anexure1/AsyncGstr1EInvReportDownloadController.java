...
@RestController
@Slf4j
public class AsyncGstr1EInvReportDownloadController {
	...
	public ResponseEntity<String> ReportProcess(
		...
		try {
			...
			if ("gstr1EInvProcess".equalsIgnoreCase(reqDto.getType())) {
				asyncJobsService.createJob(groupCode,
						JobConstants.GSTR1EINV_PROCESSED, jobParams.toString(),
	...
	@GetMapping(value = "/ui/Gstr1EInvDownloadDocument")
