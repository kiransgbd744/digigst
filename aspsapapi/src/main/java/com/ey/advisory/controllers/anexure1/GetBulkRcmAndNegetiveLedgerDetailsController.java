...
@RestController
@Slf4j
public class GetBulkRcmAndNegetiveLedgerDetailsController {
	...
	/*//for testing
	@Autowired
	CreditAndCashLedgerReportProcessorTest creditAndCashLedgerReportProcessorTest;*/

	@PostMapping(value = "/ui/getBulkRcmAndNegetiveDetails")
...
*/			JsonObject jobParams = new JsonObject();
			...
			//RCM Ledger
			else if(reportTypeVal.equalsIgnoreCase("ITC RCM Ledger"))
				jobParams.addProperty("reportType", "ITC RCM Ledger");
			//Negetive Ledger
			else if(reportTypeVal.equalsIgnoreCase("Negative Liability Ledger"))
				jobParams.addProperty("reportType", "Negative Liability Ledger");
			else
			{
