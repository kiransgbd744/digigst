...
import com.ey.advisory.services.gstr3b.entity.setoff.Gstr3BSetOffEntityLevelSaveToGstnService;
...
@RestController
@Slf4j
public class Gstr3BEntitySaveToGstnSetOffController {
	
	@Autowired
	@Qualifier("Gstr3BSetOffEntityLevelSaveToGstnServiceImpl")
	Gstr3BSetOffEntityLevelSaveToGstnService service;

	private static final String GSTIN = "gstins";

	@PostMapping(value = "/ui/gstr3BSetOffEntityLevelSave", produces = {
	...
	public ResponseEntity<String> saveToGstn(
		...
		try {
			if (LOGGER.isDebugEnabled()) {
				String msg = "Begin Gstr3BEntitySaveToGstnSetOffController"
