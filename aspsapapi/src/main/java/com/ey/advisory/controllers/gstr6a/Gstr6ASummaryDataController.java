 ...
 */
@RestController
public class Gstr6ASummaryDataController {
	...
	private static final Logger LOGGER = LoggerFactory
			.getLogger(Gstr6ASummaryDataController.class);

	@RequestMapping(value = "/ui/Gstr6ASummaryData", method = RequestMethod.POST, produces = {
			MediaType.APPLICATION_JSON_VALUE })
	public ResponseEntity<String> getGstr6ASummaryData(
		...
		try {
			Gstr6ASummaryDataRequestDto criteria = gson.fromJson(json,
					Gstr6ASummaryDataRequestDto.class);
			...
			List<Gstr6ASummaryDataResponseDto> responseData = 
					gstr6AReviewSummaryDetails.getReviewSummaryData(criteria);
