...
@Slf4j
@RestController
public class Gstr7ProcessedController {

	@Autowired
	@Qualifier("Gstr7ProcessedRecordsFetchService")
	Gstr7ProcessedRecordsFetchService gstr7ProcessedRecordsFetchService;

	@RequestMapping(value = "/ui/getGstr7ProcessPrSummary", method = RequestMethod.POST, produces = {
	...
	public ResponseEntity<String> getProcessedRecords(
		...
		try {
			...
			List<Gstr7ProcessedRecordsRespDto> response = gstr7ProcessedRecordsFetchService
