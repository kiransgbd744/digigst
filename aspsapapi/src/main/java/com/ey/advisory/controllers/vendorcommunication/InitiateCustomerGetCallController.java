...
@RestController
@Slf4j
public class InitiateCustomerGetCallController {
	...
	@PostMapping(value = "/ui/initiateCustomerFilingByDays", produces = {
	...
	public ResponseEntity<String> getVendorsReturnFileStatus(
		...
		try {
			...
			jsonParams.addProperty("complianceType", "Customer");
			jsonParams.addProperty("requestId", requestId);
			asyncJobsService.createJob(TenantContext.getTenantId(),
					JobConstants.InitiateGetCustomerDaysFiling,
