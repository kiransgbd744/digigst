...
@RestController
public class GetGstr1DetailStatusController {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(GetAnx2DetailStatusController.class);

	@Autowired
	@Qualifier("GetGstr1DetailStatusService")
	private GetGstr1DetailStatusService getGstr1DetailStatusService;

	@PostMapping(value = "/ui/getGstr1DetailStatus", produces = {
