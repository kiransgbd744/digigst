...
import static com.ey.advisory.common.GSTConstants.GSTR8_FOLDER_NAME;
...
@RestController
@Slf4j
public class EWB3WayReconUploadController {
	...
	@PostMapping(value = "/ui/ewb3WayReconUpload", produces = {
			MediaType.APPLICATION_XML_VALUE })
	public ResponseEntity<String> ewbUpload(
		...
		try {
			...
			LOGGER.debug(
					"Inside EWB3WayReconUploadController and file type is {}"
							+ " foldername is {} ",
					ConfigConstants.EWB_UPLOAD);
			...
			fileStatus.setFileType("EWB_UPLOAD");
			...
			asyncJobsService.createJob(groupCode,
					JobConstants.EWB_UPLOAD, jsonParams.toString(),
