...
import com.ey.advisory.app.anx2.vendorsummary.VenderReconResponseService;
import com.ey.advisory.app.anx2.vendorsummary.VendorReconResponseRepDto;
...
@Slf4j
@RestController
public class VendorReconResponseController {

	@Autowired 
	@Qualifier("VenderReconResponseServiceImpl")
	private VenderReconResponseService venderReconResponseService;
	
	@Autowired
	private EntityService entityService; 
	
	@PostMapping(value = "/ui/getAnx2VendorReconResponse", produces = {
			MediaType.APPLICATION_JSON_VALUE }, consumes = {
					MediaType.APPLICATION_JSON_VALUE })
	public ResponseEntity<String> getvendorReconResponseDet(@RequestBody
			String jsonReq) {
		...
		try {
			...
			List<VendorReconResponseRepDto> searchResult = 
					venderReconResponseService.getReconResponseDetails(criteria);
