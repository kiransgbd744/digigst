...
import com.ey.advisory.app.gstr3b.itc10perc.service.Gstr3BITC10PerSaveChangesService;
...
@RestController
@Slf4j
public class Gstr3BITC10PerSaveUserChangesController {

	@Autowired
	@Qualifier("Gstr3BITC10PerSaveChangesServiceImpl")
	private Gstr3BITC10PerSaveChangesService service;

	@PostMapping(value = "/ui/gstr3BITC10PerSaveUserChanges", produces = {
			MediaType.APPLICATION_JSON_VALUE })
	public ResponseEntity<String> saveITC10PerUserInput(
		...
		try {
			...
			service.saveItcChangsToUserInputs(gstin, taxPeriod, userInputList,
					status);
