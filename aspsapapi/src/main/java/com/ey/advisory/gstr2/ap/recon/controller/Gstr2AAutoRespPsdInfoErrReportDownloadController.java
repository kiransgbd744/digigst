...
@RestController
@Slf4j
public class Gstr2AAutoRespPsdInfoErrReportDownloadController {
	...
	@PostMapping(value = "/ui/gstr2APRAutoRespReportGenerate")
	public ResponseEntity<String> get2AAutoRespReport(
			@RequestBody String jsonParams) {

		if (LOGGER.isDebugEnabled()) {
			String msg = "Inside Gstr2AAutoRespPsdInfoErrReportDownloadController";
			LOGGER.debug(msg);
		}
...

		{
			...
			entity.setReportCateg("Recon Response 2APR(202DFs)");
			...
			asyncJobsService.createJob(TenantContext.getTenantId(),
					JobConstants.Gstr2AAuto_RECON_RESP_DOWNLOAD,
	...
	@GetMapping(value = "/ui/gstr2AAutoPRRespDownload")
