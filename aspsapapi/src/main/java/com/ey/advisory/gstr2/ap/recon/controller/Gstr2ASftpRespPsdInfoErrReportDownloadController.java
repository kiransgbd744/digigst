...
@RestController
@Slf4j
public class Gstr2ASftpRespPsdInfoErrReportDownloadController {
	...
	@PostMapping(value = "/ui/gstr2ASftpRespReportGenerate")
	public ResponseEntity<String> get2BPRRespReport(@RequestBody String jsonParams) {

		if (LOGGER.isDebugEnabled()) {
			String msg = "Inside Gstr2ASftpRespPsdInfoErrReportDownloadController";
			LOGGER.debug(msg);
		}
		...
		{
			boolean flag = json.has("flag") ? true : false;
			...
			if(flag == true){
				entity.setReportCateg("Recon Response SFTP(108DFs)");
			} else {
				entity.setReportCateg("Recon Response Auto(108DFs)");
			}
			...
			asyncJobsService.createJob(TenantContext.getTenantId(),
					JobConstants.Gstr2ASftp_RECON_RESP_DOWNLOAD, 
	...
	@GetMapping(value = "/ui/gstr2APRSftpRespDownload")
