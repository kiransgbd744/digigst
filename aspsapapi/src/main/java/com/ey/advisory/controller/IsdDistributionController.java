...
@RestController
@Slf4j
public class IsdDistributionController {
	...
	private static final List<String> EXT_LIST = ImmutableList.of("csv", "xlsx",
			"xlsm");
	@PostMapping(value = "/ui/isddistributionWebUpload", produces = {
	...
	public ResponseEntity<String> vendorMaster(
		...
		try {
			...
			fileStatus.setFileType(GSTConstants.ISD);
			...
			fileStatus.setDataType(GSTConstants.INWARD);
			...
			asyncJobsService.createJob(groupCode,
					JobConstants.ISDDISTRIBUTIONFILEUPLOAD, jsonParams.toString(),
