...
@Slf4j
@RestController
public class EWBDetailedReportDownloadController {
	...
	@PostMapping(value = "/ui/getEWBDetailedReportDownload", produces = {
			MediaType.APPLICATION_JSON_VALUE })
	public ResponseEntity<String> getEWBDetailedReportDownload(
		...
		String msg1 = String
				.format("Inside EWBDetailedReportDownloadController.getEWBDetailedReportDownload() "
						+ "method : %s {} ", jsonString);
		LOGGER.debug(msg1);
		...
		try {
			...
			entity.setReportType("EWB_DETAIL_REPORT");
			...
			asyncJobsService.createJob(groupCode,
					JobConstants.EWB_DETAILED_REPORT, jobParams.toString(),
