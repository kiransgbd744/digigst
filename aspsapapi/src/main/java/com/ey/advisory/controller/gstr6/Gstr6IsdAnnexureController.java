...
@Slf4j
@RestController
public class Gstr6IsdAnnexureController {
	...
	@PostMapping(value = "/ui/getGstr6IsdAnnxFile", produces = {
			MediaType.APPLICATION_JSON_VALUE })
	public ResponseEntity<String> getGstr6IsdAnnxFile(
		...
		String msg1 = String.format("Req Json for GSTR6 Isd Annx %s {} ",
				jsonString);
		LOGGER.debug(msg1);
		...
		try {
			...
			entity.setReportType("ISDAnnexure");
			entity.setCreatedBy(userName);
			entity.setTaxPeriod(reqDto.getTaxPeriod());
			entity.setCreatedDate(LocalDateTime.now());
			entity.setReportStatus(ReportStatusConstants.INITIATED);
			entity.setReportCateg(GSTConstants.GSTR6ISDANNEX);
			entity.setDataType(GSTConstants.GSTR6ISDANNEX);
			...
			asyncJobsService.createJob(groupCode, JobConstants.GSTR6_ISD_ANNEX,
			...
			APIRespDto dto = new APIRespDto("Failed",
					"Unexpected occured in GSTR6 ISD ANX Async Report"
							+ e.getMessage());
			JsonObject resp = new JsonObject();
			JsonElement respBody = gson.toJsonTree(dto);
			String msg = "Error Occured in GSTR6 ISD ANX Async Report Controller";
	...
	@PostMapping(value = "/api/getGstr6IsdAnnxFile", produces = {
			MediaType.APPLICATION_JSON_VALUE })
	public ResponseEntity<String> testgetGstr6IsdAnnxFile(
			@RequestBody String jsonString) throws IOException {
