...
import com.ey.advisory.app.services.daos.get2a.GetItc04SummarySaveStatusService;
 ...
 */
@RestController
public class Itc04SummarySaveStatusController {
	private static final Logger LOGGER = LoggerFactory.getLogger(Itc04SummarySaveStatusController.class);

	@Autowired
	@Qualifier("GetItc04SummarySaveStatusService")
	private GetItc04SummarySaveStatusService getItc04SummarySaveStatusService;

	@PostMapping(value = "/ui/itc04SummarySaveStatus", produces = { MediaType.APPLICATION_JSON_VALUE })
	public ResponseEntity<String> itc04SummarySaveStatus(@RequestBody String jsonString) throws JsonParseException {
		...
		try {
			...
			List<Gstr1SummarySaveStatusRespDto> summaryList = getItc04SummarySaveStatusService.findByCriteria(criteria);
