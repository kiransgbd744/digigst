...
@RestController
@Slf4j
public class Gstr8FileUploadController {
	...
	private static final List<String> EXT_LIST = ImmutableList.of("csv", "xlsx",
			"xlsm");
	@PostMapping(value = "/ui/gstr8FileUpload", produces = {
	...
	public ResponseEntity<String> vendorMaster(
		...
		try {
			...
			LOGGER.debug(
					"Inside Gstr8 fileUpload controller and file type is {}"
							+ " foldername is {} ",
							GSTR8_FOLDER_NAME);
			...
			fileStatus.setFileType(GSTConstants.GSTR8);
			...
			asyncJobsService.createJob(groupCode,
					JobConstants.GSTR8FILEUPLOAD, jsonParams.toString(),
