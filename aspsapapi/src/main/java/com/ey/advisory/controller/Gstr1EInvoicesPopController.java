...
import com.ey.advisory.app.services.gstr1.Gstr1PopUpRecordsServiceImpl;
...
@Slf4j
@RestController
public class Gstr1EInvoicesPopController {

	@Autowired
	@Qualifier("Gstr1PopUpRecordsServiceImpl")
	private Gstr1PopUpRecordsServiceImpl gstr1PopUpRecordsService;

	@PostMapping(value = "/ui/getGstr1EPopUpRecords", produces = {
