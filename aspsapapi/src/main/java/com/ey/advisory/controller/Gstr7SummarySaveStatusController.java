...
import com.ey.advisory.app.services.daos.get2a.GetGstr7SummarySaveStatusService;
...
@RestController
public class Gstr7SummarySaveStatusController {
	private static final Logger LOGGER = LoggerFactory
			.getLogger(Gstr7SummarySaveStatusController.class);

	@Autowired
	@Qualifier("GetGstr7SummarySaveStatusService")
	private GetGstr7SummarySaveStatusService gstr7SummarySaveStatusService;

	@PostMapping(value = "/ui/gstr7SummarySaveStatus", produces = {
	...
	public ResponseEntity<String> gstr1SummarySaveStatus(
		...
		try {
			...
			List<Gstr1SummarySaveStatusRespDto> summaryList = gstr7SummarySaveStatusService
