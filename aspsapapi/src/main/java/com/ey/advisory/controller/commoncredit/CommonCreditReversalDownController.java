...
@Slf4j
@RestController
public class CommonCreditReversalDownController {
	...
	private AsyncReportDownloadService asyncOutReportDownloadService;


	@RequestMapping(value = "/ui/downloadreversalreports", method = RequestMethod.POST, produces = {
...
//			if("Inward".equals(criteria.getReportType())){
//				asyncReportDownloadService.generateReports(id);
//			}
//			else{
//				asyncOutReportDownloadService.generateReports(id);
//			}
			 asyncJobsService.createJob(TenantContext.getTenantId(),
			 JobConstants.COMMON_CREDIT_DOWNLOAD,
			...
			String errMsg = "Unexpected error occured in Common Credit Download Async Report";
