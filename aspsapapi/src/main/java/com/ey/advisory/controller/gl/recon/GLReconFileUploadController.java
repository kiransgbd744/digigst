...
@Slf4j
@RestController
public class GLReconFileUploadController {
	...
	@PostMapping(value = "/ui/glReconFileUpload", produces = {
			MediaType.APPLICATION_XML_VALUE })
	public ResponseEntity<String> glReconFileUpload(
		...
		try {
			...
			LOGGER.debug(
					"Inside GLReconFileUploadController and file type is {}  "
							+ "foldername is {} ",
					"GLReconFileUpload", ConfigConstants.GLRECONFILEUPLOAD);
			...
			Pair<String, String> downloadFileDetails = DocumentUtility.uploadDocumentAndReturnDocID(workbook,
					ConfigConstants.GLRECONFILEUPLOAD, "XLSX");
			...
			fileStatus.setFileType("GLUPLOAD");
			...
			jsonParams.addProperty("folderName",
					ConfigConstants.GLRECONFILEUPLOAD);

			asyncJobsService.createJob(groupCode,
					JobConstants.GL_RECON_FILE_UPLOAD, jsonParams.toString(),
