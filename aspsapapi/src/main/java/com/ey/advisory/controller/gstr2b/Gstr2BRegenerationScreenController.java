...
import com.ey.advisory.app.gstr2b.summary.Gstr2BRegenerationService;
...
@RestController
@Slf4j
public class Gstr2BRegenerationScreenController {
	...
	@Autowired
	@Qualifier("Gstr2BRegenerationServiceImpl")
	private Gstr2BRegenerationService service;
	...
	@PostMapping(value = "/ui/gstr2bRegenerationDashboard", produces = {
	...
	public ResponseEntity<String> getGSTINsandStatus(
		...
		try {
			if (LOGGER.isDebugEnabled()) {
				String msg = "Begin Gstr2BRegenerationScreenController"
			...
			List<Gstr2BRegenerationRespDto> statusData = service.getStatusData(
					gstnsList, derivedStartPeriod, derivedEndPeriod, stateNames,
					authTokenStatus,appendMonthYear);
			...
			if (LOGGER.isDebugEnabled()) {
				String msg = "End Gstr2BRegenerationScreenController"
