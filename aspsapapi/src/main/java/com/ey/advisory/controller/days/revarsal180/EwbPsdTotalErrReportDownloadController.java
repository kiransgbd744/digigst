...
@RestController
@Slf4j
public class EwbPsdTotalErrReportDownloadController {
	...
	@PostMapping(value = "/ui/ewbRespReportRequest")
	public ResponseEntity<String> ewbReprtReq(@RequestBody String jsonParams) {

		if (LOGGER.isDebugEnabled()) {
			String msg = "Inside EwbPsdTotalErrReportDownloadController";
			LOGGER.debug(msg);
		}
...

		{
			...
			asyncJobsService.createJob(TenantContext.getTenantId(),
					JobConstants.EWB_REPORT, jobParams.toString(), userName, 1L,
					null, null);
			...
			String msg = "Error Occured in EwbPsdTotalErrReportDownloadController";
	...
	@GetMapping(value = "/ui/ewbReportDownload")
	public void fileDownloads(HttpServletRequest request,
		...
		if (entity.isPresent()) {
			...
			String fileFolder = GSTConstants.EWB_FOLDER_NAME;
