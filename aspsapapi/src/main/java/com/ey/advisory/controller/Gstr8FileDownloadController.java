...
@RestController
@Slf4j
public class Gstr8FileDownloadController {
	...
	@PostMapping(value = "/ui/downloadGstr8FileReports")
	public ResponseEntity<String> ReportProcess(
		...
		try {
			...
			asyncJobsService.createJob(groupCode,
					JobConstants.GSTR8_FILE_DOWNLOAD, jobParams.toString(),
			...
			jobParams1.addProperty("reportType", reqDto.getType());
