...
import com.ey.advisory.app.services.search.filestatussearch.GlReconFileStatusService;
...
@RestController
@Slf4j
public class GlReconFileStatusController {

	@Autowired
	@Qualifier("GlReconFileStatusService")
	private GlReconFileStatusService glReconFileStatusService;
	 ...
	 */
	@PostMapping(value = { "/ui/glReconFileStatus" }, produces = {
	...
	public ResponseEntity<String> fileStatus(@RequestBody String fileStatusJson,
		...
		try {
			...
			SearchResult<FileStatusResponseDto> searchResult = glReconFileStatusService
					.find(fileReqDto, null, FileStatusResponseDto.class);
