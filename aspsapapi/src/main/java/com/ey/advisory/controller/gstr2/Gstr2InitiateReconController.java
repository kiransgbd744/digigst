...
import com.ey.advisory.app.asprecon.gstr2.initiaterecon.Gstr2InitiateReconLineItemDto;
import com.ey.advisory.app.asprecon.gstr2.initiaterecon.Gstr2InitiateReconService;
...
@Slf4j
@RestController
public class Gstr2InitiateReconController {
	...
	@Autowired
	@Qualifier("Gstr2InitiateReconService")
	private Gstr2InitiateReconService reconService;

	@RequestMapping(value = "/ui/gstr2InitiateRecon", method = 
	...
	public ResponseEntity<String> getInitiateRecon(
		...
		try {
			...
			List<Gstr2InitiateReconLineItemDto> recResponse = reconService
					.find(criteria);
