...
import com.ey.advisory.app.services.itc04.Itc04PopUpService;
...
@Slf4j
@RestController
public class Itc04PopUpController {

	@Autowired
	@Qualifier("Itc04PopUpService")
	private Itc04PopUpService itc04PopUpService;

	@PostMapping(value = "/ui/getItc04PopUpRecords", produces = {
	...
	public ResponseEntity<String> fetchProcessedRecords(
		...
		try {
			...
			Gstr1PopScreenRecordsFinalResponseDto finalResponseDtos = itc04PopUpService
					.fetchRec(dto);
			...
			String msg = "Unexpected error while getting the itc04 popup records";
			LOGGER.error(msg, ex);
			JsonObject resp = new JsonObject();
