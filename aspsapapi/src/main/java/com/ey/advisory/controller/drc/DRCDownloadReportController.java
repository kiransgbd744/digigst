...
@Slf4j
@RestController
public class DRCDownloadReportController {
	...
	@RequestMapping(value = "/ui/downloaddrcreport", method = RequestMethod.POST, produces = {
	...
	public ResponseEntity<String> downloadreviewSummReport(
		...
		try {
			...
			entity.setReportType(ReportTypeConstants.DRC01B);
			...
			asyncJobsService.createJob(TenantContext.getTenantId(),
					JobConstants.DRC_REPORT_DOWNLOAD, jobParams.toString(),
			...
			String errMsg = "Unexpected error occured in Drc Download Async Report";
