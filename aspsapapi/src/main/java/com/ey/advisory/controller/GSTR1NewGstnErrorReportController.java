...
import com.ey.advisory.app.services.reports.Gstr1NewGstnErrorReportHandler;
...
@RestController
public class GSTR1NewGstnErrorReportController {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(GSTR1NewGstnErrorReportController.class);

	@Autowired
	@Qualifier("Gstr1NewGstnErrorReportHandler")
	private Gstr1NewGstnErrorReportHandler gstr1NewGstnErrorReportHandler;

	@Autowired
	@Qualifier("BasicCommonSecParamRSReports")
	BasicCommonSecParamRSReports basicCommonSecParamRSReports;

	@RequestMapping(value = "/ui/downloadGstr1GstnErrorReports", method = RequestMethod.POST, produces = {
	...
	public void downloadreviewSummReport(@RequestBody String jsonString,
		...
		try {
			...
			if (criteria.getType() != null && criteria.getType()
				...
				workbook = gstr1NewGstnErrorReportHandler
						.getGstr1NewGstSavableReports(setDataSecurity);
