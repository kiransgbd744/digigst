...
@RestController
@Slf4j
public class Gstr3bDrc01cJSONFileDownloadController {

	@Autowired
	@Qualifier("TblDrc01cSaveStatusRepo")
	TblDrc01cSaveStatusRepo repo;
	...
	@RequestMapping(value = "/ui/gstr3bDrc01cJsonDownloadDocument", method = RequestMethod.POST, produces = {
	...
	public void fileDownloads(@RequestBody String jsonString,
		...
		try {
			...
			TblDrc01cSaveStatus entity = repo.findByGstinAndTaxPeriodAndCreatedOn(
			...
			if ("ErrorFiledStatus".equalsIgnoreCase(dataType)) {
				...
				SignAndFileEntity entty = signAndFileRepo
						.findByGstinAndTaxPeriodAndReturnTypeAndCreatedOn(gstin,
								taxPeriod, APIIdentifiers.DRC01C, utcDateTime);
