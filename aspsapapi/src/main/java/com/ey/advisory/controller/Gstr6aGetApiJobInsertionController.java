...
@RestController
@Slf4j
public class Gstr6aGetApiJobInsertionController {
	...
	@PostMapping(value = "/ui/Gstr6aGstnGetSection", produces = { MediaType.APPLICATION_JSON_VALUE })
		...
		try {
			...
			for (Gstr6aGetInvoicesReqDto dto : dtos) {
				...
				Long userRequestId = gstnUserRequestUtil.createGstnUserRequest(gstin, taxPeriod, APIConstants.GET,
						APIConstants.GSTR6A.toUpperCase(), groupCode, userName, false, false, false);
