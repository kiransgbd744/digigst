 ...
 */
@Entity
@Table(name = "TBL_GETIMS_INVOICE_STAGGING_B2B")
@Data
public class ImsInvoiceStagingB2BEntity {
	
	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "TBL_GETIMS_INVOICE_HEADER_B2B_SEQ", allocationSize = 100)
