 ...
 */
@Entity
@Table(name = "TBL_GETIMS_GSTR1A_B2BA_HEADER")
@Data
public class SupplierImsGstr1AB2BAHeaderEntity {
 ...
 /*   @Column(name = "IRN_GEN_DATE")
	...
	protected List<SupplierImsGstr1AB2BAItemEntity> lineItems = new ArrayList<>();
