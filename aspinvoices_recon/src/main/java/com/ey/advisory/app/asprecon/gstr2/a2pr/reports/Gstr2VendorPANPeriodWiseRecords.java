...
@Slf4j
@Component("Gstr2VendorPANPeriodWiseRecords")
public class Gstr2VendorPANPeriodWiseRecords {
	...
	public void getVendorPANPeriodWiseRecords(Long configId) throws IOException {
		...
		String reportType = getUniqueFileName("Vendor PAN Tax Period Wise Report");
		...
		try {
			...
			StoredProcedureQuery storedProc = entityManager
					.createStoredProcedureQuery(
							"USP_RECON_RPT_VENDOR_PAN_PERIOD");
			...
			if (records != null && !records.isEmpty()) {
				...
				try (Writer writer = new BufferedWriter(
					...
					if (reconDataList != null && !reconDataList.isEmpty()) {
						...
						"gstr2.recon.vendor.pan.period.wise.header");
						writer.append(invoiceHeadersTemplate);
						String[] columnMappings = commonUtility
			    .getProp("gstr2.recon.vendor.pan.period.wise.column")
								.split(",");
				...
				String vendorPANPeriodWiseRecordsFilePath = null;
				if (tempDir.list().length > 0) {
					...
					vendorPANPeriodWiseRecordsFilePath = DocumentUtility
							.uploadZipFile(zipFile, "Gstr2ReconReports");

				} if(vendorPANPeriodWiseRecordsFilePath != null)
				addlReportRepo.updateReconFilePath(vendorPANPeriodWiseRecordsFilePath,
						configId, "Vendor_PAN_Period_Wise_Records");
				if (LOGGER.isDebugEnabled()) {
					String msg = String
							.format("Update file path for Vendor_PAN_Period_Wise_Records "
									+ ":%s : ", vendorPANPeriodWiseRecordsFilePath);
					LOGGER.debug(msg);
				}
			}
	...
	private Gstr2VendorPANPeriodWiseRecordsDto convert(Object[] arr) {
		...
		obj.setPeriodPR((arr[2] != null) ? "`".concat(arr[2].toString()) : null);
		
		obj.setDocType((arr[3] != null) ? arr[3].toString() : null);
		...
		obj.setExactMatchIGST((arr[12] != null) ? arr[12].toString() : null);
		obj.setExactMatchCGST((arr[13] != null) ? arr[13].toString() : null);
		obj.setExactMatchSGST((arr[14] != null) ? arr[14].toString() : null);
		obj.setExactMatchCESS((arr[15] != null) ? arr[15].toString() : null);
		obj.setMatchWithTolerenceCount((arr[16] != null) ? arr[16].toString() : null);
		obj.setMatchWithTolerenceTaxable((arr[17] != null) ? arr[17].toString() : null);
		obj.setMatchWithTolerenceIGST((arr[18] != null) ? arr[18].toString() : null);
		obj.setMatchWithTolerenceCGST((arr[19] != null) ? arr[19].toString() : null);
		obj.setMatchWithTolerenceSGST((arr[20] != null) ? arr[20].toString() : null);
		obj.setMatchWithTolerenceCESS((arr[21] != null) ? arr[21].toString() : null);
		obj.setValueMismatchCount((arr[22] != null) ? arr[22].toString() : null);
		obj.setValueMismatchTaxable((arr[23] != null) ? arr[23].toString() : null);
		obj.setValueMismatchIGST((arr[24] != null) ? arr[24].toString() : null);
		obj.setValueMismatchCGST((arr[25] != null) ? arr[25].toString() : null);
		obj.setValueMismatchSGST((arr[26] != null) ? arr[26].toString() : null);
		obj.setValueMismatchCESS((arr[27] != null) ? arr[27].toString() : null);
		obj.setPosMismatchCount((arr[28] != null) ? arr[28].toString() : null);
		obj.setPosMismatchTaxable((arr[29] != null) ? arr[29].toString() : null);
		obj.setPosMismatchIGST((arr[30] != null) ? arr[30].toString() : null);
		obj.setPosMismatchCGST((arr[31] != null) ? arr[31].toString() : null);
		obj.setPosMismatchSGST((arr[32] != null) ? arr[32].toString() : null);
		obj.setPosMismatchCESS((arr[33] != null) ? arr[33].toString() : null);
		...
		obj.setMultiMismatchCount((arr[52] != null) ? arr[52].toString() : null);
		obj.setMultiMismatchTaxable((arr[53] != null) ? arr[53].toString() : null);
		obj.setMultiMismatchIGST((arr[54] != null) ? arr[54].toString() : null);
		obj.setMultiMismatchCGST((arr[55] != null) ? arr[55].toString() : null);
		obj.setMultiMismatchSGST((arr[56] != null) ? arr[56].toString() : null);
		obj.setMultiMismatchCESS((arr[57] != null) ? arr[57].toString() : null);
		...
		obj.setAdditionTaxable2A((arr[83] != null) ? arr[83].toString() : null);
		obj.setAdditionIGST2A((arr[84] != null) ? arr[84].toString() : null);
		obj.setAdditionCGST2A((arr[85] != null) ? arr[85].toString() : null);
		obj.setAdditionSGST2A((arr[86] != null) ? arr[86].toString() : null);
		obj.setAdditionCESS2A((arr[87] != null) ? arr[87].toString() : null);
		obj.setAdditionCountPR((arr[88] != null) ? arr[88].toString() : null);
		obj.setAdditionTaxablePR((arr[89] != null) ? arr[89].toString() : null);
		obj.setAdditionIGSTPR((arr[90] != null) ? arr[90].toString() : null);
		obj.setAdditionCGSTPR((arr[91] != null) ? arr[91].toString() : null);
		obj.setAdditionSGSTPR((arr[92] != null) ? arr[92].toString() : null);
		obj.setAdditionCESSPR((arr[93] != null) ? arr[93].toString() : null);
	...
	private static File createTempDir(Long configId) throws IOException {
		...
		String tempFolderPrefix = "Vendor_PAN_Period_Wise_Records" + "_" + configId;
