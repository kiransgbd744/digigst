 ...
 */
@Entity
@Table(name = "TBL_GETIMS_INVOICE_STAGGING_CN")
@Data
public class ImsInvoiceStagingCNEntity {
	
	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "TBL_GETIMS_INVOICE_HEADER_CN_SEQ", allocationSize = 100)
