...
@Entity
@Table(name = "TBL_GETIMS_GSTR1_CDNR_HEADER")
@Data
public class SupplierImsGstr1CDNRHeaderEntity {
	...
	protected List<SupplierImsGstr1CDNRItemEntity> lineItems = new ArrayList<>();
