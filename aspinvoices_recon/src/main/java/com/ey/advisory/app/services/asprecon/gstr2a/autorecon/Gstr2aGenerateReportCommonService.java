...
@Slf4j
@Component("Gstr2aGenerateReportCommonService")
public class Gstr2aGenerateReportCommonService {

	@Autowired
	private Gstr2GenerateReportTypeRepository reportTypeRepo;
	...
	private static final String CONF_KEY = "gstr2.recon.generate.report.size";
		...
		try {
			...
			for (Pair<Long, List<File>> rptChunks : reportIds) {
				...
				Pair<String, String> uploadedDocName = DocumentUtility
						.uploadFile(zipFile,"Gstr2aAutoCloudReport");
	...
	public Long saveReportChunks(Long reportId, String reportType,
		...
		Gstr2GenerateReportTypeEntity entity = 
				new Gstr2GenerateReportTypeEntity();
