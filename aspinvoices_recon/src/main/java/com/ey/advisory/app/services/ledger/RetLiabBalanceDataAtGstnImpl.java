 ...
 *
 */
@Service("retLiabBalanceDataAtGstnImpl")
public class RetLiabBalanceDataAtGstnImpl implements RetLiabBalanceDataAtGstn {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(RetLiabBalanceDataAtGstnImpl.class);
	...
	public String fromGstn(RetLiabBalanceReqDto dto, String groupCode) {
		...
		APIParam param3 = new APIParam("ret_type", dto.getRetType());
		APIParam param4 = new APIParam("action", dto.getAction());
		APIParams params = new APIParams(groupCode, APIProviderEnum.GSTN,
				APIIdentifiers.LEDGER_GET_TAXPAYABLE, param1, param2, param3);
