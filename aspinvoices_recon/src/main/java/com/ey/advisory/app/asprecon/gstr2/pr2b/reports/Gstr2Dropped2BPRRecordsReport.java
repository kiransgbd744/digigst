...
@Component("Gstr2Dropped2BPRRecordsReport")
@Slf4j
public class Gstr2Dropped2BPRRecordsReport {
	...
	public void getGstr2DroppedPRRecordsReport(Long configId)
		...
		if (LOGGER.isDebugEnabled()) {
			msg = String.format("Get Dropped_PR_Records_Report Details "
		...
		if (noOfChunk > 0) {
			...
			try {
				...
				String[] columnMappings = commonUtility
						.getProp("gstr2bpr.dropout.pr.report.column")
						.split(",");
