...
import com.ey.advisory.app.asprecon.gstr2.a2pr.reports.Gstr2VendorPANPeriodWiseRecordsDto;
...
@Slf4j
@Component("Gstr2VendorPANWise2BPRRecords")
public class Gstr2VendorPANWise2BPRRecords {

	// Vendor_PAN_Wise_Records
	...
	public void getVendorPANWiseRecords(Long configId) throws IOException {
		...
		String reportType = getUniqueFileName("Vendor PAN Wise Report");
		...
		try {
			...
			StoredProcedureQuery storedProc = entityManager
					.createStoredProcedureQuery("USP_RECON_RPT_2B_VENDOR_PAN");
			...
			if (records != null && !records.isEmpty()) {
				...
				fullPath = tempDir.getAbsolutePath() + File.separator
						+ reportType + ".csv";
				List<Gstr2VendorPANPeriodWiseRecordsDto> reconDataList = new ArrayList<>();
				...
				try (Writer writer = new BufferedWriter(
					...
					if (reconDataList != null && !reconDataList.isEmpty()) {
						...
						String invoiceHeadersTemplate = commonUtility.getProp(
								"gstr2bpr.recon.vendor.pan.wise.header");
						writer.append(invoiceHeadersTemplate);
						String[] columnMappings = commonUtility
								.getProp("gstr2.recon.vendor.pan.wise.column")
								.split(",");

						ColumnPositionMappingStrategy<Gstr2VendorPANPeriodWiseRecordsDto> mappingStrategy = new ColumnPositionMappingStrategy<>();
						mappingStrategy.setType(
								Gstr2VendorPANPeriodWiseRecordsDto.class);
						mappingStrategy.setColumnMapping(columnMappings);
						StatefulBeanToCsvBuilder<Gstr2VendorPANPeriodWiseRecordsDto> builder = new StatefulBeanToCsvBuilder<>(
								writer);
						StatefulBeanToCsv<Gstr2VendorPANPeriodWiseRecordsDto> beanWriter = builder
				...
				if (tempDir.list().length > 0) {
					...
					/*vendorPANWiseRecordsFilePath = DocumentUtility
				...
				if (uploadedDocName != null) {
					// addlReportRepo.updateReconFilePath(vendorPANWiseRecordsFilePath,
					// configId, "Vendor_PAN_Wise_Records");
					...
					commonService.saveReportChunks(chunkDetails.getId(),
							"Vendor_PAN_Wise_Records_1",
							uploadedDocName.getValue0(), true, 
							uploadedDocName.getValue1());
				}
				if (LOGGER.isDebugEnabled()) {
					String msg = String
							.format("Update file path for Vendor_PAN_Wise_Records "
									+ ":%s : ", uploadedDocName);
					LOGGER.debug(msg);
				}
			}
	...
	private Gstr2VendorPANPeriodWiseRecordsDto convert(Object[] arr) {

		Gstr2VendorPANPeriodWiseRecordsDto obj = new Gstr2VendorPANPeriodWiseRecordsDto();

		// todo confirm mapping

		obj.setSupplierPan((arr[0] != null) ? arr[0].toString() : null);
		...
		obj.setTotalCount((arr[3] != null) ? arr[3].toString() : null);
		if (docType != null && (docType.equalsIgnoreCase("CR")
				|| docType.equalsIgnoreCase("C")
				|| docType.equalsIgnoreCase("RCR"))) {
			obj.setTotalTaxable(CheckForNegativeValue(arr[4]));
			obj.setTotalIGST(CheckForNegativeValue(arr[5]));
			obj.setTotalCGST(CheckForNegativeValue(arr[6]));
			obj.setTotalSGST(CheckForNegativeValue(arr[7]));
			obj.setTotalCESS(CheckForNegativeValue(arr[8]));
			obj.setExactMatchTaxable(CheckForNegativeValue(arr[10]));
			obj.setExactMatchIGST(CheckForNegativeValue(arr[11]));
			obj.setExactMatchCGST(CheckForNegativeValue(arr[12]));
			obj.setExactMatchSGST(CheckForNegativeValue(arr[13]));
			obj.setExactMatchCESS(CheckForNegativeValue(arr[14]));
			obj.setMatchWithTolerenceTaxable(CheckForNegativeValue(arr[16]));
			obj.setMatchWithTolerenceIGST(CheckForNegativeValue(arr[17]));
			obj.setMatchWithTolerenceCGST(CheckForNegativeValue(arr[18]));
			obj.setMatchWithTolerenceSGST(CheckForNegativeValue(arr[19]));
			obj.setMatchWithTolerenceCESS(CheckForNegativeValue(arr[20]));
			obj.setValueMismatchTaxable(CheckForNegativeValue(arr[22]));
			obj.setValueMismatchIGST(CheckForNegativeValue(arr[23]));
			obj.setValueMismatchCGST(CheckForNegativeValue(arr[24]));
			obj.setValueMismatchSGST(CheckForNegativeValue(arr[25]));
			obj.setValueMismatchCESS(CheckForNegativeValue(arr[26]));
			obj.setPosMismatchTaxable(CheckForNegativeValue(arr[28]));
			obj.setPosMismatchIGST(CheckForNegativeValue(arr[29]));
			obj.setPosMismatchCGST(CheckForNegativeValue(arr[30]));
			obj.setPosMismatchSGST(CheckForNegativeValue(arr[31]));
			obj.setPosMismatchCESS(CheckForNegativeValue(arr[32]));
			obj.setDocumentDateMishmatchTaxable(CheckForNegativeValue(arr[34]));
			obj.setDocumentDateMishmatchIGST(CheckForNegativeValue(arr[35]));
			obj.setDocumentDateMishmatchCGST(CheckForNegativeValue(arr[36]));
			obj.setDocumentDateMishmatchSGST(CheckForNegativeValue(arr[37]));
			obj.setDocumentDateMishmatchCESS(CheckForNegativeValue(arr[38]));
			obj.setDocumentTypeMishmatchTaxable(CheckForNegativeValue(arr[40]));
			obj.setDocumentTypeMishmatchIGST(CheckForNegativeValue(arr[41]));
			obj.setDocumentTypeMishmatchCGST(CheckForNegativeValue(arr[42]));
			obj.setDocumentTypeMishmatchSGST(CheckForNegativeValue(arr[43]));
			obj.setDocumentTypeMishmatchCESS(CheckForNegativeValue(arr[44]));
			obj.setDocumentNumberMishmatch1Taxable(
					CheckForNegativeValue(arr[46]));
			obj.setDocumentNumberMishmatch1IGST(CheckForNegativeValue(arr[47]));
			obj.setDocumentNumberMishmatch1CGST(CheckForNegativeValue(arr[48]));
			obj.setDocumentNumberMishmatch1SGST(CheckForNegativeValue(arr[49]));
			obj.setDocumentNumberMishmatch1CESS(CheckForNegativeValue(arr[50]));
			obj.setMultiMismatchTaxable(CheckForNegativeValue(arr[52]));
			obj.setMultiMismatchIGST(CheckForNegativeValue(arr[53]));
			obj.setMultiMismatchCGST(CheckForNegativeValue(arr[54]));
			obj.setMultiMismatchSGST(CheckForNegativeValue(arr[55]));
			obj.setMultiMismatchCESS(CheckForNegativeValue(arr[56]));
			obj.setPotentialMatch1Taxable(CheckForNegativeValue(arr[58]));
			obj.setPotentialMatch1IGST(CheckForNegativeValue(arr[59]));
			obj.setPotentialMatch1CGST(CheckForNegativeValue(arr[60]));
			obj.setPotentialMatch1SGST(CheckForNegativeValue(arr[61]));
			obj.setPotentialMatch1CESS(CheckForNegativeValue(arr[62]));
			obj.setDocumentNumberMishmatch2Taxable(
					CheckForNegativeValue(arr[64]));
			obj.setDocumentNumberMishmatch2IGST(CheckForNegativeValue(arr[65]));
			obj.setDocumentNumberMishmatch2CGST(CheckForNegativeValue(arr[66]));
			obj.setDocumentNumberMishmatch2SGST(CheckForNegativeValue(arr[67]));
			obj.setDocumentNumberMishmatch2CESS(CheckForNegativeValue(arr[68]));
			obj.setPotentialMatch2Taxable(CheckForNegativeValue(arr[70]));
			obj.setPotentialMatch2IGST(CheckForNegativeValue(arr[71]));
			obj.setPotentialMatch2CGST(CheckForNegativeValue(arr[72]));
			obj.setPotentialMatch2SGST(CheckForNegativeValue(arr[73]));
			obj.setPotentialMatch2CESS(CheckForNegativeValue(arr[74]));
			obj.setLogicalMatchTaxable(CheckForNegativeValue(arr[76]));
			obj.setLogicalMatchIGST(CheckForNegativeValue(arr[77]));
			obj.setLogicalMatchCGST(CheckForNegativeValue(arr[78]));
			obj.setLogicalMatchSGST(CheckForNegativeValue(arr[79]));
			obj.setLogicalMatchCESS(CheckForNegativeValue(arr[80]));
			obj.setAdditionTaxable2A(CheckForNegativeValue(arr[82]));
			obj.setAdditionIGST2A(CheckForNegativeValue(arr[83]));
			obj.setAdditionCGST2A(CheckForNegativeValue(arr[84]));
			obj.setAdditionSGST2A(CheckForNegativeValue(arr[85]));
			obj.setAdditionCESS2A(CheckForNegativeValue(arr[86]));
			obj.setAdditionTaxablePR(CheckForNegativeValue(arr[88]));
			obj.setAdditionIGSTPR(CheckForNegativeValue(arr[89]));
			obj.setAdditionCGSTPR(CheckForNegativeValue(arr[90]));
			obj.setAdditionSGSTPR(CheckForNegativeValue(arr[91]));
			obj.setAdditionCESSPR(CheckForNegativeValue(arr[92]));
			obj.setDocNoDocDateMisMatchTaxable(CheckForNegativeValue(arr[100]));
			obj.setDocNoDocDateMisMatchIGST(CheckForNegativeValue(arr[101]));
			obj.setDocNoDocDateMisMatchCGST(CheckForNegativeValue(arr[102]));
			obj.setDocNoDocDateMisMatchSGST(CheckForNegativeValue(arr[103]));
			obj.setDocNoDocDateMisMatchCESS(CheckForNegativeValue(arr[104]));
			obj.setForceGSTR3BMatchTaxable(CheckForNegativeValue(arr[94]));
			obj.setForceGSTR3BMatchIGST(CheckForNegativeValue(arr[95]));
			obj.setForceGSTR3BMatchCGST(CheckForNegativeValue(arr[96]));
			obj.setForceGSTR3BMatchSGST(CheckForNegativeValue(arr[97]));
			obj.setForceGSTR3BMatchCESS(CheckForNegativeValue(arr[98]));

		} else {
			obj.setTotalTaxable((arr[4] != null) ? arr[4].toString() : null);
			obj.setTotalIGST((arr[5] != null) ? arr[5].toString() : null);
			obj.setTotalCGST((arr[6] != null) ? arr[6].toString() : null);
			obj.setTotalSGST((arr[7] != null) ? arr[7].toString() : null);
			obj.setTotalCESS((arr[8] != null) ? arr[8].toString() : null);
		...
		obj.setLogicalMatchCount((arr[75] != null) ? arr[75].toString() : null);
		obj.setAdditionCount2A((arr[81] != null) ? arr[81].toString() : null);
		obj.setAdditionCountPR((arr[87] != null) ? arr[87].toString() : null);
		obj.setDocNoDocDateMisMatchCount(
				(arr[99] != null) ? arr[99].toString() : null);	
		obj.setForceGSTR3BMatchCount(
	...
	private static File createTempDir(Long configId) throws IOException {
		...
		String tempFolderPrefix = "Vendor_PAN_Wise_Records" + "_" + configId;
