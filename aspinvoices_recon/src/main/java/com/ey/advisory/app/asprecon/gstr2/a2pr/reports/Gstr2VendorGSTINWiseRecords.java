 ...
 */
@Slf4j
@Component("Gstr2VendorGSTINWiseRecords")
public class Gstr2VendorGSTINWiseRecords {
	...
	public void getVendorGSTINWiseRecords(Long configId) throws IOException {
		...
		try {
			...
			StoredProcedureQuery storedProc = entityManager
					.createStoredProcedureQuery("USP_RECON_RPT_VENDOR_GSTIN");
			...
			if (records != null && !records.isEmpty()) {
				...
				try (Writer writer = new BufferedWriter(
					...
					if (reconDataList != null && !reconDataList.isEmpty()) {
						...
						String invoiceHeadersTemplate = commonUtility.getProp(
								"gstr2.recon.vendor.gstin.wise.header");
				...
				String vendorGSTINWiseRecordsFilePath = null;
				...
				if (vendorGSTINWiseRecordsFilePath != null)
					addlReportRepo.updateReconFilePath(
							vendorGSTINWiseRecordsFilePath, configId,
							"Vendor_GSTIN_Wise_Records");
				if (LOGGER.isDebugEnabled()) {
					String msg = String
							.format("Update file path for Vendor_GSTIN_Wise_Records "
									+ ":%s : ", vendorGSTINWiseRecordsFilePath);
					LOGGER.debug(msg);
				}
	...
	private Gstr2VendorGSTINPeriodWiseRecordsDto convert(Object[] arr) {
		...
		obj.setExactMatchTaxable((arr[11] != null) ? arr[11].toString() : null);
		...
		obj.setLogicalMatchIGST((arr[78] != null) ? arr[78].toString() : null);
		obj.setLogicalMatchCGST((arr[79] != null) ? arr[79].toString() : null);
		obj.setLogicalMatchSGST((arr[80] != null) ? arr[80].toString() : null);
		obj.setLogicalMatchCESS((arr[81] != null) ? arr[81].toString() : null);
