...
@Entity
@Table(name = "TBL_GETIMS_STAGING_GSTR1_CDNRA_HEADER")
@Data
public class SupplierImsGstr1CDNRAHeaderStaggingEntity {
   ...
   //	@OrderColumn(name = "ITEM_INDEX")
	...
	protected List<SupplierImsGstr1CDNRAItemStaggingEntity> lineItems = new ArrayList<>();
