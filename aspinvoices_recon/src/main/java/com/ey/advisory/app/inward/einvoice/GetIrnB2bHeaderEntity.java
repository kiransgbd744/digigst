...
@Data
@Entity
@Table(name = "TBL_GETIRN_B2B_HEADER")
public class GetIrnB2bHeaderEntity {

	@Expose
	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "TBL_GETIRN_B2B_HEADER_SEQ", allocationSize = 100)
	...
	private BigDecimal invOtherCharges = BigDecimal.ZERO;

	@Column(name = "INV_ASSESSABLE_AMT")
	private BigDecimal invAssessableAmt = BigDecimal.ZERO;

	@Column(name = "INV_IGST_AMT")
	private BigDecimal invIgstAmt = BigDecimal.ZERO;

	@Column(name = "INV_CGST_AMT")
	private BigDecimal invCgstAmt = BigDecimal.ZERO;

	@Column(name = "INV_SGST_AMT")
	private BigDecimal invSgstAmt = BigDecimal.ZERO;

	@Column(name = "INV_CESS_ADVALOREM_AMT")
	private BigDecimal invCessAdvaloremAmt = BigDecimal.ZERO;

	@Column(name = "INV_CESS_SPECIFIC_AMT")
	private BigDecimal invCessSpecificAmt= BigDecimal.ZERO;

	@Column(name = "INV_STATECESS_ADVALOREM_AMT")
	private BigDecimal invStateCessAdvaloremAmt = BigDecimal.ZERO;

	@Column(name = "INV_STATECESS_SPECIFIC_AMT")
	private BigDecimal invStateCessSpecificAmt = BigDecimal.ZERO;
	...
	private BigDecimal invoiceValueFC = BigDecimal.ZERO;
	...
	protected List<GetIrnB2bItemEntity> lineItems = new ArrayList<>();*/
