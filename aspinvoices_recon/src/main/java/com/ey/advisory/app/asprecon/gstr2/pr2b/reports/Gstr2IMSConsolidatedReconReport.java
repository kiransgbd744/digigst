...
@Slf4j
@Component("Gstr2IMSConsolidatedReconReport")
public class Gstr2IMSConsolidatedReconReport {
	...
	public void getImsConsolidatedReconReport(Long configId)
			throws IOException {
		...
		if (LOGGER.isDebugEnabled()) {
			msg = String.format(
					"Get getImsConsolidatedReconReport Details with configId:'%s'",
					configId.toString());
			LOGGER.debug(msg);
		}

		String reportType = "Consolidated 2BvsPR + IMS Report";
		String reportTypeUi = "Consolidated PR 2B Report IMS";
		...
		if (noOfChunk != 0) {
			...
			msg = String.format(
					"Get Recon Consolidated 2BvsPR + IMS Report Details with "
			...
			try {
				...
				String[] columnMappings = commonUtility
						.getProp("gstr2.recon.2bpr.ims.report.column")
						.split(",");
				...
				while (j < noOfChunk) {
					...
					if (records != null && !records.isEmpty()) {
						...
						if (count >= maxLimitPerFile) {
							...
							if (LOGGER.isDebugEnabled()) {
								LOGGER.debug("Invoking 2BPR commonService to"
										+ " upload a zip file : "
										+ "configId {}, ReportName" + " {}, ",
										configId, reportType);
							}
				...
				LOGGER.error("Exception while executing proc "
						+ "USP_RECON_2BPR_RPT_MASTER_IMS for "
		...
		addlReportRepo.updateIsReportProcExecuted(configId, reportTypeUi);
		deleteTemporaryDirectory(tempDir);
	}
	...
	private Gstr2Recon2BPRReportDto convert(Object[] arr) {
		...
		obj.setTotalTax2B((arr[30] != null) ? arr[30].toString() : null);
		obj.setInvoiceValue2B((arr[32] != null) ? arr[32].toString() : null);
		...
		if (arr[173] != null && (!arr[173].toString().trim().isEmpty())) {
			obj.setTaxPeriodGSTR3B(
					(arr[173] != null) ? "`".concat(arr[173].toString())
							: null);
		}
		...
		/*
		 * obj.setITCReversalIdentifier( (arr[186] != null) ?
		 * arr[186].toString() : null);
		 */
		...
		obj.setVendorType((arr[191] != null) ? arr[191].toString() : null);
		obj.setHSN((arr[192] != null) ? arr[192].toString() : null);
		...
		obj.setVendorRemarks((arr[195] != null) ? arr[195].toString() : null);
		...
		obj.setImsUserResponse((arr[201] != null) ? arr[201].toString() : null);
		obj.setImsResponseRemark(
				(arr[202] != null) ? arr[202].toString() : null);
		obj.setActionGstn((arr[203] != null) ? arr[203].toString() : null);
		obj.setPendingActionbloacked(
				(arr[204] != null) ? arr[204].toString() : null);
		obj.setImsGetCallDateTime(
				(arr[205] != null) ?  "'".concat(arr[205].toString()) : null);
		obj.setActionDigi((arr[206] != null) ? arr[206].toString() : null);
		obj.setActionDigiDateTime(
				(arr[207] != null) ? "'".concat(arr[207].toString()) : null);
		obj.setImsSaveToGstn((arr[208] != null) ? arr[208].toString() : null);
		obj.setActiveInIms((arr[209] != null) ? arr[209].toString() : null);
		obj.setImsTotalTaxDiff((arr[210] != null) ? arr[210].toString() : null);
		...
		obj.setImsUniqueId((arr[213] != null) ? arr[213].toString() : null);
		/*obj.setAmountSource2B((arr[214] != null) ? arr[214].toString() : null);*/
