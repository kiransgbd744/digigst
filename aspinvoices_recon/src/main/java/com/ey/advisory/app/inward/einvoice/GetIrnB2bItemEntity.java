...
@Data
@Entity
@Table(name = "TBL_GETIRN_B2B_ITEM")
public class GetIrnB2bItemEntity {

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "TBL_GETIRN_B2B_ITEM_SEQ", allocationSize = 100)
	...
	protected GetIrnB2bHeaderEntity header;*/
