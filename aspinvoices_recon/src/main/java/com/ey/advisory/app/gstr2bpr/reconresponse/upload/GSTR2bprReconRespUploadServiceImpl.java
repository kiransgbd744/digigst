 ...
 */
@Slf4j
@Component("GSTR2bprReconRespUploadServiceImpl")
public class GSTR2bprReconRespUploadServiceImpl
		implements GSTR2bprReconRespUploadService {
	...
	private static final List<String> EXPECTED_HEADERNAMES_LIST = Arrays.asList(
			"SuggestedResponse", "UserResponse", "Tax Period- GSTR 3B",
			"ResponseRemarks", "MatchingScoreOutof-12", "Match Reason",
			"MismatchReason", "Report Category", "ReportType",
			...
			"Cess(PR)", "TotalTax(2B)", "TotalTax(PR)", "InvoiceValue(2B)",
			...
			"SystemDefinedField1", "SystemDefinedField2", "SystemDefinedField3",
			"SystemDefinedField4", "SystemDefinedField5", "EWBNumber",
			"EWBDate", "MatchingID", "RequestID", "IDPR", "ID2B",
			"InvoiceKeyPR", "InvoiceKey2B", "ReferenceIDPR", "ReferenceID2B");
	...
	public void validateResponse(Long fileId, String fileName,
		...
		if (LOGGER.isDebugEnabled()) {
			String msg = "Validating GSTR2bprAutoReconResponse file";
			LOGGER.debug(msg);
		}
		try {
	...
	private void validation(List<GSTR2bprAutoReconRespUploadDTO> dtoList,
		...
		try {
			...
			for (GSTR2bprAutoReconRespUploadDTO rowData : dtoList) {
				...
				LOGGER.debug("validationResult size {} for document number 2b {}, pr {} ", validationResult , rowData.getDocumentNumber2B(), rowData.getDocumentNumberPR());
				if (validationResult.isEmpty()) {
					errorMessage = checkForDuplicates(rowData, invoiceKey2BSet,
			...
			List<List<String>> chunksInvKey2B = Lists
					.partition(new ArrayList<String>(invoiceKey2BSet), 2000);
			...
			if (LOGGER.isDebugEnabled()) {
				LOGGER.debug(
						"Getting proc list from TBL_2BPR_RECON_RESP_UPLOAD for, BatchId {}",
			...
			try {
				...
				for (Integer indx : procs.keySet()) {
					...
					try {
						...
						String msg = String.format(
								"Calling GSTR2-BPR failure Proc '%s' for Batch Id is '%s'",
				...
				LOGGER.debug("GSTR2-BPR File is Processed for fileId: {}",
						fileId);

			} catch (Exception e) {
				String msg = String.format(
						"Exception Occure while fetching Proc List for GSTR2-BPR from TBL :'%s'",
						failurePocName);
				LOGGER.error(msg, e);
				fileStatusRepository.updateFileStatus(fileId, "Failed");
	...
	public String checkDataCategory(GSTR2bprAutoReconRespUploadDTO rowData) {
		...
		LOGGER.debug("inside checkdatacategory {} for document number2b {}, PR {} ",checkImpgorNot, rowData.getDocumentNumber2B(), rowData.getDocumentNumberPR());
	...
	private GSTR2bprAutoReconRespUploadDTO convertRowsToDto(Object[] arr,
		...
		obj.setTaxPeriod2B((arr[11] != null) ? arr[11].toString() : null);
		obj.setTaxPeriodPR((arr[12] != null) ? arr[12].toString() : null);
		...
		obj.setDocumentNumber2B((arr[25] != null) ? arr[25].toString() : null);
		obj.setDocumentNumberPR((arr[26] != null) ? arr[26].toString() : null);
		...
		obj.setItcAvailability2B((arr[55] != null) ? arr[55].toString() : null);
		...
		obj.setGSTR1FilingDate((arr[58] != null) ? arr[58].toString() : null);
		obj.setGSTR1FilingPeriod((arr[59] != null) ? arr[59].toString() : null);
		obj.setGSTR3BFilingStatus(
				(arr[60] != null) ? arr[60].toString() : null);
		obj.setGstr3bFilingDate((arr[61] != null) ? arr[61].toString() : null);
		/*
		 * obj.setSupplierGSTINStatus( (arr[62] != null) ? arr[62].toString() :
		 * null);
		 */
		obj.setCancellationDate((arr[62] != null) ? arr[62].toString() : null);
		obj.setGenerationDate2B((arr[63] != null) ? arr[63].toString() : null);
		...
		obj.setOrgDocNumber2B(
				(arr[69] != null) ? removeQuotes(arr[69].toString()) : null);
		...
		obj.setBoeReferenceDate((arr[77] != null) ? arr[77].toString() : null);
		...
		obj.setPlant((arr[93] != null) ? arr[93].toString() : null);
		...
		obj.setGLCodeIGST((arr[104] != null) ? arr[104].toString() : null);
		obj.setGLCodeCGST((arr[105] != null) ? arr[105].toString() : null);
		obj.setGLCodeSGST((arr[106] != null) ? arr[106].toString() : null);
		...
		obj.setHsnVendor((arr[147] != null) ? arr[147].toString() : null);
		...
		obj.setEWayBillNumber((arr[177] != null) ? arr[177].toString() : null);
		obj.setEWayBillDate((arr[178] != null) ? arr[178].toString() : null);
		obj.setMatchingID((arr[179] != null) ? arr[179].toString() : null);
		obj.setRequestID((arr[180] != null) ? arr[180].toString() : null);
