 ...
 */
@Entity
@Table(name = "TBL_GETIMS_INVOICE_STAGGING_CNA")
@Data
public class ImsInvoiceStagingCNAEntity {
	
	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "TBL_GETIMS_INVOICE_HEADER_CNA_SEQ", allocationSize = 100)
