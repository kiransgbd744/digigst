...
@Slf4j
@Component("Gstr2RecipientGSTINPeriodWise2BPRRecords")
public class Gstr2RecipientGSTINPeriodWise2BPRRecords {
	...
	public void getRecipientGSTINPeriodWiseRecords(Long configId)
			throws IOException {
		...
		try {
			...
			if (records != null && !records.isEmpty()) {
				...
				try (Writer writer = new BufferedWriter(
					...
					if (reconDataList != null && !reconDataList.isEmpty()) {
						...
						String invoiceHeadersTemplate = commonUtility
								.getProp("gstr2bpr.recon.rgpwr.header");
						writer.append(invoiceHeadersTemplate);
						String[] columnMappings = commonUtility
								.getProp("gstr2bpr.recon.rgpwr.column")
								.split(",");
				...
				if (tempDir.list().length > 0) {
					...
					/*recipientGPRecordsFilePath = DocumentUtility
				...
				if (uploadedDocName != null) {
					...
					// recipientGPRecordsFilePath, configId,
					...
					commonService.saveReportChunks(chunkDetails.getId(),
							"Recipient_GSTIN_Period_Wise_Record_1",
	...
	private static File createTempDir(Long configId) throws IOException {
		...
		String tempFolderPrefix = "Recipient_GSTIN_Period_Wise_Record" + "_"
				+ configId;
