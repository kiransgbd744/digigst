...
@Entity
@Table(name = "TBL_GETIMS_STAGING_GSTR1A_CDNRA_HEADER")
@Data
public class SupplierImsGstr1ACDNRAHeaderStaggingEntity {

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "TBL_GETIMS_GSTR1A_CDNRA_HEADER_SEQ", allocationSize = 100)
    ...
    protected List<SupplierImsGstr1ACDNRAItemStaggingEntity> lineItems = new ArrayList<>();
