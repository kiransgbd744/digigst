...
public class Anx2ReconResultsPotentialMatchSummaryResDto {
			...
			public String toString() {
				return "Anx2ReconResultsPotentialMatchSummaryResDto [taxPeriod="
						+ taxPeriod + ", myGSTIN=" + myGSTIN + ", vendorGSTIN="
						+ vendorGSTIN + ", vendorTradeNmae=" + vendorTradeNmae
						+ ", count=" + count + ", elTaxableValue="
						+ elTaxableValue + ", elIGST=" + elIGST + ", elCGST="
						+ elCGST + ", elSGST=" + elSGST + ", elCess=" + elCess
						+ ", avTaxableValue=" + avTaxableValue + ", avIGST="
						+ avIGST + ", avCGST=" + avCGST + ", avSGST=" + avSGST
						+ ", avCess=" + avCess + "]";
			}
		}
