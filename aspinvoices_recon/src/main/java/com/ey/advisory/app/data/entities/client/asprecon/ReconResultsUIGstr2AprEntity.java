...
@Entity
@Table(name = "TBL_AUTO_2APR_RECON_RESULT_UI")
@Setter
@Getter
@ToString

public class ReconResultsUIGstr2AprEntity {

	//private static final long serialVersionUID = 1L;

	@Expose
	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "RECON_RESULT_2APR_SEQ", allocationSize = 100)
