 ...
 */
@Slf4j
@Component("Gstr2aGenerateReportServiceImpl")
public class Gstr2aGenerateReportServiceImpl
	...
	public void generateReport(Long requestId) throws Exception {
		...
		StoredProcedureQuery storedProc = entityManager
				.createStoredProcedureQuery("USP_AUTO_2APR_INS_CHUNK_CLOUD");
				...
				while (j < noOfChunk) {
					...
					StoredProcedureQuery dispProc = entityManager
							.createStoredProcedureQuery(
									"USP_AUTO_2APR_DISP_CHUNK_CLOUD");
