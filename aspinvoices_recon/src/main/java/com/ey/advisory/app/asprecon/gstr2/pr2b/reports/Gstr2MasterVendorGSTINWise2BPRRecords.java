 ...
 */
@Slf4j
@Component("Gstr2MasterVendorGSTINWise2BPRRecords")
public class Gstr2MasterVendorGSTINWise2BPRRecords {
	...
	public void getMasterVendorGSTINWiseRecords(Long configId)
			...
			try {
				...
				StoredProcedureQuery storedProc = entityManager
						.createStoredProcedureQuery(
								"USP_RECON_RPT_2B_MASTER_VENDOR_GSTIN");
		...
		if (uploadedDocName != null) {
			...
			commonService.saveReportChunks(chunkDetails.getId(),
					"Vendor_Records_GSTIN_1", uploadedDocName.getValue0(), true,
	...
	private List<String> findGstins(Long configId) {
		...
		String queryString = "SELECT DISTINCT "
				+ " IFNULL(B2_SUPPLIER_GSTIN,PR_SUPPLIER_GSTIN) AS VENDOR_GSTIN "
				+ " FROM TBL_LINK_2B_PR WHERE RECON_REPORT_CONFIG_ID=:configId "
