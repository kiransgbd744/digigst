...
@Component("Anx2PRSDetailsSEZWP")
public class Anx2PRSDetailsSEZWP implements Anx2PRSDetailsSection {
	@Override
	public Anx2PRSDetailHeaderDto getAnx2PRSummaryDetail(
		...
		if (entityResponse.size() > 0) {
			b2b = entityResponse.stream().filter(
					p -> GSTConstants.SEZWP.equalsIgnoreCase(p.getTaxDocType()))
