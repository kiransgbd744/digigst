...
@Slf4j
@Component("Gstr2Potential2Mismatch2BPRReport")
public class Gstr2Potential2Mismatch2BPRReport {
	...
	public void getPotential2(Long configId) throws IOException {
		...
		if (LOGGER.isDebugEnabled()) {
			msg = String.format(
					"Get Recon Potential-II Report Details with configId:'%s'",
					configId.toString());
			LOGGER.debug(msg);
		}

		String reportType = "Potential-II";
		...
		if (noOfChunk != 0) {
			...
			msg = String.format(
					"Get Recon Potential-II Report Details with "
