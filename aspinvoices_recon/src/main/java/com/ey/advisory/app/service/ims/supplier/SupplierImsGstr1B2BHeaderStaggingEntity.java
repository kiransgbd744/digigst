 ...
 */
@Entity
@Table(name = "TBL_GETIMS_STAGING_GSTR1_B2B_HEADER")
@Data
public class SupplierImsGstr1B2BHeaderStaggingEntity {

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "TBL_GETIMS_GSTR1_B2B_HEADER_SEQ", allocationSize = 100)
   ...
   //	@OrderColumn(name = "ITEM_INDEX")
	...
	protected List<SupplierImsGstr1B2BItemStaggingEntity> lineItems = new ArrayList<>();
