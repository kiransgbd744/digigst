...
@Data
@Entity
@Table(name = "TBL_GETIRN_EXPWP_ITEM")
public class GetIrnExpWpItemEntity {

	@Expose
	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "TBL_GETIRN_EXPWP_ITEM_SEQ", allocationSize = 100)
	...
	protected GetIrnExpWpHeaderEntity header;
*/
}
