 ...
 */
@Entity
@Table(name = "TBL_GETIMS_INVOICE_STAGGING_ECOMA")
@Data
public class ImsInvoiceStagingECOMAEntity {
	
	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "TBL_GETIMS_INVOICE_HEADER_ECOMA_SEQ", allocationSize = 100)
