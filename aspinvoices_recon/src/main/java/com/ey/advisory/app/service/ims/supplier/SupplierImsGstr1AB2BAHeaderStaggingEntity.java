...
@Entity
@Table(name = "TBL_GETIMS_STAGING_GSTR1A_B2BA_HEADER")
@Data
public class SupplierImsGstr1AB2BAHeaderStaggingEntity {

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "TBL_GETIMS_GSTR1A_B2BA_HEADER_SEQ", allocationSize = 100)
   ...
   //	@OrderColumn(name = "ITEM_INDEX")
	...
	protected List<SupplierImsGstr1AB2BAItemStaggingEntity> lineItems = new ArrayList<>();
