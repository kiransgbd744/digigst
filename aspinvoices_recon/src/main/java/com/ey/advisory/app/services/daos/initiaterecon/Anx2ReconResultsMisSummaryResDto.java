...
public class Anx2ReconResultsMisSummaryResDto {
		...
		public String toString() {
			return "Anx2ReconResultsMisSummaryResDto [taxPeriod=" + taxPeriod
					+ ", myGSTIN=" + myGSTIN + ", vendorGSTIN=" + vendorGSTIN
					+ ", vendorTradeNmae=" + vendorTradeNmae + ", count="
					+ count + ", elTaxableValue=" + elTaxableValue + ", elIGST="
					+ elIGST + ", elCGST=" + elCGST + ", elSGST=" + elSGST
					+ ", elCess=" + elCess + ", avTaxableValue="
					+ avTaxableValue + ", avIGST=" + avIGST + ", avCGST="
					+ avCGST + ", avSGST=" + avSGST + ", avCess=" + avCess
					+ "]";
		}
