 ...
 */
@Entity
@Table(name = "TBL_GETIMS_STAGING_GSTR1A_B2B_HEADER")
@Data
public class SupplierImsGstr1AB2BHeaderStaggingEntity {

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "TBL_GETIMS_GSTR1A_B2B_HEADER_SEQ", allocationSize = 100)
   ...
   //	@OrderColumn(name = "ITEM_INDEX")
	...
	protected List<SupplierImsGstr1AB2BItemStaggingEntity> lineItems = new ArrayList<>();
