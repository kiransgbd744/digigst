...
@Entity
@Table(name = "TBL_GETIMS_STAGING_GSTR1A_CDNR_HEADER")
@Data
public class SupplierImsGstr1ACDNRHeaderStaggingEntity {
   ...
   //	@OrderColumn(name = "ITEM_INDEX")
	...
	protected List<SupplierImsGstr1ACDNRItemStaggingEntity> lineItems = new ArrayList<>();
