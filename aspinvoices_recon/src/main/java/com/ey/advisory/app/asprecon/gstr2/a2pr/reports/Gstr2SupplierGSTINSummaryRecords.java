...
@Slf4j
@Component("Gstr2SupplierGSTINSummaryRecords")
public class Gstr2SupplierGSTINSummaryRecords {
	...
	public void getSupplierGSTINSummaryRecords(Long configId) throws IOException {
		...
		try {
			...
			if (records != null && !records.isEmpty()) {
				...
				String supplierGSTINSummaryRecordsFilePath = null;
				...
				} if(supplierGSTINSummaryRecordsFilePath != null)
				...
				if (LOGGER.isDebugEnabled()) {
					String msg = String
							.format("Update file path for Supplier_GSTIN_Summary_Records "
									+ ":%s : ", supplierGSTINSummaryRecordsFilePath);
					LOGGER.debug(msg);
				}
			}
