...
@Entity
@Table(name = "TBL_GETIMS_STAGING_GSTR1A_ECOMA_HEADER")
@Data
public class SupplierImsGstr1AECOMAHeaderStaggingEntity {

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "TBL_GETIMS_GSTR1A_ECOMA_HEADER_SEQ", allocationSize = 100)
	...
	protected List<SupplierImsGstr1AECOMAItemStaggingEntity> lineItems = new ArrayList<>();
