...
@Entity
@Table(name = "TBL_GETIMS_GSTR1_ECOMA_HEADER")
@Data
public class SupplierImsGstr1ECOMAHeaderEntity {
	...
	protected List<SupplierImsGstr1ECOMAItemEntity> lineItems = new ArrayList<>();
