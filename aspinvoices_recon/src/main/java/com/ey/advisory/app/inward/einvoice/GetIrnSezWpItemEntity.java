...
@Data
@Entity
@Table(name = "TBL_GETIRN_SEZWP_ITEM")
public class GetIrnSezWpItemEntity {

	@Expose
	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "TBL_GETIRN_SEZWP_ITEM_SEQ", allocationSize = 100)
...
/*	@ManyToOne
	...
	protected GetIrnSezWpHeaderEntity header;*/
