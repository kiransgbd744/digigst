...
@Slf4j
@Component("Gstr2Potential1Mismatch2BPRReport")
public class Gstr2Potential1Mismatch2BPRReport {
	...
	public void getPotential2(Long configId) throws IOException {
		...
		if (LOGGER.isDebugEnabled()) {
			msg = String.format(
					"Get Recon Potential-I Report Details with configId:'%s'",
					configId.toString());
			LOGGER.debug(msg);
		}

		String reportType = "Potential-I";
		...
		if (noOfChunk != 0) {
			...
			msg = String.format(
					"Get Recon Potential-I Report Details with "
