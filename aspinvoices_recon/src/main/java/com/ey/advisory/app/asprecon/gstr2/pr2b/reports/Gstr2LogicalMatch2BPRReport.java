...
@Slf4j
@Component("Gstr2LogicalMatch2BPRReport")
public class Gstr2LogicalMatch2BPRReport {
	...
	public void getLogicalMatchReport(Long configId) throws IOException {
		...
		if (LOGGER.isDebugEnabled()) {
			msg = String.format(
					"Get Recon Logical Match Report Details with configId:'%s'",
					configId.toString());
			LOGGER.debug(msg);
		}

		String reportType = "Logical Match";
		...
		if (noOfChunk != 0) {
			...
			msg = String.format(
					"Get Recon LogicalMatchReport Details with "
