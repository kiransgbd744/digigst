...
@Data
@Entity
@Table(name = "TBL_GETIRN_EXPWOP_ITEM")
public class GetIrnExpWopItemEntity {

	@Expose
	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "TBL_GETIRN_EXPWOP_ITEM_SEQ", allocationSize = 100)
	...
	private Date precedingInvoiceDate;
	...
	private Date receiptAdviceDate;
	...
	private Date customerPoReferenceDate;
...
/*	@ManyToOne
	...
	protected GetIrnExpWopHeaderEntity header;
*/
}
