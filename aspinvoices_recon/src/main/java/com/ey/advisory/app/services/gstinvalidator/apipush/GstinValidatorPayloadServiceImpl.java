 ...
 *
 */
@Service("GstinValidatorPayloadServiceImpl")
@Slf4j
public class GstinValidatorPayloadServiceImpl implements GstinValidatorPayloadService {
	...
	public void create(String payloadId, String companyCode, String gstinCount, String pushType, String genCheckSum,
		...
		GstinValidatorPayloadEntity payload = new GstinValidatorPayloadEntity();
	...
	public void saveCPIError(String payloadId, String companyCode,
		...
		if (payloadID == null || payloadID.isEmpty()) {
			...
			GstinValidatorPayloadEntity outPayload = new GstinValidatorPayloadEntity();
