...
@Slf4j
@Component("Gstr2ConsolidatedPRRegister")
public class Gstr2ConsolidatedPRRegister {
	...
	public void getGstr2ConsolidatedPRRegister(Long configId)
		...
		if (noOfChunk != 0) {
			...
			addlReportRepo.updateAndSave(configId, "Consolidated_PR_Register");
			int j = 0;
				...
				while (j < noOfChunk) {
					...
					StoredProcedureQuery storedProc = entityManager
							.createStoredProcedureQuery(
									"USP_RECON_RPT_CONS_PR_REGISTER");
