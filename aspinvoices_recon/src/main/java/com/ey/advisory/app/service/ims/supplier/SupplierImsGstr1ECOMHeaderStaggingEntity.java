...
@Entity
@Table(name = "TBL_GETIMS_STAGING_GSTR1_ECOM_HEADER")
@Data
public class SupplierImsGstr1ECOMHeaderStaggingEntity {
   ...
   //	@OrderColumn(name = "ITEM_INDEX")
	...
	protected List<SupplierImsGstr1ECOMItemStaggingEntity> lineItems = new ArrayList<>();
