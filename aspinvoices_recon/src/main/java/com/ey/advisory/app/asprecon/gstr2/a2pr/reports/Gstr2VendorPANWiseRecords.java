...
@Slf4j
@Component("Gstr2VendorPANWiseRecords")
public class Gstr2VendorPANWiseRecords {
			...
			if (records != null && !records.isEmpty()) {
				...
				try (Writer writer = new BufferedWriter(
					...
					if (reconDataList != null && !reconDataList.isEmpty()) {
						...
						"gstr2.recon.vendor.pan.wise.header");
			    ...
			    .getProp("gstr2.recon.vendor.pan.wise.column")
						...
						<Gstr2VendorPANPeriodWiseRecordsDto> 
						mappingStrategy = new ColumnPositionMappingStrategy<>();
						mappingStrategy
								.setType(Gstr2VendorPANPeriodWiseRecordsDto.class);
						mappingStrategy.setColumnMapping(columnMappings);
						StatefulBeanToCsvBuilder<Gstr2VendorPANPeriodWiseRecordsDto> 
						builder = new StatefulBeanToCsvBuilder<>(
								writer);
						StatefulBeanToCsv<Gstr2VendorPANPeriodWiseRecordsDto> 
						beanWriter = builder
				...
				String vendorPANWiseRecordsFilePath = null;
				...
				} if(vendorPANWiseRecordsFilePath != null)
				...
				if (LOGGER.isDebugEnabled()) {
					String msg = String
							.format("Update file path for Vendor_PAN_Wise_Records "
									+ ":%s : ", vendorPANWiseRecordsFilePath);
					LOGGER.debug(msg);
				}
			}
	...
	private Gstr2VendorPANPeriodWiseRecordsDto convert(Object[] arr) {
		...
		Gstr2VendorPANPeriodWiseRecordsDto obj = 
				new Gstr2VendorPANPeriodWiseRecordsDto();
