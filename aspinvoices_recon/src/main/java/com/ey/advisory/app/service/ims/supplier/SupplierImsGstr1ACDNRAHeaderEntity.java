...
@Entity
@Table(name = "TBL_GETIMS_GSTR1A_CDNRA_HEADER")
@Data
public class SupplierImsGstr1ACDNRAHeaderEntity {
	...
	protected List<SupplierImsGstr1ACDNRAItemEntity> lineItems = new ArrayList<>();
