...
@Slf4j
@Component("Gstr2InitiateRecon2BPRFetchReportDetailsImpl")
public class Gstr2InitiateRecon2BPRFetchReportDetailsImpl
		implements Gstr2InitiateRecon2BPRFetchReportDetails {
	...
	@Autowired
	@Qualifier("Gstr2DocumentNumberMismatchII2BPRReport")
	Gstr2DocumentNumberMismatchII2BPRReport docNum2Report;

	@Autowired
	@Qualifier("Gstr2LogicalMatch2BPRReport")
	Gstr2LogicalMatch2BPRReport logicalReport;

	@Autowired
	@Qualifier("Gstr2DocNumberDocDateMismatch2BPRReport")
	Gstr2DocNumberDocDateMismatch2BPRReport docNumDocDateReport;
	
	@Autowired
	@Qualifier("Gstr2Potential2Mismatch2BPRReport")
	Gstr2Potential2Mismatch2BPRReport potential2Report;

	@Autowired
	@Qualifier("Gstr2RecipientGSTINWise2BPRRecords")
	Gstr2RecipientGSTINWise2BPRRecords recptGstnWiseReport;

	@Autowired
	@Qualifier("Gstr2RecipientGSTINPeriodWise2BPRRecords")
	Gstr2RecipientGSTINPeriodWise2BPRRecords recptGstnPeriodWiseReport;
	
	@Autowired
	@Qualifier("Gstr2RecipientGSTINPeriodWiseII2BPRRecords")
	Gstr2RecipientGSTINPeriodWiseII2BPRRecords recptGstnPeriodWiseIIReport;

	@Autowired
	@Qualifier("Gsr2ReverseChargeRegister2BPRReports")
	Gsr2ReverseChargeRegister2BPRReports revChargeRegisterReport;

	@Autowired
	@Qualifier("Gstr2ForceMatch2BPRRecords")
	Gstr2ForceMatch2BPRRecords forceMatchReport;

	@Autowired
	@Qualifier("Gstr2CdnrInvRefRegGstin2BPRRecords")
	Gstr2CdnrInvRefRegGstin2BPRRecords cdnrInvRefRegGstnReport;

	@Autowired
	@Qualifier("Gstr2CdnrInvRefRegGstinPR2BPRRecords")
	Gstr2CdnrInvRefRegGstinPR2BPRRecords cdnrInvRefRegGstnPrReport;

	@Autowired
	@Qualifier("Gstr2LockedCFSNAmended2BPRRecords")
	Gstr2LockedCFSNAmended2BPRRecords lockedCfsnAmendedReport;

	@Autowired
	@Qualifier("Gstr2TimeStamp2BReport")
	Gstr2TimeStamp2BReport timeStamp2BReport;

	@Autowired
	@Qualifier("Gstr2VendorGSTINPeriodWise2BPRRecords")
	Gstr2VendorGSTINPeriodWise2BPRRecords vendorGstnPeriodWise2BPRReport;

	@Autowired
	@Qualifier("Gstr2VendorGSTINWise2BPRRecords")
	Gstr2VendorGSTINWise2BPRRecords vendorGstnWise2BPRReport;

	@Autowired
	@Qualifier("Gstr2VendorPANWise2BPRRecords")
	Gstr2VendorPANWise2BPRRecords vendorPanWise2BPRReport;

	@Autowired
	@Qualifier("Gstr2VendorPANPeriodWise2BPRRecords")
	Gstr2VendorPANPeriodWise2BPRRecords vendorPanPeriodWise2BPRReport;

	@Autowired
	@Qualifier("Gstr2SupplierGSTINSummary2BPRRecords")
	Gstr2SupplierGSTINSummary2BPRRecords supplierGstnSummary2BPRReport;

	@Autowired
	@Qualifier("Gstr2SupplierPANSummary2BPRRecords")
	Gstr2SupplierPANSummary2BPRRecords supplierPanSummary2BPRReport;

	@Autowired
	@Qualifier("Gstr2FuzzyMatch2BPRRecords")
	Gstr2FuzzyMatch2BPRRecords fuzzyMatch2BPRReport;

	@Autowired
	@Qualifier("Gstr2SummaryCalenderPeriod2BPRRecords")
	Gstr2SummaryCalenderPeriod2BPRRecords summaryCalPeriod2BPRReport;

	@Autowired
	@Qualifier("Gstr2SummaryTaxPeriod2BPRRecords")
	Gstr2SummaryTaxPeriod2BPRRecords summaryTaxPeriod2BPRReport;

	@Autowired
	@Qualifier("Gstr2MasterVendorGSTINWise2BPRRecords")
	Gstr2MasterVendorGSTINWise2BPRRecords masterVendorGstnWise2BPRReport;

	@Autowired
	@Qualifier("Gstr2MasterVendorPANWise2BPRRecords")
	Gstr2MasterVendorPANWise2BPRRecords masterVendorPanWise2BPRReport;

	@Autowired
	@Qualifier("Gstr2Dropped2BPRRecordsReport")
	Gstr2Dropped2BPRRecordsReport dropped2BPRReport;

	@Autowired
	@Qualifier("Gstr2Consolidated2BPRRegister")
	Gstr2Consolidated2BPRRegister consolidated2BPRReport;

	@Autowired
	@Qualifier("Dropped2BRecordsReport")
	Dropped2BRecordsReport dropped2BRecordsReport;
	...
	@Autowired
	@Qualifier("Gstr2Potential1Mismatch2BPRReport")
	Gstr2Potential1Mismatch2BPRReport potential1Report;

	@Autowired
	@Qualifier("Impg2BPRReconReport")
	Impg2BPRReconReport impgReport;
	
	@Autowired
	@Qualifier("Gstr2ISDMatching2BPRReconReport")
	Gstr2ISDMatching2BPRReconReport isdReport;
	
	@Autowired
	@Qualifier("Gstr2IMSConsolidatedReconReport")
	Gstr2IMSConsolidatedReconReport imsReport;
	...
	@Override
	public void get2BPRReconReportData(Long configId, 
			List<String> addnReportList) throws IOException {
		...
		for (int i = 0; i < reportType.length; i++) {
			...
			msg = String.format("fullPath :'%s' with configId:'%s' "
					+ "of ReportType : '%s'",
					fullPath, configId.toString(), reportType[i]);
			LOGGER.debug(msg);

			Gstr2Recon2BPRAddlReportsEntity chunkDetails = addl2BPRReportRepo
			...
			if (noOfChunk != 0) {
				...
				// addl2BPRReportRepo.updateAndSave(configId, reportType[i]);
				int j = 0;
				...
				try {
					...
					String[] columnMappings = commonUtility
							...
							.split(",");
					StatefulBeanToCsv<Gstr2Recon2BPRReportDto> beanWriter = getBeanWriter(
			...
			addl2BPRReportRepo.updateIsReportProcExecuted(configId, 
							reportType[i]);
			deleteTemporaryDirectory(tempDir);
		}
		...
		try {
			...
			if (addnReportList.contains("Doc No & Doc Date Mismatch"))
				docNumDocDateReport.getDocNumDocDateMatchReport(configId);
			...
			if (addnReportList.contains("Potential-I"))
				potential1Report.getPotential2(configId);

			if (addnReportList.contains("Potential-II"))
				potential2Report.getPotential2(configId);
			
			if (addnReportList.contains("Force_Match_Records"))
				forceMatchReport.getForceMatchRecords(configId);

			if (addnReportList.contains("Recipient_GSTIN_Wise_Records"))
				recptGstnWiseReport.getRecipientGSTINWiseRecords(configId);

			if (addnReportList.contains("Recipient_GSTIN_Period_Wise_Record"))
				recptGstnPeriodWiseReport
						.getRecipientGSTINPeriodWiseRecords(configId);

			if (addnReportList.contains("Reverse_Charge_Register"))
				revChargeRegisterReport
						.getGsr2ReverseChargeRegisterReports(configId);

			if (addnReportList.contains("CRD-INV_Ref_Reg_GSTR_2B_Records"))
				cdnrInvRefRegGstnReport
						.getCdnrInvRefRegGstin2BRecords(configId);

			if (addnReportList.contains("CRD-INV_Ref_Reg_PR_Records"))
				cdnrInvRefRegGstnPrReport
						.getCdnrInvRefRegGstinPRRecords(configId);

			if (addnReportList.contains("Locked_CFS_N_Amended_Records"))
				lockedCfsnAmendedReport
						.getGstr2LockedCFSNAmendedRecords(configId);

			if (addnReportList.contains("GSTR_2B_Time_Stamp_Report"))
				timeStamp2BReport.getGstr2TimeStampReport(configId);

			if (addnReportList.contains("Vendor_GSTIN_Period_Wise_Records"))
				vendorGstnPeriodWise2BPRReport
						.getVendorGSTINPeriodWiseRecords(configId);

			if (addnReportList.contains("Vendor_GSTIN_Wise_Records"))
				vendorGstnWise2BPRReport.getVendorGSTINWiseRecords(configId);

			if (addnReportList.contains("Vendor_PAN_Wise_Records"))
				vendorPanWise2BPRReport.getVendorPANWiseRecords(configId);

			if (addnReportList.contains("Vendor_PAN_Period_Wise_Records"))
				vendorPanPeriodWise2BPRReport
						.getVendorPANPeriodWiseRecords(configId);

			if (addnReportList.contains("Supplier_GSTIN_Summary_Records"))
				supplierGstnSummary2BPRReport
						.getSupplierGSTINSummaryRecords(configId);

			if (addnReportList.contains("Supplier_PAN_Summary_Records"))
				supplierPanSummary2BPRReport
						.getSupplierPANSummaryRecords(configId);

			/*
			 * if (addnReportList.contains("Fuzzy_Match_Records"))
			 * fuzzyMatch2BPRReport.getFuzzyMatchRecords(configId);
			 */

			if (addnReportList.contains("Summary_CalendarPeriod_Records"))
				summaryCalPeriod2BPRReport
						.getSummaryCalendarPeriodRecords(configId);

			if (addnReportList.contains("Summary_TaxPeriod_Record"))
				summaryTaxPeriod2BPRReport.getSummaryTaxPeriodRecords(configId);

			// Vendor Gstin Wise Detailed Report

			if (addnReportList.contains("Vendor_Records_GSTIN"))
				masterVendorGstnWise2BPRReport
						.getMasterVendorGSTINWiseRecords(configId);

			// Vendor Pan Wise Detailed Report

			if (addnReportList.contains("Vendor_Records_PAN"))
				masterVendorPanWise2BPRReport
						.getMasterVendorPANWiseRecords(configId);

			if (addnReportList.contains("Dropped_PR_Records_Report"))
				dropped2BPRReport.getGstr2DroppedPRRecordsReport(configId);

			if (addnReportList.contains("Consolidated_PR_Register"))
				consolidated2BPRReport.getGstr2ConsolidatedPRRegister(configId);

			if (addnReportList.contains("Dropped 2B Records Report"))
				dropped2BRecordsReport
						.getGstr2Dropped2A6ARecordsReport(configId);
			...
			if(addnReportList.contains("ISD Matching Report"))
				isdReport.getGstr2IsdReconReport(configId);
			
			//IMS Report
			if(addnReportList.contains("Consolidated PR 2B Report IMS"))
				imsReport.getImsConsolidatedReconReport(configId);
			
			if (addnReportList.contains("Recipient_GSTIN_Period_Wise_Record_II"))
				recptGstnPeriodWiseIIReport
						.getRecipientGSTINPeriodWiseIIRecords(configId);
			  
			if (LOGGER.isDebugEnabled()) {
		            String msg1 = String.format("Report List %s", addnReportList);
		            LOGGER.debug(msg1);
		        }
			if (LOGGER.isDebugEnabled()) {
				msg = String.format(
			...
			LOGGER.error("Exception while generating additional reports {}",
					ex);
			updateReconConfigStatus(
	...
	private StatefulBeanToCsv<Gstr2Recon2BPRReportDto> getBeanWriter(
		...
		ColumnPositionMappingStrategy<Gstr2Recon2BPRReportDto> mappingStrategy = new ColumnPositionMappingStrategy<>();
		mappingStrategy.setType(Gstr2Recon2BPRReportDto.class);
		mappingStrategy.setColumnMapping(columnMappings);
		StatefulBeanToCsvBuilder<Gstr2Recon2BPRReportDto> builder = new StatefulBeanToCsvBuilder<>(
				writer);
	...
	public static void main(String[] args) {
		String[] reportType = { "Exact Match",
				"Match With Tolerance", "Value Mismatch", "POS Mismatch",
				"Doc Date Mismatch", "Doc Type Mismatch", "Doc No Mismatch I",
				"Multi-Mismatch", "Addition in PR", "Addition in 2B",
				"Consolidated PR 2B Report" };
		
		System.out.println("reportType1"+ reportType[0]);
		
		reportType = Arrays.asList("Consolidated PR 2B Report")
				.toArray(new String[0]);

		System.out.println("reportType2"+ reportType[1]);
	}
}
