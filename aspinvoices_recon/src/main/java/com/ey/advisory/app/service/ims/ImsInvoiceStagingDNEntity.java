 ...
 */
@Entity
@Table(name = "TBL_GETIMS_INVOICE_STAGGING_DN")
@Data
public class ImsInvoiceStagingDNEntity {

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "TBL_GETIMS_INVOICE_HEADER_DN_SEQ", allocationSize = 100)
