...
@Entity
@Table(name = "TBL_GETIMS_STAGING_GSTR1_ECOMA_HEADER")
@Data
public class SupplierImsGstr1ECOMAHeaderStaggingEntity {

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "TBL_GETIMS_GSTR1_ECOMA_HEADER_SEQ", allocationSize = 100)
   ...
   //	@OrderColumn(name = "ITEM_INDEX")
	...
	protected List<SupplierImsGstr1ECOMAItemStaggingEntity> lineItems = new ArrayList<>();
