...
@Slf4j
@Component("Gstr2ReconResponseErrorDaoImpl")
public class Gstr2ReconResponseErrorDaoImpl
		implements Gstr2ReconResponseErrorDao {
	...
	public String getErrorData(Long batchId) throws IOException {
		...
		StoredProcedureQuery storedProc = entityManager
				.createStoredProcedureQuery("USP_RECON_RPT_FM3B_ERR");
		...
		if (records != null && !records.isEmpty()) {
			...
			if (LOGGER.isDebugEnabled()) {
				String msg = String.format("Uploaded file Name :'%s'",
						uploadedDocName);
				LOGGER.debug(msg);
			}
	...
	private GSTR2AAutoReconErrInfoDTO convertRowsToDto(Object[] arr,
		...
		if ("CR".equalsIgnoreCase(docTypePR) || "C".equalsIgnoreCase(docTypePR)
				|| "RCR".equalsIgnoreCase(docTypePR)
				|| "CR".equalsIgnoreCase(docType2A)
				|| "C".equalsIgnoreCase(docType2A)
				|| "RCR".equalsIgnoreCase(docType2A)) {
