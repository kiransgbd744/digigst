...
@Slf4j
@Component("Gstr2RecipientGSTINWiseRecords")
public class Gstr2RecipientGSTINWiseRecords {
	...
	public void getRecipientGSTINWiseRecords(Long configId)
			throws IOException {
		...
		try {
			...
			StoredProcedureQuery storedProc = entityManager
					.createStoredProcedureQuery("USP_RECON_RPT_RGSTIN_DOCTYPE");
			...
			if (records != null && !records.isEmpty()) {
				...
				fullPath = tempDir.getAbsolutePath() + File.separator
						+ reportType + ".csv";
				List<Gstr2RecipientGSTINPeriodWiseRecordDto> reconDataList =
						new ArrayList<>();
				...
				try (Writer writer = new BufferedWriter(
					...
					if (reconDataList != null && !reconDataList.isEmpty()) {
						...
						<Gstr2RecipientGSTINPeriodWiseRecordDto> 
						...
						<Gstr2RecipientGSTINPeriodWiseRecordDto> builder 
						= new StatefulBeanToCsvBuilder<>(
								writer);
						StatefulBeanToCsv
						<Gstr2RecipientGSTINPeriodWiseRecordDto> beanWriter = 
								builder
				...
				String gstinWiseRecordsFilePath = null;
				if (tempDir.list().length > 0) {
					zipFileName = combineAndZipCsvFiles.zipfolder(configId, tempDir, reportType);

					File zipFile = new File(tempDir, zipFileName);

					gstinWiseRecordsFilePath = DocumentUtility.uploadZipFile(zipFile,
							"Gstr2ReconReports");

				}
				if(gstinWiseRecordsFilePath != null)
				addlReportRepo.updateReconFilePath(gstinWiseRecordsFilePath, configId,
						"Recipient_GSTIN_Wise_Records");
				if (LOGGER.isDebugEnabled()) {
					String msg = String.format(
							"Update file path for Recipient_GSTIN_Wise_Records "
							+ ":%s : ", gstinWiseRecordsFilePath);
					LOGGER.debug(msg);
				}
	...
	private Gstr2RecipientGSTINPeriodWiseRecordDto convert(Object[] arr) {
		...
		Gstr2RecipientGSTINPeriodWiseRecordDto obj = 
				new Gstr2RecipientGSTINPeriodWiseRecordDto();
		...
		obj.setExactMatchIGST((arr[11] != null) ? arr[11].toString() : null);
		obj.setExactMatchCGST((arr[12] != null) ? arr[12].toString() : null);
		obj.setExactMatchSGST((arr[13] != null) ? arr[13].toString() : null);
		obj.setExactMatchCESS((arr[14] != null) ? arr[14].toString() : null);
		obj.setMatchWithTolerenceCount((arr[15] != null) ? arr[15].toString() : null);
		obj.setMatchWithTolerenceTaxable((arr[16] != null) ? arr[16].toString() : null);
		obj.setMatchWithTolerenceIGST((arr[17] != null) ? arr[17].toString() : null);
		obj.setMatchWithTolerenceCGST((arr[18] != null) ? arr[18].toString() : null);
		obj.setMatchWithTolerenceSGST((arr[19] != null) ? arr[19].toString() : null);
		obj.setMatchWithTolerenceCESS((arr[20] != null) ? arr[20].toString() : null);
		obj.setValueMismatchCount((arr[21] != null) ? arr[21].toString() : null);
		obj.setValueMismatchTaxable((arr[22] != null) ? arr[22].toString() : null);
		obj.setValueMismatchIGST((arr[23] != null) ? arr[23].toString() : null);
		obj.setValueMismatchCGST((arr[24] != null) ? arr[24].toString() : null);
		obj.setValueMismatchSGST((arr[25] != null) ? arr[25].toString() : null);
		obj.setValueMismatchCESS((arr[26] != null) ? arr[26].toString() : null);
		obj.setPosMismatchCount((arr[27] != null) ? arr[27].toString() : null);
		obj.setPosMismatchTaxable((arr[28] != null) ? arr[28].toString() : null);
		obj.setPosMismatchIGST((arr[29] != null) ? arr[29].toString() : null);
		obj.setPosMismatchCGST((arr[30] != null) ? arr[30].toString() : null);
		obj.setPosMismatchSGST((arr[31] != null) ? arr[31].toString() : null);
		obj.setPosMismatchCESS((arr[32] != null) ? arr[32].toString() : null);
		...
		obj.setMultiMismatchCount((arr[51] != null) ? arr[51].toString() : null);
		obj.setMultiMismatchTaxable((arr[52] != null) ? arr[52].toString() : null);
		obj.setMultiMismatchIGST((arr[53] != null) ? arr[53].toString() : null);
		obj.setMultiMismatchCGST((arr[54] != null) ? arr[54].toString() : null);
		obj.setMultiMismatchSGST((arr[55] != null) ? arr[55].toString() : null);
		obj.setMultiMismatchCESS((arr[56] != null) ? arr[56].toString() : null);
		...
		obj.setAdditionTaxable2A((arr[82] != null) ? arr[82].toString() : null);
		obj.setAdditionIGST2A((arr[83] != null) ? arr[83].toString() : null);
		obj.setAdditionCGST2A((arr[84] != null) ? arr[84].toString() : null);
		obj.setAdditionSGST2A((arr[85] != null) ? arr[85].toString() : null);
		obj.setAdditionCESS2A((arr[86] != null) ? arr[86].toString() : null);
		obj.setAdditionCountPR((arr[87] != null) ? arr[87].toString() : null);
		obj.setAdditionTaxablePR((arr[88] != null) ? arr[88].toString() : null);
		obj.setAdditionIGSTPR((arr[89] != null) ? arr[89].toString() : null);
		obj.setAdditionCGSTPR((arr[90] != null) ? arr[90].toString() : null);
		obj.setAdditionSGSTPR((arr[91] != null) ? arr[91].toString() : null);
		obj.setAdditionCESSPR((arr[92] != null) ? arr[92].toString() : null);
	...
	private static File createTempDir(Long configId) throws IOException {
		...
		String tempFolderPrefix = "Recipient_GSTIN_Wise_Records" + "_" + configId;
