...
@Service("GstNoticesCommonFailureHandler")
@Slf4j
public class GstNoticesCommonFailureHandler implements FailureHandler {

	@Autowired
	@Qualifier("anx1GetBatchUtil")
	private Anx1GetBatchUtil batchUtil;

	private static final List<String> ERROR_CODES = ImmutableList.of("NOTC_010");
