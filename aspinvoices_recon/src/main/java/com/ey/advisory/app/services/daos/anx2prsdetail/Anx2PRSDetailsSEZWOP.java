...
@Component("Anx2PRSDetailsSEZWOP")
public class Anx2PRSDetailsSEZWOP implements Anx2PRSDetailsSection {
	...
	public Anx2PRSDetailHeaderDto getAnx2PRSummaryDetail(
		...
		if (entityResponse.size() > 0) {
			b2b = entityResponse.stream()
					.filter(p -> GSTConstants.SEZWOP
							.equalsIgnoreCase(p.getTaxDocType()))
