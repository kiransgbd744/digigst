 ...
 */
@Entity
@Table(name = "TBL_GETIMS_INVOICE_STAGGING_B2BA")
@Data
public class ImsInvoiceStagingB2BAEntity {
	
	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "TBL_GETIMS_INVOICE_HEADER_B2BA_SEQ", allocationSize = 100)
