...
@Slf4j
@Component("Gstr2VendorGSTINPeriodWiseRecords")
public class Gstr2VendorGSTINPeriodWiseRecords {
		...
		try {
			...
			StoredProcedureQuery storedProc = entityManager
					.createStoredProcedureQuery(
							"USP_RECON_RPT_VENDOR_GSTIN_PERIOD");
			...
			if (records != null && !records.isEmpty()) {
				...
				String vendorGSTINPeriodWiseRecordsFilePath = null;
				...
				if (vendorGSTINPeriodWiseRecordsFilePath != null)
				...
				if (LOGGER.isDebugEnabled()) {
					String msg = String.format(
							"Update file path for Vendor_GSTIN_Period_Wise_Records "
									+ ":%s : ",
							vendorGSTINPeriodWiseRecordsFilePath);
					LOGGER.debug(msg);
				}
