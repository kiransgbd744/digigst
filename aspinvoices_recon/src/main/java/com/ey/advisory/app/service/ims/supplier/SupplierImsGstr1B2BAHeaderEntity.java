 ...
 */
@Entity
@Table(name = "TBL_GETIMS_GSTR1_B2BA_HEADER")
@Data
public class SupplierImsGstr1B2BAHeaderEntity {
 ...
 /*   @Column(name = "IRN_GEN_DATE")
	...
	protected List<SupplierImsGstr1B2BAItemEntity> lineItems = new ArrayList<>();
