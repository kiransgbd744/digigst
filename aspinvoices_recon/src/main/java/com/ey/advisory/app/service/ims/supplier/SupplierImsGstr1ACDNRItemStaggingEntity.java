...
@Entity
@Table(name = "TBL_GETIMS_STAGING_GSTR1A_CDNR_ITEM")
@Data
public class SupplierImsGstr1ACDNRItemStaggingEntity {
	...
	protected SupplierImsGstr1ACDNRHeaderStaggingEntity header;
