...
@Repository("GlReconGstinRepository")
@Transactional(value = "clientTransactionManager", 
propagation = Propagation.REQUIRED)
public interface GlReconGstinRepository
		extends JpaRepository<GlReconGstinEntity, Long>,
		JpaSpecificationExecutor<GlReconGstinEntity> {
	
	
	@Query("Select gstin from GlReconGstinEntity configEntity where"
			+ " configId =:configId")
