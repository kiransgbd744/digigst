...
@Entity
@Table(name = "TBL_RECON_RPT_2BPR_DWNLD")
@Setter
@Getter
@ToString
@AllArgsConstructor
...
public class Gstr2Recon2BPRAddlReportsEntity implements Serializable {
	...
	public Gstr2Recon2BPRAddlReportsEntity( String reportType, Long configId, 
