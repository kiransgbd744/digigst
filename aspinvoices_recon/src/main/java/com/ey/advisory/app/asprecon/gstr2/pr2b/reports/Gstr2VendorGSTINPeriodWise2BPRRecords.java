...
@Slf4j
@Component("Gstr2VendorGSTINPeriodWise2BPRRecords")
public class Gstr2VendorGSTINPeriodWise2BPRRecords {
		...
		try {
			...
			StoredProcedureQuery storedProc = entityManager
					.createStoredProcedureQuery(
							"USP_RECON_RPT_2B_VENDOR_GSTIN_PERIOD");
			...
			if (records != null && !records.isEmpty()) {
				...
				try (Writer writer = new BufferedWriter(
					...
					if (reconDataList != null && !reconDataList.isEmpty()) {
						...
						String invoiceHeadersTemplate = commonUtility.getProp(
								"gstr2bpr.recon.vendor.gstin.period.wise.header");
				...
				if (uploadedDocName != null) {
					...
					commonService.saveReportChunks(chunkDetails.getId(),
							"Vendor_GSTIN_Period_Wise_Records_1",
	...
	private Gstr2VendorGSTINPeriodWiseRecordsDto convert(Object[] arr) {
		...
		if (docType != null && (docType.equalsIgnoreCase("CR")
			...
			obj.setDocNoDocDateMisMatchTaxable(CheckForNegativeValue(arr[95]));
			obj.setDocNoDocDateMisMatchIGST(CheckForNegativeValue(arr[96]));
			obj.setDocNoDocDateMisMatchCGST(CheckForNegativeValue(arr[97]));
			obj.setDocNoDocDateMisMatchSGST(CheckForNegativeValue(arr[98]));
			obj.setDocNoDocDateMisMatchCESS(CheckForNegativeValue(arr[99]));
			obj.setForceGSTR3BMatchTaxable(CheckForNegativeValue(arr[101]));
			obj.setForceGSTR3BMatchIGST(CheckForNegativeValue(arr[102]));
			obj.setForceGSTR3BMatchCGST(CheckForNegativeValue(arr[103]));
			obj.setForceGSTR3BMatchSGST(CheckForNegativeValue(arr[104]));
			obj.setForceGSTR3BMatchCESS(CheckForNegativeValue(arr[105]));
		} else {
		...
		obj.setDocNoDocDateMisMatchCount((arr[94] != null) ? arr[94].toString() : null);
