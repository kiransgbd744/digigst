...
@Service("GetImsInvoicesJobHandlerImpl")
@Slf4j
public class GetImsInvoicesJobHandlerImpl implements GetImsInvoicesJobHandler {
	...
	@Autowired
	@Qualifier("GetImsInvoicesDataAtGstnImpl")
	private Gstr2aDataAtGstn gstr2aDataAtGstn;

	@Override
	public void getImsInvoicesCall(String jsonReq, String groupCode) {
