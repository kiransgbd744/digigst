...
@Entity
@Table(name = "TBL_GETIMS_GSTR1A_ECOM_HEADER")
@Data
public class SupplierImsGstr1AECOMHeaderEntity {
	...
	protected List<SupplierImsGstr1AECOMItemEntity> lineItems = new ArrayList<>();
