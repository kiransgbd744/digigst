...
@Data
@Entity
@Table(name = "TBL_GETIRN_SEZWOP_HEADER")
public class GetIrnSezWopHeaderEntity {

	@Expose
	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "TBL_GETIRN_SEZWOP_HEADER_SEQ", allocationSize = 100)
	...
	protected List<GetIrnSezWopItemEntity> lineItems = new ArrayList<>();*/
