...
@Entity
@Table(name = "TBL_GETIMS_STAGING_GSTR1A_ECOM_HEADER")
@Data
public class SupplierImsGstr1AECOMHeaderStaggingEntity {

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "TBL_GETIMS_GSTR1A_ECOM_HEADER_SEQ", allocationSize = 100)
	...
	protected List<SupplierImsGstr1AECOMItemStaggingEntity> lineItems = new ArrayList<>();
