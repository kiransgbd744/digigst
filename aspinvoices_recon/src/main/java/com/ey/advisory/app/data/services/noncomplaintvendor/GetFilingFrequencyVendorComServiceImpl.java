...
@Service("GetFilingFrequencyVendorComServiceImpl")
@Slf4j
public class GetFilingFrequencyVendorComServiceImpl
		implements GetFilingFrequencyVendorComService {
	...
	@Override
	public void getVendorFilingFrequency(List<String> vendorGstins,
			String financialYear, String complianceType) {
		try {
			...
			Set<String> requiredGetGstinList = getRequiredGstinList(
					vendorGstins, financialYear, q1FilingGstinList,
					q2FilingGstinList, q3FilingGstinList, q4FilingGstinList);
			if (LOGGER.isDebugEnabled()) {
