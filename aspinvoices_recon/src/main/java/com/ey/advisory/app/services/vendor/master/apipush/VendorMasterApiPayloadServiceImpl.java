 ...
 *
 */
@Service("VendorMasterApiPayloadServiceImpl")
@Slf4j
public class VendorMasterApiPayloadServiceImpl
		implements VendorMasterApiPayloadService {
	...
	@Override
	public void create(String payloadId, String gstinCount, String pushType,
			String genCheckSum, String category, String apiStatus,
			String checkSum, String jsonString) {
		...
		VendorMasterApiPayloadEntity payload = new VendorMasterApiPayloadEntity();
	...
	public void saveCPIError(String payloadId, String companyCode,
		...
		if (payloadID == null || payloadID.isEmpty()) {
			...
			VendorMasterApiPayloadEntity outPayload = new VendorMasterApiPayloadEntity();
