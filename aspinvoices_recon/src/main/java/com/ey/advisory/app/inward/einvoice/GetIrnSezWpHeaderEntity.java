...
@Data
@Entity
@Table(name = "TBL_GETIRN_SEZWP_HEADER")
public class GetIrnSezWpHeaderEntity {

	@Expose
	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "TBL_GETIRN_SEZWP_HEADER_SEQ", allocationSize = 100)
...
/*	@OneToMany(mappedBy = "header")
	...
	protected List<GetIrnSezWpItemEntity> lineItems = new ArrayList<>();
*/
}
