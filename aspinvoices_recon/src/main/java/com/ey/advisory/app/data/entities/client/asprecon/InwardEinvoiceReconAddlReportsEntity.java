...
@Entity
@Table(name = "TBL_RECON_RPT_EINVPR_DWNLD")
@Setter
@Getter
@ToString
@AllArgsConstructor
...
public class InwardEinvoiceReconAddlReportsEntity implements Serializable {
	...
	public InwardEinvoiceReconAddlReportsEntity( String reportType, Long configId, 
			Boolean flag) {
		super();
