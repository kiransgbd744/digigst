...
@Slf4j
@Component("Gstr2DocNumberDocDateMismatch2BPRReport")
public class Gstr2DocNumberDocDateMismatch2BPRReport {
	...
	public void getDocNumDocDateMatchReport(Long configId) throws IOException {
		...
		if (LOGGER.isDebugEnabled()) {
			msg = String.format(
					"Get Recon Doc No & Doc Date Mismatch Report Details with configId:'%s'",
					configId.toString());
			LOGGER.debug(msg);
		}

		String reportType = "Doc No & Doc Date Mismatch";
		...
		if (noOfChunk != 0) {
			...
			msg = String.format(
					"Get Recon Doc No Mismatch II Report Details with "
