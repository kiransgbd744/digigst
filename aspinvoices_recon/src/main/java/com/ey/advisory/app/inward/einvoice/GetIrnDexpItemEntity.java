...
@Data
@Entity
@Table(name = "TBL_GETIRN_DEXP_ITEM")
public class GetIrnDexpItemEntity {

	@Expose
	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "TBL_GETIRN_DEXP_ITEM_SEQ", allocationSize = 100)
	...
	protected GetIrnDexpHeaderEntity header;*/
