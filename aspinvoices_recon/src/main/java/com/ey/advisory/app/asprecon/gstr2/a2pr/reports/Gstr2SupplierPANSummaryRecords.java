...
@Slf4j
@Component("Gstr2SupplierPANSummaryRecords")
public class Gstr2SupplierPANSummaryRecords {
	...
	public void getSupplierPANSummaryRecords(Long configId) throws IOException {
		...
		try {
			...
			if (records != null && !records.isEmpty()) {
				...
				String supplierPanSummaryRecordsFilePath = null;
				...
				} if(supplierPanSummaryRecordsFilePath != null)
				...
				if (LOGGER.isDebugEnabled()) {
					String msg = String
							.format("Update file path for Supplier_PAN_Summary_Records "
									+ ":%s : ", supplierPanSummaryRecordsFilePath);
					LOGGER.debug(msg);
				}
			}
