 ...
 */
@Slf4j
@Component("Gstr2MasterVendorGSTINWiseRecords")
public class Gstr2MasterVendorGSTINWiseRecords {
	...
	public void getMasterVendorGSTINWiseRecords(Long configId)
			throws IOException {
		...
		String reportType = "Vendor GSTIN Wise Detailed Report";

		tempDir = createTempDir(configId);

		List<String> gstinList = findGstins(configId);

		String[] arr = new String[gstinList.size()];
		arr = gstinList.toArray(arr);
			...
			try {
				...
				StoredProcedureQuery storedProc = entityManager
						.createStoredProcedureQuery(
								"USP_RECON_RPT_MASTER_VENDOR_GSTIN");
				...
				storedProc.setParameter("P_VENDOR_GSTIN", arr[i]);
		...
		String masterVandorGstinfilPath = null;
		if (tempDir.list().length > 0) {
			...
			masterVandorGstinfilPath = DocumentUtility.uploadZipFile(zipFile,
					"Gstr2ReconReports");

		}
		if (masterVandorGstinfilPath != null)
			addlReportRepo.updateReconFilePath(masterVandorGstinfilPath,
					configId, "Vendor_Records_GSTIN");
		if (LOGGER.isDebugEnabled()) {
			String msg = String.format(
					"Update file path for Vendor_Records_GSTIN " + ":%s : ",
					masterVandorGstinfilPath);
			LOGGER.debug(msg);
		}
	...
	private Gstr2InitiateReconReportDto convert(Object[] arr) {
		...
		obj.setOrgDocNumberPR((arr[43] != null) ? arr[43].toString() : null);
		obj.setOrgDocNumber2A((arr[44] != null) ? arr[44].toString() : null);
		...
		// newlogic
		obj.setMatchReason((arr[154] != null) ? arr[154].toString() : null);
		obj.setReportCategory((arr[155] != null) ? arr[155].toString() : null);
		obj.setSupplierTradeName2A(
				(arr[156] != null) ? arr[156].toString() : null);
		obj.setBoeReferenceDate(
				(arr[157] != null) ? arr[157].toString() : null);
		obj.setBoeAmended((arr[158] != null) ? arr[158].toString() : null);
		obj.setPortCode2A((arr[159] != null) ? arr[159].toString() : null);
		obj.setBillOfEntry2A((arr[160] != null) ? arr[160].toString() : null);
		obj.setBillOfEntryDate2A(
				(arr[161] != null) ? arr[161].toString() : null);
		obj.setTaxPeriodforGSTR3B(
				(arr[162] != null) ? "`".concat(arr[162].toString()) : null);
		obj.setGSTR1FilingStatus((arr[163] != null) ? arr[163].toString() : null);
		obj.setGSTR1FilingDate((arr[164] != null) ? arr[164].toString() : null);
		obj.setGSTR1FilingPeriod(
				(arr[165] != null) ? "`".concat(arr[165].toString()) : null);
		obj.setGSTR3BFilingStatus(
				(arr[166] != null) ? arr[166].toString() : null);
		
		// Suggested Response
		if ((arr[167] != null && (!arr[167].toString().isEmpty())
				&& (arr[167].toString().matches("[0-9]+")))) {

			obj.setSuggestedFMResponse(arr[167].toString().length() == 5
					? "`".concat(("0").concat(arr[167].toString()))
					: "`".concat((arr[167].toString())));
		} else {
		...
		obj.setIrn2A((arr[169] != null) ? arr[169].toString() : null);
		obj.setIrnPR((arr[170] != null) ? arr[170].toString() : null);
		obj.setIrnDate2A((arr[171] != null) ? arr[171].toString() : null);
		obj.setIrnDatePR((arr[172] != null) ? arr[172].toString() : null);

		// 2B data in 2A
		obj.setTaxPeriod2B(
				(arr[173] != null) ? "`".concat(arr[173].toString()) : null);
		...
		obj.setSourceType((arr[176] != null) ? arr[176].toString() : null);
		obj.setGenerationDate2B(
				(arr[177] != null) ? "`".concat(arr[177].toString()) : null);
	...
	private static File createTempDir(Long configId) throws IOException {
		...
		String tempFolderPrefix = "Vendor_Records_GSTIN" + "_" + configId;
		return Files.createTempDirectory(tempFolderPrefix).toFile();
	}

	private List<String> findGstins(Long configId) {

		String queryString = "SELECT DISTINCT "
				+ " IFNULL(A2_SUPPLIER_GSTIN,PR_SUPPLIER_GSTIN) "
				+ " AS VENDOR_GSTIN FROM  TBL_LINK_2A_PR WHERE "
				+ " RECON_REPORT_CONFIG_ID=:configId AND "
				+ " REPORT_TYPE_ID BETWEEN 1 AND 14";
