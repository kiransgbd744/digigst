...
@Setter
@ToString
public class CashLedgersDetailsDto {
	...
	private CashLedgerOpenCloseBalDto openBal;
	
	@Expose
	@SerializedName(value = "cl_bal")
	private CashLedgerOpenCloseBalDto closenBal;
	
	@Expose
	@SerializedName(value = "tr")
	private List<TransactionTypeBalDto> transTypeBalDto;
