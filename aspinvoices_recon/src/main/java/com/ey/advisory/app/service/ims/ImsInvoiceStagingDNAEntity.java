 ...
 */
@Entity
@Table(name = "TBL_GETIMS_INVOICE_STAGGING_DNA")
@Data
public class ImsInvoiceStagingDNAEntity {
	
	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "TBL_GETIMS_INVOICE_HEADER_DNA_SEQ", allocationSize = 100)
