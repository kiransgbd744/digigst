...
@Slf4j
@Component("Gstr2DocumentNumberMismatchII2BPRReport")
public class Gstr2DocumentNumberMismatchII2BPRReport {
	...
	public void getDocNum2MatchReport(Long configId) throws IOException {
		...
		if (LOGGER.isDebugEnabled()) {
			msg = String.format(
					"Get Recon Doc No Mismatch II Report Details with configId:'%s'",
					configId.toString());
			LOGGER.debug(msg);
		}

		String reportType = "Doc No Mismatch II";
