 ...
 */
@Slf4j
@Component("Gstr2CdnrInvRefRegGstinPRRecords")
public class Gstr2CdnrInvRefRegGstinPRRecords {
	...
	public void getCdnrInvRefRegGstinPRRecords(Long configId)
		...
		try {
			...
			StoredProcedureQuery storedProc = entityManager
					.createStoredProcedureQuery("USP_RECON_RPT_CDNRINVPR");
	...
	private Gstr2CdnrInvRefRegGstinPRDto convert(Object[] arr) {
		...
		obj.setDocTypeCR((arr[12] != null) ? arr[12].toString() : null);
		obj.setDocTypeINV((arr[13] != null) ? arr[13].toString() : null);
		obj.setDocNoCR(
		...
		obj.setTaxableValueCR((arr[20] != null) ? (arr[20].toString()) : null);
		obj.setTaxableValueINV((arr[21] != null) ? (arr[21].toString()) : null);
		...
		obj.setInvoiceValueCR((arr[30] != null) ? (arr[30].toString()) : null);
		obj.setInvoiceValueINV((arr[31] != null) ? (arr[31].toString()) : null);
		...
		obj.setAvailableIGSTCR((arr[41] != null) ? (arr[41].toString()) : null);
		obj.setAvailableIGSTINV(
				(arr[42] != null) ? (arr[42].toString()) : null);
		obj.setAvailableCGSTCR((arr[43] != null) ? (arr[43].toString()) : null);
		obj.setAvailableCGSTINV(
				(arr[44] != null) ? (arr[44].toString()) : null);
		obj.setAvailableSGSTCR((arr[45] != null) ? (arr[45].toString()) : null);
		obj.setAvailableSGSTINV(
				(arr[46] != null) ? (arr[46].toString()) : null);
		obj.setAvailableCESSCR((arr[47] != null) ? (arr[47].toString()) : null);
