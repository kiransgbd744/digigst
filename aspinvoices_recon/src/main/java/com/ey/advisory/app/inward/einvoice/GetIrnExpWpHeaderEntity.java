...
@Data
@Entity
@Table(name = "TBL_GETIRN_EXPWP_HEADER")
public class GetIrnExpWpHeaderEntity {

	@Expose
	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "TBL_GETIRN_EXPWP_HEADER_SEQ", allocationSize = 100)
	...
	protected List<GetIrnExpWpItemEntity> lineItems = new ArrayList<>();*/
