...
@Slf4j
@Component("Gstr2MasterVendorPANWiseRecords")
public class Gstr2MasterVendorPANWiseRecords {
	...
	public void getMasterVendorPANWiseRecords(Long configId)
			...
			try {
				...
				StoredProcedureQuery storedProc = entityManager
						.createStoredProcedureQuery(
								"USP_RECON_RPT_MASTER_VENDOR_PAN");
					...
					try (Writer writer = new BufferedWriter(
						...
						if (reconDataList != null && !reconDataList.isEmpty()) {
							...
							String invoiceHeadersTemplate = commonUtility
									.getProp("gstr2.recon.master.pan.header");
							writer.append(invoiceHeadersTemplate);
							String[] columnMappings = commonUtility
									.getProp("gstr2.recon.master.pan.column")
									.split(",");
		...
		String vendorMasterRecordsFilePath = null;
		...
		if (vendorMasterRecordsFilePath != null)
	...
	private Gstr2MasterPanDto convert(Object[] arr) {
		...
		obj.setTaxPeriodforGSTR3B(
				(arr[164] != null) ? "`".concat(arr[164].toString()) : null);
		obj.setGSTR1FilingStatus((arr[165] != null) ? arr[165].toString() : null);
		...
		// 2B data in 2A
		obj.setTaxPeriod2B(
				(arr[175] != null) ? "`".concat(arr[175].toString()) : null);
		...
		obj.setSourceType((arr[178] != null) ? arr[178].toString() : null);
		obj.setGenerationDate2B(
				(arr[179] != null) ? "`".concat(arr[179].toString()) : null);
		obj.setGenerationDate2A(
				(arr[180] != null) ? "`".concat(arr[180].toString()) : null);
	...
	private List<String> findPan(Long configId) {
		...
		String queryString = "SELECT DISTINCT "
				+ " IFNULL(SUBSTRING(A2_SUPPLIER_GSTIN,3,10), "
				+ " SUBSTRING(PR_SUPPLIER_GSTIN,3,10)) AS VENDOR_PAN "
				+ " FROM TBL_LINK_2A_PR WHERE RECON_REPORT_CONFIG_ID=:configId"
