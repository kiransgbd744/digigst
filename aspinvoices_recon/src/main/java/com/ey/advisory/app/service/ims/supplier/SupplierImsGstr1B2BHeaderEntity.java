 ...
 */
@Entity
@Table(name = "TBL_GETIMS_GSTR1_B2B_HEADER")
@Data
public class SupplierImsGstr1B2BHeaderEntity {
	...
	protected List<SupplierImsGstr1B2BItemEntity> lineItems = new ArrayList<>();
