...
@Entity
@Table(name = "TBL_GETIMS_GSTR1A_ECOMA_HEADER")
@Data
public class SupplierImsGstr1AECOMAHeaderEntity {
	...
	protected List<SupplierImsGstr1AECOMAItemEntity> lineItems = new ArrayList<>();
