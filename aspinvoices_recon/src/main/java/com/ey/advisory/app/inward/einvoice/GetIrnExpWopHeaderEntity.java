...
@Data
@Entity
@Table(name = "TBL_GETIRN_EXPWOP_HEADER")
public class GetIrnExpWopHeaderEntity {

	@Expose
	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "TBL_GETIRN_EXPWOP_HEADER_SEQ", allocationSize = 100)
...
/*
	...
	protected List<GetIrnExpWopItemEntity> lineItems = new ArrayList<>();
*/
}
