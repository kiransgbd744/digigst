 ...
 */
@Entity
@Table(name = "TBL_GETIMS_GSTR1A_B2B_HEADER")
@Data
public class SupplierImsGstr1AB2BHeaderEntity {
	...
	protected List<SupplierImsGstr1AB2BItemEntity> lineItems = new ArrayList<>();
