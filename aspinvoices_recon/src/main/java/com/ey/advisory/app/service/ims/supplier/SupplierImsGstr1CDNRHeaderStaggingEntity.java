...
@Entity
@Table(name = "TBL_GETIMS_STAGING_GSTR1_CDNR_HEADER")
@Data
public class SupplierImsGstr1CDNRHeaderStaggingEntity {

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "TBL_GETIMS_GSTR1_CDNR_HEADER_SEQ", allocationSize = 100)
   ...
   //	@OrderColumn(name = "ITEM_INDEX")
	...
	protected List<SupplierImsGstr1CDNRItemStaggingEntity> lineItems = new ArrayList<>();
