...
@Slf4j
@Component("Gstr2APAndNonAPVendorPANPeriodWiseRecords")
public class Gstr2APAndNonAPVendorPANPeriodWiseRecords {
		...
		try {
			...
			StoredProcedureQuery storedProc = entityManager
					.createStoredProcedureQuery(
							"USP_AUTO_2APR_RPT_VENDOR_PAN_PERIOD");
			...
			if (records != null && !records.isEmpty()) {
				...
				if (uploadedDocName != null)
					/*addlReportRepo.updateReconFilePath(
							vendorPANPeriodWiseRecordsFilePath, configId,
							"Vendor_PAN_Period_Wise_Records");*/
