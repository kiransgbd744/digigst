...
@Slf4j
@Component("Gstr2APAndNonAPVendorPANWiseRecords")
public class Gstr2APAndNonAPVendorPANWiseRecords {
	...
	public void getVendorPANWiseRecords(Long configId) throws IOException {
		...
		try {
			...
			StoredProcedureQuery storedProc = entityManager
					.createStoredProcedureQuery("USP_AUTO_2APR_RPT_VENDOR_PAN");
			...
			if (records != null && !records.isEmpty()) {
				...
				try (Writer writer = new BufferedWriter(
					...
					if (reconDataList != null && !reconDataList.isEmpty()) {
						...
						String invoiceHeadersTemplate = commonUtility
								.getProp("gstr2.recon.vendor.pan.wise.header");
				...
				if (uploadedDocName != null)
					...
					/*addlReportRepo.updateReconFilePath(
							vendorPANWiseRecordsFilePath, configId,
							"Vendor_PAN_Wise_Records");*/
