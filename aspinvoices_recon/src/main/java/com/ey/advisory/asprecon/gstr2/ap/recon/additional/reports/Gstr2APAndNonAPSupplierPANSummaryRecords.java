...
@Slf4j
@Component("Gstr2APAndNonAPSupplierPANSummaryRecords")
public class Gstr2APAndNonAPSupplierPANSummaryRecords {
			...
			if (records != null && !records.isEmpty()) {
				...
				try (Writer writer = new BufferedWriter(
					...
					if (reconDataList != null && !reconDataList.isEmpty()) {
						...
						"gstr2.recon.supplier.pan.summary.taxperiod.header");
						writer.append(invoiceHeadersTemplate);
						String[] columnMappings = commonUtility
			    .getProp("gstr2.recon.supplier.pan.summary.taxperiod.column")
								.split(",");

						ColumnPositionMappingStrategy
						<Gstr2SupplierPANSummaryRecordsDto> 
						mappingStrategy = new ColumnPositionMappingStrategy<>();
						mappingStrategy
								.setType(Gstr2SupplierPANSummaryRecordsDto.class);
						mappingStrategy.setColumnMapping(columnMappings);
						StatefulBeanToCsvBuilder<Gstr2SupplierPANSummaryRecordsDto> 
						builder = new StatefulBeanToCsvBuilder<>(
								writer);
						StatefulBeanToCsv<Gstr2SupplierPANSummaryRecordsDto> 
						beanWriter = builder
				...
				if (LOGGER.isDebugEnabled()) {
					String msg = String
							.format("Update file path for Supplier_PAN_Summary_Records "
									+ ":%s : ", uploadedDocName);
					LOGGER.debug(msg);
				}
			}
	...
	private Gstr2SupplierPANSummaryRecordsDto convert(Object[] arr) {
		...
		Gstr2SupplierPANSummaryRecordsDto obj = 
				new Gstr2SupplierPANSummaryRecordsDto();
		...
		obj.setForceGSTR3BMatchGST2A((arr[6] != null) ? arr[6].toString() : null);
		obj.setForceGSTR3BMatchGSTPR((arr[7] != null) ? arr[7].toString() : null);
		
		obj.setMatchWithTolerenceGST2A((arr[8] != null) ? arr[8].toString() : null);
		obj.setMatchWithTolerenceGSTPR((arr[9] != null) ? arr[9].toString() : null);
		
		obj.setValueMismatchGST2A((arr[10] != null) ? arr[10].toString() : null);
		obj.setValueMismatchGSTPR((arr[11] != null) ? arr[11].toString() : null);
		
		obj.setPosMismatchGST2A((arr[12] != null) ? arr[12].toString() : null);
		obj.setPosMismatchGSTPR((arr[13] != null) ? arr[13].toString() : null);
		
		obj.setDocDateMismatchGST2A((arr[14] != null) ? arr[14].toString() : null);
		obj.setDocDateMismatchGSTPR((arr[15] != null) ? arr[15].toString() : null);
		
		obj.setDocTypeMismatchGST2A((arr[16] != null) ? arr[16].toString() : null);
		obj.setDocTypeMismatchGSTPR((arr[17] != null) ? arr[17].toString() : null);
		
		obj.setDocNoMismatchIGST2A((arr[18] != null) ? arr[18].toString() : null);
		obj.setDocNoMismatchIGSTPR((arr[19] != null) ? arr[19].toString() : null);
		
		obj.setMultiMismatchGST2A((arr[20] != null) ? arr[20].toString() : null);
		obj.setMultiMismatchGSTPR((arr[21] != null) ? arr[21].toString() : null);
		
		obj.setPotentialIGST2A((arr[22] != null) ? arr[22].toString() : null);
		obj.setPotentialIGSTPR((arr[23] != null) ? arr[23].toString() : null);
	
		obj.setDocNoMismatchIIGST2A((arr[24] != null) ? arr[24].toString() : null);
		obj.setDocNoMismatchIIGSTPR((arr[25] != null) ? arr[25].toString() : null);
		...
		obj.setDocNoDocDateMismatch2A((arr[30] != null) ? arr[30].toString() : null);
		obj.setDocNoDocDateMismatchPR((arr[31] != null) ? arr[31].toString() : null);
		
		obj.setTotalGST2A((arr[32] != null) ? arr[32].toString() : null);
		obj.setTotalGSTPR((arr[33] != null) ? arr[33].toString() : null);
		
		obj.setDifferencePR2A((arr[34] != null) ? arr[34].toString() : null);
	...
	private static File createTempDir(Long configId) throws IOException {
		...
		String tempFolderPrefix = "Supplier_PAN_Summary_Records" + "_" + configId;
