 ...
 */
@Slf4j
@Component("Gstr2APAndNonAPMasterVendorGSTINWiseRecords")
public class Gstr2APAndNonAPMasterVendorGSTINWiseRecords {
			...
			try {
				...
				StoredProcedureQuery storedProc = entityManager
						.createStoredProcedureQuery(
								"USP_AUTO_2APR_RPT_MASTER_VENDOR_GSTIN");
	...
	private List<String> findGstins(Long configId) {
		...
		StoredProcedureQuery storedProc = entityManager
				.createStoredProcedureQuery("USP_AUTO_2APR_GET_VENDOR_GSTIN");
		...
		if (LOGGER.isDebugEnabled()) {
			String msg = String.format(
					"Executing  proc to get List of PAN"
							+ " USP_AUTO_2APR_GET_VENDOR_GSTIN: '%s'",
					configId.toString());
			LOGGER.debug(msg);
		}
