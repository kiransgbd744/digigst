 ...
 */
@Slf4j
@Component("Gstr2APAndNonAPSummaryCalenderPeriodRecords")
public class Gstr2APAndNonAPSummaryCalenderPeriodRecords {
	...
	public void getSummaryCalendarPeriodRecords(Long configId)
		...
		try {
			...
			StoredProcedureQuery storedProc = entityManager
					.createStoredProcedureQuery("USP_AUTO_2APR_RPT_CALMONTH_SMRY");
