...
@Slf4j
@Component("Gstr2APAndNonAPRecipientGSTINPeriodWiseRecords")
public class Gstr2APAndNonAPRecipientGSTINPeriodWiseRecords {
		...
		try {
			...
			StoredProcedureQuery storedProc = entityManager
					.createStoredProcedureQuery(
							"USP_AUTO_2APR_RPT_RGSTIN_TXPRD");
			...
			if (records != null && !records.isEmpty()) {
				...
				try (Writer writer = new BufferedWriter(
					...
					if (reconDataList != null && !reconDataList.isEmpty()) {
						...
						String invoiceHeadersTemplate = commonUtility
								.getProp("gstr2.recon.rgpwr.header");
						writer.append(invoiceHeadersTemplate);
						String[] columnMappings = commonUtility
								.getProp("gstr2.recon.rgpwr.column").split(",");
				...
				if (LOGGER.isDebugEnabled()) {
					String msg = String
							.format("Update file path for Recipient_GSTIN_Period_Wise_Record "
									+ ":%s : ", uploadedDocName);
					LOGGER.debug(msg);
				}
