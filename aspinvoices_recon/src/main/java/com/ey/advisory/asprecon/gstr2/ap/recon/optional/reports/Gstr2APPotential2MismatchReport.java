...
@Slf4j
@Component("Gstr2APPotential2MismatchReport")
public class Gstr2APPotential2MismatchReport {
	...
	public void getPotential2MatchReport(Long configId,
		...
		if (LOGGER.isDebugEnabled()) {
			msg = String
					.format("Get Recon Potential-II Report Details with "
