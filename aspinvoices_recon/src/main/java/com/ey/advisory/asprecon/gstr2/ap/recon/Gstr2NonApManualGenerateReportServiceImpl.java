...
import com.ey.advisory.app.asprecon.gstr2.pr2b.reports.Gstr2Consolidated2AvsPRReconNonAimImsReport;
...
import com.ey.advisory.asprecon.gstr2.ap.recon.additional.reports.DroppedNonAP2A6ARecordsReport;
...
import com.ey.advisory.asprecon.gstr2.ap.recon.additional.reports.Gstr2NonAPConsolidatedPRRegister;
import com.ey.advisory.asprecon.gstr2.ap.recon.additional.reports.GstrAPAndNonAP2ReconITCTrackingReport;
import com.ey.advisory.asprecon.gstr2.ap.recon.additional.reports.ImpgNonAPReconReport;
import com.ey.advisory.asprecon.gstr2.ap.recon.optional.reports.Gstr2NonAPDocumentNumberDocumentDateMismatchReport;
import com.ey.advisory.asprecon.gstr2.ap.recon.optional.reports.Gstr2NonAPDocumentNumberMismatch2Report;
import com.ey.advisory.asprecon.gstr2.ap.recon.optional.reports.Gstr2NonAPISDMatchingReport;
import com.ey.advisory.asprecon.gstr2.ap.recon.optional.reports.Gstr2NonAPLogicalMatchReport;
import com.ey.advisory.asprecon.gstr2.ap.recon.optional.reports.Gstr2NonAPPotential1MismatchReport;
import com.ey.advisory.asprecon.gstr2.ap.recon.optional.reports.Gstr2NonAPPotential2MismatchReport;
 ...
 */
@Slf4j
@Component("Gstr2NonApManualGenerateReportServiceImpl")
public class Gstr2NonApManualGenerateReportServiceImpl
		implements Gstr2NonApManualGenerateReportService {
	...
	@Autowired
	@Qualifier("Gstr2NonAPDocumentNumberMismatch2Report")
	Gstr2NonAPDocumentNumberMismatch2Report docNum2Report;

	@Autowired
	@Qualifier("Gstr2NonAPDocumentNumberDocumentDateMismatchReport")
	Gstr2NonAPDocumentNumberDocumentDateMismatchReport docNumDoctDateReport;

	@Autowired
	@Qualifier("Gstr2NonAPLogicalMatchReport")
	Gstr2NonAPLogicalMatchReport logicalReport;

	@Autowired
	@Qualifier("Gstr2NonAPPotential2MismatchReport")
	Gstr2NonAPPotential2MismatchReport potential2Report;

	@Autowired
	@Qualifier("Gstr2NonAPPotential1MismatchReport")
	Gstr2NonAPPotential1MismatchReport potential1Report;
	...
	@Autowired
	@Qualifier("Gstr2NonAPConsolidatedPRRegister")
	Gstr2NonAPConsolidatedPRRegister consolPRReg;
	...
	@Autowired
	@Qualifier("DroppedNonAP2A6ARecordsReport")
	DroppedNonAP2A6ARecordsReport drop2a6aReport;
	...
	@Autowired
	@Qualifier("Gstr2NonAPISDMatchingReport")
	Gstr2NonAPISDMatchingReport isdMatchingReport;
	...
	@Autowired
	@Qualifier("Gstr2Consolidated2AvsPRReconNonAimImsReport")
	Gstr2Consolidated2AvsPRReconNonAimImsReport gstr2Consolidated2AvsPRReconNonAimImsReport;
	...
	@Override
	public void generateReport(Long configId, List<String> addnReportList)
			throws Exception {
		...
		// creating list of mandatory reports to regenerate report in failed
		// case
		...
		for (int i = 0; i < reportType.length; i++) {
			...
			fullPath = tempDir.getAbsolutePath() + File.separator
					+ getUniqueFileName(reportType[i]) + "_" + 1 + ".csv";
		...
		try {
			...
			//IMS 2A vs PR -Non AIM
			
			if (addnReportList.contains("Consolidated PR 2A Report IMS"))
				gstr2Consolidated2AvsPRReconNonAimImsReport.getImsConsolidated2AReconReportNonAim(configId);
