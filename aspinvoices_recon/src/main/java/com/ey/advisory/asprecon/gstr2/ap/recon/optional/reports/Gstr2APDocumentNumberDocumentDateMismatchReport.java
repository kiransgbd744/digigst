...
@Slf4j
@Component("Gstr2APDocumentNumberDocumentDateMismatchReport")
public class Gstr2APDocumentNumberDocumentDateMismatchReport {
	...
	public void getDocNum2MatchReport(Long configId,
		...
		if (LOGGER.isDebugEnabled()) {
			msg = String
					.format("Get Recon Doc No & Doc Date Mismatch Report Details with "
