...
@Slf4j
@Component("Gstr2APLogicalMatchReport")
public class Gstr2APLogicalMatchReport {
	...
	public void getLogicalMatchReport(Long configId,
		...
		if (LOGGER.isDebugEnabled()) {
			msg = String
					.format("Get Recon Logical Match Report Details with "
