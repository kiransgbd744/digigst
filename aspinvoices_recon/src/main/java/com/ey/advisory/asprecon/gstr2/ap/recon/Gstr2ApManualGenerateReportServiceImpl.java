...
import com.ey.advisory.app.asprecon.gstr2.pr2b.reports.Gstr2IMSConsolidated2AvsPRReconReport;
...
import com.ey.advisory.asprecon.gstr2.ap.recon.additional.reports.DroppedAp2A6ARecordsReport;
import com.ey.advisory.asprecon.gstr2.ap.recon.additional.reports.Gsr2APAndNonAPReverseChargeRegisterReports;
import com.ey.advisory.asprecon.gstr2.ap.recon.additional.reports.Gstr2APAndNonAPCdnrInvRefRegGstin2ARecords;
import com.ey.advisory.asprecon.gstr2.ap.recon.additional.reports.Gstr2APAndNonAPCdnrInvRefRegGstinPRRecords;
import com.ey.advisory.asprecon.gstr2.ap.recon.additional.reports.Gstr2APAndNonAPLockedCFSNAmendedRecords;
import com.ey.advisory.asprecon.gstr2.ap.recon.additional.reports.Gstr2APAndNonAPMasterVendorGSTINWiseRecords;
import com.ey.advisory.asprecon.gstr2.ap.recon.additional.reports.Gstr2APAndNonAPMasterVendorPANWiseRecords;
import com.ey.advisory.asprecon.gstr2.ap.recon.additional.reports.Gstr2APAndNonAPRecipientGSTINPeriodWiseRecords;
import com.ey.advisory.asprecon.gstr2.ap.recon.additional.reports.Gstr2APAndNonAPRecipientGSTINWiseRecords;
import com.ey.advisory.asprecon.gstr2.ap.recon.additional.reports.Gstr2APAndNonAPSummaryCalenderPeriodRecords;
import com.ey.advisory.asprecon.gstr2.ap.recon.additional.reports.Gstr2APAndNonAPSummaryTaxPeriodRecords;
import com.ey.advisory.asprecon.gstr2.ap.recon.additional.reports.Gstr2APAndNonAPSupplierPANSummaryRecords;
import com.ey.advisory.asprecon.gstr2.ap.recon.additional.reports.Gstr2APAndNonAPVendorGSTINPeriodWiseRecords;
import com.ey.advisory.asprecon.gstr2.ap.recon.additional.reports.Gstr2APAndNonAPVendorGSTINWiseRecords;
import com.ey.advisory.asprecon.gstr2.ap.recon.additional.reports.Gstr2APAndNonAPVendorPANPeriodWiseRecords;
import com.ey.advisory.asprecon.gstr2.ap.recon.additional.reports.Gstr2APAndNonAPVendorPANWiseRecords;
import com.ey.advisory.asprecon.gstr2.ap.recon.additional.reports.Gstr2APAndNonSupplierGSTINSummaryRecords;
import com.ey.advisory.asprecon.gstr2.ap.recon.additional.reports.Gstr2APConsolidatedPRRegister;
import com.ey.advisory.asprecon.gstr2.ap.recon.additional.reports.Gstr2APNonAPDroppedPRRecordsReport;
import com.ey.advisory.asprecon.gstr2.ap.recon.additional.reports.Gstr2APNonAPTimeStampReport;
import com.ey.advisory.asprecon.gstr2.ap.recon.additional.reports.Gstr2ApAndNonAPForceMatchRecords;
import com.ey.advisory.asprecon.gstr2.ap.recon.additional.reports.GstrAPAndNonAP2ReconITCTrackingReport;
import com.ey.advisory.asprecon.gstr2.ap.recon.additional.reports.ImpgAPReconReport;
import com.ey.advisory.asprecon.gstr2.ap.recon.optional.reports.Gstr2APDocumentNumberDocumentDateMismatchReport;
import com.ey.advisory.asprecon.gstr2.ap.recon.optional.reports.Gstr2APDocumentNumberMismatch2Report;
import com.ey.advisory.asprecon.gstr2.ap.recon.optional.reports.Gstr2APISDMatchingReport;
import com.ey.advisory.asprecon.gstr2.ap.recon.optional.reports.Gstr2APLogicalMatchReport;
import com.ey.advisory.asprecon.gstr2.ap.recon.optional.reports.Gstr2APPotential1MismatchReport;
import com.ey.advisory.asprecon.gstr2.ap.recon.optional.reports.Gstr2APPotential2MismatchReport;
 ...
 */
@Slf4j
@Component("Gstr2ApManualGenerateReportServiceImpl")
public class Gstr2ApManualGenerateReportServiceImpl
		implements Gstr2ApManualGenerateReportService {
	...
	@Autowired
	@Qualifier("Gstr2APDocumentNumberMismatch2Report")
	Gstr2APDocumentNumberMismatch2Report docNum2Report;

	@Autowired
	@Qualifier("Gstr2APDocumentNumberDocumentDateMismatchReport")
	Gstr2APDocumentNumberDocumentDateMismatchReport docNumDoctDateReport;

	@Autowired
	@Qualifier("Gstr2APLogicalMatchReport")
	Gstr2APLogicalMatchReport logicalReport;

	@Autowired
	@Qualifier("Gstr2APPotential2MismatchReport")
	Gstr2APPotential2MismatchReport potential2Report;

	@Autowired
	@Qualifier("Gstr2APPotential1MismatchReport")
	Gstr2APPotential1MismatchReport potential1Report;
	...
	@Autowired
	@Qualifier("Gstr2APConsolidatedPRRegister")
	Gstr2APConsolidatedPRRegister consolPRReg;

	@Autowired
	@Qualifier("Gstr2ApAndNonAPForceMatchRecords")
	Gstr2ApAndNonAPForceMatchRecords fmRecords;

	@Autowired
	@Qualifier("Gsr2APAndNonAPReverseChargeRegisterReports")
	Gsr2APAndNonAPReverseChargeRegisterReports reverseChargeRegister;

	@Autowired
	@Qualifier("Gstr2APNonAPDroppedPRRecordsReport")
	Gstr2APNonAPDroppedPRRecordsReport dropedPrReport;

	@Autowired
	@Qualifier("DroppedAp2A6ARecordsReport")
	DroppedAp2A6ARecordsReport drop2a6aReport;

	@Autowired
	@Qualifier("Gstr2APAndNonAPMasterVendorGSTINWiseRecords")
	Gstr2APAndNonAPMasterVendorGSTINWiseRecords gstinMaster;

	@Autowired
	@Qualifier("Gstr2APAndNonAPMasterVendorPANWiseRecords")
	Gstr2APAndNonAPMasterVendorPANWiseRecords panMaster;

	@Autowired
	@Qualifier("Gstr2APAndNonAPSummaryCalenderPeriodRecords")
	Gstr2APAndNonAPSummaryCalenderPeriodRecords summCalPeriod;

	@Autowired
	@Qualifier("Gstr2APAndNonAPSummaryTaxPeriodRecords")
	Gstr2APAndNonAPSummaryTaxPeriodRecords summTaxPeriod;

	@Autowired
	@Qualifier("Gstr2APAndNonSupplierGSTINSummaryRecords")
	Gstr2APAndNonSupplierGSTINSummaryRecords suppGstinSummry;

	@Autowired
	@Qualifier("Gstr2APAndNonAPSupplierPANSummaryRecords")
	Gstr2APAndNonAPSupplierPANSummaryRecords suppPanSummry;

	@Autowired
	@Qualifier("Gstr2APAndNonAPRecipientGSTINPeriodWiseRecords")
	Gstr2APAndNonAPRecipientGSTINPeriodWiseRecords recpGstinPeriod;

	@Autowired
	@Qualifier("Gstr2APAndNonAPRecipientGSTINWiseRecords")
	Gstr2APAndNonAPRecipientGSTINWiseRecords recpGstinWiseRecords;

	@Autowired
	@Qualifier("Gstr2APAndNonAPVendorGSTINPeriodWiseRecords")
	Gstr2APAndNonAPVendorGSTINPeriodWiseRecords vendorGstinTaxperiod;

	@Autowired
	@Qualifier("Gstr2APAndNonAPVendorGSTINWiseRecords")
	Gstr2APAndNonAPVendorGSTINWiseRecords vendorGstinWise;

	@Autowired
	@Qualifier("Gstr2APAndNonAPVendorPANPeriodWiseRecords")
	Gstr2APAndNonAPVendorPANPeriodWiseRecords vendorPanPeriod;

	@Autowired
	@Qualifier("Gstr2APAndNonAPVendorPANWiseRecords")
	Gstr2APAndNonAPVendorPANWiseRecords vendorPanWise;

	@Autowired
	@Qualifier("Gstr2APAndNonAPCdnrInvRefRegGstin2ARecords")
	Gstr2APAndNonAPCdnrInvRefRegGstin2ARecords cdrnA2Records;

	@Autowired
	@Qualifier("Gstr2APAndNonAPCdnrInvRefRegGstinPRRecords")
	Gstr2APAndNonAPCdnrInvRefRegGstinPRRecords cdrnPRRecords;

	@Autowired
	@Qualifier("ImpgAPReconReport")
	ImpgAPReconReport impgReport;
	...
	@Autowired
	@Qualifier("Gstr2APNonAPTimeStampReport")
	Gstr2APNonAPTimeStampReport gstr2ATimeStamp;
	...
	@Autowired
	@Qualifier("Gstr2APISDMatchingReport")
	Gstr2APISDMatchingReport isdMatchingReport;

	@Autowired
	@Qualifier("Gstr2IMSConsolidated2AvsPRReconReport")
	Gstr2IMSConsolidated2AvsPRReconReport gstr2IMSConsolidated2AvsPRReconReport;
	...
	public void generateReport(Long configId, Long entityId,
		...
		String[] reportTypeMain = { "Exact Match", "Match With Tolerance",
				"Value Mismatch", "POS Mismatch", "Doc Date Mismatch",
				"Doc Type Mismatch", "Doc No Mismatch I", "Multi-Mismatch",
				"Addition in PR", "Addition in 2A_6A",
				"Consolidated PR 2A_6A Report" };
	
		Set<String> reportTypeSet = new HashSet<>();
        for (String type : reportTypeMain) {
            reportTypeSet.add(type);
        }
        
        List<String> reportsInType = new ArrayList<>();
        List<String> reportsNotInType = new ArrayList<>();
        
        // Iterate over the additional report list
        for (String report : addnReportList) {
            // Check if the report is in the reportTypeSet
            if (reportTypeSet.contains(report)) {
                reportsInType.add(report);
            } else {
                reportsNotInType.add(report);
            }
        }
        
        String[] reportType = reportsInType.toArray(new String[0]);
        addnReportList = reportsNotInType;
		
		
		msg = String.format("final reportType size :'%d' with configId:'%s addnReportList :'%s'",
				reportType.length, configId.toString(),addnReportList);
		LOGGER.debug(msg);
		...
		for (int i = 0; i < reportType.length; i++) {
			...
			fullPath = tempDir.getAbsolutePath() + File.separator
					+ getUniqueFileName(reportType[i]) + "_1" + ".csv";
			...
			if (noOfChunk > 0) {
				...
				try {
					...
					String invoiceHeadersTemplate = commonUtility.getProp(
							"gstr2.generate.recon.report.header.template");
					writer.append(invoiceHeadersTemplate);

					String[] columnMappings = commonUtility.getProp(
							"gstr2.generate.recon.report.column.mapping")
							.split(",");
					...
					while (j < noOfChunk) {
						...
						if (LOGGER.isDebugEnabled()) {
							msg = String.format("call stored proc with "
									...
									configId.toString(), reportType[i], j);
							LOGGER.debug(msg);
						}
						...
						if (records != null && !records.isEmpty()) {
							...
							if (count >= maxLimitPerFile) {
								...
								fullPath = tempDir.getAbsolutePath()
										+ File.separator
										+ getUniqueFileName(reportType[i]) + "_"
										+ fileIndex + ".csv";
			...
			addlReportRepo.updateIsReportProcExecuted(configId, reportType[i]);
			// deleting dir
		...
		try {
			...
			// ERP Report for AP
			Gstr2ReconAddlReportsEntity erpEntry = addlReportRepo
					.findByReportTypeAndConfigId("ERP_Report", configId);
			...
			if (erpEntry == null) {
				...
				addnReportList.add("ERP_Report");
			}
				//old erp report 
			if (addnReportList.contains("ERP_Report"));
			erpReport.generateReport(configId, entityId);
			
			//code is on hold 
			// Invoking for ERP +IMS report based on user selection
		...
		/* 	String grpCode = TenantContext.getTenantId();
		  ...
		  if (addnReportList.contains("ERP_Report"));
			...
			Pair<List<String>, String> distinctPanAndDate = new Pair(
					distinctPan, date);
			if (addnReportList.contains("Doc No Mismatch II"))
				docNum2Report.getDocNum2MatchReport(configId,
						distinctPanAndDate);

			if (addnReportList.contains("Doc No & Doc Date Mismatch"))
				docNumDoctDateReport.getDocNum2MatchReport(configId,
						distinctPanAndDate);
			...
			if (addnReportList.contains("Potential-II"))
				potential2Report.getPotential2MatchReport(configId,
						distinctPanAndDate);

			if (addnReportList.contains("Potential-I"))
				potential1Report.getPotential2MatchReport(configId,
						distinctPanAndDate);

			// ISD Optional
			if (addnReportList.contains("ISD Matching Report"))
				isdMatchingReport.getIsdMatchingReport(configId,
						distinctPanAndDate);

			// Invoking Additional Reports

			if (addnReportList.contains("Force_Match_Records"))
				fmRecords.getForceMatchRecords(configId, distinctPanAndDate);
			...
			if (addnReportList.contains("Reverse_Charge_Register"))
				reverseChargeRegister.getGsr2ReverseChargeRegisterReports(
						configId, distinctPanAndDate);
			...
			if (addnReportList.contains("Consolidated_PR_Register"))
				consolPRReg.getGstr2ConsolidatedPRRegister(configId,
						distinctPanAndDate);

			if (addnReportList.contains("Locked_CFS_N_Amended_Records"))
				lockedCFSNFlag.getGstr2LockedCFSNAmendedRecords(configId);
			...
			if (addnReportList.contains("GSTR_2A_Time_Stamp_Report"))
				gstr2ATimeStamp.getGstr2TimeStampReport(configId);

			if (addnReportList.contains("Consolidated IMPG Report"))
				impgReport.getGstr2ImpgReconReport(configId);
			// IMS report-2A vs PR--AIM
			if (addnReportList.contains("Consolidated PR 2A Report IMS"))
				gstr2IMSConsolidated2AvsPRReconReport
						.getImsConsolidated2AReconReportAim(configId);
			...
			msg = String.format("Exception occured while generating "
					+ "additional recon reports %s : ", ex);
			LOGGER.error(msg);
	...
	private static File createTempDir(Long requestId, String reportType)
			throws IOException {

		String tempFolderPrefix = "Gstr2" + "_" + reportType + "_" + requestId;
	...
	private Gstr2ReconAddlReportsEntity setEntity(Long configId,
		...
		entity.setReportTypeId(reportId);

		LOGGER.debug("Inside setEntity for Erp method : "
				+ "Gstr2ApManualGenerateReportServiceImpl");
		return entity;
	}
