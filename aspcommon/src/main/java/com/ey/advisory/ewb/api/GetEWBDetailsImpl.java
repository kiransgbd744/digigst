 ...
 *
 */
@Component("GetEWBDetailsImpl")
public class GetEWBDetailsImpl implements GetEWBDetails{
	...
	public APIResponse getEWBDetails(
		...
		KeyValuePair<String, String> apiParam2 = new KeyValuePair<>(
				APIReqParamConstants.GET_EWB_NO, ewbNo);
		APIParams apiParams = new APIParams(APIProviderEnum.EWB,
				APIIdentifiers.GET_EWB,"v1.03", apiParam1, apiParam2);
