 ...
 */
@Slf4j
@Component("GenerateConsolidatedEWBImpl")
public class GenerateConsolidatedEWBImpl implements GenerateConsolidatedEWB {
	...
	public APIResponse consolidateEWB(
		...
		APIParams apiParams = new APIParams(APIProviderEnum.EWB,
				APIIdentifiers.GENERATE_CONSOLIDATED_EWB, apiParam);
