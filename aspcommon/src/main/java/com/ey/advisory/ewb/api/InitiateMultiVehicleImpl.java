 ...
 *
 */
@Component("InitiateMultiVehicleImpl")
public class InitiateMultiVehicleImpl implements InitiateMultiVehicle{
	@Autowired
	@Qualifier("DefaultEWBAPIExecutor")
	private APIExecutor apiExecutor;
	
	@Override
	public APIResponse initiateMultiVehicle(InitiateMultiVehicleReqDto req,
			String gstin) {
