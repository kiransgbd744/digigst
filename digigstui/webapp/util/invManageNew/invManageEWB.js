	...
	return {
		...
		allTF: function (flag) {
			return {
				...
				"IRNDate": flag,
				"TaxScheme": flag,
				"CancellationReason": flag,
				"CancellationRemarks": flag,
				"SupplyType": flag,
				"DocCategory": flag,
				"DocumentType": flag,
				"DocumentNumber": flag,
				...
				"SupplierAddress1": flag,
				"SupplierAddress2": flag,
				...
				"CustomerAddress1": flag,
				"CustomerAddress2": flag,
				...
				"DispatcherAddress1": flag,
				"DispatcherAddress2": flag,
				...
				"StateCessAdvaloremRate": flag,
				"StateCessAdvaloremAmount": flag,
				"StateCessSpecificRate": flag,
				"StateCessSpecificAmount": flag,
				...
				"InvoiceStateCessAdvaloremAmount": flag,
				"InvoiceStateCessSpecificAmount": flag,
				"InvoiceValue": flag,
				"RoundOff": flag,
				"TotalInvoiceValue": flag,
				"TCSFlagIncomeTax": flag,
				"TCSRateIncomeTax": flag,
				"TCSAmountIncomeTax": flag,
				"CustomerPANOrAadhaar": flag,
				"CurrencyCode": flag,
				"CountryCode": flag,
				"InvoiceValueFC": flag,
				"PortCode": flag,
				...
				"SupportingDocument": flag,
				"AdditionalInformation": flag,
				...
				"GLSpecificCess": flag,
				"GLStateCessAdvalorem": flag,
				"GLStateCessSpecific": flag,
				"GLPostingDate": flag,
		...
		selectedGroup: function (oDisplay, aGroupData) {
			...
			case "EWB":
				...
				oDisplay.IRN = true;
				oDisplay.CancellationReason = true;
				oDisplay.CancellationRemarks = true;
				oDisplay.SupplyType = true;
				oDisplay.DocCategory = true;
				oDisplay.DocumentType = true;
				oDisplay.DocumentNumber = true;
				...
				oDisplay.SupplierGSTIN = true;
				oDisplay.SupplierTradeName = true;
				oDisplay.SupplierAddress1 = true;
				oDisplay.SupplierAddress2 = true;
				oDisplay.SupplierLocation = true;
				oDisplay.SupplierPincode = true;
				oDisplay.SupplierStateCode = true;
				oDisplay.CustomerGSTIN = true;
				oDisplay.CustomerTradeName = true;
				oDisplay.CustomerAddress1 = true;
				oDisplay.CustomerAddress2 = true;
				oDisplay.CustomerLocation = true;
				oDisplay.CustomerPincode = true;
				oDisplay.CustomerStateCode = true;
				oDisplay.DispatcherAddress1 = true;
				oDisplay.DispatcherAddress2 = true;
				oDisplay.DispatcherLocation = true;
				oDisplay.DispatcherPincode = true;
				oDisplay.DispatcherStateCode = true;
				oDisplay.ShipToAddress1 = true;
				oDisplay.ShipToAddress2 = true;
				oDisplay.ShipToLocation = true;
				oDisplay.ShipToPincode = true;
				oDisplay.ShipToStateCode = true;
				oDisplay.ItemSerialNumber = true;
		...
		selectedGroupMandit: function (oDisplay, aGroupData) {
			debugger;
			for (var i = 0; i < aGroupData.length; i++) {
				var vSelGroup = aGroupData[i];
				switch (vSelGroup) {
				case "All":
					oDisplay = this.allMandit(true);
					return oDisplay;
					break;
				case "M":
					oDisplay.DocCategory = true;
