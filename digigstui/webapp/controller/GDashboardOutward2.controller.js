sap.ui.define([
	...
	return BaseController.extend("com.ey.digigst.controller.GDashboardOutward2", {
		_bExpanded: true,
		/**
		 * Called when a controller is instantiated and its View controls (if available) are already created.
		 * Can be used to modify the View before it is displayed, to bind event handlers and do other one-time initialization.
		 * @memberOf com.ey.digigst.view.GDashboardOutward2
		 */
		onInit: function () {
			this.getOwnerComponent().getRouter().getRoute("GDashboardOutward2").attachPatternMatched(this._onRouteMatched, this);
