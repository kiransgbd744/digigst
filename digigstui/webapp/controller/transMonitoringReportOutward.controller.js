sap.ui.define([
	...
	return BaseController.extend("com.ey.digigst.controller.transMonitoringReportOutward", {
		...
		onInit: function () {
			var that = this,
				vDate = new Date();
			this.getOwnerComponent().getRouter().getRoute("transMonitoringReportOutward").attachPatternMatched(this._onRouteMatched, this);
		...
		_onRouteMatched: function (oEvent) {
			...
			if (oName === "transMonitoringReportOutward") {
		...
		_getTransOutward: function () {
			...
			$(document).ready(function ($) {
				$.ajax({
					method: "POST",
					url: "/aspsapapi/getTransactionalOutwardDocs.do",
					contentType: "application/json",
					data: JSON.stringify(postData)
				}).done(function (data, status, jqXHR) {

					sap.ui.core.BusyIndicator.hide();
					that.getView().setModel(new JSONModel(data), "transOutward");
