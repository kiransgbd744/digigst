sap.ui.define([
	...
	return BaseController.extend("com.ey.digigst.controller.Gstr1APRvsSD", {
		formatter: Formatter,

		/**
		 * Called when a controller is instantiated and its View controls (if available) are already created.
		 * Can be used to modify the View before it is displayed, to bind event handlers and do other one-time initialization.
		 * @memberOf com.ey.digigst.view.Gstr1APRvsSD
		 */
		onInit: function () {
			var vDate = new Date();
		...
		onDownloadOutward: function (section) {
			...
			this.excelDownload(oPayload, "/aspsapapi/downloadGstr1aAspvsSubmittedSecReports.do");
		},
		...
		_getProcessedData: function () {
			...
			$.ajax({
					method: "POST",
					url: "/aspsapapi/getGstr1aProcessedVsSubmittedData.do",
					contentType: "application/json",
		...
		_getProcessSummary: function (oPayload) {
			...
			$.ajax({
				method: "POST",
				url: "/aspsapapi/gstr1AProcessVsSubmitScreen.do",
		...
		gstr1InitiateReconCall: function (postData) {
			...
			$(document).ready(function ($) {
				$.ajax({
					method: "POST",
					url: "/aspsapapi/gstr1APRvsSubmittedInitiateMatching.do",
					contentType: "application/json",
		...
		onPressDownloadReport: function (button) {
			...
			if (button === "P") {
				...
				var vUrl = "/aspsapapi/aspGstr1APrVsSubmitDownloadReport.do";
		...
		onSearchReqIdWise: function () {
			...
			$.ajax({
					method: "POST",
					url: "/aspsapapi/gstr1APrVsSubmittedRequestIdWise.do",
					contentType: "application/json",
					data: JSON.stringify(payload)
				})
				.done(function (data, status, jqXHR) {
		...
		onConfigExtractPress2A1: function (oEvt) {
			...
			var oIniPath = "/aspsapapi/gstr1APrVsSubmDownloadIdWise.do";
			$(document).ready(function ($) {
				$.ajax({
					method: "POST",
					url: oIniPath,
		...
		onFragDownload: function (oEvt) {
			...
			var oReqExcelPath = "/aspsapapi/gstr1APrVsSubmittedRequestReport.do";
