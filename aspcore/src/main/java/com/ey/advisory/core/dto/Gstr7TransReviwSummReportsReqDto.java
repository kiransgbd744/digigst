 ...
 *
 */
public class Gstr7TransReviwSummReportsReqDto extends SearchCriteria {

	public Gstr7TransReviwSummReportsReqDto() {
	...
	public String toString() {
		return "Gstr7TransReviwSummReportsReqDto [entityId=" + entityId + ", Gstin="
				...
				+ super.toString() +", getReportType=" + getReportType() +", returnType=" + getReturnType() +",]";
	}
