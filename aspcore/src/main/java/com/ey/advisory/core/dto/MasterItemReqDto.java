...
public class MasterItemReqDto {
	...
	return "MasterItemReqDto [id=" + id + ", gstinPan=" + gstinPan
		+ ", itmCode=" + itmCode + ", itemDesc=" + itemDesc
		+ ", itmCategory=" + itmCategory + ", hsnOrSac=" + hsnOrSac
		+ ", uom=" + uom + ", reverseChargeFlag=" + reverseChargeFlag
		+ ", tdsFlag=" + tdsFlag + ", diffPercent=" + diffPercent
		+ ", nilOrNonOrExmt=" + nilOrNonOrExmt
		+ ", ifYCirularNotificationNum=" + ifYCirularNotificationNum
		+ ", ifYCirularNotificationDate=" + ifYCirularNotificationDate
		+ ", efCircularDate=" + efCircularDate + ", rate=" + rate
		+ ", elgblIndicator=" + elgblIndicator + ", perOfElgbl="
		+ perOfElgbl + ", commonSuppIndicator=" + commonSuppIndicator
