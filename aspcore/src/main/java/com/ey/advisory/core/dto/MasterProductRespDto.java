...
public class MasterProductRespDto {
    ...
    public void setIfYCircularNotificationNum(String ifYCircularNotificationNum) {
	...
	return "MasterProductRespDto [id=" + id + ", gstinPan=" + gstinPan
