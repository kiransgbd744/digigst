 ...
 *
 */
@Component("BasicCommonSecParam")
public class BasicCommonSecParam {

	public DataStatusSearchReqDto setDataSecuritySearchParams(
			DataStatusSearchReqDto searchParams) {
		...
		if ("outward".equalsIgnoreCase(dataType)) {
			...
			if (searchParams.getDataSecAttrs() == null
				...
				// List<String> dcList =
				// dataSecReqMap.get(OnboardingConstant.DC);
				List<String> locList = dataSecReqMap
						.get(OnboardingConstant.LOCATION);
				List<String> ud1List = dataSecReqMap
						.get(OnboardingConstant.UD1);
	...
	public DataStatusSearchReqDto setDataSecuritySearchParamsApi(
			DataStatusSearchReqDto searchParams) {
	...
	public Annexure1SummaryReqDto setOutwardSumDataSecuritySearchParams(
			Annexure1SummaryReqDto searchParams) {
	...
	public Annexure1SummaryReqDto setInwardSumDataSecuritySearchParams(
			Annexure1SummaryReqDto searchParams) {
	...
	public VendorSummaryReqDto setInwardPRSummaryDataSecuritySearchParams(
			VendorSummaryReqDto searchParams) {
	...
	public ConsolidatedEWBRequest setOutwardDataSecuritySearchParams(
			ConsolidatedEWBRequest searchParams) {
