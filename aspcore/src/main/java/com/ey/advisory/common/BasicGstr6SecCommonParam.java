 ...
 *
 */
@Component("BasicGstr6SecCommonParam")
public class BasicGstr6SecCommonParam {

	public Gstr6SummaryRequestDto setDataSecuritySearchParams(
			Gstr6SummaryRequestDto searchParams) {
