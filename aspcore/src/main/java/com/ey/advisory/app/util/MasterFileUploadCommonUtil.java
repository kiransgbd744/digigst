 ...
 *
 */
@Component("MasterFileUploadCommonUtil")
public class MasterFileUploadCommonUtil {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(MasterFileUploadCommonUtil.class);
	...
	public Session getCmisSession() throws Exception {
		GroupService groupService = StaticContextHolder.getBean("groupService",
				GroupService.class);
	...
	public Gstr1FileStatusEntity getFileStatus(String fileName,
            String userName,AsyncExecJob asyncExceJob,
		...
		fileStatus.setFileType("Master");
		fileStatus.setUpdatedBy("System");
		...
		fileStatus.setDataType("Onboarding");
