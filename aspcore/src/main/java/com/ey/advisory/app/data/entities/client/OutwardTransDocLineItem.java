...
@Entity
@Table(name = "ANX_OUTWARD_DOC_ITEM")
public class OutwardTransDocLineItem extends TransDocLineItem {

	@Expose
	@SerializedName("id")
	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "ANX_OUTWARD_DOC_ITEM_SEQ", allocationSize = 100)
	...
	protected List<AttributeDetails> attribDtls = new ArrayList<>();
	 ...
	 * @return the document
	 */
	public OutwardTransDocument getDocument() {
		return document;
	}
	 ...
	 *            the document to set
	 */
	public void setDocument(OutwardTransDocument document) {
