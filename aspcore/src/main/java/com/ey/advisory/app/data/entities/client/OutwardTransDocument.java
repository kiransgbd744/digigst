 ...
 */
@Entity
@Table(name = "ANX_OUTWARD_DOC_HEADER")
public class OutwardTransDocument extends TransDocument {

	@Expose
	@SerializedName("id")
	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "ANX_OUTWARD_DOC_HEADER_SEQ", allocationSize = 100)
	...
	@LazyCollection(LazyCollectionOption.FALSE)
	@Cascade({ org.hibernate.annotations.CascadeType.ALL })
	protected List<PreceedingDocDetails> preDocDtls = new ArrayList<>();
	 ...
	 */
	public List<OutwardTransDocLineItem> getLineItems() {
		return lineItems;
	}
	 ...
	 */
	public void setLineItems(List<OutwardTransDocLineItem> lineItems) {
	 ...
	 */
	public List<PreceedingDocDetails> getPreDocDtls() {
		return preDocDtls;
	}
	 ...
	 */
	public void setPreDocDtls(List<PreceedingDocDetails> preDocDtls) {
	 ...
	 */
	public List<ContractDetails> getContrDtls() {
		return contrDtls;
	}
	 ...
	 */
	public void setContrDtls(List<ContractDetails> contrDtls) {
	 ...
	 */
	public List<AdditionalDocDetails> getAddlDocDtls() {
		return addlDocDtls;
	}
	 ...
	 */
	public void setAddlDocDtls(List<AdditionalDocDetails> addlDocDtls) {
	...
	public Integer getItemNoForIndex(Integer itemIndex) {
		...
		if (itemIndex < lineItemCount && itemIndex >= 0) {
			OutwardTransDocLineItem lineItem = lineItems.get(itemIndex);
			Integer lineNo = 0;
