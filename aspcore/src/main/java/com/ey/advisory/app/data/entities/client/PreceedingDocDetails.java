 ...
 */
@Entity
@Table(name = "PRECEEDING_DOC_DTL")
@Data
public class PreceedingDocDetails {
	
	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "PRECEEDING_DOC_DTL_SEQ", allocationSize = 100)
	...
	private OutwardTransDocument preDocDetails;
	
	public PreceedingDocDetails() {
