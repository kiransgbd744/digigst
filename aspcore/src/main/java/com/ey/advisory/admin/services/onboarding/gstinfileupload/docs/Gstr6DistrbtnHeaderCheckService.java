...
@Component("Gstr6DistrbtnHeaderCheckService")
public class Gstr6DistrbtnHeaderCheckService implements MasterHeaderCheckService {
	...
	protected static final String[] EXPECTED_HEADERS ={
			"ReturnPeriod","ISDGSTIN","RecipientGSTIN","StateCode","OriginalRecipeintGSTIN",
			"OriginalStatecode","DocumentType","SupplyType","DocumentNumber","DocumentDate",
