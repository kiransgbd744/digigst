...
@Component("CommonCreditReversalHeaderCheckService")
public class CommonCreditReversalHeaderCheckService implements MasterHeaderCheckService{
	@Autowired
	...
	protected static final String[] EXPECTED_HEADERS = { "CustomerGSTIN",
			"DocumentType", "DocumentNumber", "DocumentDate", "SupplierGSTIN",
			"ItemSerialNumber", "CommonSupplyIndicator",
			"RevisedReturnperiodforITCreversalcomputation"
