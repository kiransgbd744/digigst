...
@Component("CustomerHeaderCheckService")
public class CustomerHeaderCheckService implements MasterHeaderCheckService {

	protected static final String[] EXPECTED_HEADERS = { "RecipientGSTIN/PAN",
			"LegalName", "TradeName", "RecipientType", "RecipientCode",
			"OutsideIndia", "E-MailID", "MobileNumber" };
	...
	public Pair<Boolean, String> validate(Object[] headerCols) {
		return headerCheckerUtil.validateHeaders(EXPECTED_HEADERS, headerCols);
		// return pair;
	}
