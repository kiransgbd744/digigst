...
@Component("ProductHeaderCheckService")
public class ProductHeaderCheckService implements MasterHeaderCheckService {
	...
	protected static final String[] EXPECTED_HEADERS ={
			"GSTIN/PAN","ProductCode","ProductDescription","CategoryOfProduct","HSNorSAC",
			"UnitofMeasurement","ReverseChargeFlag","TDSFlag","Differential%Flag","NIL/NON/Exempt",
			"If Y, then circular/ Notification number","If Y, then circular/ Notification date","Effective date of Circular",
			"Rate","ITCFlag"
