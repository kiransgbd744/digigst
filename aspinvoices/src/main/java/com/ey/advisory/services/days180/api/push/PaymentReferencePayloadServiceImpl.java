 ...
 *
 */
@Service("PaymentReferencePayloadServiceImpl")
@Slf4j
public class PaymentReferencePayloadServiceImpl implements PaymentReferencePayloadService {
	...
	public void create(String payloadId, String companyCode, String docCount,
		...
		PaymentReferencePayloadEntity payload = new PaymentReferencePayloadEntity();
		payload.setPayloadId(payloadId);
		payload.setCompanyCode(companyCode);
		payload.setDerivedSourceId(sourceId);
		if (docCount != null && !docCount.isEmpty()) {
			payload.setDocCount(Integer.valueOf(docCount));
		}
	...
	public void saveCPIError(String payloadId, String companyCode,
		...
		List<Object> payloadIDS = payloadRepository
		...
		if (payloadID == null || payloadID.isEmpty()) {
			...
			PaymentReferencePayloadEntity outPayload = new PaymentReferencePayloadEntity();
			...
			payloadRepository.updateCpiStatus(payloadId,
