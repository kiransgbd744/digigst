 ...
 *
 */
@Component("Gstr1ASupplyTypeMasterValidation")
public class Gstr1ASupplyTypeMasterValidation
	...
	public List<ProcessingResult> validate(Gstr1AOutwardTransDocument document,
		...
		IntStream.range(0, items.size()).forEach(idx -> {
			...
			int n = supplyTypeCache
					.findSupplyType(trimAndConvToUpperCase(supType));
			if (n == 0) {
