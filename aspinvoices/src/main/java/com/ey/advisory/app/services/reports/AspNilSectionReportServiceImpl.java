...
import com.ey.advisory.core.search.SearchCriteria;
	...
	@Service("AspNilSectionReportServiceImpl")
	public class AspNilSectionReportServiceImpl
			implements Gstr1AspNilRatedReportsService {

		private static final Logger LOGGER = LoggerFactory
				.getLogger(AspNilSectionReportServiceImpl.class);

		@Autowired
		CommonUtility commonUtility;

		@Autowired
		@Qualifier("AspNilSecRatedTransactionalDaoImpl")
		Gstr1OutwardVerticalProcessNilDao gstr1NilRatedTransactionalDao;

		@Autowired
		@Qualifier("AspSecRatedTotalSummaryDaoImpl")
		Gstr1OutwardVerticalProcessNilDao gstr1NilRatedTotalSummDao;
		
		@Autowired
		@Qualifier("AspNilRatedSummaryUploadDaoImpl")
