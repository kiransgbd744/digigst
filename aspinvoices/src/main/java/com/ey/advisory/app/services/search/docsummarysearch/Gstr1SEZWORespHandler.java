...
@Service("Gstr1SEZWORespHandler")
public class Gstr1SEZWORespHandler {
	...
	public JsonElement handleSezwoResp(List<? extends Gstr1SummaryDto> list) {
		
		/*Gstr1SummaryReqDto gstr1SummaryRequest*/
		List<Gstr1BasicSummarySectionDto> sezwoEySummary = new ArrayList<>();
		for (Gstr1SummaryDto gstr1Summary : list) {
			sezwoEySummary = gstr1Summary.getSezwop().getEySummary();
		}
