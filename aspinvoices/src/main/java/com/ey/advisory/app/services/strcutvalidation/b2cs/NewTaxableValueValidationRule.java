 ...
 *
 */
public class NewTaxableValueValidationRule implements ValidationRule {
	...
	public List<ProcessingResult> isValid(Object obj, Object[] row,
		...
		if (!isPresent(obj)){
			errorLocations.add(GSTConstants.NEW_ORGTAXABLE_VALUE);
			TransDocProcessingResultLoc location 
			                     = new TransDocProcessingResultLoc(
					null, errorLocations.toArray());
			errors.add(new ProcessingResult(APP_VALIDATION, "ER5024",
					"Invalid NewTaxableValue",
					location));
			return errors;
		}
			...
			if (!isDecimal(obj.toString().trim())) {
				...
				TransDocProcessingResultLoc location = 
						...
						null, errorLocations.toArray());
				errors.add(new ProcessingResult(APP_VALIDATION, "ER5024",
						"Invalid NewTaxableValue", location));
