 ...
 *
 */
@Component("CewbProcessedInfoReportsDaoImpl")
@Slf4j
public class CewbProcessedInfoReportsDaoImpl
	...
	private String createVerticalProcessedInfoQueryString(String buildQuery) {
		...
		if ((GSTConstants.CEWB).equalsIgnoreCase(fileType)) {
			...
			builder.append("AND ERR.INV_KEY=HI.DOC_KEY  WHERE HI.IS_INFORMATION = TRUE AND ");
