...
@Entity
@Table(name = "GETGSTR1_EXP_ITEM")

public class GetGstr1ExpItemEntity {
	...
	private GetGstr1ExpHeaderEntity document;
	...
	public GetGstr1ExpHeaderEntity getDocument() {
		return document;
	}

	public void setDocument(GetGstr1ExpHeaderEntity document) {
