...
import com.ey.advisory.app.services.annexure1fileupload.Table4StructuralErrorUploadService;
...
@Component("OutwardTable4FileArrivalHandler")
@Slf4j
public class OutwardTable4FileArrivalHandler {
	...
	@Autowired
	@Qualifier("Table4HeaderCheckService")
	...
	@Autowired
	@Qualifier("Table4StructuralErrorUploadService")
	private Table4StructuralErrorUploadService 
	              table4StructuralErrorUploadService;
	
	@Autowired
	@Qualifier("Gstr1FileStatusRepository")
	private Gstr1FileStatusRepository gstr1FileStatusRepository;
	
	public void processTable4File(Message message, AppExecContext context) {
		...
		TabularDataLayout layout = new DummyTabularDataLayout(26);
		...
		List<Object[]> listOfTable4s = ((FileUploadDocRowHandler<?>) rowHandler)
				                                          .getFileUploadList();
		...
		if(checkHeaderFormat.getValue0()){
			...
			table4StructuralErrorUploadService.
			             processData(listOfTable4s,updateFileStatus);
		}	
		else{
