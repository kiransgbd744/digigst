 ...
 *
 */
@Repository("TransactionalInwardRepository")
@Transactional(propagation = Propagation.REQUIRED, readOnly = false)
public interface TransactionalInwardRepository 
		extends CrudRepository<TransactionalInwardEntity, Long> {

@Modifying
@Query(value = "UPDATE TRANSACTIONAL_MONITORING_INWARD A "
	...
	+ "FROM ANX_INWARD_DOC_HEADER B "
	+ "WHERE A.GSTIN = B.CUST_GSTIN "
...
@Modifying
@Query(value = "UPDATE TRANSACTIONAL_MONITORING_INWARD SET IS_DELETE = TRUE"
