 ...
 *
 */
@Repository("GetGstr2StagingB2baInvoicesRepository")
@Transactional(propagation = Propagation.REQUIRED, readOnly = false)
public interface GetGstr2StagingB2baInvoicesRepository
		extends CrudRepository<GetGstr2aStagingB2baInvoicesHeaderEntity, Long> {

	/* void softlyDeleteB2baHeader(String gstin, String returnPeriod); */

	// Curently isDelete is not added in table
	@Modifying
	@Query("UPDATE GetGstr2aStagingB2baInvoicesHeaderEntity b SET b.isDelete = true , b.modifiedBy = 'SYSTEM'  , b.modifiedOn =:modifiedOn  WHERE"
	...
	@Query("from GetGstr2aStagingB2baInvoicesHeaderEntity where sgstin=:sgstin and cgstin=:cgstin and invDate=:invDate and invNum=:invNum and invType=:invType")
	List<GetGstr2aStagingB2baInvoicesHeaderEntity> findByInvoiceKey(
	...
	@Query("SELECT COUNT(*) FROM GetGstr2aStagingB2baInvoicesHeaderEntity "
			+ "WHERE cgstin=:gstin AND returnPeriod = :taxperiod and isDelete =false")
	public int gstinCount(@Param("gstin") String gstin,
			@Param("taxperiod") String taxperiod);

	@Modifying
	@Query("UPDATE GetGstr2aStagingB2baInvoicesHeaderEntity b SET b.isDelete = true, b.modifiedOn=:modifiedOn WHERE"
