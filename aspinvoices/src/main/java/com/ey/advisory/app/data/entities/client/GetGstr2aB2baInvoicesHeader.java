...
@Data
@MappedSuperclass
public class GetGstr2aB2baInvoicesHeader {
	...
	protected String origInvNum;

	@Column(name = "ORG_INV_DATE")
	protected LocalDate origInvDate;
	...
	protected GetGstr2aBatchEntity b2bBatchIdGstr2a;*/
	...
	protected Boolean sec7;

	@Column(name = "REFUND_ELG")
	protected Boolean rfndElg;
