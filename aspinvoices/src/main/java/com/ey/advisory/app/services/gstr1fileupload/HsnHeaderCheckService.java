 ...
 *
 */
@Component("HsnHeaderCheckService")
public class HsnHeaderCheckService implements Gstr1HeaderCheckService {
	@Autowired
	@Qualifier("Gstr1HeaderChecker")
	private Gstr1HeaderChecker gstr1HeaderChecker;

	public static final String[] EXPECTED_HEADERS = { "Sr.No", "SupplierGSTIN",
			"ReturnPeriod","RecordType", "HSNorSAC", "ProductDescription",
			"UnitOfMeasurement", "Quantity", "Rate", "TaxableValue",
			"IntegratedTaxAmount", "CentralTaxAmount", "StateUTTaxAmount",
			"CessAmount", "TotalValue" };
