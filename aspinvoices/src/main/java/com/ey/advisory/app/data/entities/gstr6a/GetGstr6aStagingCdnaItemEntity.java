 ...
 */
@Entity
@Table(name = "GETGSTR6A_STAGING_CDNA_ITEM")
public class GetGstr6aStagingCdnaItemEntity {

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "GETGSTR6A_CDNA_ITEM_SEQ", allocationSize = 100)
	...
	protected GetGstr6aStagingCdnaHeaderEntity header;
	...
	public GetGstr6aStagingCdnaHeaderEntity getHeader() {
		return header;
	}

	public void setHeader(GetGstr6aStagingCdnaHeaderEntity header) {
		this.header = header;
	}
