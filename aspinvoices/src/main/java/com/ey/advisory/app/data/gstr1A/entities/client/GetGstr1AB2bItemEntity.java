...
@Entity
@Table(name = "GETGSTR1A_B2B_ITEM")
public class GetGstr1AB2bItemEntity {

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "GETGSTR1A_B2B_ITEM_SEQ", allocationSize = 100)
	...
	private GetGstr1AB2bHeaderEntity document;
	...
	public GetGstr1AB2bHeaderEntity getDocument() {
		return document;
	}

	public void setDocument(GetGstr1AB2bHeaderEntity document) {
