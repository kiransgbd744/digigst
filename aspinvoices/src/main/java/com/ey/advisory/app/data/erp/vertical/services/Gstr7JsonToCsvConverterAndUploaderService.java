 ...
 */
@Slf4j
@Component("Gstr7JsonToCsvConverterAndUploaderService")
public class Gstr7JsonToCsvConverterAndUploaderService {
	...
	@Autowired
	@Qualifier("Gstr7ConvertDtoTocsv")
	private Gstr7ConvertDtoTocsv convertDtoTocsv;

	public String convertAndUpload(Gstr7HeaderReqDto dto, String cntrlPayloadId) {
		File tempDir = null;
		...
		try {
			...
			Gstr1FileStatusEntity fileStatus = gstr1FileUploadUtil
					.getErpFileStatus(filename, userName, null,
							GSTConstants.GSTR7_TDS, GSTConstants.OTHERS, null);
			...
			gstr1FileUploadJobInsertion.fileUploadJob(jsonParams,
					JobConstants.GSTR7FILEUPLOAD,userName);
