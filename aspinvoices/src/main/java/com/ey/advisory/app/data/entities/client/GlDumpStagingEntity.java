...
@Data
@Entity
@Table(name = "TBL_GL_DUMP_STG")
public class GlDumpStagingEntity {

	@Expose
	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "TBL_GL_DUMP_STG_SEQ", allocationSize = 100)
	...
	private String clearingDocDate;
