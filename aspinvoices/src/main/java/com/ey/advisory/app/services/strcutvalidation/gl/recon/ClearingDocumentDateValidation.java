...
public class ClearingDocumentDateValidation implements ValidationRule {
	@Override
	public List<ProcessingResult> isValid(int idx, Object obj, Object[] row,
		...
		if (isPresent(obj)) {
			...
			if (date == null) {
				...
				errorLocations.add(GSTConstants.CLEARING_DATE);
				TransDocProcessingResultLoc location = new TransDocProcessingResultLoc(
						null, errorLocations.toArray());
				errors.add(new ProcessingResult(APP_VALIDATION, "ER0017",
