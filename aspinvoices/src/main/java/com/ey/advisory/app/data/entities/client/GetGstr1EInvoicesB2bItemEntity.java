 ...
 */
@Entity
@Table(name = "GETGSTR1_EINV_B2B_ITEM")
public class GetGstr1EInvoicesB2bItemEntity {

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "GETGSTR1_EINV_B2B_ITEM_SEQ", allocationSize = 100)
	...
	private GetGstr1EInvoicesB2bHeaderEntity document;
	...
	public GetGstr1EInvoicesB2bHeaderEntity getDocument() {
		return document;
	}

	public void setDocument(GetGstr1EInvoicesB2bHeaderEntity document) {
