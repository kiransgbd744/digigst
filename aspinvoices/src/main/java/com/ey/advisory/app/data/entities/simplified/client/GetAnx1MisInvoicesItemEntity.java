 ...
 */
@Entity
@Table(name = "GETANX1_MIS_ITEM")
public class GetAnx1MisInvoicesItemEntity {
	...
	protected GetAnx1MisInvoicesHeaderEntity header;
	...
	public GetAnx1MisInvoicesHeaderEntity getHeader() {
		return header;
	}

	public void setHeader(GetAnx1MisInvoicesHeaderEntity header) {
		this.header = header;
	}
