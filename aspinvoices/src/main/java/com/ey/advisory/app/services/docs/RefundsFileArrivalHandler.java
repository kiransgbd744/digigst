...
import com.ey.advisory.app.services.annexure1fileupload.RefundsStructuralErrorUploadService;
...
@Component("RefundsFileArrivalHandler")
public class RefundsFileArrivalHandler {
	
	private static final Logger LOGGER = LoggerFactory
			          .getLogger(RefundsFileArrivalHandler.class);
	...
	@Autowired
	@Qualifier("RefundsHeaderCheckService")
	...
	@Autowired
	@Qualifier("RefundsStructuralErrorUploadService")
	private RefundsStructuralErrorUploadService 
	                            refundsStructuralErrorUploadService;
	...
	public void processRefundsFile(Message message, AppExecContext context) {
		
		LOGGER.error("processRefundsFile");
		...
		LOGGER.error("Header Checker Validations "+checkHeaderFormat.getValue0()
		+" ,"+checkHeaderFormat.getValue1());

		List<Object[]> listOfRefunds = ((FileUploadDocRowHandler<?>) rowHandler)
				                                          .getFileUploadList();
		...
		if(checkHeaderFormat.getValue0()){
			...
			refundsStructuralErrorUploadService.
			             processData(listOfRefunds,updateFileStatus);
		}	
		else{
