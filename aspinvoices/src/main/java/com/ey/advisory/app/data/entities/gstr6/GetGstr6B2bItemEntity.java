...
@Entity
@Table(name = "GETGSTR6_B2B_ITEM")
public class GetGstr6B2bItemEntity {

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "GETGSTR6_B2B_ITEM_SEQ", allocationSize = 100)
	...
	protected GetGstr6B2bHeaderEntity document;
	...
	public GetGstr6B2bHeaderEntity getDocument() {
		return document;
	}

	public void setDocument(GetGstr6B2bHeaderEntity document) {
