...
public class Anx2InwardProcessedRecordsDto {
	...
	private String	CreditAvailedPeriod;
	private String	ReconReport;
	...
	public String getCreditAvailedPeriod() {
		return CreditAvailedPeriod;
	}
	public void setCreditAvailedPeriod(String creditAvailedPeriod) {
		CreditAvailedPeriod = creditAvailedPeriod;
	}
	public String getReconReport() {
		return ReconReport;
	}
	public void setReconReport(String reconReport) {
	...
	public String toString() {
		return "Anx2ProcessedRecordsDto [UserID=" + UserID + ", SourceFileName="
				+ SourceFileName + ", ProfitCentre=" + ProfitCentre + ", Plant="
				...
				+ GLCodeSGST + ", GLCodeAdvaloremCess=" + GLCodeAdvaloremCess
				+ ", GLCodeSpecificCess=" + GLCodeSpecificCess
				+ ", GLCodeStateCess=" + GLCodeStateCess + ", ReturnPeriod="
				+ ReturnPeriod + ", RecipientGSTIN=" + RecipientGSTIN
				+ ", DocumentType=" + DocumentType + ", SupplyType="
				+ SupplyType + ", DocumentNumber=" + DocumentNumber
				+ ", DocumentDate=" + DocumentDate + ", OriginalDocumentNumber="
				+ OriginalDocumentNumber + ", OriginalDocumentDate="
				+ OriginalDocumentDate + ", CRDRPreGST=" + CRDRPreGST
				+ ", LineNumber=" + LineNumber + ", SupplierGSTIN="
				+ SupplierGSTIN + ", SupplierType=" + SupplierType
				+ ", DifferentialFlag=" + DifferentialFlag
				+ ", OriginalSupplierGSTIN=" + OriginalSupplierGSTIN
				+ ", SupplierName=" + SupplierName + ", SupplierCode="
				+ SupplierCode + ", SupplierAddress1=" + SupplierAddress1
				+ ", SupplierAddress2=" + SupplierAddress2
				+ ", SupplierAddress3=" + SupplierAddress3
				+ ", SupplierAddress4=" + SupplierAddress4 + ", POS=" + POS
				+ ", StateApplyingCess=" + StateApplyingCess + ", PortCode="
				+ PortCode + ", BillOfEntry=" + BillOfEntry
				+ ", BillOfEntryDate=" + BillOfEntryDate + ", CIFValue="
				+ CIFValue + ", CustomDuty=" + CustomDuty + ", HSNorSAC="
				+ HSNorSAC + ", ItemCode=" + ItemCode + ", ItemDescription="
				+ ItemDescription + ", CategoryOfItem=" + CategoryOfItem
				+ ", UnitOfMeasurement=" + UnitOfMeasurement + ", Quantity="
				+ Quantity + ", Section7ofIGSTFlag=" + Section7ofIGSTFlag
				+ ", TaxableValue=" + TaxableValue + ", IntegratedTaxRate="
				+ IntegratedTaxRate + ", IntegratedTaxAmount="
				+ IntegratedTaxAmount + ", CentralTaxRate=" + CentralTaxRate
				+ ", CentralTaxAmount=" + CentralTaxAmount + ", StateUTTaxRate="
				+ StateUTTaxRate + ", StateUTTaxAmount=" + StateUTTaxAmount
				+ ", AdvaloremCessRate=" + AdvaloremCessRate
				+ ", AdvaloremCessAmount=" + AdvaloremCessAmount
				+ ", SpecificCessRate=" + SpecificCessRate
				+ ", SpecificCessAmount=" + SpecificCessAmount
				+ ", StateCessRate=" + StateCessRate + ", StateCessAmount="
				+ StateCessAmount + ", OtherValue=" + OtherValue
				+ ", InvoiceValue=" + InvoiceValue + ", ClaimRefundFlag="
				+ ClaimRefundFlag + ", AutoPopulateToRefund="
				+ AutoPopulateToRefund + ", AdjustmentReferenceNo="
				...
				+ StateCessAmountAdjusted + ", ReverseChargeFlag="
				+ ReverseChargeFlag + ", EligibilityIndicator="
				+ EligibilityIndicator + ", CommonSupplyIndicator="
				+ CommonSupplyIndicator + ", AvailableIGST=" + AvailableIGST
				...
				+ ", UserDefinedField14=" + UserDefinedField14
				+ ", UserDefinedField15=" + UserDefinedField15
				+ ", EWayBillNumber=" + EWayBillNumber + ", EWayBillDate="
				+ EWayBillDate + ", ReturnType=" + ReturnType
				+ ", DataCategory=" + DataCategory + ", TableNumber="
				+ TableNumber + ", ASPInformationID=" + ASPInformationID
				+ ", ASPInformationDescription=" + ASPInformationDescription
				+ ", InvoiceValueASP=" + InvoiceValueASP + ", Data=" + Data
				+ ", UploadPeriod=" + UploadPeriod + ", CreditAvailedPeriod="
				+ CreditAvailedPeriod + ", ReconReport=" + ReconReport
				+ ", ReconResponse=" + ReconResponse + ", SaveStatus="
				+ SaveStatus + ", GSTNRefID=" + GSTNRefID + ", GSTNRefIDTime="
				+ GSTNRefIDTime + ", GSTNErrorCode=" + GSTNErrorCode
				+ ", GSTNErrorDescription=" + GSTNErrorDescription
				+ ", UploadSource=" + UploadSource + ", SourceID=" + SourceID
