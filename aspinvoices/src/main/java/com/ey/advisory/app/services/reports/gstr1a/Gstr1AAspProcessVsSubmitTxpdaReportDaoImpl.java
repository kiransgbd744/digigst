...
import com.google.common.base.Strings;
	...
	@Component("Gstr1AAspProcessVsSubmitTxpdaReportDaoImpl")
	public class Gstr1AAspProcessVsSubmitTxpdaReportDaoImpl
	...
	//	build.append("SUBSTR(HDR.GSTIN,1,2) AS STATE_CODE,'' STATE_NAME,");
		...
		build.append("FROM GETGSTR1A_TXPA_HEADER HDR ");
		build.append("INNER JOIN GETGSTR1A_TXPA_ITEM ITM ON HDR.ID = ITM.HEADER_ID ");
		...
		build.append("FROM GSTR1A_PROCESSED_ADV_ADJUSTMENT ADJ  ");
		...
		build.append("AND RETURN_TYPE='GSTR1A' LEFT OUTER JOIN FILE_STATUS FIL ON ADJ.FILE_ID=FIL.ID  ");
