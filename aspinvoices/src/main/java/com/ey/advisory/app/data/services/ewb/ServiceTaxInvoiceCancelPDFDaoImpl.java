 ...
 *
 */
@Component("ServiceTaxInvoiceCancelPDFDaoImpl")
@Slf4j
public class ServiceTaxInvoiceCancelPDFDaoImpl implements ServiceTaxCancelPDF {
	...
	public JasperPrint generateServiceTaxCancelPdfReport(String id,
			String docNo, String sgstin) {
		JasperPrint jasperPrint = null;
		Map<String, Object> parameters = new HashMap<>();
		String source = "jasperReports/ServiceInvoice (004).jrxml";
		if (LOGGER.isDebugEnabled()) {
			String msg = String.format(
					"Inside generateServiceTaxCancelPdfReport for docNo: %s", docNo);
			LOGGER.debug(msg);
		}
		...
		try {
			...
			parameters.put("EWBNumber",
					(out.getEwbNoresp() != null ? out.getEwbNoresp() + " " : "NA")
			...
			for (OutwardTransDocLineItem line : lineItems) {
				...
				productDetails.setInvoicestatecesscamount(stateCessAmount != null
			...
			File imgFile = ResourceUtils
					.getFile("classpath:jasperReports/CANCELLED WATERMARK-1.jpg");
