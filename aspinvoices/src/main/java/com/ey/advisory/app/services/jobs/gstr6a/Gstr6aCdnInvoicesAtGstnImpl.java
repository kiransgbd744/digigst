 ...
 *
 */
@Service("Gstr6aCdnInvoicesAtGstnImpl")
@Slf4j
public class Gstr6aCdnInvoicesAtGstnImpl implements Gstr6aInvoicesAtGstn {
	...
	public Long findInvFromGstn(Gstr6aGetInvoicesReqDto dto, String groupCode, String type, Long batchId) {
		...
		try {
			...
			throw new APIException("Unexpected error while executing Gstr6a Get Cdn");
