...
import com.ey.advisory.app.services.reports.Gstr1ASPAdvAdjSavableTotalDao;
...
@Component("Gstr1aASPAdvAdjSavableTotalDaoImpl")
public class Gstr1aASPAdvAdjSavableTotalDaoImpl
		implements Gstr1ASPAdvAdjSavableTotalDao {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(Gstr1aASPAdvAdjSavableTotalDaoImpl.class);
	...
	private static String createAdjSavableTotalQueryString(String buildQueryadj,
		...
		return "SELECT SUPPLIER_GSTIN,RETURN_PERIOD,TRAN_TYPE,MAX(MONTH)MONTH, "
				...
				+ "FROM GSTR1A_PROCESSED_ADV_ADJUSTMENT ADJ LEFT OUTER JOIN "
				+ "TF_GSTR1A_ERROR_INFO() GSTRERR ON "
				+ "ADJ.AS_ENTERED_ID= GSTRERR.COMMON_ID AND ADJ.FILE_ID=GSTRERR.FILE_ID "
				+ "AND GSTRERR.TABLE_TYPE='ADV ADJ' AND RETURN_TYPE='GSTR1A' "
				...
				+ "COMPLIANCE_APPLICABLE = TRUE AND HDR.RETURN_TYPE = 'GSTR1A' AND HDR.IS_DELETE = FALSE AND "
				...
				+ " '' FILE_NAME, '' ASP_DATE_TIME FROM GSTR1A_PROCESSED_ADV_ADJUSTMENT ADJ "
