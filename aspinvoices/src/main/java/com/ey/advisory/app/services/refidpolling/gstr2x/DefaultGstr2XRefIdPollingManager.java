 ...
 *
 */
@Service("DefaultGstr2XRefIdPollingManager")
public class DefaultGstr2XRefIdPollingManager implements Gstr2XRefIdPollingManger {
	
	private static final Logger LOGGER = LoggerFactory
			.getLogger(DefaultGstr2XRefIdPollingManager.class);

	@Autowired
	@Qualifier("DefaultGstr2XBatchIdPollingManager")
	...
	@Override
	public ResponseEntity<String> processGstr2XRefIds(PollingMessage reqDto, String groupcode) {
		List<Gstr1SaveBatchEntity> batches = new ArrayList<>();
		Gson gson = new Gson();
		List<ReturnStatusRefIdDto> b2bRefIdStatusList = new ArrayList<>();
