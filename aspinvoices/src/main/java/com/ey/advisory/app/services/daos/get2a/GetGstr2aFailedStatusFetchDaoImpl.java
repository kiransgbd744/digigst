...
@Component("GetGstr2aFailedStatusFetchDaoImpl")
public class GetGstr2aFailedStatusFetchDaoImpl
		implements GetGstr2aFailedStatusFetchDao {
	...
	public List<Object[]> findDataByCriteria(
		...
		LOGGER.debug(" Query from database is-->" + query.toString());

		List<Object[]> itemsList = query.getResultList();
		LOGGER.debug(" Query from database is-->" + itemsList.toString());
