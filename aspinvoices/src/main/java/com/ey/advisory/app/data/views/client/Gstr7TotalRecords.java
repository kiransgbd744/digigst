...
public class Gstr7TotalRecords {
	...
	public String getAspError() {
		return aspError;
	}

	public void setAspError(String aspError) {
	...
	public String toString() {
		return "Gstr7TotalRecords [aspError=" + aspError + ", gstnStatus=" + gstnStatus + ", gstnRefid=" + gstnRefid
