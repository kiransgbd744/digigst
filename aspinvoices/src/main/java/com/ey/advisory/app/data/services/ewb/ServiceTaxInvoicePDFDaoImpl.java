...
@Component("ServiceTaxInvoicePDFDaoImpl")
@Slf4j
public class ServiceTaxInvoicePDFDaoImpl implements ServiceTaxPdf {
	...
	public JasperPrint generateServiceTaxPdfReport(String id, String docNo,
		...
		String source = "jasperReports/ServiceInvoice (002).jrxml";
		if (LOGGER.isDebugEnabled()) {
			String msg = String.format(
					"Inside generateServiceTaxPdfReport for docNo: %s", docNo);
			LOGGER.debug(msg);
		}
		...
		try {
			...
			if (StringUtils.isEmpty(irn)) {
				if ((DOC_TYPE.contains(trimAndConvToUpperCase(out.getDocType()))
						...
						/*|| ((StringUtils.isEmpty(out.getCgstin())
								|| GSTConstants.URP
