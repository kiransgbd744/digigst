 ...
 *
 */
@Repository("Gstr1GetB2clGstnRepository")
@Transactional(propagation = Propagation.REQUIRED, readOnly = false)
public interface Gstr1GetB2clGstnRepository
		extends CrudRepository<GetGstr1B2clHeaderEntity, Long> {
	@Modifying
	@Query("UPDATE GetGstr1B2clHeaderEntity b SET b.isDelete = true,b.modifiedBy = 'SYSTEM'  , b.modifiedOn =:modifiedOn WHERE"
	...
	@Query("SELECT COUNT(*) FROM GetGstr1B2clHeaderEntity "
