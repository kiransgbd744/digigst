 ...
 */
	...
	@Repository("Gstr2GetGstr2BIsdHeaderRepository")
	@Transactional(propagation = Propagation.REQUIRED, readOnly = false)
	public interface Gstr2GetGstr2BIsdHeaderRepository
			extends CrudRepository<Gstr2GetGstr2BIsdHeaderEntity, Long>,
			JpaSpecificationExecutor<Gstr2GetGstr2BIsdHeaderEntity> {
		
		@Modifying
		@Query("UPDATE Gstr2GetGstr2BIsdHeaderEntity b SET b.isDelete = true, "
		...
		@Modifying
		@Query("UPDATE Gstr2GetGstr2BIsdHeaderEntity b SET b.status = 'SAVED', "
				+ " b.modifiedOn =:modifiedOn WHERE b.invocationId =:invocationId"
				+ " AND b.status = 'ONHOLD'")
		int updateStatus(@Param("invocationId") Long invocationId,
				@Param("modifiedOn") LocalDateTime modifiedOn);
		
		@Query("from Gstr2GetGstr2BIsdHeaderEntity where docKey=:docKey")
		List<Gstr2GetGstr2BIsdHeaderEntity> findByInvoiceKey(
				@Param("docKey") String docKey);
		
		@Modifying
		@Query("UPDATE Gstr2GetGstr2BIsdHeaderEntity b SET b.isDelete = true, b.modifiedOn =:modifiedOn  WHERE"
