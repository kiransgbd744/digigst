...
@Entity
@Table(name = "GETGSTR1_ATA_ITEM")
public class GetGstr1AtaItemEntity {
	
	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "GETGSTR1_ATA_ITEM_SEQ", allocationSize = 100)
	...
	private GetGstr1AtaHeaderEntity document;
	...
	public GetGstr1AtaHeaderEntity getDocument() {
		return document;
	}

	public void setDocument(GetGstr1AtaHeaderEntity document) {
