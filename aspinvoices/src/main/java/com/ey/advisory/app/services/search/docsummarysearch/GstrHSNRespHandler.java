...
@Service("GstrHSNRespHandler")
public class GstrHSNRespHandler {
	...
	public JsonElement handleHSNResp(List<? extends Gstr1SummaryDto> list,
			Gstr1SummaryReqDto gstr1SummaryRequest) {
		
		List<Gstr1BasicSummarySectionDto> hsnEySummary = new ArrayList<>();
		for (Gstr1SummaryDto gstr1Summary : list) {
			hsnEySummary = gstr1Summary.getHsn().getEySummary();
		}
...
*/				
				...
				JsonElement hsnRespBody = gstr1SummaryStructure
				.hsnStructure(hsnEySummary,gstnList);
