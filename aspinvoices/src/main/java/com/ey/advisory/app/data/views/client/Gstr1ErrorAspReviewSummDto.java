 ...
 *
 */
public class Gstr1ErrorAspReviewSummDto {
	...
	public String toString() {
		return "Gstr1ErrorAspReviewSummDto [userID=" + userID
				+ ", sourceFileName=" + sourceFileName + ", profitCentre="
				+ profitCentre + ", plant=" + plant + ", division=" + division
				+ ", location=" + location + ", salesOrganisation="
				+ salesOrganisation + ", distributionChannel="
				+ distributionChannel + ", userAccess1=" + userAccess1
				+ ", userAccess2=" + userAccess2 + ", userAccess3="
				+ userAccess3 + ", userAccess4=" + userAccess4
				+ ", userAccess5=" + userAccess5 + ", userAccess6="
				+ userAccess6 + ", gLCodeTaxableValue=" + gLCodeTaxableValue
				+ ", gLCodeIGST=" + gLCodeIGST + ", gLCodeCGST=" + gLCodeCGST
				+ ", gLCodeSGST=" + gLCodeSGST + ", gLCodeAdvlormCess="
				+ gLCodeAdvlormCess + ", gLCodeSpecificCess="
				+ gLCodeSpecificCess + ", gLCodeStateCess=" + gLCodeStateCess
				+ ", returnPeriod=" + returnPeriod + ", sgstin=" + sgstin
				+ ", docType=" + docType + ", supplyType=" + supplyType
				+ ", docNum=" + docNum + ", DocDate=" + DocDate
				+ ", OrgDocType=" + OrgDocType + ", precedNum=" + precedNum
				+ ", precedDate=" + precedDate + ", crdrPreGST=" + crdrPreGST
				+ ", itemNumber=" + itemNumber + ", recpGSTIN=" + recpGSTIN
				+ ", recpType=" + recpType + ", diffPerFlag=" + diffPerFlag
				+ ", orgRecpGSTIN=" + orgRecpGSTIN + ", recpName=" + recpName
				+ ", recpCode=" + recpCode + ", recpAdd1=" + recpAdd1
				+ ", recpAdd2=" + recpAdd2 + ", recpAdd3=" + recpAdd3
				+ ", recpAdd4=" + recpAdd4 + ", billToState=" + billToState
				+ ", shipToState=" + shipToState + ", pos=" + pos
				+ ", stateAplyCess=" + stateAplyCess + ", portCode=" + portCode
				...
				+ ", ewaybillDate=" + ewaybillDate + ", aspErrorCode="
				+ aspErrorCode + ", aspErrorDesc=" + aspErrorDesc
				+ ", aspInformationID=" + aspInformationID
				+ ", aspInformationDesc=" + aspInformationDesc
				+ ", uploadeSource=" + uploadeSource + ", sourceId=" + sourceId
				+ ", fileName=" + fileName + ", aspDateTime=" + aspDateTime
				+ "]";
	}
