...
import com.ey.advisory.app.docs.dto.simplified.Annexure1DeemExptEYFinalStructure;
 ...
 *
 */
@Service("Annexure1DeemExptStructure")
public class Annexure1DeemExptStructure {
	...
	@Autowired
	@Qualifier("Annexure1DeemExptEYFinalStructure")
	private Annexure1DeemExptEYFinalStructure deemExptEYFinalStructure;

	@Autowired
	@Qualifier("Gstr1SummaryDifference")
	private Gstr1SummaryDifference gstr1SummaryDifference;
	
	public JsonElement deemExptResp(
		...
		List<Annexure1SummaryRespDto> defaultEYList = 
				getDefaultDeemExptEYStructure();
		
		List<Annexure1SummaryRespDto> eyList = deemExptEYFinalStructure
				.getDeemExptEyList(defaultEYList, eySummaryListFromView);
