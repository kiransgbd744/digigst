 ...
 *
 */
@Component("EInvoicePDFGenerationReportService")
@Slf4j
public class EInvoicePDFGenerationReportService {
	...
	public String generateEinvoicePdfZip(File tempDir,
		...
		for (PdfPrintReqDto req : request) {
			...
			String fileName = "EInvoice_" + id + "_" + sgstin;
			...
			try (OutputStream outStream = new BufferedOutputStream(
				...
				JasperPrint jasperPrint = einvoicePdfReport
						.generateEinvoiceSummaryPdfReport(id, docNo, sgstin);
	...
	private String zipEinvoicePdfFiles(File tempDir) throws Exception {
		...
		String fileName = "EinvoicePdfReports";
