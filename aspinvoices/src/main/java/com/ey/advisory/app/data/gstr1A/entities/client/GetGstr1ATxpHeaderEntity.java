...
@Entity
@Table(name = "GETGSTR1A_TXP_HEADER")
public class GetGstr1ATxpHeaderEntity {

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "GETGSTR1A_TXP_HEADER_SEQ", allocationSize = 100)
	...
	protected List<GetGstr1ATxpItemEntity> lineItems = new ArrayList<>();
	...
	public List<GetGstr1ATxpItemEntity> getLineItems() {
		return lineItems;
	}

	public void setLineItems(List<GetGstr1ATxpItemEntity> lineItems) {
