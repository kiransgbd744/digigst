 ...
 */
@Entity
@Table(name = "GETANX1_B2B_ITEM")
public class GetAnx1B2bInvoicesItemEntity {
	...
	protected GetAnx1B2bInvoicesHeaderEntity header;
	...
	public GetAnx1B2bInvoicesHeaderEntity getHeader() {
		return header;
	}

	public void setHeader(GetAnx1B2bInvoicesHeaderEntity header) {
		this.header = header;
	}
}
