 ...
 *
 */
@Service("Gstr1ExpEInvAtGstnImpl")
@Slf4j
public class Gstr1ExpEInvAtGstnImpl implements Gstr1InvoicesAtGstn {
	...
	public Long findInvFromGstn(Gstr1GetInvoicesReqDto dto, String groupCode, String type, Long batchId) {
		if (LOGGER.isDebugEnabled()) {
			LOGGER.debug("I am from findEXPFromGstn Method type: {}", type);
		}
		...
		try {
			...
			throw new APIException("Unexpected error while executing Gstr1 Get Exp");
		}
		return reqId;
	}
