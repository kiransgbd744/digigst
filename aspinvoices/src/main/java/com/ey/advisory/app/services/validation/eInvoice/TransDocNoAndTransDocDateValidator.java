 ...
 *
 */
@Component("TransDocNoAndTransDocDateValidator")
public class TransDocNoAndTransDocDateValidator
	...
	public List<ProcessingResult> validate(OutwardTransDocument document,
		...
		if (MODE.contains(trimAndConvToUpperCase(document.getTransportMode()))) {
