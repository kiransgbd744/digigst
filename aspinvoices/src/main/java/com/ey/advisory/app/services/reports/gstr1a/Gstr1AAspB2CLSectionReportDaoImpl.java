...
@Component("Gstr1AAspB2CLSectionReportDaoImpl")
public class Gstr1AAspB2CLSectionReportDaoImpl
		implements Gstr1AReviewSummaryReportsDao {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(Gstr1AAspB2CLSectionReportDaoImpl.class);
...
//				.findAnswerForMultiSupplyType();
	...
	private static String createApiProcessedQueryString(String buildHeader,
			...
			return "SELECT TRIM(', ' FROM IFNULL(HDR.ERROR_CODES,'') ||','|| "
					...
					+ "AND HDR.RETURN_TYPE='GSTR1A' AND HDR.TAX_DOC_TYPE IN ('B2CL') "
