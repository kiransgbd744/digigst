 ...
 *
 */
@Component("Gstr1ReviewSummaryProcessedReportsDaoImpl")
public class Gstr1ReviewSummaryProcessedReportsDaoImpl
		implements Gstr1ReviewSummaryReportsDao {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(Gstr1ReviewSummaryProcessedReportsDaoImpl.class);
	...
	private static String createApiProcessedQueryString(String buildHeader) {
		...
		return "SELECT '' AS ERROR_CODE_ASP, '' AS ERROR_DESCRIPTION_ASP, TRIM(',' FROM IFNULL(HDR.INFORMATION_CODES,'')||','|| "
				...
				+ "HDR.RETURN_TYPE AS RET_TYPE, ITM.ITM_TABLE_SECTION AS TABLE_NUMBER, HDR.IRN, HDR.IRN_DATE,HDR.TAX_SCHEME, "
				...
				+ "ITM.TCS_AMT AS TCSAMOUNT, HDR.CUST_SUPP_ADDRESS3, HDR.TAX_DOC_TYPE AS DATA_CATEGORY,ITM.ITM_UQC,ITM.ITM_QTY,CASE WHEN PSD.USER_RESPONSE='S' "
				+ " THEN 'S-Save to GSTN' WHEN PSD.USER_RESPONSE ='N' THEN 'N-Do not save to GSTN'  "
				+ " ELSE '' END AS EINVVSGSTR1RESPONSE "
				...
				+ "AND HDR.IS_DELETE=FALSE AND HDR.RETURN_TYPE='GSTR1' AND HDR.TAX_DOC_TYPE NOT IN ('B2CS','NILEXTNON') "
