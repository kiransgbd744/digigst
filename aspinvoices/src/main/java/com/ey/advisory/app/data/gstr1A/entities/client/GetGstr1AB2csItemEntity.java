...
@Entity
@Table(name = "GETGSTR1A_B2CS_ITEM")

public class GetGstr1AB2csItemEntity {

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "GETGSTR1A_B2CS_ITEM_SEQ", allocationSize = 100)
	...
	private GetGstr1AB2csHeaderEntity document;
	...
	public GetGstr1AB2csHeaderEntity getDocument() {
		return document;
	}

	public void setDocument(GetGstr1AB2csHeaderEntity document) {
