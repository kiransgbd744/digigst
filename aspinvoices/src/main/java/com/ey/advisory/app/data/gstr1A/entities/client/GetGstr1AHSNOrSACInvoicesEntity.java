 ...
 */
@Entity
@Table(name = "GETGSTR1A_HSNORSAC")
@ToString
@Getter
@Setter
public class GetGstr1AHSNOrSACInvoicesEntity {

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "GETGSTR1A_HSNORSAC_SEQ", allocationSize = 100)
