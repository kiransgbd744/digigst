...
@Entity
@Table(name = "GETGSTR1A_CDNUR_ITEM")
public class GetGstr1ACdnurItemEntity {

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "GETGSTR1_CDNUR_ITEM_SEQ", allocationSize = 100)
	...
	private GetGstr1ACdnurHeaderEntity document;
	...
	public GetGstr1ACdnurHeaderEntity getDocument() {
		return document;
	}

	public void setDocument(GetGstr1ACdnurHeaderEntity document) {
