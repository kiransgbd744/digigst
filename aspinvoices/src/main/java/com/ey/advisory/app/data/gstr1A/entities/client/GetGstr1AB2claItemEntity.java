...
@Entity
@Table(name = "GETGSTR1A_B2CLA_ITEM")
public class GetGstr1AB2claItemEntity {

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "GETGSTR1A_B2CLA_ITEM_SEQ", allocationSize = 100)
	...
	private GetGstr1AB2claHeaderEntity document;
	...
	public GetGstr1AB2claHeaderEntity getDocument() {
		return document;
	}

	public void setDocument(GetGstr1AB2claHeaderEntity document) {
