 ...
 * 
 */
	@Component("Gstr2GetIMPGReportDaoImpl")
	@Slf4j
	public class Gstr2GetIMPGReportDaoImpl implements Gstr1aGetDao {
		...
		private String creategstnB2CSSummaryQueryString(String buildQuery) {
			...
			return "SELECT RETURN_PERIOD,CGSTIN,SGSTIN,LEGAL_NAME,TRADE_NAME,"
					...
					+ " GROUP BY "
					+ "RET_PERIOD,HDR.GSTIN,LEGAL_NAME_BS,TRADE_NAME,PORT_CODE,"
