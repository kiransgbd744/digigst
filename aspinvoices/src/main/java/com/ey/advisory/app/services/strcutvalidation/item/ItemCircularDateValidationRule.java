...
public class ItemCircularDateValidationRule implements ValidationRule {
	...
	public List<ProcessingResult> isValid(Object obj, Object[] row,
		...
		if (obj != null) {
			...
			if (obj.toString().contains(" ") || date == null) {
				...
				errorLocations.add(GSTConstants.CIRCULARDATE);
				TransDocProcessingResultLoc location = new TransDocProcessingResultLoc(
						null, errorLocations.toArray());
				errors.add(new ProcessingResult(APP_VALIDATION, "ER1654",
						"Invalid Circular date", location));
				return errors;
			}
		}
