 ...
 *
 */
@Component("SetOffAndUtilBusinessValidationChain")
public class SetOffAndUtilBusinessValidationChain 
                   implements DocRulesValidatorChain<SetOffAndUtilExcelEntity> {
	private static final Logger LOGGER = 
			LoggerFactory.getLogger(SetOffAndUtilBusinessValidationChain.class);
...
private static final BusinessRuleValidator[] VALIDATORS = {
		new SetOffAndUtilGstin(),
		new SetOffAndUtilReturnPeriod(),
		};
...
public List<ProcessingResult> validate(SetOffAndUtilExcelEntity document,
	...
	for(BusinessRuleValidator<SetOffAndUtilExcelEntity> 
