...
@Service("Gstr1AInvoiceFileArrivalHandler")
public class Gstr1AInvoiceFileArrivalHandler {
	private static final Logger LOGGER = LoggerFactory
			.getLogger(Gstr1AInvoiceFileArrivalHandler.class);
	...
	@Autowired
	@Qualifier("Gstr1AInvoiceStructureService")
	private Gstr1AInvoiceStructureService gstr1InvoiceStructureService;
