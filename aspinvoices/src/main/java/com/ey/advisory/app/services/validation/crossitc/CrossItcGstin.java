 ...
 *
 */
public class CrossItcGstin
		implements B2csBusinessRuleValidator<CrossItcAsEnteredEntity> {
	...
	@Override
	public List<ProcessingResult> validate(CrossItcAsEnteredEntity document,
		...
		if (document.getIsdGstin() != null && !document.getIsdGstin().isEmpty()) {
			...
			GSTNDetailEntity gstin = ehcachegstin.getGstinInfo(groupCode,
					GenUtil.trimAndConvToUpperCase(document.getIsdGstin()));
			if (gstin == null) {
