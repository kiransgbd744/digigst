...
@Component("Gstr2aVsGstr3bReviewSummaryFetchDaoImpl")
public class Gstr2aVsGstr3bReviewSummaryFetchDaoImpl {
    private static final Logger LOGGER = LoggerFactory
            .getLogger(Gstr2aVsGstr3bReviewSummaryFetchDaoImpl.class);
