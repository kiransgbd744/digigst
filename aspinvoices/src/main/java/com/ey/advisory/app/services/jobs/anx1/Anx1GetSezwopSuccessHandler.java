...
import com.ey.advisory.app.data.repositories.client.gstr2.GetAnx1SezwopInvoicesRepository;
...
@Service("Anx1GetSezwopSuccessHandler")
@Slf4j
public class Anx1GetSezwopSuccessHandler implements SuccessHandler {

	@Autowired
	@Qualifier("Anx1SezwopDataParserImpl")
	private Anx1SezwopDataParser anx1SezwopDataParser;

	@Autowired
	@Qualifier("GetAnx1SezwopInvoicesRepository")
	private GetAnx1SezwopInvoicesRepository headerRepo;
	...
	public void handleSuccess(SuccessResult result, String apiParams) {
		try {
			...
			if (LOGGER.isDebugEnabled()) {
				LOGGER.debug(
						"GET Call is Success for the batchId {} inside Anx1GetSezwopSuccessHandler.class",
			...
			resultIds.forEach(id -> {
				...
				Set<GetAnx1SezwopInvoicesHeaderEntity> b2cEntities = anx1SezwopDataParser
