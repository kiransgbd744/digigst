 ...
 *
 */
@Service("Gstr1AdvSimpleDocSummarySearchService")
public class Gstr1AdvSimpleDocSummarySearchService implements SearchService{

	private static final Logger LOGGER = LoggerFactory
			.getLogger(Gstr1AdvSimpleDocSummarySearchService.class);
	
	@Autowired
	@Qualifier("SimpleGstr1AdvBasicSummarySectionFetcher")
	SimpleGstr1AdvBasicSummarySectionFetcher fetcher;
