...
public class ApiSummaryResDto {
	...
	public String toString() {
		return "ApiSummaryResDto [receivedDate=" + receivedDate + ", docDate="
				+ docDate + ", gstin=" + gstin + ", period=" + period
				+ ", section=" + section + ", count=" + count
				+ ", taxableValue=" + taxableValue + ", toatlTaxes="
				+ toatlTaxes + ", igst=" + igst + ", cgst=" + cgst + ", sgst="
				+ sgst + ", cess=" + cess + ", authToken=" + authToken
				+ ", status=" + status + "]";
	}
	
	

	public ApiSummaryResDto(String section) {
		this.section = section;
	}

	public ApiSummaryResDto(LocalDate receivedDate, LocalDate docDate,
			String gstin, String period, String section, Integer count,
	...
	public ApiSummaryResDto add(ApiSummaryResDto newObj) {
