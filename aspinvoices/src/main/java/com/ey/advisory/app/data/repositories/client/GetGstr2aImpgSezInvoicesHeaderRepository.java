...
@Repository("GetGstr2aImpgSezInvoicesHeaderRepository")
@Transactional(propagation = Propagation.REQUIRED, readOnly = true)
public interface GetGstr2aImpgSezInvoicesHeaderRepository
		extends CrudRepository<GetGstr2aImpgSezHeaderEntity, Long> {

	@Modifying
	@Transactional
	@Query("UPDATE GetGstr2aImpgSezHeaderEntity SET "
	...
	@Query("SELECT distinct erpBatchId FROM GetGstr2aImpgSezHeaderEntity WHERE "
			+ "gstin=:cgstin AND batchId=:batchId "
