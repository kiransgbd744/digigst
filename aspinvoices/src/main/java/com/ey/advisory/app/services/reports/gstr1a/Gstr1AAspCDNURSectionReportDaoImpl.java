...
import com.google.common.base.Strings;
	...
	@Component("Gstr1AAspCDNURSectionReportDaoImpl")
	public class Gstr1AAspCDNURSectionReportDaoImpl
			implements Gstr1AReviewSummaryReportsDao {

		private static final Logger LOGGER = LoggerFactory
				.getLogger(Gstr1AAspCDNURSectionReportDaoImpl.class);
...
//					.findAnswerForMultiSupplyType(); 
		...
		private static String createApiProcessedQueryString(String buildHeader, String multiSupplyTypeAns) {
				...
				+ "AND HDR.RETURN_TYPE='GSTR1A' AND HDR.TAX_DOC_TYPE IN ('CDNUR','CDNUR-B2CL','CDNUR-EXPORTS') " + buildHeader
