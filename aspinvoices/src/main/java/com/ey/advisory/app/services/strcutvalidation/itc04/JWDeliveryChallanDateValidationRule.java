...
public class JWDeliveryChallanDateValidationRule implements ValidationRule {
	...
	public List<ProcessingResult> isValid(int idx, Object obj, Object[] row,
		...
		if (date == null) {
			...
			errors.add(new ProcessingResult(APP_VALIDATION, "ER5815",
					"Invalid JWDeliveryChallanDate.", location));
			return errors;
		}
		return errors;
	}
