...
public class Anx2InwardErrorRecordsDto {
	...
	public void setASPErrorDescription(String aSPErrorDescription) {
		ASPErrorDescription = aSPErrorDescription;
	}
	...
	public String toString() {
		return "Anx2InwardErrorRecordsDto [UserID=" + UserID
				...
				+ EWayBillDate + ", ASPErrorCode=" + ASPErrorCode
				+ ", ASPErrorDescription=" + ASPErrorDescription
				+ ", ASPInformationID=" + ASPInformationID
				+ ", ASPInformationDescription=" + ASPInformationDescription
