...
import com.ey.advisory.core.search.SearchCriteria;
	...
	@Component("AspSecB2CSSavableSummaryLevelDaoImpl")
	public class AspSecB2CSSavableSummaryLevelDaoImpl
			implements Gstr1ASPB2CSSavableSummaryLevelDao {

		private static final Logger LOGGER = LoggerFactory
				.getLogger(AspSecB2CSSavableSummaryLevelDaoImpl.class);
		...
		public List<Object> getGstr1B2CSSavableReports(SearchCriteria criteria) {
			...
			if (taxPeriodFrom != null && taxPeriodTo != null) {
				buildQuery.append(" AND B2CS.DERIVED_RET_PERIOD BETWEEN ");
