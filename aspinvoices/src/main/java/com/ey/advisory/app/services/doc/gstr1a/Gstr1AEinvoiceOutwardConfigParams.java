 ...
 *
 */
@Component("Gstr1AEinvoiceOutwardConfigParams")
public class Gstr1AEinvoiceOutwardConfigParams {

	public void configurableParameters(Gstr1AOutwardTransDocument document,
	...
	private void setDocAmount(Gstr1AOutwardTransDocument document,
			Map<String, String> questionAnsMap) {
			...
			if (ansA.equalsIgnoreCase(o1SelectedAnswer)) {
				if ((document.getSupplyType() != null) && (SUPPLY_TYPE.contains(
					...
					if (null != document.getLineItems()) {
						for (Gstr1AOutwardTransDocLineItem item : document
								.getLineItems()) {
	...
	public void configurebleOnboardingLineItemAmt(
	...
	private void setOnbLineItemAmt(Gstr1AOutwardTransDocument document,
			Map<String, String> questionAnsMap) {
