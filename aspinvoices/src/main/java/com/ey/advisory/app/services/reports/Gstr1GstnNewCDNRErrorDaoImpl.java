 ...
 *
 */
@Component("Gstr1GstnNewCDNRErrorDaoImpl")
public class Gstr1GstnNewCDNRErrorDaoImpl implements Gstr1GstnErrorDao {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(Gstr1GstnNewCDNRErrorDaoImpl.class);
