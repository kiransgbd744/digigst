...
public class Anx1AspConsolidatedErrorDto {
	...
	public String getAspInfoDesc() {
		return aspInfoDesc;
	}

	public void setAspInfoDesc(String aspInfoDesc) {
		this.aspInfoDesc = aspInfoDesc;
	}
