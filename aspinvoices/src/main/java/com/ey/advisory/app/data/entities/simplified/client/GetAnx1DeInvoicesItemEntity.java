 ...
 */
@Entity
@Table(name = "GETANX1_DE_ITEM")
public class GetAnx1DeInvoicesItemEntity {
	...
	protected GetAnx1DeInvoicesHeaderEntity header;
	...
	public GetAnx1DeInvoicesHeaderEntity getHeader() {
		return header;
	}

	public void setHeader(GetAnx1DeInvoicesHeaderEntity header) {
		this.header = header;
	}
