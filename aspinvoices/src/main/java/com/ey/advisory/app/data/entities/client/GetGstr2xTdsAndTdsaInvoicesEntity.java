 ...
 */
@Entity
@Table(name = "GETGSTR2X_TDS_TDSA")
@Data
public class GetGstr2xTdsAndTdsaInvoicesEntity {

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "GETGSTR2X_TDS_TDSA_SEQ", allocationSize = 100)
