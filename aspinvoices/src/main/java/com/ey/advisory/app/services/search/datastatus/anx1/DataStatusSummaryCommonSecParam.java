...
@Component("DataStatusSummaryCommonSecParam")
public class DataStatusSummaryCommonSecParam {

	public DataStatusApiSummaryReqDto setDataSecuritySearchParams(
			DataStatusApiSummaryReqDto dataStatusApiSummaryReqDto) {

		List<Long> entityIds = dataStatusApiSummaryReqDto.getEntityId();
		...
		if("outward".equalsIgnoreCase(dataType)){
			...
			if (dataStatusApiSummaryReqDto.getDataSecAttrs() == null
					|| dataStatusApiSummaryReqDto.getDataSecAttrs().isEmpty()) {
				dataStatusApiSummaryReqDto.setDataSecAttrs(dataSecurityAttrMap);
			} else {
				Map<String, List<String>> dataSecReqMap = dataStatusApiSummaryReqDto
						.getDataSecAttrs();
...
//				}
		...
		return dataStatusApiSummaryReqDto;
