...
@Entity
@Table(name = "GETGSTR1A_B2CLA_HEADER")
public class GetGstr1AB2claHeaderEntity {

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "GETGSTR1A_B2CLA_HEADER_SEQ", allocationSize = 100)
	...
	protected List<GetGstr1AB2claItemEntity> lineItems = new ArrayList<>();
	...
	public List<GetGstr1AB2claItemEntity> getLineItems() {
		return lineItems;
	}

	public void setLineItems(List<GetGstr1AB2claItemEntity> lineItems) {
