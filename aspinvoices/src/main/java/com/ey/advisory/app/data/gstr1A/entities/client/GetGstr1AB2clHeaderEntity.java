...
@Entity
@Table(name = "GETGSTR1A_B2CL_HEADER")
public class GetGstr1AB2clHeaderEntity {

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "GETGSTR1A_B2CL_HEADER_SEQ", allocationSize = 100)
	...
	protected List<GetGstr1AB2clItemEntity> lineItems = new ArrayList<>();
	...
	public List<GetGstr1AB2clItemEntity> getLineItems() {
		return lineItems;
	}

	public void setLineItems(List<GetGstr1AB2clItemEntity> lineItems) {
