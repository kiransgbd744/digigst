...
@Entity
@Table(name = "GETGSTR1_B2CLA_ITEM")
public class GetGstr1B2claItemEntity {

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "GETGSTR1_B2CLA_ITEM_SEQ", allocationSize = 100)
	...
	private GetGstr1B2claHeaderEntity document;
	...
	public GetGstr1B2claHeaderEntity getDocument() {
		return document;
	}

	public void setDocument(GetGstr1B2claHeaderEntity document) {
