...
@Entity
@Table(name = "GSTR1_PROCESSED_INV_SERIES")
@Data
public class Gstr1InvoiceFileUploadEntity {

	@Expose
	@SerializedName("id")
	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "GSTR1_PROCESSED_INV_SERIES_SEQ", allocationSize = 100)
