 ...
 *
 */
public class JobWorkeGstinValidationRule implements ValidationRule {
	...
	public List<ProcessingResult> isValid(int idx, Object obj, Object[] row,
		...
		if (matcher.matches() || matcher1.matches() 
			...
			errors.add(new ProcessingResult(APP_VALIDATION, "ER5821",
					"Invalid JobWorkerGSTIN.", location));
			return errors;
		}
