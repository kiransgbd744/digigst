 ...
 */
@Entity
@Table(name = "GETANX1_DE_HEADER")
public class GetAnx1DeInvoicesHeaderEntity {
	...
	protected List<GetAnx1DeInvoicesItemEntity> lineItems = new ArrayList<>();

	@Column(name = "BATCH_ID")
	private Long deBatchId;
	...
	public List<GetAnx1DeInvoicesItemEntity> getLineItems() {
		return lineItems;
	}

	public void setLineItems(List<GetAnx1DeInvoicesItemEntity> lineItems) {
		this.lineItems = lineItems;
	}

	/*
	 * public GetAnx1BatchEntity getDeBatchId() { return deBatchId; }
	 * 
	 * public void setDeBatchId(GetAnx1BatchEntity deBatchId) { this.deBatchId =
	 * deBatchId; }
	 */
	...
	public Long getDeBatchId() {
		return deBatchId;
	}

	public void setDeBatchId(Long deBatchId) {
