...
import com.ey.advisory.app.util.OnboardingConstant.
CONFIG_PARAM_OUTWARD_ANS_KEY_ID;
 ...
 *
 */
@Component("OrgHierarchyMasterDataUpdation")
public class OrgHierarchyMasterDataUpdation {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(OrgHierarchyMasterDataUpdation.class);
