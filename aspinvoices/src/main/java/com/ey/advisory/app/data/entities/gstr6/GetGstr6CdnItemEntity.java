 ...
 */
@Entity
@Table(name = "GETGSTR6_CDN_ITEM")
public class GetGstr6CdnItemEntity {

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "GETGSTR6_CDN_ITEM_SEQ", allocationSize = 100)
	...
	protected GetGstr6CdnHeaderEntity document;
	...
	public GetGstr6CdnHeaderEntity getDocument() {
		return document;
	}

	public void setDocument(GetGstr6CdnHeaderEntity document) {
