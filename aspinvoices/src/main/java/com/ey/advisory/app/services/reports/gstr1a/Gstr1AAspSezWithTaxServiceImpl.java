...
import com.ey.advisory.core.search.SearchCriteria;
	...
	@Service("Gstr1AAspSezWithTaxServiceImpl")
	public class Gstr1AAspSezWithTaxServiceImpl
			implements Gstr1AReviewSummReportsService {

		private static final Logger LOGGER = LoggerFactory
				.getLogger(Gstr1AAspSezWithTaxServiceImpl.class);

		@Autowired
		CommonUtility commonUtility;

		@Autowired
		@Qualifier("Gstr1AAspSezSectionReportDaoImpl")
