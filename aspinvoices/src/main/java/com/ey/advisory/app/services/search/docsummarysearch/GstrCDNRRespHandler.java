...
@Service("GstrCDNRRespHandler")
public class GstrCDNRRespHandler {
	...
	public JsonElement handleCDNRResp(List<? extends Gstr1SummaryDto> list,
			Gstr1SummaryReqDto gstr1SummaryRequest) {
		

		List<Gstr1BasicSummarySectionDto> cdnrEySummary = new ArrayList<>();
		for (Gstr1SummaryDto gstr1Summary : list) {
			cdnrEySummary = gstr1Summary.getCdnr().getEySummary();
		}
...
*/				
		...
		JsonElement cdnrRespBody = gstr1SummaryStructure
				.cdnrStructure(cdnrEySummary, gstnList);
