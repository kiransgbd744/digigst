...
@Entity
@Table(name = "GETGSTR1A_CDNR_HEADER")
public class GetGstr1ACdnrHeaderEntity {

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "GETGSTR1A_CDNR_HEADER_SEQ", allocationSize = 100)
	...
	protected List<GetGstr1ACdnrItemEntity> lineItems = new ArrayList<>();
	...
	public List<GetGstr1ACdnrItemEntity> getLineItems() {
		return lineItems;
	}

	public void setLineItems(List<GetGstr1ACdnrItemEntity> lineItems) {
