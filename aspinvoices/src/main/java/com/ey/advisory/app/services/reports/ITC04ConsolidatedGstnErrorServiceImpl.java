 ...
 * 
 */
@Service("ITC04ConsolidatedGstnErrorServiceImpl")
public class ITC04ConsolidatedGstnErrorServiceImpl {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(ITC04ConsolidatedGstnErrorServiceImpl.class);

	@Autowired
	CommonUtility commonUtility;

	@Autowired
	@Qualifier("ITC04ConsolidatedGstnErrorReportDaoImpl")
	private ITC04ConsolidatedGstnErrorReportDaoImpl iTC04ConsolidatedGstnErrorReportDaoImpl;

	public Workbook findgstnerror(Gstr6SummaryRequestDto setDataSecurity,
			PageRequest pageReq) {
		...
		responseFromView = iTC04ConsolidatedGstnErrorReportDaoImpl
				.getGstnErrorReport(request);
