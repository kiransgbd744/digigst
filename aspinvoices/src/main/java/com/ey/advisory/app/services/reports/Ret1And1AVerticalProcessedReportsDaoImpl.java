...
@Component("Ret1And1AVerticalProcessedReportsDaoImpl")
public class Ret1And1AVerticalProcessedReportsDaoImpl
	...
	private static final Logger LOGGER = LoggerFactory
			.getLogger(Ret1And1AVerticalProcessedReportsDaoImpl.class);
	...
	public List<Object> getRet1VerticalReports(
		 ...
		 */
		String queryStr = createVerticalProcessQueryString(
				buildQuery.toString());
		...
		List<Object> retList = list.parallelStream()
				.map(o -> convertVerticalProcess(o))
				.collect(Collectors.toCollection(ArrayList::new));
		return retList;
	}

	private Object convertVerticalProcess(Object[] arr) {
	...
	private String createVerticalProcessQueryString(String buildQuery) {
		String queryStr = "";
		...
		if ((DownloadReportsConstant.RET1AND1A).equalsIgnoreCase(fileType)) {
			queryStr = "SELECT RETURN_TYPE,GSTIN,RETURN_PERIOD,RETURN_TABLE,"
					...
					+ "WHERE HI.IS_DELETE = FALSE AND " + buildQuery;
