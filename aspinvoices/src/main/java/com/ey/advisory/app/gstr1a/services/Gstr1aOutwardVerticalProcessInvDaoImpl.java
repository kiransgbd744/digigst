...
@Component("Gstr1aOutwardVerticalProcessInvDaoImpl")
public class Gstr1aOutwardVerticalProcessInvDaoImpl
		implements Gstr1OutwardVerticalProcessInvDao {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(Gstr1aOutwardVerticalProcessInvDaoImpl.class);
	...
	private String createB2CSSavableSummaryQueryString(String buildQuery) {
		...
		return "select INV.SUPPLIER_GSTIN,INV.RETURN_PERIOD,"
				...
				+ "INV.CREATED_ON FROM GSTR1A_PROCESSED_INV_SERIES INV "
