...
@Entity
@Table(name = "GETGSTR1_B2CSA_HEADER")
public class GetGstr1B2csaHeaderEntity {

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "GETGSTR1_B2CSA_HEADER_SEQ", allocationSize = 100)
	...
	protected List<GetGstr1B2csaItemEntity> lineItems = new ArrayList<>();
	...
	public List<GetGstr1B2csaItemEntity> getLineItems() {
		return lineItems;
	}

	public void setLineItems(List<GetGstr1B2csaItemEntity> lineItems) {
