...
import com.google.common.base.Strings;
	...
	@Component("Gstr1AAspSezWopSectionReportDaoImpl")
	public class Gstr1AAspSezWopSectionReportDaoImpl
			implements Gstr1AReviewSummaryReportsDao {

		private static final Logger LOGGER = LoggerFactory
				.getLogger(Gstr1AAspSezWopSectionReportDaoImpl.class);
		...
		private String createApiProcessedQueryString(String buildHeader) {
			...
			return "SELECT TRIM(', ' FROM IFNULL(HDR.ERROR_CODES,'') ||','|| "
				...
				+ "AND HDR.RETURN_TYPE='GSTR1A' AND HDR.TAX_DOC_TYPE IN ('B2B') AND HDR.SUPPLY_TYPE = 'SEZWOP' " 
				+ buildHeader
