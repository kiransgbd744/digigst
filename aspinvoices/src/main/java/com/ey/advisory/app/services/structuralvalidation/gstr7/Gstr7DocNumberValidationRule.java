 ...
 *
 */
public class Gstr7DocNumberValidationRule implements ValidationRule {
	...
	public List<ProcessingResult> isValid(int idx,Object obj, Object[] row,
		...
		if (obj.toString().length() > 16) {
			...
			errors.add(new ProcessingResult(APP_VALIDATION, "ER2032",
					"Invalid Invoice Number", location));
			return errors;
