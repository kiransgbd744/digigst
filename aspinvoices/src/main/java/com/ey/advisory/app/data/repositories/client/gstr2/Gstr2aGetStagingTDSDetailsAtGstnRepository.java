 ...
 *
 */
@Repository("Gstr2aGetStagingTDSDetailsAtGstnRepository")
@Transactional(propagation = Propagation.REQUIRED, readOnly = false)
public interface Gstr2aGetStagingTDSDetailsAtGstnRepository 
extends CrudRepository<GetGstr2aStagingTDSDetailsEntity, Long> {

	//Curently isDelete is not added in table
	@Modifying
	@Query("UPDATE GetGstr2aStagingTDSDetailsEntity b SET b.isDelete = true ,b.modifiedBy = 'SYSTEM'  , b.modifiedOn =:modifiedOn  WHERE"
