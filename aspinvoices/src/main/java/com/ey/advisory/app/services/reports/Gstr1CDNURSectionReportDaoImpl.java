...
@Component("Gstr1CDNURSectionReportDaoImpl")
public class Gstr1CDNURSectionReportDaoImpl
		implements Gstr1ReviewSummaryCustomizedReportsDao {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(Gstr1CDNURSectionReportDaoImpl.class);
	...
	private static String createApiProcessedQueryStringForGstr1a(String buildHeader) {
		...
		+ "AND HDR.TAX_DOC_TYPE IN ('CDNUR','CDNUR-EXPORTS','CDNUR-B2CL') "
