...
@Component("Gstr1AAspProcessVsSubmitAtAReportDaoImpl")
public class Gstr1AAspProcessVsSubmitAtAReportDaoImpl
	...
	//	build.append("SUPPLY_TYPE,SUBSTR(HDR.GSTIN,1,2) AS STATE_CODE,'' STATE_NAME,");
		...
		build.append("FROM GETGSTR1A_ATA_HEADER HDR ");
		build.append("INNER JOIN GETGSTR1A_ATA_ITEM ITM ON HDR.ID = ITM.HEADER_ID  ");
		...
		build.append("FROM GSTR1A_PROCESSED_ADV_RECEIVED REC ");
		...
		build.append("AND GSTRERR.TABLE_TYPE='ADV REC-A' AND RETURN_TYPE='GSTR1A'  ");
