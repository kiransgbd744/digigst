 ...
 *
 */
@Service("Gstr2bB2bFileArrivalHandler")
public class Gstr2bB2bFileArrivalHandler {
	private static final Logger LOGGER = LoggerFactory
			.getLogger(Gstr2bB2bFileArrivalHandler.class);
	...
	private Gstr2bFileProcessService gstr2bFileProcessService;

	public void processGstr2bB2bFile(Message message, AppExecContext context) {
		

		if (LOGGER.isDebugEnabled()) {
			LOGGER.debug("processGstr2bFile");
		}
		...
		// Extract the File Arrival message from the serialized Job paramsobject.
		...
		try {
			 fileName="042022_29AAAPH9357H000_GSTR2B_21052022_111.xlsx";
			
			String filePath = "C:/Users/QE793HL/OneDrive - EY/Desktop/gstr2b testing/042022_29AAAPH9357H000_GSTR2B_21052022_111.xlsx";
			 inputStream = new FileInputStream(filePath);
		}*/
		catch (Exception e) {

			String msg1 = "Exception occured in gstr2b File Arrival Processor";
			e.printStackTrace();
			LOGGER.error(msg1, e);
		...
		try {
			int count = gstr2bFileProcessService.processGstr2File(inputStream,
					fileName, null);
			...
			String msg1 = "Error occured while processing the Gstr2b file:: ";
			e.printStackTrace();
			LOGGER.error(msg1, e);
			throw new APIException(msg1, e);
		}
