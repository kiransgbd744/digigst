 ...
 *
 */
@Repository("Gstr1GetB2csaGstnRepository")
@Transactional(propagation = Propagation.REQUIRED, readOnly = false)
public interface Gstr1GetB2csaGstnRepository
		extends CrudRepository<GetGstr1B2csaHeaderEntity, Long> {
	@Modifying
	@Query("UPDATE GetGstr1B2csaHeaderEntity b SET b.isDelete = true,b.modifiedBy = 'SYSTEM'  , b.modifiedOn =:modifiedOn   WHERE"
	...
	@Query("SELECT COUNT(*) FROM GetGstr1B2csaHeaderEntity "
