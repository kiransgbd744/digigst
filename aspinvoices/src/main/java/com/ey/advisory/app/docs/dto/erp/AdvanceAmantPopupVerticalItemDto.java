...
@Data
public class AdvanceAmantPopupVerticalItemDto {
	...
	@XmlElement(name="ObillingPos")
	private String obillingPos;
	
	@XmlElement(name="Orate")
	private BigDecimal orate;
	
	@XmlElement(name="Ogar")
	private BigDecimal ogar;
	
	
	@XmlElement(name = "NbillingPos")
	private String nbillingPos;

	@XmlElement(name = "Nrate")
