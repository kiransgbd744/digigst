 ...
 *
 */
public class GSTR1GetEInvoicesTableDto {
	...
	private String itemAssessAmount;
	...
	public String getItemAssessAmount() {
		return itemAssessAmount;
	}

	public void setItemAssessAmount(String itemAssessAmount) {
