...
public class CessSpecificRateValidationRule implements ValidationRule {
	...
	public List<ProcessingResult> isValid(int idx, Object obj, Object[] row,
		...
		if (!isDecimal(igstRate)) {
			...
			errors.add(new ProcessingResult(APP_VALIDATION, "ER5848",
					"Invalid CessSpecificRate.", location));
