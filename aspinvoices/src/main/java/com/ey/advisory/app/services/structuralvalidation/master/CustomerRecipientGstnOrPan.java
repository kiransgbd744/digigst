...
public class CustomerRecipientGstnOrPan implements ValidationRule {
	...
	public List<ProcessingResult> isValid(Object obj, Object[] row,
		...
		if (recipientGstnOrPan != null && recipientGstnOrPan.length() != 15
			...
			errorLocations.add(GSTConstants.RECIPIENTGSTNORPAN);
			errors.add(new ProcessingResult(APP_VALIDATION, "ER1604",
					"Invalid Recipient GSTIN/PAN.", location));
			return errors;
		}
