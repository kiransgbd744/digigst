...
import com.ey.advisory.core.search.SearchCriteria;
	...
	@Component("Gstr1AAspAdvRecSecSummaryDaoImpl")
	public class Gstr1AAspAdvRecSecSummaryDaoImpl
			implements Gstr1AAdvRecSavableDao {

		private static final Logger LOGGER = LoggerFactory
				.getLogger(Gstr1AAspAdvRecSecSummaryDaoImpl.class);
		...
		private String createApiProcessedQueryString(String buildQuery) {
			...
			return "SELECT REC.SUPPLIER_GSTIN,REC.RETURN_PERIOD,TRAN_TYPE,"
					+ " MONTH, ORG_POS,ORG_RATE,ORG_GROSS_ADV_RECEIVED, NEW_POS,NEW_RATE,"
					+ " NEW_GROSS_ADV_RECEIVED, IGST_AMT,CGST_AMT,SGST_AMT,CESS_AMT, PROFIT_CENTRE,PLANT_CODE,DIVISION,"
					+ " LOCATION,SALES_ORGANIZATION, DISTRIBUTION_CHANNEL, USERACCESS1,USERACCESS2,USERACCESS3,"
					+ " USERACCESS4,USERACCESS5,USERACCESS6, USERDEFINED_FIELD1, USERDEFINED_FIELD2,USERDEFINED_FIELD3,"
