 ...
 *
 */
@Service("SRFileToGstr1AInvoiceDetailsConvertion")
public class SRFileToGstr1AInvoiceDetailsConvertion {
	@Autowired
	...
	public List<Gstr1AAsEnteredInvEntity> convertSRFileToExcelInvoiceDoc(
			List<Object[]> listOfInvoices, Gstr1FileStatusEntity fileStatus) {
		List<Gstr1AAsEnteredInvEntity> list = new ArrayList<>();

		for (Object[] obj : listOfInvoices) {
			Gstr1AAsEnteredInvEntity invoice = new Gstr1AAsEnteredInvEntity();
	...
	public List<Gstr1AInvoiceFileUploadEntity> convertSRFileToInvoiceDoc(
			List<Gstr1AAsEnteredInvEntity> busProcessRecords,
		...
		for (Gstr1AAsEnteredInvEntity obj : busProcessRecords) {
