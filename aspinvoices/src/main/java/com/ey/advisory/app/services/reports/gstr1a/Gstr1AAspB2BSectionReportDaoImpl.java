...
import com.google.common.base.Strings;
	...
	@Component("Gstr1AAspB2BSectionReportDaoImpl")
	public class Gstr1AAspB2BSectionReportDaoImpl implements Gstr1AReviewSummaryReportsDao {

		private static final Logger LOGGER = LoggerFactory.getLogger(Gstr1AAspB2BSectionReportDaoImpl.class);
...
//					.findAnswerForMultiSupplyType(); 
		...
		private static String createApiProcessedQueryString(String buildHeader, String multiSupplyTypeAns) {
				...
				+ "AND HDR.RETURN_TYPE='GSTR1A' AND HDR.TAX_DOC_TYPE IN ('B2B') " + buildHeader
