...
@Component("BusinessValidationReportConvertor")
@Slf4j
public class BusinessValidationReportConvertor implements ReportConvertor {
	...
	public Object convert(Object[] arr, String reportType) {
		...
		if ((DownloadReportsConstant.PROCESSED).equalsIgnoreCase(reportType)
	...
	private static String deriveOldReturnPeriod(Object[] arr,String docNum){
		try{
		return (arr[312] != null ? arr[312].toString() : null);
		}catch (Exception e) {
