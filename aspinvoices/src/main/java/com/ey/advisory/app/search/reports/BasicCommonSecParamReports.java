 ...
 *
 */
@Component("BasicCommonSecParamReports")
public class BasicCommonSecParamReports {

	public Anx1ReportSearchReqDto setDataSecuritySearchParams(
			Anx1ReportSearchReqDto searchParams) {
