 ...
 *
 */
@Component("OutwardDocMemoValCalculation")
public class OutwardDocMemoValCalculation {
	 ...
	 * @param item
	 */
	public void calculateMemoValues(OutwardTransDocument document,
