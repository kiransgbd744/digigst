...
@Component("AspProcessVsSubmitDocSeriesReportDaoImpl")
public class AspProcessVsSubmitDocSeriesReportDaoImpl
	...
	private String createApiProcessedQueryString(String buildQuery,String buildQueryForGstn) {
		...
		build.append("FROM GETGSTR1_DOC_ISSUED HDR WHERE HDR.IS_DELETE=FALSE ");
		...
		build.append("'' SOURCE_ID,'' FILE_NAME, '' CREATED_ON FROM GSTR1_PROCESSED_INV_SERIES INV ");
