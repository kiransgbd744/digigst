...
import com.ey.advisory.core.search.SearchCriteria;
	...
	@Service("Gstr1AAspCDNRAReportServiceImpl")
	public class Gstr1AAspCDNRAReportServiceImpl
			implements Gstr1AReviewSummReportsService {

		private static final Logger LOGGER = LoggerFactory
				.getLogger(Gstr1AAspCDNRAReportServiceImpl.class);

		@Autowired
		CommonUtility commonUtility;

		@Autowired
		@Qualifier("Gstr1AAspCDNRASectionReportDaoImpl")
