 ...
 *
 */
@Service("Gstr1ASPHsnSummaryReportsServiceImpl")
public class Gstr1ASPHsnSummaryReportsServiceImpl
		implements Gstr1ASPHsnSummaryReportsService {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(Gstr1ASPHsnSummaryReportsServiceImpl.class);
	...
	Gstr1AspHsnSummaryDaoImpl gstr1AspHsnSummaryDao;
