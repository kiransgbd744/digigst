...
public class AROrgGrossAdvancedValidationRule implements ValidationRule {
	@Override
	public List<ProcessingResult> isValid(Object obj, Object[] row,
		...
		if (!isDecimal(obj.toString().trim())) {
			...
			errors.add(new ProcessingResult(APP_VALIDATION, "ER5112",
					"Invalid OrgGross Advance Received", location));
			return errors;
		}
