 ...
 *
 */
@Component("gstr1AB2csB2csaAtGstnImpl")
public class Gstr1AB2csB2csaAtGstnImpl implements Gstr1InvoicesAtGstn {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(Gstr1AB2csB2csaAtGstnImpl.class);

	@Autowired
	@Qualifier("gstr1AB2csB2csaDataAtGstnImpl")
	Gstr1AB2csB2csaDataAtGstnImpl gstr1AB2csB2csaDataAtGstnImpl;
	...
	public Long findInvFromGstn(Gstr1GetInvoicesReqDto dto,
		...
		try {
			...
			reqId = gstr1AB2csB2csaDataAtGstnImpl.findB2CSDataATGstn(dto,
					groupCode, type, json);
