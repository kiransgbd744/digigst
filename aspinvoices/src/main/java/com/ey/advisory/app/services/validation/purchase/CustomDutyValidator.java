...
import static com.ey.advisory.common.GSTConstants.CustomDuty;
...
public class CustomDutyValidator implements 
	...
	public List<ProcessingResult> validate(InwardTransDocument document,
		...
		if((!ORGDOCNUM_REQUIRING_IMPORTS.contains(document.getDocType())) 
			...
			/*if(document.getCustomsDuty().compareTo(BigDecimal.ZERO) < 0){
				

		errorLocations.add(CustomDuty);
		TransDocProcessingResultLoc location = 
				                  new TransDocProcessingResultLoc(
				idx, errorLocations.toArray());
		errors.add(new ProcessingResult(APP_VALIDATION, "ER103",
				"Invalid Custom Duty",
				location));
		}
*/
