...
@AllArgsConstructor
@Entity
@Table(name = "GETGSTR2B_IMPG_ITEM")
public class Gstr2GetGstr2BImpgItemEntity {

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "GETGSTR2B_IMPG_ITEM_SEQ", allocationSize = 100)
	...
	protected Gstr2GetGstr2BImpgHeaderEntity header;
}
