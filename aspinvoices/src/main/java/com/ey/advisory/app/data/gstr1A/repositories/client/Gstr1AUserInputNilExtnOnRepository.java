...
@Repository("Gstr1AUserInputNilExtnOnRepository")
@Transactional(propagation = Propagation.REQUIRED, readOnly = false)
public interface Gstr1AUserInputNilExtnOnRepository
        extends CrudRepository<Gstr1AUserInputNilExtnOnEntity, Long> {

    @Transactional
    @Modifying
    @Query("UPDATE Gstr1AUserInputNilExtnOnEntity SET isDelete = true WHERE "
    ...
    @Modifying
	@Query("UPDATE Gstr1AUserInputNilExtnOnEntity doc SET doc.gstnBatchId=:gstnBatchId,"
    ...
    @Modifying
	@Query("UPDATE Gstr1AUserInputNilExtnOnEntity doc SET doc.isGstnError=true, "
			+ "doc.isSaved=false WHERE doc.gstnBatchId=:gstnBatchId")
	void updateIserrorfalg(@Param("gstnBatchId") Long gstnBatchId);
	
	@Modifying
	@Query("UPDATE Gstr1AUserInputNilExtnOnEntity doc SET doc.isSaved=true, "
