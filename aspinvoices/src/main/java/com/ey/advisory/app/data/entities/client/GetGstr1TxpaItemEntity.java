...
@Entity
@Table(name = "GETGSTR1_TXPA_ITEM")

public class GetGstr1TxpaItemEntity {

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "GETGSTR1_TXPA_ITEM_SEQ", allocationSize = 100)
	...
	private GetGstr1TxpaHeaderEntity document;
	...
	public GetGstr1TxpaHeaderEntity getDocument() {
		return document;
	}

	public void setDocument(GetGstr1TxpaHeaderEntity document) {
