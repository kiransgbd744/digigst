...
@Entity
@Table(name = "GETGSTR1A_EXP_ITEM")

public class GetGstr1AExpItemEntity {

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "GETGSTR1_EXP_ITEM_SEQ", allocationSize = 100)
	...
	private GetGstr1AExpHeaderEntity document;
	...
	public GetGstr1AExpHeaderEntity getDocument() {
		return document;
	}

	public void setDocument(GetGstr1AExpHeaderEntity document) {
