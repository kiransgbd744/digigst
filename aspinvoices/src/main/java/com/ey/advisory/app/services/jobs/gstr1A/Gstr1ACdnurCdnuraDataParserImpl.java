...
import com.ey.advisory.app.data.gstr1A.entities.client.GetGstr1ACdnurItemEntity;
import com.ey.advisory.app.data.gstr1A.entities.client.GetGstr1ACdnuraHeaderEntity;
import com.ey.advisory.app.data.gstr1A.entities.client.GetGstr1ACdnuraItemEntity;
...
@Component("gstr1ACdnurCdnuraDataParserImpl")
@Slf4j
public class Gstr1ACdnurCdnuraDataParserImpl implements Gstr1ACdnurCdnuraDataParser {
	...
	@Override
	public List<GetGstr1ACdnurHeaderEntity> parseCdnurData(Gstr1GetInvoicesReqDto dto, String apiResp) {

		Gson gson = GsonUtil.newSAPGsonInstance();
		JsonArray respObject = null;
		List<GetGstr1ACdnurHeaderEntity> headerList = new ArrayList<>();
		...
		for (CDNURInvoices eachInv : baseEntity) {
			...
			List<GetGstr1ACdnurItemEntity> lineItems = new ArrayList<>();
			if (eachInv.getCdnrLineItem() != null) {
				...
				for (CdnurLineItem b2cItems : eachInv.getCdnrLineItem()) {
					...
					// New Item Entity
					GetGstr1ACdnurItemEntity item = new GetGstr1ACdnurItemEntity();
					/**
				...
				// New Header Entity
				GetGstr1ACdnurHeaderEntity header = new GetGstr1ACdnurHeaderEntity();
				/**
				 * Input data
				 */
	...
	@Override
	public List<GetGstr1ACdnuraHeaderEntity> parseCdnuraData(Gstr1GetInvoicesReqDto dto, String apiResp) {

		Gson gson = GsonUtil.newSAPGsonInstance();
		JsonArray respObject = null;
		List<GetGstr1ACdnuraHeaderEntity> headerList = new ArrayList<>();
		...
		for (CDNURInvoices eachInv : baseEntity) {
			...
			BigDecimal igstAmt = BigDecimal.ZERO;
			BigDecimal cessAmt = BigDecimal.ZERO;
			List<GetGstr1ACdnuraItemEntity> lineItems = new ArrayList<>();
			if (eachInv.getCdnrLineItem() != null) {
				...
				for (CdnurLineItem b2cItems : eachInv.getCdnrLineItem()) {
					...
					// New Item Entity
					GetGstr1ACdnuraItemEntity item = new GetGstr1ACdnuraItemEntity();
					/**
				...
				// New Header Entity
				GetGstr1ACdnuraHeaderEntity header = new GetGstr1ACdnuraHeaderEntity();
				/**
				 * Input data
				 */
				header.setGstin(dto.getGstin());
