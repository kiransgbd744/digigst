...
public class ARIntegratedTaxAmountValidationRule implements ValidationRule {
	@Override
	public List<ProcessingResult> isValid(Object obj, Object[] row,
		...
		if (!isDecimal(obj.toString().trim())) {
			...
			errors.add(new ProcessingResult(APP_VALIDATION, "ER5119",
					"Invalid Integrated Tax Amount.", location));
			return errors;
		}
