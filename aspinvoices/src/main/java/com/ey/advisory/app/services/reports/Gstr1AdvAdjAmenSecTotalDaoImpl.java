...
@Component("Gstr1AdvAdjAmenSecTotalDaoImpl")
public class Gstr1AdvAdjAmenSecTotalDaoImpl
		implements Gstr1ASPAdvAdjSavableTotalDao {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(Gstr1AdvAdjAmenSecTotalDaoImpl.class);
	...
	private String createAdjSavableTotalQueryString(String buildQueryadj) {
		...
		return " SELECT SUPPLIER_GSTIN,RETURN_PERIOD, "
				+ "(CASE WHEN TRAN_TYPE IN ('ZL65','L65') THEN 'L65' "
				+ "WHEN (TRAN_TYPE IN ('Z','N','') OR TRAN_TYPE IS NULL) "
				+ "THEN 'N' END) TRAN_TYPE,MONTH, MAX(ORG_POS)ORG_POS,"
	...
	private String createAdjSavableTotalQueryStringForGstr1a(String buildQueryadj) {
