...
@Entity
@Table(name = "GETGSTR1A_B2CS_HEADER")
public class GetGstr1AB2csHeaderEntity {

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "GETGSTR1A_B2CS_HEADER_SEQ", allocationSize = 100)
	...
	protected List<GetGstr1AB2csItemEntity> lineItems = new ArrayList<>();
	...
	public List<GetGstr1AB2csItemEntity> getLineItems() {
		return lineItems;
	}

	public void setLineItems(List<GetGstr1AB2csItemEntity> lineItems) {
