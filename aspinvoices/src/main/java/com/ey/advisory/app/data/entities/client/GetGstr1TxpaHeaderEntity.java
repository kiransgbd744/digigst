...
@Entity
@Table(name = "GETGSTR1_TXPA_HEADER")
public class GetGstr1TxpaHeaderEntity {
	...
	protected List<GetGstr1TxpaItemEntity> lineItems = new ArrayList<>();
	...
	public List<GetGstr1TxpaItemEntity> getLineItems() {
		return lineItems;
	}

	public void setLineItems(List<GetGstr1TxpaItemEntity> lineItems) {
