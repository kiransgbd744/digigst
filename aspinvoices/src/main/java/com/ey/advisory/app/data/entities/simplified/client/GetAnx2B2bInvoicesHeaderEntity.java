 ...
 */
@Entity
@Table(name = "GETANX2_B2B_HEADER")
public class GetAnx2B2bInvoicesHeaderEntity {
	...
	protected List<GetAnx2B2bInvoicesItemEntity> lineItems = new ArrayList<>();

	/*
	 * @ManyToOne
	 * 
	 * @JoinColumn(name = "BATCH_ID", referencedColumnName = "ID", nullable =
	 * false) private GetGstr2aBatchEntity b2bBatchIdAnx2;
	 */

	@Column(name = "BATCH_ID")
	private Long b2bBatchIdAnx2;
	...
	public List<GetAnx2B2bInvoicesItemEntity> getLineItems() {
		return lineItems;
	}

	public void setLineItems(List<GetAnx2B2bInvoicesItemEntity> lineItems) {
		this.lineItems = lineItems;
	}

	/*
	 * public GetGstr2aBatchEntity getB2bBatchIdAnx2() { return b2bBatchIdAnx2;
	 * }
	 * 
	 * public void setB2bBatchIdAnx2(GetGstr2aBatchEntity b2bBatchIdAnx2) {
	 * this.b2bBatchIdAnx2 = b2bBatchIdAnx2; }
	 */
	...
	public Long getB2bBatchIdAnx2() {
		return b2bBatchIdAnx2;
	}

	public void setB2bBatchIdAnx2(Long b2bBatchIdAnx2) {
		this.b2bBatchIdAnx2 = b2bBatchIdAnx2;
	}
