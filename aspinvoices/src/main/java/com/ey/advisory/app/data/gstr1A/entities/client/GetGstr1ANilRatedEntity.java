...
@Entity
@Table(name = "GETGSTR1A_NILEXTNON")
@Setter
@Getter
@ToString
public class GetGstr1ANilRatedEntity {

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "GETGSTR1A_NILEXTNON_SEQ", allocationSize = 100)
