...
import com.ey.advisory.app.data.repositories.client.gstr2.GetAnx1DeInvoicesRepository;
...
@Service("Anx1GetDeSuccessHandler")
@Slf4j
public class Anx1GetDeSuccessHandler implements SuccessHandler {

	@Autowired
	@Qualifier("Anx1DeDataParserImpl")
	private Anx1DeDataParser anx1DeDataParser;

	@Autowired
	@Qualifier("GetAnx1DeInvoicesRepository")
	private GetAnx1DeInvoicesRepository headerRepo;
	...
	public void handleSuccess(SuccessResult result, String apiParams) {
		try {
			...
			if (LOGGER.isDebugEnabled()) {
				LOGGER.debug(
						"GET Call is Success for the batchId {} inside Anx1GetDeSuccessHandler.class",
			...
			resultIds.forEach(id -> {
				...
				Set<GetAnx1DeInvoicesHeaderEntity> b2cEntities = anx1DeDataParser
