...
@Entity
@Table(name = "GETGSTR1A_B2CSA_ITEM")
public class GetGstr1AB2csaItemEntity {

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "GETGSTR1A_B2CSA_ITEM_SEQ", allocationSize = 100)
	...
	private GetGstr1AB2csaHeaderEntity document;
	...
	public GetGstr1AB2csaHeaderEntity getDocument() {
		return document;
	}

	public void setDocument(GetGstr1AB2csaHeaderEntity document) {
