 ...
 *
 */
@Repository("GetAnx2B2bInvoicesRepository")
@Transactional(propagation = Propagation.REQUIRED, readOnly = false)
public interface GetAnx2B2bInvoicesRepository
		extends CrudRepository<GetAnx2B2bInvoicesHeaderEntity, Long> {

	@Modifying
	@Query("UPDATE GetAnx2B2bInvoicesHeaderEntity b SET b.isDelete = true WHERE"
