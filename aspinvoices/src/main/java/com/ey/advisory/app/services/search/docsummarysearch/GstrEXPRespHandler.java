...
@Service("GstrEXPRespHandler")
public class GstrEXPRespHandler {
	...
	public JsonElement handleEXPResp(List<? extends Gstr1SummaryDto> list,
			Gstr1SummaryReqDto gstr1SummaryRequest) {
		
		List<Gstr1BasicSummarySectionDto> expEySummary = new ArrayList<>();
		for (Gstr1SummaryDto gstr1Summary : list) {
			expEySummary = gstr1Summary.getExp().getEySummary();
		}
...
*/				
				...
				JsonElement expRespBody = gstr1SummaryStructure
				.expStructure(expEySummary,gstnList);
