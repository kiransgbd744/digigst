...
import com.ey.advisory.app.gstr2b.Gstr2GetGstr2BLinkingCdnrHeaderEntity;
...
@Repository("Gstr2GetGstr2BLinkingCdnrHeaderRepository")
@Transactional(propagation = Propagation.REQUIRED, readOnly = false)
public interface Gstr2GetGstr2BLinkingCdnrHeaderRepository
		extends CrudRepository<Gstr2GetGstr2BLinkingCdnrHeaderEntity, Long>,
		JpaSpecificationExecutor<Gstr2GetGstr2BLinkingCdnrHeaderEntity> {

	@Modifying
	@Query("UPDATE Gstr2GetGstr2BLinkingCdnrHeaderEntity b SET b.isDelete = true, "
	...
	@Modifying
	@Query("UPDATE Gstr2GetGstr2BLinkingCdnrHeaderEntity b SET b.status = 'SAVED', "
			+ " b.modifiedOn =:modifiedOn WHERE b.invocationId =:invocationId"
			+ " AND b.status = 'ONHOLD'")
	int updateStatus(@Param("invocationId") Long invocationId,
			@Param("modifiedOn") LocalDateTime modifiedOn);
	
	@Query("from Gstr2GetGstr2BLinkingCdnrHeaderEntity where docKey=:docKey")
	List<Gstr2GetGstr2BLinkingCdnrHeaderEntity> findByInvoiceKey(
			@Param("docKey") String docKey);

	@Modifying
	@Query("UPDATE Gstr2GetGstr2BLinkingCdnrHeaderEntity b SET b.isDelete = true, b.modifiedOn =:modifiedOn  WHERE"
	...
	@Query("SELECT COUNT(1) FROM Gstr2GetGstr2BLinkingCdnrHeaderEntity where "
