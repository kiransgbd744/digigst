...
@Component("NilNonVerticalTotalReportsDaoImpl")
public class NilNonVerticalTotalReportsDaoImpl implements NilNonVerticalDao {

	@PersistenceContext(unitName = "clientDataUnit")
	private EntityManager entityManager;

	private static final Logger LOGGER = LoggerFactory
			.getLogger(NilNonVerticalTotalReportsDaoImpl.class);
