 ...
 */
@Entity
@Table(name = "GETANX2_DE_ITEM")
public class GetAnx2DeInvoicesItemEntity {
	...
	protected GetAnx2DeInvoicesHeaderEntity header;
	...
	public GetAnx2DeInvoicesHeaderEntity getHeader() {
		return header;
	}

	public void setHeader(GetAnx2DeInvoicesHeaderEntity header) {
		this.header = header;
	}
