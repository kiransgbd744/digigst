...
import com.ey.advisory.app.data.views.client.ItcNilNonVerticalDto;
...
@Component("ItcNilNonDaoImpl")
public class ItcNilNonDaoImpl implements ItcReversalInwardDao {
	...
	private ItcNilNonVerticalDto convertApiInwardProcessedRecords(
			Object[] arr) {
		ItcNilNonVerticalDto obj = new ItcNilNonVerticalDto();
	...
	private String createApiProcessedQueryString(String buildQuery) {
		return "select SUPPLIER_GSTIN,RETURN_PERIOD,ITM_HSNSAC,"
				+ " ITM_DESCRIPTION,"
				+ " ITM_UQC, ITM_QTY, NIL_INTERSTATE_REG,NIL_INTRASTATE_REG,"
				+ "NIL_INTERSTATE_UNREG, NIL_INTRASTATE_UNREG,EXT_INTERSTATE_REG ,"
				+ "EXT_INTRASTATE_REG ,EXT_INTERSTATE_UNREG, EXT_INTRASTATE_UNREG, "
				+ "NON_INTERSTATE_REG ,NON_INTRASTATE_REG ,NON_INTERSTATE_UNREG , "
				+ "NON_INTRASTATE_UNREG FROM GSTR1_PROCESSED_NILEXTNON "
