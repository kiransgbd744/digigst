 ...
 *
 */
public class Table4EcomValidationRule implements ValidationRule {
	...
	public List<ProcessingResult> isValid(Object obj, Object[] row,
		...
		if (!isPresent(obj)) {
			...
			errors.add(new ProcessingResult(APP_VALIDATION, "ER0308",
		...
		if (obj.toString().trim().length() != 15 || !matcher.matches()) {
			...
			TransDocProcessingResultLoc location =
					new TransDocProcessingResultLoc(
					null, errorLocations.toArray());
			errors.add(new ProcessingResult(APP_VALIDATION, "ER0309",
					"Invalid Ecom GSTIN", location));
			return errors;
		}
		return errors;
