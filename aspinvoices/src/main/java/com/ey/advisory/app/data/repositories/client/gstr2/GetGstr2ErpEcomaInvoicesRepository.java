 ...
 *
 */
@Repository("GetGstr2ErpEcomaInvoicesRepository")
@Transactional(propagation = Propagation.REQUIRED, readOnly = false)
public interface GetGstr2ErpEcomaInvoicesRepository extends CrudRepository<GetGstr2aErpEcomaInvoicesHeaderEntity, Long> {

	/* void softlyDeleteB2baHeader(String gstin, String returnPeriod); */

	// Curently isDelete is not added in table
	@Modifying
	@Query("UPDATE GetGstr2aErpEcomaInvoicesHeaderEntity b SET b.isDelete = true , b.modifiedBy = 'SYSTEM'  , b.modifiedOn =:modifiedOn  WHERE"
	...
	@Query("from GetGstr2aErpEcomaInvoicesHeaderEntity where sgstin=:sgstin and cgstin=:cgstin and invDate=:invDate and invNum=:invNum and invType=:invType")
	List<GetGstr2aErpEcomaInvoicesHeaderEntity> findByInvoiceKey(
	...
	@Query("SELECT COUNT(*) FROM GetGstr2aErpEcomaInvoicesHeaderEntity "
	...
	@Modifying
	@Query("UPDATE GetGstr2aErpEcomaInvoicesHeaderEntity b SET b.isDelete = true WHERE"
