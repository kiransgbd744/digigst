...
@Entity
@Table(name = "GETANX1_B2BA_ITEM")
public class GetAnx1B2baInvoicesItemEntity {
	...
	protected GetAnx1B2baInvoicesHeaderEntity header;
	...
	public GetAnx1B2baInvoicesHeaderEntity getHeader() {
		return header;
	}

	public void setHeader(GetAnx1B2baInvoicesHeaderEntity header) {
		this.header = header;
	}
