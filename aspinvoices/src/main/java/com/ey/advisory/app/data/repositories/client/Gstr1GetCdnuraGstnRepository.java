 ...
 *
 */
@Repository("Gstr1GetCdnuraGstnRepository")
@Transactional(propagation = Propagation.REQUIRED, readOnly = false)
public interface Gstr1GetCdnuraGstnRepository
		extends CrudRepository<GetGstr1CdnuraHeaderEntity, Long> {
	@Modifying
	@Query("UPDATE GetGstr1CdnuraHeaderEntity b SET b.isDelete = true,b.modifiedBy = 'SYSTEM'  , b.modifiedOn =:modifiedOn  WHERE"
	...
	@Query("SELECT COUNT(*) FROM GetGstr1CdnuraHeaderEntity "
