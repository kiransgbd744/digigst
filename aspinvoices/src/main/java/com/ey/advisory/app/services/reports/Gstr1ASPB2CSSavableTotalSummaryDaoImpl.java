...
@Component("Gstr1ASPB2CSSavableTotalSummaryDaoImpl")
public class Gstr1ASPB2CSSavableTotalSummaryDaoImpl
		implements Gstr1ASPB2CSSavableTotalDao {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(Gstr1ASPB2CSSavableTotalSummaryDaoImpl.class);
	...
	private static String createB2CSSavableTotalQueryString(
			...
			return "SELECT SUPPLIER_GSTIN "
					...
					+ "FROM ( "
					+ "	SELECT (IFNULL(B2CS.SUPPLIER_GSTIN, '') || '|' || IFNULL(B2CS.RETURN_PERIOD, '') || '|' || IFNULL(TRAN_TYPE, '') || '|' || IFNULL(NEW_POS, 9999) || '|' || IFNULL(NEW_ECOM_GSTIN, '') || '|' || IFNULL(MONTH, 9999)) DOC_KEY "
					+ "		,B2CS.SUPPLIER_GSTIN "
					+ "		,B2CS.RETURN_PERIOD "
					+ "		,TRAN_TYPE "
					+ "		,MONTH "
