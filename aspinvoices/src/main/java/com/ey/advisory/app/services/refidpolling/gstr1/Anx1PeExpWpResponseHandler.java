 ...
 *
 */
@Component("Anx1PeExpWpResponseHandler")
public class Anx1PeExpWpResponseHandler implements Anx1ResponseHandler{
	...
	public Triplet<List<String>, Map<String, OutwardTransDocError>,Integer> response(
		...
		for (Anx1ExpwpAndExpwopData invoice : anx1ErrorReportData.getExpwpInvoice()) {
