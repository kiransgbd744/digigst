 ...
 *
 */
@Repository("Gstr6aGetCdnaGstnRepository")
@Transactional(propagation = Propagation.REQUIRED, readOnly = false)
public interface Gstr6aGetCdnaGstnRepository
		extends CrudRepository<GetGstr6aCdnaHeaderEntity, Long> {
	@Modifying
	@Query("UPDATE GetGstr6aCdnaHeaderEntity b SET b.isDelete = true,b.modifiedBy = 'SYSTEM'  , b.modifiedOn =:modifiedOn WHERE"
	...
	@Query("SELECT distinct erpBatchId FROM GetGstr6aCdnaHeaderEntity WHERE "
