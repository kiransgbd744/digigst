...
@Component("ServiceCredDebCancelPDFDaoImpl")
@Slf4j
public class ServiceCredDebCancelPDFDaoImpl implements ServiceCredDebCancel {
...
B2CQRCodeLoggerRepository qrCodeRepo;
	...
	public JasperPrint generateServiceCredCancelPdfReport(String id,
		...
		String source = "jasperReports/ServiceTaxInvoice (004).jrxml";
		if (LOGGER.isDebugEnabled()) {
			String msg = String.format(
					"Inside generateServiceCredCancelPdfReport for docNo: %s", docNo);
			LOGGER.debug(msg);
		}
