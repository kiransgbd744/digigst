...
public class Anx1MisData {
	...
	@Expose
	@SerializedName("tblref")
	private String tblref;

	@Expose
	@SerializedName("docs")
	private List<Anx1MisDocumentData> docs;
	...
	public List<Anx1MisDocumentData> getDocs() {
		return docs;
	}

	public void setDocs(List<Anx1MisDocumentData> docs) {
		this.docs = docs;
	}
