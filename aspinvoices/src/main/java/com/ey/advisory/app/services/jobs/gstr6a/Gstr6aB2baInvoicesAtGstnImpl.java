 ...
 *
 */
@Service("Gstr6aB2baInvoicesAtGstnImpl")
@Slf4j
public class Gstr6aB2baInvoicesAtGstnImpl implements Gstr6aInvoicesAtGstn {
	...
	public Long findInvFromGstn(Gstr6aGetInvoicesReqDto dto, String groupCode, String type, Long batchId) {
		...
		try {
			...
			throw new APIException("Unexpected error while executing Gstr6a Get B2ba");
