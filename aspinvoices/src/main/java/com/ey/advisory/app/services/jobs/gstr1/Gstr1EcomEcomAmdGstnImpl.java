 ...
 */
@Slf4j
@Component("Gstr1EcomEcomAmdGstnImpl")
public class Gstr1EcomEcomAmdGstnImpl implements Gstr1InvoicesAtGstn {

	@Autowired
	@Qualifier("Gstr1EcomEcomAmdDataGstnImpl")
	Gstr1EcomEcomAmdDataGstnImpl gstr1EcomEcomAmdDataGstnImpl;
	...
	public Long findInvFromGstn(Gstr1GetInvoicesReqDto dto, String groupCode,
		...
		try {
			...
			Long reqId = gstr1EcomEcomAmdDataGstnImpl.findEcomDataGstn(dto,
