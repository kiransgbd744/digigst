 ...
 *
 */
public class AvailableCessValidationRule implements ValidationRule {
	...
	public List<ProcessingResult> isValid(Object obj, Object[] row,
		...
		if (!isPresent(obj))
			...
			if (!isDecimal(obj.toString().trim())) {
				...
				errors.add(new ProcessingResult(APP_VALIDATION, "ER1235",
						"Invalid Available CESS Amount", location));
				return errors;
			}
			// First check if the input object is a valid decimal number.
