...
public class EXPStructure {
	...
	@Autowired
	@Qualifier("EXPEYFinalStructure")
	private EXPEYFinalStructure expEYFinalStructure;

	@Autowired
	@Qualifier("Gstr1SummaryDifference")
	private Gstr1SummaryDifference gstr1SummaryDifference;

	public JsonElement expResp(
		...
		List<Gstr1SummaryRespDto> expEYList = expEYFinalStructure
				.getexpEyList(defaultexpEYList, eySummaryListFromView);
	...
	private List<Gstr1SummaryRespDto> getDefaultEXPEYStructure() {
		// TODO Auto-generated method stub
		List<Gstr1SummaryRespDto> defaultEXPEY = new ArrayList<>();

		Gstr1SummaryRespDto expEy6A = new Gstr1SummaryRespDto();
		expEy6A.setTableSection("6A");
		expEy6A = defaultStructureUtil.defaultB2CLStructure(expEy6A);

		defaultEXPEY.add(expEy6A);
