...
import com.ey.advisory.core.search.SearchCriteria;
	...
	@Service("Gstr1AAspB2CLSectionReportReportServiceImpl")
	public class Gstr1AAspB2CLSectionReportReportServiceImpl
			implements Gstr1AReviewSummReportsService {

		private static final Logger LOGGER = LoggerFactory
				.getLogger(Gstr1AAspB2CLSectionReportReportServiceImpl.class);

		@Autowired
		CommonUtility commonUtility;

		@Autowired
		@Qualifier("Gstr1AAspB2CLSectionReportDaoImpl")
