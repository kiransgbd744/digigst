...
@Component("Gstr1aOutwardVerticalProcessedB2CSDaoImpl")
public class Gstr1aOutwardVerticalProcessedB2CSDaoImpl
		implements Gstr1OutwardVerticalProcessedB2CSDao {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(Gstr1aOutwardVerticalProcessedB2CSDaoImpl.class);
