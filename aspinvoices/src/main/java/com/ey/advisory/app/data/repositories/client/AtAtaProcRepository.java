...
import com.ey.advisory.app.data.entities.client.AtProcEntity;
/**
 * 
 * @author Hemasundar.J
 *
 */
@Repository("AtAtaProcRepository")
@Transactional(propagation = Propagation.REQUIRED, readOnly = false)
public interface AtAtaProcRepository extends CrudRepository<AtProcEntity, Long> {

	@Modifying
	@Query("UPDATE AtProcEntity doc SET doc.gstnBatchId=:gstnBatchId,"
	...
	/*@Modifying
	@Query("UPDATE AtProcEntity doc SET "
	...
	@Modifying
	@Query("UPDATE AtProcEntity doc SET doc.isSaved=true, doc.isError = false "
			+ "WHERE doc.gstnBatchId=:gstnBatchId")
	void updateIsSavedToGstn(@Param("gstnBatchId") Long gstnBatchId);
	
	@Modifying
	@Query("UPDATE AtProcEntity doc SET doc.isError=true, doc.isSaved=false "
			+ "WHERE doc.gstnBatchId=:gstnBatchId")
