...
@Component("Gstr1GstnNewEXPErrorDaoImpl")
public class Gstr1GstnNewEXPErrorDaoImpl implements Gstr1GstnErrorDao {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(Gstr1GstnNewEXPErrorDaoImpl.class);
	...
	private String creategstnB2BErrorQueryString(String buildQuery) {
		...
		return "SELECT SUPPLIER_GSTIN,RETURN_PERIOD,DOCUMENT_TYPE,"
				...
				+ "BATCH_ID  "
				+ " FROM GSTR1_GSTN_DELETE_DATA " + buildQuery;
	}
}
