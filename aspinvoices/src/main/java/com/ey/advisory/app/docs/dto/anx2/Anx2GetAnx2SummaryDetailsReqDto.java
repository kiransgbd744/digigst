...
public class Anx2GetAnx2SummaryDetailsReqDto {
	...
	public String toString() {
		return "Anx2GetAnx2SummaryDetailsReqDto [entityId=" + entityId
				+ ", gstins=" + gstins + ", taxPeriod=" + taxPeriod
				+ ", docType=" + docType + ", recordType=" + recordType
				+ ", data=" + data + ", dataSecAttrs=" + dataSecAttrs + "]";
	}
