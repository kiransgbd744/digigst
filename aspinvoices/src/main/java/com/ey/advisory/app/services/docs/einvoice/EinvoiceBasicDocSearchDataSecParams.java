 ...
 *
 */
@Component("EinvoiceBasicDocSearchDataSecParams")
public class EinvoiceBasicDocSearchDataSecParams {

	public EInvoiceDocSearchReqDto setDataSecuritySearchParams(
			EInvoiceDocSearchReqDto searchParams) {
