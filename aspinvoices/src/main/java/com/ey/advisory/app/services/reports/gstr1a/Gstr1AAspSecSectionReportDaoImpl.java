...
import com.google.common.base.Strings;
	...
	@Component("Gstr1AAspSecSectionReportDaoImpl")
	public class Gstr1AAspSecSectionReportDaoImpl
			implements Gstr1AASPB2CSSavableTransactionalDao {

		private static final Logger LOGGER = LoggerFactory
				.getLogger(Gstr1AAspSecSectionReportDaoImpl.class);
		...
		public List<Object> getGstr1B2CSSavableReports(SearchCriteria criteria) {
			...
			if (ProfitCenter != null && !ProfitCenter.isEmpty()) {
				if (pcList != null && pcList.size() > 0) {
					...
					buildQueryheader
					.append(" AND ITM.PROFIT_CENTRE IN :pcList");
				}
			}
			if (plant != null && !plant.isEmpty()) {
				if (plantList != null && plantList.size() > 0) {
					...
					buildQueryheader
					.append(" AND ITM.PLANT_CODE IN :plantList");
				}
			}
			...
			if (location != null && !location.isEmpty()) {
				if (locationList != null && locationList.size() > 0) {
					buildQueryheader
					.append(" AND ITM.LOCATION IN :locationList");
				}
			}
		...
		private String createB2CSSavableTransactionalQueryString(
			...
			return "SELECT '' AS ERROR_CODE_ASP, '' AS ERROR_DESCRIPTION_ASP, "
					...
					+ "ITM.ORIGIN_COUNTRY,ITM.ITM_UQC,ITM.ITM_QTY, "
