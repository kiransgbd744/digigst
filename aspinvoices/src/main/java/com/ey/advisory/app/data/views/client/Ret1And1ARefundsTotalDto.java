 ...
 * 
 */
public class Ret1And1ARefundsTotalDto {
	...
	public String toString() {
		return "Ret1And1ARefundsTotalDto [gstin=" + gstin + ", returnPeriod="
				+ returnPeriod + ", description=" + description + ", tax=" + tax
				+ ", interest=" + interest + ", penalty=" + penalty + ", fee="
				+ fee + ", other=" + other + ", total=" + total
