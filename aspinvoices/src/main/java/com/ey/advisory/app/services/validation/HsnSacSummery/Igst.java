...
public class Igst implements B2csBusinessRuleValidator<Gstr1HsnFileUploadEntity> {
	 ...
	 private static DecimalFormat df = new DecimalFormat("0.00");
		...
		public List<ProcessingResult> validate(Gstr1HsnFileUploadEntity document, ProcessingContext context) {
			...
			if(document.getIgst()!=null){
				
			document.setIgst(new BigDecimal(df.format(document.getIgst())));
