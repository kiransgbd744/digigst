 ...
 */
@Slf4j
@Component("gstr1AB2clB2claAtGstnImpl")
public class Gstr1AB2clB2claAtGstnImpl implements Gstr1InvoicesAtGstn {

	@Autowired
	@Qualifier("gstr1AB2clB2claDataAtGstnImpl")
	Gstr1AB2clB2claDataAtGstnImpl gstr1AB2clB2claDataAtGstnImpl;
...
/*
			...
			reqId = gstr1AB2clB2claDataAtGstnImpl.findB2CLDataAtGstn(dto,
					groupCode, type, json);
