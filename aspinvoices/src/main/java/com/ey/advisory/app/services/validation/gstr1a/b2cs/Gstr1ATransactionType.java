...
public class Gstr1ATransactionType
		implements B2csBusinessRuleValidator<Gstr1AB2csDetailsEntity> {
	private static final List<String> Trans_TYPE_IMPORTS = ImmutableList.of("L",
			"Z", "ZL");

	@Override
	public List<ProcessingResult> validate(Gstr1AB2csDetailsEntity document,
