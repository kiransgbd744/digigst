...
@Entity
@Table(name = "GSTR1A_PROCESSED_ADV_ADJUSTMENT")
@Setter
@Getter
@ToString
public class Gstr1AAdvanceAdjustmentFileUploadEntity {

	@Expose
	@Id
	@SerializedName("id")
	@SequenceGenerator(name = "sequence", sequenceName = "GSTR1A_PROCESSED_ADV_ADJUSTMENT_SEQ", allocationSize = 100)
