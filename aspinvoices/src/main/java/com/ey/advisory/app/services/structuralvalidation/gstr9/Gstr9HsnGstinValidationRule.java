 ...
 *
 */
public class Gstr9HsnGstinValidationRule implements ValidationRule {
	...
	public List<ProcessingResult> isValid(Object obj, Object[] row,
		...
		if (!isPresent(obj)) {
			...
			errorLocations.add(GSTConstants.HSN_GSTIN);
			TransDocProcessingResultLoc location = new TransDocProcessingResultLoc(
					null, errorLocations.toArray());

			errors.add(new ProcessingResult(APP_VALIDATION, "ER6166",
					"GSTIN cannot be left blank", location));
			return errors;
		}
		...
		if (matcher.matches() || matcher1.matches()
			...
			errors.add(new ProcessingResult(APP_VALIDATION, "ER6167",
					"Invalid GSTIN", location));
			return errors;
		}
