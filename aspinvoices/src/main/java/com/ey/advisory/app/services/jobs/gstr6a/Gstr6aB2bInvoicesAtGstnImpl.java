 ...
 *
 */
@Service("Gstr6aB2bInvoicesAtGstnImpl")
@Slf4j
public class Gstr6aB2bInvoicesAtGstnImpl implements Gstr6aInvoicesAtGstn {
	@Autowired
	...
	public Long findInvFromGstn(Gstr6aGetInvoicesReqDto dto, String groupCode, String type, Long batchId) {
		if (LOGGER.isDebugEnabled()) {
			LOGGER.debug("I am from findB2BFromGstn Method type: {}", type);
		}
		...
		try {
			...
			throw new APIException("Unexpected error while executing Gstr6a Get B2b");
