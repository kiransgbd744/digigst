 ...
 *
 */
@Repository("Gstr1AGetEcomAmdGstnRepository")
@Transactional(propagation = Propagation.REQUIRED, readOnly = false)
public interface Gstr1AGetEcomAmdGstnRepository
		extends CrudRepository<GetGstr1AEcomSupAmdHeaderEntity, Long> {
	@Modifying
	@Query("UPDATE GetGstr1AEcomSupAmdHeaderEntity b SET b.isDelete = true,b.modifiedBy = 'SYSTEM'  , b.modifiedOn =:modifiedOn   WHERE"
	...
	@Query("SELECT COUNT(*) FROM GetGstr1AEcomSupAmdHeaderEntity "
