...
@Component("Anx1ApiTotalReportsDaoImpl")
public class Anx1ApiTotalReportsDaoImpl implements Anx1ApiTotalReportsDao {
	...
	@Override
	public List<Anx1ApiTotalRecordsDto> getApiTotalReports(
		...
		String queryStr = createApiTotalRecQueryString(buildQuery.toString());
		...
		return list.parallelStream().map(o -> convertApiTotalRecords(o))
				.collect(Collectors.toCollection(ArrayList::new));
	}

	private Anx1ApiTotalRecordsDto convertApiTotalRecords(Object[] arr) {
		Anx1ApiTotalRecordsDto obj = new Anx1ApiTotalRecordsDto();
		...
		obj.setInvoiceValue(arr[126] != null ? arr[126].toString() : null);
		...
		obj.setAspErrorCode(arr[114] != null ? arr[114].toString() : null);
		obj.setAspErrorDesc(arr[115] != null ? arr[115].toString() : null);
	...
	private String createApiTotalRecQueryString(String buildQuery) {
		return "SELECT HDR.ID," + "ITM.USER_ID,"
				...
				+ "ITM.ORIGINAL_DOC_TYPE,ITM.CRDR_PRE_GST,"
				+ "ITM.CUST_GSTIN,ITM.CUST_SUPP_TYPE,ITM.DIFF_PERCENT,"
				+ "ITM.ORIGINAL_CUST_GSTIN,ITM.CUST_SUPP_NAME,"
				+ "ITM.CUST_SUPP_CODE,ITM.CUST_SUPP_ADDRESS1,"
				+ "ITM.CUST_SUPP_ADDRESS2,HDR.CUST_SUPP_ADDRESS3,"
				+ "ITM.CUST_SUPP_ADDRESS4,ITM.BILL_TO_STATE,"
				+ "ITM.SHIP_TO_STATE,ITM.POS,ITM.STATE_APPLYING_CESS,"
				+ "ITM.SHIP_PORT_CODE,ITM.SHIP_BILL_NUM,ITM.SHIP_BILL_DATE,"
				...
				+ "WHERE " + "HDR.DATAORIGINTYPECODE IN ('A','AI') "
