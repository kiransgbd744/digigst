...
import com.ey.advisory.app.data.gstr1A.entities.client.Gstr1ATxpProcEntity;
/**
 * 
 * @author Hemasundar.J
 *
 */
@Repository("Gstr1ATxpTxpaProcRepository")
@Transactional(propagation = Propagation.REQUIRED, readOnly = false)
public interface Gstr1ATxpTxpaProcRepository extends CrudRepository<Gstr1ATxpProcEntity, Long> {
	@Modifying
	@Query("UPDATE Gstr1ATxpProcEntity doc SET doc.gstnBatchId=:gstnBatchId,"
	...
	@Query("SELECT "
			...
			+ "FROM Gstr1ATxpProcEntity doc WHERE "
	...
	public List<Object[]> getTxpda(
			...
			@Param("sgstins") String sgstins);
	@Modifying
	@Query("UPDATE Gstr1ATxpProcEntity doc SET doc.isSaved=true, doc.isError =false "
			+ "WHERE doc.gstnBatchId=:gstnBatchId")
	void updateIsSavedToGstn(@Param("gstnBatchId") Long gstnBatchId);
	
	@Modifying
	@Query("UPDATE Gstr1ATxpProcEntity doc SET doc.isError=true, doc.isSaved=false "
			+ "WHERE doc.gstnBatchId=:gstnBatchId")
