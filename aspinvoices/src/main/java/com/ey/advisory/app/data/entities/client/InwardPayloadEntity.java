...
@Setter
@ToString
@Table(name = "PAYLOAD_METADATA_INWARD")
public class InwardPayloadEntity {

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "PAYLOAD_METADATA_INWARD_SEQ", allocationSize = 100)
