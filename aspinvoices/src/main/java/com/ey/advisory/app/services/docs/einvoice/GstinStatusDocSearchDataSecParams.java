 ...
 *
 */
@Component("GstinStatusDocSearchDataSecParams")
public class GstinStatusDocSearchDataSecParams {

	public GstinStatusDocSearchReqDto setDataSecuritySearchParams(
			GstinStatusDocSearchReqDto searchParams) {
