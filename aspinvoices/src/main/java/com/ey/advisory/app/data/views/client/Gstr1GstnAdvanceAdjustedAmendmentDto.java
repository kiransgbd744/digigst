 ...
 * 
 */
public class Gstr1GstnAdvanceAdjustedAmendmentDto {
	...
	public String toString() {
		return "Gstr1GstnAdvanceAdjustedAmendmentDto [serialNo=" + serialNo
				...
				+ ", rateofTax=" + rateofTax + ", grossAdvanceAdjusted="
				+ grossAdvanceAdjusted + ", igstAmount=" + igstAmount
