...
@Service("SRFileToGstr1AATExcelDetailsConvertion")
public class SRFileToGstr1AATExcelDetailsConvertion {
	...
	public List<Gstr1AARDetailsEntity> convertSRFileToAtaDoc(
			List<Gstr1AAsEnteredAREntity> busProcessRecords,
			Gstr1FileStatusEntity fileStatus) {
		List<Gstr1AARDetailsEntity> listOfAta = new ArrayList<>();
		Gstr1AARDetailsEntity ataObj = null;
		for (Gstr1AAsEnteredAREntity obj : busProcessRecords) {
			ataObj = new Gstr1AARDetailsEntity();
	...
	public List<Gstr1AAsEnteredAREntity> convertSRFileToATExcel(
			List<Object[]> atObjects, Gstr1FileStatusEntity fileStatus) {
		List<Gstr1AAsEnteredAREntity> listOfAt = new ArrayList<>();

		Gstr1AAsEnteredAREntity obj = null;

		for (Object[] arr : atObjects) {
			obj = new Gstr1AAsEnteredAREntity();
