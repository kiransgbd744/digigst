...
@Entity
@Table(name = "GETGSTR1A_ATA_HEADER")
public class GetGstr1AAtaHeaderEntity {

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "GETGSTR1A_ATA_HEADER_SEQ", allocationSize = 100)
	...
	protected BigDecimal advRecAmt;
	...
	protected List<GetGstr1AAtaItemEntity> lineItems = new ArrayList<>();
	...
	public List<GetGstr1AAtaItemEntity> getLineItems() {
		return lineItems;
	}

	public void setLineItems(List<GetGstr1AAtaItemEntity> lineItems) {
