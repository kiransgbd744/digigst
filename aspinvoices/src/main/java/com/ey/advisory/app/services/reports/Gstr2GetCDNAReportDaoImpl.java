...
@Component("Gstr2GetCDNAReportDaoImpl")
@Slf4j
public class Gstr2GetCDNAReportDaoImpl implements Gstr1aGetDao {
	...
	private String creategstnB2CSSummaryQueryString(String buildQuery) {
		...
		return "SELECT RETURN_PERIOD,CGSTIN,SGSTIN,LEGAL_NAME,TRADE_NAME,"
				...
				+ "NOTE_TYPE DOC_TYPE,"
				+ " INV_TYPE SUPPLY_TYPE, 'CDNA' TABLE_TYPE,NOTE_NUMBER DOC_NUM,"
				...
				*/+ "HDR.D_FLAG AS CDN_DELINKING_FLAG ,'' CR_DR_PRE_GST,'' ITC_ELIGIBLE,"
				...
				+ "CTIN,HDR.GSTIN,LEGAL_NAME_BS,NOTE_VALUE,TRADE_NAME,NOTE_TYPE,NOTE_NUMBER,"
				+ "NOTE_DATE,TAX_RATE ,"
				...
				+ "HDR.CREATED_ON,HDR.DERIVED_RET_PERIOD,INV_TYPE,HDR.D_FLAG) "
				+ buildQuery;
