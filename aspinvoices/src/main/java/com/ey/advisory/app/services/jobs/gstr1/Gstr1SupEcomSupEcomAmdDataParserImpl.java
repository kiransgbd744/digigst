 ...
 *
 */
@Component("Gstr1SupEcomSupEcomAmdDataParserImpl")
@Slf4j
public class Gstr1SupEcomSupEcomAmdDataParserImpl
		implements Gstr1SupEcomSupEcomAmdDataParser {
	...
	public List<GetGstr1SupEcomHeaderEntity> parseSupEcomData(
		...
		List<GetGstr1SupEcomHeaderEntity> headerList = new ArrayList<>();
		...
		try {
			...
			for (SupEcomInvoices supEcomInvoices : clttx) {
				GetGstr1SupEcomHeaderEntity header = new GetGstr1SupEcomHeaderEntity();
	...
	public List<GetGstr1SupEcomAmdHeaderEntity> parseSupEcomAmdData(
		...
		Gson gson = GsonUtil.newSAPGsonInstance();
		JsonArray respObject = null;
		List<GetGstr1SupEcomAmdHeaderEntity> headerList = new ArrayList<>();
		...
		try {
			...
			for (SupEcomInvoices supEcomInvoices : clttx) {
				GetGstr1SupEcomAmdHeaderEntity header = new GetGstr1SupEcomAmdHeaderEntity();
	...
	private void setSupEcomAttr(Gstr1GetInvoicesReqDto dto,
			...
			GetGstr1SupEcomHeaderEntity header) {
	...
	private void setSupEcomAttrAmd(Gstr1GetInvoicesReqDto dto,
			SupEcomInvoices supEcomInvoices,
			GetGstr1SupEcomAmdHeaderEntity header) {
		header.setGstin(dto.getGstin());
		header.setReturnPeriod(dto.getReturnPeriod());
		if (dto.getReturnPeriod() != null
				&& dto.getReturnPeriod().length() > 0) {
