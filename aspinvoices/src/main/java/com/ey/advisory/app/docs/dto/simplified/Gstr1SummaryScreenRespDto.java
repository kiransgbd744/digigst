 ...
 *
 */
public class Gstr1SummaryScreenRespDto implements Cloneable {
	...
	public List<Gstr1SummaryScreenItemRespDto> getItems() {
		return items;
	}

	public void setItems(List<Gstr1SummaryScreenItemRespDto> items) {
		this.items = items;
	}
