...
@Component("Gstr1AdvRecAmenSecTotalSummaryDaoImpl")
public class Gstr1AdvRecAmenSecTotalSummaryDaoImpl
		implements Gstr1AdvRecSavableDao {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(Gstr1AdvRecAmenSecTotalSummaryDaoImpl.class);
	...
	public List<Object> getGstr1AdvRecSavableReports(SearchCriteria criteria) {
		...
		if (APIConstants.GSTR1A.equalsIgnoreCase(request.getReturnType())) {
			queryStr = createApiProcessedQueryStringForGstr1a(
					buildQueryAdv.toString());

		} else {
			queryStr = createApiProcessedQueryString(buildQueryAdv.toString());
	...
	private String createApiProcessedQueryStringForGstr1a(String buildQueryAdv) {
