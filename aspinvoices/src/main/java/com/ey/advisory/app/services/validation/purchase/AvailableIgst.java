...
import static com.ey.advisory.common.GSTConstants.Availableigstamount;
...
public class AvailableIgst  implements DocRulesValidator<InwardTransDocument>{
			...
			if((!ORGDOCNUM_REQUIRING_IMPORTS.contains(
					...
					errorLocations.add(Availableigstamount);
					TransDocProcessingResultLoc location = 
							                  new TransDocProcessingResultLoc(
							idx, errorLocations.toArray());
					errors.add(new ProcessingResult(APP_VALIDATION, "ER106",
							"Invalid Available IGST",
							location));
				}
