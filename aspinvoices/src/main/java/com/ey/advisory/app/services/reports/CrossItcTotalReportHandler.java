...
@Component("CrossItcTotalReportHandler")
public class CrossItcTotalReportHandler {
	
	@Autowired
	@Qualifier("CrossItcTotalReportsServiceImpl")
	private Gstr1VerticalReportsService gstr1VerticalReportsService;

	public Workbook downloadCrossItcTotalReport(
