...
@Entity
@Table(name = "GETGSTR1_CDNR_ITEM")
public class GetGstr1CdnrItemEntity {
	...
	private GetGstr1CdnrHeaderEntity document;
	...
	public GetGstr1CdnrHeaderEntity getDocument() {
		return document;
	}

	public void setDocument(GetGstr1CdnrHeaderEntity document) {
