 ...
 *
 */
public class SetOffSgstinValidationRule implements ValidationRule {
	...
	public List<ProcessingResult> isValid(Object obj, Object[] row,
		...
		if (!isPresent(obj)) {
			...
			errors.add(new ProcessingResult(APP_VALIDATION, "ER1857",
		...
		if (obj.toString().trim().length() != 15 || !matcher.matches()) {
			...
			errors.add(new ProcessingResult(APP_VALIDATION, "ER1855",
