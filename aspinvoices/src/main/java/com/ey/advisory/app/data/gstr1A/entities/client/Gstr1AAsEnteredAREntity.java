...
@Entity
@Table(name = "GSTR1A_AS_ENTERED_ADV_RECEVIED")
@Setter
@Getter
@ToString
public class Gstr1AAsEnteredAREntity {

	@Expose
	@Id
	@SerializedName("id")
	@SequenceGenerator(name = "sequence", sequenceName = "GSTR1A_AS_ENTERED_ADV_RECEVIED_SEQ", allocationSize = 100)
