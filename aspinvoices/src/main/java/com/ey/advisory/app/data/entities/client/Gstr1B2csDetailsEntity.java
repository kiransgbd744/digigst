...
@Entity
@Table(name = "GSTR1_PROCESSED_B2CS")
@Setter
@Getter
@ToString
public class Gstr1B2csDetailsEntity {

	@Expose
	@Id
	@SerializedName("id")
	@SequenceGenerator(name = "sequence", sequenceName = "GSTR1_PROCESSED_B2CS_SEQ", allocationSize = 100)
	...
	public Gstr1B2csDetailsEntity(Long fileId, String sgstin,
	...
	public Gstr1B2csDetailsEntity add(Gstr1B2csDetailsEntity newObj) {
	...
	public Gstr1B2csDetailsEntity() {
	}

	public Gstr1B2csDetailsEntity(String b2csKey) {
		// this.b2csKey = b2csKey;
	}
}
