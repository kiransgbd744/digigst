...
@Service("GstrCDNURRespHandler")
public class GstrCDNURRespHandler {
	...
	public JsonElement handleCDNURResp(List<? extends Gstr1SummaryDto> list,
			Gstr1SummaryReqDto gstr1SummaryRequest) {
		
		List<Gstr1BasicSummarySectionDto> cdnurEySummary = new ArrayList<>();
		for (Gstr1SummaryDto gstr1Summary : list) {
			cdnurEySummary = gstr1Summary.getCdnur().getEySummary();
		}
...
*/				/**
				...
				JsonElement cdnurRespBody = gstr1SummaryStructure
				.cdnurStructure(cdnurEySummary, gstnList);
