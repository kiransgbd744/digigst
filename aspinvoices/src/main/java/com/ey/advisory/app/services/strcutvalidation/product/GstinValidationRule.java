 ...
 *
 */
public class GstinValidationRule implements ValidationRule {
	...
	public List<ProcessingResult> isValid(Object obj, Object[] row,
		...
		if (obj != null) {
			...
			if (recipientGstnOrPan != null && recipientGstnOrPan.length() != 15
				...
				errors.add(new ProcessingResult(APP_VALIDATION, "ER1612",
			...
			if (recipientGstnOrPan != null && recipientGstnOrPan.length() == 15
				...
				TransDocProcessingResultLoc location = new TransDocProcessingResultLoc(
						null, errorLocations.toArray());
				errorLocations.add(GSTConstants.GSTINORPAN);
				errors.add(new ProcessingResult(APP_VALIDATION, "ER1611",
