...
import com.ey.advisory.core.search.SearchCriteria;
	...
	@Service("Gstr1AAspCDNRReportServiceImpl")
	public class Gstr1AAspCDNRReportServiceImpl
			implements Gstr1AReviewSummReportsService {

		private static final Logger LOGGER = LoggerFactory
				.getLogger(Gstr1AAspCDNRReportServiceImpl.class);

		@Autowired
		CommonUtility commonUtility;

		@Autowired
		@Qualifier("Gstr1AAspCDNRSectionReportDaoImpl")
