 ...
 */
@Entity
@Table(name = "GETGSTR1A_B2BA_ITEM")
public class GetGstr1AB2baItemEntity {

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "GETGSTR1A_B2BA_ITEM_SEQ", allocationSize = 100)
	...
	private GetGstr1AB2baHeaderEntity document;
	...
	public GetGstr1AB2baHeaderEntity getDocument() {
		return document;
	}

	public void setDocument(GetGstr1AB2baHeaderEntity document) {
