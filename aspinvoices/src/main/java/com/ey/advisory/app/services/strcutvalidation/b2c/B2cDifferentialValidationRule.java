 ...
 *
 */
public class B2cDifferentialValidationRule implements ValidationRule {
	...
	public List<ProcessingResult> isValid(Object obj, Object[] row,
		...
		String diff = obj.toString().trim();
			if (diff.length() > 3
					|| !IMPORTS.contains(diff)) {

				Set<String> errorLocations = new HashSet<>();
				errorLocations.add(GSTConstants.DifferentialPercentageFlag);
				TransDocProcessingResultLoc location = new TransDocProcessingResultLoc(
						null, errorLocations.toArray());
				errors.add(new ProcessingResult(APP_VALIDATION, "ER0209",
