...
@Component("Gstr1AspNilRatedTransactionalDaoImpl")
public class Gstr1AspNilRatedTransactionalDaoImpl
		implements Gstr1OutwardVerticalProcessNilDao {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(Gstr1AspNilRatedTransactionalDaoImpl.class);
	...
	private static String createApiProcessedQueryString(String buildQueryheader, String multiSupplyTypeAns) {
			...
			return "SELECT '' AS ERROR_CODE_ASP "
					...
					+ "			THEN 'Rejected' "
					+ "		WHEN HDR.EWB_STATUS = 13 "
					+ "			THEN 'Generated as provided by user' "
