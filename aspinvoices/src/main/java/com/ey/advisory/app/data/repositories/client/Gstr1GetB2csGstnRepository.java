 ...
 *
 */
@Repository("Gstr1GetB2csGstnRepository")
@Transactional(propagation = Propagation.REQUIRED, readOnly = false)
public interface Gstr1GetB2csGstnRepository
		extends CrudRepository<GetGstr1B2csHeaderEntity, Long> {
	@Modifying
	@Query("UPDATE GetGstr1B2csHeaderEntity b SET b.isDelete = true,b.modifiedBy = 'SYSTEM'  , b.modifiedOn =:modifiedOn   WHERE"
	...
	@Query("SELECT COUNT(*) FROM GetGstr1B2csHeaderEntity "
