...
@Entity
@Table(name = "GETGSTR1_DOC_ISSUED")
@Setter
@Getter
@ToString
public class GetGstr1DocIssuedEntity {

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "GETGSTR1_DOC_ISSUED_SEQ", allocationSize = 100)
