...
public class GetGstr6ADetailStatusService {
	...
	private GetGstr6ADetailStatusFetchDaoImpl getGstr6ADetailStatusFetchDao;
	...
	public GetGstr6DetailStatusMainDetailsRespDto findByCriteria(
		...
		List<Object[]> gstinList = getGstr6ADetailStatusFetchDao
		...
		if (!gstinList.isEmpty() && gstinList.size() > 0) {
			for (Object obj : gstinList) {
				...
				List<Object[]> itemsList = getGstr6ADetailStatusFetchDao
