 ...
 *
 */
@Repository("GetGstr2aTcsInvoicesRepository")
@Transactional(propagation = Propagation.REQUIRED, readOnly = false)
public interface GetGstr2aTcsInvoicesRepository
		extends CrudRepository<GetGstr2aTcsInvoicesEntity, Long> {

	@Modifying
	@Query("UPDATE GetGstr2aTcsInvoicesEntity b SET b.isDelete = true ,b.modifiedBy = 'SYSTEM'  , b.modifiedOn =:modifiedOn   WHERE"
