...
import com.google.common.base.Strings;
	...
	@Component("Gstr1AAspCDNRSectionReportDaoImpl")
	public class Gstr1AAspCDNRSectionReportDaoImpl
			implements Gstr1AReviewSummaryReportsDao {

		private static final Logger LOGGER = LoggerFactory
				.getLogger(Gstr1AAspCDNRSectionReportDaoImpl.class);
...
//					.findAnswerForMultiSupplyType();
		...
		private static String createApiProcessedQueryString(String buildHeader, String multiSupplyTypeAns) {
				...
				+ "AND HDR.RETURN_TYPE='GSTR1A' AND HDR.TAX_DOC_TYPE IN ('CDNR') " + buildHeader
