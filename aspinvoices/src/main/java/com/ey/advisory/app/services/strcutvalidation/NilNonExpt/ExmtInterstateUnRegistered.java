...
public class ExmtInterstateUnRegistered implements ValidationRule {
	...
	public List<ProcessingResult> isValid(Object obj, Object[] row,
		...
		if (!isDecimal(obj.toString().trim())) {
			...
			errorLocations.add(GSTConstants.EXT_INTERSTATE_UN_REG);
			TransDocProcessingResultLoc location = new TransDocProcessingResultLoc(
					null, errorLocations.toArray());
			errors.add(new ProcessingResult(APP_VALIDATION, "ER5611",
					"Invalid EXT-Inter State UnRegistered.", location));
			return errors;
		}
