 ...
 */
@Entity
@Table(name = "GETANX1_DOC_TYPE_SUMMARY")
@Setter
@Getter
public class GetAnx1DocTypeSummaryEntity {
	...
	private GetAnx1SectionSummaryEntity docSecSumId;

/*	@ManyToOne
	@JoinColumn(name = "EXPWP_ID", referencedColumnName = "ID", nullable = false)
	private GetAnx1ExpwpExpwopSecSummaryEntity expwpSecSumId;*/
