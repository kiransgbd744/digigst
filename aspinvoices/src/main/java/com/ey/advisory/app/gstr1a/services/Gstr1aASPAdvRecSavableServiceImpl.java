...
@Service("Gstr1aASPAdvRecSavableServiceImpl")
public class Gstr1aASPAdvRecSavableServiceImpl
		implements Gstr1ASPAdvRecSavableService {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(Gstr1aASPAdvRecSavableServiceImpl.class);

	@Autowired
	CommonUtility commonUtility;
	
	@Autowired
	@Qualifier("Gstr1aASPAdvRecSavableTotalSummaryDaoImpl")
	private Gstr1AdvRecSavableDao gstr1AdvRectotalDao;

	@Autowired
	@Qualifier("Gstr1aASPAdvRecSavableSummaryDaoImpl")
	...
	public Workbook findGstr1AdvRecSavableReports(SearchCriteria criteria,
		...
		workbook = createWorkbookWithExcelTemplate("ReportTemplates",
				"GSTR-1A_ASP_Advance_Received_Savable.xlsx");
