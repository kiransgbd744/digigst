...
@Service("Gstr2ANewConsolidatedServiceImpl")
public class Gstr2ANewConsolidatedServiceImpl
		implements Gstr2AspErrorReportsService {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(Gstr2ANewConsolidatedServiceImpl.class);

	@Autowired
	CommonUtility commonUtility;

	@Autowired
	@Qualifier("Gstr2ANewconsolidatedReportDaoImpl")
	private Gstr2ANewconsolidatedReportDaoImpl gstr2ANewconsolidatedReportDaoImpl;
	...
	public Workbook findError(SearchCriteria criteria, PageRequest pageReq) {
		...
		responseFromView = gstr2ANewconsolidatedReportDaoImpl
