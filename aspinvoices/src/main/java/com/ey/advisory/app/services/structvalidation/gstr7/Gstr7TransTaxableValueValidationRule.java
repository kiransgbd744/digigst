...
public class Gstr7TransTaxableValueValidationRule implements ValidationRule {
	...
	public List<ProcessingResult> isValid(int idx, Object obj, Object[] row,
		...
		if (obj == null) {
			...
			errors.add(new ProcessingResult(APP_VALIDATION, "ER63037",
					"Taxable Value cannot be left blank.", location));
			return errors;
		}
