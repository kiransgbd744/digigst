...
@Entity
@Table(name = "GETGSTR1_B2CSA_ITEM")
public class GetGstr1B2csaItemEntity {

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "GETGSTR1_B2CSA_ITEM_SEQ", allocationSize = 100)
	...
	private GetGstr1B2csaHeaderEntity document;
	...
	public GetGstr1B2csaHeaderEntity getDocument() {
		return document;
	}

	public void setDocument(GetGstr1B2csaHeaderEntity document) {
