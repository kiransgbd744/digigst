...
@Slf4j
@Component("gstr1ATxpTxpaAtGstnImpl")
public class Gstr1ATxpTxpaAtGstnImpl implements Gstr1InvoicesAtGstn {

	
	@Autowired
	@Qualifier("gstr1ATxpTxpaDataAtGstnImpl")
	Gstr1ATxpTxpaDataAtGstn gstr1ATxpTxpaDataAtGstn;
...
*/
			...
			reqId = gstr1ATxpTxpaDataAtGstn.getGstr1TxpTxpaDataAtGstn(dto,
					groupCode, type, json);
