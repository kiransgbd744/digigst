...
@Entity
@Table(name = "GETGSTR1_B2BA_HEADER")

public class GetGstr1B2baHeaderEntity {

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "GETGSTR1_B2BA_HEADER_SEQ", allocationSize = 100)
	...
	protected List<GetGstr1B2baItemEntity> lineItems = new ArrayList<>();
	...
	public List<GetGstr1B2baItemEntity> getLineItems() {
		return lineItems;
	}

	public void setLineItems(List<GetGstr1B2baItemEntity> lineItems) {
