...
@Entity
@Table(name = "GSTR1_PROCESSED_NILEXTNON")
@Data
@NoArgsConstructor
public class Gstr1NilDetailsEntity {

	@Expose
	@Id
	@SerializedName("id")
	@SequenceGenerator(name = "sequence", sequenceName = "GSTR1_PROCESSED_NILEXTNON_SEQ", allocationSize = 100)
	...
	public Gstr1NilDetailsEntity(String nKey2) {
		this.nKey = nKey2;
	}

	public Gstr1NilDetailsEntity add(Gstr1NilDetailsEntity newObj) {
