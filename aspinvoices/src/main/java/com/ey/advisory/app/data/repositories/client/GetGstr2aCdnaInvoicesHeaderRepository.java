...
@Repository("GetGstr2aCdnaInvoicesHeaderRepository")
@Transactional(propagation = Propagation.REQUIRED, readOnly = true)
public interface GetGstr2aCdnaInvoicesHeaderRepository
		extends CrudRepository<GetGstr2aCdnaInvoicesHeaderEntity, Long> {

	@Modifying
	@Transactional
	@Query("UPDATE GetGstr2aCdnaInvoicesHeaderEntity SET "
	...
	@Query("SELECT distinct erpBatchId FROM GetGstr2aCdnaInvoicesHeaderEntity WHERE "
			+ "countergstin=:cgstin AND cdnBatchIdGstr2a=:batchId "
