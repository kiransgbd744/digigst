 ...
 *
 */
@Repository("Gstr1AInvoiceRepository")
@Transactional(propagation = Propagation.REQUIRED, readOnly = false)
public interface Gstr1AInvoiceRepository
		extends JpaRepository<Gstr1AInvoiceFileUploadEntity, Long>,
		JpaSpecificationExecutor<Gstr1AInvoiceFileUploadEntity> {

	@Modifying
	@Query("UPDATE Gstr1AInvoiceFileUploadEntity doc SET doc.gstnBatchId = "
	...
	@Modifying
	@Query("UPDATE Gstr1AInvoiceFileUploadEntity b SET b.isDelete= TRUE "
	...
	@Query("SELECT "
			...
			+ "FROM Gstr1AInvoiceFileUploadEntity doc WHERE "
	...
	@Modifying
	@Query("UPDATE Gstr1AInvoiceFileUploadEntity doc SET doc.isDelete=true,"
	...
	@Modifying
	@Query("UPDATE Gstr1AInvoiceFileUploadEntity doc SET doc.isSentToGstn = false,"
	...
	Optional<Gstr1AInvoiceFileUploadEntity> findTop1BySgstinAndReturnPeriodAndIsDeleteFalseOrderByCreatedOnDesc(
			@Param("sgstin") String sgstin,
			@Param("returnPeriod") String returnPeriod);

	@Query("SELECT COUNT(*) FROM Gstr1AInvoiceFileUploadEntity  WHERE  "
