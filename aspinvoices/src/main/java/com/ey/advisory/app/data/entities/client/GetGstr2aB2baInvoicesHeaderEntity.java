...
@Data
@Entity
@Table(name = "GETGSTR2A_B2BA_HEADER")
public class GetGstr2aB2baInvoicesHeaderEntity extends GetGstr2aB2baInvoicesHeader {
	...
	protected List<GetGstr2aB2baInvoicesItemEntity> lineItems = new ArrayList<>();
