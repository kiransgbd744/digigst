...
@Service("Gstr1AEinvoiceSalesDocRulesValidatorService")
public class Gstr1AEinvoiceSalesDocRulesValidatorService implements 
			DocRulesValidatorService<Gstr1AOutwardTransDocument, String> {

	@Autowired
	@Qualifier("Gstr1AEinvoiceDefaultSalesDocListRulesValidator")
