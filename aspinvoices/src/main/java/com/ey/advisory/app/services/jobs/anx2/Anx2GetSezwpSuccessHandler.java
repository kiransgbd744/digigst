 ...
 *
 */
@Service("Anx2GetSezwpSuccessHandler")
@Slf4j
public class Anx2GetSezwpSuccessHandler  implements SuccessHandler {

	@Autowired
	@Qualifier("Anx2SezwpDataParserImpl")
	private Anx2SezwpDataParser anx2DataParser;
	...
	@Autowired
	private GetAnx2SezwpInvoicesRepository headerRepo;
	...
	public void handleSuccess(SuccessResult result, String apiParams) {
		try {
			...
			if (LOGGER.isDebugEnabled()) {
				LOGGER.debug(
						"GET Call is Success for the batchId {} inside Anx2GetSezwpSuccessHandler.java",
