 ...
 *
 */
public class Gstr7TransPayAdvDateValidationRule implements ValidationRule {
	...
	public List<ProcessingResult> isValid(int idx,Object obj, Object[] row,
		...
		if (date == null) {
			...
			errorLocations.add(GSTConstants.PAYMENT_ADVICE_DATE);
			TransDocProcessingResultLoc location = new TransDocProcessingResultLoc(
					idx, errorLocations.toArray());
			errors.add(new ProcessingResult(APP_VALIDATION, "ER63020",
					"Invalid Payment Advice Date", location));
