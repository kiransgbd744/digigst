...
@Data
@Entity
@Table(name = "TBL_ISD_DISTRIBUTION_PSD")
public class IsdDistributionPsdEntity {
	
	@Expose
	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "ISD_PROCESSED_DOC_SEQ", allocationSize = 100)
