...
public class StateApplyingCessValidationRule implements ValidationRule {
	...
	public List<ProcessingResult> isValid(int idx,Object obj, Object[] row,
		...
		if (!isPresent(obj)) return errors;
			...
			if (obj.toString().trim().length() > 2 || !StringUtils.isNumeric(obj.toString().trim())) {
				...
				errors.add(new ProcessingResult(APP_VALIDATION, "ER0058",
						"Invalid State Applying Cess (State Code)", location));
				return errors;
			}
