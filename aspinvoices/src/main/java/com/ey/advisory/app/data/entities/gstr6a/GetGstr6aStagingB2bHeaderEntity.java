 ...
 */
@Entity
@Table(name = "GETGSTR6A_STAGING_B2B_HEADER")
public class GetGstr6aStagingB2bHeaderEntity {
	...
	protected List<GetGstr6aStagingB2bItemEntity> lineItems = new ArrayList<>();
	...
	public List<GetGstr6aStagingB2bItemEntity> getLineItems() {
		return lineItems;
	}

	public void setLineItems(List<GetGstr6aStagingB2bItemEntity> lineItems) {
