...
import com.ey.advisory.app.data.entities.client.TransDocHeaderItemError;
...
@Entity
@Table(name = "ANX_OUTWARD_ERR_ITEM_1A")
@Setter
@Getter
@ToString
public class Gstr1AAnxOutwardTransDocLineItemError
		extends TransDocHeaderItemError {

	@Expose
	@SerializedName("id")
	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "ANX_OUTWARD_ERR_ITEM_SEQ_1A", allocationSize = 100)
	...
	private Gstr1AAnx1OutWardErrHeader document;

	public Gstr1AAnxOutwardTransDocLineItemError() {
