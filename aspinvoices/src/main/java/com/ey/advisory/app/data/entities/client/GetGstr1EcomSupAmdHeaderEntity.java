...
@Data
@Entity
@Table(name = "GETGSTR1_ECOMSUP_AMD_HEADER")
public class GetGstr1EcomSupAmdHeaderEntity {
	...
	protected List<GetGstr1EcomSupAmdItemEntity> lineItems = new ArrayList<>();
	
	@Override
	public String toString() {
	    return "GetGstr1EcomSupAmdHeaderEntity{" +
	            "id=" + id +
	            ", batchId=" + batchId +
	            ", ctin='" + ctin + '\'' +
	            ", action='" + action + '\'' +
	            ...
	            ", gstin='" + gstin + '\'' +
	            ", orgPeriod='" + orgPeriod + '\'' +
	            ", orgSuppGstin='" + orgSuppGstin + '\'' +
	            ", orgCustGstin='" + orgCustGstin + '\'' +
	            ", taxValue=" + taxValue +
	            ", igstAmt=" + igstAmt +
	            ", cgstAmt=" + cgstAmt +
	            ", sgstAmt=" + sgstAmt +
