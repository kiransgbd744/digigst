...
@Entity
@Table(name = "GETGSTR1_CDNRA_HEADER")
public class GetGstr1CdnraHeaderEntity {

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "GETGSTR1_CDNRA_HEADER_SEQ", allocationSize = 100)
	...
	protected List<GetGstr1CdnraItemEntity> lineItems = new ArrayList<>();
	...
	public List<GetGstr1CdnraItemEntity> getLineItems() {
		return lineItems;
	}

	public void setLineItems(List<GetGstr1CdnraItemEntity> lineItems) {
