 ...
 *
 */
public class TcsTdsTaxpayerGstinValidationRule implements ValidationRule {
	...
	public List<ProcessingResult> isValid(Object obj, Object[] row,
		...
		if (!isPresent(obj)) {
			...
			errors.add(new ProcessingResult(APP_VALIDATION, "ER1322",
					"TaxPayerGSTIN cannot be left blank", location));
			return errors;
		}
		...
		if (obj.toString().trim().length() != 15 || !matcher.matches()) {
			...
			TransDocProcessingResultLoc location = new TransDocProcessingResultLoc(
					null, errorLocations.toArray());
			errors.add(new ProcessingResult(APP_VALIDATION, "ER1323",
					"Invalid TaxPayerGSTIN", location));
			return errors;
		}
		return errors;
