 ...
 */
@Slf4j
@Component("gstr1AAtAtaAtGstnImpl")
public class Gstr1AAtAtaAtGstnImpl implements Gstr1InvoicesAtGstn {

	@Autowired
	@Qualifier("gstr1AAtAtaDataAtGstnImpl")
	private Gstr1AAtAtaDataAtGstn gstr1AAtAtaDataAtGstn;
	...
	public Long findInvFromGstn(Gstr1GetInvoicesReqDto dto,
		...
		try {
			...
			reqId = gstr1AAtAtaDataAtGstn.findAtAtaDataAtGstn(dto, groupCode,
					type, json);
			...
			throw new APIException(
					"Unexpected error while executing Gstr1A Get At/Ata");
