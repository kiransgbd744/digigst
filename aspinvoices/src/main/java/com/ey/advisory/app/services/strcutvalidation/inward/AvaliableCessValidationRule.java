...
public class AvaliableCessValidationRule implements ValidationRule {
	...
	public List<ProcessingResult> isValid(int idx,Object obj, Object[] row,
		...
		if (!isPresent(obj)) return errors;
			...
			if (!isDecimal(obj)) {
				...
				errors.add(new ProcessingResult(APP_VALIDATION, "ER1153",
						"Invalid Avaliable Cess", location));
