 ...
 * 
 */
public class Anx1Asp3H3IVerticalDto {
	...
	public String toString() {
		return "Anx1Asp3H3IVerticalDto [returnType=" + returnType
				+ ", recipientGSTIN=" + recipientGSTIN + ", returnPeriod="
				+ returnPeriod  + ", transactionFlag="
				...
				+ ", userdefinedfield3=" + userdefinedfield3 + ", saveStatus="
