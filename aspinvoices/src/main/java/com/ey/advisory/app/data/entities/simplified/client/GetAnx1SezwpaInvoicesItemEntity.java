...
@Entity
@Table(name = "GETANX1_SEZWPA_ITEM")
public class GetAnx1SezwpaInvoicesItemEntity {
	...
	protected GetAnx1SezwpaInvoicesHeaderEntity header;
	...
	public GetAnx1SezwpaInvoicesHeaderEntity getHeader() {
		return header;
	}

	public void setHeader(GetAnx1SezwpaInvoicesHeaderEntity header) {
		this.header = header;
	}
