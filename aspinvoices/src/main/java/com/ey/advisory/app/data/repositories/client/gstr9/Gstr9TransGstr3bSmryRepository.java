 ...
 *
 */
@Repository("Gstr9TransGstr3bSmryRepository")
@Transactional(propagation = Propagation.REQUIRED, readOnly = false)
public interface Gstr9TransGstr3bSmryRepository
		extends JpaRepository<Gstr9TransGstr3bSmryEntity, Long> {

	@Query("SELECT distinct chunkId FROM Gstr9TransGstr3bSmryEntity WHERE "
	...
	public List<Gstr9TransGstr3bSmryEntity> findBySgstinAndGstr9FyAndIsDeleteAndChunkId(
