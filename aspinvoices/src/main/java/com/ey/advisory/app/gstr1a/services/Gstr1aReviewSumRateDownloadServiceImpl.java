...
import com.ey.advisory.app.services.reports.Gstr1ReviewRateDynamicExcel;
...
@Component("Gstr1aReviewSumRateDownloadServiceImpl")
public class Gstr1aReviewSumRateDownloadServiceImpl
		implements Gstr1ReviewSummaryDownloadService {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(Gstr1aReviewSumRateDownloadServiceImpl.class);
	...
	private Gstr1ASimpleDocGstnSummarySearchService gstr1SimpleDocGstnSummarySearchService;
	...
	public Workbook findGstr1RevSummTablesReports(
		...
		SearchResult<Gstr1CompleteSummaryDto> gstnSumryResult = (SearchResult<Gstr1CompleteSummaryDto>) gstr1SimpleDocGstnSummarySearchService
		...
		workbook = createWorkbookWithExcelTemplate("ReportTemplates",
				"GSTR-1A_ReviewRate_Screen_Download.xlsx");

		LOGGER.debug("GSTR1A Review Summary screen download Response"
		...
		try {
			...
			Gstr1ReviewRateDynamicExcel.generaterateExcelForGstr1a(workbook,
