...
import com.ey.advisory.app.data.entities.simplified.client.Anx1RevProcEntity;

@Repository("Anx1RevProcRepository")
@Transactional(propagation = Propagation.REQUIRED, readOnly = false)
public interface Anx1RevProcRepository extends CrudRepository<Anx1RevProcEntity, Long> {

	@Modifying
	@Query("UPDATE Anx1RevProcEntity doc SET doc.gstnBatchId=:gstnBatchId,"
	...
	@Modifying
	@Query("UPDATE Anx1RevProcEntity doc SET "
