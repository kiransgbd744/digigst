...
import com.ey.advisory.app.data.entities.client.B2csProcEntity;
 ...
 *
 */
@Repository("B2csProcRepository")
@Transactional(propagation = Propagation.REQUIRED, readOnly = false)
public interface B2csProcRepository extends CrudRepository<B2csProcEntity, Long> {

	@Modifying
	@Query("UPDATE B2csProcEntity doc SET doc.gstnBatchId=:gstnBatchId,"
	...
	/*@Modifying
	@Query("UPDATE B2csProcEntity doc SET "
	...
	@Modifying
	@Query("UPDATE B2csProcEntity doc SET doc.isSaved=true,doc.modifiedOn = "
	...
	@Modifying
	@Query("UPDATE B2csProcEntity doc SET doc.isError=true, doc.modifiedOn = "
