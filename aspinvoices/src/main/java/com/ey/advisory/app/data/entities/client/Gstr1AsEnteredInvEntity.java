...
@Entity
@Table(name = "GSTR1_AS_ENTERED_INV_SERIES")
@Setter
@Getter
@ToString
public class Gstr1AsEnteredInvEntity {
	...
	@SerializedName("id")
	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "GSTR1_AS_ENTERED_INV_SERIES_SEQ", allocationSize = 100)
