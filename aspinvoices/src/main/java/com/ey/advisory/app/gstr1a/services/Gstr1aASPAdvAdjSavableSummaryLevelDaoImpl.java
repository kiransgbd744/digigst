...
import com.ey.advisory.app.services.reports.Gstr1ASPAdvAdjSavableSummaryLevelDao;
import com.ey.advisory.app.util.OnboardingConstant;
import com.ey.advisory.common.GenUtil;
import com.ey.advisory.core.dto.Gstr1ReviwSummReportsReqDto;
import com.ey.advisory.core.search.SearchCriteria;

@Component("Gstr1aASPAdvAdjSavableSummaryLevelDaoImpl")
public class Gstr1aASPAdvAdjSavableSummaryLevelDaoImpl
		implements Gstr1ASPAdvAdjSavableSummaryLevelDao {
	private static final Logger LOGGER = LoggerFactory
			.getLogger(Gstr1aASPAdvAdjSavableSummaryLevelDaoImpl.class);
	...
	public List<Object> getGstr1AdjSavableReports(SearchCriteria criteria) {
		...
		String queryStr = createAdjSavableSummaryQueryString(
				buildQuery.toString());
	...
	private String createAdjSavableSummaryQueryString(String buildQuery) {
