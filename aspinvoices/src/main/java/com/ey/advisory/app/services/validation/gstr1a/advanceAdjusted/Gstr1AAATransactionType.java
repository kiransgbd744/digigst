...
public class Gstr1AAATransactionType implements
		B2csBusinessRuleValidator<Gstr1AAdvanceAdjustmentFileUploadEntity> {
	private static final List<String> Trans_TYPE_IMPORTS = ImmutableList.of("L",
			"Z", "ZL");

	@Override
	public List<ProcessingResult> validate(
			Gstr1AAdvanceAdjustmentFileUploadEntity document,
