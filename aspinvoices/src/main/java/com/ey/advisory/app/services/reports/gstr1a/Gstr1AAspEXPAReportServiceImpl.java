...
import com.ey.advisory.core.search.SearchCriteria;
	...
	@Service("Gstr1AAspEXPAReportServiceImpl")
	public class Gstr1AAspEXPAReportServiceImpl
			implements Gstr1AReviewSummReportsService {

		private static final Logger LOGGER = LoggerFactory
				.getLogger(Gstr1AAspEXPAReportServiceImpl.class);

		@Autowired
		CommonUtility commonUtility;

		@Autowired
		@Qualifier("Gstr1AAspEXPASectionReportDaoImpl")
