 ...
 *
 */
@Repository("Gstr1GetCdnurGstnRepository")
@Transactional(propagation = Propagation.REQUIRED, readOnly = false)
public interface Gstr1GetCdnurGstnRepository
		extends CrudRepository<GetGstr1CdnurHeaderEntity, Long> {
	@Modifying
	@Query("UPDATE GetGstr1CdnurHeaderEntity b SET b.isDelete = true,b.modifiedBy = 'SYSTEM'  , b.modifiedOn =:modifiedOn   WHERE"
	...
	@Query("SELECT COUNT(*) FROM GetGstr1CdnurHeaderEntity "
