...
@Service("Gstr1ASPAdvAdjSavableServiceImpl")
public class Gstr1ASPAdvAdjSavableServiceImpl
		implements Gstr1ASPAdvAdjSavableService {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(Gstr1ASPAdvAdjSavableServiceImpl.class);
	...
	@Autowired
	@Qualifier("Gstr1ASPAdvAdjSavableTotalDaoImpl")
	private Gstr1ASPAdvAdjSavableTotalDao gstr1ASPAdvAdjSavableTotalDao;
	...
	@Autowired
	@Qualifier("Gstr1ASPAdvAdjSavableSummaryLevelDaoImpl")
