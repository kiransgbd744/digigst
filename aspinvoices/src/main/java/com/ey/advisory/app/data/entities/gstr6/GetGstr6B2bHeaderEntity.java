...
@Entity
@Table(name = "GETGSTR6_B2B_HEADER")
public class GetGstr6B2bHeaderEntity {

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "GETGSTR6_B2B_HEADER_SEQ", allocationSize = 100)
	...
	protected List<GetGstr6B2bItemEntity> lineItems = new ArrayList<>();
	...
	public List<GetGstr6B2bItemEntity> getLineItems() {
		return lineItems;
	}

	public void setLineItems(List<GetGstr6B2bItemEntity> lineItems) {
