...
public class Gstr1B2clFilingDto {
	
	private String gstin;
	private String ret_period;
	private String summ_typ;
	
	private List<B2CLFilingDto> sec_sum;
	 ...
	 * @return the sec_sum
	 */
	public List<B2CLFilingDto> getSec_sum() {
		return sec_sum;
	}
	 ...
	 */
	public void setSec_sum(List<B2CLFilingDto> sec_sum) {
