...
import com.ey.advisory.core.search.SearchCriteria;
	...
	@Service("Gstr1AAspSezWopServiceImpl")
	public class Gstr1AAspSezWopServiceImpl
			implements Gstr1AReviewSummReportsService {

		private static final Logger LOGGER = LoggerFactory
				.getLogger(Gstr1AAspSezWopServiceImpl.class);

		@Autowired
		CommonUtility commonUtility;

		@Autowired
		@Qualifier("Gstr1AAspSezWopSectionReportDaoImpl")
