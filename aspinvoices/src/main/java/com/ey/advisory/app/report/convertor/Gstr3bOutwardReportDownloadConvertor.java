...
@Component("Gstr3bOutwardReportDownloadConvertor")
@Slf4j
public class Gstr3bOutwardReportDownloadConvertor implements ReportConvertor {
	...
	public Object convert(Object[] arr, String reportType) {
		...
		Gstr3BOutwardReportDownloadDto obj = new Gstr3BOutwardReportDownloadDto();
		...
		if (arr[297] != null) {
			...
			obj.setEwbTime(DownloadReportsConstant.CSVCHARACTER
					.concat(time));
		...
		obj.setShippingBillDate(arr[131] != null ? arr[131].toString() : null);
		...
		obj.setPaymentDueDate(arr[156] != null ? arr[156].toString() : null);
		...
		obj.setTransportDocDate(arr[170] != null ? arr[170].toString() : null);
		...
		obj.setGlPostingDate(arr[226] != null ? arr[226].toString() : null);
		...
		obj.setTableNumberGSTR3B(arr[304] != null ? arr[304].toString() : null);
