...
@Component("NilNonVerticalProcessedReportsDaoImpl")
public class NilNonVerticalProcessedReportsDaoImpl implements NilNonVerticalDao {

	@PersistenceContext(unitName = "clientDataUnit")
	private EntityManager entityManager;

	private static final Logger LOGGER = LoggerFactory.getLogger(NilNonVerticalProcessedReportsDaoImpl.class);
	...
	private NilNonProcessedRecordsDto convertVerticalTotal(Object[] arr) {
		 ...
		 * obj.setaSPErrorDescription(arr[15] != null ? arr[15].toString() :
		 * null);
		 */
