...
import com.ey.advisory.app.services.annexure1fileupload.InterestStructuralErrorUploadService;
...
@Component("InterestAndLateFeeFileArrivalHandler")
public class InterestAndLateFeeFileArrivalHandler {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(InterestAndLateFeeFileArrivalHandler.class);
	...
	@Autowired
	@Qualifier("InterestAndLateFeeHeaderCheckService")
	...
	@Autowired
	@Qualifier("InterestStructuralErrorUploadService")
	private InterestStructuralErrorUploadService interestStructuralErrorUploadService;
	...
	public void processInterestAndLateFeeFile(Message message,
		...
		List<Object[]> listOfInterest = ((FileUploadDocRowHandler<?>) rowHandler)
				.getFileUploadList();
		...
		if (checkHeaderFormat.getValue0()) {
			...
			interestStructuralErrorUploadService.processData(listOfInterest,
					updateFileStatus);
		} else {
