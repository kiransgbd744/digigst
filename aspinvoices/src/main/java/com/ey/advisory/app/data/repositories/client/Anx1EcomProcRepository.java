...
import com.ey.advisory.app.data.entities.simplified.client.Anx1EcomProcEntity;

/**
 * @author Hemasundar.J
 *
 */
@Repository("Anx1EcomProcRepository")
@Transactional(propagation = Propagation.REQUIRED, readOnly = false)
public interface Anx1EcomProcRepository extends CrudRepository<Anx1EcomProcEntity, Long> {

	@Modifying
	@Query("UPDATE Anx1EcomProcEntity doc SET doc.gstnBatchId=:gstnBatchId,"
	...
	@Modifying
	@Query("UPDATE Anx1EcomProcEntity doc SET "
