...
/**
 * This class represents a single document error. DocErrorDetailDto class is
 * responsible for transferring error details response data from server to UI
 *
 * @author Laxmi.Salukuti
 */
public class EInvoiceDocErrorDto {
