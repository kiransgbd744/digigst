 ...
 */
@Entity
@Table(name = "GETGSTR6A_CDNA_ITEM")
public class GetGstr6aCdnaItemEntity {
	...
	protected GetGstr6aCdnaHeaderEntity header;
	...
	public GetGstr6aCdnaHeaderEntity getHeader() {
		return header;
	}

	public void setHeader(GetGstr6aCdnaHeaderEntity header) {
		this.header = header;
	}
