...
@Component("Gstr1GstnB2CSSummaryTablesDaoImpl")
public class Gstr1GstnB2CSSummaryTablesDaoImpl
		implements Gstr1GstnSummaryTablesDao {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(Gstr1GstnB2CSSummaryTablesDaoImpl.class);
	...
	public List<Object> getGstr1GstnSummaryTablesReport(
		...
		return list.parallelStream().map(o -> convertgstnB2CSSummary(o))
				.collect(Collectors.toCollection(ArrayList::new));
	}

	private Gstr1GstnB2CSSummaryTablesDto convertgstnB2CSSummary(Object[] arr) {
	...
	private String creategstnB2CSSummaryQueryString(String buildQuery) {
		...
		return "SELECT HDR.ID,HDR.GSTIN,HDR.RETURN_PERIOD,MT.STATE_NAME,"
				...
				+ "SUBSTR(HDR.GSTIN,1,2) = MT.STATE_CODE WHERE HDR.IS_DELETE=FALSE " + buildQuery
				+ " GROUP BY HDR.ID,HDR.GSTIN,HDR.RETURN_PERIOD,"
				+ "MT.STATE_NAME,SUPPLY_TYPE,POS,ITM.TAX_RATE,HDR.DIFF_PERCENT,"
				+ "HDR.ECOM_TYPE,HDR.ETIN,BT.IS_FILED";
	}
}
