...
import com.ey.advisory.core.search.SearchCriteria;
	...
	@Service("AspB2CLSectionReportReportServiceImpl")
	public class AspB2CLSectionReportReportServiceImpl
			implements Gstr1ReviewSummReportsService {

		private static final Logger LOGGER = LoggerFactory
				.getLogger(AspB2CLSectionReportReportServiceImpl.class);

		@Autowired
		CommonUtility commonUtility;

		@Autowired
		@Qualifier("AspB2CLSectionReportDaoImpl")
