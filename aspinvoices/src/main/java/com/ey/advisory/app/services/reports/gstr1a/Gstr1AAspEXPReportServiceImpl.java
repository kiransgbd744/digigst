...
import com.ey.advisory.core.search.SearchCriteria;
	...
	@Service("Gstr1AAspEXPReportServiceImpl")
	public class Gstr1AAspEXPReportServiceImpl
			implements Gstr1AReviewSummReportsService {

		private static final Logger LOGGER = LoggerFactory
				.getLogger(Gstr1AAspEXPReportServiceImpl.class);

		@Autowired
		CommonUtility commonUtility;

		@Autowired
		@Qualifier("Gstr1AAspEXPSectionReportDaoImpl")
