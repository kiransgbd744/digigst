...
@Service("GstrB2BARespHandler")
public class GstrB2BARespHandler {
	...
	public JsonElement handleB2BAResp(List<? extends Gstr1SummaryDto> list,
			Gstr1SummaryReqDto gstr1SummaryRequest) {
		
		List<Gstr1BasicSummarySectionDto> b2baEySummary = new ArrayList<>();
		for (Gstr1SummaryDto gstr1Summary : list) {
			b2baEySummary = gstr1Summary.getB2ba().getEySummary();
		}
...
*/				
				...
				JsonElement b2baRespBody = gstr1SummaryStructure
				.b2baStructure(b2baEySummary, gstnList);
