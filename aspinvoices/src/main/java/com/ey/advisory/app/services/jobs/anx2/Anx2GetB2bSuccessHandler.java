 ...
 *
 */
@Service("Anx2GetB2bSuccessHandler")
@Slf4j
public class Anx2GetB2bSuccessHandler implements SuccessHandler {

	@Autowired
	@Qualifier("Anx2B2bDataParserImpl")
	private Anx2B2bDataParser anx2DataParser;
	...
	@Autowired
	private GetAnx2B2bInvoicesRepository headerRepo;
	...
	public void handleSuccess(SuccessResult result, String apiParams) {
		try {
			...
			if (LOGGER.isDebugEnabled()) {
				LOGGER.debug(
						"GET Call is Success for the batchId {} inside Anx2GetB2bSuccessHandler.java",
