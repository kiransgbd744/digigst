...
@Entity
@Table(name = "GSTR1A_AS_ENTERED_NILEXTNON")
@Data
public class Gstr1ANilNonExemptedAsEnteredEntity {


	@Expose
	@SerializedName("id")
	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "GSTR1A_AS_ENTERED_NILEXTNON_SEQ", allocationSize = 100)
