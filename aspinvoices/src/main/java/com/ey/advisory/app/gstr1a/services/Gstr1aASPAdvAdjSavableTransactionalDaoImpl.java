...
import com.ey.advisory.app.services.reports.Gstr1ASPAdvAdjSavableTransactionalDao;
 ...
 */
@Slf4j
@Component("Gstr1aASPAdvAdjSavableTransactionalDaoImpl")
public class Gstr1aASPAdvAdjSavableTransactionalDaoImpl
		implements Gstr1ASPAdvAdjSavableTransactionalDao {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(Gstr1aASPAdvAdjSavableTransactionalDaoImpl.class);
	...
	public List<Object> getGstr1AdjSavableReports(SearchCriteria criteria) {
		...
		String queryStr = createAdjSavableTransactionalQueryString(
				buildQuery.toString());
