 ...
 */
@Entity
@Table(name = "GETGSTR1_CDNURA_ITEM")
public class GetGstr1CdnuraItemEntity {

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "GETGSTR1_CDNURA_ITEM_SEQ", allocationSize = 100)
	...
	private GetGstr1CdnuraHeaderEntity document;
	...
	public GetGstr1CdnuraHeaderEntity getDocument() {
		return document;
	}

	public void setDocument(GetGstr1CdnuraHeaderEntity document) {
