...
@Data
@Entity
@Table(name = "GETGSTR2A_ISD_HEADER")
public class GetGstr2aIsdInvoicesHeaderEntity extends GetGstr2aIsdInvoicesHeader {
	...
	protected List<GetGstr2aIsdInvoicesItemEntity> lineItems = new ArrayList<>();
