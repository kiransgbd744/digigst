...
import com.ey.advisory.core.search.SearchCriteria;
	...
	@Service("Gstr1AAspB2BASectionReportReportServiceImpl")
	public class Gstr1AAspB2BASectionReportReportServiceImpl
			implements Gstr1AReviewSummReportsService {

		private static final Logger LOGGER = LoggerFactory
				.getLogger(Gstr1AAspB2BASectionReportReportServiceImpl.class);

		@Autowired
		CommonUtility commonUtility;

		@Autowired
		@Qualifier("Gstr1AAspB2BASectionReportDaoImpl")
		private Gstr1AReviewSummaryReportsDao gstr1ReviewSummaryReportsDao;
		...
		public Workbook findGstr1ReviewSummRecords(SearchCriteria criteria,
			...
			LOGGER.debug("Gstr1A processed data item level response" + responseFromView);
