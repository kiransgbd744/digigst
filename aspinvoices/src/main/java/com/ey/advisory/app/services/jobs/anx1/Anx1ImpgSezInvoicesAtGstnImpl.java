 ...
 *
 */
@Service("Anx1ImpgSezInvoicesAtGstnImpl")
@Slf4j
public class Anx1ImpgSezInvoicesAtGstnImpl implements Anx1InvoicesAtGstn {
	...
	public ResponseEntity<String> findInvFromGstn(Anx1GetInvoicesReqDto dto,
		...
		try {
			...
			throw new APIException(
					"Unexpected error while executing Anx1 Get ImpgSez");
