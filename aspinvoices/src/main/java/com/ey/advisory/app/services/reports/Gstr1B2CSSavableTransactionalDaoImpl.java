...
@Component("Gstr1B2CSSavableTransactionalDaoImpl")
public class Gstr1B2CSSavableTransactionalDaoImpl
		implements Gstr1ASPB2CSSavableTransactionalDao {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(Gstr1B2CSSavableTransactionalDaoImpl.class);
	...
	private static String createB2CSSavableTransactionalQueryString(
			String buildQueryheader, String multiSupplyTypeAns) {
	...
	public static void main(String[] args) {
		...
		System.out.println(createB2CSSavableTransactionalQueryString(
				buildQueryheader.toString(), multiSupplyTypeAns));
	}
}
