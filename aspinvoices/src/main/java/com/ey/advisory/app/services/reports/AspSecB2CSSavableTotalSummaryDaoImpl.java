...
import com.google.common.base.Strings;
	...
	@Component("AspSecB2CSSavableTotalSummaryDaoImpl")
	public class AspSecB2CSSavableTotalSummaryDaoImpl
			implements Gstr1ASPB2CSSavableTotalDao {

		private static final Logger LOGGER = LoggerFactory
				.getLogger(AspSecB2CSSavableTotalSummaryDaoImpl.class);
		...
		public static void main(String[] args) {
			...
			System.out.println(createB2CSSavableTotalQueryString(buildQueryheader.toString(), multiSupplyTypeAns));
		}
		...
		private static String createB2CSSavableTotalQueryString(String buildQueryheader, String multiSupplyTypeAns) {
				...
				+ " +IFNULL(CESS_AMT,0) AS TOT_VAL, B2CS.PROFIT_CENTRE,B2CS.PLANT_CODE,B2CS.DIVISION, "
				+ " B2CS.LOCATION,B2CS.SALES_ORGANIZATION,B2CS.DISTRIBUTION_CHANNEL, "
				+ " B2CS.USERACCESS1,B2CS.USERACCESS2,B2CS.USERACCESS3,B2CS.USERACCESS4, "
				...
				+ "AND GSTRERR.TABLE_TYPE='B2CS' AND RETURN_TYPE='GSTR1' "
				...
				+ "ANX_OUTWARD_DOC_HEADER B2CS INNER JOIN "
