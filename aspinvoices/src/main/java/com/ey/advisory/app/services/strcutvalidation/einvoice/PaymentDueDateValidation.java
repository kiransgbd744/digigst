 ...
 *
 */
public class PaymentDueDateValidation implements ValidationRule {
	...
	public List<ProcessingResult> isValid(int idx, Object obj, Object[] row,
		...
		if (date == null ) {
			...
			errorLocations.add(GSTConstants.PAYMENT_DUE_DATE);
			TransDocProcessingResultLoc location = 
					new TransDocProcessingResultLoc(
					null, errorLocations.toArray());
			errors.add(new ProcessingResult(APP_VALIDATION, "ER10113",
					          "Invalid Payment Due Date.", location));
			return errors;
		}
