...
@Repository("Gstr1AGetAtaGstnRepository")
@Transactional(propagation = Propagation.REQUIRED, readOnly = false)
public interface Gstr1AGetAtaGstnRepository
		extends CrudRepository<GetGstr1AAtaHeaderEntity, Long> {
	@Modifying
	@Query("UPDATE GetGstr1AAtaHeaderEntity b SET b.isDelete = true,b.modifiedBy = 'SYSTEM'  , b.modifiedOn =:modifiedOn  WHERE"
	...
	@Query("SELECT COUNT(*) FROM GetGstr1AAtaHeaderEntity "
