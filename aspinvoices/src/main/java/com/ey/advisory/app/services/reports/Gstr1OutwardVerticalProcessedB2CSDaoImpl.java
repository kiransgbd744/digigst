...
import com.ey.advisory.app.data.views.client.Gstr1AspVerticalB2csDto;
...
@Component("Gstr1OutwardVerticalProcessedB2CSDaoImpl")
public class Gstr1OutwardVerticalProcessedB2CSDaoImpl
		implements Gstr1OutwardVerticalProcessedB2CSDao {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(Gstr1OutwardVerticalProcessedB2CSDaoImpl.class);
	...
	public List<Object> getGstr1RSReports(SearchCriteria criteria) {
		...
		return list.parallelStream().map(o -> convertProcessedB2CS(o))
				.collect(Collectors.toCollection(ArrayList::new));
	}

	private Gstr1AspVerticalB2csDto convertProcessedB2CS(Object[] arr) {
		Gstr1AspVerticalB2csDto obj = new Gstr1AspVerticalB2csDto();
