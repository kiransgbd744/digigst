...
@AllArgsConstructor
@Entity
@Table(name = "GETGSTR2B_LINKING_ECOM_HEADER")
public class Gstr2GetGstr2BLinkingEcomHeaderEntity {
	...
	protected List<Gstr2GetGstr2BLinkingEcomItemEntity> lineItems = new ArrayList<>();
}
