...
@Data
@Entity
@Table(name = "TBL_GSTR8_UPLOAD_ERROR")
public class Gstr8UploadErrorEntity {

	@Expose
	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "GSTR8_UPLOAD_ERROR_SEQ", allocationSize = 100)
