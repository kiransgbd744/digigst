...
import com.ey.advisory.core.search.SearchCriteria;
	...
	@Service("Gstr1AAspB2CLASectionReportReportServiceImpl")
	public class Gstr1AAspB2CLASectionReportReportServiceImpl
			implements Gstr1AReviewSummReportsService {

		private static final Logger LOGGER = LoggerFactory
				.getLogger(Gstr1AAspB2CLASectionReportReportServiceImpl.class);

		@Autowired
		CommonUtility commonUtility;

		@Autowired
		@Qualifier("Gstr1AAspB2CLASectionReportDaoImpl")
