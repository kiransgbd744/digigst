 ...
 */
@Entity
@Table(name = "GETANX1_EXPWP_ITEM")
public class GetAnx1ExpwpInvoicesItemEntity {
	...
	protected GetAnx1ExpwpInvoicesHeaderEntity header;
	...
	public GetAnx1ExpwpInvoicesHeaderEntity getHeader() {
		return header;
	}

	public void setHeader(GetAnx1ExpwpInvoicesHeaderEntity header) {
		this.header = header;
	}
