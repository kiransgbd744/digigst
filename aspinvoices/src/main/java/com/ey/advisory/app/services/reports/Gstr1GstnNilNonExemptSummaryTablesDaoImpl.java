...
@Component("Gstr1GstnNilNonExemptSummaryTablesDaoImpl")
public class Gstr1GstnNilNonExemptSummaryTablesDaoImpl
		implements Gstr1GstnSummaryTablesDao {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(Gstr1GstnNilNonExemptSummaryTablesDaoImpl.class);
	...
	private Gstr1GstnnilnonexemptSummarylevelDto convertgstnnilnonexemptSummary(
		...
		obj.setSerialNo(arr[8] != null ? arr[8].toString() : null);
		return obj;
	}
	...
	private String creategstnNILQueryString(String buildQuery) {
		...
		return "SELECT HDR.ID,HDR.GSTIN,HDR.RETURN_PERIOD,SUPPLY_TYPE,"
				...
				+ "SUM(NONGST_SUP_AMT) NONGST_SUP_AMT,BT.IS_FILED, "
				...
				+ " HDR.IS_DELETE=FALSE " + buildQuery
				+ " GROUP BY HDR.ID,HDR.GSTIN,HDR.RETURN_PERIOD,"
				+ "SUPPLY_TYPE,BT.IS_FILED;";
	}
}
