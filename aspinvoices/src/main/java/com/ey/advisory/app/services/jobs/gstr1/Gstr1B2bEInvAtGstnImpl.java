 ...
 *
 */
@Service("Gstr1B2bEInvAtGstnImpl")
@Slf4j
public class Gstr1B2bEInvAtGstnImpl implements Gstr1InvoicesAtGstn {
	...
	public Long findInvFromGstn(Gstr1GetInvoicesReqDto dto, String groupCode, String type, Long batchId) {
		...
		try {
			...
			throw new APIException("Unexpected error while executing Gstr1 Get B2b");
		}
		return reqId;
	}
