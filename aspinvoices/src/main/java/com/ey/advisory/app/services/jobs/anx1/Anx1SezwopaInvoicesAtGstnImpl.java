...
@Service("Anx1SezwopaInvoicesAtGstnImpl")
@Slf4j
public class Anx1SezwopaInvoicesAtGstnImpl implements Anx1InvoicesAtGstn {
	...
	public ResponseEntity<String> findInvFromGstn(Anx1GetInvoicesReqDto dto,
		...
		try {
			...
			throw new APIException(
					"Unexpected error while executing Anx1 Get Sezwopa");
