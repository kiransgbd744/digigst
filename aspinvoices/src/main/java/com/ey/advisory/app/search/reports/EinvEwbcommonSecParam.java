 ...
 * 
 */
@Component("EinvEwbcommonSecParam")
public class EinvEwbcommonSecParam {

	public EwbEinvDownloadRequestDto setDataSecuritySearchParams(
			EwbEinvDownloadRequestDto searchParams) {
