 ...
 */
	...
	@Component("Gstr1AdvRecSecSummaryDaoImpl")
	public class Gstr1AdvRecSecSummaryDaoImpl
			implements Gstr1AdvRecSavableDao {

		private static final Logger LOGGER = LoggerFactory
				.getLogger(Gstr1AdvRecSecSummaryDaoImpl.class);
		...
		private String createApiProcessedQueryString(String buildQuery) {
			...
			return "SELECT REC.SUPPLIER_GSTIN,REC.RETURN_PERIOD,TRAN_TYPE,"
					...
					+ "WHERE REC.IS_DELETE=FALSE AND REC.IS_AMENDMENT=FALSE "
					+ buildQuery;
		}
