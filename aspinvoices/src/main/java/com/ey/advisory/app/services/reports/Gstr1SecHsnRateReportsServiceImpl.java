 ...
 */
	...
	@Service("Gstr1SecHsnRateReportsServiceImpl")
	public class Gstr1SecHsnRateReportsServiceImpl
			implements Gstr1ASPHsnSummaryReportsService {

		private static final Logger LOGGER = LoggerFactory
				.getLogger(Gstr1SecHsnRateReportsServiceImpl.class);

		@Autowired
		CommonUtility commonUtility;

		@Autowired
		@Qualifier("Gstr1SecHsnRateDaoImpl")
		Gstr1SecHsnRateDaoImpl gstr1AspHsnSummaryDao;
