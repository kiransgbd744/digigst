...
public class Anx1ApiErrorRecordsDto {
	...
	public String toString() {
		return "Anx1ApiErrorRecordsDto [source=" + source + ", id=" + id
				+ ", dateTime=" + dateTime + ", aspErrorCode=" + aspErrorCode
				+ ", aspErrorDesc=" + aspErrorDesc + ", aspInformationID="
				+ aspInformationID + ", aspInformationDesc="
				+ aspInformationDesc + ", userID=" + userID
