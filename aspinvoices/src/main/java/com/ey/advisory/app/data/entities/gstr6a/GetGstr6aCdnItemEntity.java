 ...
 */
@Entity
@Table(name = "GETGSTR6A_CDN_ITEM")
public class GetGstr6aCdnItemEntity {
	...
	protected GetGstr6aCdnHeaderEntity header;
	...
	public GetGstr6aCdnHeaderEntity getHeader() {
		return header;
	}

	public void setHeader(GetGstr6aCdnHeaderEntity header) {
		this.header = header;
	}
