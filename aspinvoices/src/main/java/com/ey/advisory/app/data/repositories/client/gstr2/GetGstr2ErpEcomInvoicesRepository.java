 ...
 *
 */
@Repository("GetGstr2ErpEcomInvoicesRepository")
@Transactional(propagation = Propagation.REQUIRED, readOnly = false)
public interface GetGstr2ErpEcomInvoicesRepository extends CrudRepository<GetGstr2aErpEcomInvoicesHeaderEntity, Long> {

	// Curently isDelete is not added in table
	@Modifying
	@Query("UPDATE GetGstr2aErpEcomInvoicesHeaderEntity b SET b.isDelete = true,b.modifiedBy = 'SYSTEM'  , b.modifiedOn =:modifiedOn  WHERE"
	...
	@Query("from GetGstr2aErpEcomInvoicesHeaderEntity where sgstin=:sgstin and cgstin=:cgstin and invDate=:invDate and invNum=:invNum and invType=:invType")
	List<GetGstr2aErpEcomInvoicesHeaderEntity> findByInvoiceKey(
	...
	@Query("SELECT COUNT(*) FROM GetGstr2aErpEcomInvoicesHeaderEntity "
	...
	@Modifying
	@Query("UPDATE GetGstr2aErpEcomInvoicesHeaderEntity b SET b.isDelete = true  WHERE"
