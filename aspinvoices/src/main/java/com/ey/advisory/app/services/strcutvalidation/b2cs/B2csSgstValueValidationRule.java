 ...
 *
 */
public class B2csSgstValueValidationRule implements ValidationRule {
	...
	public List<ProcessingResult> isValid(Object obj, Object[] row,
		...
		if (!isDecimal(obj.toString().trim())) {
			...
			errors.add(new ProcessingResult(APP_VALIDATION, "ER5029",
					"Invalid StateUT TaxAmount ", location));
			return errors;
		}
