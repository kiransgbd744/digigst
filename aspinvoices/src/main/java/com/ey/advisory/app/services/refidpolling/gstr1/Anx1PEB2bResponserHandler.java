...
@Component("Anx1PEB2bResponserHandler")
public class Anx1PEB2bResponserHandler implements Anx1ResponseHandler {
	...
	public Triplet<List<String>, Map<String, OutwardTransDocError>,Integer> response(
		...
		for (Anx1B2bData invoice : anx1ErrorReportData.getB2bInvoice()) {
			for (Anx1B2bDocumentData docData : invoice.getDocs()) {
