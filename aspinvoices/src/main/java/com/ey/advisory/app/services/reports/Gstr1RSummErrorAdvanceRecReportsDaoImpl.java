...
@Component("Gstr1RSummErrorAdvanceRecReportsDaoImpl")
public class Gstr1RSummErrorAdvanceRecReportsDaoImpl implements Gstr1ReviewSummaryReportsDao {

	private static final Logger LOGGER = LoggerFactory.getLogger(Gstr1RSummErrorAdvanceRecReportsDaoImpl.class);
	...
	private Gstr1VerticalAdvRecDto convertError(Object[] arr) {
		...
		obj2.setAspErrorDescription(arr[30] != null ? arr[30].toString() : null);
		obj2.setAspInformationID(arr[31] != null ? arr[31].toString() : null);
		obj2.setAspInformationDescription(arr[32] != null ? arr[32].toString() : null);
	...
	private String createErrorQueryString(String buildQuery) {
		return "SELECT SUPPLIER_GSTIN,RETURN_PERIOD,TRAN_TYPE,MONTH,"
				...
				+ "AS INFO_ERROR_DESCRIPTION_ASP " + "FROM " + "GSTR1_AS_ENTERED_ADV_RECEVIED HI LEFT OUTER JOIN "
				...
				+ "ERR.INV_KEY=HI.AT_INVKEY WHERE HI.IS_ERROR = TRUE  " + buildQuery;
