...
@Component("Gstr1RSummErrorAdvanceAdjReportsDaoImpl")
public class Gstr1RSummErrorAdvanceAdjReportsDaoImpl implements Gstr1ReviewSummaryReportsDao {

	private static final Logger LOGGER = LoggerFactory.getLogger(Gstr1RSummErrorAdvanceAdjReportsDaoImpl.class);
	...
	public List<Object> getGstr1RSReports(SearchCriteria criteria) {
		...
		return list.parallelStream().map(o -> convertError(o)).collect(Collectors.toCollection(ArrayList::new));

	}

	private Gstr1VerticalAdvAdjDto convertError(Object[] arr) {
		...
		obj3.setOrgGrossAdvanceAdjusted(arr[7] != null ? arr[7].toString() : null);
		obj3.setNewPOS(arr[8] != null ? arr[8].toString() : null);
		obj3.setNewRate(arr[9] != null ? arr[9].toString() : null);
		obj3.setNewGrossAdvanceAdjusted(arr[10] != null ? arr[10].toString() : null);
		obj3.setIntegratedTaxAmount(arr[11] != null ? arr[11].toString() : null);
		obj3.setCentralTaxAmount(arr[12] != null ? arr[12].toString() : null);
		obj3.setStateUTTaxAmount(arr[13] != null ? arr[13].toString() : null);
		...
		obj3.setSalesOrganisation(arr[19] != null ? arr[19].toString() : null);
		obj3.setDistributionChannel(arr[20] != null ? arr[20].toString() : null);
		...
		obj3.setUserdefinedfield1(arr[27] != null ? arr[27].toString() : null);
		obj3.setUserdefinedfield2(arr[28] != null ? arr[28].toString() : null);
		obj3.setUserdefinedfield3(arr[29] != null ? arr[29].toString() : null);
		obj3.setAspErrorCode(arr[30] != null ? arr[30].toString() : null);
		obj3.setAspErrorDescription(arr[31] != null ? arr[31].toString() : null);
		obj3.setAspInformationID(arr[32] != null ? arr[32].toString() : null);
		obj3.setAspInformationDescription(arr[33] != null ? arr[33].toString() : null);

		return obj3;
	}

	private String createErrorQueryString(String buildQuery) {
		return "SELECT HI.ID,SUPPLIER_GSTIN,RETURN_PERIOD,TRAN_TYPE,"
				...
				+ "USERACCESS1,USERACCESS2,USERACCESS3,USERACCESS4," + "USERACCESS5,USERACCESS6,USERDEFINED_FIELD1,"
				+ "USERDEFINED_FIELD2,USERDEFINED_FIELD3," + "TRIM(', ' FROM IFNULL(ERROR_CODE_ASP,'') ) "
				+ "AS ERROR_CODE_ASP," + "TRIM(', ' FROM IFNULL(ERROR_DESCRIPTION_ASP,'') ) "
				+ "AS ERROR_DESCRIPTION_ASP," + "TRIM(', ' FROM IFNULL(INFO_ERROR_CODE_ASP,'') ) "
				+ "AS INFO_ERROR_CODE_ASP," + "TRIM(', ' FROM IFNULL(INFO_ERROR_DESCRIPTION_ASP,'') ) "
				+ "AS INFO_ERROR_DESCRIPTION_ASP " + "FROM " + "GSTR1_AS_ENTERED_ADV_ADJUSTMENT HI LEFT OUTER JOIN "
				...
				+ "ERR.INV_KEY=HI.TXPD_INVKEY WHERE HI.IS_ERROR = TRUE " + buildQuery;
