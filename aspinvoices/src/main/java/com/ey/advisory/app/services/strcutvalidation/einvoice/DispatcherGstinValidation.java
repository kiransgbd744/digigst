 ...
 *
 */
public class DispatcherGstinValidation implements ValidationRule {
...
if ( matcher.matches() || matcher1.matches()) {
			...
			errorLocations.add(GSTConstants.DISPATCHER_GSTIN);
			TransDocProcessingResultLoc location = 
					new TransDocProcessingResultLoc(
					null, errorLocations.toArray());
			errors.add(new ProcessingResult(APP_VALIDATION, "ER10028",
					             "Invalid Dispatcher GSTIN", location));
			return errors;
		}
