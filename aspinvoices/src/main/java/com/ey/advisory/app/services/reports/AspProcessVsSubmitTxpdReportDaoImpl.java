 ...
 * 
 */
@Component("AspProcessVsSubmitTxpdReportDaoImpl")
public class AspProcessVsSubmitTxpdReportDaoImpl
...
private String createApiProcessedQueryString(String buildHeader,String buildHeaderForGet, String buildHeader3) {
	...
	build.append("FROM GETGSTR1_TXP_HEADER HDR  ");
	build.append("INNER JOIN GETGSTR1_TXP_ITEM ITM ON HDR.ID = ITM.HEADER_ID ");
	...
	build.append("'' ASP_DATE_TIME FROM GSTR1_PROCESSED_ADV_ADJUSTMENT ADJ ");
	...
	build.append("AND GSTRERR.TABLE_TYPE='ADV ADJ' AND RETURN_TYPE='GSTR1' "); 
