 ...
 *
 */
@Service("Anx1InwardApiErrorReportsServiceImpl")
public class Anx1InwardApiErrorReportsServiceImpl implements Anx1ApiTotalReportsService {

private static final Logger LOGGER = LoggerFactory
		.getLogger(Anx1InwardApiErrorReportsServiceImpl.class);

@Autowired
CommonUtility commonUtility;

@Autowired
@Qualifier("Anx1InwardApiErrorReportsDaoImpl")
private Anx1InwardApiErrorReportsDao anx1InwardApiErrorReportsDao;
...
public Workbook findApiTotalRec(SearchCriteria criteria,
	...
	responseFromView = anx1InwardApiErrorReportsDao
