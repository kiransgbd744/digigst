...
@Entity
@Table(name = "GSTR1A_PR_VS_SUBM_RECON_GSTIN_DETAILS")
@Getter
@Setter
@ToString
public class Gstr1APRvsSubmReconGstinDetailEntity {
	...
	public Gstr1APRvsSubmReconGstinDetailEntity(String gstin, Long reconConfigId, Integer fromReturnPeriod,
