...
public class Gstr1SavableB2CSTransactionalDto {
	...
	private String gLCodeAdvlormCess;
	...
	private String precedNum;
	private String precedDate;
	private String crdrPreGST;
	private String itemNumber;
	private String recpGSTIN;
	private String recpType;
	private String diffPerFlag;
	private String orgRecpGSTIN;
	private String recpName;
	private String recpCode;
	private String recpAdd1;
	private String recpAdd2;
	private String recpAdd3;
	private String recpAdd4;
	private String billToState;
	private String shipToState;
	private String pos;
	private String stateAplyCess;
	private String portCode;
	private String ShippingBillNum;
	...
	private String advmCessRate;
	private String advmCessAmt;
	private String specfcCessRate;
	private String specfcCessAmt;
	private String stateCessRate;
	private String stateCessAmt;
	private String otherValue;
	private String invoiceValue;
	private String adjRefNo;
	private String adjRefDate;
	private String taxableValueAdj;
	private String integdTaxAmtAdj;
	private String centralTaxAmtAdj;
	private String stateUTTaxAmtAdj;
	private String advlmCessAmtAdj;
	private String specfCessAmtAdj;
	private String stateCessAmtAdj;
	...
	private String integratedTaxamountdiff;
	private String centralTaxamountdiff;
	private String stateUTTaxamountdiff;
	private String saveStatus;
	private String gstnRefId;
	private String gstnRefIdTime;
	private String gstnErrorCode;
	private String gstnErrorDesc;
	private String uploadeSource;
	...
	public String getgLCodeAdvlormCess() {
		return gLCodeAdvlormCess;
	}

	public void setgLCodeAdvlormCess(String gLCodeAdvlormCess) {
		this.gLCodeAdvlormCess = gLCodeAdvlormCess;
	}
	...
	public void setgLCodeSpecificCess(String gLCodeSpecificCess) {
		this.gLCodeSpecificCess = gLCodeSpecificCess;
	}
	...
	public String getPrecedNum() {
		return precedNum;
	}

	public void setPrecedNum(String precedNum) {
		this.precedNum = precedNum;
	}

	public String getPrecedDate() {
		return precedDate;
	}

	public void setPrecedDate(String precedDate) {
		this.precedDate = precedDate;
	}
	...
	public String getOrgRecpGSTIN() {
		return orgRecpGSTIN;
	}

	public void setOrgRecpGSTIN(String orgRecpGSTIN) {
		this.orgRecpGSTIN = orgRecpGSTIN;
	}
	...
	public String getRecpAdd1() {
		return recpAdd1;
	}

	public void setRecpAdd1(String recpAdd1) {
		this.recpAdd1 = recpAdd1;
	}

	public String getRecpAdd2() {
		return recpAdd2;
	}

	public void setRecpAdd2(String recpAdd2) {
		this.recpAdd2 = recpAdd2;
	}

	public String getRecpAdd3() {
		return recpAdd3;
	}

	public void setRecpAdd3(String recpAdd3) {
		this.recpAdd3 = recpAdd3;
	}

	public String getRecpAdd4() {
		return recpAdd4;
	}

	public void setRecpAdd4(String recpAdd4) {
		this.recpAdd4 = recpAdd4;
	}
	...
	public String getStateAplyCess() {
		return stateAplyCess;
	}

	public void setStateAplyCess(String stateAplyCess) {
		this.stateAplyCess = stateAplyCess;
	}
	...
	public String getShippingBillNum() {
		return ShippingBillNum;
	}

	public void setShippingBillNum(String shippingBillNum) {
		ShippingBillNum = shippingBillNum;
	}
	...
	public String getIntegTaxRate() {
		return integTaxRate;
	}

	public void setIntegTaxRate(String integTaxRate) {
		this.integTaxRate = integTaxRate;
	}
	...
	public String getAdvmCessRate() {
		return advmCessRate;
	}

	public void setAdvmCessRate(String advmCessRate) {
		this.advmCessRate = advmCessRate;
	}

	public String getAdvmCessAmt() {
		return advmCessAmt;
	}

	public void setAdvmCessAmt(String advmCessAmt) {
		this.advmCessAmt = advmCessAmt;
	}

	public String getSpecfcCessRate() {
		return specfcCessRate;
	}

	public void setSpecfcCessRate(String specfcCessRate) {
		this.specfcCessRate = specfcCessRate;
	}

	public String getSpecfcCessAmt() {
		return specfcCessAmt;
	}

	public void setSpecfcCessAmt(String specfcCessAmt) {
		this.specfcCessAmt = specfcCessAmt;
	}
	...
	public String getAdjRefDate() {
		return adjRefDate;
	}

	public void setAdjRefDate(String adjRefDate) {
		this.adjRefDate = adjRefDate;
	}

	public String getTaxableValueAdj() {
		return taxableValueAdj;
	}

	public void setTaxableValueAdj(String taxableValueAdj) {
		this.taxableValueAdj = taxableValueAdj;
	}

	public String getIntegdTaxAmtAdj() {
		return integdTaxAmtAdj;
	}

	public void setIntegdTaxAmtAdj(String integdTaxAmtAdj) {
		this.integdTaxAmtAdj = integdTaxAmtAdj;
	}

	public String getCentralTaxAmtAdj() {
		return centralTaxAmtAdj;
	}

	public void setCentralTaxAmtAdj(String centralTaxAmtAdj) {
		this.centralTaxAmtAdj = centralTaxAmtAdj;
	}

	public String getStateUTTaxAmtAdj() {
		return stateUTTaxAmtAdj;
	}

	public void setStateUTTaxAmtAdj(String stateUTTaxAmtAdj) {
		this.stateUTTaxAmtAdj = stateUTTaxAmtAdj;
	}

	public String getAdvlmCessAmtAdj() {
		return advlmCessAmtAdj;
	}

	public void setAdvlmCessAmtAdj(String advlmCessAmtAdj) {
		this.advlmCessAmtAdj = advlmCessAmtAdj;
	}

	public String getSpecfCessAmtAdj() {
		return specfCessAmtAdj;
	}

	public void setSpecfCessAmtAdj(String specfCessAmtAdj) {
		this.specfCessAmtAdj = specfCessAmtAdj;
	}

	public String getStateCessAmtAdj() {
		return stateCessAmtAdj;
	}

	public void setStateCessAmtAdj(String stateCessAmtAdj) {
		this.stateCessAmtAdj = stateCessAmtAdj;
	}
	...
	public String getAccVoucherNum() {
		return accVoucherNum;
	}

	public void setAccVoucherNum(String accVoucherNum) {
		this.accVoucherNum = accVoucherNum;
	}

	public String getAccVoucherDate() {
		return accVoucherDate;
	}

	public void setAccVoucherDate(String accVoucherDate) {
		this.accVoucherDate = accVoucherDate;
	}
	...
	public String getIntegratedTaxamountdiff() {
		return integratedTaxamountdiff;
	}

	public void setIntegratedTaxamountdiff(String integratedTaxamountdiff) {
		this.integratedTaxamountdiff = integratedTaxamountdiff;
	}

	public String getCentralTaxamountdiff() {
		return centralTaxamountdiff;
	}

	public void setCentralTaxamountdiff(String centralTaxamountdiff) {
		this.centralTaxamountdiff = centralTaxamountdiff;
	}

	public String getStateUTTaxamountdiff() {
		return stateUTTaxamountdiff;
	}

	public void setStateUTTaxamountdiff(String stateUTTaxamountdiff) {
		this.stateUTTaxamountdiff = stateUTTaxamountdiff;
	}
	...
	public String getUploadeSource() {
		return uploadeSource;
	}

	public void setUploadeSource(String uploadeSource) {
		this.uploadeSource = uploadeSource;
	}
	...
	public void setAspDateTime(String aspDateTime) {
		this.aspDateTime = aspDateTime;
	}

	@Override
	public String toString() {
		return "Gstr1SavableB2CSTransactionalDto [returnType=" + returnType
				+ ", dataCategory=" + dataCategory + ", tableNumber="
				+ tableNumber + ", aspInformationID=" + aspInformationID
				+ ", aspInformationDesc=" + aspInformationDesc + ", userID="
				+ userID + ", sourceFileName=" + sourceFileName
				+ ", profitCentre=" + profitCentre + ", plant=" + plant
				...
				+ ", gLCodeTaxableValue=" + gLCodeTaxableValue + ", gLCodeIGST="
				+ gLCodeIGST + ", gLCodeCGST=" + gLCodeCGST + ", gLCodeSGST="
				+ gLCodeSGST + ", gLCodeAdvlormCess=" + gLCodeAdvlormCess
				+ ", gLCodeSpecificCess=" + gLCodeSpecificCess
				+ ", gLCodeStateCess=" + gLCodeStateCess + ", returnPeriod="
				+ returnPeriod + ", sgstin=" + sgstin + ", docType=" + docType
				+ ", supplyType=" + supplyType + ", docNum=" + docNum
				+ ", DocDate=" + DocDate + ", OrgDocType=" + OrgDocType
				+ ", precedNum=" + precedNum + ", precedDate=" + precedDate
				+ ", crdrPreGST=" + crdrPreGST + ", itemNumber=" + itemNumber
				+ ", recpGSTIN=" + recpGSTIN + ", recpType=" + recpType
				+ ", diffPerFlag=" + diffPerFlag + ", orgRecpGSTIN="
				+ orgRecpGSTIN + ", recpName=" + recpName + ", recpCode="
				+ recpCode + ", recpAdd1=" + recpAdd1 + ", recpAdd2=" + recpAdd2
				+ ", recpAdd3=" + recpAdd3 + ", recpAdd4=" + recpAdd4
				+ ", billToState=" + billToState + ", shipToState="
				+ shipToState + ", pos=" + pos + ", stateAplyCess="
				+ stateAplyCess + ", portCode=" + portCode
				+ ", ShippingBillNum=" + ShippingBillNum + ", shippingBillDate="
				+ shippingBillDate + ", fob=" + fob + ", exportDuty="
				+ exportDuty + ", hsnOrSac=" + hsnOrSac + ", productCode="
				+ productCode + ", productDesc=" + productDesc
				+ ", categoryOfProduct=" + categoryOfProduct + ", uom=" + uom
				+ ", quantity=" + quantity + ", sec7ofIGSTFlag="
				+ sec7ofIGSTFlag + ", taxableValue=" + taxableValue
				+ ", integTaxRate=" + integTaxRate + ", integTaxAmt="
				+ integTaxAmt + ", centralTaxRate=" + centralTaxRate
				+ ", CentralTaxAmt=" + CentralTaxAmt + ", stateUTTaxRate="
				+ stateUTTaxRate + ", stateUTTaxAmt=" + stateUTTaxAmt
				+ ", advmCessRate=" + advmCessRate + ", advmCessAmt="
				+ advmCessAmt + ", specfcCessRate=" + specfcCessRate
				+ ", specfcCessAmt=" + specfcCessAmt + ", stateCessRate="
				+ stateCessRate + ", stateCessAmt=" + stateCessAmt
				+ ", otherValue=" + otherValue + ", invoiceValue="
				+ invoiceValue + ", adjRefNo=" + adjRefNo + ", adjRefDate="
				+ adjRefDate + ", taxableValueAdj=" + taxableValueAdj
				+ ", integdTaxAmtAdj=" + integdTaxAmtAdj + ", centralTaxAmtAdj="
				+ centralTaxAmtAdj + ", stateUTTaxAmtAdj=" + stateUTTaxAmtAdj
				+ ", advlmCessAmtAdj=" + advlmCessAmtAdj + ", specfCessAmtAdj="
				+ specfCessAmtAdj + ", stateCessAmtAdj=" + stateCessAmtAdj
				+ ", reverseChargeFlag=" + reverseChargeFlag + ", tcsFlag="
				+ tcsFlag + ", eComGSTIN=" + eComGSTIN + ", tcsAmt=" + tcsAmt
				+ ", itcFlag=" + itcFlag + ", claimRefndFlag=" + claimRefndFlag
				+ ", autoPopltToRefund=" + autoPopltToRefund
				+ ", reasonForCrDbNote=" + reasonForCrDbNote
				+ ", accVoucherNum=" + accVoucherNum + ", accVoucherDate="
				+ accVoucherDate + ", userDefField1=" + userDefField1
				...
				+ userDefField15 + ", ewaybillNum=" + ewaybillNum
				+ ", ewaybillDate=" + ewaybillDate + ", invoiceValueAsp="
				+ invoiceValueAsp + ", integratedTaxamountASP="
				+ integratedTaxamountASP + ", centralTaxamountASP="
				+ centralTaxamountASP + ", stateUTTaxamountASP="
				+ stateUTTaxamountASP + ", integratedTaxamountdiff="
				+ integratedTaxamountdiff + ", centralTaxamountdiff="
				+ centralTaxamountdiff + ", stateUTTaxamountdiff="
				+ stateUTTaxamountdiff + ", saveStatus=" + saveStatus
				+ ", gstnRefId=" + gstnRefId + ", gstnRefIdTime="
				+ gstnRefIdTime + ", gstnErrorCode=" + gstnErrorCode
				+ ", gstnErrorDesc=" + gstnErrorDesc + ", uploadeSource="
				+ uploadeSource + ", sourceId=" + sourceId + ", fileName="
