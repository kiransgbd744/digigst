...
@Entity
@Table(name = "GETGSTR1_B2CS_HEADER")
public class GetGstr1B2csHeaderEntity {

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "GETGSTR1_B2CS_HEADER_SEQ", allocationSize = 100)
	...
	protected List<GetGstr1B2csItemEntity> lineItems = new ArrayList<>();
	...
	public List<GetGstr1B2csItemEntity> getLineItems() {
		return lineItems;
	}

	public void setLineItems(List<GetGstr1B2csItemEntity> lineItems) {
