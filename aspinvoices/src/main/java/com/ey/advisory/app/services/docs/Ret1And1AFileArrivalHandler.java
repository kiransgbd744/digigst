...
import com.ey.advisory.app.services.annexure1fileupload.Ret1And1AStructuralErrorUploadService;
...
@Component("Ret1And1AFileArrivalHandler")
public class Ret1And1AFileArrivalHandler {
	
	private static final Logger LOGGER = LoggerFactory
			          .getLogger(Ret1And1AFileArrivalHandler.class);
	...
	@Autowired
	@Qualifier("Ret1And1AHeaderCheckService")
	...
	@Autowired
	@Qualifier("Ret1And1AStructuralErrorUploadService")
	private Ret1And1AStructuralErrorUploadService 
	                            ret1And1AStructuralErrorUploadService;
	...
	public void processRet1And1AFile(Message message, AppExecContext context) {
		...
		try {
			...
			LOGGER.error("Exception occured in Ret 1 and 1A "
					+ "File Arrival Processor", e);
		}
		TabularDataSourceTraverser traverser = traverserFactory
				.getTraverser(fileName);
		TabularDataLayout layout = new DummyTabularDataLayout(24);
		...
		List<Object[]> ret11Adata = ((FileUploadDocRowHandler<?>) rowHandler)
				                                          .getFileUploadList();
		...
		if(checkHeaderFormat.getValue0()){
			...
			ret1And1AStructuralErrorUploadService.
			             processData(ret11Adata,updateFileStatus);
		}	
		else{
