 ...
 *
 */
@Component("Anx1PeDeResponseHandler")
public class Anx1PeDeResponseHandler implements Anx1ResponseHandler{
	...
	public Triplet<List<String>, Map<String, OutwardTransDocError>,Integer> response(
		...
		for (Anx1DeemadExportsData invoice : anx1ErrorReportData.getDeInvoice()) {
			
			 
			for (Anx1DeemadExportsDocumentData docData : invoice.getDocs()) {
