...
@Component("Gstr1OutwardVerticalProcessedAdvanceReceivedDaoImpl")
public class Gstr1OutwardVerticalProcessedAdvanceReceivedDaoImpl
		implements Gstr1OutwardVerticalProcessedAdvanceReceivedDao {

	private static final Logger LOGGER = LoggerFactory.getLogger(
			Gstr1OutwardVerticalProcessedAdvanceReceivedDaoImpl.class);
