...
@Component("Anx2PRsummaryProcessedReportsDaoImpl")
public class Anx2PRsummaryProcessedReportsDaoImpl
		implements Anx2PrSummaryReportsDao {
	...
	private PRSummaryProcessedRecordsDto convertProcessed(Object[] arr) {
		PRSummaryProcessedRecordsDto obj = new PRSummaryProcessedRecordsDto();
		...
		obj.setGLCodeAdvaloremCess(arr[18] != null ? arr[18].toString() : null);
		...
		obj.setRecipientGSTIN(arr[22] != null ? arr[22].toString() : null);
		obj.setDocumentType(arr[23] != null ? arr[23].toString() : null);
		obj.setSupplyType(arr[24] != null ? arr[24].toString() : null);
		obj.setDocumentNumber(arr[25] != null ? arr[25].toString() : null);
		...
		obj.setCRDRPreGST(arr[29] != null ? arr[29].toString() : null);
		obj.setLineNumber(arr[30] != null ? arr[30].toString() : null);
		obj.setSupplierGSTIN(arr[31] != null ? arr[31].toString() : null);
		obj.setSupplierType(arr[32] != null ? arr[32].toString() : null);
		obj.setDifferentialFlag(arr[33] != null ? arr[33].toString() : null);
		obj.setOriginalSupplierGSTIN(
				arr[34] != null ? arr[34].toString() : null);
		obj.setSupplierName(arr[35] != null ? arr[35].toString() : null);
		obj.setSupplierCode(arr[36] != null ? arr[36].toString() : null);
		obj.setSupplierAddress1(arr[37] != null ? arr[37].toString() : null);
		obj.setSupplierAddress2(arr[38] != null ? arr[38].toString() : null);
		obj.setSupplierAddress3(arr[39] != null ? arr[39].toString() : null);
		obj.setSupplierAddress4(arr[40] != null ? arr[40].toString() : null);
		obj.setPOS(arr[41] != null ? arr[41].toString() : null);
		obj.setStateApplyingCess(arr[42] != null ? arr[42].toString() : null);
		obj.setPortCode(arr[43] != null ? arr[43].toString() : null);
		obj.setBillOfEntry(arr[44] != null ? arr[44].toString() : null);
		...
		obj.setCIFValue(arr[46] != null ? arr[46].toString() : null);
		obj.setCustomDuty(arr[47] != null ? arr[47].toString() : null);
		obj.setHSNorSAC(arr[48] != null ? arr[48].toString() : null);
		obj.setItemCode(arr[49] != null ? arr[49].toString() : null);
		obj.setItemDescription(arr[50] != null ? arr[50].toString() : null);
		obj.setCategoryOfItem(arr[51] != null ? arr[51].toString() : null);
		obj.setUnitOfMeasurement(arr[52] != null ? arr[52].toString() : null);
		obj.setQuantity(arr[53] != null ? arr[53].toString() : null);
		obj.setSection7ofIGSTFlag(arr[54] != null ? arr[54].toString() : null);
		obj.setTaxableValue(arr[55] != null ? arr[55].toString() : null);
		obj.setIntegratedTaxRate(arr[56] != null ? arr[56].toString() : null);
		obj.setIntegratedTaxAmount(arr[57] != null ? arr[57].toString() : null);
		obj.setCentralTaxRate(arr[58] != null ? arr[58].toString() : null);
		obj.setCentralTaxAmount(arr[59] != null ? arr[59].toString() : null);
		obj.setStateUTTaxRate(arr[60] != null ? arr[60].toString() : null);
		obj.setStateUTTaxAmount(arr[61] != null ? arr[61].toString() : null);
		obj.setAdvaloremCessRate(arr[62] != null ? arr[62].toString() : null);
		obj.setAdvaloremCessAmount(arr[63] != null ? arr[63].toString() : null);
		obj.setSpecificCessRate(arr[64] != null ? arr[64].toString() : null);
		obj.setSpecificCessAmount(arr[65] != null ? arr[65].toString() : null);
		obj.setStateCessRate(arr[66] != null ? arr[66].toString() : null);
		obj.setStateCessAmount(arr[67] != null ? arr[67].toString() : null);
		obj.setOtherValue(arr[68] != null ? arr[68].toString() : null);
		obj.setInvoiceValue(arr[69] != null ? arr[69].toString() : null);
		obj.setClaimRefundFlag(arr[70] != null ? arr[70].toString() : null);
		...
		obj.setReverseChargeFlag(arr[81] != null ? arr[81].toString() : null);
		obj.setEligibilityIndicator(
				arr[82] != null ? arr[82].toString() : null);
		obj.setCommonSupplyIndicator(
				arr[83] != null ? arr[83].toString() : null);
		obj.setAvailableIGST(arr[84] != null ? arr[84].toString() : null);
		obj.setAvailableCGST(arr[85] != null ? arr[85].toString() : null);
		obj.setAvailableSGST(arr[86] != null ? arr[86].toString() : null);
		obj.setAvailableCess(arr[87] != null ? arr[87].toString() : null);
		obj.setITCEntitlement(arr[88] != null ? arr[88].toString() : null);
		...
		//obj.setPurchaseVoucherDate(arr[92] != null ? arr[92].toString() : null);
		if (arr[92] != null) {
		...
		if (arr[93] != null) {
			String strdate = arr[93].toString();
			DateTimeFormatter f = new DateTimeFormatterBuilder()
					.appendPattern(OLDFARMATTER).toFormatter();
			LocalDate parsedDate = LocalDate.parse(strdate, f);
			DateTimeFormatter f2 = DateTimeFormatter.ofPattern(NEWFARMATTER);
		...
		obj.setContractNumber(arr[96] != null ? arr[96].toString() : null);
		//obj.setContractDate(arr[97] != null ? arr[97].toString() : null);
		if (arr[97] != null) {
			String strdate = arr[97].toString();
			DateTimeFormatter f = new DateTimeFormatterBuilder()
					.appendPattern(OLDFARMATTER).toFormatter();
			LocalDate parsedDate = LocalDate.parse(strdate, f);
			DateTimeFormatter f2 = DateTimeFormatter.ofPattern(NEWFARMATTER);
		...
		obj.setContractValue(arr[98] != null ? arr[98].toString() : null);
		obj.setUserDefinedField1(arr[99] != null ? arr[99].toString() : null);
		obj.setUserDefinedField2(arr[100] != null ? arr[100].toString() : null);
		obj.setUserDefinedField3(arr[101] != null ? arr[101].toString() : null);
		obj.setUserDefinedField4(arr[102] != null ? arr[102].toString() : null);
		obj.setUserDefinedField5(arr[103] != null ? arr[103].toString() : null);
		obj.setUserDefinedField6(arr[104] != null ? arr[104].toString() : null);
		obj.setUserDefinedField7(arr[105] != null ? arr[105].toString() : null);
		obj.setUserDefinedField8(arr[106] != null ? arr[106].toString() : null);
		obj.setUserDefinedField9(arr[107] != null ? arr[107].toString() : null);
		...
		obj.setEWayBillNumber(arr[114] != null ? arr[114].toString() : null);
		//obj.setEWayBillDate(arr[115] != null ? arr[115].toString() : null);
		if (arr[115] != null) {
		...
		obj.setReturnType(arr[116] != null ? arr[116].toString() : null);
		obj.setDataCategory(arr[117] != null ? arr[117].toString() : null);
		obj.setTableNumber(arr[118] != null ? arr[118].toString() : null);
		...
		obj.setInvoiceValueASP(arr[121] != null ? arr[121].toString() : null);
		obj.setUploadSource(arr[122] != null ? arr[122].toString() : null);
		obj.setSourceID(arr[123] != null ? arr[123].toString() : null);
		obj.setFileName(arr[124] != null ? arr[124].toString() : null);
		obj.setASPDateTime(arr[125] != null ? arr[125].toString() : null);

		return obj;
	}

	private String createAnx2InwardProcessedRecQueryString(String buildQuery) {
		return "SELECT HDR.ID AS HID, HDR.USER_ID,HDR.SOURCE_FILENAME,"
				...
				+ "ITM.OTHER_VALUES,TO_CHAR(ITM.LINE_ITEM_AMT) "
				+ "AS ITM_INV_VALUE,HDR.CLAIM_REFUND_FLAG,"
				+ "HDR.AUTOPOPULATE_TO_REFUND,ITM.ADJ_REF_NO,"
				...
				+ "ITM.ADJ_STATECESS_AMT,HDR.REVERSE_CHARGE,ITM.ELIGIBILITY_INDICATOR "
				+ "AS ITM_ELIGIBILITY_INDICATOR,ITM.COMMON_SUP_INDICATOR,"
				+ "ITM.AVAILABLE_IGST,ITM.AVAILABLE_CGST,"
				+ "ITM.AVAILABLE_SGST,ITM.AVAILABLE_CESS,HDR.ITC_ENTITLEMENT,"
				+ "HDR.ITC_REVERSAL_IDENTIFER,ITM.CRDR_REASON,"
				+ "ITM.PURCHASE_VOUCHER_NUM,ITM.PURCHASE_VOUCHER_DATE,"
				+ "HDR.POSTING_DATE,ITM.PAYMENT_VOUCHER_NUM,"
				+ "ITM.PAYMENT_DATE,ITM.CONTRACT_NUMBER,ITM.CONTRACT_DATE,"
				+ "ITM.CONTRACT_VALUE,ITM.USERDEFINED_FIELD1,ITM.USERDEFINED_FIELD2,"
				...
				+ "HDR.AN_RETURN_TYPE AS RETURN_TYPE,HDR.AN_TAX_DOC_TYPE "
				+ "AS DATA_CATEGORY,HDR.AN_TABLE_SECTION AS TABLE_NUMBER,"
				...
				+ "AS INFO_ERROR_DESCRIPTION_ASP,HDR.DOC_AMT AS INV_VALUE,"
				+ "FIL.SOURCE AS UPLOAD_SOURCE,FIL.CREATED_BY AS SOURCE_ID,"
				+ "FIL.FILE_NAME, HDR.CREATED_ON AS ASP_DATE_TIME "
				...
				+ "ERRI ON ITM.DOC_HEADER_ID= ERRI.DOC_HEADER_ID "
				...
				+ "WHERE IS_ERROR=FALSE AND HDR.AN_RETURN_TYPE = 'ANX2' "
				+ "AND HDR.AN_TAX_DOC_TYPE IN ('B2B','DXP','SEZWP','SEZWOP') "
