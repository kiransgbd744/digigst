...
import com.ey.advisory.core.search.SearchCriteria;
	...
	@Service("AspCDNURASectionReportServiceImpl")
	public class AspCDNURASectionReportServiceImpl
			implements Gstr1ReviewSummReportsService {

		private static final Logger LOGGER = LoggerFactory
				.getLogger(AspCDNURASectionReportServiceImpl.class);

		@Autowired
		CommonUtility commonUtility;

		@Autowired
		@Qualifier("AspCDNURASectionReportDaoImpl")
