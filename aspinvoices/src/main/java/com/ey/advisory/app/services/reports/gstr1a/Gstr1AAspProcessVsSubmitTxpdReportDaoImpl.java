 ...
 * 
 */
@Component("Gstr1AAspProcessVsSubmitTxpdReportDaoImpl")
public class Gstr1AAspProcessVsSubmitTxpdReportDaoImpl
...
private AdvAdjprocessSubmitdto convertProcessed(Object[] arr, Map<String, String> hsnMap, ProcessingContext context) {
	...
	String stateCode = (arr[4] != null ? arr[4].toString() : null);
	...
	obj.setGstnRateofTax(arr[7] != null ? arr[7].toString() : null);
	obj.setGstnGrossAdvanceAdjusted(arr[8] != null ? arr[8].toString() : null);
	obj.setGstnIgstAmount(arr[9] != null ? arr[9].toString() : null);
	obj.setGstnCgstAmount(arr[10] != null ? arr[10].toString() : null);
	obj.setGstnSgstUTGSTAmount(arr[11] != null ? arr[11].toString() : null);
	obj.setGstnCessAmount(arr[12] != null ? arr[12].toString() : null);
	obj.setGstnDifferentialPercentageRate(arr[13] != null ? arr[13].toString() : null);
	//obj.setGstnIsFiled(arr[14] != null ? arr[14].toString() : null);
	...
	obj.setTransactionType(arr[15] != null ? arr[15].toString() : null);
	obj.setMonth(
			arr[16] != null ? arr[16].toString() : null);
	obj.setOrgPos(arr[17] != null ? arr[17].toString() : null);
	obj.setOrgRate(arr[18] != null ? arr[18].toString() : null);
	obj.setOrgGrossAdvanceAdjusted(arr[19] != null ? arr[19].toString() : null);
	obj.setNewPOS(arr[20] != null ? arr[20].toString() : null);
	obj.setNewRate(arr[21] != null ? arr[21].toString() : null);
    obj.setNewGrossAdvanceAdjusted(arr[22] != null ? arr[22].toString() : null);
	...
	obj.setPlant(arr[28] != null ? arr[28].toString() : null);
	obj.setDivision(arr[29] != null ? arr[29].toString() : null);
	obj.setLocation(arr[30] != null ? arr[30].toString() : null);
	obj.setSalesOrganisation(arr[31] != null ? arr[31].toString() : null);
	obj.setDistributionChannel(arr[32] != null ? arr[32].toString() : null);
	obj.setUserAccess1(arr[33] != null ? arr[33].toString() : null);
	obj.setUserAccess2(arr[34] != null ? arr[34].toString() : null);
	obj.setUserAccess3(arr[35] != null ? arr[35].toString() : null);
	obj.setUserAccess4(arr[36] != null ? arr[36].toString() : null);
	obj.setUserAccess5(arr[37] != null ? arr[37].toString() : null);
	obj.setUserAccess6(arr[38] != null ? arr[38].toString() : null);
	obj.setUserdefinedfield1(arr[39] != null ? arr[39].toString() : null);
	obj.setUserdefinedfield2(arr[40] != null ? arr[40].toString() : null);
	obj.setUserdefinedfield3(arr[41] != null ? arr[41].toString() : null);
	obj.setAspInformationID(arr[42] != null ? arr[42].toString() : null);
	obj.setAspInformationDescription(arr[43] != null ? arr[43].toString() : null);
	obj.setSaveStatus(arr[44] != null ? arr[44].toString() : null);
	obj.setgSTNRefID(arr[45] != null ? arr[45].toString() : null);
	obj.setgSTNRefIDTime(arr[46] != null ? arr[46].toString() : null);
	obj.setgSTNErrorcode(arr[47] != null ? arr[47].toString() : null);
	obj.setgSTNErrorDescription(arr[48] != null ? arr[48].toString() : null);
	...
	obj.setsNo(arr[52] != null ? arr[52].toString() : null);
...
private String createApiProcessedQueryString(String buildHeader,String buildHeaderForGet, String buildHeader3) {
	...
	build.append("( with GSTN as ( SELECT HDR.GSTIN SUPPLIER_GSTIN,HDR.RETURN_PERIOD,");
	build.append("HDR.DERIVED_RET_PERIOD,SUPPLY_TYPE,(IFNULL(HDR.GSTIN,'') "); 
	...
	build.append("SUBSTR(HDR.GSTIN,1,2) AS STATE_CODE,");
	build.append("'' STATE_NAME,POS,NULL as TAX_RATE, SUM(ITM.ADVADJ_AMT) TAXABLE_VALUE,");
	...
	build.append("HDR.DIFF_PERCENT, BT.IS_FILED,'ADV ADJ' AS TABLE_TYPE  ");
	build.append("FROM GETGSTR1A_TXP_HEADER HDR  ");
	build.append("INNER JOIN GETGSTR1A_TXP_ITEM ITM ON HDR.ID = ITM.HEADER_ID ");
	...
	build.append("GROUP BY HDR.GSTIN,HDR.RETURN_PERIOD,");
	build.append("HDR.DERIVED_RET_PERIOD,SUPPLY_TYPE, POS,");
	build.append("HDR.DIFF_PERCENT,BT.IS_FILED ),DIGI as ( ");
	...
	build.append("NEW_RATE, SUM(NEW_GROSS_ADV_ADJUSTED)NEW_TAXABLE_VALUE,");
	...
	build.append("MAX(LOCATION)LOCATION,MAX(SALES_ORGANIZATION)SALES_ORGANIZATION,");
	...
	build.append("MAX(GSTIN_REF_ID_TIME)GSTIN_REF_ID_TIME, MAX(GSTN_ERROR_CODE)GSTN_ERROR_CODE,");
	...
	build.append("MAX(ASP_DATE_TIME)ASP_DATE_TIME FROM ( SELECT ");
	build.append("ADJ.SUPPLIER_GSTIN,ADJ.RETURN_PERIOD,ADJ.DERIVED_RET_PERIOD, TRAN_TYPE,MONTH,");
	build.append("NULL ORG_POS,NULL ORG_RATE, 0 ORG_GROSS_ADV_ADJUSTED, NEW_POS,NULL NEW_RATE,");
	build.append("NEW_GROSS_ADV_ADJUSTED, IFNULL(IGST_AMT,0) AS IGST_AMT, IFNULL(CGST_AMT,0) AS CGST_AMT, IFNULL(SGST_AMT,0) AS SGST_AMT, IFNULL(CESS_AMT,0) AS CESS_AMT,");
	build.append("'' PROFIT_CENTRE,''PLANT_CODE, '' DIVISION,''LOCATION,");
	build.append("''SALES_ORGANIZATION, ''DISTRIBUTION_CHANNEL, ''USERACCESS1,");
	build.append("''USERACCESS2,''USERACCESS3,''USERACCESS4,''USERACCESS5, ''USERACCESS6,");
	...
	build.append("(CASE WHEN ADJ.IS_SAVED_TO_GSTN = TRUE AND ADJ.IS_DELETE = FALSE  ");
	build.append("THEN 'IS_SAVED' ELSE 'NOT_SAVED' END) AS SAVE_STATUS,");
	...
	build.append("'' ASP_DATE_TIME FROM GSTR1A_PROCESSED_ADV_ADJUSTMENT ADJ ");
	build.append("LEFT OUTER JOIN TF_GSTR1A_ERROR_INFO() GSTRERR  ");
	build.append("ON ADJ.AS_ENTERED_ID= GSTRERR.COMMON_ID AND ADJ.FILE_ID=GSTRERR.FILE_ID  ");
	build.append("AND GSTRERR.TABLE_TYPE='ADV ADJ' AND RETURN_TYPE='GSTR1A' "); 
	build.append("LEFT OUTER JOIN FILE_STATUS FIL ON ADJ.FILE_ID=FIL.ID "); 
	...
	build.append("WHERE ADJ.IS_DELETE=FALSE AND IS_AMENDMENT=FALSE ");
	...
	build.append("	,(IFNULL(ITM.CESS_AMT_SPECIFIC,0)+IFNULL(ITM.CESS_AMT_ADVALOREM,0))");
	build.append("	,'' PROFIT_CENTRE");
	build.append("	,'' PLANT_CODE");
	build.append("	,'' DIVISION");
	build.append("	,'' LOCATION");
	...
	build.append(" WHERE HDR.TAX_DOC_TYPE='TXP' ");
	...
	build.append("OR TRAN_TYPE IS NULL) THEN 'N' END), NEW_POS,NEW_RATE ) SELECT ");
	...
	build.append("SUPPLY_TYPE, STATE_CODE, STATE_NAME, POS,TAX_RATE,");
	...
	build.append("SUM(DIGI.IGST_AMT)ASP_IGST_AMT,SUM(DIGI.CGST_AMT)ASP_CGST_AMT,");
	build.append("SUM(DIGI.SGST_AMT)ASP_SGST_AMT,SUM(DIGI.CESS_AMT)ASP_CESS_AMT,");
	...
	build.append("'' AS USERACCESS5,'' AS USERACCESS6,USERDEFINED_FIELD1,USERDEFINED_FIELD2,");
	build.append("USERDEFINED_FIELD3,INFO_ERROR_CODE_ASP,INFO_ERROR_DESCRIPTION_ASP,SAVE_STATUS,");
	build.append("GSTIN_REF_ID ,");
	...
	build.append("TRAN_TYPE,TAX_RATE,MONTH,ORG_POS,ORG_RATE,NEW_POS,");
	build.append("NEW_RATE,USERDEFINED_FIELD1, USERDEFINED_FIELD2,");
	build.append("USERDEFINED_FIELD3,INFO_ERROR_CODE_ASP,");
	...
	build.append("ASP_DATE_TIME,SUPPLY_TYPE, STATE_CODE, STATE_NAME, POS,");
