...
public class Uom
	...
	/*private static final List<String> UQC_REQUIRING_IMPORTS = ImmutableList.of(
			"BAG", "BAL", "BDL", "BKL", "BOU", "BOX", "BTL", "BUN", "CAN",
			"CBM", "CCM", "CMS", "CTN", "DOZ", "DRM", "GGR", "GMS", "GRS",
			"GYD", "KGS", "KLR", "KME", "MLT", "MTR", "NOS", "PAC", "PCS",
			"PRS", "QTL", "ROL", "SET", "SQF", "SQM", "SQY", "TBS", "TGM",
			"THD", "TON", "TUB", "UGS", "UNT", "YDS");
*/
	@Override
	public List<ProcessingResult> validate(Gstr1AsEnteredHsnEntity item,
