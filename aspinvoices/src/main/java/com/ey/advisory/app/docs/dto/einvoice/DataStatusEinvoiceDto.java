 ...
 */
@ToString
public class DataStatusEinvoiceDto {
	...
	private String processFreq;
	private String processDateTime;
	private String userIDN;
	private String distanceProvidedByUser;
	private String eINVvsGstr1Reponse;
	
	public String getEINVvsGstr1Reponse() {
		return eINVvsGstr1Reponse;
	}

	public void setEINVvsGstr1Reponse(String eINVvsGstr1Reponse) {
		this.eINVvsGstr1Reponse = eINVvsGstr1Reponse;
	}
	...
	public String getProcessFreq() {
		return processFreq;
	}

	public void setProcessFreq(String processFreq) {
	...
	public String getDistanceProvidedByUser() {
		return distanceProvidedByUser;
	}

	public void setDistanceProvidedByUser(String distanceProvidedByUser) {
		this.distanceProvidedByUser = distanceProvidedByUser;
	}
	...
	public String toString() {
		return "DataStatusEinvoiceDto [aspErrorCode=" + aspErrorCode
				...
				+ ", irn=" + irn + ", irnDate=" + irnDate + ", taxScheme="
				+ taxScheme + ", cancellationReason=" + cancellationReason
				...
				+ salesOrderNumber + ", eWBNumber=" + eWBNumber + ", eWBDate="
				...
				+ userId + ", userId1=" + userId1 + ", fileID=" + fileID
				+ ", fileName=" + fileName + ", invoiceOtherChargesASP="
				+ invoiceOtherChargesASP + ", invoiceAssessableAmountASP="
				+ invoiceAssessableAmountASP + ", invoiceIGSTAmountASP="
				+ invoiceIGSTAmountASP + ", invoiceCGSTAmountASP="
				+ invoiceCGSTAmountASP + ", invoiceSGSTAmountASP="
				+ invoiceSGSTAmountASP + ", invoiceCessAdvaloremAmountASP="
				...
				+ ", infoErrorMsg=" + infoErrorMsg + ", processFreq="
				+ processFreq + ", processDateTime=" + processDateTime
				+ ", userIDN=" + userIDN + ", distanceProvidedByUser="
				+ distanceProvidedByUser + ", eINVvsGstr1Reponse="
				+ eINVvsGstr1Reponse + "]";
	}
	...
	public String toString() {
		return "DataStatusEinvoiceDto [aspErrorCode=" + aspErrorCode
				...
				+ ", ewbNo=" + ewbNo + ", ewbRespDate=" + ewbRespDate
				+ ", ewbErrorCode=" + ewbErrorCode + ", ewbErrorDescription="
				+ ewbErrorDescription  + ", gstnStatus="
				...
				+ ", infoErrorMsg=" + infoErrorMsg + ", processFreq="
				+ processFreq + ", processDateTime=" + processDateTime
				+", eINVvsGstr1Reponse="+eINVvsGstr1Reponse 
				+ ", userIDN=" + userIDN + "]";
	}*/
