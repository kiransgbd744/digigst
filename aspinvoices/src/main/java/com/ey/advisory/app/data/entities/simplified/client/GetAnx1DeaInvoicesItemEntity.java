...
@Entity
@Table(name = "GETANX1_DEA_ITEM")
public class GetAnx1DeaInvoicesItemEntity {
	...
	protected GetAnx1DeaInvoicesHeaderEntity header;
	...
	public GetAnx1DeaInvoicesHeaderEntity getHeader() {
		return header;
	}

	public void setHeader(GetAnx1DeaInvoicesHeaderEntity header) {
		this.header = header;
	}
