...
import com.ey.advisory.core.search.SearchCriteria;
	...
	@Service("AspAdvAdjSecServiceImpl")
	public class AspAdvAdjSecServiceImpl
			implements Gstr1ASPAdvAdjSavableService {

		private static final Logger LOGGER = LoggerFactory
				.getLogger(AspAdvAdjSecServiceImpl.class);

		@Autowired
		CommonUtility commonUtility;

		@Autowired
		@Qualifier("AspAdvAdjSecTotalDaoImpl")
		...
		@Autowired
		@Qualifier("AspAdvAdjsecSummaryLevelDaoImpl")
