...
public class AccountingVoucDateValidationRule implements ValidationRule {
	...
	public List<ProcessingResult> isValid(int idx, Object obj, Object[] row,
		...
		if (date == null) {
			...
			errors.add(new ProcessingResult(APP_VALIDATION, "ER0107",
					"Invalid Accounting Voucher Date", location));
			return errors;
		}
