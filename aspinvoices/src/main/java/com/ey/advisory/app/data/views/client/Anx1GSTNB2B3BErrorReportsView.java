...
public class Anx1GSTNB2B3BErrorReportsView {
	...
	public String toString() {
		return "Anx1GSTNB2B3BErrorReportsView [supplierGSTIN=" + supplierGSTIN
				...
				+ ", integTaxAmt=" + integTaxAmt + ", CentralTaxAmt="
				+ CentralTaxAmt + ", stateUTTaxAmt=" + stateUTTaxAmt
				+ ", cessAmt=" + cessAmt + ", invoiceValue=" + invoiceValue
				+ ", pos=" + pos + ", diffPerFlag=" + diffPerFlag
