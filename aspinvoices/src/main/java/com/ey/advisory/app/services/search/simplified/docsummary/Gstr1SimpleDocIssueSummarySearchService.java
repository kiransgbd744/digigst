 ...
 *
 */
@Service("Gstr1SimpleDocIssueSummarySearchService")
public class Gstr1SimpleDocIssueSummarySearchService implements SearchService{
	
	
	private static final Logger LOGGER = LoggerFactory
			.getLogger(Gstr1SimpleDocIssueSummarySearchService.class);
	
	@Autowired
	@Qualifier("SimpleGstr1BasicDocIssueSummarySectionFetcher")
	...
	public <R> SearchResult<R> find(SearchCriteria criteria,
		...
		List<Gstr1SummaryDocSectionDto> doclist = eySummaries.get("DOC ISSUED");
		Gstr1BasicDocSectionSummaryDto docSummary = 
				new Gstr1BasicDocSectionSummaryDto();
