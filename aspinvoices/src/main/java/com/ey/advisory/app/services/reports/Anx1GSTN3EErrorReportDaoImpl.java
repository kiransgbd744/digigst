...
import com.ey.advisory.app.data.views.client.Anx1GSTN3EErrorReportsView;
import com.ey.advisory.app.util.OnboardingConstant;
import com.ey.advisory.common.GenUtil;
import com.ey.advisory.core.dto.Gstr1ReviwSummReportsReqDto;
import com.ey.advisory.core.search.SearchCriteria;

@Component("Anx1GSTN3EErrorReportDaoImpl")
public class Anx1GSTN3EErrorReportDaoImpl implements Anx1GstnErrorDao {
	...
	public List<Object> getAnx1GstnErrorReport(SearchCriteria criteria) {
		...
		String queryStr = GSTN3EErrorQueryString(buildQuery.toString());
		...
		return list.parallelStream().map(o -> convertGSTN3EError(o))
				.collect(Collectors.toCollection(ArrayList::new));
	}

	private Anx1GSTN3EErrorReportsView convertGSTN3EError(Object[] arr) {
		Anx1GSTN3EErrorReportsView obj = new Anx1GSTN3EErrorReportsView();
		...
		obj.setClaimRefundFlag(arr[14] != null ? arr[14].toString() : null);
	...
	private String GSTN3EErrorQueryString(String buildQuery) {
		return "SELECT HT.SUPPLIER_GSTIN,HT.CUST_GSTIN,"
				+ "DOC_TYPE,DOC_NUM,HT.DOC_DATE,ITM_HSNSAC,TAX_RATE,"
				...
				+ "HT.AUTOPOPULATE_TO_REFUND,HT.CLAIM_REFUND_FLAG,"
				...
				+ "AND UCASE(HT.AN_TAX_DOC_TYPE) = UCASE('SEZT') "
				...
				+ "ON GSB.ID = HT.BATCH_ID " + buildQuery + " GROUP BY "
