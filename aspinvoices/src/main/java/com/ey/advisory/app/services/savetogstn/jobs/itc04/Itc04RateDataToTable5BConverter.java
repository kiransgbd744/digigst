 ...
 *
 */
@Service("Itc04RateDataToTable5BConverter")
@Slf4j
public class Itc04RateDataToTable5BConverter implements RateDataToItc04Converter {
	...
	public SaveBatchProcessDto convertToItc04Object(List<Object[]> objects, String section, String groupCode,
		...
		try {
			if (objects != null && !objects.isEmpty()) {
				...
				List<Itc04Table5BDto> table5bList = new ArrayList<>();
	...
	private Itc04Dto setBatch(Object[] arr1, String section, List<Itc04Table5BDto> table5bList) {
		...
		dto.setTable5b(table5bList);
		return dto;
	}

	private Itc04Table5BDto setInv(Object[] arr1, List<Itc04ItemsDto> itmsList, String taxDocType) {
		Itc04Table5BDto data = new Itc04Table5BDto();
