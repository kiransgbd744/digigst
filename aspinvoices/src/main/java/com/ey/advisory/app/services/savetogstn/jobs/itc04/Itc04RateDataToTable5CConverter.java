 ...
 *
 */
@Service("Itc04RateDataToTable5CConverter")
@Slf4j
public class Itc04RateDataToTable5CConverter implements RateDataToItc04Converter {
	...
	public SaveBatchProcessDto convertToItc04Object(List<Object[]> objects, String section, String groupCode,
		...
		try {
			if (objects != null && !objects.isEmpty()) {
				...
				List<Itc04Table5CDto> table5cList = new ArrayList<>();
	...
	private Itc04Dto setBatch(Object[] arr1, String section, List<Itc04Table5CDto> table5cList) {
		...
		dto.setTable5c(table5cList);
		return dto;
	}

	private Itc04Table5CDto setInv(Object[] arr1, List<Itc04ItemsDto> itmsList, String taxDocType) {
		Itc04Table5CDto data = new Itc04Table5CDto();
	...
	private Itc04ItemsDto setItemDetail(Object[] arr1) {
		...
		items.setInum(arr1[7] != null ? String.valueOf(arr1[7]) : null);
		items.setIdt(arr1[8] != null ? String.valueOf(arr1[8]) : null);
