 ...
 */
@Entity
@Table(name = "GETGSTR6_B2BA_ITEM")
public class GetGstr6B2baItemEntity {

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "GETGSTR6_B2BA_ITEM_SEQ", allocationSize = 100)
	...
	protected GetGstr6B2baHeaderEntity document;
	...
	public GetGstr6B2baHeaderEntity getDocument() {
		return document;
	}

	public void setDocument(GetGstr6B2baHeaderEntity document) {
