...
@Service("NilNonVerticalErrorReportsServiceImpl")
public class NilNonVerticalErrorReportsServiceImpl
		implements NilNonVerticalReportsService {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(NilNonVerticalErrorReportsServiceImpl.class);

	@Autowired
	CommonUtility commonUtility;

	@Autowired
	@Qualifier("NilNonVerticalErrorReportsDaoImpl")
