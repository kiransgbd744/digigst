...
@Component("RefundsHeaderCheckService")
public class RefundsHeaderCheckService implements Annexure11HeaderCheckService {

	@Autowired
	@Qualifier("Annexure1HeaderChecker")
	private Annexure1HeaderChecker annexure1HeaderChecker;

	public static final String[] EXPECTED_HEADERS = { "Sr.No.", "GSTIN",
			"ReturnPeriod", "Description", "Tax", "Interest", "Penalty", "Fee",
			"Other", "Total", "Userdefinedfield1", "Userdefinedfield2",
			"Userdefinedfield3" };
