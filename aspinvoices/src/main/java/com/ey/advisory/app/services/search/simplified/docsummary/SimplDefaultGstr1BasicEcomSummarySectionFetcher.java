 ...
 *
 */
@Component("SimplDefaultGstr1BasicEcomSummarySectionFetcher")
public class SimplDefaultGstr1BasicEcomSummarySectionFetcher
		implements SimplBasicEcommSummarySectionFetcher {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(SimplDefaultGstr1BasicEcomSummarySectionFetcher.class);

	@Autowired
	@Qualifier("EcomDocSummarySectionDaoImpl")
