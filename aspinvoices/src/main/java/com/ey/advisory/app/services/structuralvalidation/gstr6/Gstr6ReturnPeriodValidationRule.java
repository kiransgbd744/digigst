...
public class Gstr6ReturnPeriodValidationRule implements ValidationRule {
...
if (!isPresent(obj)){
			...
			errors.add(new ProcessingResult(APP_VALIDATION, "ER3001",
			...
			if (!taxPeriod.matches("[0-9]+") || taxPeriod.length() != 6) {
				...
				TransDocProcessingResultLoc location = new TransDocProcessingResultLoc(
						null, errorLocations.toArray());
				errors.add(new ProcessingResult(APP_VALIDATION, "ER3002",
