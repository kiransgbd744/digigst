...
@Component("Gstr1GstnB2CSASummaryTablesDaoImpl")
public class Gstr1GstnB2CSASummaryTablesDaoImpl
		implements Gstr1GstnSummaryTablesDao {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(Gstr1GstnB2CSASummaryTablesDaoImpl.class);
	...
	private String creategstnB2CSSummaryQueryString(String buildQuery) {
		...
		return "SELECT HDR.ID,HDR.GSTIN,HDR.RETURN_PERIOD,HDR.ORG_INV_MONTH,"
				...
				+ "BT.IS_FILED,(ROW_NUMBER () OVER (ORDER BY HDR.GSTIN)) AS  SNO "
				+ " FROM GETGSTR1_B2CSA_HEADER HDR INNER JOIN "
				+ "GETGSTR1_B2CSA_ITEM ITM ON HDR.ID = ITM.HEADER_ID "
				...
				+ "ITM.TAX_RATE,HDR.DIFF_PERCENT,HDR.ECOM_TYPE,HDR.ETIN,BT.IS_FILED";
	}
}
