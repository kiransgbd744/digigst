...
@Entity
@Table(name = "GETGSTR1A_AT_ITEM")
public class GetGstr1AAtItemEntity {

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "GETGSTR1A_AT_ITEM_SEQ", allocationSize = 100)
	...
	private GetGstr1AAtHeaderEntity document;
	...
	public GetGstr1AAtHeaderEntity getDocument() {
		return document;
	}

	public void setDocument(GetGstr1AAtHeaderEntity document) {
