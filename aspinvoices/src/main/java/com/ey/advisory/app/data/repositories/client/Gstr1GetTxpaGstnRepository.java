 ...
 *
 */
@Repository("Gstr1GetTxpaGstnRepository")
@Transactional(propagation = Propagation.REQUIRED, readOnly = false)
public interface Gstr1GetTxpaGstnRepository
		extends CrudRepository<GetGstr1TxpaHeaderEntity, Long> {
	@Modifying
	@Query("UPDATE GetGstr1TxpaHeaderEntity b SET b.isDelete = true,b.modifiedBy = 'SYSTEM'  , b.modifiedOn =:modifiedOn  WHERE"
	...
	@Query("SELECT COUNT(*) FROM GetGstr1TxpaHeaderEntity "
