 ...
 */
@Entity
@Table(name = "GETGSTR8_TCS_HEADER")
public class GetGstr8TcsHeaderEntity {

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "GETGSTR8_TCS_HEADER_SEQ", allocationSize = 100)
