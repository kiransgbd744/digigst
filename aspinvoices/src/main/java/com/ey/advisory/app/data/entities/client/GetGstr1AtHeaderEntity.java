 ...
 */
@Entity
@Table(name = "GETGSTR1_AT_HEADER")

public class GetGstr1AtHeaderEntity {

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "GETGSTR1_AT_HEADER_SEQ", allocationSize = 100)
	...
	protected List<GetGstr1AtItemEntity> lineItems = new ArrayList<>();
	...
	public List<GetGstr1AtItemEntity> getLineItems() {
		return lineItems;
	}

	public void setLineItems(List<GetGstr1AtItemEntity> lineItems) {
