 ...
 *
 */
@Repository("GetGstr2ErpB2bInvoicesRepository")
@Transactional(propagation = Propagation.REQUIRED, readOnly = false)
public interface GetGstr2ErpB2bInvoicesRepository extends CrudRepository<GetGstr2aErpB2bInvoicesHeaderEntity, Long> {

	// Curently isDelete is not added in table
	@Modifying
	@Query("UPDATE GetGstr2aErpB2bInvoicesHeaderEntity b SET b.isDelete = true,b.modifiedBy = 'SYSTEM'  , b.modifiedOn =:modifiedOn  WHERE"
	...
	@Query("from GetGstr2aErpB2bInvoicesHeaderEntity where sgstin=:sgstin and cgstin=:cgstin and invDate=:invDate and invNum=:invNum and invType=:invType")
	List<GetGstr2aErpB2bInvoicesHeaderEntity> findByInvoiceKey(
	...
	@Query("SELECT COUNT(*) FROM GetGstr2aErpB2bInvoicesHeaderEntity "
	...
	@Modifying
	@Query("UPDATE GetGstr2aErpB2bInvoicesHeaderEntity b SET b.isDelete = true  WHERE"
