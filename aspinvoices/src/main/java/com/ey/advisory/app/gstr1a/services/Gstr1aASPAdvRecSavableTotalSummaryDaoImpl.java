...
@Component("Gstr1aASPAdvRecSavableTotalSummaryDaoImpl")
public class Gstr1aASPAdvRecSavableTotalSummaryDaoImpl
		implements Gstr1AdvRecSavableDao {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(Gstr1aASPAdvRecSavableTotalSummaryDaoImpl.class);
	...
	private static String createApiProcessedQueryString(String buildQueryAdv,
		...
		return "SELECT SUPPLIER_GSTIN,RETURN_PERIOD,TRAN_TYPE,MAX(MONTH)MONTH, "
				...
				+ "FROM GSTR1A_PROCESSED_ADV_RECEIVED REC LEFT OUTER JOIN "
				+ "TF_GSTR1A_ERROR_INFO() GSTRERR ON REC.AS_ENTERED_ID= GSTRERR.COMMON_ID "
