 ...
 *
 */
@Component("InvMnagmntCommonSecParams")
public class InvMnagmntCommonSecParams {

	public EInvMangmntScreenDownloadReqDto setDataSecuritySearchParams(
			EInvMangmntScreenDownloadReqDto searchParams) {
