...
import com.ey.advisory.app.data.views.client.Gstr6B2BGstnErrorDto;
...
@Component("Gstr6GstnB2BErrorDaoImpl")
public class Gstr6GstnB2BErrorDaoImpl implements Gstr6GstnErrorDao {
	...
	private Gstr6B2BGstnErrorDto convertgstnB2BError(Object[] arr) {
		Gstr6B2BGstnErrorDto obj = new Gstr6B2BGstnErrorDto();
		...
		obj.setLineNo(arr[3] != null ? arr[3].toString() : null);
		...
		obj.setRefId(arr[12] != null ? arr[12].toString() : null);
		obj.setRefIdDateTime(arr[13] != null ? arr[13].toString() : null);
		obj.setErrorCode(arr[14] != null ? arr[14].toString() : null);
		obj.setErrorMessage(arr[15] != null ? arr[15].toString() : null);

		return obj;
	}


	private static String creategstnB2BErrorQueryString(String buildQuery) {
		...
		return "select HDR.SUPPLIER_GSTIN,HDR.DOC_NUM,HDR.DOC_DATE,"
				...
				+ "as CESS_AMT, ifnull(SUM(HDR.DOC_AMT),0),BT.GSTN_SAVE_REF_ID,BT.CREATED_ON, "
				+ "HDR.GSTN_ERROR_CODE AS GSTIN_ERROR_CODE, HDR.GSTN_ERROR_DESC "
				+ "AS GSTN_ERROR_DESC FROM ANX_INWARD_DOC_HEADER "
				...
				+ "HDR.TAX_DOC_TYPE = 'B2B' AND GSTN_ERROR = TRUE "
				...
				+ "ITM.TAX_RATE,HDR.POS,HDR.GSTN_ERROR_CODE,"
				+ "HDR.GSTN_ERROR_DESC,BT.GSTN_SAVE_REF_ID,BT.CREATED_ON ";
	}
}
