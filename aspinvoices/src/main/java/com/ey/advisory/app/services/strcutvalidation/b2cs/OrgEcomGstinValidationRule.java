...
public class OrgEcomGstinValidationRule implements ValidationRule {
	@Autowired
	...
	public List<ProcessingResult> isValid(Object obj, Object[] row,
		...
		if (obj.toString().trim().length() != 15 || !matcher.matches()) {
			...
			errorLocations.add(GSTConstants.OrgE_ComGstin);
			TransDocProcessingResultLoc location = 
					new TransDocProcessingResultLoc(
					null, errorLocations.toArray());
			errors.add(new ProcessingResult(APP_VALIDATION, "ER5017",
					"InvalidOrgeComGSTIN", location));
			return errors;
		}
		return errors;
	}
