...
import com.ey.advisory.app.services.reports.Gstr1ASPB2CSSavableSummaryLevelDao;
...
@Service("Gstr1aASPB2CSSavableServiceImpl")
public class Gstr1aASPB2CSSavableServiceImpl
		implements Gstr1ASPB2CSSavableService {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(Gstr1aASPB2CSSavableServiceImpl.class);

	@Autowired
	CommonUtility commonUtility;

	@Autowired
	@Qualifier("Gstr1aASPB2CSSavableTotalSummaryDaoImpl")
	private Gstr1ASPB2CSSavableTotalDao gstr1ASPB2CSSavableTotalDao;

	@Autowired
	@Qualifier("Gstr1aB2CSSavableTransactionalDaoImpl")
	private Gstr1ASPB2CSSavableTransactionalDao gstr1ASPB2CSSavableTransactionalDao;

	@Autowired
	@Qualifier("Gstr1aASPB2CSSavableSummaryLevelDaoImpl")
