...
public class EComValueOfSuppliesReturned implements ValidationRule {
	private static final String ECOM_VAL_RET ="ECOM_VAL_RET";
	...
	public List<ProcessingResult> isValid(Object obj, Object[] row,
		...
		if (obj != null) {
			...
			if (!isDecimal(obj)) {
				errorLocations.add(ECOM_VAL_RET);
