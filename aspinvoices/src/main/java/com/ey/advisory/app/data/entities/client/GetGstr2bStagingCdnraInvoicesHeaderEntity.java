...
@Entity
@Table(name = "GETGSTR2B_STAGING_CDNRA_HEADER")
@Data
public class GetGstr2bStagingCdnraInvoicesHeaderEntity {

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "GETGSTR2B_STAGING_CDNRA_HEADER_SEQ", allocationSize = 100)
	...
	protected List<GetGstr2bStagingCdnraInvoicesItemEntity> lineItemss = new ArrayList<>();
