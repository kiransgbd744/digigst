...
@Component("AsyncGstr6ProcessReportDownloadServiceImpl")
@Slf4j
public class AsyncGstr6ProcessReportDownloadServiceImpl
	...
	public void generateReports(Long id) {
		...
		try {
			...
			if (entity.getReportType().equalsIgnoreCase("gstr6Process"))

				reportType = "GSTR6Process";
			else
			...
			StatefulBeanToCsv<GSTR2ProcessedInwarddto> beanWriter = getBeanWriter(
					reportConfig, writer, Answer.toString());

			WritetoCsv(chunkCount, id, reportConvertor, reportType, beanWriter,
					reportCateg, Answer.toString());
	...
	private void WritetoCsv(Integer chunkNo, Long id,
			...
			String reportCateg, String answer) {
		...
		if (ReportTypeConstants.PROCESSED_SUMMARY.equalsIgnoreCase(reportCateg)
			...
			if (answer.equalsIgnoreCase("A") || answer.equalsIgnoreCase("B"))
				procName = "gstr6ChunkData";
			else
				procName = "gstr6LockChunkData";
		}
		try {
				...
				if (list.size() > 0) {
					...
					if (answer.equalsIgnoreCase("A")
						...
						responseFromDao = list.stream()
								.map(o -> convertRowsToDto(o, false))
								.collect(Collectors
										.toCollection(ArrayList::new));
					} else {
						responseFromDao = list.stream()
								.map(o -> convertRowsToDto(o, true))
								.collect(Collectors
										.toCollection(ArrayList::new));
					}
	...
	private Integer getChunkCount(String reportCateg, Long id, String answer) {
		...
		if (ReportTypeConstants.PROCESSED_SUMMARY.equalsIgnoreCase(reportCateg)
				|| ReportTypeConstants.REVIEW_SUMMARY
						.equalsIgnoreCase(reportCateg)) {
			if (answer.equalsIgnoreCase("A") || answer.equalsIgnoreCase("B"))
				procName = "gstr6ChunkCount";
			else
				procName = "gstr6LockChunkCount";
		}
	...
	private StatefulBeanToCsv<GSTR2ProcessedInwarddto> getBeanWriter(
			ReportConfig config, Writer writer, String answer)
			throws Exception {

		String invoiceHeadersTemplate = null;
		String[] columnMappings = null;

		// Excel report should be same whether it is option A/B/C/D
		if (answer.equalsIgnoreCase("A") || answer.equalsIgnoreCase("B")) {
			invoiceHeadersTemplate = commonUtility
					.getProp("anx1.inward.processed.lock.report.headers");

			columnMappings = commonUtility
					.getProp("anx1.inward.processed.lock.report.column.mapping")
					.split(",");
		} else {
			invoiceHeadersTemplate = commonUtility
					.getProp("anx1.inward.processed.lock.report.headers");
	...
	private GSTR2ProcessedInwarddto convertRowsToDto(Object[] arr,
			boolean isLock) {
		...
		obj.setPreTaxAmount(
				arr[65] != null ? DownloadReportsConstant.CSVCHARACTER
						.concat(arr[65].toString()) : null);
		obj.setItemAssessableAmount(
				arr[66] != null ? DownloadReportsConstant.CSVCHARACTER
						.concat(arr[66].toString()) : null);
		obj.setiGSTRate(arr[67] != null ? DownloadReportsConstant.CSVCHARACTER
				.concat(arr[67].toString()) : null);
		obj.setiGSTAmount(arr[68] != null ? DownloadReportsConstant.CSVCHARACTER
				.concat(arr[68].toString()) : null);
		obj.setcGSTRate(arr[69] != null ? DownloadReportsConstant.CSVCHARACTER
				.concat(arr[69].toString()) : null);
		obj.setcGSTAmount(arr[70] != null ? DownloadReportsConstant.CSVCHARACTER
				.concat(arr[70].toString()) : null);
		obj.setsGSTRate(arr[71] != null ? DownloadReportsConstant.CSVCHARACTER
				.concat(arr[71].toString()) : null);
		obj.setsGSTAmount(arr[72] != null ? DownloadReportsConstant.CSVCHARACTER
		...
		obj.setCessAdvaloremAmount(
				arr[74] != null ? DownloadReportsConstant.CSVCHARACTER
						.concat(arr[74].toString()) : null);
		obj.setCessSpecificRate(
				arr[75] != null ? DownloadReportsConstant.CSVCHARACTER
						.concat(arr[75].toString()) : null);
		obj.setCessSpecificAmount(
				arr[76] != null ? DownloadReportsConstant.CSVCHARACTER
						.concat(arr[76].toString()) : null);
		...
		obj.setStateCessAdvaloremAmount(
				arr[78] != null ? DownloadReportsConstant.CSVCHARACTER
						.concat(arr[78].toString()) : null);
		obj.setStateCessSpecificRate(
				arr[79] != null ? DownloadReportsConstant.CSVCHARACTER
						.concat(arr[79].toString()) : null);
		obj.setStateCessSpecificAmount(
				arr[80] != null ? DownloadReportsConstant.CSVCHARACTER
						.concat(arr[80].toString()) : null);
		obj.setItemOtherCharges(arr[81] != null ? arr[81].toString() : null);
		obj.setTotalItemAmount(
				arr[82] != null ? DownloadReportsConstant.CSVCHARACTER
		...
		obj.setInvoiceIGSTAmount(
				arr[85] != null ? DownloadReportsConstant.CSVCHARACTER
						.concat(arr[85].toString()) : null);
		obj.setInvoiceCGSTAmount(
				arr[86] != null ? DownloadReportsConstant.CSVCHARACTER
						.concat(arr[86].toString()) : null);
		obj.setInvoiceSGSTAmount(
				arr[87] != null ? DownloadReportsConstant.CSVCHARACTER
						.concat(arr[87].toString()) : null);
		obj.setInvoiceCessAdvaloremAmount(
				arr[88] != null ? DownloadReportsConstant.CSVCHARACTER
						.concat(arr[88].toString()) : null);
		obj.setInvoiceCessSpecificAmount(
				arr[89] != null ? DownloadReportsConstant.CSVCHARACTER
						.concat(arr[89].toString()) : null);
		obj.setInvoiceStateCessAdvaloremAmount(
				arr[90] != null ? DownloadReportsConstant.CSVCHARACTER
						.concat(arr[90].toString()) : null);
		obj.setInvoiceStateCessSpecificAmount(
				arr[91] != null ? DownloadReportsConstant.CSVCHARACTER
						.concat(arr[91].toString()) : null);
		obj.setInvoiceValue(
				arr[92] != null ? DownloadReportsConstant.CSVCHARACTER
						.concat(arr[92].toString()) : null);
		...
		obj.setAvailableIgst(
				arr[97] != null ? DownloadReportsConstant.CSVCHARACTER
						.concat(arr[97].toString()) : null);
		obj.setAvailableCgst(
				arr[98] != null ? DownloadReportsConstant.CSVCHARACTER
						.concat(arr[98].toString()) : null);
		obj.setAvailableSgst(
				arr[99] != null ? DownloadReportsConstant.CSVCHARACTER
						.concat(arr[99].toString()) : null);
		obj.setAvailableCess(
				arr[100] != null ? DownloadReportsConstant.CSVCHARACTER
						.concat(arr[100].toString()) : null);
		...
		String infoCode = (arr[244] != null) ? arr[244].toString() : null;
		...
		obj.setSource(arr[246] != null ? arr[246].toString() : null);
		obj.setSourceID(arr[247] != null ? arr[247].toString() : null);
		obj.setFileName(arr[248] != null ? arr[248].toString() : null);
		/*
		...
		if (arr[249] != null) {
			Timestamp timeStamp = (Timestamp) arr[249];
