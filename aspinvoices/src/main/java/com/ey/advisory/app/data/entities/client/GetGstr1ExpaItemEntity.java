...
@Entity
@Table(name = "GETGSTR1_EXPA_ITEM")

public class GetGstr1ExpaItemEntity {
	...
	private GetGstr1ExpaHeaderEntity document;
	...
	public GetGstr1ExpaHeaderEntity getDocument() {
		return document;
	}

	public void setDocument(GetGstr1ExpaHeaderEntity document) {
