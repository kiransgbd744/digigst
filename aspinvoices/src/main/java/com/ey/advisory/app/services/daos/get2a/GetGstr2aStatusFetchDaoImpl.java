...
@Component("GetGstr2aStatusFetchDaoImpl")
public class GetGstr2aStatusFetchDaoImpl implements GetGstr2aStatusFetchDao {
	...
	public List<Object[]> getDataUploadedStatusDetails(String gstin,
		...
		buffer.append(
				"SELECT * FROM ( SELECT * FROM (SELECT GSTIN,RETURN_PERIOD,DENSE_RANK() "
						...
						+ "API_SECTION='GSTR2A') A WHERE NUM = 1 AND GSTIN = :gstin");
		...
		buffer.append(" UNION "
				...
				+ " WHERE STATUS = 'SUCCESS' AND API_SECTION='GSTR2A')"
