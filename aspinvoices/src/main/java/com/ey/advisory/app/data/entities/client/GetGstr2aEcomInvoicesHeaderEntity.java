...
@Data
@Entity
@Table(name = "GETGSTR2A_ECOM_HEADER")
public class GetGstr2aEcomInvoicesHeaderEntity
		extends GetGstr2aEcomInvoicesHeader {

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "GETGSTR2A_ECOM_HEADER_SEQ", allocationSize = 100)
	...
	protected List<GetGstr2aEcomInvoicesItemEntity> lineItems = new ArrayList<>();
