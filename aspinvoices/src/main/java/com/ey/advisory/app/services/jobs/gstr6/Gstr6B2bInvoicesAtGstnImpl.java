 ...
 *
 */
@Service("Gstr6B2bInvoicesAtGstnImpl")
@Slf4j
public class Gstr6B2bInvoicesAtGstnImpl implements Gstr6InvoicesAtGstn {
	...
	public Long findInvFromGstn(Gstr6GetInvoicesReqDto dto, String groupCode, String type, Long batchId) {
		...
		try {
			...
			throw new APIException("Unexpected error while executing Gstr6 Get B2b");
		}
		return reqId;
	}
