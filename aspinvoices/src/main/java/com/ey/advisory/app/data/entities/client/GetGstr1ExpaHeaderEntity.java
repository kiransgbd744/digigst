...
@Entity
@Table(name = "GETGSTR1_EXPA_HEADER")
public class GetGstr1ExpaHeaderEntity {
	...
	protected List<GetGstr1ExpaItemEntity> lineItems = new ArrayList<>();
	...
	public List<GetGstr1ExpaItemEntity> getLineItems() {
		return lineItems;
	}

	public void setLineItems(List<GetGstr1ExpaItemEntity> lineItems) {
