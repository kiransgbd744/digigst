...
@Component("Gstr1ALuCgstRateValidator")
public class Gstr1ALuCgstRateValidator
	...
	public List<ProcessingResult> validate(Gstr1AOutwardTransDocument document,
		...
		IntStream.range(0, items.size()).forEach(idx -> {
			...
			if (n <= 0) {
				...
				errors.add(new ProcessingResult(APP_VALIDATION, "ER0077",
						"Invalid CGST Rate", location));
			}
