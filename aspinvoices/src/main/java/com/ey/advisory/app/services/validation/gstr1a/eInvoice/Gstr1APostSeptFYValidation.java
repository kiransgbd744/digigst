...
public class Gstr1APostSeptFYValidation
	...
	public List<ProcessingResult> validate(Gstr1AOutwardTransDocument document,
		...
		if (document.getDocType() == null || document.getDocType().isEmpty())
			return errors;
		if (GSTConstants.CR
				.equalsIgnoreCase(document.getDocType().toUpperCase())
				&& document.getDocDate() == null)
			return errors;
		...
		Integer derivedFy = GenUtil.convertTaxPeriodToInt(
				SEPTEMBER + finYear.substring(0, 2) + finYear.substring(4, 6));
		Integer derivedTaxperiod = GenUtil
				.convertTaxPeriodToInt(document.getTaxperiod());
