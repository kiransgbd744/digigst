 ...
 *
 */
public class TenderReferenceValidation implements ValidationRule {
	...
	public List<ProcessingResult> isValid(int idx, Object obj, Object[] row,
		...
		if (date == null ) {
			...
			errorLocations.add(GSTConstants.TENDER_REFERENCE);
			TransDocProcessingResultLoc location = 
					new TransDocProcessingResultLoc(
					null, errorLocations.toArray());
			errors.add(new ProcessingResult(APP_VALIDATION, "ER10103",
					          "Invalid Tender Reference.", location));
			return errors;
		}
