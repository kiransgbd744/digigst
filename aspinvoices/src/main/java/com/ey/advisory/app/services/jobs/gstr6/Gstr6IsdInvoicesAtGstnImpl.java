 ...
 *
 */
@Service("Gstr6IsdInvoicesAtGstnImpl")
@Slf4j
public class Gstr6IsdInvoicesAtGstnImpl implements Gstr6InvoicesAtGstn {
	@Autowired
	...
	public Long findInvFromGstn(Gstr6GetInvoicesReqDto dto, String groupCode, String type, Long batchId) {
		...
		try {
			...
			throw new APIException("Unexpected error while executing Gstr6 Get Isd");
