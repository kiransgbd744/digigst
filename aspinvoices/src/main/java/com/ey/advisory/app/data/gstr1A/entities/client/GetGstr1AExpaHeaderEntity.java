...
@Entity
@Table(name = "GETGSTR1A_EXPA_HEADER")
public class GetGstr1AExpaHeaderEntity {

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "GETGSTR1_EXPA_HEADER_SEQ", allocationSize = 100)
	...
	protected List<GetGstr1AExpaItemEntity> lineItems = new ArrayList<>();
	...
	public void setOrgInvDate(String orgInvDate) {
	...
	public List<GetGstr1AExpaItemEntity> getLineItems() {
		return lineItems;
	}

	public void setLineItems(List<GetGstr1AExpaItemEntity> lineItems) {
