...
@Data
@Entity
@Table(name = "TBL_GSTR9_TRANS_ADV_REC_AMD")
public class Gstr9TransAdvRecAmdEntity {
	...
	@Column(name = "ORG_GROSS_ADV_REC")
	private BigDecimal orgGrossAdvRec = BigDecimal.ZERO;
	...
	@Column(name = "REV_GROSS_ADV_REC")
	private BigDecimal revGrossAdvRec = BigDecimal.ZERO;
	...
	@Column(name = "NET_GROSS_ADV_REC")
	private BigDecimal netGrossAdvRec = BigDecimal.ZERO;
