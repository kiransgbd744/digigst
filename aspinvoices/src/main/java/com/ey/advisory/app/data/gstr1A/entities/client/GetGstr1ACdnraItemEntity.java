...
@Entity
@Table(name = "GETGSTR1A_CDNRA_ITEM")
public class GetGstr1ACdnraItemEntity {

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "GETGSTR1_CDNRA_ITEM_SEQ", allocationSize = 100)
	...
	private GetGstr1ACdnraHeaderEntity document;
	...
	public GetGstr1ACdnraHeaderEntity getDocument() {
		return document;
	}

	public void setDocument(GetGstr1ACdnraHeaderEntity document) {
