...
public class TransportDocDateValidation implements ValidationRule {
	...
	public List<ProcessingResult> isValid(int idx, Object obj, Object[] row,
		...
		if (date == null ) {
			...
			errors.add(new ProcessingResult(APP_VALIDATION, "ER10123",
					          "Invalid Transport Doc Date.", location));
			return errors;
		}
