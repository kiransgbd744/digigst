...
@Repository("Gstr1GetB2baGstnRepository")
@Transactional(propagation = Propagation.REQUIRED, readOnly = false)
public interface Gstr1GetB2baGstnRepository
		extends CrudRepository<GetGstr1B2baHeaderEntity, Long> {
	@Modifying
	@Query("UPDATE GetGstr1B2baHeaderEntity b SET b.isDelete = true,b.modifiedBy = 'SYSTEM'  , b.modifiedOn =:modifiedOn  WHERE"
	...
	@Query("SELECT COUNT(*) FROM GetGstr1B2baHeaderEntity "
