...
import com.ey.advisory.app.services.gstr1fileupload.Gstr1TxpdStructuralProcess;
...
@Service("TxpdFileArrivalHandler")
@Slf4j
public class TxpdFileArrivalHandler {
	...
	@Autowired
	@Qualifier("Gstr1TxpdStructuralProcess")
	private Gstr1TxpdStructuralProcess gstr1TxpdStructuralProcess;
