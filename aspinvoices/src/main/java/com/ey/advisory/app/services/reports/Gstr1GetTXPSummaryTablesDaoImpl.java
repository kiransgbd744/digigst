...
@Component("Gstr1GetTXPSummaryTablesDaoImpl")
@Slf4j
public class Gstr1GetTXPSummaryTablesDaoImpl implements Gstr1aGetDao {
	...
	private String creategstnTXPQueryString(String buildQuery) {
		...
		return "select ID,GSTIN,RETURN_PERIOD,SUPPLY_TYPE,STATE_NAME,"
				...
				+ "FROM GETGSTR1_TXP_HEADER HDR INNER JOIN "
				+ "GETGSTR1_TXP_ITEM ITM ON HDR.ID = ITM.HEADER_ID "
