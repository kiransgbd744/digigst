 ...
 */
@Entity
@Table(name = "GETANX1_SEZWOP_ITEM")
public class GetAnx1SezwopInvoicesItemEntity {
	...
	protected GetAnx1SezwopInvoicesHeaderEntity header;
	...
	public GetAnx1SezwopInvoicesHeaderEntity getHeader() {
		return header;
	}

	public void setHeader(GetAnx1SezwopInvoicesHeaderEntity header) {
		this.header = header;
	}
}