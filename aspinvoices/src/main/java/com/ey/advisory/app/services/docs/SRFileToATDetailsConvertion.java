...
@Service("SRFileToATDetailsConvertion")
@Slf4j
public class SRFileToATDetailsConvertion {
	...
	public List<Gstr1ARDetailsEntity> convertSRFileToOutwardTransDoc(
			List<Gstr1AsEnteredAREntity> businessProcessed,
			Gstr1FileStatusEntity fileStatusId) {

		List<Gstr1ARDetailsEntity> listOfAt = new ArrayList<>();

		Gstr1ARDetailsEntity at = null;
		for (Gstr1AsEnteredAREntity obj : businessProcessed) {
	...
	public List<Gstr1AsEnteredAREntity> convertSRFileToOutward(
			List<Gstr1AsEnteredAREntity> strucProcessedRecords,
			Gstr1FileStatusEntity updateFileStatus) {
		List<Gstr1AsEnteredAREntity> listAt = new ArrayList<>();
		...
		Gstr1AsEnteredAREntity at = null;
		for (Gstr1AsEnteredAREntity arr : strucProcessedRecords) {
			at = new Gstr1AsEnteredAREntity();
