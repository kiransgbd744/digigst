...
public class AccountingVocharDateValidationRule implements ValidationRule {
	...
	public List<ProcessingResult> isValid(int idx, Object obj, Object[] row,
		...
		if (date == null) {
			...
			errors.add(new ProcessingResult(APP_VALIDATION, "ER5862",
					"Invalid AccountingVoucherDate.", location));
			return errors;
		}
		return errors;
	}
