 ...
 *
 */
@Repository("Gstr1AGetSupEcomGstnRepository")
@Transactional(propagation = Propagation.REQUIRED, readOnly = false)
public interface Gstr1AGetSupEcomGstnRepository
		extends CrudRepository<GetGstr1ASupEcomHeaderEntity, Long> {
	@Modifying
	@Query("UPDATE GetGstr1ASupEcomHeaderEntity b SET b.isDelete = true,b.modifiedBy = 'SYSTEM'  , b.modifiedOn =:modifiedOn   WHERE"
	...
	@Query("SELECT COUNT(*) FROM GetGstr1ASupEcomHeaderEntity "
