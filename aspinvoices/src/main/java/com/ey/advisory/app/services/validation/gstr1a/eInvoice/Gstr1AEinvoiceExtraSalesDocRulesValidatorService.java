...
@Service("Gstr1AEinvoiceExtraSalesDocRulesValidatorService")
public class Gstr1AEinvoiceExtraSalesDocRulesValidatorService implements 
			DocRulesValidatorService<Gstr1AOutwardTransDocument, String> {

	@Autowired
	@Qualifier("Gstr1AEinvoiceDefaultExtraSalesDocListRulesValidator")
	private DocListRulesValidator<Gstr1AOutwardTransDocument, String> chain;
	
	@Override
	public DocRulesValidationResult<String> validate(
			List<Gstr1AOutwardTransDocument> documents, ProcessingContext context) {
