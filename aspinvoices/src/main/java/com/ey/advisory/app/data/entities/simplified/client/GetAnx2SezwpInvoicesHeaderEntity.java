 ...
 */
@Entity
@Table(name = "GETANX2_SEZWP_HEADER")
public class GetAnx2SezwpInvoicesHeaderEntity {
	...
	protected List<GetAnx2SezwpInvoicesItemEntity> lineItems = new ArrayList<>();

	/*
	 * @ManyToOne
	 * 
	 * @JoinColumn(name = "BATCH_ID", referencedColumnName = "ID", nullable =
	 * false) private GetGstr2aBatchEntity sezwpBatchIdAnx2;
	 */

	@Column(name = "BATCH_ID")
	private Long sezwpBatchIdAnx2;
	...
	public List<GetAnx2SezwpInvoicesItemEntity> getLineItems() {
		return lineItems;
	}

	public void setLineItems(List<GetAnx2SezwpInvoicesItemEntity> lineItems) {
		this.lineItems = lineItems;
	}

	/*
	 * public GetGstr2aBatchEntity getSezwpBatchIdAnx2() { return
	 * sezwpBatchIdAnx2; }
	 * 
	 * public void setSezwpBatchIdAnx2(GetGstr2aBatchEntity sezwpBatchIdAnx2) {
	 * this.sezwpBatchIdAnx2 = sezwpBatchIdAnx2; }
	 */
	...
	public Long getSezwpBatchIdAnx2() {
		return sezwpBatchIdAnx2;
	}

	public void setSezwpBatchIdAnx2(Long sezwpBatchIdAnx2) {
		this.sezwpBatchIdAnx2 = sezwpBatchIdAnx2;
	}
