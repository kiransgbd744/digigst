...
@Component("gstr1NilRatedSupDataParserImpl")
@Slf4j
public class GSTR1NilRatedSupDataParserImpl
		implements GSTR1NilRatedSupDataParser {

	@Override
	public List<GetGstr1NilRatedEntity> gstr1NilRatedSupDataParser(
			Gstr1GetInvoicesReqDto dto, String apiResp) {

		List<GetGstr1NilRatedEntity> entities = new ArrayList<>();
		...
		//try {
			...
			nilInvoices.forEach(nilInvoice -> {
				GetGstr1NilRatedEntity gstr1NilDetailsEntity = new GetGstr1NilRatedEntity();
				/**
				 * Input data
				 */
