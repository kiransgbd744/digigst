...
import com.ey.advisory.app.data.entities.simplified.client.Anx1ImpsProcEntity;

@Repository("Anx1ImpsProcRepository")
@Transactional(propagation = Propagation.REQUIRED, readOnly = false)
public interface Anx1ImpsProcRepository extends CrudRepository<Anx1ImpsProcEntity, Long> {

	@Modifying
	@Query("UPDATE Anx1ImpsProcEntity doc SET doc.gstnBatchId=:gstnBatchId,"
	...
	@Modifying
	@Query("UPDATE Anx1ImpsProcEntity doc SET "
