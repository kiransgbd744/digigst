...
import com.google.common.base.Strings;
	...
	@Component("Gstr1AAspSezSectionReportDaoImpl")
	public class Gstr1AAspSezSectionReportDaoImpl
			implements Gstr1AReviewSummaryReportsDao {

		private static final Logger LOGGER = LoggerFactory
				.getLogger(Gstr1AAspSezSectionReportDaoImpl.class);
		...
		private String createApiProcessedQueryString(String buildHeader) {
			...
			return "SELECT TRIM(', ' FROM IFNULL(HDR.ERROR_CODES,'') ||','|| "
					...
					+ "AND HDR.RETURN_TYPE='GSTR1A' AND HDR.TAX_DOC_TYPE IN ('B2B') AND HDR.SUPPLY_TYPE = 'SEZWP' " 
					+ buildHeader
