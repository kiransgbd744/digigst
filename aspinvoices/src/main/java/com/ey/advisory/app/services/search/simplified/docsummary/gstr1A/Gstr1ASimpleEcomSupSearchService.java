 ...
 *
 */
@Service("Gstr1ASimpleEcomSupSearchService")
public class Gstr1ASimpleEcomSupSearchService implements SearchService {

	@Autowired
	@Qualifier("SimpleGstr1AEcomSupSummarySectionFetcher")
	SimpleGstr1AEcomSupSummarySectionFetcher fetcher;
	...
	public <R> SearchResult<R> find(SearchCriteria criteria,
		...
		if (eySummaries.containsKey(GSTConstants.GSTR1_15AI)) {
			...
			tbl15AmdOneSectionSummary
					.setEySummary(defaultDigiGSTValue(GSTConstants.GSTR1_15AI));
		}
