 ...
 * 
 */
public class Ret1And1AUserInputsErrorDto {
	...
	private String salesOrganiastion;
	...
	public String getSalesOrganiastion() {
		return salesOrganiastion;
	}

	public void setSalesOrganiastion(String salesOrganiastion) {
		this.salesOrganiastion = salesOrganiastion;
	}
	...
	public String toString() {
		return "Ret1And1AUserInputsErrorDto [returnType=" + returnType
				+ ", gstin=" + gstin + ", returnPeriod=" + returnPeriod
				+ ", returnTable=" + returnTable + ", value=" + value
				...
				+ ", salesOrganiastion=" + salesOrganiastion
				...
				+ aspErrorDescription + ", aspInformationId=" + aspInformationId
