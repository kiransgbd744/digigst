...
import com.google.common.base.Strings;
	...
	@Component("Gstr1AAspEXPSectionReportDaoImpl")
	public class Gstr1AAspEXPSectionReportDaoImpl implements Gstr1AReviewSummaryReportsDao {

		private static final Logger LOGGER = LoggerFactory.getLogger(Gstr1AAspEXPSectionReportDaoImpl.class);
		...
		private String createApiProcessedQueryString(String buildHeader) {
			...
			return "SELECT TRIM(', ' FROM IFNULL(HDR.ERROR_CODES,'') ||','|| "
					...
					+ "AND HDR.RETURN_TYPE='GSTR1A' AND HDR.TAX_DOC_TYPE IN ('EXPORTS') " + buildHeader
