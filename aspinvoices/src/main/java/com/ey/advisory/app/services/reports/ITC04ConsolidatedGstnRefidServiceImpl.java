...
@Service("ITC04ConsolidatedGstnRefidServiceImpl")
public class ITC04ConsolidatedGstnRefidServiceImpl {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(ITC04ConsolidatedGstnRefidServiceImpl.class);

	@Autowired
	CommonUtility commonUtility;

	@Autowired
	@Qualifier("ITC04ConsolidatedGstnRefidReportDaoImpl")
	private ITC04ConsolidatedGstnRefidReportDaoImpl iTC04ConsolidatedGstnRefidReportDaoImpl;

	public Workbook findrefid(Gstr6SummaryRequestDto setDataSecurity,
			PageRequest pageReq) {
		...
		responseFromView = iTC04ConsolidatedGstnRefidReportDaoImpl
				.getRefidReport(request);
