 ...
 */
@Slf4j
@Component("Gstr1ASPAdvRecSavableTransactionalDaoImpl")
public class Gstr1ASPAdvRecSavableTransactionalDaoImpl
		implements Gstr1AdvRecSavableDao {
	...
	public List<Object> getGstr1AdvRecSavableReports(SearchCriteria criteria) {
		...
		if (APIConstants.GSTR1A.equalsIgnoreCase(request.getReturnType())) {
			queryStr = createAdvRecSavableTransactionalQueryStringForGstr1a(
					buildQuery.toString());

		} else {
			queryStr = createAdvRecSavableTransactionalQueryString(
					buildQuery.toString());	
		}
	...
	private String createAdvRecSavableTransactionalQueryString(
		...
		return "SELECT '' AS ERROR_CODE_ASP, '' AS ERROR_DESCRIPTION_ASP, "
				...
				+ "  AND HDR.IS_DELETE=FALSE AND HDR.TAX_DOC_TYPE IN ('AT') ";

	}
	private String createAdvRecSavableTransactionalQueryStringForGstr1a(
			String buildQueryheader) {
