...
@Service("Anx2InwardRawFileArrivalHandler")
@Slf4j
public class Anx2InwardRawFileArrivalHandler {
	...
	@Autowired
	@Qualifier("Anx2RawFileToInwardTrans115DocConvertion")
	private Anx2RawFileToInwardTrans115DocConvertion anx2RawFileToInwardTransDocConvertion;
