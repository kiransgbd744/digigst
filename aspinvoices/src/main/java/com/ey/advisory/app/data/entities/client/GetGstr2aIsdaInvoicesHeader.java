...
@Data
@MappedSuperclass
public class GetGstr2aIsdaInvoicesHeader {
	...
	protected LocalDate originalDocumentDate;
	...
	@Column(name = "ORG_ISD_DOC_TYPE")
	protected String orgIsdDocumentType;
	
	@Column(name = "BATCH_ID")
	private Long isdaBatchIdGstr2a;
