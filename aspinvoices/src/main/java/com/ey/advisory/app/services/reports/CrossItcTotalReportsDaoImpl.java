...
@Component("CrossItcTotalReportsDaoImpl")
@Slf4j
public class CrossItcTotalReportsDaoImpl implements Gstr1VerticalReportsDao {
	...
	private String createVerticalTotalQueryString(String buildQuery) {
		...
		if ((GSTConstants.CROSS_ITC).equalsIgnoreCase(fileType)) {
			...
			builder.append("FROM CROSS_ITC_AS_ENTERED HI ");
