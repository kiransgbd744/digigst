 ...
 *
 */
public class Gstr7TdsDeducteeGstinValidationRule implements ValidationRule {
	...
	public List<ProcessingResult> isValid(int idx,Object obj, Object[] row,
		...
		errorLocations.add(GSTConstants.TDS_DEDUCTEE_GSTIN);
		TransDocProcessingResultLoc location = new TransDocProcessingResultLoc(
				null, errorLocations.toArray());
		
		errors.add(new ProcessingResult(APP_VALIDATION, "ER2011",
				"TDS Deductee GSTIN cannot be left balnk", location));
		return errors;
		}
		...
		if (matcher.matches() || matcher1.matches() 
				...
				errors.add(new ProcessingResult(APP_VALIDATION, "ER2012",
						"Invalid TDS Deductee GSTIN.", location));
				return errors;
			}
			return errors;
	}
