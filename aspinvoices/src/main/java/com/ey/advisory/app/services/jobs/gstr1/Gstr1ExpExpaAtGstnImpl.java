...
@Slf4j
@Component("gstr1ExpExpaAtGstnImpl")
public class Gstr1ExpExpaAtGstnImpl implements Gstr1InvoicesAtGstn {

	@Autowired
	@Qualifier("gstr1ExpExpaDataAtGstnImpl")
	Gstr1ExpExpaDataAtGstn getGstr1ExpExpaDataAtGstn;
	...
	public Long findInvFromGstn(Gstr1GetInvoicesReqDto dto,
		...
		try {
			...
			reqId = getGstr1ExpExpaDataAtGstn.findExpDataAtGstn(dto,
					groupCode, type, json);
