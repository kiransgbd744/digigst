 ...
 */
@Entity
@Table(name = "GETGSTR6_CDNA_HEADER")
public class GetGstr6CdnaHeaderEntity {

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "GETGSTR6_CDNA_HEADER_SEQ", allocationSize = 100)
	...
	protected List<GetGstr6CdnaItemEntity> lineItems = new ArrayList<>();
	...
	public List<GetGstr6CdnaItemEntity> getLineItems() {
		return lineItems;
	}

	public void setLineItems(List<GetGstr6CdnaItemEntity> lineItems) {
