 ...
 *
 */
public class Anx1SezwpAndSezwopData {
	...
	@Expose
	@SerializedName("docs")
	private List<Anx1SezwpAndSezwopDocumentData> docs;
	...
	public List<Anx1SezwpAndSezwopDocumentData> getDocs() {
		return docs;
	}

	public void setDocs(List<Anx1SezwpAndSezwopDocumentData> docs) {
		this.docs = docs;
	}
