...
@Component("Anx1ApiProcessedReportsDaoImpl")
public class Anx1ApiProcessedReportsDaoImpl
		implements Anx1ApiProcessedReportsDao {
	...
	@Override
	public List<Anx1ApiProcessedRecordsDto> getApiProcessedReports(
	...
	private Anx1ApiProcessedRecordsDto convertProcessed(Object[] arr) {
		Anx1ApiProcessedRecordsDto obj = new Anx1ApiProcessedRecordsDto();
	...
	private String createApiProcessedQueryString(String buildQuery) {
		return "SELECT HDR.ID,HDR.USER_ID,"
				...
				+ "ITM.ITM_NO = ERRI.ITM_NO WHERE HDR.IS_ERROR = FALSE "
