 ...
 *
 */
@Component("Gstr1VerticalReqResponse")
public class Gstr1VerticalReqResponse {
	...
	Gstr1AspDocVerticalSummaryService aspDocVertical;
	
	private static final Logger LOGGER = LoggerFactory
			.getLogger(Gstr1VerticalReqResponse.class);
