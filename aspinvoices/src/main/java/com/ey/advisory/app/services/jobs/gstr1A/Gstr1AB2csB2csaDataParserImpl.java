...
import com.ey.advisory.app.data.gstr1A.entities.client.GetGstr1AB2csItemEntity;
import com.ey.advisory.app.data.gstr1A.entities.client.GetGstr1AB2csaHeaderEntity;
import com.ey.advisory.app.data.gstr1A.entities.client.GetGstr1AB2csaItemEntity;
 ...
 *
 */
@Component("gstr1AB2csB2csaDataParserImpl")
@Slf4j
public class Gstr1AB2csB2csaDataParserImpl implements Gstr1AB2csB2csaDataParser {
	...
	public List<GetGstr1AB2csHeaderEntity> parseB2csData(
		...
		List<GetGstr1AB2csHeaderEntity> headerList = new ArrayList<>();
		...
		for (B2CSInvoices eachInv : baseEntity) {
			...
			List<GetGstr1AB2csItemEntity> lineItems = new ArrayList<>();
			// New Item Entity
			GetGstr1AB2csItemEntity item = new GetGstr1AB2csItemEntity();
			/**
			...
			// New Header Entity
			GetGstr1AB2csHeaderEntity header = new GetGstr1AB2csHeaderEntity();
			/**
			 * Input data
			 */
	...
	public List<GetGstr1AB2csaHeaderEntity> parseB2csaData(
		...
		Gson gson = GsonUtil.newSAPGsonInstance();
		JsonArray respObject = null;
		List<GetGstr1AB2csaHeaderEntity> headerList = new ArrayList<>();
		...
		for (B2CSInvoices eachInv : baseEntity) {
			...
			List<GetGstr1AB2csaItemEntity> lineItems = new ArrayList<>();
			if (eachInv.getLineItems() != null) {
				for (B2CSALineItem eachInvData : eachInv.getLineItems()) {

					// New Item Entity
					GetGstr1AB2csaItemEntity item = new GetGstr1AB2csaItemEntity();
					/**
			...
			// New Header Entity
			GetGstr1AB2csaHeaderEntity header = new GetGstr1AB2csaHeaderEntity();
			/**
			 * Input data
			 */
			header.setGstin(dto.getGstin());
