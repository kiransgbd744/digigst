...
public class Anx1ApiTotalRecordsDto {
	...
	public String toString() {
		return "Anx1ApiTotalRecordsDto [userID=" + userID + ", fileName="
				+ fileName + ", aspErrorCode=" + aspErrorCode
				+ ", aspErrorDesc=" + aspErrorDesc + ", returnType="
				+ returnType + ", dataCategory=" + dataCategory
				+ ", tableNumber=" + tableNumber + ", aspInformationID="
				+ aspInformationID + ", aspInformationDesc="
				+ aspInformationDesc + ", sourceFileName=" + sourceFileName
