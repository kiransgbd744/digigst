...
public class DeliveryChallanDateValidationRule implements ValidationRule {
	...
	public List<ProcessingResult> isValid(int idx, Object obj, Object[] row,
		...
		if (date == null) {
			...
			errors.add(new ProcessingResult(APP_VALIDATION, "ER5812",
					"Invalid DeliveryChallanDate.", location));
			return errors;
		}
		return errors;
	}
