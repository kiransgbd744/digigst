...
@Slf4j
@Component("ITC04DataStatusProcessedReportsServiceImpl")
public class ITC04DataStatusProcessedReportsServiceImpl
	...
	@Autowired
	@Qualifier("ITC04DataStatusReportsDaoImpl")
	private ITC04DataStatusReportsDaoImpl itc04ProcessedReportsDao;
	...
	public Workbook findApiProcesseRec(SearchCriteria criteria,
		...
		if (responseFromView != null && responseFromView.size() > 0) {
			String[] invoiceHeaders = commonUtility
					.getProp("itco4.dataStatus.process.report").split(",");
