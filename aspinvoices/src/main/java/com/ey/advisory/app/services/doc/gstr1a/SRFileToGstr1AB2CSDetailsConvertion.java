 ...
 *
 */
@Service("SRFileToGstr1AB2CSDetailsConvertion")
@Slf4j
public class SRFileToGstr1AB2CSDetailsConvertion {
	...
	public List<Gstr1AB2csDetailsEntity> convertSRFileToOutwardTransDoc(
			List<Gstr1AAsEnteredB2csEntity> businessProcessed,
			Gstr1FileStatusEntity fileStatusId) {

		List<Gstr1AB2csDetailsEntity> listOfB2cs = new ArrayList<>();

		Gstr1AB2csDetailsEntity b2cs = null;
		for (Gstr1AAsEnteredB2csEntity obj : businessProcessed) {

			b2cs = new Gstr1AB2csDetailsEntity();
	...
	public List<Gstr1AAsEnteredB2csEntity> convertSRFileToOutward(
			List<Gstr1AAsEnteredB2csEntity> strucProcessedRecords,
			Gstr1FileStatusEntity updateFileStatus) {
		List<Gstr1AAsEnteredB2csEntity> listB2cs = new ArrayList<>();
		...
		Gstr1AAsEnteredB2csEntity b2cs = null;
		for (Gstr1AAsEnteredB2csEntity arr : strucProcessedRecords) {
			b2cs = new Gstr1AAsEnteredB2csEntity();
