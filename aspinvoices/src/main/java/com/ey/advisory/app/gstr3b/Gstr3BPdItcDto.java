...
public class Gstr3BPdItcDto {
	...
	@Expose
	@SerializedName("i_adjNegative2i")
	private BigDecimal i_adjNegative2i;
	
	@Expose
	@SerializedName("c_adjNegative2i")
	private BigDecimal c_adjNegative2i;
	
	@Expose
	@SerializedName("s_adjNegative2i")
	private BigDecimal s_adjNegative2i;
	
	@Expose
	@SerializedName("cs_adjNegative2i")
	private BigDecimal cs_adjNegative2i;
	 
	@Expose
	@SerializedName("i_adjNegative8A")
	private BigDecimal i_adjNegative8A;
	
	@Expose
	@SerializedName("c_adjNegative8A")
	private BigDecimal c_adjNegative8A;
	
	@Expose
	@SerializedName("s_adjNegative8A")
	private BigDecimal s_adjNegative8A;
	
	@Expose
	@SerializedName("cs_adjNegative8A")
