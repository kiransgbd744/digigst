...
@Setter
@ToString
@Table(name = "PAYLOAD_METADATA_OUTWARD")
public class OutwardPayloadEntity {

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "PAYLOAD_METADATA_OUTWARD_SEQ", allocationSize = 100)
