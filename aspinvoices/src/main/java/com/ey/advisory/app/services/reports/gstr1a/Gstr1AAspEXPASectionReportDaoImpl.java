...
import com.google.common.base.Strings;
	...
	@Component("Gstr1AAspEXPASectionReportDaoImpl")
	public class Gstr1AAspEXPASectionReportDaoImpl implements Gstr1AReviewSummaryReportsDao {

		private static final Logger LOGGER = LoggerFactory.getLogger(Gstr1AAspEXPASectionReportDaoImpl.class);
		...
		private String createApiProcessedQueryString(String buildHeader) {
			...
			return "SELECT TRIM(', ' FROM IFNULL(HDR.ERROR_CODES,'') ||','|| "
					...
					+ "AND HDR.RETURN_TYPE='GSTR1A' AND HDR.TAX_DOC_TYPE IN ('EXPORTS-A') " + buildHeader
