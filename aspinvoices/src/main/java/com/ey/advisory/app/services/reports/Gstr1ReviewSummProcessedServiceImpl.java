 ...
 *
 */
@Service("Gstr1ReviewSummProcessedServiceImpl")
public class Gstr1ReviewSummProcessedServiceImpl
		implements Gstr1ReviewSummReportsService {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(Gstr1ReviewSummProcessedServiceImpl.class);

	@Autowired
	CommonUtility commonUtility;

	@Autowired
	@Qualifier("Gstr1ReviewSummaryProcessedReportDaoImpl")
