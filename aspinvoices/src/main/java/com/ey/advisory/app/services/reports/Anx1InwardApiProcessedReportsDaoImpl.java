...
@Component("Anx1InwardApiProcessedReportsDaoImpl")
public class Anx1InwardApiProcessedReportsDaoImpl
		implements Anx1InwardApiProcessedReportsDao {
	...
	@Override
	public List<Anx1InwardApiProcessedRecordsDto> getInwardApiProcessedReports(
	...
	private Anx1InwardApiProcessedRecordsDto convertApiInwardProcessedRecords(
			Object[] arr) {
		Anx1InwardApiProcessedRecordsDto obj = new Anx1InwardApiProcessedRecordsDto();
	...
	private String createInwardApiProcessedRecQueryString(String buildQuery) {
		return "SELECT HDR.ID, HDR.USER_ID,"
				...
				+ "HDR.TABLE_SECTION AS TABLE_NUMBER,HDR.SOURCE_FILENAME,"
