...
import com.ey.advisory.core.search.SearchCriteria;
	...
	@Service("AspAdvAdjAmenSecServiceImpl")
	public class AspAdvAdjAmenSecServiceImpl
			implements Gstr1ASPAdvAdjSavableService {

		private static final Logger LOGGER = LoggerFactory
				.getLogger(AspAdvAdjAmenSecServiceImpl.class);

		@Autowired
		CommonUtility commonUtility;

		@Autowired
		@Qualifier("AspAdvAdjAmenSecTotalDaoImpl")
		...
		@Autowired
		@Qualifier("AspAdvAdjAmensecSummaryLevelDaoImpl")
