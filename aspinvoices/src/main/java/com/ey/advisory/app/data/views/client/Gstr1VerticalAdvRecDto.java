 ...
 *
 */
public class Gstr1VerticalAdvRecDto {
	...
	private String orgGrossAdvanceReceived;
	private String newPOS;
	private String newRate;
	private String newGrossAdvanceReceived;
	...
	/**
	 * @return the orgGrossAdvanceReceived
	 */
	public String getOrgGrossAdvanceReceived() {
		return orgGrossAdvanceReceived;
	}

	/**
	 * @param orgGrossAdvanceReceived
	 *            the orgGrossAdvanceReceived to set
	 */
	public void setOrgGrossAdvanceReceived(String orgGrossAdvanceReceived) {
	...
	/**
	 * @return the newGrossAdvanceReceived
	 */
	public String getNewGrossAdvanceReceived() {
		return newGrossAdvanceReceived;
	}

	/**
	 * @param newGrossAdvanceReceived
	 *            the newGrossAdvanceReceived to set
	 */
	public void setNewGrossAdvanceReceived(String newGrossAdvanceReceived) {
	...
	public String toString() {
		return "Gstr1VerticalAdvRecDto [supplierGSTIN=" + supplierGSTIN
				+ ", returnPeriod=" + returnPeriod + ", transactionType="
				+ transactionType + ", month=" + month + ", orgPos=" + orgPos
				+ ", orgRate=" + orgRate + ", orgGrossAdvanceReceived="
