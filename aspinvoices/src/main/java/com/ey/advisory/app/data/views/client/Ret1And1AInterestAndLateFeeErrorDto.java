 ...
 * 
 */
public class Ret1And1AInterestAndLateFeeErrorDto {
	...
	public String toString() {
		return "Ret1And1AInterestAndLateFeeErrorDto [returnType=" + returnType
				+ ", gstin=" + gstin + ", returnPeriod=" + returnPeriod
				+ ", returnTable=" + returnTable + ", interestIGST="
				+ interestIGST + ", interestCGST=" + interestCGST
				+ ", interestSGST=" + interestSGST + ", interestCess="
				+ interestCess + ", lateFeeCGST=" + lateFeeCGST
				+ ", lateFeeSGST=" + lateFeeSGST + ", userDefined1="
