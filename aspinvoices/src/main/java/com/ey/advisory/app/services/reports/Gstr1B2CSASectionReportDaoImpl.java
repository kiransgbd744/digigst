...
import com.google.common.base.Strings;
	...
	@Component("Gstr1B2CSASectionReportDaoImpl")
	public class Gstr1B2CSASectionReportDaoImpl
			implements Gstr1ReviewSummaryReportsDao {

		private static final Logger LOGGER = LoggerFactory
				.getLogger(Gstr1B2CSASectionReportDaoImpl.class);
		...
		private DataStatusEinvoiceDto convertProcessed(Object[] arr) {
			...
			obj.setuQC(
					arr[310] == null ? arr[86] != null ? arr[86].toString() : null
							: arr[310].toString());
			obj.setQuantity(
					arr[311] == null ? arr[87] != null ? arr[87].toString() : null
							: arr[311].toString());
		...
		private String createApiProcessedQueryString(String buildHeader ) {
			...
			return "SELECT '' AS ERROR_CODE_ASP,"
					...
					+ "EINV.SIGNED_INV AS SIGNED_INVOICE,"
					...
					+ "AND HDR.IS_DELETE=FALSE AND HDR.RETURN_TYPE='GSTR1' "
					+ "AND HDR.TAX_DOC_TYPE IN ('B2CSA') "
					+ buildHeader
