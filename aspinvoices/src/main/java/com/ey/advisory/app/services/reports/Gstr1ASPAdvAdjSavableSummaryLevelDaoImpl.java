...
@Component("Gstr1ASPAdvAdjSavableSummaryLevelDaoImpl")
public class Gstr1ASPAdvAdjSavableSummaryLevelDaoImpl
		implements Gstr1ASPAdvAdjSavableSummaryLevelDao {
	private static final Logger LOGGER = LoggerFactory
			.getLogger(Gstr1ASPAdvAdjSavableSummaryLevelDaoImpl.class);
