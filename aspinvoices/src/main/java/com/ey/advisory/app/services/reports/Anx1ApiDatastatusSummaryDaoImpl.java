...
import com.ey.advisory.common.GenUtil;
	...
	@Component("Anx1ApiDatastatusSummaryDaoImpl")
	public class Anx1ApiDatastatusSummaryDaoImpl
			implements Anx1OutwardApiDatastatusSummaryDao {
		
		@PersistenceContext(unitName = "clientDataUnit")
		private EntityManager entityManager;

		@Override
		public List<Anx1ApiDataStatusSummaryDto> getOutwardDataStatusSummary(
			...
			List<Anx1ApiDataStatusSummaryDto> retList = list.parallelStream()
					.map(o -> convertApiDataStatusSummary(o))
					.collect(Collectors.toCollection(ArrayList::new));
			return retList;
		}

		private Anx1ApiDataStatusSummaryDto convertApiDataStatusSummary(
				Object[] arr) {
			Anx1ApiDataStatusSummaryDto obj = new Anx1ApiDataStatusSummaryDto();
		...
		private String createDSSQueryString(String buildQuery) {
			...
			return  "SELECT HDR.RECEIVED_DATE AS DATE,"
					+ "HDR.SUPPLIER_GSTIN,"
