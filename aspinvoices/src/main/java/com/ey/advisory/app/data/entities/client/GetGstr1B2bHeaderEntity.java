 ...
 */
@Entity
@Table(name = "GETGSTR1_B2B_HEADER")
public class GetGstr1B2bHeaderEntity {

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "GETGSTR1_B2B_HEADER_SEQ", allocationSize = 100)
	...
	protected List<GetGstr1B2bItemEntity> lineItems = new ArrayList<>();
	...
	public List<GetGstr1B2bItemEntity> getLineItems() {
		return lineItems;
	}

	public void setLineItems(List<GetGstr1B2bItemEntity> lineItems) {
