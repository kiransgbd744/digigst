...
import com.ey.advisory.core.search.SearchCriteria;
	...
	@Service("AspB2CLASectionReportReportServiceImpl")
	public class AspB2CLASectionReportReportServiceImpl
			implements Gstr1ReviewSummReportsService {

		private static final Logger LOGGER = LoggerFactory
				.getLogger(AspB2CLASectionReportReportServiceImpl.class);

		@Autowired
		CommonUtility commonUtility;

		@Autowired
		@Qualifier("AspB2CLASectionReportDaoImpl")
