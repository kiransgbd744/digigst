...
import com.ey.advisory.app.services.gstr1afileupload.Gstr1ANilNonExtStructuralProcess;
...
@Service("Gstr1ANilFileArrivalHandler")
@Slf4j
public class Gstr1ANilFileArrivalHandler {
	...
	@Autowired
	@Qualifier("Gstr1ANilNonExtStructuralProcess")
	private Gstr1ANilNonExtStructuralProcess gstr1NilNonExtStructuralProcess;

	@Autowired
	@Qualifier("NilHeaderCheckService")
