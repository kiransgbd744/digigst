 ...
 *
 */
@Repository("Gstr9TransB2CSB2CSARepository")
@Transactional(propagation = Propagation.REQUIRED, readOnly = false)
public interface Gstr9TransB2CSB2CSARepository
		extends JpaRepository<Gstr9TransB2CSB2CSAEntity, Long> {

	@Query("SELECT distinct chunkId FROM Gstr9TransB2CSB2CSAEntity WHERE "
	...
	public List<Gstr9TransB2CSB2CSAEntity> findBySgstinAndGstr9FyAndIsDeleteAndChunkId(
