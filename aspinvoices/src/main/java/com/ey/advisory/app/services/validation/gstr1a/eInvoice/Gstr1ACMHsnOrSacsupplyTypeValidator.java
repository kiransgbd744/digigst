 ...
 *
 */
@Component("Gstr1ACMHsnOrSacsupplyTypeValidator")
public class Gstr1ACMHsnOrSacsupplyTypeValidator
		implements DocRulesValidator<Gstr1AOutwardTransDocument> {

	private static final List<String> SUPPLYTYPE_IMPORTS = ImmutableList.of(
			GSTConstants.SEZWP, GSTConstants.SEZWOP, GSTConstants.DXP,
			...
			if (document.getSupplyType() != null
				...
				if (SUPPLYTYPE_IMPORTS.contains(
					...
					if (item.getHsnSac() == null
						...
						errors.add(
								new ProcessingResult(APP_VALIDATION, "ER0070",
										"HSN or SAC madatory 6 digits required.",
										location));
