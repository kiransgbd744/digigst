 ...
 *
 */
@Component("Gstr1GstnB2BErrorDaoImpl")
public class Gstr1GstnB2BErrorDaoImpl implements Gstr1GstnErrorDao {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(Gstr1GstnB2BErrorDaoImpl.class);
	...
	public List<Object> getGstr1GstnErrorReport(SearchCriteria criteria) {
		...
		{
			queryStr = creategstnGstr1AB2BErrorQueryString(buildQuery.toString());
		}
		else
		{
			queryStr = creategstnB2BErrorQueryString(buildQuery.toString());
		}
	...
	private Gstr1GstnB2BErrorDto convertgstnB2BError(Object[] arr) {
		...
		obj.setInvoiceNumber(arr[2] != null ? arr[2].toString() : null);
		obj.setInvoiceDate(arr[3] != null ? arr[3].toString() : null);
		obj.setDifferentialPercentage(
				arr[4] != null ? arr[4].toString() : null);
		obj.setTaxableValue(arr[5] != null ? arr[5].toString() : null);
		obj.setRate(arr[6] != null ? arr[6].toString() : null);
		obj.setIntegratedAmount(arr[7] != null ? arr[7].toString() : null);
		obj.setCentralTaxAmount(arr[8] != null ? arr[8].toString() : null);
		obj.setStateTaxAmount(arr[9] != null ? arr[9].toString() : null);
		obj.setCessAmount(arr[10] != null ? arr[10].toString() : null);
		obj.setInvoiceValue(arr[11] != null ? arr[11].toString() : null);
		obj.setInvoiceType(arr[12] != null ? arr[12].toString() : null);
		obj.setPlaceofSupply(arr[13] != null ? arr[13].toString() : null);
		obj.setReverseChargeFlag(arr[14] != null ? arr[14].toString() : null);
		obj.setEcommerceGSTIN(arr[15] != null ? arr[15].toString() : null);
		obj.setErrorCode(arr[16] != null ? arr[16].toString() : null);
		obj.setGstnErrorMessage(arr[17] != null ? arr[17].toString() : null);
	...
	private String creategstnB2BErrorQueryString(String buildQuery) {
		...
		return "SELECT HDR.ORIGINAL_DOC_PERIOD,HDR.CUST_GSTIN AS GSTIN,HDR.DOC_NUM,"
				+ "HDR.DOC_DATE,HDR.DIFF_PERCENT,ITM.TAXABLE_VALUE,"
				+ "ITM.TAX_RATE,ITM.IGST_AMT,ITM.CGST_AMT,ITM.SGST_AMT,"
				+ "(ITM.CESS_AMT_SPECIFIC+ITM.CESS_AMT_ADVALOREM) CESS_AMT,"
				+ "ITM.LINE_ITEM_AMT,HDR.DOC_TYPE,HDR.POS,HDR.REVERSE_CHARGE,HDR.ECOM_GSTIN,"
				...
				+ "LEFT OUTER JOIN TF_OUTWARD_HEADER_GSTIN_ASP_ERROR_INFO () ERRH "
				...
				+ "AND HDR.GSTN_ERROR=TRUE AND HDR.TAX_DOC_TYPE='B2B' "
				+ "AND HDR.IS_DELETE=FALSE "
				+ "AND GSTN_SAVE_STATUS='PE' " + buildQuery;
	}
	
	
	private String creategstnGstr1AB2BErrorQueryString(String buildQuery) {
		...
		return "SELECT HDR.ORIGINAL_DOC_PERIOD,HDR.CUST_GSTIN AS GSTIN,HDR.DOC_NUM,"
				...
				+ "LEFT OUTER JOIN TF_OUTWARD_HEADER_GSTIN_ASP_ERROR_INFO_1A () ERRH "
				+ "ON HDR.ID = ERRH.DOC_HEADER_ID INNER JOIN ANX_OUTWARD_DOC_ITEM_1A ITM "
				+ "ON HDR.ID = ITM.DOC_HEADER_ID LEFT OUTER JOIN "
