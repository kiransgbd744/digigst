...
@Setter
@Getter
public class Gstr3BGstinsDto implements Serializable {
	 ...
	 * @param intraState
	 */
	public Gstr3BGstinsDto(String sectionName, String subSectionName,
	...
	public String toString() {
		return "Gstr3BGstinsDto [sectionName=" + sectionName
				+ ", subSectionName=" + subSectionName + ", taxableVal="
				+ taxableVal + ", igst=" + igst + ", cgst=" + cgst + ", sgst="
				+ sgst + ", cess=" + cess + ", pos=" + pos + ", interState="
