...
import static com.ey.advisory.common.GSTConstants.CIF_VALUE;
...
public class CIFValidator implements DocRulesValidator<InwardTransDocument> {
	...
	public List<ProcessingResult> validate(InwardTransDocument document,
		...
		if((!ORGDOCNUM_REQUIRING_IMPORTS.contains(document.getDocType())) 
			...
			/*if(document.getCifValue().compareTo(BigDecimal.ZERO) < 0){
				

		errorLocations.add(CIF_VALUE);
