 ...
 *
 */
public class TcsTdsSuRetByRegBuyersValidation implements ValidationRule {
	...
	public List<ProcessingResult> isValid(Object obj, Object[] row,
		...
		if (!isDecimal(obj.toString().trim())) {
			...
			errorLocations.add(GSTConstants.SUPPLIES_RETURNED);
			TransDocProcessingResultLoc location = new TransDocProcessingResultLoc(
					null, errorLocations.toArray());
			errors.add(new ProcessingResult(APP_VALIDATION, "ER1343",
					"Invalid SuppliesReturned", location));
			return errors;
		}
