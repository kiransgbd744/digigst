...
import com.ey.advisory.app.data.views.client.Gstr1GstnCDNURErrorDto;
...
@Component("Gstr1GstnCDNURErrorDaoImpl")
public class Gstr1GstnCDNURErrorDaoImpl implements Gstr1GstnErrorDao {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(Gstr1GstnCDNURErrorDaoImpl.class);
...
String queryStr = null;
		...
		{
			queryStr = creategstnGstr1ACDNURErrorQueryString(buildQuery.toString());
		}
		else{

		queryStr = creategstnCDNURErrorQueryString(buildQuery.toString());
		...
		return list.parallelStream().map(o -> convertgstnCDNURError(o))
				.collect(Collectors.toCollection(ArrayList::new));
	}

	private Gstr1GstnCDNURErrorDto convertgstnCDNURError(Object[] arr) {
		Gstr1GstnCDNURErrorDto obj = new Gstr1GstnCDNURErrorDto();

		obj.setType(arr[0] != null ? arr[0].toString() : null);
		obj.setNoteType(arr[1] != null ? arr[1].toString() : null);
		obj.setCreditdebitNoteNumber(arr[2] != null ? arr[2].toString() : null);
		obj.setCreditdebitNoteDate(arr[3] != null ? arr[3].toString() : null);
		obj.setPregstFlag(arr[4] != null ? arr[4].toString() : null);
		obj.setReasonforNote(arr[5] != null ? arr[5].toString() : null);
		obj.setInvoiceNumber(arr[6] != null ? arr[6].toString() : null);
		obj.setInvoiceDate(arr[7] != null ? arr[7].toString() : null);
		...
		obj.setIntegratedAmount(arr[11] != null ? arr[11].toString() : null);
		obj.setCess(arr[12] != null ? arr[12].toString() : null);
		obj.setInvoiceValue(arr[13] != null ? arr[13].toString() : null);
		obj.setErrorCode(arr[14] != null ? arr[14].toString() : null);
	...
	private String creategstnCDNURErrorQueryString(String buildQuery) {

		return "SELECT (CASE WHEN HDR.SUPPLY_TYPE IN ('EXPT','EXPWT','B2CL') "
				+ "THEN HDR.SUPPLY_TYPE END ) AS TYPE, HDR.DOC_TYPE AS NOTE_TYPE,"
				...
				+ "(ITM.CESS_AMT_SPECIFIC+ITM.CESS_AMT_ADVALOREM) CESS_AMT,"
				+ "ITM.LINE_ITEM_AMT, TRIM(', ' FROM "
				...
				+ "GSTNBATCH.GSTN_SAVE_REF_ID AS GSTIN_REF_ID,HDR.POS "
				...
				+ "AND HDR.GSTN_ERROR=TRUE AND HDR.TAX_DOC_TYPE='CDNUR' "
				+ "AND HDR.IS_DELETE=FALSE "
				+ "AND GSTN_SAVE_STATUS='PE' " + buildQuery;
	}
	
	private String creategstnGstr1ACDNURErrorQueryString(String buildQuery) {
		...
		return "SELECT (CASE WHEN HDR.SUPPLY_TYPE IN ('EXPT','EXPWT','B2CL') "
				...
				+ "TF_OUTWARD_HEADER_GSTIN_ASP_ERROR_INFO_1A () ERRH "
				+ "ON HDR.ID = ERRH.DOC_HEADER_ID INNER JOIN "
