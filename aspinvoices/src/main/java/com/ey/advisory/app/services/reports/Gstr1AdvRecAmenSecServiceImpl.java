 ...
 * 
 */
@Service("Gstr1AdvRecAmenSecServiceImpl")
	public class Gstr1AdvRecAmenSecServiceImpl
			implements Gstr1ASPAdvRecSavableService {

		private static final Logger LOGGER = LoggerFactory
				.getLogger(Gstr1AdvRecAmenSecServiceImpl.class);

		@Autowired
		CommonUtility commonUtility;

		@Autowired
		@Qualifier("Gstr1AdvRecAmenSecTotalSummaryDaoImpl")
		private Gstr1AdvRecSavableDao gstr1AdvRectotalDao;
		
		@Autowired
		@Qualifier("Gstr1AdvRecAmenSecSummaryDaoImpl")
