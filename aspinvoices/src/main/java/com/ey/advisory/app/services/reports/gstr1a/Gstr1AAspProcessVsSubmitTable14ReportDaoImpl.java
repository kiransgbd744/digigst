...
@Component("Gstr1AAspProcessVsSubmitTable14ReportDaoImpl")
public class Gstr1AAspProcessVsSubmitTable14ReportDaoImpl
	...
	private String createApiProcessedQueryString(String buildHeaderHdr,
		...
		build.append("SELECT  S_No, " + "         GSTIN, "
				+ "         RETURN_PERIOD, " + "	     ECOM_GSTIN, "
				+ "	     ORG_RET_PERIOD, " + "	     ASP_TAXABLE_VALUE, "
				+ "		 ASP_IGST_AMT, " + "		 ASP_CGST_AMT, "
				+ "		 ASP_SGST_AMT, " + "		 ASP_CESS_AMT, "
				+ "		 GSTN_TAXABLE_VALUE, " + "		 GSTN_IGST_AMT, "
				...
				+ "FROM " + " ( " + " SELECT     'Table 14(i)' AS S_No, "
				...
				+ "		 AND HDR.TCS_FLAG = 'Y' AND HDR.RETURN_TYPE='GSTR1A' AND HDR.ECOM_GSTIN IS NOT NULL "
				+ "		 AND ASP_INVOICE_STATUS = 2 "
				+ "		 AND COMPLIANCE_APPLICABLE = TRUE "
				+ "		 AND IS_DELETE = FALSE " + " AND " + buildHeaderHdr
				+ "		 GROUP BY HDR.RETURN_PERIOD "
				+ "		 	,SUPPLIER_GSTIN " + "		 	,HDR.ECOM_GSTIN "
				+ "			,HDR.ORG_INV_DATE " + "        UNION ALL "
				...
				+ "		 AND HDR.TCS_FLAG='E' AND HDR.RETURN_TYPE='GSTR1A' "
