 ...
 *
 */
public class GLPostingDateValidation implements ValidationRule {
	...
	public List<ProcessingResult> isValid(int idx, Object obj, Object[] row,
		...
		if (date == null ) {
			...
			errorLocations.add(GSTConstants.GL_POSTING_DATE);
			TransDocProcessingResultLoc location = 
					new TransDocProcessingResultLoc(
					null, errorLocations.toArray());
			errors.add(new ProcessingResult(APP_VALIDATION, "ER10133",
					          "Invalid GLPosting Date.", location));
			return errors;
		}
