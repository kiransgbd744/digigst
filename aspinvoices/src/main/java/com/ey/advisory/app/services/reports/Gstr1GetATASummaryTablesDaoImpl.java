 ...
 */
	...
	@Component("Gstr1GetATASummaryTablesDaoImpl")
	@Slf4j
	public class Gstr1GetATASummaryTablesDaoImpl implements Gstr1aGetDao {
		...
		private String creategstnATAQueryString(String buildQuery) {
			...
			return "select ID,GSTIN,RETURN_PERIOD,ORG_MONTH,"
					...
					+ "FROM GETGSTR1_ATA_HEADER HDR INNER JOIN GETGSTR1_ATA_ITEM ITM "
