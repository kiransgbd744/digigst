...
@Component("InwardProcessedDataStatusConvertor")
public class InwardProcessedDataStatusConvertor implements ReportConvertor {
	...
	public Object convert(Object[] arr, String reportType) {
		...
		obj.setDocumentNumber(
				arr[6] != null ? DownloadReportsConstant.CSVCHARACTER
		...
		if (docType != null && (docType.equalsIgnoreCase("CR")
			...
			obj.setItemAmount(CheckForNegativeValue(arr[63]));
			obj.setItemDiscount(CheckForNegativeValue(arr[64]));
			obj.setPreTaxAmount(CheckForNegativeValue(arr[65]));
			obj.setItemAssessableAmount(CheckForNegativeValue(arr[66]));
			obj.setiGSTAmount(CheckForNegativeValue(arr[68]));
			obj.setcGSTAmount(CheckForNegativeValue(arr[70]));
			obj.setsGSTAmount(CheckForNegativeValue(arr[72]));
			obj.setCessAdvaloremAmount(CheckForNegativeValue(arr[74]));
			obj.setCessSpecificAmount(CheckForNegativeValue(arr[76]));
			obj.setStateCessAdvaloremAmount(CheckForNegativeValue(arr[78]));
			obj.setStateCessSpecificAmount(CheckForNegativeValue(arr[80]));
			obj.setItemOtherCharges(CheckForNegativeValue(arr[81]));
			obj.setTotalItemAmount(CheckForNegativeValue(arr[82]));
			obj.setInvoiceOtherCharges(CheckForNegativeValue(arr[83]));
			obj.setInvoiceAssessableAmount(CheckForNegativeValue(arr[84]));
			obj.setInvoiceIGSTAmount(CheckForNegativeValue(arr[85]));
			obj.setInvoiceCGSTAmount(CheckForNegativeValue(arr[86]));
			obj.setInvoiceSGSTAmount(CheckForNegativeValue(arr[87]));
			obj.setInvoiceCessAdvaloremAmount(CheckForNegativeValue(arr[88]));
			obj.setInvoiceCessSpecificAmount(CheckForNegativeValue(arr[89]));
			obj.setInvoiceStateCessAdvaloremAmount(
					CheckForNegativeValue(arr[90]));
			obj.setInvoiceStateCessSpecificAmount(
					CheckForNegativeValue(arr[91]));
			obj.setInvoiceValue(CheckForNegativeValue(arr[92]));
			obj.setAvailableIgst(CheckForNegativeValue(arr[97]));
			obj.setAvailableCgst(CheckForNegativeValue(arr[98]));
			obj.setAvailableSgst(CheckForNegativeValue(arr[99]));
			obj.setAvailableCess(CheckForNegativeValue(arr[100]));
			obj.settCSAmountIncomeTax(CheckForNegativeValue(arr[105]));
			obj.setInvoiceValueFC(CheckForNegativeValue(arr[108]));
		} else {
		...
		if (docType != null && (docType.equalsIgnoreCase("CR")
				...
				|| docType.equalsIgnoreCase("RCR")
				|| docType.equalsIgnoreCase("ADJ"))) {
			obj.setCif(CheckForNegativeValue(arr[166]));
			obj.setCustomDuty(CheckForNegativeValue(arr[167]));
			obj.settCSIGSTAmount(CheckForNegativeValue(arr[171]));
			obj.settCSCGSTAmount(CheckForNegativeValue(arr[172]));
			obj.settCSSGSTAmount(CheckForNegativeValue(arr[173]));
			obj.settDSIGSTAmount(CheckForNegativeValue(arr[175]));
			obj.settDSCGSTAmount(CheckForNegativeValue(arr[176]));
			obj.settDSSGSTAmount(CheckForNegativeValue(arr[177]));
		} else {
		...
		if (docType != null && (docType.equalsIgnoreCase("CR")
				...
				|| docType.equalsIgnoreCase("RCR")
				|| docType.equalsIgnoreCase("ADJ"))) {
			obj.setPurchaseOrderValue(CheckForNegativeValue(arr[204]));
		}else{
