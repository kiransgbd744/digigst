...
public class Anx1GSTN3GErrorReportsView {
	...
	public String toString() {
		return "Anx1GSTN3GErrorReportsView [supplierGSTIN=" + supplierGSTIN
				...
				+ ", sec7ofIGSTFlag=" + sec7ofIGSTFlag + ", claimRefundFlag="
				+ claimRefundFlag + ", gSTNErrorCode=" + gSTNErrorCode
