...
import com.ey.advisory.core.search.SearchCriteria;
	...
	@Service("Gstr1AAspAdvAdjAmenSecServiceImpl")
	public class Gstr1AAspAdvAdjAmenSecServiceImpl
			implements Gstr1AASPAdvAdjSavableService {

		private static final Logger LOGGER = LoggerFactory
				.getLogger(Gstr1AAspAdvAdjAmenSecServiceImpl.class);

		@Autowired
		CommonUtility commonUtility;

		@Autowired
		@Qualifier("Gstr1AAspAdvAdjAmenSecTotalDaoImpl")
		...
		@Autowired
		@Qualifier("Gstr1AAspAdvAdjAmensecSummaryLevelDaoImpl")
