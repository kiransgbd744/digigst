 ...
 */
@Entity
@Table(name = "GETGSTR6A_CDN_HEADER")
public class GetGstr6aCdnHeaderEntity {
	...
	protected List<GetGstr6aCdnItemEntity> lineItems = new ArrayList<>();
	...
	public List<GetGstr6aCdnItemEntity> getLineItems() {
		return lineItems;
	}

	public void setLineItems(List<GetGstr6aCdnItemEntity> lineItems) {
