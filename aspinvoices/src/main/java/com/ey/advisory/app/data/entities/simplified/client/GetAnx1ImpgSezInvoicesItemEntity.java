 ...
 */
@Entity
@Table(name = "GETANX1_IMPGSEZ_ITEM")
public class GetAnx1ImpgSezInvoicesItemEntity {
	...
	protected GetAnx1ImpgSezInvoicesHeaderEntity header;
	...
	public GetAnx1ImpgSezInvoicesHeaderEntity getHeader() {
		return header;
	}

	public void setHeader(GetAnx1ImpgSezInvoicesHeaderEntity header) {
		this.header = header;
	}
