 ...
 *
 */
@Repository("Gstr1GetEcomGstnRepository")
@Transactional(propagation = Propagation.REQUIRED, readOnly = false)
public interface Gstr1GetEcomGstnRepository
		extends CrudRepository<GetGstr1EcomSupHeaderEntity, Long> {
	@Modifying
	@Query("UPDATE GetGstr1EcomSupHeaderEntity b SET b.isDelete = true,b.modifiedBy = 'SYSTEM', b.modifiedOn =:modifiedOn   WHERE"
	...
	@Query("SELECT COUNT(*) FROM GetGstr1EcomSupHeaderEntity "
