 ...
 */
@Slf4j
@Service("ProcsSubmitScreenReqRespHandler")
public class ProcsSubmitScreenReqRespHandler {

	@Autowired
	@Qualifier("ProcessSubmitDocSummarySearchService")
	ProcessSubmitDocSummarySearchService searchService;
