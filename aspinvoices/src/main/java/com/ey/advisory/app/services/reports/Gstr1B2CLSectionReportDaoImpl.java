...
@Component("Gstr1B2CLSectionReportDaoImpl")
public class Gstr1B2CLSectionReportDaoImpl
		implements Gstr1ReviewSummaryCustomizedReportsDao {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(Gstr1B2CLSectionReportDaoImpl.class);
	...
	public static void main(String[] args) {
		...
		System.out.println(createApiProcessedQueryString(buildHeader.toString(),
				multiSupplyTypeAns)); 
	}
