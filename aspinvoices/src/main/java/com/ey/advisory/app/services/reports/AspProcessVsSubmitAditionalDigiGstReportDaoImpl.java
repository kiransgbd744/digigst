 ...
 * 
 */
@Component("AspProcessVsSubmitAditionalDigiGstReportDaoImpl")
public class AspProcessVsSubmitAditionalDigiGstReportDaoImpl
	...
	private String createApiProcessedQueryString(String buildQuery) {
		...
		build.append("SELECT CASE "
				...
				+ "ELSE HDR.table_section END AS TABLE_NUMBER, " //CHAnge done recently BUG 156571
				...
				+ "inner join (select TABLE_ID from GSTR1_SUBMITTED_PS_TRANS WHERE "
				...
				//+ "AND HDR.TCS_FLAG = 'O' "//CHAnge done recently BUG 156571
				+ "AND HDR.return_type = 'GSTR1' "
				//+ "AND HDR.TABLE_SECTION IN ('15(i)','15(iii)') "//CHAnge done recently BUG 156571
				+ buildQuery);
