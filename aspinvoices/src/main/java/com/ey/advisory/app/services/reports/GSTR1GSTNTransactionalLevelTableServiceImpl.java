...
@Service("GSTR1GSTNTransactionalLevelTableServiceImpl")
public class GSTR1GSTNTransactionalLevelTableServiceImpl
		implements Gstr1GstnErrorReportService {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(GSTR1GSTNTransactionalLevelTableServiceImpl.class);

	@Autowired
	CommonUtility commonUtility;

	@Autowired
	@Qualifier("GSTR1GSTNTransactionalLevelTablesDaoImpl")
	...
	public Workbook findGstnErrorReports(SearchCriteria criteria,
		...
		workbook = createWorkbookWithExcelTemplate("ReportTemplates",
				"GSTR-1_GSTN_Transactional_Level_Tables_Saved_Submitted.xlsx");
