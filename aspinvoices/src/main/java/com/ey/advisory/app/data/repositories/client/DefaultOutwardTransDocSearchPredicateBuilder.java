 ...
 *
 */
@Component("DefaultOutwardTransDocSearchPredicateBuilder")
public class DefaultOutwardTransDocSearchPredicateBuilder
		implements OutwardTransDocSearchPredicateBuilder {
