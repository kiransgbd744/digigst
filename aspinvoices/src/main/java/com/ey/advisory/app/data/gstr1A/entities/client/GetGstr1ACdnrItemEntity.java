...
@Entity
@Table(name = "GETGSTR1A_CDNR_ITEM")
public class GetGstr1ACdnrItemEntity {

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "GETGSTR1_CDNR_ITEM_SEQ", allocationSize = 100)
	...
	private GetGstr1ACdnrHeaderEntity document;
	...
	public GetGstr1ACdnrHeaderEntity getDocument() {
		return document;
	}

	public void setDocument(GetGstr1ACdnrHeaderEntity document) {
