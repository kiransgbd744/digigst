...
import com.ey.advisory.core.search.SearchCriteria;
	...
	@Service("AspSecHsnSummaryReportsServiceImpl")
	public class AspSecHsnSummaryReportsServiceImpl
			implements Gstr1ASPHsnSummaryReportsService {

		private static final Logger LOGGER = LoggerFactory
				.getLogger(AspSecHsnSummaryReportsServiceImpl.class);

		@Autowired
		CommonUtility commonUtility;

		@Autowired
		@Qualifier("AspSecHsnSummaryDaoImpl")
		Gstr1AspHsnSummaryDao gstr1AspHsnSummaryDao;
