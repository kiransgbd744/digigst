 ...
 *
 */
@Repository("Gstr2aGetTDSDetailsAtGstnRepository")
@Transactional(propagation = Propagation.REQUIRED, readOnly = false)
public interface Gstr2aGetTDSDetailsAtGstnRepository
		extends CrudRepository<GetGstr2aTDSDetailsEntity, Long> {
