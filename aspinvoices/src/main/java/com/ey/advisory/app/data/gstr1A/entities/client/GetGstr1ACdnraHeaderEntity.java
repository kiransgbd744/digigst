...
@Entity
@Table(name = "GETGSTR1A_CDNRA_HEADER")
public class GetGstr1ACdnraHeaderEntity {

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "GETGSTR1A_CDNRA_HEADER_SEQ", allocationSize = 100)
	...
	protected List<GetGstr1ACdnraItemEntity> lineItems = new ArrayList<>();
	...
	public List<GetGstr1ACdnraItemEntity> getLineItems() {
		return lineItems;
	}

	public void setLineItems(List<GetGstr1ACdnraItemEntity> lineItems) {
