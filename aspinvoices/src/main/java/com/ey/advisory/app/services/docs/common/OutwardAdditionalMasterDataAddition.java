 ...
 *
 */
@Component("OutwardAdditionalMasterDataAddition")
public class OutwardAdditionalMasterDataAddition {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(OutwardAdditionalMasterDataAddition.class);
	...
	public void addAdditionalMasterData(List<OutwardTransDocument> documents) {
