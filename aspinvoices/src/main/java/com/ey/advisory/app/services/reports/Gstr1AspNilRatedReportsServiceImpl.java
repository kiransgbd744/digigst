 ...
 *
 */
@Service("Gstr1AspNilRatedReportsServiceImpl")
public class Gstr1AspNilRatedReportsServiceImpl
	...
	@Autowired
	@Qualifier("Gstr1AspNilRatedTransactionalDaoImpl")
	Gstr1OutwardVerticalProcessNilDao gstr1NilRatedTransactionalDao;

	@Autowired
	@Qualifier("Gstr1NilRatedTotalSummaryDaoImpl")
	...
	public Workbook findNilReport(SearchCriteria criteria, PageRequest pageReq) {
		...
		workbook = createWorkbookWithExcelTemplate("ReportTemplates",
				"1GSTR1_ASP_NIL_EXEMPT_NON_Savable.xlsx");
