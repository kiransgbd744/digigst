...
import com.google.common.base.Strings;
	...
	@Component("AspEXPASectionReportDaoImpl")
	public class AspEXPASectionReportDaoImpl implements Gstr1ReviewSummaryReportsDao {

		private static final Logger LOGGER = LoggerFactory.getLogger(AspEXPASectionReportDaoImpl.class);
		...
		private String createApiProcessedQueryString(String buildHeader) {
			...
			return "SELECT TRIM(', ' FROM IFNULL(HDR.ERROR_CODES,'') ||','|| "
					...
					+ "HDR.CUST_SUPP_ADDRESS3, " + "HDR.TAX_DOC_TYPE AS DATA_CATEGORY " + "FROM ANX_OUTWARD_DOC_HEADER "
					...
					+ "AND HDR.RETURN_TYPE='GSTR1' AND HDR.TAX_DOC_TYPE IN ('EXPORTS-A') " + buildHeader
