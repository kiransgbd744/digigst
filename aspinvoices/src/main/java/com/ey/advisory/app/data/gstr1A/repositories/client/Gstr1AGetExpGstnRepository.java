...
@Repository("Gstr1AGetExpGstnRepository")
@Transactional(propagation = Propagation.REQUIRED, readOnly = false)
public interface Gstr1AGetExpGstnRepository
		extends CrudRepository<GetGstr1AExpHeaderEntity, Long> {
	@Modifying
	@Query("UPDATE GetGstr1AExpHeaderEntity b SET b.isDelete = true,b.modifiedBy = 'SYSTEM'  , b.modifiedOn =:modifiedOn  WHERE"
	...
	@Query("SELECT COUNT(*) FROM GetGstr1AExpHeaderEntity "
