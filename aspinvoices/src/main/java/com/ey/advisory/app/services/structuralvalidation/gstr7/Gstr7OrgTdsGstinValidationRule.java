 ...
 *
 */
public class Gstr7OrgTdsGstinValidationRule implements ValidationRule {
	...
	public List<ProcessingResult> isValid(int idx, Object obj, Object[] row,
		...
		if (matcher.matches() || matcher1.matches() 
			...
			errors.add(new ProcessingResult(APP_VALIDATION, "ER2005",
					"Invalid Original TDS Deductee GSTIN.", location));
			return errors;
