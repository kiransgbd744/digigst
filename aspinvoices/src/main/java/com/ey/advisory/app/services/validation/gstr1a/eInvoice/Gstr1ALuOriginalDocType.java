 ...
 *
 */
@Component("Gstr1ALuOriginalDocType")
public class Gstr1ALuOriginalDocType
	...
	public List<ProcessingResult> validate(Gstr1AOutwardTransDocument document,
		...
		if (document.getOrigDocType() != null
				&& !document.getOrigDocType().isEmpty()) {

			docTypeCache = StaticContextHolder.getBean("DefaultDocTypeCache",
					DocTypeCache.class);
			int n = docTypeCache.findDocType(
			...
			if (n <= 0) {
				...
				errors.add(new ProcessingResult(APP_VALIDATION, "ER0110",
						"Invalid Original Document Type.", location));
			}
		}
		return errors;
	}
