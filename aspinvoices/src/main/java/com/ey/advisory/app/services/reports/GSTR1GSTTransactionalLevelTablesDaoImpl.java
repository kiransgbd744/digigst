...
@Component("GSTR1GSTTransactionalLevelTablesDaoImpl")
public class GSTR1GSTTransactionalLevelTablesDaoImpl
		implements Gstr1GstnErrorDao {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(GSTR1GSTTransactionalLevelTablesDaoImpl.class);
	...
	private String creategstnTransQueryString(String buildQuery) {
		...
		return "SELECT HDR.GSTIN SUPPLIER_GSTIN,HDR.RETURN_PERIOD, "
				...
				+ "BT.IS_FILED FROM GETGSTR1_B2B_HEADER HDR INNER JOIN "
				...
				+ " '' SHIPP_BILL_DATE,BT.IS_FILED FROM GETGSTR1_B2BA_HEADER HDR INNER JOIN "
				...
				+ " 'CDNR' TABLE_TYPE,HDR.NOTE_TYPE,'' TYPE,HDR.NOTE_NUM DOC_NUM,"
				+ "HDR.NOTE_DATE DOC_DATE,HDR.INV_NUM ORG_DOC_NUM,"
				+ "HDR.INV_DATE ORG_DOC_DATE,HDR.PRE_GST CRDRPreGST,"
				+ "HDR.CTIN CUST_GSTIN,'' POS,HDR.SERIAL_NUM LINE_NUM,"
				+ "ITM.TAX_RATE,HDR.DIFF_PERCENT,ITM.TAXABLE_VALUE,ITM.IGST_AMT,"
				+ "ITM.CGST_AMT,ITM.SGST_AMT,ITM.CESS_AMT, 0 INV_VALUE,'' RCHRG,"
				+ " '' E_COM_GSTIN,'' ORG_INV_NUM, '' ORG_INV_DATE,'' PORT_CODE,"
				+ " '' SHIPP_BILL_NUM, '' SHIPP_BILL_DATE,BT.IS_FILED FROM "
				...
				+ " UNION ALL "
				+ "SELECT HDR.GSTIN SUPPLIER_GSTIN,HDR.RETURN_PERIOD, "
				+ " 'CDNRA' TABLE_TYPE,HDR.NOTE_TYPE,'' TYPE,HDR.NOTE_NUM DOC_NUM,"
				...
				+ " '' PORT_CODE, '' SHIPP_BILL_NUM,'' SHIPP_BILL_DATE,"
				+ "BT.IS_FILED FROM GETGSTR1_CDNRA_HEADER HDR INNER JOIN "
				...
				+ "HDR.NOTE_TYPE,HDR.TYPE,HDR.NOTE_NUM DOC_NUM,"
				+ "HDR.NOTE_DATE DOC_DATE,HDR.INV_NUM ORG_DOC_NUM,"
				+ "HDR.INV_DATE ORG_DOC_DATE,HDR.PRE_GST CRDRPreGST,"
				+ "'' CUST_GSTIN,'' POS,HDR.SERIAL_NUM LINE_NUM, ITM.TAX_RATE,"
				+ "HDR.DIFF_PERCENT,ITM.TAXABLE_VALUE,ITM.IGST_AMT,"
				...
				+ " UNION ALL "
				+ "SELECT HDR.GSTIN SUPPLIER_GSTIN,HDR.RETURN_PERIOD, "
				+ " 'CDNURA' TABLE_TYPE,HDR.NOTE_TYPE,HDR.TYPE, HDR.NOTE_NUM DOC_NUM,"
				+ "HDR.NOTE_DATE DOC_DATE,HDR.ORG_NOTE_NUM ORG_DOC_NUM,"
				+ "HDR.ORG_NOTE_DATE ORG_DOC_DATE, HDR.PRE_GST CRDRPreGST,"
				+ " '' CUST_GSTIN,'' POS, HDR.SERIAL_NUM LINE_NUM,ITM.TAX_RATE,"
				...
				+ "HDR.SHIPP_BILL_NUM,HDR.SHIPP_BILL_DATE,BT.IS_FILED "
				...
				+ "HDR.SHIPP_BILL_DATE,BT.IS_FILED FROM GETGSTR1_EXPA_HEADER "
				...
				+ "HDR.INV_NUM ORG_INV_NUM, HDR.INV_DATE ORG_INV_DATE,"
				+ " '' PORT_CODE,'' SHIPP_BILL_NUM, '' SHIPP_BILL_DATE,"
				+ "BT.IS_FILED FROM GETGSTR1_B2CL_HEADER HDR INNER JOIN "
				...
				+ " '' SHIPP_BILL_DATE, BT.IS_FILED FROM GETGSTR1_B2CLA_HEADER "
				+ "HDR INNER JOIN GETGSTR1_B2CLA_ITEM ITM ON "
				+ "HDR.ID = ITM.HEADER_ID AND "
				+ "HDR.DERIVED_RET_PERIOD = ITM.DERIVED_RET_PERIOD "
				+ "LEFT JOIN GETANX1_BATCH_TABLE BT "
				+ "ON HDR.BATCH_ID = BT.ID WHERE HDR.IS_DELETE = FALSE "
				+ "AND BT.IS_DELETE = FALSE UNION ALL SELECT HDR.GSTIN SUPPLIER_GSTIN,"
				+ "HDR.RETURN_PERIOD, 'B2CS' TABLE_TYPE,'' INV_TYPE,'' TYPE,"
				+ " '' DOC_NUM, '' DOC_DATE,'' ORG_DOC_NUM,'' ORG_DOC_DATE, "
				+ " '' CRDRPreGST,'' CUST_GSTIN,HDR.POS,0 LINE_NUM,ITM.TAX_RATE,"
				+ "HDR.DIFF_PERCENT,ITM.TAXABLE_VALUE,ITM.IGST_AMT,ITM.CGST_AMT,"
				+ "ITM.SGST_AMT,ITM.CESS_AMT,"
				+ "(ITM.TAXABLE_VALUE+ITM.IGST_AMT+ ITM.CGST_AMT+ITM.SGST_AMT+ITM.CESS_AMT) "
				+ "AS INV_VALUE,'' RCHRG, HDR.ETIN E_COM_GSTIN,'' ORG_INV_NUM, "
				+ " '' ORG_INV_DATE,'' PORT_CODE,'' SHIPP_BILL_NUM, '' SHIPP_BILL_DATE,"
				+ "BT.IS_FILED FROM GETGSTR1_B2CS_HEADER "
				+ "HDR INNER JOIN GETGSTR1_B2CS_ITEM ITM ON HDR.ID = ITM.HEADER_ID "
				+ "AND HDR.DERIVED_RET_PERIOD = ITM.DERIVED_RET_PERIOD "
				+ "LEFT JOIN GETANX1_BATCH_TABLE BT ON HDR.BATCH_ID = BT.ID "
				+ "WHERE HDR.IS_DELETE = FALSE AND BT.IS_DELETE = FALSE "
				+ buildQuery
				+" UNION ALL "
				+ "SELECT HDR.GSTIN SUPPLIER_GSTIN,"
				+ "HDR.RETURN_PERIOD,'B2CS' TABLE_TYPE,"
				+ " '' INV_TYPE,'' TYPE,'' DOC_NUM, '' DOC_DATE,"
				+ " '' ORG_DOC_NUM,'' ORG_DOC_DATE, '' CRDRPreGST,"
				+ " '' CUST_GSTIN,HDR.POS,'0' LINE_NUM, ITM.TAX_RATE,"
				+ "HDR.DIFF_PERCENT,ITM.TAXABLE_VALUE,ITM.IGST_AMT,"
				+ "ITM.CGST_AMT,ITM.SGST_AMT,ITM.CESS_AMT,"
				+ "(ITM.TAXABLE_VALUE+ITM.IGST_AMT+ ITM.CGST_AMT"
				+ " +ITM.SGST_AMT+ITM.CESS_AMT) AS INV_VALUE,'' RCHRG,"
				+ "HDR.ETIN E_COM_GSTIN,'' ORG_INV_NUM, '' ORG_INV_DATE,"
				+ " '' PORT_CODE,'' SHIPP_BILL_NUM, '' SHIPP_BILL_DATE,"
				+ "BT.IS_FILED FROM GETGSTR1_B2CS_HEADER "
				+ "HDR INNER JOIN GETGSTR1_B2CS_ITEM ITM "
				+ "ON HDR.ID = ITM.HEADER_ID AND "
				+ "HDR.DERIVED_RET_PERIOD = ITM.DERIVED_RET_PERIOD "
				+ "LEFT JOIN GETANX1_BATCH_TABLE BT "
				+ "ON HDR.BATCH_ID = BT.ID WHERE "
				+ "HDR.IS_DELETE = FALSE AND BT.IS_DELETE = FALSE "
				+ buildQuery
				+ " UNION ALL "
				+ "SELECT HDR.GSTIN SUPPLIER_GSTIN,HDR.RETURN_PERIOD, 'B2CSA' TABLE_TYPE,"
				+ " '' INV_TYPE,'' TYPE,'' DOC_NUM, '' DOC_DATE,'' ORG_DOC_NUM,"
				+ " '' ORG_DOC_DATE, '' CRDRPreGST,'' CUST_GSTIN,HDR.POS,'0' LINE_NUM,"
				+ "ITM.TAX_RATE,HDR.DIFF_PERCENT,ITM.TAXABLE_VALUE,ITM.IGST_AMT,"
				+ "ITM.CGST_AMT,ITM.SGST_AMT,ITM.CESS_AMT,"
				+ "(ITM.TAXABLE_VALUE+ITM.IGST_AMT+ ITM.CGST_AMT+ITM.SGST_AMT+ITM.CESS_AMT) "
				+ "AS INV_VALUE,'' RCHRG, HDR.ETIN E_COM_GSTIN,'' ORG_INV_NUM, "
				+ " '' ORG_INV_DATE,'' PORT_CODE,'' SHIPP_BILL_NUM, "
				+ " '' SHIPP_BILL_DATE,BT.IS_FILED FROM GETGSTR1_B2CSA_HEADER "
				+ "HDR INNER JOIN GETGSTR1_B2CSA_ITEM ITM "
				+ "ON HDR.ID = ITM.HEADER_ID AND "
				+ "HDR.DERIVED_RET_PERIOD = ITM.DERIVED_RET_PERIOD LEFT JOIN "
				+ "GETANX1_BATCH_TABLE BT ON HDR.BATCH_ID = BT.ID "
				+ "WHERE HDR.IS_DELETE = FALSE AND "
				+ "BT.IS_DELETE = FALSE "
				+ buildQuery;
