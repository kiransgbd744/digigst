...
@Repository("Gstr1GetExpaGstnRepository")
@Transactional(propagation = Propagation.REQUIRED, readOnly = false)
public interface Gstr1GetExpaGstnRepository
		extends CrudRepository<GetGstr1ExpaHeaderEntity, Long> {
	@Modifying
	@Query("UPDATE GetGstr1ExpaHeaderEntity b SET b.isDelete = true,b.modifiedBy = 'SYSTEM'  , b.modifiedOn =:modifiedOn  WHERE"
	...
	@Query("SELECT COUNT(*) FROM GetGstr1ExpaHeaderEntity "
