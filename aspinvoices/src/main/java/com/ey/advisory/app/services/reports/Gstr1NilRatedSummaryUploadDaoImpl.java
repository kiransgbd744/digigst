 ...
 * 
 */
	@Component("Gstr1NilRatedSummaryUploadDaoImpl")
	public class Gstr1NilRatedSummaryUploadDaoImpl
			implements Gstr1OutwardVerticalProcessNilDao {

		private static final Logger LOGGER = LoggerFactory
				.getLogger(Gstr1NilRatedSummaryUploadDaoImpl.class);
		...
		private String createNilRatedTotalSummQueryString(String buildQuery) {
			...
			return "SELECT NEN.SUPPLIER_GSTIN, NEN.RETURN_PERIOD,"
					...
					+ "GSTR1_PROCESSED_NILEXTNON NEN LEFT OUTER JOIN "
		...
		private String createNilRatedTotalSummQueryStringForGstr1a(String buildQuery) {
