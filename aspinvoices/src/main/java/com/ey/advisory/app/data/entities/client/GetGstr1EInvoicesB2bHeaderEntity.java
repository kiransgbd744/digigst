 ...
 */
@Entity
@Table(name = "GETGSTR1_EINV_B2B_HEADER")
public class GetGstr1EInvoicesB2bHeaderEntity {

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "GETGSTR1_EINV_B2B_HEADER_SEQ", allocationSize = 100)
	...
	/*
	 * @Column(name = "CFLAG") private String cflag;
	 */
	...
	/*
	 * @Column(name = "TABLE_SECTION") protected String tableSection;
	 */
	...
	protected List<GetGstr1EInvoicesB2bItemEntity> lineItems = new ArrayList<>();
	...
	public void setEstimTime(String estimTime) {
		this.estimTime = estimTime;
	}
	...
	public List<GetGstr1EInvoicesB2bItemEntity> getLineItems() {
		return lineItems;
	}

	public void setLineItems(List<GetGstr1EInvoicesB2bItemEntity> lineItems) {
