 ...
 *
 */
@Service("GstnConsolidatedReportsServiceImpl")
public class GstnConsolidatedReportsServiceImpl implements GstnConsolidatedReportsService {

	private static final Logger LOGGER = LoggerFactory.getLogger(GstnConsolidatedReportsServiceImpl.class);

	@Autowired
	CommonUtility commonUtility;

	@Autowired
	@Qualifier("GstnConsolidatedReportsDaoImpl")
	private GstnConsolidatedReportsDao gstnConsolidatedReportsDao;

	@Override
	public Workbook generateGstnReports(SearchCriteria criteria, PageRequest pageReq) {
