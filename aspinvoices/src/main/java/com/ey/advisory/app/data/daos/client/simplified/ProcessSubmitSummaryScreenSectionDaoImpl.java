 ...
 */
@Slf4j
@Component("ProcessSubmitSummaryScreenSectionDaoImpl")
public class ProcessSubmitSummaryScreenSectionDaoImpl
...
/*	@Autowired
	...
	NilAndHsnProcedureCallRepositoryImpl procService;
...
*/	@Override
	...
	/*	LOGGER.debug("Executing HSN Proc {} ");
		String sgstin = gstinList.get(0);
		procService.getHsnProc(sgstin, taxPeriod);
*/		
		/**
		...
		if (taxPeriodFrom1 != 0 && taxPeriodTo1 !=0) {
			...
			build.append(" AND DERIVED_RET_PERIOD BETWEEN :taxPeriodFrom1 AND :taxPeriodTo1 ");
		}
