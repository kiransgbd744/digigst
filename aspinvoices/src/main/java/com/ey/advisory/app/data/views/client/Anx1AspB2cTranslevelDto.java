 ...
 * 
 */
public class Anx1AspB2cTranslevelDto {
	...
	public String getOrgDocDate() {
		return OrgDocDate;
	}

	public void setOrgDocDate(String orgDocDate) {
		OrgDocDate = orgDocDate;
	}
	...
	public String toString() {
		return "Anx1AspB2cTranslevelDto [returnType=" + returnType
				...
				+ ", OrgDocNum=" + OrgDocNum + ", OrgDocDate=" + OrgDocDate
