...
@Slf4j
@Component("gstr1AExpExpaAtGstnImpl")
public class Gstr1AExpExpaAtGstnImpl implements Gstr1InvoicesAtGstn {

	@Autowired
	@Qualifier("gstr1AExpExpaDataAtGstnImpl")
	Gstr1AExpExpaDataAtGstn getGstr1AExpExpaDataAtGstn;
	...
	public Long findInvFromGstn(Gstr1GetInvoicesReqDto dto,
		...
		try {
			...
			reqId = getGstr1AExpExpaDataAtGstn.findExpDataAtGstn(dto,
					groupCode, type, json);
			...
			throw new APIException(
					"Unexpected error while executing Gstr1 Get Exp/Expa");
