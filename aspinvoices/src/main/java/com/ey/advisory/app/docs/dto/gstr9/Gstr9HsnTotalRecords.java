 ...
 *
 */
public class Gstr9HsnTotalRecords {
	...
	public String toString() {
		return "Gstr9HsnTotalRecords [errorCode=" + errorCode
				+ ", errorMessage=" + errorMessage + ", gstin=" + gstin
				+ ", fy=" + fy + ", tableNumber=" + tableNumber + ", hsn=" + hsn
