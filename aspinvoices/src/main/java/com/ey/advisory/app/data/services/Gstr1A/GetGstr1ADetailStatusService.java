...
@Component("GetGstr1ADetailStatusService")
public class GetGstr1ADetailStatusService {
	...
	@Autowired
	@Qualifier("GetGstr1AStatusFetchDaoImpl")
	private GetGstr1AStatusFetchDaoImpl getGstr1ADetailStatusFetchDao;
	...
	public GetGstr6DetailStatusMainDetailsRespDto findByCriteria(
		...
		List<Object[]> gstinList = getGstr1ADetailStatusFetchDao
		...
		if (!gstinList.isEmpty() && gstinList.size() > 0) {
			for (Object obj : gstinList) {
				...
				List<Object[]> itemsList = getGstr1ADetailStatusFetchDao
