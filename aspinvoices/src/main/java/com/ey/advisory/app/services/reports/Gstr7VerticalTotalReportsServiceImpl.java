...
@Service("Gstr7VerticalTotalReportsServiceImpl")
public class Gstr7VerticalTotalReportsServiceImpl implements Gstr7VerticalReportsService {

	private static final Logger LOGGER = LoggerFactory.getLogger(Gstr7VerticalTotalReportsServiceImpl.class);

	@Autowired
	CommonUtility commonUtility;

	@Autowired
	@Qualifier("Gstr7VerticalTotalReportsDaoImpl")
