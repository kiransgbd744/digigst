...
@Service("Gstr1HsnSectionServiceImpl")
	public class Gstr1HsnSectionServiceImpl
			implements Gstr1ASPHsnSummaryReportsService {

		private static final Logger LOGGER = LoggerFactory
				.getLogger(Gstr1HsnSectionServiceImpl.class);

		@Autowired
		CommonUtility commonUtility;

		@Autowired
		@Qualifier("Gstr1AspHsnSummaryDaoImpl")
