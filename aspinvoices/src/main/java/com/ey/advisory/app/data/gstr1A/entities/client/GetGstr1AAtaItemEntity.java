...
@Entity
@Table(name = "GETGSTR1A_ATA_ITEM")
public class GetGstr1AAtaItemEntity {
	
	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "GETGSTR1A_ATA_ITEM_SEQ", allocationSize = 100)
	...
	private GetGstr1AAtaHeaderEntity document;
	...
	public GetGstr1AAtaHeaderEntity getDocument() {
		return document;
	}

	public void setDocument(GetGstr1AAtaHeaderEntity document) {
