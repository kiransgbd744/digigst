 ...
 *
 */
@Service("anx1RevInvoicesAtGstnImpl")
@Slf4j
public class Anx1RevInvoicesAtGstnImpl implements Anx1InvoicesAtGstn {
	...
	public ResponseEntity<String> findInvFromGstn(Anx1GetInvoicesReqDto dto,
		...
		try {
			...
			throw new APIException(
					"Unexpected error while executing Anx1 Get RevInvoices");
