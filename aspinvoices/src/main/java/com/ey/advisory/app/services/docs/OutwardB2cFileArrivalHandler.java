...
import com.ey.advisory.app.services.annexure1fileupload.B2cStructuralErrorUploadService;
...
@Service("OutwardB2cFileArrivalHandler")
@Slf4j
public class OutwardB2cFileArrivalHandler {
	
	@Autowired
	@Qualifier("B2cStructuralErrorUploadService")
	private B2cStructuralErrorUploadService b2cStructuralErrorUploadService;
	...
	@Autowired
	@Qualifier("B2cHeaderCheckService")
	...
	private Gstr1FileStatusRepository gstr1FileStatusRepository;
		...
		public void processB2csFile(Message message, AppExecContext context) {
			LOGGER.error("Enter processB2csFile ");
		...
		TabularDataLayout layout = new DummyTabularDataLayout(41);
		...
		LOGGER.error("Start Time "+stTime);
		...
		List<Object[]> listOfB2c = ((FileUploadDocRowHandler<?>) rowHandler)
				                                         .getFileUploadList();
		...
		if (checkHeaderFormat.getValue0()) {
			...
			b2cStructuralErrorUploadService.
			                          processData(listOfB2c,updateFileStatus);	
		}
