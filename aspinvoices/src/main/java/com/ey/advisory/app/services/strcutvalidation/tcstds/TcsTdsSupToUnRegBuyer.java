...
public class TcsTdsSupToUnRegBuyer implements ValidationRule {
	...
	public List<ProcessingResult> isValid(Object obj, Object[] row,
		...
		if (!isDecimal(obj.toString().trim())) {
			...
			errorLocations.add(GSTConstants.SUP_TO_UN_REG_BUYER);
			TransDocProcessingResultLoc location = new TransDocProcessingResultLoc(
					null, errorLocations.toArray());
			errors.add(new ProcessingResult(APP_VALIDATION, "ER5921",
					"Invalid SuppliestoURbuyers.", location));
			return errors;
		}
