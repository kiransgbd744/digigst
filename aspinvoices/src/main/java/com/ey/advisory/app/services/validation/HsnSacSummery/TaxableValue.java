...
public class TaxableValue implements B2csBusinessRuleValidator<Gstr1HsnFileUploadEntity> {
	 ...
	 private static DecimalFormat df = new DecimalFormat("0.00");
		...
		public List<ProcessingResult> validate(Gstr1HsnFileUploadEntity document, ProcessingContext context) {
			...
			if(document.getTaxableValue()!=null){
				
			document.setTaxableValue(new BigDecimal(df.format(document.getTaxableValue())));
