 ...
 *
 */
public class Gstr1AARArthimatics
	...
	public List<ProcessingResult> validate(Gstr1AAsEnteredAREntity document,
		...
		String taxableValues = (document.getNewGrossAdvRec() != null)
				? document.getNewGrossAdvRec().trim() : null;
		...
		if (document.getTransType() != null
				...
				&& (document.getTransType().trim().equalsIgnoreCase("L65")
						|| document.getTransType().trim().
			...
			if ((sgstin != null && pos != null)
				...
				if (sgstAmount.compareTo(intraL65taxAmount) != 0) {
					...
					errors.add(new ProcessingResult(APP_VALIDATION,
							ProcessingResultType.INFO, "IN5504",
				...
				if (cgstAmount.compareTo(intraL65taxAmount) != 0) {
					...
					TransDocProcessingResultLoc location = 
							...
							null, errorLocations.toArray());
					errors.add(new ProcessingResult(APP_VALIDATION,
							ProcessingResultType.INFO, "IN5505",
				...
				if (igstAmount.compareTo(interL65taxAmount) != 0) {
					...
					TransDocProcessingResultLoc location = 
							...
							null, errorLocations.toArray());
					errors.add(new ProcessingResult(APP_VALIDATION,
							ProcessingResultType.INFO, "IN5506",
