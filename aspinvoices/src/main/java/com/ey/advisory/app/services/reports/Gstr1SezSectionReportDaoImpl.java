...
@Component("Gstr1SezSectionReportDaoImpl")
public class Gstr1SezSectionReportDaoImpl
		implements Gstr1ReviewSummaryCustomizedReportsDao {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(Gstr1SezSectionReportDaoImpl.class);
	...
	public Pair<List<Object[]>, List<Object>> getGstr1RSReports(
		...
		if (ProfitCenter != null && !ProfitCenter.isEmpty()) {
			if (pcList != null && pcList.size() > 0) {
				buildHeader.append(" AND ITM.PROFIT_CENTRE IN :pcList");
			}
		}
