 ...
 */
@Slf4j
@Service("Gstr1AB2CSUpdateService")
public class Gstr1AB2CSUpdateService {
	...
	Gstr1AB2CSRepository repository;
	...
	public JsonObject updateVerticalData(
		...
		for (Gstr1VerticalSummaryRespDto dto : list) {
			...
			Gstr1AAsEnteredB2csEntity entity = new Gstr1AAsEnteredB2csEntity();
			...
			if (errorList.size() > 0) {
				...
				Gstr1AB2csDetailsEntity save2 = save(entity, section);
				if ("B2CSA".equalsIgnoreCase(section)) {
					save2.setSectionType(true);
				}
				repository.UpdateId(dto.getId());
				Gstr1AB2csDetailsEntity save = repository.save(save2);
	...
	public String getInvKey(Gstr1AAsEnteredB2csEntity obj) {
	...
	private String getGstnKey(Gstr1AAsEnteredB2csEntity obj) {
		String sgstin = (obj.getSgstin() != null)
				? String.valueOf(obj.getSgstin()).trim() : "";
		String retPeriod = (obj.getReturnPeriod() != null)
				? String.valueOf(obj.getReturnPeriod()).trim() : "";
	...
	public Gstr1AB2csDetailsEntity save(Gstr1AAsEnteredB2csEntity dto,
			String section) {

		Gstr1AB2csDetailsEntity entity = new Gstr1AB2csDetailsEntity();
		if (dto != null) {
	...
	public Gstr1VerticalSummaryRespDto convertEntityToDto(
			Gstr1AB2csDetailsEntity save, String section) {
