...
@Repository("Gstr2GetGstr2BSuppSmryRepository")
@Transactional(propagation = Propagation.REQUIRED, readOnly = false)
public interface Gstr2GetGstr2BSuppSmryRepository
		extends CrudRepository<Gstr2GetGstr2BSuppSmryEntity, Long>,
		JpaSpecificationExecutor<Gstr2GetGstr2BSuppSmryEntity> {

	@Modifying
	@Query("UPDATE Gstr2GetGstr2BSuppSmryEntity b SET b.isDelete = true, "
	...
	@Modifying
	@Query("UPDATE Gstr2GetGstr2BSuppSmryEntity b SET b.status = 'SAVED', "
