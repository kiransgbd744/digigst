...
@Component("Gstr1ASPB2CSSavableSummaryLevelDaoImpl")
public class Gstr1ASPB2CSSavableSummaryLevelDaoImpl
		implements Gstr1ASPB2CSSavableSummaryLevelDao {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(Gstr1ASPB2CSSavableSummaryLevelDaoImpl.class);
