...
@Entity
@Table(name = "GETGSTR1_B2B_ITEM")
public class GetGstr1B2bItemEntity {
	...
	private GetGstr1B2bHeaderEntity document;
	...
	public GetGstr1B2bHeaderEntity getDocument() {
		return document;
	}

	public void setDocument(GetGstr1B2bHeaderEntity document) {
