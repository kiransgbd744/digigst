...
import com.ey.advisory.common.TransDocProcessingResultLoc;
	...
	public class UserAccess5Validator implements 
						...
						if (OnboardingConstant.AT_M.equalsIgnoreCase(atOutward)) {
							...
							if(ua5==null || ua5.isEmpty()){
								...
								errors.add(new ProcessingResult(APP_VALIDATION,
										"ER1259",
										"User Access 5 not as per configurable "
							...
							if (!isAttrValid) {
									...
									TransDocProcessingResultLoc location 
									      = new TransDocProcessingResultLoc(
											null, errorLocations.toArray());
									errors.add(new ProcessingResult(APP_VALIDATION,
											ProcessingResultType.INFO, "IN1210",
											"User Access 5 not as per configurable"
											+ " parameters selected by user.",
											location));
			...
			if (CONFIG_PARAM_OUTWARD_ANS_KEY_ID.A.name()
				...
				if (!isAttrUserValid) {
					...
					TransDocProcessingResultLoc location = 
							new TransDocProcessingResultLoc(
							null, errorLocations.toArray());
					errors.add(new ProcessingResult(APP_VALIDATION, "ER1270",
