 ...
 */
@Component
public class EInvoiceInwardDocSearchReqDto extends SearchCriteria {

	public EInvoiceInwardDocSearchReqDto() {
...
*/
	...
	public List<String> getAccVoucherNo() {
		return accVoucherNo;
	}

	public void setAccVoucherNo(List<String> accVoucherNo) {
		this.accVoucherNo = accVoucherNo;
	}
