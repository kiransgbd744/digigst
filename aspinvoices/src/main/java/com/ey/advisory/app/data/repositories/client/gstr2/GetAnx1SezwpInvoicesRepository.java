 ...
 *
 */
@Repository("GetAnx1SezwpInvoicesRepository")
@Transactional(propagation = Propagation.REQUIRED, readOnly = false)
public interface GetAnx1SezwpInvoicesRepository
		extends CrudRepository<GetAnx1SezwpInvoicesHeaderEntity, Long> {

	@Modifying
	@Query("UPDATE GetAnx1SezwpInvoicesHeaderEntity b SET b.isDelete = true WHERE"
