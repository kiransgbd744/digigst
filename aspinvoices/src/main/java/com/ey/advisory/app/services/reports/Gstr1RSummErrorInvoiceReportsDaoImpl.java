...
@Component("Gstr1RSummErrorInvoiceReportsDaoImpl")
public class Gstr1RSummErrorInvoiceReportsDaoImpl implements Gstr1ReviewSummaryReportsDao {

	private static final Logger LOGGER = LoggerFactory.getLogger(Gstr1RSummErrorInvoiceReportsDaoImpl.class);
	...
	private Gstr1VerticalInvoiceDto convertError(Object[] arr) {
		...
		obj4.setAspErrorDescription(arr[10] != null ? arr[10].toString() : null);

		return obj4;
	}

	private String createErrorQueryString(String buildQuery) {
		return "SELECT SUPPLIER_GSTIN,RETURN_PERIOD,SERIAL_NUM," + "NATURE_OF_DOC,TOT_NUM,CANCELED,NET_NUM,"
				...
				+ "ERR.FILE_ID=FIL.ID WHERE HI.IS_ERROR = TRUE " + buildQuery;
