...
import com.ey.advisory.app.services.gstr1afileupload.Gstr1aB2csStructuralProcess;
...
@Service("Gstr1AB2csFileArrivalHandler")
@Slf4j
public class Gstr1AB2csFileArrivalHandler {
	...
	@Autowired
	@Qualifier("Gstr1aB2csStructuralProcess")
	private Gstr1aB2csStructuralProcess gstr1aB2csStructuralProcess;
	...
	public void processB2csFile(Message message, AppExecContext context) {
		...
		if (checkHeaderFormat.getValue0()) {
			gstr1aB2csStructuralProcess.processData(listOfB2cs,
					updateFileStatus);
		} else {
