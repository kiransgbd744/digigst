...
@Entity
@Table(name = "GSTR1_SUMMARY_NILEXTNON")
@Data
public class Gstr1NilNonExmptSummaryEntity {

	@Expose
	@Id
	@SerializedName("id")
	@SequenceGenerator(name = "sequence", sequenceName = "GSTR1_SUMMARY_NILEXTNON_SEQ", allocationSize = 100)
