...
public class Gstr6OriginalCreditNoteDateValidtion implements ValidationRule {
	...
	public List<ProcessingResult> isValid(int idx,Object obj, Object[] row,
		...
		if (!isPresent(obj)) return errors;
			...
			errors.add(new ProcessingResult(APP_VALIDATION, "ER3024",
					"Invalid Original Credit Note Date", location));
			return errors;
		}
