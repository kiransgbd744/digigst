 ...
 */
@Entity
@Table(name = "GETGSTR1A_CDNURA_ITEM")
public class GetGstr1ACdnuraItemEntity {

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "GETGSTR1A_CDNURA_ITEM_SEQ", allocationSize = 100)
	...
	private GetGstr1ACdnuraHeaderEntity document;
	...
	public GetGstr1ACdnuraHeaderEntity getDocument() {
		return document;
	}

	public void setDocument(GetGstr1ACdnuraHeaderEntity document) {
