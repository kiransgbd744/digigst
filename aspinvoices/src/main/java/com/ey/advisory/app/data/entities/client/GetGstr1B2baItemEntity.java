 ...
 */
@Entity
@Table(name = "GETGSTR1_B2BA_ITEM")
public class GetGstr1B2baItemEntity {

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "GETGSTR1_B2BA_ITEM_SEQ", allocationSize = 100)
	...
	private GetGstr1B2baHeaderEntity document;
	...
	public GetGstr1B2baHeaderEntity getDocument() {
		return document;
	}

	public void setDocument(GetGstr1B2baHeaderEntity document) {
