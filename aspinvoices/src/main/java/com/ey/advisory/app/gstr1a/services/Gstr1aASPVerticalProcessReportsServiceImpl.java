...
import com.ey.advisory.app.services.reports.Gstr1OutwardVerticalProcessAdvAdjDao;
import com.ey.advisory.app.services.reports.Gstr1OutwardVerticalProcessInvDao;
import com.ey.advisory.app.services.reports.Gstr1OutwardVerticalProcessedAdvanceReceivedDao;
import com.ey.advisory.app.services.reports.Gstr1OutwardVerticalProcessedB2CSDao;
...
@Service("Gstr1aASPVerticalProcessReportsServiceImpl")
public class Gstr1aASPVerticalProcessReportsServiceImpl
		implements Gstr1ASPVerticalProcessReportsService {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(Gstr1aASPVerticalProcessReportsServiceImpl.class);

	@Autowired
	CommonUtility commonUtility;

	@Autowired
	@Qualifier("Gstr1aOutwardVerticalProcessedB2CSDaoImpl")
	Gstr1OutwardVerticalProcessedB2CSDao gstr1OutwardVerticalProcessedB2CSDao;

	@Autowired
	@Qualifier("Gstr1aOutwardVerticalProcessedAdvanceReceivedDaoImpl")
	Gstr1OutwardVerticalProcessedAdvanceReceivedDao gstr1OutwardVerticalProcessedAdvanceReceivedDao;
	@Autowired
	@Qualifier("Gstr1aOutwardVerticalProcessAdvAdjDaoImpl")
	Gstr1OutwardVerticalProcessAdvAdjDao gstr1OutwardVerticalProcessAdvAdjDao;

	@Autowired
	@Qualifier("Gstr1aOutwardVerticalProcessInvDaoImpl")
	...
	public Workbook findReports(SearchCriteria criteria, PageRequest pageReq) {
		...
		workbook = createWorkbookWithExcelTemplate("ReportTemplates",
				"GSTR1A_Asp_ProcessedRecords_Outward_Vertical.xlsx");
