...
@Slf4j
@Component("gstr1AHSNSummaryAtGstnImpl")
public class Gstr1AHSNSummaryAtGstnImpl implements Gstr1InvoicesAtGstn {

	@Autowired
	@Qualifier("gstr1AHSNSummaryDataAtGstnImpl")
	private Gstr1AHSNSummaryDataAtGstn gstr1AHSNSummaryDataAtGstn;
	...
	public Long findInvFromGstn(Gstr1GetInvoicesReqDto dto,
		...
		try {
			...
			reqId = gstr1AHSNSummaryDataAtGstn.gstr1HSNSummaryDataAtGstn(dto,
					groupCode, type, json);
			...
			throw new APIException(
					"Unexpected error while executing Gstr1 Get Hsn summary");
