...
public class ItemRateValidationRule implements ValidationRule {
	...
	public List<ProcessingResult> isValid(Object obj, Object[] row,
		...
		if (!isPresent(obj)) {
			...
			errors.add(new ProcessingResult(APP_VALIDATION, "ER1645",
					"Rate should be Zero in case of NIL, NON, EXT goods or services.",
					location));
			return errors;
		}
