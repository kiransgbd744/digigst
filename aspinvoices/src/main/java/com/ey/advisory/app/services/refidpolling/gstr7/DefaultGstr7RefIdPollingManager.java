 ...
 *
 */
@Service("DefaultGstr7RefIdPollingManager")
public class DefaultGstr7RefIdPollingManager
		implements Gstr7RefIdPollingManger {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(DefaultGstr7RefIdPollingManager.class);
	@Autowired
	@Qualifier("DefaultGstr7BatchIdPollingManager")
	...
	@Override
	public ResponseEntity<String> processGstr7RefIds(PollingMessage reqDto,
			String groupcode) {
