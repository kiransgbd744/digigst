 ...
 *
 */
@Repository("GetGstr2StagingEcomInvoicesRepository")
@Transactional(propagation = Propagation.REQUIRED, readOnly = false)
public interface GetGstr2StagingEcomInvoicesRepository
		extends CrudRepository<GetGstr2aStagingEcomInvoicesHeaderEntity, Long> {

	
	@Modifying
	@Query("UPDATE GetGstr2aStagingEcomInvoicesHeaderEntity b SET b.isDelete = true,b.modifiedBy = 'SYSTEM'  , b.modifiedOn =:modifiedOn  WHERE"
	...
	@Query("from GetGstr2aStagingEcomInvoicesHeaderEntity where sgstin=:sgstin and cgstin=:cgstin and invDate=:invDate and invNum=:invNum and invType=:invType")
	List<GetGstr2aStagingEcomInvoicesHeaderEntity> findByInvoiceKey(
	...
	@Query("SELECT COUNT(*) FROM GetGstr2aStagingEcomInvoicesHeaderEntity "
			+ "WHERE cgstin=:gstin AND returnPeriod = :taxperiod and isDelete = false")
	public int gstinCount(@Param("gstin") String gstin,
			@Param("taxperiod") String taxperiod);

	@Modifying
	@Query("UPDATE GetGstr2aStagingEcomInvoicesHeaderEntity b SET b.isDelete = true, b.modifiedOn=:modifiedOn WHERE"
