 ...
 */
@Entity
@Table(name = "GETGSTR6A_B2BA_ITEM")
public class GetGstr6aB2baItemEntity {
	...
	protected GetGstr6aB2baHeaderEntity header;
	...
	public GetGstr6aB2baHeaderEntity getHeader() {
		return header;
	}

	public void setHeader(GetGstr6aB2baHeaderEntity header) {
		this.header = header;
	}
