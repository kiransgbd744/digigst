 ...
 *
 */
public class ShipToGstinValidation implements ValidationRule {
	...
	public List<ProcessingResult> isValid(int idx, Object obj, Object[] row,
		...
		if (matcher.matches() || matcher1.matches()) {
			...
			errorLocations.add(GSTConstants.SHIP_TO_GSTIN);
			TransDocProcessingResultLoc location = 
					new TransDocProcessingResultLoc(
					null, errorLocations.toArray());
			errors.add(new ProcessingResult(APP_VALIDATION, "ER10036",
					             "Invalid Ship to GSTIN", location));
			return errors;
		}
		return errors;
	}
