...
@Slf4j
@Component("CMEcomGstinValidator")
public class CMEcomGstinValidator
	...
	public static void main(String[] args) {
		CMEcomGstinValidator a = new CMEcomGstinValidator();
		OutwardTransDocument doc = new OutwardTransDocument();
		// ecomgstin--33GSPTN1234G1CA
		// reggstin--33GSPTN1234G1ZA
		doc.setTcsFlag("O");
		a.validate(doc, null);
