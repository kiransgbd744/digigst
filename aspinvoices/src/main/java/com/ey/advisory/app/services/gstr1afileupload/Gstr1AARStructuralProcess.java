...
import com.ey.advisory.app.services.doc.gstr1a.SRFileToGstr1AATExcelDetailsConvertion;
import com.ey.advisory.app.services.strcutvalidation.advanceReceived.Gstr1AARStructValidationChain;
 ...
 *
 */
@Component("Gstr1AARStructuralProcess")
@Slf4j
public class Gstr1AARStructuralProcess {
	@Autowired
	@Qualifier("Gstr1AARStructValidationChain")
	private Gstr1AARStructValidationChain arStructValidationChain;

	@Autowired
	@Qualifier("Gstr1AARBusinessProcess")
	private Gstr1AARBusinessProcess gstr1ARBusinessProcess;

	@Autowired
	@Qualifier("SRFileToGstr1AATExcelDetailsConvertion")
	private SRFileToGstr1AATExcelDetailsConvertion sRFileToATExcelDetailsConvertion;
	...
	public void processData(List<Object[]> listOfAt,
		...
		List<Gstr1AAsEnteredAREntity> strErrRecords = new ArrayList<>();
		List<Gstr1AAsEnteredAREntity> strProcessRecords = new ArrayList<>();
		...
		List<Gstr1AAsEnteredAREntity> excelData = sRFileToATExcelDetailsConvertion
				.convertSRFileToATExcel(listOfAt, updateFileStatus);
		LOGGER.error("Starting Excel data Dumping process in to Table");
		List<Gstr1AAsEnteredAREntity> excelDataSave = gstr1ATAsEnteredRepository
				.saveAll(excelData);
		LOGGER.error("Starting Excel data Dumping process in to Table");
		...
		for (Gstr1AAsEnteredAREntity id : excelDataSave) {
