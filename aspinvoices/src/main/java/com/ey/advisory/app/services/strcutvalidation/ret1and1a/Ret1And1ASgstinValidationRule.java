...
public class Ret1And1ASgstinValidationRule implements ValidationRule {
	...
	public List<ProcessingResult> isValid(Object obj, Object[] row,
		...
		if (!isPresent(obj)) {
			...
			errors.add(new ProcessingResult(APP_VALIDATION, "ER1804",
			...
			if (obj.toString().trim().length() != 15 || !matcher.matches()) {
				...
				errors.add(new ProcessingResult(APP_VALIDATION, "ER1802",
						"Invalid SGSTIN.", location));
				return errors;
