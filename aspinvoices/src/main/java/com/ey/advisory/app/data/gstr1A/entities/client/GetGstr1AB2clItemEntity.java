 ...
 */
@Entity
@Table(name = "GETGSTR1A_B2CL_ITEM")
public class GetGstr1AB2clItemEntity {

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "GETGSTR1A_B2CL_ITEM_SEQ", allocationSize = 100)
	...
	private GetGstr1AB2clHeaderEntity document;
	...
	public GetGstr1AB2clHeaderEntity getDocument() {
		return document;
	}

	public void setDocument(GetGstr1AB2clHeaderEntity document) {
