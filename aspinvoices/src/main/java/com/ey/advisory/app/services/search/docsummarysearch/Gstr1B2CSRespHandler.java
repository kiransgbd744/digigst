...
@Service("Gstr1B2CSRespHandler")
public class Gstr1B2CSRespHandler {
	...
	public JsonElement handleB2CSResp(List<? extends Gstr1SummaryDto> list,
			Gstr1SummaryReqDto gstr1SummaryRequest) {
		

		List<Gstr1BasicSummarySectionDto> b2csEySummary = new ArrayList<>();
		for (Gstr1SummaryDto gstr1Summary : list) {
			b2csEySummary = gstr1Summary.getB2cs().getEySummary();
		}
...
*/				/**
		...
		JsonElement b2csRespBody = gstr1SummaryStructure
				.b2csStructure(b2csEySummary, gstnList);
