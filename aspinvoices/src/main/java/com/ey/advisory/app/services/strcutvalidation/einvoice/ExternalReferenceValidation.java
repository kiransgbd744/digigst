 ...
 *
 */
public class ExternalReferenceValidation implements ValidationRule {
	...
	public List<ProcessingResult> isValid(int idx, Object obj, Object[] row,
		...
		/*if (obj.toString().trim().length() > 20) {
			...
			errorLocations.add(GSTConstants.EXTERNAL_REFERENCE);
			TransDocProcessingResultLoc location = 
					new TransDocProcessingResultLoc(
					null, errorLocations.toArray());
			errors.add(new ProcessingResult(APP_VALIDATION, "ER10105",
					          "Invalid External Reference.", location));
			return errors;
		}
