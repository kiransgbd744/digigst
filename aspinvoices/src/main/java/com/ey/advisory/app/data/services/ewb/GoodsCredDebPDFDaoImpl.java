...
@Component("GoodsCredDebPDFDaoImpl")
@Slf4j
public class GoodsCredDebPDFDaoImpl implements GoodsCredDebPdf {
	...
	private static final Map<String, String> supplyType = ImmutableMap
	...
	private static final Map<String, String> REVERSECHARGE = ImmutableMap
	...
	public JasperPrint generateCredDebPdfReport(String id, String docNo,
		...
		String source = "jasperReports/GoodscredInvoice (002).jrxml";
		if (LOGGER.isDebugEnabled()) {
			String msg = String.format(
					"Inside generateCredDebPdfReport for docNo: %s", docNo);
			LOGGER.debug(msg);
		}
		...
		try {
			...
			parameters.put("statecessamount",
	...
	public static String signedQrCodeGeneration(OutwardTransDocument out,
			...
			String marchentCode, String signedqr, String a20) {
	...
	public static String q19SetVlau(String a19) {
		if ("A".equalsIgnoreCase(a19)) {
			return a19 = "02";
		} else if ("B".equalsIgnoreCase(a19)) {
			return a19 = "03";
		} else if ("C".equalsIgnoreCase(a19)) {
			return a19 = "04";
		} else if ("D".equalsIgnoreCase(a19)) {
			return a19 = "05";
		}
	...
	public static String q15SetVlau(String a15) {

		if ("B".equalsIgnoreCase(a15)) {
			return a15 = "22";
		}
		return "15";
	}
	...
	private static String amount(OutwardTransDocument out) {
		...
		if (out.getIgstAmount() != null) {
			amount.append("IGST:" + out.getIgstAmount());
		}
		if (out.getIgstAmount() == null) {
