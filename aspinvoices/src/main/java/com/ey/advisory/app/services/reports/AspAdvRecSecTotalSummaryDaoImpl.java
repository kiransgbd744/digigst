...
@Component("AspAdvRecSecTotalSummaryDaoImpl")
public class AspAdvRecSecTotalSummaryDaoImpl implements Gstr1AdvRecSavableDao {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(AspAdvRecSecTotalSummaryDaoImpl.class);
