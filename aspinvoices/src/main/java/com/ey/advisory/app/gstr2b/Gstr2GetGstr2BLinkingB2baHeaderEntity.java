...
@AllArgsConstructor
@Entity
@Table(name = "GETGSTR2B_LINKING_B2BA_HEADER")
public class Gstr2GetGstr2BLinkingB2baHeaderEntity {

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "GETGSTR2B_B2BA_HEADER_SEQ", allocationSize = 100)
	...
	protected List<Gstr2GetGstr2BLinkingB2baItemEntity> lineItems = new ArrayList<>();
}
