...
@Component("Gstr1aGetReportDaoImpl")
@Slf4j
public class Gstr1aGetReportDaoImpl implements Gstr1aGetDao {
	...
	private String createGstnErrorQueryString(String buildQuery) {
		...
		return " SELECT SUPPLIER_GSTIN,RETURN_PERIOD,TABLE_TYPE,INV_TYPE,TYPE, "
				...
				+ "GETGSTR1_B2B_HEADER HDR INNER JOIN GETGSTR1_B2B_ITEM ITM "
				...
				+ " '' D_FLAG,HDR.DERIVED_RET_PERIOD,"
				+ "'' IRN_NUM, '' IRN_GEN_DATE, '' IRN_SOURCE_TYPE "
				+ "FROM GETGSTR1_B2BA_HEADER "
				+ "HDR INNER JOIN GETGSTR1_B2BA_ITEM ITM ON HDR.ID = ITM.HEADER_ID "
				...
				+ "FROM GETGSTR1_CDNR_HEADER "
				+ "HDR INNER JOIN GETGSTR1_CDNR_ITEM ITM ON HDR.ID = ITM.HEADER_ID "
				+ "AND HDR.DERIVED_RET_PERIOD = ITM.DERIVED_RET_PERIOD "
				+ "LEFT JOIN GETANX1_BATCH_TABLE BT ON HDR.BATCH_ID = BT.ID "
				+ "WHERE HDR.IS_DELETE = FALSE AND BT.IS_DELETE = FALSE) "
				+ " UNION ALL "
				...
				+ " '' IRN_SOURCE_TYPE FROM GETGSTR1_CDNRA_HEADER "
				+ "HDR INNER JOIN GETGSTR1_CDNRA_ITEM ITM "
				...
				+ " FROM GETGSTR1_CDNUR_HEADER HDR INNER JOIN GETGSTR1_CDNUR_ITEM ITM "
				+ "ON HDR.ID = ITM.HEADER_ID AND "
				+ "HDR.DERIVED_RET_PERIOD = ITM.DERIVED_RET_PERIOD LEFT JOIN "
				+ "GETANX1_BATCH_TABLE BT ON HDR.BATCH_ID = BT.ID "
				+ "WHERE HDR.IS_DELETE = FALSE AND BT.IS_DELETE = FALSE "
				...
				+ "GETGSTR1_CDNURA_HEADER HDR INNER JOIN GETGSTR1_CDNURA_ITEM ITM "
				+ "ON HDR.ID = ITM.HEADER_ID AND "
				...
				+ "HDR.IRN_SOURCE_TYPE FROM GETGSTR1_EXP_HEADER "
				+ "HDR INNER JOIN GETGSTR1_EXP_ITEM ITM ON HDR.ID = ITM.HEADER_ID "
				+ "AND HDR.DERIVED_RET_PERIOD = ITM.DERIVED_RET_PERIOD "
				+ "LEFT JOIN GETANX1_BATCH_TABLE BT ON HDR.BATCH_ID = BT.ID "
				+ "WHERE HDR.IS_DELETE = FALSE AND BT.IS_DELETE = FALSE "
				+ " UNION ALL "
				...
				+ "HDR INNER JOIN GETGSTR1_EXPA_ITEM ITM ON HDR.ID = ITM.HEADER_ID "
				+ "AND HDR.DERIVED_RET_PERIOD = ITM.DERIVED_RET_PERIOD "
				+ "LEFT JOIN GETANX1_BATCH_TABLE BT ON HDR.BATCH_ID = BT.ID "
				+ "WHERE HDR.IS_DELETE = FALSE AND BT.IS_DELETE = FALSE "
				+ " UNION ALL "
				...
				+ " '' IRN_SOURCE_TYPE FROM GETGSTR1_B2CL_HEADER "
				+ "HDR INNER JOIN GETGSTR1_B2CL_ITEM ITM ON HDR.ID = ITM.HEADER_ID "
				+ "AND HDR.DERIVED_RET_PERIOD = ITM.DERIVED_RET_PERIOD "
				+ "LEFT JOIN GETANX1_BATCH_TABLE BT ON HDR.BATCH_ID = BT.ID "
				+ "WHERE HDR.IS_DELETE = FALSE AND BT.IS_DELETE = FALSE "
				+ " UNION ALL "
				...
				+ "BT.IS_FILED,'' D_FLAG,HDR.DERIVED_RET_PERIOD,"
				+ " '' IRN_NUM, '' IRN_GEN_DATE, '' IRN_SOURCE_TYPE FROM "
				+ "GETGSTR1_B2CLA_HEADER HDR INNER JOIN GETGSTR1_B2CLA_ITEM ITM "
				+ "ON HDR.ID = ITM.HEADER_ID "
				+ "AND HDR.DERIVED_RET_PERIOD = ITM.DERIVED_RET_PERIOD "
				+ "LEFT JOIN GETANX1_BATCH_TABLE BT ON HDR.BATCH_ID = BT.ID "
				+ "WHERE HDR.IS_DELETE = FALSE AND BT.IS_DELETE = FALSE ) "
