 ...
 * 
 */
public class Gstr6ProcessedRecCurrentPeriodDto {
	...
	public void setgLCodeAdvaloremCess(String gLCodeAdvaloremCess) {
		this.gLCodeAdvaloremCess = gLCodeAdvaloremCess;
	}
	...
	public void setDifferentialFlag(String differentialFlag) {
		this.differentialFlag = differentialFlag;
	}
	...
	public void setAdvaloremCessRate(String advaloremCessRate) {
		this.advaloremCessRate = advaloremCessRate;
	}
	...
	public void setAdvaloremCessAmount(String advaloremCessAmount) {
		this.advaloremCessAmount = advaloremCessAmount;
	}
	...
	public void setSpecificCessRate(String specificCessRate) {
		this.specificCessRate = specificCessRate;
	}
	...
	public void setSpecificCessAmount(String specificCessAmount) {
		this.specificCessAmount = specificCessAmount;
	}
	...
	public void setAdjustmentReferenceNo(String adjustmentReferenceNo) {
		this.adjustmentReferenceNo = adjustmentReferenceNo;
	}
	...
	public void setAdjustmentReferenceDate(String adjustmentReferenceDate) {
		this.adjustmentReferenceDate = adjustmentReferenceDate;
	}
	...
	public void setTaxableValueAdjusted(String taxableValueAdjusted) {
		this.taxableValueAdjusted = taxableValueAdjusted;
	}
	...
	public void setIntegratedTaxAmountAdjusted(
			String integratedTaxAmountAdjusted) {
		this.integratedTaxAmountAdjusted = integratedTaxAmountAdjusted;
	}
	...
	public void setCentralTaxAmountAdjusted(String centralTaxAmountAdjusted) {
		this.centralTaxAmountAdjusted = centralTaxAmountAdjusted;
	}
	...
	public void setStateUTTaxAmountAdjusted(String stateUTTaxAmountAdjusted) {
		this.stateUTTaxAmountAdjusted = stateUTTaxAmountAdjusted;
	}
	...
	public void setAdvaloremCessAmountAdjusted(
			String advaloremCessAmountAdjusted) {
		this.advaloremCessAmountAdjusted = advaloremCessAmountAdjusted;
	}
	...
	public void setSpecificCessAmountAdjusted(
			String specificCessAmountAdjusted) {
		this.specificCessAmountAdjusted = specificCessAmountAdjusted;
	}
	...
	public void setStateCessAmountAdjusted(String stateCessAmountAdjusted) {
		this.stateCessAmountAdjusted = stateCessAmountAdjusted;
	}
	...
	public String toString() {
		return "Gstr6ProcessedRecCurrentPeriodDto [userID=" + userID
				+ ", sourceFileName=" + sourceFileName + ", profitCentre="
				+ profitCentre + ", plant=" + plant + ", division=" + division
				+ ", location=" + location + ", purchaseOrganisation="
				+ purchaseOrganisation + ", userAccess1=" + userAccess1
				...
				+ ", gLCodeSGST=" + gLCodeSGST + ", gLCodeAdvaloremCess="
				+ gLCodeAdvaloremCess + ", gLCodeSpecificCess="
				+ gLCodeSpecificCess + ", gLCodeStateCess=" + gLCodeStateCess
				+ ", returnPeriod=" + returnPeriod + ", recipientGSTIN="
				+ recipientGSTIN + ", documentType=" + documentType
				+ ", supplyType=" + supplyType + ", documentNumber="
				...
				+ ", cRDRPreGST=" + cRDRPreGST + ", lineNumber=" + lineNumber
				+ ", supplierGSTIN=" + supplierGSTIN + ", supplierType="
				+ supplierType + ", differentialFlag=" + differentialFlag
				...
				+ ", invoicevalueasp=" + invoicevalueasp + ", uploadSource="
				+ uploadSource + ", sourceID=" + sourceID + ", fileName="
