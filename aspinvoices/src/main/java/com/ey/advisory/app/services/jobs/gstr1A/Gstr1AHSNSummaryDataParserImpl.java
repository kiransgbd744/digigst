...
@Component("gstr1AHSNSummaryDataParserImpl")
@Slf4j
public class Gstr1AHSNSummaryDataParserImpl
		implements Gstr1AHSNSummaryDataParser {
	...
	public List<GetGstr1AHSNOrSACInvoicesEntity> gstr1HSNSummaryDataParser(
		...
		List<GetGstr1AHSNOrSACInvoicesEntity> entities = new ArrayList<>();
	...
	private void saveData(Gstr1GetInvoicesReqDto dto,
			List<GetGstr1AHSNOrSACInvoicesEntity> entities,
			HSNSummaryInvoices hsnSummaryInvoices,
			HSNSummaryInvData hsnSummaryInvData, String recordType) {
		GetGstr1AHSNOrSACInvoicesEntity entity = new GetGstr1AHSNOrSACInvoicesEntity();
		/**
		 * Input data
		 */
