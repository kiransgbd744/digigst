...
public class PurchasevoucherDateValidationRule implements ValidationRule {
	...
	public List<ProcessingResult> isValid(int idx,Object obj, Object[] row,
		...
		if (!isPresent(obj)) return errors;
			...
			if (date == null) {
				...
				errorLocations.add(GSTConstants.PURCHASE_DATE);
				TransDocProcessingResultLoc location = new TransDocProcessingResultLoc(
						idx, errorLocations.toArray());
				errors.add(new ProcessingResult(APP_VALIDATION, "ER1113",
						"Invalid Purchase Voucher Date", location));
				return errors;
			}
