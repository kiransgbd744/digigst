 ...
 */
@Slf4j
@Component("InwardErrorsFileStatusConvertor")
public class InwardErrorsFileStatusConvertor implements ReportConvertor {
	...
	public Object convert(Object[] arr, String reportType) {
		...
		obj.setDocumentNumber(
			    arr[6] != null ? DownloadReportsConstant.CSVCHARACTER + arr[6].toString() : null);
		...
		obj.setQuantity(arr[60] != null
				? convertToStringAndConcat(arr[60].toString()) : null);
		obj.setFreeQuantity(arr[61] != null
				? convertToStringAndConcat(arr[61].toString()) : null);
		if (docType != null && (docType.equalsIgnoreCase("CR")
			...
			obj.setItemAmount(
					convertToStringAndConcat(CheckForNegativeValue(arr[63])));
			obj.setItemDiscount(
					convertToStringAndConcat(CheckForNegativeValue(arr[64])));
			obj.setPreTaxAmount(
					convertToStringAndConcat(CheckForNegativeValue(arr[65])));
			obj.setItemAssessableAmount(
					convertToStringAndConcat(CheckForNegativeValue(arr[66])));
			obj.setiGSTAmount(
					convertToStringAndConcat(CheckForNegativeValue(arr[68])));
			obj.setcGSTAmount(
					convertToStringAndConcat(CheckForNegativeValue(arr[70])));
			obj.setsGSTAmount(
					convertToStringAndConcat(CheckForNegativeValue(arr[72])));
			obj.setCessAdvaloremAmount(
					convertToStringAndConcat(CheckForNegativeValue(arr[74])));
			obj.setCessSpecificAmount(
					convertToStringAndConcat(CheckForNegativeValue(arr[76])));
			obj.setStateCessAdvaloremAmount(
					convertToStringAndConcat(CheckForNegativeValue(arr[78])));
			obj.setStateCessSpecificAmount(
					convertToStringAndConcat(CheckForNegativeValue(arr[80])));
			obj.setItemOtherCharges(
					convertToStringAndConcat(CheckForNegativeValue(arr[81])));
			obj.setTotalItemAmount(
					convertToStringAndConcat(CheckForNegativeValue(arr[82])));
			obj.setInvoiceOtherCharges(
					convertToStringAndConcat(CheckForNegativeValue(arr[83])));
			obj.setInvoiceAssessableAmount(
					convertToStringAndConcat(CheckForNegativeValue(arr[84])));
			obj.setInvoiceIGSTAmount(
					convertToStringAndConcat(CheckForNegativeValue(arr[85])));
			obj.setInvoiceCGSTAmount(
					convertToStringAndConcat(CheckForNegativeValue(arr[86])));
			obj.setInvoiceSGSTAmount(
					convertToStringAndConcat(CheckForNegativeValue(arr[87])));
			obj.setInvoiceCessAdvaloremAmount(
					convertToStringAndConcat(CheckForNegativeValue(arr[88])));
			obj.setInvoiceCessSpecificAmount(
					convertToStringAndConcat(CheckForNegativeValue(arr[89])));
			obj.setInvoiceStateCessAdvaloremAmount(
					convertToStringAndConcat(CheckForNegativeValue(arr[90])));
			obj.setInvoiceStateCessSpecificAmount(
					convertToStringAndConcat(CheckForNegativeValue(arr[91])));
			obj.setInvoiceValue(
					convertToStringAndConcat(CheckForNegativeValue(arr[92])));
			obj.setAvailableIgst(
					convertToStringAndConcat(CheckForNegativeValue(arr[97])));
			obj.setAvailableCgst(
					convertToStringAndConcat(CheckForNegativeValue(arr[98])));
			obj.setAvailableSgst(
					convertToStringAndConcat(CheckForNegativeValue(arr[99])));
			obj.setAvailableCess(
					convertToStringAndConcat(CheckForNegativeValue(arr[100])));
			obj.settCSAmountIncomeTax(
					convertToStringAndConcat(CheckForNegativeValue(arr[105])));
			obj.setInvoiceValueFC(
					convertToStringAndConcat(CheckForNegativeValue(arr[108])));
		} else {
			obj.setItemAmount(arr[63] != null
					? convertToStringAndConcat(arr[63].toString()) : null);
			obj.setItemDiscount(arr[64] != null
					? convertToStringAndConcat(arr[64].toString()) : null);
			obj.setPreTaxAmount(arr[65] != null
					? convertToStringAndConcat(arr[65].toString()) : null);
			obj.setItemAssessableAmount(arr[66] != null
					? convertToStringAndConcat(arr[66].toString()) : null);
			obj.setiGSTAmount(arr[68] != null
					? convertToStringAndConcat(arr[68].toString()) : null);
			obj.setcGSTAmount(arr[70] != null
					? convertToStringAndConcat(arr[70].toString()) : null);
			obj.setsGSTAmount(arr[72] != null
					? convertToStringAndConcat(arr[72].toString()) : null);
			obj.setCessAdvaloremAmount(arr[74] != null
					? convertToStringAndConcat(arr[74].toString()) : null);
			obj.setCessSpecificAmount(arr[76] != null
					? convertToStringAndConcat(arr[76].toString()) : null);
			obj.setStateCessAdvaloremAmount(arr[78] != null
					? convertToStringAndConcat(arr[78].toString()) : null);
			obj.setStateCessSpecificAmount(arr[80] != null
					? convertToStringAndConcat(arr[80].toString()) : null);
			obj.setItemOtherCharges(arr[81] != null
					? convertToStringAndConcat(arr[81].toString()) : null);
			obj.setTotalItemAmount(arr[82] != null
					? convertToStringAndConcat(arr[82].toString()) : null);
			obj.setInvoiceOtherCharges(arr[83] != null
					? convertToStringAndConcat(arr[83].toString()) : null);
			obj.setInvoiceAssessableAmount(arr[84] != null
					? convertToStringAndConcat(arr[84].toString()) : null);
			obj.setInvoiceIGSTAmount(arr[85] != null
					? convertToStringAndConcat(arr[85].toString()) : null);
			obj.setInvoiceCGSTAmount(arr[86] != null
					? convertToStringAndConcat(arr[86].toString()) : null);
			obj.setInvoiceSGSTAmount(arr[87] != null
					? convertToStringAndConcat(arr[87].toString()) : null);
			obj.setInvoiceCessAdvaloremAmount(arr[88] != null
					? convertToStringAndConcat(arr[88].toString()) : null);
			obj.setInvoiceCessSpecificAmount(arr[89] != null
					? convertToStringAndConcat(arr[89].toString()) : null);
			obj.setInvoiceStateCessAdvaloremAmount(arr[90] != null
					? convertToStringAndConcat(arr[90].toString()) : null);
			obj.setInvoiceStateCessSpecificAmount(arr[91] != null
					? convertToStringAndConcat(arr[91].toString()) : null);
			obj.setInvoiceValue(arr[92] != null
					? convertToStringAndConcat(arr[92].toString()) : null);
			obj.setAvailableIgst(arr[97] != null
					? convertToStringAndConcat(arr[97].toString()) : null);
			obj.setAvailableCgst(arr[98] != null
					? convertToStringAndConcat(arr[98].toString()) : null);
			obj.setAvailableSgst(arr[99] != null
					? convertToStringAndConcat(arr[99].toString()) : null);
			obj.setAvailableCess(arr[100] != null
					? convertToStringAndConcat(arr[100].toString()) : null);
			obj.settCSAmountIncomeTax(arr[105] != null
					? convertToStringAndConcat(arr[105].toString()) : null);
			obj.setInvoiceValueFC(arr[108] != null
					? convertToStringAndConcat(arr[108].toString()) : null);
		}
		obj.setUnitPrice(arr[62] != null
				? convertToStringAndConcat(arr[62].toString()) : null);
		obj.setiGSTRate(arr[67] != null
				? convertToStringAndConcat(arr[67].toString()) : null);
		obj.setcGSTRate(arr[69] != null
				? convertToStringAndConcat(arr[69].toString()) : null);
		obj.setsGSTRate(arr[71] != null
				? convertToStringAndConcat(arr[71].toString()) : null);
		obj.setCessAdvaloremRate(arr[73] != null
				? convertToStringAndConcat(arr[73].toString()) : null);
		obj.setCessSpecificRate(arr[75] != null
				? convertToStringAndConcat(arr[75].toString()) : null);
		obj.setStateCessAdvaloremRate(arr[77] != null
				? convertToStringAndConcat(arr[77].toString()) : null);
		obj.setStateCessSpecificRate(arr[79] != null
				? convertToStringAndConcat(arr[79].toString()) : null);
		obj.setRoundOff(arr[93] != null
				? convertToStringAndConcat(arr[93].toString()) : null);
		...
		obj.settCSRateIncomeTax(arr[104] != null
				? convertToStringAndConcat(arr[104].toString()) : null);
		...
		obj.setPaidAmount(arr[134] != null
				? convertToStringAndConcat(arr[134].toString()) : null);
		obj.setBalanceAmount(arr[135] != null
				? convertToStringAndConcat(arr[135].toString()) : null);
		...
		if (docType != null && (docType.equalsIgnoreCase("CR")
				...
				|| docType.equalsIgnoreCase("ADJ"))) {
			obj.setCif(
					convertToStringAndConcat(CheckForNegativeValue(arr[166])));
			obj.setCustomDuty(
					convertToStringAndConcat(CheckForNegativeValue(arr[167])));
			obj.settCSIGSTAmount(
					convertToStringAndConcat(CheckForNegativeValue(arr[171])));
			obj.settCSCGSTAmount(
					convertToStringAndConcat(CheckForNegativeValue(arr[172])));
			obj.settCSSGSTAmount(
					convertToStringAndConcat(CheckForNegativeValue(arr[173])));
			obj.settDSIGSTAmount(
					convertToStringAndConcat(CheckForNegativeValue(arr[175])));
			obj.settDSCGSTAmount(
					convertToStringAndConcat(CheckForNegativeValue(arr[176])));
			obj.settDSSGSTAmount(
					convertToStringAndConcat(CheckForNegativeValue(arr[177])));
		} else {
			obj.setCif(arr[166] != null
					? convertToStringAndConcat(arr[166].toString()) : null);
			obj.setCustomDuty(arr[167] != null
					? convertToStringAndConcat(arr[167].toString()) : null);
			obj.settCSIGSTAmount(arr[171] != null
					? convertToStringAndConcat(arr[171].toString()) : null);
			obj.settCSCGSTAmount(arr[172] != null
					? convertToStringAndConcat(arr[172].toString()) : null);
			obj.settCSSGSTAmount(arr[173] != null
					? convertToStringAndConcat(arr[173].toString()) : null);
			obj.settDSIGSTAmount(arr[175] != null
					? convertToStringAndConcat(arr[175].toString()) : null);
			obj.settDSCGSTAmount(arr[176] != null
					? convertToStringAndConcat(arr[176].toString()) : null);
			obj.settDSSGSTAmount(arr[177] != null
					? convertToStringAndConcat(arr[177].toString()) : null);
		}
		obj.setStateApplyingCess(arr[165] != null ? arr[165].toString() : null);
		obj.setExchangeRate(arr[168] != null
				? convertToStringAndConcat(arr[168].toString()) : null);
		...
		obj.setGlAssessableValue(arr[195] != null
				? convertToStringAndConcat(arr[195].toString()) : null);
		obj.setGlIGST(arr[196] != null
				? convertToStringAndConcat(arr[196].toString()) : null);
		obj.setGlCGST(arr[197] != null
				? convertToStringAndConcat(arr[197].toString()) : null);
		obj.setGlSGST(arr[198] != null
				? convertToStringAndConcat(arr[198].toString()) : null);
		obj.setGlAdvaloremCess(arr[199] != null
				? convertToStringAndConcat(arr[199].toString()) : null);
		obj.setGlSpecificCess(arr[200] != null
				? convertToStringAndConcat(arr[200].toString()) : null);
		obj.setgLStateCessAdvalorem(arr[201] != null
				? convertToStringAndConcat(arr[201].toString()) : null);
		obj.setgLStateCessSpecific(arr[202] != null
				? convertToStringAndConcat(arr[202].toString()) : null);
		...
		if (docType != null && (docType.equalsIgnoreCase("CR")
			...
			obj.setPurchaseOrderValue(
					convertToStringAndConcat(CheckForNegativeValue(arr[204])));
		} else {
			obj.setPurchaseOrderValue(arr[204] != null
					? convertToStringAndConcat(arr[204].toString()) : null);
		}
		...
		obj.setSource(arr[244] != null ? arr[244].toString() : null);
		obj.setSourceID(arr[245] != null ? arr[245].toString() : null);
		obj.setFileName(arr[246] != null ? arr[246].toString() : null);
		/*
		 * obj.setDigiGSTDateTime( arr[247] != null ? arr[247].toString() :
		 * null);
		 */

		if (arr[247] != null) {
			Timestamp timeStamp = (Timestamp) arr[247];
			/*
			 * LocalDateTime localDT = timeStamp.toLocalDateTime();
			 * LocalDateTime convertref =
			 * EYDateUtil.toISTDateTimeFromUTC(localDT);
			 */ obj.setDigiGSTDateTime(dateChange(timeStamp));
		} else {
			obj.setDigiGSTDateTime(null);
		}
		//US 131855
		/*obj.setSource(arr[244] != null ? arr[244].toString() : null);
		obj.setSourceID(arr[244] != null ? arr[244].toString() : null);
		obj.setSourceFileName(arr[244] != null ? arr[244].toString() : null);
		obj.setDigiGSTDateTime(arr[244] != null ? arr[244].toString() : null);
		*/

		return obj;
	}

	private static String CheckForNegativeValue(Object value) {
		if (value != null) {

			if (value instanceof String) {
				if (value.toString().equalsIgnoreCase("0")
						|| value.toString().equalsIgnoreCase("0.00")
						|| value.toString().equalsIgnoreCase("0.000")) {
					return "0";
				} else {
	...
	private String convertToStringAndConcat(Object obj) {
...
//		String str = obj.toString().split("\\.")[0];
	...
	private static String deriveOldReturnPeriod(Object[] arr, String docNum) {
		try {
			if (arr.length >= 249 && arr[248] != null) {
				return arr[248].toString();
			} else {
				return null;
			}
		} catch (Exception e) {
			LOGGER.error("error for docNum:{}", docNum, e);
			return null;
		}
