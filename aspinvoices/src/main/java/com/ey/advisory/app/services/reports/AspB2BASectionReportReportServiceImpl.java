...
import com.ey.advisory.core.search.SearchCriteria;
	...
	@Service("AspB2BASectionReportReportServiceImpl")
	public class AspB2BASectionReportReportServiceImpl
			implements Gstr1ReviewSummReportsService {

		private static final Logger LOGGER = LoggerFactory
				.getLogger(AspB2BASectionReportReportServiceImpl.class);

		@Autowired
		CommonUtility commonUtility;

		@Autowired
		@Qualifier("AspB2BASectionReportDaoImpl")
