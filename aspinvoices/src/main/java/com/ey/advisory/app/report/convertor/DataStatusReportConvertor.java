...
@Component("DataStatusReportConvertor")
@Slf4j
public class DataStatusReportConvertor implements ReportConvertor {
	...
	public Object convert(Object[] arr, String reportType) {
		...
		if (!Strings.isNullOrEmpty(errCode)) {
			...
			errDesc = ErrorMasterUtil.findDynamicErrorInfoByErrorCodes(errCodeList, "OUTWARD",dynamicMap);
		}
		...
		obj.setIrnAcknowledgmentNo(arr[6] != null ? DownloadReportsConstant.
				CSVCHARACTER.concat(arr[6].toString()) : null);
		if (arr[7] != null) {

			LOGGER.debug("Data Status Irn Ack Date :" + arr[7].toString());
		...
		if (arr[13] != null) {
			LOGGER.debug("Data Status validUpto :" + arr[13].toString());
		...
		if (arr[297] != null) {
			...
			LOGGER.debug("Data Status EwbRespDate :" + arr[297].toString());
		...
		if (arr[26] != null) {
			...
			String timestamp = arr[26].toString();
			String[] dateTime = timestamp.split(" ");
		...
		obj.setSupplierLocation(arr[41] != null ? DownloadReportsConstant.CSVCHARACTER
		...
		obj.setCustomerLocation(arr[51] != null ? DownloadReportsConstant.CSVCHARACTER
		...
		obj.setDispatcherLocation(arr[61] != null ? DownloadReportsConstant.CSVCHARACTER
		...
		obj.setShipToLocation(arr[69] != null ? DownloadReportsConstant.CSVCHARACTER
		...
		obj.setProductSerialNumber(arr[73] != null ? DownloadReportsConstant.CSVCHARACTER
		...
		obj.setAttributeValue(arr[84] != null ? DownloadReportsConstant.CSVCHARACTER
		...
		obj.setOtherReference(arr[137] != null ? DownloadReportsConstant.CSVCHARACTER
		...
		obj.setContractReference(arr[141] != null ? DownloadReportsConstant.CSVCHARACTER
				.concat(arr[141].toString()) : null);
		obj.setExternalReference(arr[142] != null ? DownloadReportsConstant.CSVCHARACTER
				.concat(arr[142].toString()) : null);
		obj.setProjectReference(arr[143] != null ? DownloadReportsConstant.CSVCHARACTER
		...
		obj.setIrnCancellationDate(
				arr[291] != null ? DownloadReportsConstant.CSVCHARACTER
						.concat(arr[291].toString()) : null);
		...
		obj.seteWBCancellationTime(
				arr[303] != null ? DownloadReportsConstant.CSVCHARACTER
						.concat(arr[303].toString()) : null);
	...
	private static String deriveOldReturnPeriod(Object[] arr,String docNum){
		try{
		return (arr[313] != null ? arr[313].toString() : null);
		}catch (Exception e) {
