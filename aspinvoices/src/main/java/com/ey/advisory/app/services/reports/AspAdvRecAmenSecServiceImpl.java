...
import com.ey.advisory.core.search.SearchCriteria;
	...
	@Service("AspAdvRecAmenSecServiceImpl")
	public class AspAdvRecAmenSecServiceImpl
			implements Gstr1ASPAdvRecSavableService {

		private static final Logger LOGGER = LoggerFactory
				.getLogger(AspAdvRecAmenSecServiceImpl.class);

		@Autowired
		CommonUtility commonUtility;

		@Autowired
		@Qualifier("AspAdvRecAmenSecTotalSummaryDaoImpl")
		private Gstr1AdvRecSavableDao gstr1AdvRectotalDao;
		
		@Autowired
		@Qualifier("AspAdvRecAmenSecSummaryDaoImpl")
