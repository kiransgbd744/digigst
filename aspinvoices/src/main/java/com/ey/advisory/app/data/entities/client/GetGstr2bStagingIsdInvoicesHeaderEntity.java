...
@Data
public class GetGstr2bStagingIsdInvoicesHeaderEntity{

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "GETGSTR2B_STAGING_ISD_HEADER_SEQ", allocationSize = 100)
	...
	protected GetGstr2bStagingIsdInvoicesItemEntity lineItemss;
