...
import com.ey.advisory.core.search.SearchCriteria;
	...
	@Service("Gstr1AAspB2CSSectionReportServiceImpl")
	public class Gstr1AAspB2CSSectionReportServiceImpl
			implements Gstr1AReviewSummReportsService {

		private static final Logger LOGGER = LoggerFactory
				.getLogger(Gstr1AAspB2CSSectionReportServiceImpl.class);

		@Autowired
		CommonUtility commonUtility;

		@Autowired
		@Qualifier("Gstr1AAspSecB2CSSavableTotalSummaryDaoImpl")
		private Gstr1AASPB2CSSavableTotalDao gstr1ASPB2CSSavableTotalDao;

		@Autowired
		@Qualifier("Gstr1AAspSecSectionReportDaoImpl")
		private Gstr1AASPB2CSSavableTransactionalDao gstr1ASPB2CSSavableTransactionalDao;

		@Autowired
		@Qualifier("Gstr1AAspSecB2CSSavableSummaryLevelDaoImpl")
		private Gstr1AASPB2CSSavableSummaryLevelDao gstr1ASPB2CSSavableSummaryLevelDao;
