...
@Service("AspAdvRecSecServiceImpl")
public class AspAdvRecSecServiceImpl implements Gstr1ASPAdvRecSavableService {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(AspAdvRecSecServiceImpl.class);

	@Autowired
	CommonUtility commonUtility;

	@Autowired
	@Qualifier("AspAdvRecSecTotalSummaryDaoImpl")
	private Gstr1AdvRecSavableDao gstr1AdvRectotalDao;

	@Autowired
	@Qualifier("AspAdvRecSecSummaryDaoImpl")
