 ...
 *
 */
@Component("Gstr1AEInvoiceOutwardFieldTruncation")
public class Gstr1AEInvoiceOutwardFieldTruncation {
	 ...
	 * @param document
	 */
	public void truncateHeaderFields(Gstr1AOutwardTransDocument document) {
		...
		if (document.getEwbProcessingStatus() != null
			...
			String totalInvoiceValueInWords = document
					.getTotalInvoiceValueInWords();
	 ...
	 * @param item
	 */
	public void truncateLineItemFields(Gstr1AOutwardTransDocLineItem item) {
