 ...
 */
@Slf4j
@Service("Gstr1AProcsSubmitSummaryHsnSectionFetcher")
public class Gstr1AProcsSubmitSummaryHsnSectionFetcher
		implements SimpleGstr1ASummaryHsnSectionFetcher {

	@Autowired
	@Qualifier("Gstr1AProcsSubmitScreenHsnSectionDaoImpl")
	Gstr1AProcsSubmitScreenHsnSectionDaoImpl basicDocSummaryDao;
