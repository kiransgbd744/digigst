...
@Entity
@Table(name = "GETGSTR1A_B2BA_HEADER")

public class GetGstr1AB2baHeaderEntity {

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "GETGSTR1A_B2BA_HEADER_SEQ", allocationSize = 100)
	...
	protected List<GetGstr1AB2baItemEntity> lineItems = new ArrayList<>();
	...
	public List<GetGstr1AB2baItemEntity> getLineItems() {
		return lineItems;
	}

	public void setLineItems(List<GetGstr1AB2baItemEntity> lineItems) {
