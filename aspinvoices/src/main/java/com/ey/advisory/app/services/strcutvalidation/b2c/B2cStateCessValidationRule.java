...
public class B2cStateCessValidationRule implements ValidationRule {
	private static final String STATE_CESS = "StateCessAmount";
	...
	public List<ProcessingResult> isValid(Object obj, Object[] row,
        ...
        if (!isPresent(obj))
			...
			Set<String> errorLocations = new HashSet<>();
				errorLocations.add(STATE_CESS);
				TransDocProcessingResultLoc location 
				                   = new TransDocProcessingResultLoc(
						null, errorLocations.toArray());
				errors.add(new ProcessingResult(APP_VALIDATION, "ER0234",
						"Invalid STATE CESS", location));
