 ...
 *
 */
@Component("CrossItcHeaderCheckService")
public class CrossItcHeaderCheckService implements Gstr1HeaderCheckService {
	@Autowired
	@Qualifier("Gstr1HeaderChecker")
	private Gstr1HeaderChecker gstr1HeaderChecker;

	public static final String[] EXPECTED_HEADERS = { "ISDGSTIN", "TaxPeriod",
			"IGSTusedasIGST", "SGSTusedasIGST", "CGSTusedasIGST",
			"SGSTusedasSGST", "IGSTusedasSGST", "CGSTusedasCGST",
			"IGSTusedasCGST", "CessusedasCess" };
