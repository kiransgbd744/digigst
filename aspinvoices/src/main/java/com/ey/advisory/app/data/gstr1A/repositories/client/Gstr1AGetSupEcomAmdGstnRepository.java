 ...
 *
 */
@Repository("Gstr1AGetSupEcomAmdGstnRepository")
@Transactional(propagation = Propagation.REQUIRED, readOnly = false)
public interface Gstr1AGetSupEcomAmdGstnRepository
		extends CrudRepository<GetGstr1ASupEcomAmdHeaderEntity, Long> {
	@Modifying
	@Query("UPDATE GetGstr1ASupEcomAmdHeaderEntity b SET b.isDelete = true,b.modifiedBy = 'SYSTEM'  , b.modifiedOn =:modifiedOn   WHERE"
	...
	@Query("SELECT COUNT(*) FROM GetGstr1ASupEcomAmdHeaderEntity "
