 ...
 */
@Slf4j
@Service("Gstr1AProcessSubmitDocSummarySearchService")
public class Gstr1AProcessSubmitDocSummarySearchService
		implements SearchService {

	@Autowired
	@Qualifier("Gstr1AProcessSubmitBasicSummarySectionFetcher")
	Gstr1AProcessSubmitBasicSummarySectionFetcher fetcher;
