...
@Slf4j
@Component("gstr1ANilRatedSupATGstnImpl")
public class GSTR1ANilRatedSupATGstnImpl implements Gstr1InvoicesAtGstn {

	
	@Autowired
	@Qualifier("gstr1ANilRatedSupDataATGstnImpl")
	GSTR1ANilRatedSupDataATGstnImpl gstr1ANilRatedSupDataATGstnImpl;
	...
	public Long findInvFromGstn(Gstr1GetInvoicesReqDto dto,
		...
		if (LOGGER.isDebugEnabled()) {
			LOGGER.debug("I am from findNilRatedSupAtGstn ");
		}
		Long reqId = null;
		...
		try {
			...
			reqId = gstr1ANilRatedSupDataATGstnImpl
					.findNilRatedSupDataAtGstn(dto, groupCode, type, json);
			...
			throw new APIException(
					"Unexpected error while executing Gstr1A Get Nil rated");
