 ...
 */
@Entity
@Table(name = "GSTR1_USERINPUT_HSNSAC")
@Setter
@Getter
@ToString
public class Gstr1UserInputHsnSacEntity {

	@Expose
	@Id
	@SerializedName("id")
	@SequenceGenerator(name = "sequence", sequenceName = "GSTR1_USERINPUT_HSNSAC_SEQ", allocationSize = 100)
