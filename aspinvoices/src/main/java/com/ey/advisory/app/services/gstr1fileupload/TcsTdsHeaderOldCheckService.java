...
@Component("TcsTdsHeaderOldCheckService")
public class TcsTdsHeaderOldCheckService implements Gstr1HeaderCheckService {
	@Autowired
	@Qualifier("Gstr1HeaderChecker")
	private Gstr1HeaderChecker gstr1HeaderChecker;

	public static final String[] EXPECTED_HEADERS = { "DigiGSTAction",
			"DigiGSTRemarks", "DigiGSTComment", "GSTIN", "Type", "Taxperiod",
			"Month", "GSTINofdeductor/Collector", "Deductor/CollectorName",
			"DocumentNumber", "DocumentDate", "OriginalMonth", 
			"OriginalDocumentNo", "OriginalDocumentDate", "SuppliesCollected",
			"SuppliesReturned", "TaxableValue/NetSupplies", "IGST", "CGST",
			"SGST", "InvoiceValue", "OriginalTaxableValue", 
			"OriginalInvoiceValue", "POS", "Chksum", "GSTNAction",
			"GSTNRemarks", "GSTNComment"
