...
import com.ey.advisory.app.data.entities.client.GetGstr1CdnrItemEntity;
import com.ey.advisory.app.data.entities.client.GetGstr1CdnraHeaderEntity;
import com.ey.advisory.app.data.entities.client.GetGstr1CdnraItemEntity;
...
@Component("gstr1CdnrCdnraDataParserImpl")
@Slf4j
public class Gstr1CdnrCdnraDataParserImpl implements Gstr1CdnrCdnraDataParser {
	...
	@Override
	public List<GetGstr1CdnrHeaderEntity> parseCdnrData(Gstr1GetInvoicesReqDto dto, String apiResp) {

		Gson gson = GsonUtil.newSAPGsonInstance();
		JsonArray respObject = null;
		List<GetGstr1CdnrHeaderEntity> headerList = new ArrayList<>();
		...
		for (CDNRInvoices eachInv : baseEntity) {
			...
			for (CreditDebitNote eachInvData : eachInv.getCreditDebitNoteDetails()) {
				...
				List<GetGstr1CdnrItemEntity> lineItems = new ArrayList<>();

				for (CdnrLineItem b2cItems : eachInvData.getCdnrLineItem()) {

					CdnrLineItemDetail b2cItem = b2cItems.getItemDetail();
					// New Item Entity
					GetGstr1CdnrItemEntity item = new GetGstr1CdnrItemEntity();
					/**
				...
				// New Header Entity
				GetGstr1CdnrHeaderEntity header = new GetGstr1CdnrHeaderEntity();
				/**
				 * Input data
				 */
	...
	@Override
	public List<GetGstr1CdnraHeaderEntity> parseCdnraData(Gstr1GetInvoicesReqDto dto, String apiResp) {

		Gson gson = GsonUtil.newSAPGsonInstance();
		JsonArray respObject = null;
		List<GetGstr1CdnraHeaderEntity> headerList = new ArrayList<>();
		...
		for (CDNRInvoices eachInv : baseEntity) {
			...
			for (CreditDebitNote eachInvData : eachInv.getCreditDebitNoteDetails()) {
				...
				BigDecimal sgstAmt = BigDecimal.ZERO;
				BigDecimal cessAmt = BigDecimal.ZERO;
				List<GetGstr1CdnraItemEntity> lineItems = new ArrayList<>();

				for (CdnrLineItem b2cItems : eachInvData.getCdnrLineItem()) {

					CdnrLineItemDetail b2cItem = b2cItems.getItemDetail();
					// New Item Entity
					GetGstr1CdnraItemEntity item = new GetGstr1CdnraItemEntity();
					/**
				...
				// New Header Entity
				GetGstr1CdnraHeaderEntity header = new GetGstr1CdnraHeaderEntity();
				/**
				 * Input data
				 */
				header.setActionRequired(APIConstants.N);
