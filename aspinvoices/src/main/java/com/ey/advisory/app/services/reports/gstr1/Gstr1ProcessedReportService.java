...
import com.ey.advisory.app.services.reports.ReportService;
 ...
 *
 */
@Service("Gstr1ProcessedReportService")
public class Gstr1ProcessedReportService implements ReportService {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(Gstr1ProcessedReportService.class);
