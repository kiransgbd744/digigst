...
import com.ey.advisory.app.services.search.simplified.docsummary.Gstr1AdvSimpleDocSummarySearchService;
 ...
 *
 */
@Service("Gstr1SummaryScreenAdvReqRespHandler")
public class Gstr1SummaryScreenAdvReqRespHandler {
	...
	private static final Logger LOGGER = LoggerFactory
			.getLogger(Gstr1SummaryScreenAdvReqRespHandler.class);
	@Autowired
	@Qualifier("Gstr1AdvSimpleDocSummarySearchService")
	Gstr1AdvSimpleDocSummarySearchService service;
	...
	public List<Gstr1SummaryScreenRespDto> handleGstr1AdvReqAndResp(
		...
		List<? extends Gstr1CompleteSummaryDto> list = summaryResult
				.getResult();
		/*List<Gstr1SummarySectionDto> gstnAtSummary = gstnResult.get(0).getAt()
				.getGstnSummary();*/
		...
		/*List<Gstr1SummarySectionDto> gstnAtaSummary = gstnResult.get(0).getAta()
				.getGstnSummary();*/
