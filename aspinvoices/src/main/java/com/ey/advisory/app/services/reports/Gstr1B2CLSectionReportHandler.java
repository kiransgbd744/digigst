...
@Slf4j
@Component("Gstr1B2CLSectionReportHandler")
public class Gstr1B2CLSectionReportHandler {

	@Autowired
	@Qualifier("Gstr1B2CLSectionReportServiceImpl")
		...
		try {
			...
			if (workbook != null) {
				...
				if (LOGGER.isDebugEnabled()) {
					LOGGER.debug("Gstr1 B2CL template file name is : {}",
				...
				if (LOGGER.isDebugEnabled()) {
					LOGGER.debug("Gstr1 B2CL file name is : {}", fileName);
				}
				...
				if (LOGGER.isDebugEnabled()) {
					LOGGER.debug(
							"Workbook has been generated successfully with the"
									+ " Gstr1 B2CL response list in the directory : {}",
				...
				if (id != null) {
					try {
						...
						String msg = String
								.format("Gstr1B2CLSectionReportHandler - "
				...
				if (LOGGER.isDebugEnabled()) {
					LOGGER.debug("Gstr1 B2CL No Data found for report id : {} ",
							id);
				}
			...
			String msg = String.format("Gstr1B2CLSectionReportHandler - "
