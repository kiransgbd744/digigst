...
@Service("SRFileToGstr1aB2CSExelDetailsConvertion")
public class SRFileToGstr1aB2CSExelDetailsConvertion {
	...
	public List<Gstr1AAsEnteredB2csEntity> convertSRFileToB2csExcel(
			List<Object[]> b2csObjects, Gstr1FileStatusEntity fileStatusId) {

		List<Gstr1AAsEnteredB2csEntity> listOfB2cs = new ArrayList<>();

		for (Object[] obj : b2csObjects) {
			Gstr1AAsEnteredB2csEntity b2cs = new Gstr1AAsEnteredB2csEntity();
