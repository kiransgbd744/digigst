...
@Entity
@Table(name = "GETGSTR2B_STAGING_CDNR_HEADER")
@Data
public class GetGstr2bStagingCdnrInvoicesHeaderEntity {

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "GETGSTR2B_STAGING_CDNR_HEADER_SEQ", allocationSize = 100)
	...
	protected List<GetGstr2bStagingCdnrInvoicesItemEntity> lineItemss = new ArrayList<>();
