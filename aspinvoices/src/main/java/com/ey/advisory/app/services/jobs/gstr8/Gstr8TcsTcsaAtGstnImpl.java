 ...
 */
@Slf4j
@Component("Gstr8TcsTcsaAtGstnImpl")
public class Gstr8TcsTcsaAtGstnImpl implements Gstr8InvoicesAtGstn {

	@Autowired
	@Qualifier("Gstr8TcsTcsaDataAtGstnImpl")
	private Gstr8TcsTcsaDataAtGstn getGstr8TcsTcsaDataAtGstn;
	...
	public Long findInvFromGstn(Gstr1GetInvoicesReqDto dto,
		...
		try {
			...
			reqId = getGstr8TcsTcsaDataAtGstn.findTcsTcsaDataAtGstn(dto,
					groupCode, type, json);
