 ...
 *
 */
@Component("DefaultGstr1AOutwardTransDocKeyGenerator")
public class DefaultGstr1AOutwardTransDocKeyGenerator
		implements DocKeyGenerator<Gstr1AOutwardTransDocument, String> {
	...
	@Override
	public String generateKey(Gstr1AOutwardTransDocument doc) {
	...
	@Override
	public String generateOrgKey(Gstr1AOutwardTransDocument doc) {
