...
@Slf4j
@Component("Gstr2ProcessedReconTaggingReportConvertor")
public class Gstr2ProcessedReconTaggingReportConvertor
	...
	public Object convert(Object[] arr, String reportType) {
		...
		try {
			...
			LOGGER.debug("Inside Gstr2ProcessedReconTaggingReportConvertor");
		...
		//	obj.setMismatchReason(arr[4] != null ? arr[4].toString() : null);
			...
			obj.setCustomerStateCode(
					arr[35] != null
							? DownloadReportsConstant.CSVCHARACTER
									.concat(arr[35].toString())
							: null);
			obj.setBillingPOS(
					arr[36] != null
							? DownloadReportsConstant.CSVCHARACTER
									.concat(arr[36].toString())
							: null);
			...
			if (docType != null && (docType.equalsIgnoreCase("CR")
				...
				obj.setInvoiceCessAdvaloremAmount(
						CheckForNegativeValue(arr[97]));
				obj.setInvoiceCessSpecificAmount(
						CheckForNegativeValue(arr[98]));
			...
			obj.setUserDefField10(
					arr[228] != null ? arr[228].toString() : null);
			obj.setUserDefField11(
					arr[229] != null ? arr[229].toString() : null);
			...
			obj.setUserResponse(arr[259] != null ? arr[259].toString() : null);
			obj.setResponseRemarks(arr[260] != null ? arr[260].toString() : null);
			obj.setReportCategory(arr[261] != null ? arr[261].toString() : null);
			obj.setReportType(arr[262] != null ? arr[262].toString() : null);
			obj.setMismatchReason(arr[263] != null ? arr[263].toString() : null);
			obj.setMatchReason(arr[264] != null ? arr[264].toString() : null);
			obj.setReconRequestID(arr[265] != null ? arr[265].toString() : null);
			
			/*if (arr[266] != null) {
				Timestamp timeStamp = (Timestamp) arr[266];
				LocalDateTime localDT = timeStamp.toLocalDateTime();
				LocalDateTime convertref = EYDateUtil
						.toISTDateTimeFromUTC(localDT);
				obj.setReconDateTime(convertref.toString());
			} else {
				obj.setReconDateTime(null);
			}*/
			obj.setReconDateTime(arr[266] != null ? "'".concat(arr[266].toString()) : null);
			
			return obj;
		} catch (Exception e) {
			LOGGER.error(
					"error occured - Gstr2ProcessedReconTaggingReportConvertor");
