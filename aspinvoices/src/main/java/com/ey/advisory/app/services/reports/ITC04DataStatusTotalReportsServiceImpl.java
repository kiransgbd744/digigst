...
@Slf4j
@Component("ITC04DataStatusTotalReportsServiceImpl")
public class ITC04DataStatusTotalReportsServiceImpl
	...
	@Autowired
	@Qualifier("ITC04DataStatusTotalReportsDaoImpl")
	private ITC04DataStatusTotalReportsDaoImpl itc04ProcessedReportsDao;
	...
	public Workbook findApiProcesseRec(SearchCriteria criteria,
		...
		responseFromView = itc04ProcessedReportsDao.getItc04TotalRecordsReport(request);

		if (responseFromView != null && responseFromView.size() > 0) {
			String[] invoiceHeaders = commonUtility
					.getProp("itco4.dataStatus.total.report").split(",");
