 ...
 * 
 */
	@Service("NilNonVerticalProcessedReportsServiceImpl")
	public class NilNonVerticalProcessedReportsServiceImpl
			implements NilNonVerticalReportsService {

		private static final Logger LOGGER = LoggerFactory
				.getLogger(NilNonVerticalProcessedReportsServiceImpl.class);

		@Autowired
		CommonUtility commonUtility;

		@Autowired
		@Qualifier("NilNonVerticalProcessedReportsDaoImpl")
