 ...
 */
@Entity
@Table(name = "ANX_OUTWARD_DOC_RATE_SUMMARY_1A")
public class Gstr1ADocRateSummary {

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "ANX_OUTWARD_DOC_RATE_SUMMARY_SEQ_1A", 
	 allocationSize = 100)
