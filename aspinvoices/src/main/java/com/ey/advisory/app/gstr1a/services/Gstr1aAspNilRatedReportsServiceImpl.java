...
@Service("Gstr1aAspNilRatedReportsServiceImpl")
public class Gstr1aAspNilRatedReportsServiceImpl
		implements Gstr1AspNilRatedReportsService {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(Gstr1aAspNilRatedReportsServiceImpl.class);

	@Autowired
	CommonUtility commonUtility;

	@Autowired
	@Qualifier("Gstr1aAspNilRatedTransactionalDaoImpl")
	Gstr1OutwardVerticalProcessNilDao gstr1NilRatedTransactionalDao;

	@Autowired
	@Qualifier("Gstr1aNilRatedTotalSummaryDaoImpl")
	Gstr1OutwardVerticalProcessNilDao gstr1NilRatedTotalSummDao;
	
	@Autowired
	@Qualifier("Gstr1aNilRatedSummaryUploadDaoImpl")
	...
	public Workbook findNilReport(SearchCriteria criteria, PageRequest pageReq) {
		...
		workbook = createWorkbookWithExcelTemplate("ReportTemplates",
				"GSTR1A_ASP_NIL_EXEMPT_NON_Savable.xlsx");
