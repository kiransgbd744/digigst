...
import com.google.common.base.Strings;
	...
	@Component("AspB2CLSectionReportDaoImpl")
	public class AspB2CLSectionReportDaoImpl implements Gstr1ReviewSummaryReportsDao {

		private static final Logger LOGGER = LoggerFactory.getLogger(AspB2CLSectionReportDaoImpl.class);
		...
		private static String createApiProcessedQueryString(String buildHeader, String multiSupplyTypeAns) {
				...
				return "SELECT TRIM(', ' FROM IFNULL(HDR.ERROR_CODES, '') || ',' || IFNULL(ITM.ERROR_CODES, '')) AS ERROR_CODE_ASP "
						...
						+ "	AND ITM.ITM_TAX_DOC_TYPE IN ('B2CL') "
						+ buildHeader
						+ " ORDER BY DOC_NUM "
						+ "	,ITM.ITM_NO";
