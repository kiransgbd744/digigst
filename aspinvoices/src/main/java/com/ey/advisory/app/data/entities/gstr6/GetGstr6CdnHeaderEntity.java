 ...
 */
@Entity
@Table(name = "GETGSTR6_CDN_HEADER")
public class GetGstr6CdnHeaderEntity {

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "GETGSTR6_CDN_HEADER_SEQ", allocationSize = 100)
	...
	protected List<GetGstr6CdnItemEntity> lineItems = new ArrayList<>();
	...
	public List<GetGstr6CdnItemEntity> getLineItems() {
		return lineItems;
	}

	public void setLineItems(List<GetGstr6CdnItemEntity> lineItems) {
