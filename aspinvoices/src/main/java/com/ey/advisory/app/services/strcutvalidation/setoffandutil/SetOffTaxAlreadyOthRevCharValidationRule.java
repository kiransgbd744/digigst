...
public class SetOffTaxAlreadyOthRevCharValidationRule
	...
	public List<ProcessingResult> isValid(Object obj, Object[] row,
		...
		if (!isDecimal(obj.toString().trim())) {
			...
			errors.add(new ProcessingResult(APP_VALIDATION, "ER1865",
					"Invalid Tax already paid-Other than reverse charge", location));
