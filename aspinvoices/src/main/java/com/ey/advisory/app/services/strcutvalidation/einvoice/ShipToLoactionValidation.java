 ...
 *
 */
public class ShipToLoactionValidation implements ValidationRule {
	...
	public List<ProcessingResult> isValid(int idx, Object obj, Object[] row,
		...
		if (obj.toString().trim().length() > 60 || 
			...
			errors.add(new ProcessingResult(APP_VALIDATION, "ER10021",
					             "Invalid Ship to Location", location));
			return errors;
		}*/
		return errors;
	}
