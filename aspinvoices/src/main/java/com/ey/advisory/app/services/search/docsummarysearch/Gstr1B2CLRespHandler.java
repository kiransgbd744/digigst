...
@Service("Gstr1B2CLRespHandler")
public class Gstr1B2CLRespHandler {
	...
	public JsonElement handleB2CLResp(List<? extends Gstr1SummaryDto> list,
			Gstr1SummaryReqDto gstr1SummaryRequest) 
	{
		
		/*Gstr1SummaryReqDto gstr1SummaryRequest*/
		List<Gstr1BasicSummarySectionDto> b2clEySummary = new ArrayList<>();
		for (Gstr1SummaryDto gstr1Summary : list) {
			b2clEySummary = gstr1Summary.getB2cl().getEySummary();
		}
...
*/		
		...
		JsonElement b2clRespBody = gstr1SummaryStructure.b2clStructure(b2clEySummary,
				gstnList);
