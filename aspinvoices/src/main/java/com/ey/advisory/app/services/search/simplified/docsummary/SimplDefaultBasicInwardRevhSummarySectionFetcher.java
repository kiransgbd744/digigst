...
@Component("SimplDefaultBasicInwardRevhSummarySectionFetcher")
public class SimplDefaultBasicInwardRevhSummarySectionFetcher
		implements SimplBasicInwardSummarySectionFetcher {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(SimplDefaultBasicInwardRevhSummarySectionFetcher.class);

	
	@Autowired
	@Qualifier("InwardRevhSummarysectionDaoImpl")
	private BasicDocInwardSummarySectionDao basicDocRevhSummarySectionDao;

	@Override
	public Map<String, List<Annexure1SummarySectionDto>> fetch(Annexure1SummaryReqDto req) {
		
		LOGGER.debug("Executing LoadBasicSummarySection Method");
		List<Annexure1SummarySectionDto> result = basicDocRevhSummarySectionDao
