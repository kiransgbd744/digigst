...
@Component("Gstr1GetHsnSummaryTablesDaoImpl")
@Slf4j
public class Gstr1GetHsnSummaryTablesDaoImpl implements Gstr1aGetDao {
	...
	private String creategstnHsnQueryString(String buildQuery) {
		...
		return "select ID,GSTIN,RETURN_PERIOD,HSNORSAC,ITM_DESC,"
				...
				+ "SGST_AMT,CESS_AMT,TOT_VAL,IS_FILED,DERIVED_RET_PERIOD,"
				...
				+ "SUM(TOT_VAL) TOT_VAL,BT.IS_FILED,HDR.DERIVED_RET_PERIOD,"
				+ " 'HSN' AS TABLE_TYPE "
