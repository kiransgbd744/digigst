...
@Slf4j
@Component("gstr1ADocIssuesAtGstnImpl")
public class Gstr1ADocIssuesAtGstnImpl implements Gstr1InvoicesAtGstn {

	
	@Autowired
	@Qualifier("gstr1ADocIssuesDataAtGstnImpl")
	Gstr1ADocIssuesDataAtGstnImpl gstr1ADocIssuesDataAtGstn;
	...
	public Long findInvFromGstn(Gstr1GetInvoicesReqDto dto,
		...
		try {
			...
			reqId = gstr1ADocIssuesDataAtGstn.findDocIssueDataAtGstn(dto,
					groupCode, type, json);
