...
@Component("LURecipientGSTINValidation")
public class LURecipientGSTINValidation
	...
	public List<ProcessingResult> validate(OutwardTransDocument document,
		...
		if(Strings.isNullOrEmpty(document.getSgstin()) 
				...
				|| GSTConstants.I.equalsIgnoreCase(document.getTransactionType()) 
				|| GSTConstants.URP.equalsIgnoreCase(document.getCgstin())) return errors;
		...
		if (paramtrvalue == null || paramtrvalue.isEmpty() 
				...
				CONFIG_PARAM_OUTWARD_ANS_KEY_ID.C.name())) {
