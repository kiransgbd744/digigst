...
@Service("Gstr6IsdaInvoicesAtGstnImpl")
@Slf4j
public class Gstr6IsdaInvoicesAtGstnImpl implements Gstr6InvoicesAtGstn {
	@Autowired
	...
	public Long findInvFromGstn(Gstr6GetInvoicesReqDto dto, String groupCode, String type, Long batchId) {
		if (LOGGER.isDebugEnabled()) {
			LOGGER.debug("I am from findISDAFromGstn Method type: {}", type);
		}
		...
		try {
			...
			throw new APIException("Unexpected error while executing Gstr6 Get Isda");
