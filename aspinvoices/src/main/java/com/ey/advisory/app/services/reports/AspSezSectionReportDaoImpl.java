...
import com.google.common.base.Strings;
	...
	@Component("AspSezSectionReportDaoImpl")
	public class AspSezSectionReportDaoImpl
			implements Gstr1ReviewSummaryReportsDao {

		private static final Logger LOGGER = LoggerFactory
				.getLogger(AspSezSectionReportDaoImpl.class);
		...
		private String createApiProcessedQueryString(String buildHeader) {
			...
			return "SELECT TRIM(', ' FROM IFNULL(HDR.ERROR_CODES,'') ||','|| "
					...
					+ "AND HDR.RETURN_TYPE='GSTR1' AND HDR.TAX_DOC_TYPE IN ('B2B') AND HDR.SUPPLY_TYPE = 'SEZWP' " 
					+ buildHeader
