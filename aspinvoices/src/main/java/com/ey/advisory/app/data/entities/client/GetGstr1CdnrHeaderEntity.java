...
@Entity
@Table(name = "GETGSTR1_CDNR_HEADER")
public class GetGstr1CdnrHeaderEntity {

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "GETGSTR1_CDNR_HEADER_SEQ", allocationSize = 100)
	...
	protected List<GetGstr1CdnrItemEntity> lineItems = new ArrayList<>();
	...
	public List<GetGstr1CdnrItemEntity> getLineItems() {
		return lineItems;
	}

	public void setLineItems(List<GetGstr1CdnrItemEntity> lineItems) {
