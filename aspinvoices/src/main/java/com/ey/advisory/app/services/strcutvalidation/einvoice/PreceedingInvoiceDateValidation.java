 ...
 *
 */
public class PreceedingInvoiceDateValidation implements ValidationRule {
	...
	public List<ProcessingResult> isValid(int idx, Object obj, Object[] row,
		...
		if (date == null ) {
			...
			errors.add(new ProcessingResult(APP_VALIDATION, "ER10101",
					          "Invalid Preceeding Invoice Date.", location));
			return errors;
		}
