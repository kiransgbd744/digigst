 ...
 *
 */
@Component("Gstr1InvoiceStructureService")
@Slf4j
public class Gstr1InvoiceStructureService {
	...
	@Autowired
	@Qualifier("Gstr1InvoiceBusinessService")
	private Gstr1InvoiceBusinessService gstr1InvoiceBusinessService;
	...
	public void invoiceStructrureProcessData(List<Object[]> listOfInvoices,
		...
		List<Gstr1AsEnteredInvEntity> strErrRecords = new ArrayList<>();
		List<Gstr1AsEnteredInvEntity> strProcessRecords = new ArrayList<>();
		...
		List<Gstr1AsEnteredInvEntity> invoiceDoc = sRFileToInvoiceDetailsConvertion
		...
		List<Gstr1AsEnteredInvEntity> excelDataSave = gstr1AsEnteredInvoiceRepository
				.saveAll(invoiceDoc);
		PerfUtil.logEventToFile(PerfamanceEventConstants.FILE_PROCESSING,
		...
		PerfUtil.logEventToFile(PerfamanceEventConstants.FILE_PROCESSING,
				...
				CLASS_NAME, "invoiceStructrureProcessData", null);
		for (Gstr1AsEnteredInvEntity id : excelDataSave) {
