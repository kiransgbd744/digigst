...
@Repository("Gstr1GetExpGstnRepository")
@Transactional(propagation = Propagation.REQUIRED, readOnly = false)
public interface Gstr1GetExpGstnRepository
		extends CrudRepository<GetGstr1ExpHeaderEntity, Long> {
	@Modifying
	@Query("UPDATE GetGstr1ExpHeaderEntity b SET b.isDelete = true,b.modifiedBy = 'SYSTEM'  , b.modifiedOn =:modifiedOn  WHERE"
	...
	@Query("SELECT COUNT(*) FROM GetGstr1ExpHeaderEntity "
