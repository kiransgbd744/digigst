...
@Component("BasicPRCommonDSSecParam")
public class BasicPRCommonDSSecParam {

public Anx2PRSProcessedRequestDto setDataSecuritySearchParams(
		Anx2PRSProcessedRequestDto searchParams) {
