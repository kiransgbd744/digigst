 ...
 *
 */
@Component("B2csHeaderCheckService")
public class B2csHeaderCheckService implements Gstr1HeaderCheckService {
	@Autowired
	...
	public static final String[] EXPECTED_HEADERS = { "SupplierGSTIN",
			"ReturnPeriod", "TransactionType", "Month", "OrgPOS", "OrgHSNorSAC",
			"OrgUnitOfMeasurement", "OrgQuantity", "OrgRate", "OrgTaxableValue",
			"OrgeComGSTIN", "OrgeComSupplyValue", "NewPOS", "NewHSNorSAC",
			"NewUnitOfMeasurement", "NewQuantity", "NewRate", "NewTaxableValue",
			"NeweComGSTIN", "NeweComSupplyValue", "IntegratedTaxAmount",
			"CentralTaxAmount", "StateUTTaxAmount", "CessAmount", "TotalValue",
