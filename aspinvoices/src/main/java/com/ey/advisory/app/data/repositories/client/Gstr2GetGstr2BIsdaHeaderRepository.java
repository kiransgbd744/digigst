...
@Repository("Gstr2GetGstr2BIsdaHeaderRepository")
@Transactional(propagation = Propagation.REQUIRED, readOnly = false)
public interface Gstr2GetGstr2BIsdaHeaderRepository
		extends CrudRepository<Gstr2GetGstr2BIsdaHeaderEntity, Long>,
		JpaSpecificationExecutor<Gstr2GetGstr2BIsdaHeaderEntity> {

	@Modifying
	@Query("UPDATE Gstr2GetGstr2BIsdaHeaderEntity b SET b.isDelete = true, "
	...
	@Modifying
	@Query("UPDATE Gstr2GetGstr2BIsdaHeaderEntity b SET b.status = 'SAVED', "
			+ " b.modifiedOn =:modifiedOn WHERE b.invocationId =:invocationId"
			+ " AND b.status = 'ONHOLD'")
	int updateStatus(@Param("invocationId") Long invocationId,
			@Param("modifiedOn") LocalDateTime modifiedOn);

	@Query("from Gstr2GetGstr2BIsdaHeaderEntity where docKey=:docKey")
	List<Gstr2GetGstr2BIsdaHeaderEntity> findByInvoiceKey(
			@Param("docKey") String docKey);

	@Modifying
	@Query("UPDATE Gstr2GetGstr2BIsdaHeaderEntity b SET b.isDelete = true, b.modifiedOn =:modifiedOn  WHERE"
