...
@Entity
@Table(name = "GSTR1A_PROCESSED_ADV_RECEIVED")
@Setter
@Getter
@ToString
public class Gstr1AARDetailsEntity {

	@Expose
	@Id
	@SerializedName("id")
	@SequenceGenerator(name = "sequence", sequenceName = "GSTR1A_PROCESSED_ADV_RECEIVED_SEQ", allocationSize = 100)
	...
	public Gstr1AARDetailsEntity(Long fileId, Long asEnterId,
	...
	public Gstr1AARDetailsEntity add(Gstr1AARDetailsEntity newObj) {
	...
	public Gstr1AARDetailsEntity() {
	}

	public Gstr1AARDetailsEntity(String atKey) {
