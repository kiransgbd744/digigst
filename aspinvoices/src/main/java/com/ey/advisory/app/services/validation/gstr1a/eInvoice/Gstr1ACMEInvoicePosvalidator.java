 ...
 *
 */
@Component("Gstr1ACMEInvoicePosvalidator")
public class Gstr1ACMEInvoicePosvalidator
		implements DocRulesValidator<Gstr1AOutwardTransDocument> {

	private static final List<String> SUPPLY_TYPE_IMPORTS = ImmutableList.of(
			GSTConstants.TAX, GSTConstants.DTA, GSTConstants.SEZWP,
			GSTConstants.DXP, GSTConstants.SEZWOP);
