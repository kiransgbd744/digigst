 ...
 */
@Entity
@Table(name = "GETGSTR6A_B2B_ITEM")
public class GetGstr6aB2bItemEntity {
	...
	protected GetGstr6aB2bHeaderEntity header;
	...
	public GetGstr6aB2bHeaderEntity getHeader() {
		return header;
	}

	public void setHeader(GetGstr6aB2bHeaderEntity header) {
		this.header = header;
	}
