 ...
 */
@Slf4j
@Service("DefaultGstr8RefIdPollingManager")
public class DefaultGstr8RefIdPollingManager
		implements Gstr8RefIdPollingManger {
	...
	@Override
	public ResponseEntity<String> processGstr8RefIds(PollingMessage reqDto,
			String groupcode) {
		...
		try {
			...
			String msg = "failed to hit the refId";
			LOGGER.error(msg, ex);
