 ...
 *
 */
@Component("BasicInwardListingDataSecParams")
public class BasicInwardListingDataSecParams {

	public InwardListingReqDto setDataSecuritySearchParams(
			InwardListingReqDto searchParams) {
