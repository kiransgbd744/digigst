...
@Entity
@Table(name = "GETGSTR1_EXP_HEADER")
public class GetGstr1ExpHeaderEntity {
	...
	protected List<GetGstr1ExpItemEntity> lineItems = new ArrayList<>();
	...
	public List<GetGstr1ExpItemEntity> getLineItems() {
		return lineItems;
	}

	public void setLineItems(List<GetGstr1ExpItemEntity> lineItems) {
