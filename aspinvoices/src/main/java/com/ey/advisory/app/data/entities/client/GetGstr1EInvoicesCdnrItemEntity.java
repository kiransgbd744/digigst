 ...
 */
@Entity
@Table(name = "GETGSTR1_EINV_CDNR_ITEM")
public class GetGstr1EInvoicesCdnrItemEntity {
	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "GETGSTR1_EINV_CDNR_ITEM_SEQ", allocationSize = 100)
	...
	private GetGstr1EInvoicesCdnrHeaderEntity document;
	...
	public GetGstr1EInvoicesCdnrHeaderEntity getDocument() {
		return document;
	}

	public void setDocument(GetGstr1EInvoicesCdnrHeaderEntity document) {
