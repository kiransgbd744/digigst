...
import com.ey.advisory.core.search.SearchCriteria;
	...
	@Service("Gstr1AAspB2BSectionReportReportServiceImpl")
	public class Gstr1AAspB2BSectionReportReportServiceImpl
			implements Gstr1AReviewSummReportsService {

		private static final Logger LOGGER = LoggerFactory
				.getLogger(Gstr1AAspB2BSectionReportReportServiceImpl.class);

		@Autowired
		CommonUtility commonUtility;

		@Autowired
		@Qualifier("Gstr1AAspB2BSectionReportDaoImpl")
		private Gstr1AReviewSummaryReportsDao gstr1aReviewSummaryReportsDao;
		...
		public Workbook findGstr1ReviewSummRecords(SearchCriteria criteria,
			...
			responseFromView = gstr1aReviewSummaryReportsDao
