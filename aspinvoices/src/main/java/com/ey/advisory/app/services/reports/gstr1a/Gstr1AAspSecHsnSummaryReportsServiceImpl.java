...
import com.ey.advisory.core.search.SearchCriteria;
	...
	@Service("Gstr1AAspSecHsnSummaryReportsServiceImpl")
	public class Gstr1AAspSecHsnSummaryReportsServiceImpl
			implements Gstr1AASPHsnSummaryReportsService {

		private static final Logger LOGGER = LoggerFactory
				.getLogger(Gstr1AAspSecHsnSummaryReportsServiceImpl.class);

		@Autowired
		CommonUtility commonUtility;

		@Autowired
		@Qualifier("Gstr1AAspSecHsnSummaryDaoImpl")
		Gstr1AAspHsnSummaryDao gstr1AspHsnSummaryDao;
		...
		public Workbook findReports(SearchCriteria criteria, PageRequest pageReq) {
			...
			List<Object> responseFromHsnSummary = new ArrayList<>();
			...
			if (responseFromHsnSummary != null
				...
				String[] invoiceHeaders = commonUtility
						.getProp("Asp.Sub.hsn.process.report.headers")
						.split(",");
