...
@Component("BasicCommonSecParamAsyncReports")
public class BasicCommonSecParamAsyncReports {
	


	public FileStatusReportDto setDataSecuritySearchParams(
			FileStatusReportDto searchParams) {
