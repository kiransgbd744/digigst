...
@Data
public class ReviwB2banPopupVertItemDto {

	@XmlElement(name = "TranType")
	private String tranType;

	@XmlElement(name = "OdMonth")
	private String odMonth;

	@XmlElement(name = "OdBillingPos")
	private String odBillingPos;
	
	@XmlElement(name="OdHsnSac")
	private String odHsnSac;

	@XmlElement(name = "OdUom")
	private String odUom;

	@XmlElement(name = "OdQuantity")
	private BigDecimal odQuantity;

	@XmlElement(name = "OdRate")
	private BigDecimal odRate;

	@XmlElement(name = "OdTaxableVal")
	private BigDecimal odTaxableVal;

	@XmlElement(name = "OdEcomGstin")
	private String odEcomGstin;

	@XmlElement(name = "OdEcomSupVal")
	private BigDecimal odEcomSupVal;
