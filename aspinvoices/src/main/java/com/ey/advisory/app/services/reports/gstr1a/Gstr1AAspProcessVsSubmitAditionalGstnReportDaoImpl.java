...
@Component("Gstr1AAspProcessVsSubmitAditionalGstnReportDaoImpl")
public class Gstr1AAspProcessVsSubmitAditionalGstnReportDaoImpl
...
/*		if (ProfitCenter != null && !ProfitCenter.isEmpty()) {
	...
	private String createApiProcessedQueryString(String buildQuery) {
		...
		build.append("SELECT irn_num,irn_gen_date,e_invoicestatus,autodraftstatus,errorcode, "
				...
				+ "irn_source_type,'B2B' table_type,hdr.derived_ret_period FROM  getgstr1a_b2b_header HDR "
				+ "INNER JOIN getgstr1a_b2b_item ITM  ON         hdr.id = itm.header_id "
				+ "AND        hdr.derived_ret_period = itm.derived_ret_period "
				+ "INNER JOIN ( select TABLE_ID from GSTR1A_SUBMITTED_PS_TRANS "
				...
				+ "hdr.derived_ret_period FROM       getgstr1a_b2ba_header HDR INNER JOIN getgstr1a_b2ba_item ITM "
				...
				+ " hdr.derived_ret_period FROM  getgstr1a_cdnr_header HDR INNER JOIN getgstr1a_cdnr_item ITM "
				+ "ON         hdr.id = itm.header_id AND        hdr.derived_ret_period = itm.derived_ret_period "
				+ "         INNER JOIN ( select TABLE_ID from GSTR1A_SUBMITTED_PS_TRANS "
				...
				+ "        'CDNRA' table_type, hdr.derived_ret_period FROM       getgstr1a_cdnra_header HDR "
				...
				+ "        INNER JOIN getgstr1a_cdnur_item ITM "
				...
				+ "        INNER JOIN getgstr1a_cdnura_item ITM "
				+ "        ON         hdr.id = itm.header_id "
				+ "        AND        hdr.derived_ret_period = itm.derived_ret_period "
				+ "        INNER JOIN ( select TABLE_ID from GSTR1A_SUBMITTED_PS_TRANS "
				+ "        WHERE REPORT_TYPE='ADDITIONAL IN GSTN' "
				...
				+ "        INNER JOIN getgstr1a_exp_item ITM "
				+ "        ON         hdr.id = itm.header_id "
				+ "        AND        hdr.derived_ret_period = itm.derived_ret_period "
				+ "        INNER JOIN ( select TABLE_ID from GSTR1A_SUBMITTED_PS_TRANS "
				+ "        WHERE REPORT_TYPE='ADDITIONAL IN GSTN' "
				...
				+ "        INNER JOIN getgstr1a_expa_item ITM "
				+ "        ON         hdr.id = itm.header_id "
				+ "        AND        hdr.derived_ret_period = itm.derived_ret_period "
				+ "        INNER JOIN ( select TABLE_ID from GSTR1A_SUBMITTED_PS_TRANS "
				+ "         WHERE REPORT_TYPE='ADDITIONAL IN GSTN' "
				...
				+ "         INNER JOIN getgstr1a_b2cl_item ITM "
				+ "        ON         hdr.id = itm.header_id "
				+ "         AND        hdr.derived_ret_period = itm.derived_ret_period "
				+ "        INNER JOIN ( select TABLE_ID from GSTR1A_SUBMITTED_PS_TRANS "
				+ "        WHERE REPORT_TYPE='ADDITIONAL IN GSTN' "
				...
				+ "        INNER JOIN getgstr1a_b2cla_item ITM "
				+ "        ON         hdr.id = itm.header_id "
				+ "        AND        hdr.derived_ret_period = itm.derived_ret_period "
				+ "        INNER JOIN ( select TABLE_ID from GSTR1A_SUBMITTED_PS_TRANS "
				+ "        WHERE REPORT_TYPE='ADDITIONAL IN GSTN' "
