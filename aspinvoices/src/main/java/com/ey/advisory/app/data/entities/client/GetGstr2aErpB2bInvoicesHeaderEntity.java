...
@Data
@Entity
@Table(name = "GETGSTR2A_ERP_B2B_HEADER")
public class GetGstr2aErpB2bInvoicesHeaderEntity
	...
	protected List<GetGstr2aErpB2bInvoicesItemEntity> lineItems = new ArrayList<>();
