 ...
 *
 */
@Service("SimpleGstr1BasicDocIssueSummarySectionFetcher")
public class SimpleGstr1BasicDocIssueSummarySectionFetcher
		implements SimpleSummaryDocSectionFetcher {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(SimpleGstr1BasicDocIssueSummarySectionFetcher.class);
	
	@Autowired
	@Qualifier("BasicDocIssuedSummaryScreenSectionDaoImpl")
	BasicDocIssuedSummaryScreenSectionDaoImpl basicDocSummaryDao;
