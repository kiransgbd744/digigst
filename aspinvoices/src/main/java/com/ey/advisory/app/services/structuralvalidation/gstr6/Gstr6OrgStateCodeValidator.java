 ...
 *
 */
public class Gstr6OrgStateCodeValidator
	...
	public List<ProcessingResult> validate(
		...
		if (document.getOrgStateCode() != null
				&& !document.getOrgStateCode().isEmpty()) {
			String stateCode = document.getOrgStateCode();
			...
			if (n <= 0) {
				...
				errors.add(new ProcessingResult(APP_VALIDATION, "ER3047",
						"Invalid Original State Code", location));
			}
		}
		return errors;
	}
