...
@Component("Gstr1ReviewSumRateDownloadServiceImpl")
public class Gstr1ReviewSumRateDownloadServiceImpl
		implements Gstr1ReviewSummaryDownloadService {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(Gstr1ReviewSumRateDownloadServiceImpl.class);
	...
	private Gstr1SimpleDocGstnSummarySearchService gstr1SimpleDocGstnSummarySearchService;
	...
	public Workbook findGstr1RevSummTablesReports(
		...
		workbook = createWorkbookWithExcelTemplate("ReportTemplates",
				"GSTR-1_ReviewRate_Screen_Download.xlsx");
		...
		try {
			...
			Gstr1ReviewRateDynamicExcel.generaterateExcel(workbook,
