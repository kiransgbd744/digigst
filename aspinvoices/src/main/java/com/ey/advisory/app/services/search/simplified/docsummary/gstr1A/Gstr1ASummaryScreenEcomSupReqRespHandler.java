 ...
 *
 */
@Service("Gstr1ASummaryScreenEcomSupReqRespHandler")
public class Gstr1ASummaryScreenEcomSupReqRespHandler {

	@Autowired
	@Qualifier("Gstr1ASimpleEcomSupSearchService")
	Gstr1ASimpleEcomSupSearchService service;
	...
	public List<Gstr1SummaryScreenRespDto> handleGstr1ReqAndResp(
		...
		/*
		 * Gstr1SummaryScreenRespDto tbl14summaryResp = new
		 * Gstr1SummaryScreenRespDto();
