...
@Service("Gstr1AaGetReportServiceImpl")
public class Gstr1AaGetReportServiceImpl
		implements Gstr1AAGstnErrorReportService {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(Gstr1AaGetReportServiceImpl.class);
	...
	@Autowired
	@Qualifier("Gstr1AGetHsnSummaryTablesDaoImpl")
