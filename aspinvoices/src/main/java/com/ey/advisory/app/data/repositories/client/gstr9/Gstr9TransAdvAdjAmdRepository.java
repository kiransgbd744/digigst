 ...
 *
 */
@Repository("Gstr9TransAdvAdjAmdRepository")
@Transactional(propagation = Propagation.REQUIRED, readOnly = false)
public interface Gstr9TransAdvAdjAmdRepository
		extends JpaRepository<Gstr9TransAdvAdjAmdEntity, Long> {

	@Query("SELECT distinct chunkId FROM Gstr9TransAdvAdjAmdEntity WHERE "
	...
	public List<Gstr9TransAdvAdjAmdEntity> findBySgstinAndGstr9FyAndIsDeleteAndChunkId(
