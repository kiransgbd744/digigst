 ...
 * list of InwardTransDocument objects assumes that the structural 
 ...
 *
 */
public interface InwardDocSaveService {
	...
	public InwardDocSaveFinalRespDto saveDocuments(
			List<InwardTransDocument> docs, String sourceId, String headerPayloadId);  
