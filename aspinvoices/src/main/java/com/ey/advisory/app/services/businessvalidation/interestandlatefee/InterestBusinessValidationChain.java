 ...
 *
 */
@Component("InterestBusinessValidationChain")
public class InterestBusinessValidationChain 
                   implements DocRulesValidatorChain<InterestExcelEntity> {
	private static final Logger LOGGER = 
			LoggerFactory.getLogger(InterestBusinessValidationChain.class);
...
private static final BusinessRuleValidator[] VALIDATORS = {
		new InterestSupplierGstin(),
		new InterestReturnPeriod(),
		new InterestReturnTable(),
...
public List<ProcessingResult> validate(InterestExcelEntity document,
	...
	for(BusinessRuleValidator<InterestExcelEntity> 
