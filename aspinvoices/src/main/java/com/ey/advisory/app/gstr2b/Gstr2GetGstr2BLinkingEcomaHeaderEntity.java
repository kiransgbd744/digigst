...
@AllArgsConstructor
@Entity
@Table(name = "GETGSTR2B_LINKING_ECOMA_HEADER")
public class Gstr2GetGstr2BLinkingEcomaHeaderEntity {

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "GETGSTR2B_ECOMA_HEADER_SEQ", allocationSize = 100)
	...
	protected List<Gstr2GetGstr2BLinkingEcomaItemEntity> lineItems = new ArrayList<>();
}
