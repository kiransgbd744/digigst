 ...
 */
	...
	@Component("Gstr7ErrorReportDaoImpl")
	public class Gstr7ErrorReportDaoImpl implements Gstr7GstnErrorReportsDao {

		private static final Logger LOGGER = LoggerFactory.getLogger(Gstr7ErrorReportDaoImpl.class);
