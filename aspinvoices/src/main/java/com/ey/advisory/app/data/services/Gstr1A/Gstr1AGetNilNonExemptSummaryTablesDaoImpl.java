 ...
 * 
 */
@Component("Gstr1AGetNilNonExemptSummaryTablesDaoImpl")
@Slf4j
public class Gstr1AGetNilNonExemptSummaryTablesDaoImpl implements Gstr1AaGetDao {
	...
	private String creategstnNILQueryString(String buildQuery) {
		...
		return "select ID,GSTIN,RETURN_PERIOD,SUPPLY_TYPE,NIL_AMT,"
				...
				+ "FROM GETGSTR1A_NILEXTNON HDR LEFT JOIN GETANX1_BATCH_TABLE BT "
