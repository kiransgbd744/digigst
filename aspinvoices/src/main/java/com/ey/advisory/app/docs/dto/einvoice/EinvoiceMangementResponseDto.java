 ...
 *
 */
public class EinvoiceMangementResponseDto {
	...
	private String amendedReturnPeriod;
	private String amendedPortCode;
	private String amendedShipBillNo;
	private String amendedShipBillDate;

	public String getAmendedPortCode() {
		return amendedPortCode;
	}

	public void setAmendedPortCode(String amendedPortCode) {
		this.amendedPortCode = amendedPortCode;
	}

	public String getAmendedShipBillNo() {
		return amendedShipBillNo;
	}

	public void setAmendedShipBillNo(String amendedShipBillNo) {
		this.amendedShipBillNo = amendedShipBillNo;
	}

	public String getAmendedShipBillDate() {
		return amendedShipBillDate;
	}

	public void setAmendedShipBillDate(String amendedShipBillDate) {
		this.amendedShipBillDate = amendedShipBillDate;
	}
	

	public String getAmendedReturnPeriod() {
		return amendedReturnPeriod;
	}

	public void setAmendedReturnPeriod(String amendedReturnPeriod) {
		this.amendedReturnPeriod = amendedReturnPeriod;
	}
	...
	/**
	 * @param taxableValueAdj
	 *            the taxableValueAdj to set
	 */
	...
	/**
	 * @param integdTaxAmtAdj
	 *            the integdTaxAmtAdj to set
	 */
	...
	/**
	 * @param centralTaxAmtAdj
	 *            the centralTaxAmtAdj to set
	 */
	...
	/**
	 * @param stateUTTaxAmtAdj
	 *            the stateUTTaxAmtAdj to set
	 */
	...
	/**
	 * @param advlmCessAmtAdj
	 *            the advlmCessAmtAdj to set
	 */
	...
	/**
	 * @param specfCessAmtAdj
	 *            the specfCessAmtAdj to set
	 */
	...
	/**
	 * @param stateCessAmtAdj
	 *            the stateCessAmtAdj to set
	 */
	...
	public String getEWBDateStr() {
		return eWBDateStr;
	}

	public void setEWBDateStr(String eWBDateStr) {
		this.eWBDateStr = eWBDateStr;
	}
	...
	public String toString() {
		return "DataStatusEinvoiceDto [aspErrorCode=" + aspErrorCode
				...
				+ ", ewbStatus=" + ewbStatus + ", ewbValidupto=" + ewbValidupto
				+ ", ewbNo=" + ewbNo + ", ewbRespDate=" + ewbRespDate
				+ ", ewbErrorCode=" + ewbErrorCode + ", ewbErrorDescription="
				+ ewbErrorDescription + ", ewbDate=" + ewbDate + ", gstnStatus="
				+ gstnStatus + ", gstnRefid=" + gstnRefid
				+ ", gstnRefidDateTime=" + gstnRefidDateTime
				+ ", gstnErrorCode=" + gstnErrorCode + ", gstnErrorDescription="
				+ gstnErrorDescription + ", returnType=" + returnType
				+ ", tableNumber=" + tableNumber + ", irn=" + irn + ", irnDate="
				+ irnDate + ", taxScheme=" + taxScheme + ", cancellationReason="
				+ cancellationReason + ", cancellationRemarks="
				+ cancellationRemarks + ", supplyType=" + supplyType
				+ ", docCategory=" + docCategory + ", documentType="
				+ documentType + ", documentNumber=" + documentNumber
				+ ", documentDate=" + documentDate + ", reverseChargeFlag="
				+ reverseChargeFlag + ", supplierGSTIN=" + supplierGSTIN
				...
				+ ", tCSRateIncomeTax=" + tCSRateIncomeTax
				...
				+ ecomGSTIN + ", ecomTransactionID=" + ecomTransactionID
				...
				+ cRDRPreGST + ", customerType=" + customerType
				+ ", customerCode=" + customerCode + ", productCode="
				+ productCode + ", categoryOfProduct=" + categoryOfProduct
				+ ", iTCFlag=" + iTCFlag + ", stateApplyingCess="
				+ stateApplyingCess + ", fOB=" + fOB + ", exportDuty="
				+ exportDuty + ", exchangeRate=" + exchangeRate
				+ ", reasonForCreditDebitNote=" + reasonForCreditDebitNote
				+ ", tCSFlagGST=" + tCSFlagGST + ", tCSIGSTAmount="
				+ tCSIGSTAmount + ", tCSCGSTAmount=" + tCSCGSTAmount
				+ ", tCSSGSTAmount=" + tCSSGSTAmount + ", tDSFlagGST="
				+ tDSFlagGST + ", tDSIGSTAmount=" + tDSIGSTAmount
				...
				+ ", sourceFileName=" + sourceFileName + ", plantCode="
				...
				+ ", glPostingDate=" + glPostingDate + ", salesOrderNumber="
				+ salesOrderNumber + ", eWBNumber=" + eWBNumber + ", eWBDateStr="
				+ eWBDateStr + ", accountingVoucherNumber="
				+ accountingVoucherNumber + ", accountingVoucherDate="
				+ accountingVoucherDate + ", documentReferenceNumber="
				+ documentReferenceNumber + ", customerTAN=" + customerTAN
				+ ", userDefField1=" + userDefField1 + ", userDefField2="
				+ userDefField2 + ", userDefField3=" + userDefField3
				+ ", userDefField4=" + userDefField4 + ", userDefField5="
				+ userDefField5 + ", userDefField6=" + userDefField6
				+ ", userDefField7=" + userDefField7 + ", userDefField8="
				+ userDefField8 + ", userDefField9=" + userDefField9
				+ ", userDefField10=" + userDefField10 + ", userDefField11="
				+ userDefField11 + ", userDefField12=" + userDefField12
				+ ", userDefField13=" + userDefField13 + ", userDefField14="
				+ userDefField14 + ", userDefField15=" + userDefField15
				+ ", userDefField16=" + userDefField16 + ", userDefField17="
				+ userDefField17 + ", userDefField18=" + userDefField18
				+ ", userDefField19=" + userDefField19 + ", userDefField20="
				+ userDefField20 + ", userDefField21=" + userDefField21
				+ ", userDefField22=" + userDefField22 + ", userDefField23="
				+ userDefField23 + ", userDefField24=" + userDefField24
				+ ", userDefField25=" + userDefField25 + ", userDefField26="
				+ userDefField26 + ", userDefField27=" + userDefField27
				+ ", userDefField28=" + userDefField28 + ", userDefField29="
				+ userDefField29 + ", userDefField30=" + userDefField30
				+ ", supplyTypeASP=" + supplyTypeASP
				+ ", approximateDistanceASP=" + approximateDistanceASP
				+ ", distanceSavedtoEWB=" + distanceSavedtoEWB + ", userId="
				+ userId + ", fileID=" + fileID + ", fileName=" + fileName
				+ ", invoiceOtherChargesASP=" + invoiceOtherChargesASP
				+ ", invoiceAssessableAmountASP=" + invoiceAssessableAmountASP
				+ ", invoiceIGSTAmountASP=" + invoiceIGSTAmountASP
				+ ", invoiceCGSTAmountASP=" + invoiceCGSTAmountASP
				+ ", invoiceSGSTAmountASP=" + invoiceSGSTAmountASP
				...
				+ invoiceStateCessSpecificAmountASP + ", invoiceValueASP="
				+ invoiceValueASP + ", integratedTaxAmountASP="
				+ integratedTaxAmountASP + ", centralTaxAmountASP="
				+ centralTaxAmountASP + ", stateUTTaxAmountASP="
				+ stateUTTaxAmountASP + ", cessAdvaloremAmountASP="
				+ cessAdvaloremAmountASP + ", stateCessAdvaloremAmountASP="
				...
				+ stateCessAdvaloremAmountDifference + ", recordStatus="
				+ recordStatus + ", shipToState=" + shipToState + ", recpCode="
				+ recpCode + ", dataCategory=" + dataCategory + ", adjRefNo="
				+ adjRefNo + ", adjRefDate=" + adjRefDate + ", taxableValueAdj="
				+ taxableValueAdj + ", integdTaxAmtAdj=" + integdTaxAmtAdj
				+ ", centralTaxAmtAdj=" + centralTaxAmtAdj
				+ ", stateUTTaxAmtAdj=" + stateUTTaxAmtAdj
				+ ", advlmCessAmtAdj=" + advlmCessAmtAdj + ", specfCessAmtAdj="
				+ specfCessAmtAdj + ", stateCessAmtAdj=" + stateCessAmtAdj
				+ ", tcsAmount=" + tcsAmount + ", recpadd3=" + recpadd3
				+ ", shiptoState=" + shiptoState + ", digiGSTStatus="
				+ digiGSTStatus + ", errorPoint=" + errorPoint
				+ ", irnAcknowledgmentDate=" + irnAcknowledgmentDate
				+ ", irnAcknowledgmentTime=" + irnAcknowledgmentTime
				+ ", irnCancellationDate=" + irnCancellationDate
				+ ", irnCancellationTime=" + irnCancellationTime + ", ewbTime="
				+ ewbTime + ", ewbValiduptoTime=" + ewbValiduptoTime
				+ ", eWBCancellationDate=" + eWBCancellationDate
				+ ", eWBCancellationTime=" + eWBCancellationTime
				+ ", gstnRefidDate=" + gstnRefidDate + ", gstnRefidTime="
				+ gstnRefidTime + ", infoErrorCode=" + infoErrorCode
