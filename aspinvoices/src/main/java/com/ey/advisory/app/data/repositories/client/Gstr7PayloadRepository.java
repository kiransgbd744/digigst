 ...
 *
 */
@Repository("Gstr7PayloadRepository")
@Transactional(propagation = Propagation.REQUIRED, readOnly = false)
public interface Gstr7PayloadRepository
		extends CrudRepository<Gstr7PayloadEntity, Long> {

	@Modifying
	@Query("UPDATE Gstr7PayloadEntity nil SET nil.status=:status,"
