...
import com.ey.advisory.core.search.SearchCriteria;
	...
	@Service("AspCDNRAReportServiceImpl")
	public class AspCDNRAReportServiceImpl
			implements Gstr1ReviewSummReportsService {

		private static final Logger LOGGER = LoggerFactory
				.getLogger(AspCDNRAReportServiceImpl.class);

		@Autowired
		CommonUtility commonUtility;

		@Autowired
		@Qualifier("AspCDNRASectionReportDaoImpl")
