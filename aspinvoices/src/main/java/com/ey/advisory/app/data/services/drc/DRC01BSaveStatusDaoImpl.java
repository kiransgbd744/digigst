 ...
 *
 */
@Component("DRC01BSaveStatusDaoImpl")
@Slf4j
public class DRC01BSaveStatusDaoImpl implements DRC01BSaveStatusDao {
	...
	public List<Gst3BSaveStatusDto> getSaveStatus(String gstin,
		...
		if (LOGGER.isDebugEnabled()) {
			String msg = String.format("Gstr3BSaveStatusDaoImpl "
					+ "Query for Save Status in DRC01B : %s",
					queryString);
			LOGGER.debug(msg);
		}
		...
		if (LOGGER.isDebugEnabled()) {
			String msg = String.format(
					"Result List for Save Status in DRC01B : %s ",
	...
	private Gst3BSaveStatusDto convert(Object[] obj) {
		...
		dto.setAction(obj[5] != null ? String.valueOf(obj[5]) : "DRC01B_SAVE");
	...
	private String CreateQuery() {
		String query = "SELECT ID, REF_ID, STATUS, ERROR_COUNT, CREATED_ON, API_ACTION FROM "
				+ "TBL_DRC_SAVE_STATUS WHERE GSTIN = :gstin AND "
