 ...
 *
 */
@Component("InvoiceHeaderCheckService")
public class InvoiceHeaderCheckService implements Gstr1HeaderCheckService {
	@Autowired
	...
	public static final String[] EXPECTED_HEADERS = { "SupplierGSTIN",
			"ReturnPeriod","SerialNo","NatureOfDocument","From","To",
			"TotalNumber","Cancelled","NetNumber"
 };
