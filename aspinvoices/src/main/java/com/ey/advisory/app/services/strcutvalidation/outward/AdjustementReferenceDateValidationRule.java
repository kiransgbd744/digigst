...
public class AdjustementReferenceDateValidationRule implements ValidationRule {
	...
	public List<ProcessingResult> isValid(int idx,Object obj, Object[] row,
		...
		if (!isPresent(obj)) return errors;
			...
			errorLocations.add(GSTConstants.ADJREFDATE);
			TransDocProcessingResultLoc location = new TransDocProcessingResultLoc(
					idx, errorLocations.toArray());
			errors.add(new ProcessingResult(APP_VALIDATION, "ER0086",
					"Invalid Adjustement Reference Date", location));
			return errors;
		}
