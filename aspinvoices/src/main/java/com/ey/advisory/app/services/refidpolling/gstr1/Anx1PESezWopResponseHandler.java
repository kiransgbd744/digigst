 ...
 *
 */
@Component("Anx1PESezWopResponseHandler")
public class Anx1PESezWopResponseHandler implements Anx1ResponseHandler {
	...
	public Triplet<List<String>, Map<String, OutwardTransDocError>,Integer> response(
		...
		for (Anx1SezwpAndSezwopData invoice : anx1ErrorReportData.getSezwopInvoice()) {
