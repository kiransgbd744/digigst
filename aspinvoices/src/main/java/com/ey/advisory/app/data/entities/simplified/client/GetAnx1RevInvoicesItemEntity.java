 ...
 */
@Entity
@Table(name = "GETANX1_REV_ITEM")
public class GetAnx1RevInvoicesItemEntity {
	...
	protected GetAnx1RevInvoicesHeaderEntity header;
	...
	public GetAnx1RevInvoicesHeaderEntity getHeader() {
		return header;
	}

	public void setHeader(GetAnx1RevInvoicesHeaderEntity header) {
		this.header = header;
	}
