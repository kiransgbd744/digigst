 ...
 *
 */
public class Gstr1AB2csArthimatics
	...
	public List<ProcessingResult> validate(Gstr1AAsEnteredB2csEntity document,
		...
		String taxableValues = (document.getNewTaxVal() != null)
				? document.getNewTaxVal().trim() : null;
			...
			if ((sgstin != null && pos != null)
				...
				if (sgstAmount.compareTo(intraL65taxAmount) != 0) {
					...
					errors.add(new ProcessingResult(APP_VALIDATION,
							ProcessingResultType.INFO, "IN5502",
				...
				if (cgstAmount.compareTo(intraL65taxAmount) != 0) {
					...
					TransDocProcessingResultLoc location = new TransDocProcessingResultLoc(
							null, errorLocations.toArray());
					errors.add(new ProcessingResult(APP_VALIDATION,
							ProcessingResultType.INFO, "IN5503",
				...
				if (igstAmount.compareTo(interL65taxAmount) != 0) {
					...
					TransDocProcessingResultLoc location = new TransDocProcessingResultLoc(
							null, errorLocations.toArray());
					errors.add(new ProcessingResult(APP_VALIDATION,
							ProcessingResultType.INFO, "IN5507",
