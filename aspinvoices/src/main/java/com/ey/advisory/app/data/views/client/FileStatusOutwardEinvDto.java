...
public class FileStatusOutwardEinvDto {
	...
	public String getResponseTaxPeriod() {
		return responseTaxPeriod;
	}
	public void setResponseTaxPeriod(String responseTaxPeriod) {
		this.responseTaxPeriod = responseTaxPeriod;
	}
	public String getReconTaxPeriod() {
		return reconTaxPeriod;
	}
	public void setReconTaxPeriod(String reconTaxPeriod) {
		this.reconTaxPeriod = reconTaxPeriod;
	}
	...
	public String getGLCodeAdvaloremCess() {
		return GLCodeAdvaloremCess;
	}
	public void setGLCodeAdvaloremCess(String gLCodeAdvaloremCess) {
		GLCodeAdvaloremCess = gLCodeAdvaloremCess;
	}
	public String getGLCodeSpecificCess() {
		return GLCodeSpecificCess;
	}
	public void setGLCodeSpecificCess(String gLCodeSpecificCess) {
		GLCodeSpecificCess = gLCodeSpecificCess;
	}
	...
	public String getDifferentialFlag() {
		return DifferentialFlag;
	}
	public void setDifferentialFlag(String differentialFlag) {
		DifferentialFlag = differentialFlag;
	}
	...
	public void setSection7ofIGSTFlag(String section7ofIGSTFlag) {
		Section7ofIGSTFlag = section7ofIGSTFlag;
	}
	...
	public String getIntegratedTaxRate() {
		return IntegratedTaxRate;
	}
	public void setIntegratedTaxRate(String integratedTaxRate) {
	...
	public String getCentralTaxRate() {
		return CentralTaxRate;
	}
	public void setCentralTaxRate(String centralTaxRate) {
	...
	public String getStateUTTaxRate() {
		return StateUTTaxRate;
	}
	public void setStateUTTaxRate(String stateUTTaxRate) {
	...
	public String getAdvaloremCessRate() {
		return AdvaloremCessRate;
	}
	public void setAdvaloremCessRate(String advaloremCessRate) {
		AdvaloremCessRate = advaloremCessRate;
	}
	public String getAdvaloremCessAmount() {
		return AdvaloremCessAmount;
	}
	public void setAdvaloremCessAmount(String advaloremCessAmount) {
		AdvaloremCessAmount = advaloremCessAmount;
	}
	public String getSpecificCessRate() {
		return SpecificCessRate;
	}
	public void setSpecificCessRate(String specificCessRate) {
		SpecificCessRate = specificCessRate;
	}
	public String getSpecificCessAmount() {
		return SpecificCessAmount;
	}
	public void setSpecificCessAmount(String specificCessAmount) {
		SpecificCessAmount = specificCessAmount;
	}
	public String getStateCessRate() {
		return StateCessRate;
	}
	public void setStateCessRate(String stateCessRate) {
		StateCessRate = stateCessRate;
	}
	public String getStateCessAmount() {
		return StateCessAmount;
	}
	public void setStateCessAmount(String stateCessAmount) {
		StateCessAmount = stateCessAmount;
	}
	...
	public void setClaimRefundFlag(String claimRefundFlag) {
		ClaimRefundFlag = claimRefundFlag;
	}
	...
	public void setAutoPopulateToRefund(String autoPopulateToRefund) {
		AutoPopulateToRefund = autoPopulateToRefund;
	}
	public String getAdjustmentReferenceNo() {
		return AdjustmentReferenceNo;
	}
	public void setAdjustmentReferenceNo(String adjustmentReferenceNo) {
		AdjustmentReferenceNo = adjustmentReferenceNo;
	}
	public String getAdjustmentReferenceDate() {
		return AdjustmentReferenceDate;
	}
	public void setAdjustmentReferenceDate(String adjustmentReferenceDate) {
		AdjustmentReferenceDate = adjustmentReferenceDate;
	}
	public String getTaxableValueAdjusted() {
		return TaxableValueAdjusted;
	}
	public void setTaxableValueAdjusted(String taxableValueAdjusted) {
		TaxableValueAdjusted = taxableValueAdjusted;
	}
	public String getIntegratedTaxAmountAdjusted() {
		return IntegratedTaxAmountAdjusted;
	}
	public void setIntegratedTaxAmountAdjusted(String integratedTaxAmountAdjusted) {
		IntegratedTaxAmountAdjusted = integratedTaxAmountAdjusted;
	}
	public String getCentralTaxAmountAdjusted() {
		return CentralTaxAmountAdjusted;
	}
	public void setCentralTaxAmountAdjusted(String centralTaxAmountAdjusted) {
		CentralTaxAmountAdjusted = centralTaxAmountAdjusted;
	}
	public String getStateUTTaxAmountAdjusted() {
		return StateUTTaxAmountAdjusted;
	}
	public void setStateUTTaxAmountAdjusted(String stateUTTaxAmountAdjusted) {
		StateUTTaxAmountAdjusted = stateUTTaxAmountAdjusted;
	}
	public String getAdvaloremCessAmountAdjusted() {
		return AdvaloremCessAmountAdjusted;
	}
	public void setAdvaloremCessAmountAdjusted(String advaloremCessAmountAdjusted) {
		AdvaloremCessAmountAdjusted = advaloremCessAmountAdjusted;
	}
	public String getSpecificCessAmountAdjusted() {
		return SpecificCessAmountAdjusted;
	}
	public void setSpecificCessAmountAdjusted(String specificCessAmountAdjusted) {
		SpecificCessAmountAdjusted = specificCessAmountAdjusted;
	}
	public String getStateCessAmountAdjusted() {
		return StateCessAmountAdjusted;
	}
	public void setStateCessAmountAdjusted(String stateCessAmountAdjusted) {
		StateCessAmountAdjusted = stateCessAmountAdjusted;
	}
	...
	public void setInvoiceValueASP(String invoiceValueASP) {
		InvoiceValueASP = invoiceValueASP;
	}
	...
	public String getASPDateTime() {
		return ASPDateTime;
	}
	public void setASPDateTime(String aSPDateTime) {
		ASPDateTime = aSPDateTime;
	}
	@Override
	public String toString() {
		return "Gstr2ProcessedDto [category=" + category + ", userResponse=" + userResponse + ", suggestedResponse="
				+ suggestedResponse + ", reportType=" + reportType + ", mismatchReason=" + mismatchReason
				+ ", responseTaxPeriod=" + responseTaxPeriod + ", reconTaxPeriod=" + reconTaxPeriod + ", calendarMonth="
				+ calendarMonth + ", orgMonth=" + orgMonth + ", UserID=" + UserID + ", SourceFileName=" + SourceFileName
				+ ", ProfitCentre=" + ProfitCentre + ", Plant=" + Plant + ", Division=" + Division + ", Location="
				+ Location + ", PurchaseOrganisation=" + PurchaseOrganisation + ", UserAccess1=" + UserAccess1
				+ ", UserAccess2=" + UserAccess2 + ", UserAccess3=" + UserAccess3 + ", UserAccess4=" + UserAccess4
				+ ", UserAccess5=" + UserAccess5 + ", UserAccess6=" + UserAccess6 + ", GLCodeTaxableValue="
				+ GLCodeTaxableValue + ", GLCodeIGST=" + GLCodeIGST + ", GLCodeCGST=" + GLCodeCGST + ", GLCodeSGST="
				+ GLCodeSGST + ", GLCodeAdvaloremCess=" + GLCodeAdvaloremCess + ", GLCodeSpecificCess="
				+ GLCodeSpecificCess + ", GLCodeStateCess=" + GLCodeStateCess + ", ReturnPeriod=" + ReturnPeriod
				+ ", RecipientGSTIN=" + RecipientGSTIN + ", DocumentType=" + DocumentType + ", SupplyType=" + SupplyType
				+ ", DocumentNumber=" + DocumentNumber + ", DocumentDate=" + DocumentDate + ", OriginalDocumentNumber="
				+ OriginalDocumentNumber + ", OriginalDocumentDate=" + OriginalDocumentDate + ", CRDRPreGST="
				+ CRDRPreGST + ", LineNumber=" + LineNumber + ", SupplierGSTIN=" + SupplierGSTIN + ", SupplierType="
				+ SupplierType + ", DifferentialFlag=" + DifferentialFlag + ", OriginalSupplierGSTIN="
				+ OriginalSupplierGSTIN + ", SupplierName=" + SupplierName + ", SupplierCode=" + SupplierCode
				+ ", SupplierAddress1=" + SupplierAddress1 + ", SupplierAddress2=" + SupplierAddress2
				+ ", SupplierAddress3=" + SupplierAddress3 + ", SupplierAddress4=" + SupplierAddress4 + ", POS=" + POS
				+ ", StateApplyingCess=" + StateApplyingCess + ", PortCode=" + PortCode + ", BillOfEntry=" + BillOfEntry
				+ ", BillOfEntryDate=" + BillOfEntryDate + ", CIFValue=" + CIFValue + ", CustomDuty=" + CustomDuty
				+ ", HSNorSAC=" + HSNorSAC + ", ItemCode=" + ItemCode + ", ItemDescription=" + ItemDescription
				+ ", CategoryOfItem=" + CategoryOfItem + ", UnitOfMeasurement=" + UnitOfMeasurement + ", Quantity="
				+ Quantity + ", Section7ofIGSTFlag=" + Section7ofIGSTFlag + ", TaxableValue=" + TaxableValue
				+ ", IntegratedTaxRate=" + IntegratedTaxRate + ", IntegratedTaxAmount=" + IntegratedTaxAmount
				+ ", CentralTaxRate=" + CentralTaxRate + ", CentralTaxAmount=" + CentralTaxAmount + ", StateUTTaxRate="
				+ StateUTTaxRate + ", StateUTTaxAmount=" + StateUTTaxAmount + ", AdvaloremCessRate=" + AdvaloremCessRate
				+ ", AdvaloremCessAmount=" + AdvaloremCessAmount + ", SpecificCessRate=" + SpecificCessRate
				+ ", SpecificCessAmount=" + SpecificCessAmount + ", StateCessRate=" + StateCessRate
				+ ", StateCessAmount=" + StateCessAmount + ", OtherValue=" + OtherValue + ", InvoiceValue="
				+ InvoiceValue + ", ClaimRefundFlag=" + ClaimRefundFlag + ", AutoPopulateToRefund="
				+ AutoPopulateToRefund + ", AdjustmentReferenceNo=" + AdjustmentReferenceNo
				+ ", AdjustmentReferenceDate=" + AdjustmentReferenceDate + ", TaxableValueAdjusted="
				+ TaxableValueAdjusted + ", IntegratedTaxAmountAdjusted=" + IntegratedTaxAmountAdjusted
				+ ", CentralTaxAmountAdjusted=" + CentralTaxAmountAdjusted + ", StateUTTaxAmountAdjusted="
				+ StateUTTaxAmountAdjusted + ", AdvaloremCessAmountAdjusted=" + AdvaloremCessAmountAdjusted
				+ ", SpecificCessAmountAdjusted=" + SpecificCessAmountAdjusted + ", StateCessAmountAdjusted="
				+ StateCessAmountAdjusted + ", ReverseChargeFlag=" + ReverseChargeFlag + ", EligibilityIndicator="
				+ EligibilityIndicator + ", CommonSupplyIndicator=" + CommonSupplyIndicator + ", AvailableIGST="
				+ AvailableIGST + ", AvailableCGST=" + AvailableCGST + ", AvailableSGST=" + AvailableSGST
				+ ", AvailableCess=" + AvailableCess + ", ITCEntitlement=" + ITCEntitlement + ", ITCReversalIdentifier="
				+ ITCReversalIdentifier + ", ReasonForCreditDebitNote=" + ReasonForCreditDebitNote
				+ ", PurchaseVoucherNumber=" + PurchaseVoucherNumber + ", PurchaseVoucherDate=" + PurchaseVoucherDate
				+ ", PostingDate=" + PostingDate + ", PaymentVoucherNumber=" + PaymentVoucherNumber + ", PaymentDate="
				+ PaymentDate + ", ContractNumber=" + ContractNumber + ", ContractDate=" + ContractDate
				+ ", ContractValue=" + ContractValue + ", UserDefinedField1=" + UserDefinedField1
				+ ", UserDefinedField2=" + UserDefinedField2 + ", UserDefinedField3=" + UserDefinedField3
				+ ", UserDefinedField4=" + UserDefinedField4 + ", UserDefinedField5=" + UserDefinedField5
				+ ", UserDefinedField6=" + UserDefinedField6 + ", UserDefinedField7=" + UserDefinedField7
				+ ", UserDefinedField8=" + UserDefinedField8 + ", UserDefinedField9=" + UserDefinedField9
				+ ", UserDefinedField10=" + UserDefinedField10 + ", UserDefinedField11=" + UserDefinedField11
				+ ", UserDefinedField12=" + UserDefinedField12 + ", UserDefinedField13=" + UserDefinedField13
				+ ", UserDefinedField14=" + UserDefinedField14 + ", UserDefinedField15=" + UserDefinedField15
				+ ", EWayBillNumber=" + EWayBillNumber + ", EWayBillDate=" + EWayBillDate + ", ReturnType=" + ReturnType
				+ ", DataCategory=" + DataCategory + ", TableNumber=" + TableNumber + ", ASPInformationID="
				+ ASPInformationID + ", ASPInformationDescription=" + ASPInformationDescription + ", InvoiceValueASP="
				+ InvoiceValueASP + ", UploadSource=" + UploadSource + ", SourceID=" + SourceID + ", FileName="
				+ FileName + ", ASPDateTime=" + ASPDateTime + "]";
	}
