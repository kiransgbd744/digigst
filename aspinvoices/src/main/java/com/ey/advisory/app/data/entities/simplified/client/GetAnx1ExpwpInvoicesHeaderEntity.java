 ...
 */
@Entity
@Table(name = "GETANX1_EXPWP_HEADER")
public class GetAnx1ExpwpInvoicesHeaderEntity {
	...
	protected List<GetAnx1ExpwpInvoicesItemEntity> lineItems = new ArrayList<>();

	@Column(name = "BATCH_ID")
	private Long expwpBatchId;
	...
	public List<GetAnx1ExpwpInvoicesItemEntity> getLineItems() {
		return lineItems;
	}

	public void setLineItems(List<GetAnx1ExpwpInvoicesItemEntity> lineItems) {
		this.lineItems = lineItems;
	}

	/*
	 * public GetAnx1BatchEntity getExpwpBatchId() { return expwpBatchId; }
	 * 
	 * public void setExpwpBatchId(GetAnx1BatchEntity expwpBatchId) {
	 * this.expwpBatchId = expwpBatchId; }
	 */
	/*
	 * public String getDocKey() { return docKey; }
	 */

	public Long getExpwpBatchId() {
		return expwpBatchId;
	}

	public void setExpwpBatchId(Long expwpBatchId) {
		this.expwpBatchId = expwpBatchId;
	}
