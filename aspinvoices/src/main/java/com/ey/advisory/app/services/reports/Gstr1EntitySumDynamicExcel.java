...
import com.ey.advisory.app.services.reports.Gstr1ReviewSumDynamicExcel.Gstr1SummaryScreenTotalRespDto;
 ...
 *
 */
public class Gstr1EntitySumDynamicExcel {
	...
	private static final List<String> hsnTable = Lists.newArrayList("", "Count",
			"Total Value", "Assesable Amount", "Total Tax", "IGST", "CGST",
			"SGST", "Cess", "Count", "Total Value", "Gross Advances",
			"Total Tax", "IGST", "CGST", "SGST", "Cess", "Count", "Total Value",
			"Gross Advances", "Total Tax", "IGST", "CGST", "SGST", "Cess");
	 ...
	 * @throws Exception
	 */
	public static void generateEntityExcel(Workbook workbook,
		...
		applyStyles(1, 1, worksheet, 0, false, true, FontUnderlineType.NONE,
				null, null, false, 14);
		dataArray[2][1] = "ENTITY NAME- " + entityName + "| Date - " + date
				+ " | Time - " + time + " | Tax Period- " + taxPeriod + "";
