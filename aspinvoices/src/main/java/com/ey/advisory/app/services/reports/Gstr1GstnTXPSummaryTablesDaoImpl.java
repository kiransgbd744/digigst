...
@Component("Gstr1GstnTXPSummaryTablesDaoImpl")
public class Gstr1GstnTXPSummaryTablesDaoImpl
		implements Gstr1GstnSummaryTablesDao {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(Gstr1GstnTXPSummaryTablesDaoImpl.class);
	...
	private String creategstnTXPQueryString(String buildQuery) {
		...
		return "SELECT HDR.ID,HDR.GSTIN,HDR.RETURN_PERIOD,SUPPLY_TYPE,"
