...
import com.ey.advisory.core.search.SearchCriteria;
	...
	@Service("Gstr1AAspCDNURSectionReportServiceImpl")
	public class Gstr1AAspCDNURSectionReportServiceImpl
			implements Gstr1AReviewSummReportsService {

		private static final Logger LOGGER = LoggerFactory
				.getLogger(Gstr1AAspCDNURSectionReportServiceImpl.class);

		@Autowired
		CommonUtility commonUtility;

		@Autowired
		@Qualifier("Gstr1AAspCDNURSectionReportDaoImpl")
