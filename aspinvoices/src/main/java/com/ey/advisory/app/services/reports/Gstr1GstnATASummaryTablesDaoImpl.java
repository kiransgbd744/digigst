...
@Component("Gstr1GstnATASummaryTablesDaoImpl")
public class Gstr1GstnATASummaryTablesDaoImpl
		implements Gstr1GstnSummaryTablesDao {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(Gstr1GstnATASummaryTablesDaoImpl.class);
	...
	private String creategstnATAQueryString(String buildQuery) {
		...
		return "SELECT HDR.ID,HDR.GSTIN,HDR.RETURN_PERIOD,HDR.ORG_MONTH,"
