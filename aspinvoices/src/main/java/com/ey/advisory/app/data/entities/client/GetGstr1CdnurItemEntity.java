...
@Entity
@Table(name = "GETGSTR1_CDNUR_ITEM")
public class GetGstr1CdnurItemEntity {
	...
	private GetGstr1CdnurHeaderEntity document;
	...
	public GetGstr1CdnurHeaderEntity getDocument() {
		return document;
	}

	public void setDocument(GetGstr1CdnurHeaderEntity document) {
