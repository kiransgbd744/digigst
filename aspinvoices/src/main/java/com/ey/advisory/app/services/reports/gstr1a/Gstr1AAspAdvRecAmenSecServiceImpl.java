...
import com.ey.advisory.core.search.SearchCriteria;
	...
	@Service("Gstr1AAspAdvRecAmenSecServiceImpl")
	public class Gstr1AAspAdvRecAmenSecServiceImpl
			implements Gstr1AASPAdvRecSavableService {

		private static final Logger LOGGER = LoggerFactory
				.getLogger(Gstr1AAspAdvRecAmenSecServiceImpl.class);

		@Autowired
		CommonUtility commonUtility;

		@Autowired
		@Qualifier("Gstr1AAspAdvRecAmenSecTotalSummaryDaoImpl")
		private Gstr1AAdvRecSavableDao gstr1AdvRectotalDao;
		
		@Autowired
		@Qualifier("Gstr1AAspAdvRecAmenSecSummaryDaoImpl")
		...
		public Workbook findGstr1AdvRecSavableReports(SearchCriteria criteria,
			...
			workbook = createWorkbookWithExcelTemplate("ReportTemplates",
					"GSTR-1_Amen_Advance_Received_Savable.xlsx");

			LOGGER.debug(
					"Gstr1 Asp Advance Received Savable data response" + responseFromViewTotal);
