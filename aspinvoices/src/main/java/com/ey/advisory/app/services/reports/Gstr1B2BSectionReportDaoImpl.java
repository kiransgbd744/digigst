...
@Component("Gstr1B2BSectionReportDaoImpl")
public class Gstr1B2BSectionReportDaoImpl
		implements Gstr1ReviewSummaryCustomizedReportsDao {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(Gstr1B2BSectionReportDaoImpl.class);
	...
	@Override
	public Pair<List<Object[]>, List<Object>> getGstr1RSReports(
		...
		if (APIConstants.GSTR1A.equalsIgnoreCase(request.getReturnType())) {
			queryStr = createApiProcessedQueryStringForGstr1a(
					buildHeader.toString());

		} else {
			queryStr = createApiProcessedQueryString(buildHeader.toString(),
					multiSupplyTypeAns);
		...
		if (ud5 != null && !ud5.isEmpty() && ud5List.size() > 0) {
		...
		List<Object> collect = list.stream().map(o -> convertProcessed(o))
				.collect(Collectors.toCollection(ArrayList::new));
		return new Pair<>(list, collect);
	...
	private DataStatusEinvoiceDto convertProcessed(Object[] arr) {
		...
		if (arr[20] != null) {
			...
			String timestamp = removeQuotes(arr[20].toString());
			...
			String[] dteTime = istTime.split(" ");
			String date = dteTime[0];
			String tym = dteTime[1];

			obj.setGstnRefidDate(date);
			obj.setGstnRefidTime(
					DownloadReportsConstant.CSVCHARACTER.concat(tym));
		...
		obj.setUserDefField1(
				arr[234] != null ? DownloadReportsConstant.CSVCHARACTER
						.concat(arr[234].toString()) : null);
		obj.setUserDefField2(
				arr[235] != null ? DownloadReportsConstant.CSVCHARACTER
						.concat(arr[235].toString()) : null);
		obj.setUserDefField3(
				arr[236] != null ? DownloadReportsConstant.CSVCHARACTER
						.concat(arr[236].toString()) : null);
		obj.setUserDefField4(
				arr[237] != null ? DownloadReportsConstant.CSVCHARACTER
						.concat(arr[237].toString()) : null);
		obj.setUserDefField5(
				arr[238] != null ? DownloadReportsConstant.CSVCHARACTER
						.concat(arr[238].toString()) : null);
		obj.setUserDefField6(
				arr[239] != null ? DownloadReportsConstant.CSVCHARACTER
						.concat(arr[239].toString()) : null);
		obj.setUserDefField7(
				arr[240] != null ? DownloadReportsConstant.CSVCHARACTER
						.concat(arr[240].toString()) : null);
		obj.setUserDefField8(
				arr[241] != null ? DownloadReportsConstant.CSVCHARACTER
						.concat(arr[241].toString()) : null);
		obj.setUserDefField9(
				arr[242] != null ? DownloadReportsConstant.CSVCHARACTER
						.concat(arr[242].toString()) : null);
		obj.setUserDefField10(
				arr[243] != null ? DownloadReportsConstant.CSVCHARACTER
						.concat(arr[243].toString()) : null);
		obj.setUserDefField11(
				arr[244] != null ? DownloadReportsConstant.CSVCHARACTER
						.concat(arr[244].toString()) : null);
		obj.setUserDefField12(
				arr[245] != null ? DownloadReportsConstant.CSVCHARACTER
						.concat(arr[245].toString()) : null);
		obj.setUserDefField13(
				arr[246] != null ? DownloadReportsConstant.CSVCHARACTER
						.concat(arr[246].toString()) : null);
		obj.setUserDefField14(
				arr[247] != null ? DownloadReportsConstant.CSVCHARACTER
						.concat(arr[247].toString()) : null);
		obj.setUserDefField15(
				arr[248] != null ? DownloadReportsConstant.CSVCHARACTER
						.concat(arr[248].toString()) : null);
		obj.setUserDefField16(
				arr[249] != null ? DownloadReportsConstant.CSVCHARACTER
						.concat(arr[249].toString()) : null);
		obj.setUserDefField17(
				arr[250] != null ? DownloadReportsConstant.CSVCHARACTER
						.concat(arr[250].toString()) : null);
		obj.setUserDefField18(
				arr[251] != null ? DownloadReportsConstant.CSVCHARACTER
						.concat(arr[251].toString()) : null);
		obj.setUserDefField19(
				arr[252] != null ? DownloadReportsConstant.CSVCHARACTER
						.concat(arr[252].toString()) : null);
		obj.setUserDefField20(
				arr[253] != null ? DownloadReportsConstant.CSVCHARACTER
						.concat(arr[253].toString()) : null);
		obj.setUserDefField21(
				arr[254] != null ? DownloadReportsConstant.CSVCHARACTER
						.concat(arr[254].toString()) : null);
		obj.setUserDefField22(
				arr[255] != null ? DownloadReportsConstant.CSVCHARACTER
						.concat(arr[255].toString()) : null);
		obj.setUserDefField23(
				arr[256] != null ? DownloadReportsConstant.CSVCHARACTER
						.concat(arr[256].toString()) : null);
		obj.setUserDefField24(
				arr[257] != null ? DownloadReportsConstant.CSVCHARACTER
						.concat(arr[257].toString()) : null);
		obj.setUserDefField25(
				arr[258] != null ? DownloadReportsConstant.CSVCHARACTER
						.concat(arr[258].toString()) : null);
		obj.setUserDefField26(
				arr[259] != null ? DownloadReportsConstant.CSVCHARACTER
						.concat(arr[259].toString()) : null);
		obj.setUserDefField27(
				arr[260] != null ? DownloadReportsConstant.CSVCHARACTER
						.concat(arr[260].toString()) : null);
		obj.setUserDefField28(
				arr[261] != null ? DownloadReportsConstant.CSVCHARACTER
						.concat(arr[261].toString()) : null);
		obj.setUserDefField29(
				arr[262] != null ? DownloadReportsConstant.CSVCHARACTER
						.concat(arr[262].toString()) : null);
		obj.setUserDefField30(
				arr[263] != null ? DownloadReportsConstant.CSVCHARACTER
		...
		String eINVvsGSTR1Reponse = arr[312] != null ? arr[312].toString()
				: null;
		obj.setEINVvsGstr1Reponse(
				eINVvsGSTR1Reponse != null ? eINVvsGSTR1Reponse : null);
	...
	private static String createApiProcessedQueryString(String buildHeader,
			...
			return " SELECT TRIM(', ' FROM IFNULL(HDR.ERROR_CODES, '') || ',' || IFNULL(ITM.ERROR_CODES, '')) AS ERROR_CODE_ASP "
					...
					+ "			THEN 'Pushed to NIC' "
					+ "		WHEN HDR.IRN_STATUS = 13 "
					+ "			THEN 'Already Generated by User' "
					+ "		WHEN HDR.IRN_STATUS = 11 "
					+ "			THEN 'Pending (Error)' "
					+ "		END AS IRN_STATUS "
					...
					+ "	,ITM.ITM_QTY "
					+ "	,CASE "
					+ "		WHEN PSD.USER_RESPONSE = 'S' "
					+ "			THEN 'S-Save to GSTN' "
					+ "		WHEN PSD.USER_RESPONSE = 'N' "
					+ "			THEN 'N-Do Not save to GSTN' "
					+ "		ELSE '' "
					+ "		END AS EINVVSGSTR1RESPONSE "
					...
					+ "LEFT OUTER JOIN TBL_EINV_RECON_RESP_PSD PSD ON PSD.DOC_HEADER_ID = ITM.DOC_HEADER_ID "
					+ "	AND PSD.IS_DELETE = FALSE "
					+ "	AND PSD.IS_PROCESSED = TRUE "
					...
					+ "	AND  ITM.ITM_TAX_DOC_TYPE IN ('B2B') "
					+ buildHeader
					+ " ORDER BY DOC_NUM "
					+ "	,ITM.ITM_NO";
		 ...
		 * bufferString.append("IFNULL(ITM.ERROR_CODES,'')) AS ERROR_CODE_ASP,"
		 * );
		 * bufferString.append(" '' AS ERROR_DESCRIPTION_ASP, TRIM(',' FROM ");
		 * bufferString.append("IFNULL(HDR.INFORMATION_CODES,'')||','|| ");
		 * bufferString.append(
		 * "IFNULL(ITM.INFORMATION_CODES,'')) AS INFO_ERROR_CODE_ASP, '' AS INFO_ERROR_DESCRIPTION_ASP,"
		 * );
		 * bufferString.append("case when HDR.IRN_STATUS = 1 then 'Not Opted' "
		 * );
		 * bufferString.append("when HDR.IRN_STATUS = 2 then 'Not Applicable' "
		 * ); bufferString
		 * .append("when HDR.IRN_STATUS = 3 then 'Pending (No Action)' ");
		 * bufferString.
		 * append("when HDR.IRN_STATUS = 4 then 'Generation Error' ");
		 * bufferString.append("when HDR.IRN_STATUS = 5 then 'Generated' ");
		 * bufferString.append("when HDR.IRN_STATUS = 6 then 'Cancelled' ");
		 * bufferString.append("when HDR.IRN_STATUS = 7 then 'ASP Error' ");
		 * bufferString.append("when HDR.IRN_STATUS = 8 then 'Duplicate_Irn' ");
		 * bufferString.append("when HDR.IRN_STATUS = 10 then 'Pushed to NIC' "
		 * ); bufferString.append(
		 * "when HDR.IRN_STATUS = 13 then 'Already Generated by User' ");
		 * bufferString.
		 * append("when HDR.IRN_STATUS = 11 then 'Pending (Error)' ");
		 * bufferString.append("end as IRN_STATUS, HDR.IRN_RESPONSE AS IRN_NO,"
		 * ); bufferString.append("HDR.ACK_NUM AS IRN_ACK_NO,");
		 * bufferString.append(
		 * "TO_CHAR(HDR.ACK_DATE,'DD-MM-YYYY HH24:MI:SS') AS IRN_ACK_DATE_TIME,"
		 * ); bufferString.append("EINV.SIGNED_QR AS SIGNED_QR_CODE,");
		 * bufferString.append("NULL AS SIGNED_INVOICE,");
		 * bufferString.append("HDR.EINV_ERROR_CODE AS IRP_ERROR_CODE,");
		 * bufferString.append("HDR.EINV_ERROR_DESC AS IRP_ERROR_DESCRIPTION,");
		 * bufferString
		 * .append("case when HDR.EWB_STATUS = 1 then 'Not Applicable' ");
		 * bufferString.append(
		 * "when HDR.EWB_STATUS = 2 then 'Pending (No Action)' when HDR.EWB_STATUS = 3 "
		 * ); bufferString.
		 * append("then 'Generation Error' when HDR.EWB_STATUS = 4 ");
		 * bufferString.append(
		 * "then 'Part A Generated' when HDR.EWB_STATUS = 5 then ");
		 * bufferString.append(
		 * " 'EWB Active' when HDR.EWB_STATUS = 6 then 'Cancelled' ");
		 * bufferString.append("when HDR.EWB_STATUS = 7 then 'Discarded' ");
		 * bufferString.append("when HDR.EWB_STATUS = 8 then 'Rejected' ");
		 * bufferString.append("when HDR.EWB_STATUS = 9 then 'Expired' ");
		 * bufferString.append("when HDR.EWB_STATUS = 10 then 'Pushed to NIC' "
		 * ); bufferString.append("when HDR.EWB_STATUS = 11 then 'ASP Error' ");
		 * bufferString.append("WHEN HDR.EWB_STATUS = 12 then 'Not_Opted' ");
		 * bufferString.
		 * append("WHEN HDR.EWB_STATUS = 14 then 'Pending (Error)' ");
		 * bufferString.append("end as EWBPartAStatusA,"); bufferString.
		 * append("TO_CHAR(EWB.VALID_UPTO,'DD-MM-YYYY HH24:MI:SS') AS EWBValidUpTo,"
		 * ); bufferString.append("HDR.EWAY_BILL_NUM AS EWBNO,");
		 * bufferString.append("CAST(HDR.EWAY_BILL_DATE AS DATE) AS EWBDATE,");
		 * bufferString.append("HDR.EWB_ERROR_CODE AS EWB_ERROR_CODE,");
		 * bufferString.append("HDR.EWB_ERROR_DESC AS EWB_ERROR_DESCRIPTION,");
		 * bufferString.append("case when HDR.IS_SAVED_TO_GSTN = TRUE ");
		 * bufferString
		 * .append("THEN 'IS_SAVED' WHEN HDR.IS_SAVED_TO_GSTN = FALSE ");
		 * bufferString.append("AND HDR.GSTN_ERROR = TRUE THEN 'IS_ERROR' ");
		 * bufferString.append("WHEN HDR.IS_SAVED_TO_GSTN = FALSE ");
		 * bufferString.
		 * append("AND HDR.GSTN_ERROR = FALSE THEN 'NOT_SAVED' END ");
		 * bufferString.append("AS GSTIN_STATUS, GSTNBATCH.GSTN_SAVE_REF_ID ");
		 * bufferString.append("AS GSTIN_REF_ID, GSTNBATCH.BATCH_DATE ");
		 * bufferString
		 * .append("AS GSTIN_REFID_DATE_TIME, NULL AS GSTIN_ERROR_CODE,");
		 * bufferString.append("NULL AS GSTIN_ERROR_DESCRIPTION_ASP,");
		 * bufferString.append("HDR.RETURN_TYPE AS RET_TYPE,");
		 * bufferString.append("HDR.TABLE_SECTION AS TABLE_NUMBER,HDR.IRN,");
		 * bufferString.append("HDR.IRN_DATE,HDR.TAX_SCHEME, HDR.CANCEL_REASON,"
		 * ); bufferString.append(
		 * "HDR.CANCEL_REMARKS, ITM.SUPPLY_TYPE, HDR.DOC_CATEGORY,");
		 * bufferString.append("HDR.DOC_TYPE,HDR.DOC_NUM,HDR.DOC_DATE,");
		 * bufferString.append("HDR.REVERSE_CHARGE, HDR.SUPPLIER_GSTIN,");
		 * bufferString.append("HDR.SUPP_TRADE_NAME, HDR.SUPP_LEGAL_NAME,");
		 * bufferString.append(
		 * "HDR.SUPP_BUILDING_NUM,HDR.SUPP_BUILDING_NAME AS SUPPLIERADDRESS2,");
		 * bufferString.append("HDR.SUPP_LOCATION,"); bufferString.append(
		 * "HDR.SUPP_PINCODE, HDR.SUPP_STATE_CODE,HDR.SUPP_PHONE,");
		 * bufferString
		 * .append("HDR.SUPP_EMAIL, HDR.CUST_GSTIN,HDR.CUST_TRADE_NAME,");
		 * bufferString.append("HDR.CUST_SUPP_NAME, HDR.CUST_SUPP_ADDRESS1,");
		 * bufferString.append("HDR.CUST_SUPP_ADDRESS2, HDR.CUST_SUPP_ADDRESS4,"
		 * );
		 * bufferString.append("HDR.CUST_PINCODE,HDR.BILL_TO_STATE, HDR.POS,");
		 * bufferString
		 * .append("HDR.CUST_PHONE,HDR.CUST_EMAIL,HDR.DISPATCHER_GSTIN,");
		 * bufferString.append(
		 * "HDR.DISPATCHER_TRADE_NAME,HDR.DISPATCHER_BUILDING_NUM,");
		 * bufferString.append(
		 * "HDR.DISPATCHER_BUILDING_NAME,HDR.DISPATCHER_LOCATION,");
		 * bufferString
		 * .append("HDR.DISPATCHER_PINCODE,HDR.DISPATCHER_STATE_CODE ,");
		 * bufferString.append("HDR.SHIP_TO_GSTIN,");
		 * bufferString.append("HDR.SHIP_TO_TRADE_NAME, HDR.SHIP_TO_LEGAL_NAME,"
		 * ); bufferString
		 * .append("HDR.SHIP_TO_BUILDING_NUM, HDR.SHIP_TO_BUILDING_NAME,");
		 * bufferString.append("HDR.SHIP_TO_LOCATION, ITM.SHIP_TO_PINCODE,");
		 * bufferString.append("ITM.SHIP_TO_STATE,ITM.ITM_NO, ITM.SERIAL_NUM2,"
		 * ); bufferString.append(
		 * "ITM.PRODUCT_NAME,ITM.ITM_DESCRIPTION, ITM.IS_SERVICE,");
		 * bufferString
		 * .append("ITM.ITM_HSNSAC,ITM.BAR_CODE, ITM.BATCH_NAME_OR_NUM,");
		 * bufferString.append("ITM.BATCH_EXPIRY_DATE, ITM.WARRANTY_DATE,");
		 * bufferString.append("ITM.ORDER_ITEM_REFERENCE,ITM.ATTRIBUTE_NAME,");
		 * bufferString.append("ITM.ATTRIBUTE_VALUE, ITM.ORIGIN_COUNTRY,");
		 * bufferString.append("ITM.ITM_UQC_USER,ITM.QTY_USER, ITM.FREE_QTY,");
		 * bufferString.append("ITM.UNIT_PRICE, ITM.ITEM_AMT_UP_QTY,");
		 * bufferString.append("ITM.ITEM_DISCOUNT,ITM.PRE_TAX_AMOUNT,");
		 * bufferString.append("ITM.TAXABLE_VALUE, ITM.IGST_RATE,");
		 * bufferString.append("ITM.IGST_AMT,ITM.CGST_RATE,ITM.CGST_AMT,");
		 * bufferString
		 * .append("ITM.SGST_RATE,ITM.SGST_AMT,ITM.CESS_RATE_ADVALOREM,");
		 * bufferString.append("ITM.CESS_AMT_ADVALOREM, ITM.CESS_RATE_SPECIFIC,"
		 * ); bufferString.append("ITM.CESS_AMT_SPECIFIC, ITM.STATECESS_RATE,");
		 * bufferString.
		 * append("ITM.STATECESS_AMT, ITM.STATE_CESS_SPECIFIC_RATE,");
		 * bufferString.append(
		 * "ITM.STATE_CESS_SPECIFIC_AMOUNT, ITM.OTHER_VALUES,TOT_ITEM_AMT,");
		 * bufferString.append("ITM.INV_OTHER_CHARGES, ITM.INV_ASSESSABLE_AMT,"
		 * ); bufferString
		 * .append("ITM.INV_IGST_AMT,ITM.INV_CGST_AMT, ITM.INV_SGST_AMT,");
		 * bufferString
		 * .append("ITM.INV_CESS_ADVLRM_AMT, ITM.INV_CESS_SPECIFIC_AMT,");
		 * bufferString.append(
		 * "ITM.INV_STATE_CESS_AMT, ITM.INV_STATE_CESS_SPECIFIC_AMOUNT,");
		 * bufferString.append("CASE WHEN HDR.DATAORIGINTYPECODE IN ('A','AI') "
		 * ); bufferString.append(
		 * "THEN HDR.DOC_AMT WHEN HDR.DATAORIGINTYPECODE IN ('E','EI') ");
		 * bufferString.append(
		 * "THEN ITM.LINE_ITEM_AMT END LINE_ITEM_AMT,HDR.ROUND_OFF,HDR.TOT_INV_VAL_WORLDS,"
		 * ); bufferString
		 * .append("HDR.TCS_FLAG_INCOME_TAX, ITM.TCS_RATE_INCOME_TAX,");
		 * bufferString.append("ITM.TCS_AMOUNT_INCOME_TAX,"); bufferString
		 * .append("HDR.CUSTOMER_PAN_OR_AADHAAR, HDR.FOREIGN_CURRENCY,");
		 * bufferString.append("HDR.COUNTRY_CODE, HDR.INV_VAL_FC,");
		 * bufferString.append("HDR.SHIP_PORT_CODE,HDR.SHIP_BILL_NUM,");
		 * bufferString.append("HDR.SHIP_BILL_DATE, HDR.INV_REMARKS,");
		 * bufferString.append("HDR.INV_PERIOD_START_DATE,");
		 * bufferString.append("HDR.INV_PERIOD_END_DATE,");
		 * bufferString.append("ITM.PRECEEDING_INV_NUM,");
		 * bufferString.append("ITM.PRECEEDING_INV_DATE,ITM.INV_REFERENCE,");
		 * bufferString.append(
		 * "ITM.RECEIPT_ADVICE_REFERENCE,ITM.RECEIPT_ADVICE_DATE,");
		 * bufferString.append("ITM.TENDER_REFERENCE ,ITM.CONTRACT_REFERENCE,");
		 * bufferString.append("ITM.EXTERNAL_REFERENCE, ITM.PROJECT_REFERENCE,"
		 * ); bufferString.append("ITM.CUST_PO_REF_NUM,ITM.CUST_PO_REF_DATE,");
		 * bufferString.append("HDR.PAYEE_NAME, HDR.MODE_OF_PAYMENT,");
		 * bufferString.append("HDR.BRANCH_IFSC_CODE,HDR.PAYMENT_TERMS,");
		 * bufferString.append("HDR.PAYMENT_INSTRUCTION,HDR.CR_TRANSFER,");
		 * bufferString.append("HDR.DB_DIRECT, HDR.CR_DAYS,ITM.PAID_AMT,");
		 * bufferString.append("ITM.BAL_AMT, HDR.PAYMENT_DUE_DATE,");
		 * bufferString.append("HDR.ACCOUNT_DETAIL,HDR.ECOM_GSTIN,");
		 * bufferString.append("HDR.ECOM_TRANS_ID, ITM.SUPPORTING_DOC_URL,");
		 * bufferString.append("ITM.SUPPORTING_DOC_BASE64,");
		 * bufferString.append("ITM.ADDITIONAL_INFORMATION,HDR.TRANS_TYPE,");
		 * bufferString.append("HDR.SUB_SUPP_TYPE, HDR.OTHER_SUPP_TYPE_DESC,");
		 * bufferString.append("HDR.TRANSPORTER_ID, HDR.TRANSPORTER_NAME,");
		 * bufferString.append("HDR.TRANSPORT_MODE,HDR.TRANSPORT_DOC_NUM,");
		 * bufferString.append("HDR.TRANSPORT_DOC_DATE, HDR.DISTANCE,");
		 * bufferString.append("HDR.VEHICLE_NUM, HDR.VEHICLE_TYPE,");
		 * bufferString.append("HDR.RETURN_PERIOD,HDR.ORIGINAL_DOC_TYPE,");
		 * bufferString.append("HDR.ORIGINAL_CUST_GSTIN, HDR.DIFF_PERCENT,");
		 * bufferString.append(
		 * "HDR.SECTION7_OF_IGST_FLAG,HDR.CLAIM_REFUND_FLAG,");
		 * bufferString.append("HDR.AUTOPOPULATE_TO_REFUND,HDR.CRDR_PRE_GST,");
		 * bufferString.append(
		 * "HDR.CUST_SUPP_TYPE, HDR.CUST_SUPP_CODE AS CUSTOMERCODE,");
		 * bufferString.append("ITM.PRODUCT_CODE,ITM.ITM_TYPE,");
		 * bufferString.append("ITM.ITC_FLAG,HDR.STATE_APPLYING_CESS,ITM.FOB,");
		 * bufferString
		 * .append("ITM.EXPORT_DUTY,HDR.EXCHANGE_RATE,ITM.CRDR_REASON,");
		 * bufferString.append(" HDR.TCS_FLAG ,ITM.TCS_AMT,TCS_CGST_AMT,");
		 * bufferString.append("TCS_SGST_AMT, HDR.TDS_FLAG,TDS_IGST_AMT,");
		 * bufferString
		 * .append("TDS_CGST_AMT,TDS_SGST_AMT, HDR.USER_ID AS userid,");
		 * bufferString.append("HDR.COMPANY_CODE,HDR.SOURCE_IDENTIFIER,");
		 * bufferString.append(
		 * "HDR.SOURCE_FILENAME,ITM.PLANT_CODE,HDR.DIVISION,"); bufferString
		 * .append("SUB_DIVISION,ITM.LOCATION,HDR.SALES_ORGANIZATION,");
		 * bufferString.append("HDR.DISTRIBUTION_CHANNEL,ITM.PROFIT_CENTRE,");
		 * bufferString.append("HDR.PROFIT_CENTRE2, HDR.USERACCESS1,");
		 * bufferString.append("HDR.USERACCESS2,HDR.USERACCESS3,");
		 * bufferString.append("HDR.USERACCESS4,HDR.USERACCESS5,");
		 * bufferString.append("HDR.USERACCESS6, ITM.GLCODE_TAXABLEVALUE,");
		 * bufferString.append("ITM.GLCODE_IGST,ITM.GLCODE_CGST,");
		 * bufferString.append("ITM.GLCODE_SGST,ITM.GLCODE_ADV_CESS,");
		 * bufferString.append("ITM.GLCODE_SP_CESS, ITM.GLCODE_STATE_CESS,");
		 * bufferString.append("HDR.GL_STATE_CESS_SPECIFIC,");
		 * bufferString.append("HDR.GL_POSTING_DATE,HDR.SALES_ORD_NUM,");
		 * bufferString.append("HDR.EWAY_BILL_NUM,");
		 * bufferString.append("CAST(HDR.EWAY_BILL_DATE AS DATE),");
		 * bufferString.append("HDR.ACCOUNTING_VOUCHER_NUM,");
		 * bufferString.append("HDR.ACCOUNTING_VOUCHER_DATE,");
		 * bufferString.append("ITM.DOCUMENT_REFERENCE_NUMBER, HDR.CUST_TAN,");
		 * bufferString.append("ITM.USERDEFINED_FIELD1,ITM.USERDEFINED_FIELD2,")
		 * ;
		 * bufferString.append("ITM.USERDEFINED_FIELD3,ITM.USERDEFINED_FIELD4,")
		 * ;
		 * bufferString.append("ITM.USERDEFINED_FIELD5,ITM.USERDEFINED_FIELD6,")
		 * ;
		 * bufferString.append("ITM.USERDEFINED_FIELD7,ITM.USERDEFINED_FIELD8,")
		 * ;
		 * bufferString.append("ITM.USERDEFINED_FIELD9,ITM.USERDEFINED_FIELD10,"
		 * ); bufferString.append(
		 ...
		 * bufferString.append(
		 * "ITM.USERDEFINED_FIELD17,ITM.USERDEFINED_FIELD18,"); bufferString
		 * .append("ITM.USERDEFINED_FIELD19, ITM.USERDEFINED_FIELD20,");
		 * bufferString.append(
		 * "ITM.USERDEFINED_FIELD21,ITM.USERDEFINED_FIELD22,");
		 * bufferString.append(
		 * "ITM.USERDEFINED_FIELD23,ITM.USERDEFINED_FIELD24,"); bufferString
		 * .append("ITM.USERDEFINED_FIELD25, ITM.USERDEFINED_FIELD26,");
		 * bufferString.append(
		 * "ITM.USERDEFINED_FIELD27,ITM.USERDEFINED_FIELD28,");
		 * bufferString.append(
		 * "ITM.USERDEFINED_FIELD29,ITM.USERDEFINED_FIELD30,");
		 * bufferString.append("HDR.SUPPLY_TYPE AS SUPPLYTYPEASP,");
		 * bufferString.append("EWB. ASP_DISTANCE AS ApproximateDistance_ASP,");
		 * bufferString.append("EWB.REMAINING_DISTANCE AS DistanceSavedtoEWB,");
		 * bufferString.append("HDR.CREATED_BY as USER_ID,HDR.FILE_ID,");
		 * bufferString.append("FIL.FILE_NAME as FILE_NAME,"); bufferString.
		 * append("HDR.INV_OTHER_CHARGES as InvoiceOtherChargesASP,");
		 * bufferString.append(
		 * "HDR.INV_ASSESSABLE_AMT as InvoiceAssessableAmountASP,");
		 * bufferString.append(
		 * "HDR.INV_IGST_AMT AS InvoiceIGSTAmountASP,HDR.INV_CGST_AMT ");
		 * bufferString.append("as InvoiceCGSTAmountASP, HDR.INV_SGST_AMT ");
		 * bufferString.
		 * append("as InvoiceSGSTAmountASP,HDR.INV_CESS_ADVLRM_AMT ");
		 * bufferString.append("as InvoiceCessAdvaloremAmountASP,");
		 * bufferString.append(
		 * "HDR.INV_CESS_SPECIFIC_AMT as InvoiceCessSpecificAmountASP,");
		 * bufferString.append(
		 * "HDR.INV_STATE_CESS_AMT as InvoiceStateCessAdvaloremAmountASP,");
		 * bufferString.append("HDR.INV_STATE_CESS_SPECIFIC_AMOUNT AS ");
		 * bufferString.append("InvoiceStateCessSpecificAmountASP,");
		 * bufferString.append(
		 * "HDR.DOC_AMT, HDR.MEMO_VALUE_IGST,HDR.MEMO_VALUE_CGST,");
		 * bufferString.append("HDR.MEMO_VALUE_SGST, ITM.MEMO_VALUE_CESS_ADV ");
		 * bufferString.append(
		 * "AS CessAdvaloremAmount_ASP, ITM.MEMO_VALUE_STATE_CESS_ADV ");
		 * bufferString.append("AS StateCessAdvaloremAmount_ASP,");
		 * bufferString.append("ITM.IGST_RET1_IMPACT,ITM.CGST_RET1_IMPACT,");
		 * bufferString.append("ITM.SGST_RET1_IMPACT, ITM.CESS_ADV_RET1_IMPACT "
		 * ); bufferString.append("AS CessAdvaloremAmount_Difference,");
		 * bufferString.append("ITM.STATE_CESS_ADV_RET1_IMPACT ");
		 * bufferString.append("AS StateCessAdvaloremAmount_Difference,");
		 * bufferString.append("CASE WHEN HDR.IS_DELETE = TRUE ");
		 * bufferString.append("THEN 'INACTIVE' WHEN HDR.IS_DELETE = FALSE ");
		 * bufferString.append("THEN 'ACTIVE' END AS RECORD_STATUS,");
		 * bufferString.append(
		 * "TO_CHAR(EINV.CANCELLATION_DATE,'DD-MM-YYYY HH24:MI:SS') AS IRN_CANCELLATION_DATE, "
		 * ); bufferString.append(
		 * "TO_CHAR(EWB.CANCELLATION_DATE,'DD-MM-YYYY HH24:MI:SS') AS EWB_CANCELLATION_DATE, "
		 * ); bufferString.append("CASE WHEN HDR.ASP_INVOICE_STATUS=1 ");
		 * bufferString
		 * .append("THEN 'DigiGST Error' WHEN HDR.ASP_INVOICE_STATUS=2 ");
		 * bufferString.
		 * append("THEN 'DigiGST Processed' END AS DIGI_GST_STATUS,");
		 * bufferString.append("HDR.INFO_ERROR_CODE AS EWB_INFO_CODE,");
		 * bufferString.append("HDR.INFO_ERROR_MSG AS EWB_INFO_ERROR_MSG,");
		 * bufferString.append("HDR.EWB_NO_RESP AS EWB_NUM,");
		 * bufferString.append(
		 * "TO_CHAR(HDR.EWB_DATE_RESP,'DD-MM-YYYY HH24:MI:SS') AS EWB_DATE_TIME, "
		 * ); bufferString.append("ITM.ADJ_REF_NO,ITM.ADJ_REF_DATE,");
		 * bufferString.append("ITM.ADJ_TAXABLE_VALUE, ITM.ADJ_IGST_AMT,");
		 * bufferString.append("ITM.ADJ_CGST_AMT, ITM.ADJ_SGST_AMT,");
		 * bufferString.append("ITM.ADJ_CESS_AMT_ADVALOREM,");
		 * bufferString.append("ITM.ADJ_CESS_AMT_SPECIFIC,");
		 * bufferString.append("ITM.ADJ_STATECESS_AMT,");
		 * bufferString.append("ITM.TCS_AMT AS Tcsamount,");
		 * bufferString.append("HDR.CUST_SUPP_ADDRESS3,"); bufferString.append(
		 * "HDR.TAX_DOC_TYPE AS DATA_CATEGORY,ITM.ITM_UQC,ITM.ITM_QTY,CASE WHEN PSD.USER_RESPONSE='S' THEN 'Save to Gstin' WHEN PSD.USER_RESPONSE='N' THEN 'Do Not save  GSTN' WHEN PSD.USER_RESPONSE='D' THEN 'Delete fron GSTN' ELSE PSD.USER_RESPONSE END AS EINVVSGSTR1RESPONSE"
		 * ); bufferString.append(" FROM ANX_OUTWARD_DOC_HEADER ");
		 * bufferString.append("HDR INNER JOIN ANX_OUTWARD_DOC_ITEM ITM ");
		 * bufferString.append("ON HDR.ID = ITM.DOC_HEADER_ID "); bufferString
		 * .append("AND HDR.DERIVED_RET_PERIOD = ITM.DERIVED_RET_PERIOD ");
		 * bufferString.append("LEFT OUTER JOIN ");
		 * bufferString.append("FILE_STATUS FIL ON HDR.FILE_ID=FIL.ID ");
		 * bufferString.append("LEFT OUTER JOIN GSTR1_GSTN_SAVE_BATCH ");
		 * bufferString.append("GSTNBATCH ON GSTNBATCH.ID = HDR.BATCH_ID ");
		 * bufferString.append("LEFT OUTER JOIN EINV_MASTER EINV ");
		 * bufferString.
		 * append("ON HDR.IRN_RESPONSE = EINV.IRN LEFT OUTER JOIN TBL_EINV_RECON_RESP_PSD PSD ON PSD.DOC_HEADER_ID = ITM.DOC_HEADER_ID LEFT OUTER JOIN "
		 * ); bufferString.
		 * append("EWB_MASTER EWB ON HDR.EWB_NO_RESP = EWB.EWB_NUM ");
		 * bufferString.append("WHERE HDR.ASP_INVOICE_STATUS = 2 ");
		 * bufferString.append(
		 * "AND COMPLIANCE_APPLICABLE=TRUE AND HDR.IS_DELETE=FALSE  AND PSD.IS_DELETE=FALSE AND PSD.IS_PROCESSED=TRUE"
		 * ); bufferString.append(
		 * "AND HDR.RETURN_TYPE='GSTR1' AND HDR.TAX_DOC_TYPE IN ('B2B') ");
		 * bufferString.append(buildHeader);
		 * bufferString.append(" ORDER BY DOC_NUM,ITM.ITM_NO "); return
		 * bufferString;
		 * 
		 */}

	private String createApiProcessedQueryStringForGstr1a(String buildHeader) {
		...
		return "SELECT TRIM(', ' FROM IFNULL(HDR.ERROR_CODES,'') ||','|| "
				...
				+ "when HDR.IRN_STATUS = 3 then 'Pending (No Action)' "
				...
				+ "when HDR.IRN_STATUS = 13 then 'Already Generated by User' "
				+ "when HDR.IRN_STATUS = 11 then 'Pending (Error)' "
				+ "end as IRN_STATUS, HDR.IRN_RESPONSE AS IRN_NO, "
				+ "HDR.ACK_NUM AS IRN_ACK_NO, "
				+ "TO_CHAR(HDR.ACK_DATE,'DD-MM-YYYY HH24:MI:SS') AS IRN_ACK_DATE_TIME, "
				+ "EINV.SIGNED_QR AS SIGNED_QR_CODE, "
				+ "NULL AS SIGNED_INVOICE, "
				...
				+ "when HDR.EWB_STATUS = 2 then 'Pending (No Action)' when HDR.EWB_STATUS = 3  "
				+ "then 'Generation Error' when HDR.EWB_STATUS = 4  "
				+ "then 'Part A Generated' when HDR.EWB_STATUS = 5 then  "
				+ " 'EWB Active' when HDR.EWB_STATUS = 6 then 'Cancelled'  "
				...
				+ "WHEN HDR.EWB_STATUS = 14 then 'Pending (Error)'  "
				+ "end as EWBPartAStatusA, "
				+ "TO_CHAR(EWB.VALID_UPTO,'DD-MM-YYYY HH24:MI:SS') AS EWBValidUpTo, "
				+ "HDR.EWAY_BILL_NUM AS EWBNO, "
				+ "CAST(HDR.EWAY_BILL_DATE AS DATE) AS EWBDATE, "
				+ "HDR.EWB_ERROR_CODE AS EWB_ERROR_CODE, "
				+ "HDR.EWB_ERROR_DESC AS EWB_ERROR_DESCRIPTION, "
				+ "case when HDR.IS_SAVED_TO_GSTN = TRUE  "
				+ "THEN 'IS_SAVED' WHEN HDR.IS_SAVED_TO_GSTN = FALSE  "
				+ "AND HDR.GSTN_ERROR = TRUE THEN 'IS_ERROR'  "
				+ "WHEN HDR.IS_SAVED_TO_GSTN = FALSE  "
				+ "AND HDR.GSTN_ERROR = FALSE THEN 'NOT_SAVED' END  "
				+ "AS GSTIN_STATUS, GSTNBATCH.GSTN_SAVE_REF_ID  "
				+ "AS GSTIN_REF_ID, GSTNBATCH.BATCH_DATE  "
				+ "AS GSTIN_REFID_DATE_TIME, NULL AS GSTIN_ERROR_CODE, "
				+ "NULL AS GSTIN_ERROR_DESCRIPTION_ASP, "
				+ "HDR.RETURN_TYPE AS RET_TYPE, "
				+ "HDR.TABLE_SECTION AS TABLE_NUMBER,HDR.IRN, "
				+ "HDR.IRN_DATE,HDR.TAX_SCHEME, HDR.CANCEL_REASON, "
				+ "HDR.CANCEL_REMARKS, ITM.SUPPLY_TYPE, HDR.DOC_CATEGORY, "
				+ "HDR.DOC_TYPE,HDR.DOC_NUM,HDR.DOC_DATE, "
				+ "HDR.REVERSE_CHARGE, HDR.SUPPLIER_GSTIN, "
				+ "HDR.SUPP_TRADE_NAME, HDR.SUPP_LEGAL_NAME, "
				+ "HDR.SUPP_BUILDING_NUM,HDR.SUPP_BUILDING_NAME AS SUPPLIERADDRESS2, "
				+ "HDR.SUPP_LOCATION, "
				+ "HDR.SUPP_PINCODE, HDR.SUPP_STATE_CODE,HDR.SUPP_PHONE, "
				+ "HDR.SUPP_EMAIL, HDR.CUST_GSTIN,HDR.CUST_TRADE_NAME, "
				+ "HDR.CUST_SUPP_NAME, HDR.CUST_SUPP_ADDRESS1, "
				+ "HDR.CUST_SUPP_ADDRESS2, HDR.CUST_SUPP_ADDRESS4, "
				+ "HDR.CUST_PINCODE,HDR.BILL_TO_STATE, HDR.POS, "
				+ "HDR.CUST_PHONE,HDR.CUST_EMAIL,HDR.DISPATCHER_GSTIN, "
				+ "HDR.DISPATCHER_TRADE_NAME,HDR.DISPATCHER_BUILDING_NUM, "
				+ "HDR.DISPATCHER_BUILDING_NAME,HDR.DISPATCHER_LOCATION, "
				+ "HDR.DISPATCHER_PINCODE,HDR.DISPATCHER_STATE_CODE , "
				+ "HDR.SHIP_TO_GSTIN, "
				+ "HDR.SHIP_TO_TRADE_NAME, HDR.SHIP_TO_LEGAL_NAME, "
				+ "HDR.SHIP_TO_BUILDING_NUM, HDR.SHIP_TO_BUILDING_NAME, "
				+ "HDR.SHIP_TO_LOCATION, ITM.SHIP_TO_PINCODE, "
				+ "ITM.SHIP_TO_STATE,ITM.ITM_NO, ITM.SERIAL_NUM2, "
				+ "ITM.PRODUCT_NAME,ITM.ITM_DESCRIPTION, ITM.IS_SERVICE, "
				+ "ITM.ITM_HSNSAC,ITM.BAR_CODE, ITM.BATCH_NAME_OR_NUM, "
				+ "ITM.BATCH_EXPIRY_DATE, ITM.WARRANTY_DATE, "
				+ "ITM.ORDER_ITEM_REFERENCE,ITM.ATTRIBUTE_NAME, "
				+ "ITM.ATTRIBUTE_VALUE, ITM.ORIGIN_COUNTRY, "
				+ "ITM.ITM_UQC_USER,ITM.QTY_USER, ITM.FREE_QTY, "
				+ "ITM.UNIT_PRICE, ITM.ITEM_AMT_UP_QTY, "
				+ "ITM.ITEM_DISCOUNT,ITM.PRE_TAX_AMOUNT, "
				+ "ITM.TAXABLE_VALUE, ITM.IGST_RATE, "
				...
				+ "ITM.CESS_AMT_SPECIFIC, ITM.STATECESS_RATE, "
				+ "ITM.STATECESS_AMT, ITM.STATE_CESS_SPECIFIC_RATE, "
				+ "ITM.STATE_CESS_SPECIFIC_AMOUNT, ITM.OTHER_VALUES,TOT_ITEM_AMT, "
				+ "ITM.INV_OTHER_CHARGES, ITM.INV_ASSESSABLE_AMT, "
				+ "ITM.INV_IGST_AMT,ITM.INV_CGST_AMT, ITM.INV_SGST_AMT, "
				+ "ITM.INV_CESS_ADVLRM_AMT, ITM.INV_CESS_SPECIFIC_AMT, "
				+ "ITM.INV_STATE_CESS_AMT, ITM.INV_STATE_CESS_SPECIFIC_AMOUNT, "
				+ "CASE WHEN HDR.DATAORIGINTYPECODE IN ('A','AI')  "
				+ "THEN HDR.DOC_AMT WHEN HDR.DATAORIGINTYPECODE IN ('E','EI')  "
				+ "THEN ITM.LINE_ITEM_AMT END LINE_ITEM_AMT,HDR.ROUND_OFF,HDR.TOT_INV_VAL_WORLDS, "
				+ "HDR.TCS_FLAG_INCOME_TAX, ITM.TCS_RATE_INCOME_TAX, "
				+ "ITM.TCS_AMOUNT_INCOME_TAX, "
				+ "HDR.CUSTOMER_PAN_OR_AADHAAR, HDR.FOREIGN_CURRENCY, "
				...
				+ "ITM.CUST_PO_REF_NUM,ITM.CUST_PO_REF_DATE, "
				+ "HDR.PAYEE_NAME, HDR.MODE_OF_PAYMENT, "
				+ "HDR.BRANCH_IFSC_CODE,HDR.PAYMENT_TERMS, "
				+ "HDR.PAYMENT_INSTRUCTION,HDR.CR_TRANSFER, "
				+ "HDR.DB_DIRECT, HDR.CR_DAYS,ITM.PAID_AMT, "
				+ "ITM.BAL_AMT, HDR.PAYMENT_DUE_DATE, "
				+ "HDR.ACCOUNT_DETAIL,HDR.ECOM_GSTIN, "
				+ "HDR.ECOM_TRANS_ID, ITM.SUPPORTING_DOC_URL, "
				+ "ITM.SUPPORTING_DOC_BASE64, "
				+ "ITM.ADDITIONAL_INFORMATION,HDR.TRANS_TYPE, "
				+ "HDR.SUB_SUPP_TYPE, HDR.OTHER_SUPP_TYPE_DESC, "
				+ "HDR.TRANSPORTER_ID, HDR.TRANSPORTER_NAME, "
				+ "HDR.TRANSPORT_MODE,HDR.TRANSPORT_DOC_NUM, "
				+ "HDR.TRANSPORT_DOC_DATE, HDR.DISTANCE, "
				+ "HDR.VEHICLE_NUM, HDR.VEHICLE_TYPE, "
				...
				+ "HDR.CUST_SUPP_TYPE, HDR.CUST_SUPP_CODE AS CUSTOMERCODE, "
				+ "ITM.PRODUCT_CODE,ITM.ITM_TYPE, "
				+ "ITM.ITC_FLAG,HDR.STATE_APPLYING_CESS,ITM.FOB, "
				+ "ITM.EXPORT_DUTY,HDR.EXCHANGE_RATE,ITM.CRDR_REASON, "
				+ " HDR.TCS_FLAG ,ITM.TCS_AMT,TCS_CGST_AMT, "
				+ "TCS_SGST_AMT, HDR.TDS_FLAG,TDS_IGST_AMT, "
				+ "TDS_CGST_AMT,TDS_SGST_AMT, HDR.USER_ID AS userid, "
				...
				+ "HDR.DISTRIBUTION_CHANNEL,ITM.PROFIT_CENTRE, "
				...
				+ "HDR.EWAY_BILL_NUM, " + "CAST(HDR.EWAY_BILL_DATE AS DATE), "
				+ "HDR.ACCOUNTING_VOUCHER_NUM, "
				+ "HDR.ACCOUNTING_VOUCHER_DATE, "
				+ "ITM.DOCUMENT_REFERENCE_NUMBER, HDR.CUST_TAN, "
				...
				+ "EWB. ASP_DISTANCE AS ApproximateDistance_ASP, "
				+ "EWB.REMAINING_DISTANCE AS DistanceSavedtoEWB, "
				+ "HDR.CREATED_BY as USER_ID,HDR.FILE_ID, "
				+ "FIL.FILE_NAME as FILE_NAME, "
				+ "HDR.INV_OTHER_CHARGES as InvoiceOtherChargesASP, "
				+ "HDR.INV_ASSESSABLE_AMT as InvoiceAssessableAmountASP, "
				+ "HDR.INV_IGST_AMT AS InvoiceIGSTAmountASP,HDR.INV_CGST_AMT  "
				...
				+ "HDR.DOC_AMT, HDR.MEMO_VALUE_IGST,HDR.MEMO_VALUE_CGST, "
				+ "HDR.MEMO_VALUE_SGST, ITM.MEMO_VALUE_CESS_ADV  "
				+ "AS CessAdvaloremAmount_ASP, ITM.MEMO_VALUE_STATE_CESS_ADV  "
				...
				+ "CASE WHEN HDR.IS_DELETE = TRUE  "
				+ "THEN 'INACTIVE' WHEN HDR.IS_DELETE = FALSE  "
				+ "THEN 'ACTIVE' END AS RECORD_STATUS, "
				+ "TO_CHAR(EINV.CANCELLATION_DATE,'DD-MM-YYYY HH24:MI:SS') AS IRN_CANCELLATION_DATE,  "
				+ "TO_CHAR(EWB.CANCELLATION_DATE,'DD-MM-YYYY HH24:MI:SS') AS EWB_CANCELLATION_DATE,  "
				+ "CASE WHEN HDR.ASP_INVOICE_STATUS=1  "
				+ "THEN 'DigiGST Error' WHEN HDR.ASP_INVOICE_STATUS=2  "
				+ "THEN 'DigiGST Processed' END AS DIGI_GST_STATUS, "
				+ "HDR.INFO_ERROR_CODE AS EWB_INFO_CODE, "
				+ "HDR.INFO_ERROR_MSG AS EWB_INFO_ERROR_MSG, "
				+ "HDR.EWB_NO_RESP AS EWB_NUM, "
				+ "TO_CHAR(HDR.EWB_DATE_RESP,'DD-MM-YYYY HH24:MI:SS') AS EWB_DATE_TIME,  "
				+ "ITM.ADJ_REF_NO,ITM.ADJ_REF_DATE, "
				+ "ITM.ADJ_TAXABLE_VALUE, ITM.ADJ_IGST_AMT, "
				...
				+ "HDR.CUST_SUPP_ADDRESS3, "
				+ "HDR.TAX_DOC_TYPE AS DATA_CATEGORY,ITM.ITM_UQC,ITM.ITM_QTY,"
				// + " CASE WHEN PSD.USER_RESPONSE='S' THEN 'S-Save to GSTN'
				// WHEN PSD.USER_RESPONSE='N' THEN 'N-Do Not save to GSTN' ELSE
				// '' END "
				+ "NULL AS EINVVSGSTR1RESPONSE "
				+ " FROM ANX_OUTWARD_DOC_HEADER_1A  "
				+ "HDR INNER JOIN ANX_OUTWARD_DOC_ITEM_1A ITM  "
				+ "ON HDR.ID = ITM.DOC_HEADER_ID  "
				+ "AND HDR.DERIVED_RET_PERIOD = ITM.DERIVED_RET_PERIOD  "
				+ "LEFT OUTER JOIN 	FILE_STATUS FIL ON HDR.FILE_ID=FIL.ID  "
				+ "LEFT OUTER JOIN GSTR1_GSTN_SAVE_BATCH  "
				+ "GSTNBATCH ON GSTNBATCH.ID = HDR.BATCH_ID  "
				+ "LEFT OUTER JOIN EINV_MASTER EINV  "
				+ "ON HDR.IRN_RESPONSE = EINV.IRN "
				// + "LEFT OUTER JOIN TBL_EINV_RECON_RESP_PSD PSD ON
				// PSD.DOC_HEADER_ID = ITM.DOC_HEADER_ID AND PSD.IS_DELETE=FALSE
				// AND PSD.IS_PROCESSED=TRUE "
				+ "LEFT OUTER JOIN  "
				+ "EWB_MASTER EWB ON HDR.EWB_NO_RESP = EWB.EWB_NUM  "
				+ "WHERE HDR.ASP_INVOICE_STATUS = 2  "
				+ "AND COMPLIANCE_APPLICABLE=TRUE AND HDR.IS_DELETE=FALSE  "
				+ "AND HDR.RETURN_TYPE='GSTR1A'  AND HDR.TAX_DOC_TYPE IN ('B2B')  "
