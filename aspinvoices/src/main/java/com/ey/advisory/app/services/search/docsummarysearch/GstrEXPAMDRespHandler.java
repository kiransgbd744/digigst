...
@Service("GstrEXPAMDRespHandler")
public class GstrEXPAMDRespHandler {
	...
	public JsonElement handleEXPAResp(List<? extends Gstr1SummaryDto> list,
			Gstr1SummaryReqDto gstr1SummaryRequest) {
		
		List<Gstr1BasicSummarySectionDto> expaEySummary = new ArrayList<>();
		for (Gstr1SummaryDto gstr1Summary : list) {
			expaEySummary = gstr1Summary.getExpa().getEySummary();
		}
...
*/				
				...
				JsonElement expaRespBody = gstr1SummaryStructure
				.expaStructure(expaEySummary,gstnList);
