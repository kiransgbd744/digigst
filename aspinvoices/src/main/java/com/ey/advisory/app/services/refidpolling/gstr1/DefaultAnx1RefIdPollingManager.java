 ...
 */
@Slf4j
@Component("DefaultAnx1RefIdPollingManager")
public class DefaultAnx1RefIdPollingManager
	...
	public ResponseEntity<String> processAnx1RefIds(PollingMessage reqDto,
		...
		try {
			// batches = gstr1BatchRepository.findanx1ReferenceId();
			batches = gstr1BatchRepository
					.findReferenceIdForPooling(reqDto.getReturnType().toUpperCase());
