 ...
 *
 */
public class ItemSerialNumberValidationRule implements ValidationRule {
	...
	public List<ProcessingResult> isValid(int idx, Object obj, Object[] row,
		...
		if (!isDecimal(obj.toString().trim())) {
			...
			errors.add(new ProcessingResult(APP_VALIDATION, "ER5829",
					"Invalid ItemSerialNumber.", location));
			return errors;
