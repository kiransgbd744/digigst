...
@Slf4j
@Component("InwardErrorsDataStatusConvertor")
public class InwardErrorsDataStatusConvertor implements ReportConvertor {
	...
	public Object convert(Object[] arr, String reportType) {
		...
		if (docType != null && (docType.equalsIgnoreCase("CR")
			...
			obj.setItemAssessableAmount(CheckForNegativeValue(
					arr[66]));
			...
			obj.setStateCessAdvaloremAmount(CheckForNegativeValue(
					arr[78]));
			obj.setStateCessSpecificAmount(CheckForNegativeValue(
					arr[80]));
			...
			obj.setInvoiceAssessableAmount(CheckForNegativeValue(
					arr[84]));
			...
			obj.setInvoiceCessAdvaloremAmount(CheckForNegativeValue(
					arr[88]));
			obj.setInvoiceCessSpecificAmount(CheckForNegativeValue(
					arr[89]));
			obj.setInvoiceStateCessAdvaloremAmount(CheckForNegativeValue(
					arr[90]));
			obj.setInvoiceStateCessSpecificAmount(CheckForNegativeValue(
					arr[91]));
			...
			obj.settCSAmountIncomeTax(CheckForNegativeValue(
					arr[105]));
		}else{
	...
	private static String deriveOldReturnPeriod(Object[] arr,String docNum){
		try{
		return (arr[248] != null ? arr[248].toString() : null);
		}catch (Exception e) {
