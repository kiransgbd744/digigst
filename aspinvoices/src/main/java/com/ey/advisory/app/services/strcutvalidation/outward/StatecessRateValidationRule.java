...
public class StatecessRateValidationRule implements ValidationRule {
	...
	public List<ProcessingResult> isValid(Object obj, Object[] row,
		...
		// First check if the input object is a valid decimal number.
					if (!isDecimal(obj)) {
						...
						errorLocations.add(GSTConstants.CESS_RATE_STATE);
						TransDocProcessingResultLoc location 
						                   = new TransDocProcessingResultLoc(
								null, errorLocations.toArray());
						errors.add(new ProcessingResult(APP_VALIDATION, "ER1081",
