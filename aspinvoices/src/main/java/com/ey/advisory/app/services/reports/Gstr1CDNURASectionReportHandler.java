...
@Slf4j
@Component("Gstr1CDNURASectionReportHandler")
public class Gstr1CDNURASectionReportHandler {

	@Autowired
	@Qualifier("Gstr1CDNURASectionReportServiceImpl")
		...
		try {
			...
			if (workbook != null) {
				...
				if (LOGGER.isDebugEnabled()) {
					LOGGER.debug("Gstr1 CDNURA template file name is : {}",
				...
				if (LOGGER.isDebugEnabled()) {
					LOGGER.debug("Gstr1 CDNURA file name is : {}", fileName);
				}
				...
				if (LOGGER.isDebugEnabled()) {
					LOGGER.debug(
							"Workbook has been generated successfully with the"
									+ " Gstr1 CDNURA response list in the directory : {}",
				...
				if (id != null) {
					try {
						...
						String msg = String
								.format("Gstr1CDNURASectionReportHandler - "
				...
				if (LOGGER.isDebugEnabled()) {
					LOGGER.debug(
							"Gstr1 CDNURA No Data found for report id : {} ",
							id);
				}
			...
			String msg = String.format("Gstr1CDNURASectionReportHandler - "
					+ "Exception occured while "
