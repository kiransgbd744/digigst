...
public class Anx1aSummaryInwardOutwardRespDto {
	...
	private List<Anx1aSummaryInwardOutwardItemRespDto> items = new ArrayList<>();
	...
	public List<Anx1aSummaryInwardOutwardItemRespDto> getItems() {
		return items;
	}

	public void setItems(List<Anx1aSummaryInwardOutwardItemRespDto> items) {
		this.items = items;
	}
