...
@Component("Ret1And1AVerticalTotalReportHandler")
public class Ret1And1AVerticalTotalReportHandler {
	@Autowired
	@Qualifier("Ret1And1AVerticalTotalReportServiceImpl")
	private Ret1And1AVerticalProcessedReportService ret1And1AVerticalProcessedReportService;

	public Workbook downloadRet1VerticalTotalReport(
