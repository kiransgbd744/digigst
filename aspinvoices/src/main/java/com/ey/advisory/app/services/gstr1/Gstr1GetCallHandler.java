...
@Service("Gstr1GetCallHandler")
@Slf4j
public class Gstr1GetCallHandler {
			...
			for (Gstr1GetInvoicesReqDto dto : dtos) {
				...
				for (; fromPeriod <= toPeriod; fromPeriod++) {
					...
					if (isFailedGet == true) {
						...
						if (LOGGER.isDebugEnabled()) {
							LOGGER.debug(
									"GSTR1 Failed GET eligible sections are {} ",
									failedBatchs);
						}
					} else {
						if (LOGGER.isDebugEnabled()) {
						...
						if (LOGGER.isDebugEnabled()) {
							LOGGER.debug(
									"GSTR1 All GET Not eligible sections are {} ",
					...
					if (isEligible(isFailedGet, failedBatchs,
						...
						jobList.add(asyncJobsService.createJobAndReturn(
								groupCode, JobConstants.GSTR1_GSTN_GET_SECTION,
						...
						APIParams params = new APIParams(groupCode,
								...
								APIIdentifiers.GSTR1_GET_B2B, param1, param2);
...
//						saveOrUpdateFyTable(gstin, fy);
					...
					if (isEligible(isFailedGet, failedBatchs,
						...
						APIParams params = new APIParams(groupCode,
								APIProviderEnum.GSTN,
								APIIdentifiers.GSTR1_GET_B2BA, param1, param2);
						JsonElement apiParams = gson.toJsonTree(params);
...
//						saveOrUpdateFyTable(gstin, fy);
					...
					if (isEligible(isFailedGet, failedBatchs,
						...
						APIParams params = new APIParams(groupCode,
								APIProviderEnum.GSTN,
								APIIdentifiers.GSTR1_GET_B2CL, param1, param2);
						JsonElement apiParams = gson.toJsonTree(params);
...
//						saveOrUpdateFyTable(gstin, fy);
					...
					if (isEligible(isFailedGet, failedBatchs,
						...
						APIParams params = new APIParams(groupCode,
								APIProviderEnum.GSTN,
								APIIdentifiers.GSTR1_GET_B2CLA, param1, param2);
						JsonElement apiParams = gson.toJsonTree(params);
...
//						saveOrUpdateFyTable(gstin, fy);
					...
					if (isEligible(isFailedGet, failedBatchs,
						...
						APIParams params = new APIParams(groupCode,
								APIProviderEnum.GSTN,
								APIIdentifiers.GSTR1_GET_EXP, param1, param2);
						JsonElement apiParams = gson.toJsonTree(params);
...
//						saveOrUpdateFyTable(gstin, fy);
					...
					if (isEligible(isFailedGet, failedBatchs,
						...
						APIParams params = new APIParams(groupCode,
								APIProviderEnum.GSTN,
								APIIdentifiers.GSTR1_GET_EXPA, param1, param2);
						JsonElement apiParams = gson.toJsonTree(params);
...
//						saveOrUpdateFyTable(gstin, fy);
					...
					if (isEligible(isFailedGet, failedBatchs,
						...
						APIParams params = new APIParams(groupCode,
								APIProviderEnum.GSTN,
								APIIdentifiers.GSTR1_GET_CDNUR, param1, param2);
						JsonElement apiParams = gson.toJsonTree(params);
...
//						saveOrUpdateFyTable(gstin, fy);
					...
					if (isEligible(isFailedGet, failedBatchs,
						...
						APIParams params = new APIParams(groupCode,
								APIProviderEnum.GSTN,
								APIIdentifiers.GSTR1_GET_AT, param1, param2);
						JsonElement apiParams = gson.toJsonTree(params);
...
//						saveOrUpdateFyTable(gstin, fy);
					...
					if (isEligible(isFailedGet, failedBatchs,
						...
						APIParams params = new APIParams(groupCode,
								APIProviderEnum.GSTN,
								APIIdentifiers.GSTR1_GET_ATA, param1, param2);
						JsonElement apiParams = gson.toJsonTree(params);
...
//						saveOrUpdateFyTable(gstin, fy);
					...
					if (isEligible(isFailedGet, failedBatchs,
						...
						APIParams params = new APIParams(groupCode,
								APIProviderEnum.GSTN,
								APIIdentifiers.GSTR1_GET_NIL_RATED, param1,
								param2);
						JsonElement apiParams = gson.toJsonTree(params);
...
//						saveOrUpdateFyTable(gstin, fy);
					...
					if (isEligible(isFailedGet, failedBatchs,
						...
						APIParams params = new APIParams(groupCode,
								APIProviderEnum.GSTN,
								APIIdentifiers.GSTR1_GET_HSN_SUMMARY, param1,
								param2);
						JsonElement apiParams = gson.toJsonTree(params);
					...
					if (isEligible(isFailedGet, failedBatchs,
						...
						APIParams params = new APIParams(groupCode,
								APIProviderEnum.GSTN,
								APIIdentifiers.GSTR1_GET_DOC_ISSUED, param1,
								param2);
						JsonElement apiParams = gson.toJsonTree(params);
					...
					if (isEligible(isFailedGet, failedBatchs,
						...
						APIParams params = new APIParams(groupCode,
								APIProviderEnum.GSTN,
								APIIdentifiers.GSTR1_GET_SUPECO, param1,
								param2);
						JsonElement apiParams = gson.toJsonTree(params);
...
//						saveOrUpdateFyTable(gstin, fy);
					...
					if (isEligible(isFailedGet, failedBatchs,
						...
						APIParams params = new APIParams(groupCode,
								APIProviderEnum.GSTN,
								APIIdentifiers.GSTR1_GET_SUPECO_AMD, param1,
								param2);
						JsonElement apiParams = gson.toJsonTree(params);
...
//						saveOrUpdateFyTable(gstin, fy);
					...
					if (isEligible(isFailedGet, failedBatchs,
						...
						APIParams params = new APIParams(groupCode,
								APIProviderEnum.GSTN,
								APIIdentifiers.GSTR1_GET_ECOM_AMD, param1,
								param2);
						JsonElement apiParams = gson.toJsonTree(params);
...
//						saveOrUpdateFyTable(gstin, fy);
	...
	private Gstr1GetInvoicesReqDto createBatchAndSave(String groupCode,
		...
		dto.setApiSection(APIConstants.GSTR1.toUpperCase());
		return dto;
	...
	private Boolean isEligible(Boolean isFailedGet, List<String> failedBatchs,
		...
		String previousGetFiledStatus = batchRepo.findByGstinAndTaxPeriod(gstin,
				taxPeriod, APIConstants.GSTR1.toUpperCase(),
				section.toUpperCase());
		...
		try {
			...
			if (rowsEffected == 0) {
				...
				if (LOGGER.isDebugEnabled()) {
					...
					LOGGER.debug("Creating new entry for GSTR1 Fy table for "
							+ "gstin : " + gstin + ", fy : " + fy);
				}
			...
			// happen if a race condition occurs when 2 threads try
			// to insert into the AnnualReturnController table.
			String errMsg = String.format("Trying to update entry in GSTR1 Fy "
					+ "table. Ignoring the error");
			// Don't throw back the error.
			LOGGER.error(errMsg, ex);
		}
