...
@Entity
@Table(name = "GETGSTR1A_TXPA_ITEM")

public class GetGstr1ATxpaItemEntity {

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "GETGSTR1A_TXPA_ITEM_SEQ", allocationSize = 100)
	...
	private GetGstr1ATxpaHeaderEntity document;
	...
	public GetGstr1ATxpaHeaderEntity getDocument() {
		return document;
	}

	public void setDocument(GetGstr1ATxpaHeaderEntity document) {
