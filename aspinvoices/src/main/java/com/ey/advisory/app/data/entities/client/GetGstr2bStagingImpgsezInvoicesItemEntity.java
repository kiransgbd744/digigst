 ...
 */
@Entity
@Table(name = "GETGSTR2B_STAGING_IMPGSEZ_ITEM")
@Data
public class GetGstr2bStagingImpgsezInvoicesItemEntity {

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "GETGSTR2B_STAGING_IMPGSEZ_ITEM_SEQ", allocationSize = 100)
	...
	protected GetGstr2bStagingImpgsezInvoicesHeaderEntity header;
