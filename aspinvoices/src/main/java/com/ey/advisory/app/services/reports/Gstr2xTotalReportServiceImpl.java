...
@Service("Gstr2xTotalReportServiceImpl")
public class Gstr2xTotalReportServiceImpl implements Gstr2xReportService {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(Gstr2xTotalReportServiceImpl.class);
	...
	@Autowired
	@Qualifier("Gstr2xTotalReportDaoImpl")
	private Gstr2xReportDao gstr2xTotalReportDao;
	...
	public Workbook downloadReports(SearchCriteria criteria,
		...
		//responseFromView = gstr2xTotalReportDao.getGstr2xReports(request);

		/*workbook = createWorkbookWithExcelTemplate("ReportTemplates",
				"TDS TDSA TCS TCSA_Data_GSTR-2X.xlsx");
		
		if (responseFromView != null && responseFromView.size() > 0) {
			String[] invoiceHeaders = commonUtility
					.getProp("tds.total.report.headers").split(",");
