 ...
 */
@Slf4j
@Component("gstr1AB2bB2baAtGstnImpl")
public class Gstr1AB2bB2baAtGstnImpl implements Gstr1InvoicesAtGstn {

	@Autowired
	@Qualifier("gstr1AB2bB2baDataAtGstnImpl")
	private Gstr1AB2bB2baDataAtGstn getGstr1B2bB2baDataAtGstn;
