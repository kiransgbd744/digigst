 ...
 *
 */
@Component("Gstr1GstnHsnSummErrorDaoImpl")
public class Gstr1GstnHsnSummErrorDaoImpl implements Gstr1GstnErrorDao {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(Gstr1GstnHsnSummErrorDaoImpl.class);
