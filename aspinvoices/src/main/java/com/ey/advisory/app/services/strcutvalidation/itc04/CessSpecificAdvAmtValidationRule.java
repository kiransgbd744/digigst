...
public class CessSpecificAdvAmtValidationRule implements ValidationRule {
	...
	public List<ProcessingResult> isValid(int idx, Object obj, Object[] row,
		...
		if (!isDecimal(igstRate)) {
			...
			errors.add(new ProcessingResult(APP_VALIDATION, "ER5849",
					"Invalid CessSpecificAmount.", location));
