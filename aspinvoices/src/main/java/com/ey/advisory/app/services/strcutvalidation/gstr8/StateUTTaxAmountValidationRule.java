...
public class StateUTTaxAmountValidationRule implements ValidationRule {
	...
	public List<ProcessingResult> isValid(int idx, Object obj, Object[] row,
		...
		if (!isDecimal(obj.toString().trim())) {
			...
			errors.add(new ProcessingResult(APP_VALIDATION, "ER8019",
					"Invalid StateUTTaxAmount", location));
			return errors;
		}
