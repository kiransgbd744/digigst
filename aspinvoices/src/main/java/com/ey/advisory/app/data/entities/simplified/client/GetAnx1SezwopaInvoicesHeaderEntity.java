 ...
 */
@Entity
@Table(name = "GETANX1_SEZWOPA_HEADER")
public class GetAnx1SezwopaInvoicesHeaderEntity {
	...
	protected List<GetAnx1SezwopaInvoicesItemEntity> lineItems = new ArrayList<>();
	...
	public Long getSezwopaBatchId() {
		return sezwopaBatchId;
	}

	public void setSezwopaBatchId(Long sezwopaBatchId) {
		this.sezwopaBatchId = sezwopaBatchId;
	}
	...
	public List<GetAnx1SezwopaInvoicesItemEntity> getLineItems() {
		return lineItems;
	}

	public void setLineItems(List<GetAnx1SezwopaInvoicesItemEntity> lineItems) {
