...
@Data
@Entity
@Table(name = "GETGSTR2A_ISDA_HEADER")
public class GetGstr2aIsdaInvoicesHeaderEntity extends GetGstr2aIsdaInvoicesHeader {
	...
	protected List<GetGstr2aIsdaInvoicesItemEntity> lineItems = new ArrayList<>();
