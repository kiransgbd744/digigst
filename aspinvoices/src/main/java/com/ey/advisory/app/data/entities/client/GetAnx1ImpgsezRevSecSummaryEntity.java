 ...
 */
@Entity
@Table(name = "GETANX1_IMPGSEZ_REV_SECTION_SUMMARY")
@Setter
@Getter
public class GetAnx1ImpgsezRevSecSummaryEntity {
	...
	private GetAnx1SummaryEntity impgsezSummaryId;
*/
	/*@OneToMany(mappedBy = "impgsezSecSumId", fetch = FetchType.EAGER, cascade = CascadeType.ALL)
