 ...
 *
 */
@Service("CDNURAFilingService")
public class CDNURAFilingService implements FilingService {
	...
	public B2CLFilingDto getFilingData(String gstin, String returnPeriod) {
		...
		List<Object[]> doc = docRepository.getCdnuraData(returnPeriod, gstin);
