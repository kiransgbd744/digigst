...
import com.ey.advisory.app.data.views.client.Gstr1GstnB2CLErrorDto;
...
@Component("Gstr1GstnB2CLErrorDaoImpl")
public class Gstr1GstnB2CLErrorDaoImpl implements Gstr1GstnErrorDao {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(Gstr1GstnB2CLErrorDaoImpl.class);
...
String queryStr = null;
		...
		{
			queryStr = creategstnGstr1AB2CLErrorQueryString(buildQuery.toString());
		}else
		{
			queryStr = creategstnB2CLErrorQueryString(buildQuery.toString());
		...
		return list.parallelStream().map(o -> convertgstnB2CLerror(o))
				.collect(Collectors.toCollection(ArrayList::new));
	}

	private Gstr1GstnB2CLErrorDto convertgstnB2CLerror(Object[] arr) {
		Gstr1GstnB2CLErrorDto obj = new Gstr1GstnB2CLErrorDto();

		obj.setInvoiceType(arr[0] != null ? arr[0].toString() : null);
		obj.setInvoiceNumber(arr[1] != null ? arr[1].toString() : null);
		obj.setInvoiceDate(arr[2] != null ? arr[2].toString() : null);
		obj.setDifferentialPercentage(
				arr[3] != null ? arr[3].toString() : null);
		obj.setTaxableValue(arr[4] != null ? arr[4].toString() : null);
		obj.setRate(arr[5] != null ? arr[5].toString() : null);
		obj.setIntegratedAmount(arr[6] != null ? arr[6].toString() : null);
		obj.setCessAmount(arr[7] != null ? arr[7].toString() : null);
		obj.setInvoiceValue(arr[8] != null ? arr[8].toString() : null);
		obj.setPlaceofSupply(arr[9] != null ? arr[9].toString() : null);
		obj.setEcommerceGSTIN(arr[10] != null ? arr[10].toString() : null);
	...
	private String creategstnB2CLErrorQueryString(String buildQuery) {

		return "SELECT HDR.DOC_TYPE,HDR.DOC_NUM,HDR.DOC_DATE,HDR.DIFF_PERCENT,"
				+ "ITM.TAXABLE_VALUE, ITM.TAX_RATE,ITM.IGST_AMT,"
				+ "(ITM.CESS_AMT_SPECIFIC+ITM.CESS_AMT_ADVALOREM) CESS_AMT,"
				+ "ITM.LINE_ITEM_AMT,HDR.POS,HDR.ECOM_GSTIN AS GSTIN,"
				...
				+ "HDR.GSTN_ERROR=TRUE AND HDR.TAX_DOC_TYPE='B2CL' "
				+ "AND HDR.IS_DELETE=FALSE "
				+ "AND GSTN_SAVE_STATUS='PE' " + buildQuery;
	}
	
	private String creategstnGstr1AB2CLErrorQueryString(String buildQuery) {
