...
public class Gstr6B2BAGstnErrorDto {
	...
	public String toString() {
		return "Gstr6B2BAGstnErrorDto [supplierGSTIN=" + supplierGSTIN + ", documentNumber=" + documentNumber
				+ ", documentDate=" + documentDate + ", originalDocumentNumber=" + originalDocumentNumber
				+ ", originalDocumentDate=" + originalDocumentDate + ", lineNo=" + lineNo + ", rate=" + rate + ", pos="
				+ pos + ", taxableValue=" + taxableValue + ", igst=" + igst + ", cgst=" + cgst + ", sgst=" + sgst
				+ ", cess=" + cess + ", invoiceValue=" + invoiceValue + ", refId=" + refId + ", refIdDateTime="
				+ refIdDateTime + ", errorCode=" + errorCode + ", errorMessage=" + errorMessage + "]";
	}
