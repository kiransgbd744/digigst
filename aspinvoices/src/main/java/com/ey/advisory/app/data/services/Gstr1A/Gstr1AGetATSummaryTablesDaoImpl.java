...
@Component("Gstr1AGetATSummaryTablesDaoImpl")
@Slf4j
public class Gstr1AGetATSummaryTablesDaoImpl implements Gstr1AaGetDao {
	...
	private String creategstnATQueryString(String buildQuery) {
		...
		return "select ID,GSTIN,RETURN_PERIOD,SUPPLY_TYPE,STATE_NAME,"
				...
				+ "FROM GETGSTR1A_AT_HEADER HDR INNER JOIN GETGSTR1A_AT_ITEM ITM "
