...
import com.ey.advisory.app.data.views.client.Ret1And1AInterestAndLateFeeTotalDto;
import com.ey.advisory.app.data.views.client.Ret1And1ARefundsTotalDto;
import com.ey.advisory.app.data.views.client.Ret1And1ASetoffUtilizationTotalDto;
import com.ey.advisory.app.data.views.client.Ret1And1AUserInputsTotalDto;
...
@Component("Ret1And1AVerticalTotalReportsDaoImpl")
public class Ret1And1AVerticalTotalReportsDaoImpl
	...
	private static final Logger LOGGER = LoggerFactory
			.getLogger(Ret1And1AVerticalTotalReportsDaoImpl.class);
	...
	private Object convertVerticalTotal(Object[] arr) {
		...
		Ret1And1AUserInputsTotalDto obj1 = new Ret1And1AUserInputsTotalDto();
		Ret1And1AInterestAndLateFeeTotalDto obj2 = new Ret1And1AInterestAndLateFeeTotalDto();
		Ret1And1ASetoffUtilizationTotalDto obj3 = new Ret1And1ASetoffUtilizationTotalDto();
		Ret1And1ARefundsTotalDto obj4 = new Ret1And1ARefundsTotalDto();
	...
	private String createVerticalTotalQueryString(String buildQuery) {
		...
		if ((DownloadReportsConstant.RET1AND1A).equalsIgnoreCase(fileType)) {
			queryStr = "SELECT RETURN_TYPE,GSTIN,RETURN_PERIOD,"
					+ "RETURN_TABLE,TAXABLE_VALUE,IGST_AMT,CGST_AMT,"
			...
			queryStr = "SELECT RETURN_TYPE,GSTIN,RETURN_PERIOD,RETURN_TABLE,"
					...
					+ "RET_AS_ENTERED_INTEREST_LATEFEE HI LEFT OUTER JOIN "
			...
			queryStr = "SELECT RETURN_TYPE,GSTIN,RETURN_PERIOD,DESCRIPTION,"
					...
					+ "AND HI.FILE_ID = ERR.FILE_ID LEFT OUTER JOIN "
			...
			queryStr = "SELECT GSTIN,RETURN_PERIOD,DESCRIPTION,TAX,"
					+ "INTEREST,PENALTY,FEE,OTHER,TOTAL,USERDEFINED1,"
					...
					+ "ERR.INV_KEY = HI.INVKEY_RET_REFUND_FROM_E_CASHLEDGER "
					+ "WHERE HI.IS_DELETE = FALSE "
					+ "AND " + buildQuery;
		}
		return queryStr;
