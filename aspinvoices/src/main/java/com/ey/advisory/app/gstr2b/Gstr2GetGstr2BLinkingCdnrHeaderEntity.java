...
@AllArgsConstructor
@Entity
@Table(name = "GETGSTR2B_LINKING_CDNR_HEADER")
public class Gstr2GetGstr2BLinkingCdnrHeaderEntity {

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "GETGSTR2B_CDNR_HEADER_SEQ", allocationSize = 100)
	...
	protected List<Gstr2GetGstr2BLinkingCdnrItemEntity> lineItems = new ArrayList<>();
}
