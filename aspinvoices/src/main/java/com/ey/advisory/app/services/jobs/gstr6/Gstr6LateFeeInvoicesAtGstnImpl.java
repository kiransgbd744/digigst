 ...
 *
 */
@Service("Gstr6LateFeeInvoicesAtGstnImpl")
@Slf4j
public class Gstr6LateFeeInvoicesAtGstnImpl implements Gstr6InvoicesAtGstn {
	...
	public Long findInvFromGstn(Gstr6GetInvoicesReqDto dto, String groupCode, String type, Long batchId) {
		if (LOGGER.isDebugEnabled()) {
			LOGGER.debug("I am from findLATEFEEFromGstn Method type: {}", type);
		}
		...
		try {
			...
			throw new APIException("Unexpected error while executing Gstr6 Get LateFee");
