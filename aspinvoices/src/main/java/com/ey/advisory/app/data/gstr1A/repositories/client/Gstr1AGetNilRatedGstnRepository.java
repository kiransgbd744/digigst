...
@Repository("Gstr1AGetNilRatedGstnRepository")
@Transactional(propagation = Propagation.REQUIRED, readOnly = false)
public interface Gstr1AGetNilRatedGstnRepository
		extends CrudRepository<GetGstr1ANilRatedEntity, Long> {
	@Modifying
	@Query("UPDATE GetGstr1ANilRatedEntity b SET b.isDelete = true WHERE"
	...
	@Query("SELECT COUNT(*) FROM GetGstr1ANilRatedEntity "
