 ...
 *
 */
@Service("B2claFilingService")
public class B2claFilingService implements FilingService {
	...
	public B2CLFilingDto getFilingData(String gstin, String returnPeriod) {
		...
		List<Object[]> doc = docRepository.getB2clData(returnPeriod, gstin);
