 ...
 */
	...
	@Component("NilNonVerticalErrorReportsDaoImpl")
	public class NilNonVerticalErrorReportsDaoImpl implements NilNonVerticalDao {

		@PersistenceContext(unitName = "clientDataUnit")
		private EntityManager entityManager;

		private static final Logger LOGGER = LoggerFactory
				.getLogger(NilNonVerticalErrorReportsDaoImpl.class);

		@Override
		public List<Object> getNilnonVerticalReports(
		...
		if (dataType != null && "GSTR1A".equalsIgnoreCase(dataType))
			...
			queryStr = createGstr1aVerticalTotalQueryString(
					buildQuery.toString());
		else
		...
		private NilNonProcessedRecordsDto convertVerticalTotal(Object[] arr) {
			...
			obj.setaSPErrorCode(arr[14] != null ? arr[14].toString() : null);
			obj.setaSPErrorDescription(arr[15] != null ? arr[15].toString() : null);
			obj.setHsn(
		...
		private String createVerticalTotalQueryString(String buildQuery) {
			return "select SUPPLIER_GSTIN,RETURN_PERIOD,NIL_INTERSTATE_REG,"
					...
					+ "ERROR_CODE_ASP,ERROR_DESCRIPTION_ASP,ITM_HSNSAC,"
					+ "ITM_DESCRIPTION,ITM_UQC,ITM_QTY, "
					+ "ERR.INFO_ERROR_CODE_ASP,ERR.INFO_ERROR_DESCRIPTION_ASP "
