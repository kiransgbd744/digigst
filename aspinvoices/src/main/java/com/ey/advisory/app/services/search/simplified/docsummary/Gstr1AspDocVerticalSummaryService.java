 ...
 *
 */
@Service("Gstr1AspDocVerticalSummaryService")
public class Gstr1AspDocVerticalSummaryService {

	@Autowired
	@Qualifier("Gstr1AspDocVerticalSectionDaoImpl")
	Gstr1AspDocVerticalSectionDaoImpl docVertical;
