 ...
 * 
 */
@Component("Anx1ASPEcomB2cSumLevelDaoImpl")
public class Anx1ASPEcomB2cSumLevelDaoImpl implements Anx1ASPEcomSavableDao {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(Anx1ASPEcomB2cSumLevelDaoImpl.class);
	...
	public List<Object> getAnx1EcomSavableReports(SearchCriteria criteria) {
		...
		String queryStr = createEcomB2cSavableSummaryQueryString(
				buildQuery.toString());
	...
	private String createEcomB2cSavableSummaryQueryString(String buildQuery) {
