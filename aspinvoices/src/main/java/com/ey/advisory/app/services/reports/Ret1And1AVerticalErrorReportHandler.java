...
@Component("Ret1And1AVerticalErrorReportHandler")
public class Ret1And1AVerticalErrorReportHandler {
	@Autowired
	@Qualifier("Ret1And1AVerticalErrorReportServiceImpl")
	private Ret1And1AVerticalProcessedReportService ret1And1AVerticalProcessedReportService;

	public Workbook downloadRet1VerticalErrorReport(
