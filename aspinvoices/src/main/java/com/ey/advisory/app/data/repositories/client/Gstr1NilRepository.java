 ...
 *
 */
@Service("Gstr1NilRepository")
@Transactional(propagation = Propagation.REQUIRED, readOnly = false)
public interface Gstr1NilRepository
        extends JpaRepository<Gstr1NilDetailsEntity, Long>,
        JpaSpecificationExecutor<Gstr1NilDetailsEntity> {

    @Modifying
    @Query("UPDATE Gstr1NilDetailsEntity b SET b.isDelete= TRUE "
    ...
    @Transactional
    @Modifying
    @Query("UPDATE Gstr1NilDetailsEntity SET isDelete = true WHERE "
