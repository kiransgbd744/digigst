...
@Component("GetGstr6DetailStatusService")
public class GetGstr6DetailStatusService {

	private static final List<String> HEADER_LIST = Arrays.asList("B2B", "B2BA",
			"CDN", "CDNA", "ISD", "ISDA", "IMPG", "IMPGSEZ", "AMDIMPG");

	@Autowired
	@Qualifier("GetGstr6DetailStatusFetchDaoImpl")
	private GetGstr6DetailStatusFetchDao getGstr6DetailStatusFetchDao;
	...
	public GetGstr6DetailStatusMainDetailsRespDto findByCriteria(
		...
		List<Object[]> gstinList = getGstr6DetailStatusFetchDao
		...
		if (!gstinList.isEmpty() && gstinList.size() > 0) {
			for (Object obj : gstinList) {
				...
				List<Object[]> itemsList = getGstr6DetailStatusFetchDao
