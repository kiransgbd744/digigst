 ...
 *
 */
@Repository("Gstr6aGetB2baGstnRepository")
@Transactional(propagation = Propagation.REQUIRED, readOnly = false)
public interface Gstr6aGetB2baGstnRepository extends CrudRepository<GetGstr6aB2baHeaderEntity, Long> {
	@Modifying
	@Query("UPDATE GetGstr6aB2baHeaderEntity b SET b.isDelete = true,b.modifiedBy = 'SYSTEM'  , b.modifiedOn =:modifiedOn WHERE"
			+ " b.isDelete = false AND b.gstin =:sGstin AND b.taxPeriod =:taxPeriod")
	void softlyDeleteB2baHeader(@Param("sGstin") String sGstin, @Param("taxPeriod") String taxPeriod,
			@Param("modifiedOn") LocalDateTime modifiedOn);

	
	@Query("SELECT distinct erpBatchId FROM GetGstr6aB2baHeaderEntity WHERE "
	...
	@Modifying
	@Transactional
	@Query("UPDATE GetGstr6aB2baHeaderEntity SET "
