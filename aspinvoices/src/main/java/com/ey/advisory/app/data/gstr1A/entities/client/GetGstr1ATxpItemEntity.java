...
@Entity
@Table(name = "GETGSTR1A_TXP_ITEM")

public class GetGstr1ATxpItemEntity {

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "GETGSTR1A_TXP_ITEM_SEQ", allocationSize = 100)
	...
	private GetGstr1ATxpHeaderEntity document;
	...
	public GetGstr1ATxpHeaderEntity getDocument() {
		return document;
	}

	public void setDocument(GetGstr1ATxpHeaderEntity document) {
