...
@Slf4j
@Component("Gstr1EinvResponseReconSummaryDaoImpl")
public class Gstr1EinvResponseReconSummaryDaoImpl
		implements Gstr1EinvResponseReconSummaryDao {

	@PersistenceContext(unitName = "clientDataUnit")
	private EntityManager entityManager;

	@Override
	public List<Object[]> getResponseSummary(List<String> gstins,
		...
		try {
			...
			if (LOGGER.isDebugEnabled()) {
				String msg = String
						.format("Inside Gstr1EinvResponseReconSummaryDaoImpl."
								+ " getResponseSummary():: Invoking"
								+ " USP_EINV_RECON_RESPONDED_SUMMARY Stored Proc");
				LOGGER.debug(msg);
			}
			storedProc = entityManager.createStoredProcedureQuery(
					"USP_EINV_RECON_RESPONDED_SUMMARY");
			...
			String msg = String.format(
					"Error while Executing Stored Proc to get getResponseSummary"
