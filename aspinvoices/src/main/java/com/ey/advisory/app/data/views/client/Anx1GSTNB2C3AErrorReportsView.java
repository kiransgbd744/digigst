 ...
 * 
 */
public class Anx1GSTNB2C3AErrorReportsView {
	...
	public String toString() {
		return "Anx1GSTNB2C3AErrorReportsView [supplierGSTIN=" + supplierGSTIN
				+ ", pos=" + pos + ", taxRate=" + taxRate + ", taxableValue="
				+ taxableValue + ", integTaxAmt=" + integTaxAmt
				+ ", CentralTaxAmt=" + CentralTaxAmt + ", stateUTTaxAmt="
				+ stateUTTaxAmt + ", cessAmt=" + cessAmt + ", diffPerFlag="
				+ diffPerFlag + ", autoPopltToRefund=" + autoPopltToRefund
				+ ", sec7ofIGSTFlag=" + sec7ofIGSTFlag + ", gSTNErrorCode="
				+ gSTNErrorCode + ", gSTNErrorMessage=" + gSTNErrorMessage
				+ ", refID=" + refID + ", refDate=" + refDate + "]";
	}
