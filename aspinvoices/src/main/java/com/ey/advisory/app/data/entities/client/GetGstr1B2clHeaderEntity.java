...
@Entity
@Table(name = "GETGSTR1_B2CL_HEADER")
public class GetGstr1B2clHeaderEntity {

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "GETGSTR1_B2CL_HEADER_SEQ", allocationSize = 100)
	...
	protected List<GetGstr1B2clItemEntity> lineItems = new ArrayList<>();
	...
	public List<GetGstr1B2clItemEntity> getLineItems() {
		return lineItems;
	}

	public void setLineItems(List<GetGstr1B2clItemEntity> lineItems) {
