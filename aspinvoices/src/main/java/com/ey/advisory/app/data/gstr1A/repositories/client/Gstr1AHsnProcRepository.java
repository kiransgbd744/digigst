...
import com.ey.advisory.app.data.gstr1A.entities.client.Gstr1AHsnProcEntity;
/**
 * 
 * @author Siva.Reddy
 *
 */
@Repository("Gstr1AHsnProcRepository")
@Transactional(propagation = Propagation.REQUIRED, readOnly = false)
public interface Gstr1AHsnProcRepository extends CrudRepository<Gstr1AHsnProcEntity, Long> {

	@Modifying
	@Query("UPDATE Gstr1AHsnProcEntity doc SET doc.gstnBatchId=:gstnBatchId,"
	...
	@Query("SELECT "
			...
			+ "FROM Gstr1AHsnProcEntity doc WHERE "
	...
	@Modifying
	@Query("UPDATE Gstr1AHsnProcEntity doc SET doc.isSaved=true, doc.isError=false "
			+ "WHERE doc.gstnBatchId=:gstnBatchId")
	void updateIsSavedToGstn(@Param("gstnBatchId") Long gstnBatchId);
	@Modifying
	@Query("UPDATE Gstr1AHsnProcEntity doc SET doc.isError=true, doc.isSaved=false "
			+ "WHERE doc.gstnBatchId=:gstnBatchId")
