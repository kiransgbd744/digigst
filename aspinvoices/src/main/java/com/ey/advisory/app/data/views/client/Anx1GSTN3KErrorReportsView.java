...
public class Anx1GSTN3KErrorReportsView {
	...
	public String toString() {
		return "Anx1GSTN3KErrorReportsView [recipientGSTIN=" + recipientGSTIN
				+ ", supplierGSTIN=" + supplierGSTIN + ", documentType="
				+ documentType + ", portCode=" + portCode
