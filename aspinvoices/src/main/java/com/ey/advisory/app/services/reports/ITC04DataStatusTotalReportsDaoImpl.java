...
@Slf4j
@Component("ITC04DataStatusTotalReportsDaoImpl")
public class ITC04DataStatusTotalReportsDaoImpl {

		@PersistenceContext(unitName = "clientDataUnit")
	private EntityManager entityManager;

	public List<ItcTotalRecords> getItc04TotalRecordsReport(
...
*/
	String buildQueryfilter = buildQuery.toString().substring(4);
		String queryStr = createItc04ErrorQueryString(buildQueryfilter);
...
*/		List<Object[]> list = q.getResultList();
		List<ItcTotalRecords> retList = list.parallelStream().map(o -> convertVerticalTotal(o))
	...
	private String createItc04ErrorQueryString(String buildQuery) {
		return "SELECT "
				...
				+ "JW_DELIVERY_CHALLAN_DATE,"
				+ "GOODS_RECEIVING_DATE,INV_NUM,INV_DATE,JW_GSTIN,JW_STATE_CODE,"
				+ "JW_WORKER_TYPE,JW_ID,JW_NAME,GOODS_TYPE,ITM_SER_NO,PRODUCT_DESC,"
				+ "PRODUCT_CODE,NATURE_OF_JW,ITM_HSNSAC,ITM_UQC,ITM_QTY,"
				+ "LOSSES_UQC,LOSSES_QTY,ITM.TAXABLE_VALUE ITM_ACCESSABLE_AMT,"
				+ "IGST_RATE,ITM.IGST_AMT,CGST_RATE,ITM.CGST_AMT,SGST_RATE,ITM.SGST_AMT,"
				...
				+ "STATE_CESS_RATE_SPECIFIC,ITM.STATE_CESS_AMT_SPECIFIC,ITM.TOTAL_VALUE,"
				...
				+ "USERDEFINED_FIELD10,'' USERID, '' FILE_ID,"
				+ "'' FILE_NAME,"
				+ "'ERP_PUSH' SOURCE,"
				+ "'' AS GSTN_SAVE_STATUS,"
				+ "'' AS GSTIN_REF_ID,'' AS GSTIN_REF_ID_TIME,'' AS GSTIN_ERROR_CODE,"
