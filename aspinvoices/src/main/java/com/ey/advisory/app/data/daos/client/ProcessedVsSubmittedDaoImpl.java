 ...
 *
 */
@Component("ProcessedVsSubmittedDaoImpl")
@Slf4j
public class ProcessedVsSubmittedDaoImpl implements ProcessedVsSubmittedDao {
	...
	public StringBuilder createQueryString(List<Long> entityId,
		...
		bufferString.append("SELECT SUPPLIER_GSTIN, "
				...
				+ "GSTR1_SUBMITTED_PS WHERE IS_DELETE=FALSE AND TAX_DOC_TYPE "
				...
				+ "AS ASP_COUNT, TAX_DOC_TYPE FROM GSTR1_SUBMITTED_PS"
