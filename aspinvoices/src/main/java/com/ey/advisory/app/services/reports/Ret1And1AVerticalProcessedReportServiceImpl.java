...
@Service("Ret1And1AVerticalProcessedReportServiceImpl")
public class Ret1And1AVerticalProcessedReportServiceImpl
		implements Ret1And1AVerticalProcessedReportService {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(Ret1And1AVerticalProcessedReportServiceImpl.class);

	@Autowired
	CommonUtility commonUtility;

	@Autowired
	@Qualifier("Ret1And1AVerticalProcessedReportsDaoImpl")
	...
	public Workbook downloadReports(SearchCriteria criteria,
		...
		LOGGER.debug("Ret1And1A vertical Process response" + responseFromView);
		...
		if (responseFromView != null && !responseFromView.isEmpty()) {
			...
			if ((DownloadReportsConstant.RET1AND1A)
				...
				String[] userinputsHeaders = commonUtility
						.getProp("ret1and1a.userinputs.process.report.headers")
						.split(",");
				LOGGER.debug("workbook properties reading starting ");

				workbook = createWorkbookWithExcelTemplate("ReportTemplates",
						"RET1And1AUSERINPUTSProcessed.xlsx");
				...
				String[] interestHeaders = commonUtility
						.getProp(
								"ret1and1a.interestandlatefee.process.report.headers")
						.split(",");

				LOGGER.debug("workbook properties reading starting ");

				workbook = createWorkbookWithExcelTemplate("ReportTemplates",
						"INTERESTAndLATEFEEProcessed.xlsx");
				...
				String[] setoffHeaders = commonUtility
						.getProp("ret1and1a.setoffutil.process.report.headers")
						.split(",");
				LOGGER.debug("workbook properties reading starting ");

				workbook = createWorkbookWithExcelTemplate("ReportTemplates",
						"SETOFFUTILIZATIONProcessed.xlsx");
				...
				String[] refundsHeaders = commonUtility
						.getProp("ret1and1a.refunds.process.report.headers")
						.split(",");
				LOGGER.debug("workbook properties reading starting ");

				workbook = createWorkbookWithExcelTemplate("ReportTemplates",
						"REFUNDSProcessed.xlsx");
