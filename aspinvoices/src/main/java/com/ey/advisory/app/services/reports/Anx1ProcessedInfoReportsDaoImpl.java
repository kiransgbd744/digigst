...
@Component("Anx1ProcessedInfoReportsDaoImpl")
public class Anx1ProcessedInfoReportsDaoImpl
		implements Anx1ProcessedInfoReportsDao {
	...
	@Override
	public List<Anx1ProcesssedInfo> getProcessedInfoReports(
	...
	private Anx1ProcesssedInfo convertProcessed(Object[] arr) {
		Anx1ProcesssedInfo obj = new Anx1ProcesssedInfo();
	...
	private String createProcessedQueryString(String buildQuery) {
		return "SELECT HDR.ID AS HID,HDR.USER_ID,"
				...
				+ "HDR.DOC_DATE," + "ITM.PRECEEDING_INV_DATE,"
				...
				+ "ON HDR.FILE_ID=FIL.ID WHERE IS_ERROR=FALSE "
				+ "AND IS_INFORMATION = TRUE " + buildQuery
