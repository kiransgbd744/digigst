...
@Slf4j
@Component("Gstr1CDNRASectionReportHandler")
public class Gstr1CDNRASectionReportHandler {

	@Autowired
	@Qualifier("Gstr1CDNRASectionReportServiceImpl")
		...
		try {
			...
			if (workbook != null) {
				...
				if (LOGGER.isDebugEnabled()) {
					LOGGER.debug("Gstr1 CDNRA template file name is : {}",
				...
				if (LOGGER.isDebugEnabled()) {
					LOGGER.debug("Gstr1 CDNRA file name is : {}", fileName);
				}
				...
				if (LOGGER.isDebugEnabled()) {
					LOGGER.debug(
							"Workbook has been generated successfully with the"
									+ " Gstr1 CDNRA response list in the directory : {}",
				...
				if (id != null) {
					try {
						...
						String msg = String
								.format("Gstr1CDNRASectionReportHandler - "
				...
				if (LOGGER.isDebugEnabled()) {
					LOGGER.debug(
							"Gstr1 CDNRA No Data found for report id : {} ",
							id);
				}
			...
			String msg = String.format("Gstr1CDNRASectionReportHandler - "
					+ "Exception occured while "
