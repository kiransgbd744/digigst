 ...
 *
 */
@Service("SimplDocEcommSummarySearchService")
public class SimplDocEcommSummarySearchService implements SearchService {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(SimplDocEcommSummarySearchService.class);

	
	@Autowired
	@Qualifier("SimplDefaultGstr1BasicEcomSummarySectionFetcher")
	private SimplBasicEcommSummarySectionFetcher fetcher;
