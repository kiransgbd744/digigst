 ...
 */
@Entity
@Table(name = "GETGSTR6A_STAGING_B2B_ITEM")
public class GetGstr6aStagingB2bItemEntity {

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "GETGSTR6A_B2B_ITEM_SEQ", allocationSize = 100)
	...
	protected GetGstr6aStagingB2bHeaderEntity header;
	...
	public GetGstr6aStagingB2bHeaderEntity getHeader() {
		return header;
	}

	public void setHeader(GetGstr6aStagingB2bHeaderEntity header) {
		this.header = header;
	}
