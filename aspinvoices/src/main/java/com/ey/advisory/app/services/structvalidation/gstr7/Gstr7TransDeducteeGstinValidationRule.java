 ...
 *
 */
public class Gstr7TransDeducteeGstinValidationRule implements ValidationRule {
	...
	public List<ProcessingResult> isValid(int idx, Object obj, Object[] row,
		...
		if (!isPresent(obj)) {
			...
			errors.add(new ProcessingResult(APP_VALIDATION, "ER63031",
					"Deductee GSTIN cannot be left blank.", location));
			return errors;
		}
		...
		if (matcher.matches() || matcher1.matches() || matcher2.matches()
			...
			errors.add(new ProcessingResult(APP_VALIDATION, "ER63008",
					"Invalid Deductee GSTIN.", location));
			return errors;
		}
		return errors;
	}
