...
public class EWayBillDateValidationRule implements ValidationRule {
	...
	public List<ProcessingResult> isValid(int idx,Object obj, Object[] row,
		...
		if (!isPresent(obj)) return errors;
			...
			if (date == null) {
				...
				errors.add(new ProcessingResult(APP_VALIDATION, "ER0109",
						"Invalid E-Way Bill Date", location));
				return errors;
			}
