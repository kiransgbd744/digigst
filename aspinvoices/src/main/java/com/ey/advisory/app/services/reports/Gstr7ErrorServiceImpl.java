 ...
 */
	...
	@Service("Gstr7ErrorServiceImpl")
	public class Gstr7ErrorServiceImpl
			implements Gstr7GstnErrorService {

		private static final Logger LOGGER = LoggerFactory
				.getLogger(Gstr7ErrorServiceImpl.class);

		@Autowired
		CommonUtility commonUtility;

		@Autowired
		@Qualifier("Gstr7ErrorReportDaoImpl")
		private Gstr7GstnErrorReportsDao gstr7GstnErrorReportsDao;
		...
		public Workbook findGstr7GstnSummRecords(SearchCriteria criteria,
			...
			responseFromView = gstr7GstnErrorReportsDao
					.getGstr7GstnReports(request);
