 ...
 */
@Entity
@Table(name = "GETANX1_IMPS_IMPG_MIS_SECTION_SUMMARY")
@Setter
@Getter
public class GetAnx1ImpsImpgMisSecSummaryEntity {
	...
	private Long impsSummaryId;


	/*@ManyToOne
	@JoinColumn(name = "SUMMARY_ID", referencedColumnName = "ID", nullable = false)
	private GetAnx1SummaryEntity impsSummaryId;
*/
}
