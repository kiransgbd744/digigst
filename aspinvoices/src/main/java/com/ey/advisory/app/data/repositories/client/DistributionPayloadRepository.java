 ...
 *
 */
@Repository("DistributionPayloadRepository")
@Transactional(propagation = Propagation.REQUIRED, readOnly = false)
public interface DistributionPayloadRepository
		extends CrudRepository<DistributionPayloadEntity, Long> {

	@Modifying
	@Query("UPDATE DistributionPayloadEntity nil SET nil.status=:status,"
