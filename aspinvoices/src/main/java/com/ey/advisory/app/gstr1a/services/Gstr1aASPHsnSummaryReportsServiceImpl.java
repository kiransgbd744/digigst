...
import com.ey.advisory.app.services.reports.Gstr1AspHsnSummaryDaoImpl;
import com.ey.advisory.common.CommonUtility;
import com.ey.advisory.core.dto.Gstr1ReviwSummReportsReqDto;
import com.ey.advisory.core.search.PageRequest;
import com.ey.advisory.core.search.SearchCriteria;

@Service("Gstr1aASPHsnSummaryReportsServiceImpl")
public class Gstr1aASPHsnSummaryReportsServiceImpl
		implements Gstr1ASPHsnSummaryReportsService {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(Gstr1aASPHsnSummaryReportsServiceImpl.class);

	@Autowired
	CommonUtility commonUtility;

	@Autowired
	@Qualifier("Gstr1aAspHsnSummaryDaoImpl")
	Gstr1aAspHsnSummaryDaoImpl gstr1AspHsnSummaryDao;
	...
	public Workbook findReports(SearchCriteria criteria, PageRequest pageReq) {
		...
		workbook = createWorkbookWithExcelTemplate("ReportTemplates",
				"GSTR1A_ASP_HSN_Summary_Savable.xlsx");
