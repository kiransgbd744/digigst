...
@Repository("Gstr1GetAtGstnRepository")
@Transactional(propagation = Propagation.REQUIRED, readOnly = false)
public interface Gstr1GetAtGstnRepository
		extends CrudRepository<GetGstr1AtHeaderEntity, Long> {
	@Modifying
	@Query("UPDATE GetGstr1AtHeaderEntity b SET b.isDelete = true,"
	...
	@Query("SELECT COUNT(*) FROM GetGstr1AtHeaderEntity "
