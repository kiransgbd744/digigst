 ...
 *
 */
@Service("AdvBasicGstr1ADocSummaryScreenSectionDaoImpl")
public class AdvBasicGstr1ADocSummaryScreenSectionDaoImpl
		implements AdvBasicGstr1ADocSummaryScreenSectionDao {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(AdvBasicGstr1ADocSummaryScreenSectionDaoImpl.class);
