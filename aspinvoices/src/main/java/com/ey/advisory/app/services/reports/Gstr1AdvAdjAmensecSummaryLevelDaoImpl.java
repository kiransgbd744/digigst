...
@Component("Gstr1AdvAdjAmensecSummaryLevelDaoImpl")
public class Gstr1AdvAdjAmensecSummaryLevelDaoImpl
		implements Gstr1ASPAdvAdjSavableSummaryLevelDao {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(Gstr1AdvAdjAmensecSummaryLevelDaoImpl.class);
