...
@Repository("Gstr2aGetCdnaInvoicesAtGstnRepository")
@Transactional(propagation = Propagation.REQUIRED, readOnly = false)
public interface Gstr2aGetCdnaInvoicesAtGstnRepository
	...
	@Query("from GetGstr2aCdnaInvoicesHeaderEntity where gstin=:sgstin and countergstin=:cgstin and credDebRefVoucherDate=:invDate and credDebRefVoucherNum=:invNum and credDebRefVoucher=:invType")
	List<GetGstr2aCdnaInvoicesHeaderEntity> findByInvoiceKey(@Param("sgstin") String gstin,@Param("cgstin") String countergstin,
	...
	@Modifying
	@Query("UPDATE GetGstr2aCdnaInvoicesHeaderEntity b SET b.isDelete = true, b.modifiedOn=:modifiedOn WHERE"
