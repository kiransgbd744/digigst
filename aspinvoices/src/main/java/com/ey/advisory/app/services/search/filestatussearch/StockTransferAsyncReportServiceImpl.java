...
@Component("StockTransferAsyncReportServiceImpl")
@Slf4j
public class StockTransferAsyncReportServiceImpl
	...
	public void generateReports(Long id) {
		...
		try {
			...
			Optional<CustomisedReportMasterEntity> getReportDtls = custRetMasterRepo
					.findByReportNameAndIsActiveTrue("STOCK_TRANSFER");
			...
			WritetoCsv(chunkCount, id, reportType, beanWriter,
					isActiveFieldSel);
			...
			fileStatusDownloadReportRepo.updateStatus(id,
					...
					EYDateUtil.toUTCDateTimeFromLocal(LocalDateTime.now()));
			String msg = "Exception occued while generating csv file";
			LOGGER.error(msg, e);
			throw new AppException(msg, e);
	...
	private void WritetoCsv(Integer chunkNo, Long id, String reportType,
		...
		String procName = "stockTransferRespChunkData";
	...
	private Integer getChunkCount(String reportCateg, Long id) {
		...
		String procName = "stockTransferRespChunkCount";
