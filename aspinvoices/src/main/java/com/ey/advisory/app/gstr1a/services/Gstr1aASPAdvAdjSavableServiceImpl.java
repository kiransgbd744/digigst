...
@Service("Gstr1aASPAdvAdjSavableServiceImpl")
public class Gstr1aASPAdvAdjSavableServiceImpl
		implements Gstr1ASPAdvAdjSavableService {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(Gstr1aASPAdvAdjSavableServiceImpl.class);

	@Autowired
	CommonUtility commonUtility;

	@Autowired
	@Qualifier("Gstr1aASPAdvAdjSavableTotalDaoImpl")
	...
	@Autowired
	@Qualifier("Gstr1aASPAdvAdjSavableSummaryLevelDaoImpl")
	...
	public Workbook findGstr1AdjSavableReports(SearchCriteria criteria,
		...
		workbook = createWorkbookWithExcelTemplate("ReportTemplates",
				"GSTR-1A_ASP_Advance_Adjusted_Savable.xlsx");
