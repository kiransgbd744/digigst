...
@Slf4j
@Component("Gstr1CDNURSectionReportHandler")
public class Gstr1CDNURSectionReportHandler {

	@Autowired
	@Qualifier("Gstr1CDNURSectionReportServiceImpl")
		...
		try {
			...
			if (workbook != null) {
				...
				if (LOGGER.isDebugEnabled()) {
					LOGGER.debug("Gstr1 CDNUR template file name is : {}",
				...
				if (LOGGER.isDebugEnabled()) {
					LOGGER.debug("Gstr1 CDNUR file name is : {}", fileName);
				}
				...
				if (LOGGER.isDebugEnabled()) {
					LOGGER.debug(
							"Workbook has been generated successfully with the"
									+ " Gstr1 CDNUR response list in the directory : {}",
				...
				if (id != null) {
					try {
						...
						String msg = String
								.format("Gstr1CDNURSectionReportHandler - "
				...
				if (LOGGER.isDebugEnabled()) {
					LOGGER.debug(
							"Gstr1 CDNUR No Data found for report id : {} ",
							id);
				}
			...
			String msg = String.format("Gstr1CDNURSectionReportHandler - "
					+ "Exception occured while "
