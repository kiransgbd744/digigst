 ...
 *
 */
@Repository("Gstr1GetTxpGstnRepository")
@Transactional(propagation = Propagation.REQUIRED, readOnly = false)
public interface Gstr1GetTxpGstnRepository
		extends CrudRepository<GetGstr1TxpHeaderEntity, Long> {
	@Modifying
	@Query("UPDATE GetGstr1TxpHeaderEntity b SET b.isDelete = true,b.modifiedBy = 'SYSTEM'  , b.modifiedOn =:modifiedOn   WHERE"
	...
	@Query("SELECT COUNT(*) FROM GetGstr1TxpHeaderEntity "
