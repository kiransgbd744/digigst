...
@Data
@Entity
@Table(name = "GETGSTR1_ECOMSUPAMD_ITEM")
public class GetGstr1EcomSupAmdItemEntity {
	...
	protected GetGstr1EcomSupAmdHeaderEntity document;

	@Override
	public String toString() {
	    return "GetGstr1EcomSupAmdItemEntity{" +
	            "id=" + id +
