 ...
 *
 */
public class Gstr1AAASupplierGstin implements
	...
	public List<ProcessingResult> validate(
		...
		if (document.getSgstin() != null && !document.getSgstin().isEmpty()) {
			 ...
			 * "GSTNDetailRepository", GSTNDetailRepository.class); String gstin
			 * = document.getSgstin().trim(); List<GSTNDetailEntity> out =
			 * gstinInfoRepository
