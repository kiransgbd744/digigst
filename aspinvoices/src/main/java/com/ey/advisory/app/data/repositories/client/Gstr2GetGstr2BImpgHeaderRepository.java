...
@Repository("Gstr2GetGstr2BImpgHeaderRepository")
@Transactional(propagation = Propagation.REQUIRED, readOnly = false)
public interface Gstr2GetGstr2BImpgHeaderRepository
		extends CrudRepository<Gstr2GetGstr2BImpgHeaderEntity, Long>,
		JpaSpecificationExecutor<Gstr2GetGstr2BImpgHeaderEntity> {

	@Modifying
	@Query("UPDATE Gstr2GetGstr2BImpgHeaderEntity b SET b.isDelete = true, "
	...
	@Modifying
	@Query("UPDATE Gstr2GetGstr2BImpgHeaderEntity b SET b.status = 'SAVED', "
