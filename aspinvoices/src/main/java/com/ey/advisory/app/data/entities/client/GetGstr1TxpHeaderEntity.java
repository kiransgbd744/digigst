...
@Entity
@Table(name = "GETGSTR1_TXP_HEADER")
public class GetGstr1TxpHeaderEntity {

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "GETGSTR1_TXP_HEADER_SEQ", allocationSize = 100)
	...
	protected List<GetGstr1TxpItemEntity> lineItems = new ArrayList<>();
	...
	public List<GetGstr1TxpItemEntity> getLineItems() {
		return lineItems;
	}

	public void setLineItems(List<GetGstr1TxpItemEntity> lineItems) {
