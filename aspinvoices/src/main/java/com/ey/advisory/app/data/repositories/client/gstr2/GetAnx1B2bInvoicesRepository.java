 ...
 *
 */
@Repository("GetAnx1B2bInvoicesRepository")
@Transactional(propagation = Propagation.REQUIRED, readOnly = false)
public interface GetAnx1B2bInvoicesRepository
		extends CrudRepository<GetAnx1B2bInvoicesHeaderEntity, Long> {

	@Modifying
	@Query("UPDATE GetAnx1B2bInvoicesHeaderEntity b SET b.isDelete = true WHERE"
