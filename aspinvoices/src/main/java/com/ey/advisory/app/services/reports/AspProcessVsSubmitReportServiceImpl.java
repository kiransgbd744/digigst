...
@Service("AspProcessVsSubmitReportServiceImpl")
@Slf4j
public class AspProcessVsSubmitReportServiceImpl
		implements AspProcessVsSubmitReportService {

	@Autowired
	CommonUtility commonUtility;

	@Autowired
	@Qualifier("AspProcessVsSubmitSummaryReportDaoImpl")
	private AspProcessVsSubmitDao aspProcessVsSubmitSummaryReportDao;

	@Autowired
	@Qualifier("AspProcessVsSubmitAditionalGstnReportDaoImpl")
	private AspProcessVsSubmitDao aspProcessVsSubmitAditionalGstnReportDao;

	@Autowired
	@Qualifier("AspProcessVsSubmitAditionalDigiGstReportDaoImpl")
	private AspProcessVsSubmitDao aspProcessVsSubmitAditionalDigiGstReportDao;

	@Autowired
	@Qualifier("AspProcessVsSubmitB2csReportDaoImpl")
	private AspProcessVsSubmitDao aspProcessVsSubmitB2csReportDao;

	@Autowired
	@Qualifier("AspProcessVsSubmitB2csaReportDaoImpl")
	private AspProcessVsSubmitDao aspProcessVsSubmitB2csaReportDao;

	@Autowired
	@Qualifier("AspProcessVsSubmitAtReportDaoImpl")
	private AspProcessVsSubmitDao aspProcessVsSubmitAtReportDao;

	@Autowired
	@Qualifier("AspProcessVsSubmitAtAReportDaoImpl")
	private AspProcessVsSubmitDao aspProcessVsSubmitAtAReportDao;

	@Autowired
	@Qualifier("AspProcessVsSubmitTxpdReportDaoImpl")
	private AspProcessVsSubmitDao aspProcessVsSubmitTxpdReportDao;

	@Autowired
	@Qualifier("AspProcessVsSubmitTxpdaReportDaoImpl")
	private AspProcessVsSubmitDao aspProcessVsSubmitTxpdaReportDao;

	@Autowired
	@Qualifier("AspProcessVsSubmitHsnReportDaoImpl")
	private AspProcessVsSubmitDao aspProcessVsSubmitHsnReportDao;

	@Autowired
	@Qualifier("AspProcessVsSubmitNilNonExmptReportDaoImpl")
	private AspProcessVsSubmitDao aspProcessVsSubmitNilNonExmptReportDao;

	@Autowired
	@Qualifier("AspProcessVsSubmitDocSeriesReportDaoImpl")
	private AspProcessVsSubmitDao aspProcessVsSubmitDocSeriesReportDao;

	@Autowired
	@Qualifier("AspProcessVsSubmitTable14ReportDaoImpl")
	private AspProcessVsSubmitDao aspProcessVsSubmitTable14ReportDao;
	
	@Autowired
	@Qualifier("AspProcessVsSubmitTable15ReportDaoImpl")
	private AspProcessVsSubmitDao aspProcessVsSubmitTable15ReportDao;
