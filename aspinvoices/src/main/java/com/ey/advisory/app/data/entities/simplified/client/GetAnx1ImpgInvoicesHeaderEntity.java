 ...
 */
@Entity
@Table(name = "GETANX1_IMPG_HEADER")
public class GetAnx1ImpgInvoicesHeaderEntity {
	...
	protected List<GetAnx1ImpgInvoicesItemEntity> lineItems = new ArrayList<>();

	/*
	 * @ManyToOne
	 * 
	 * @JoinColumn(name = "BATCH_ID", referencedColumnName = "ID", nullable =
	 * false) private GetAnx1BatchEntity impgBatchId;
	 */
	@Column(name = "BATCH_ID")
	private Long impgBatchId;
	...
	public List<GetAnx1ImpgInvoicesItemEntity> getLineItems() {
		return lineItems;
	}

	public void setLineItems(List<GetAnx1ImpgInvoicesItemEntity> lineItems) {
		this.lineItems = lineItems;
	}

	/*
	 * public GetAnx1BatchEntity getImpgBatchId() { return impgBatchId; }
	 * 
	 * public void setImpgBatchId(GetAnx1BatchEntity impgBatchId) {
	 * this.impgBatchId = impgBatchId; }
	 */

	public Long getImpgBatchId() {
		return impgBatchId;
	}

	public void setImpgBatchId(Long impgBatchId) {
		this.impgBatchId = impgBatchId;
	}
