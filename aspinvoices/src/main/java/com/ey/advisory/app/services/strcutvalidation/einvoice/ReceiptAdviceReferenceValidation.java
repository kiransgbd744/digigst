 ...
 *
 */
public class ReceiptAdviceReferenceValidation implements ValidationRule {
	...
	public List<ProcessingResult> isValid(int idx, Object obj, Object[] row,
		...
		if (obj.toString().trim().length() > 20) {
			...
			errorLocations.add(GSTConstants.RECEIPT_ADVICE_REFERENCE);
			TransDocProcessingResultLoc location = 
					new TransDocProcessingResultLoc(
					null, errorLocations.toArray());
			errors.add(new ProcessingResult(APP_VALIDATION, "ER10102",
					          "Invalid Receipt Advice Reference.", location));
			return errors;
		}
