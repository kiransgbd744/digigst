...
public class CustomerGstinValidation implements ValidationRule {
	@Override
	public List<ProcessingResult> isValid(int idx, Object obj, Object[] row,
		...
		if (!isPresent(obj)) {
			...
			errors.add(new ProcessingResult(APP_VALIDATION, "ER1035",
					"Customer GSTIN cannot be left balnk", location));
			return errors;
		}
		...
		if (obj.toString().trim().length() != 15
			...
			errors.add(new ProcessingResult(APP_VALIDATION, "ER1034",
