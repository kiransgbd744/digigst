 ...
 *
 */
@Service("Gstr6SaveInvicesIdentifierImpl")
@Slf4j
public class Gstr6SaveInvicesIdentifierImpl
		implements Gstr6SaveInvicesIdentifier {

	@Autowired
	@Qualifier("Gstr6SaveDataFetcherImpl")
	private Gstr6SaveDataFetcher SaveGstr6Data;
	...
	public List<SaveToGstnBatchRefIds> findGstr6SaveInvoices(String gstin,
		...
		docs = SaveGstr6Data.findInvoiceLevelData(gstin, retPeriod, groupCode,
				section, isdDocType);
		if (docs != null && !docs.isEmpty()) {
			respList = gstr6BatchMaker.saveGstr6Data(groupCode, section, docs,
