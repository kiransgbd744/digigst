 ...
 */
@Entity
@Table(name = "GETGSTR6_ISDA_DETAILS")
@Setter
@Getter
@ToString
public class GetGstr6IsdaDetailsEntity {

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "GETGSTR6_ISDA_DETAILS_SEQ", allocationSize = 100)
	...
	@Column(name = "R_DOC_NUMBER")
	private String rdocNum;

	@Column(name = "R_DOC_DATE")
	private LocalDate rdocDate;
	...
	@Column(name = "R_CRDR_DOC_NUMBER")
	private String rcrdrDocNum;

	@Column(name = "R_CRDR_DOC_DATE")
	private LocalDate rcrdrDocDate;

	@Column(name = "O_CRDR_DOC_NUMBER")
	private String ocrdrDocNum;

	@Column(name = "O_CRDR_DOC_DATE")
	private LocalDate ocrdrDocDate;
