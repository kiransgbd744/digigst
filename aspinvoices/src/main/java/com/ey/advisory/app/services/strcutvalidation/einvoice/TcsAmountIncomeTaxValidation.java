...
public class TcsAmountIncomeTaxValidation implements ValidationRule {
...
List<ProcessingResult> errors = new ArrayList<>();
		...
		if (!isDecimal(obj.toString().trim())) {
			...
			errorLocations.add(GSTConstants.TCS_AMOUNT_INCOME_TAX);  
			TransDocProcessingResultLoc location = 
					new TransDocProcessingResultLoc(
					idx, errorLocations.toArray());
			errors.add(new ProcessingResult(APP_VALIDATION, "ER15119",
					"Invalid Tcs Amount Income Tax.", location));
			return errors;
		}
