...
@Slf4j
@Component("Gstr1B2CLASectionReportHandler")
public class Gstr1B2CLASectionReportHandler {

	@Autowired
	@Qualifier("Gstr1B2CLASectionReportServiceImpl")
		...
		try {
			...
			if (workbook != null) {
				...
				if (LOGGER.isDebugEnabled()) {
					LOGGER.debug("Gstr1 B2CLA template file name is : {}",
				...
				if (LOGGER.isDebugEnabled()) {
					LOGGER.debug("Gstr1 B2CLA file name is : {}", fileName);
				}
				...
				if (LOGGER.isDebugEnabled()) {
					LOGGER.debug(
							"Workbook has been generated successfully with the"
									+ " Gstr1 B2CLA response list in the directory : {}",
				...
				if (id != null) {
					try {
						...
						String msg = String
								.format("Gstr1B2CLASectionReportHandler - "
				...
				if (LOGGER.isDebugEnabled()) {
					LOGGER.debug(
							"Gstr1 B2CLA No Data found for report id : {} ",
							id);
				}
			...
			String msg = String.format("Gstr1B2CLASectionReportHandler - "
					+ "Exception occured while "
