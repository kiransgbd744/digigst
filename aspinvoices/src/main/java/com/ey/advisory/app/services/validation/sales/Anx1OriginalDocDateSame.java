 ...
 *
 */
@Component("Anx1OriginalDocDateSame")
public class Anx1OriginalDocDateSame implements DocRulesValidator<OutwardTransDocument> {
	...
	public List<ProcessingResult> validate(OutwardTransDocument document,
		...
		if(!DOCTYPE.contains(document.getDocType())) return errors;
