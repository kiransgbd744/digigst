...
@Repository("Gstr2GetGstr2BB2bHeaderRepository")
@Transactional(propagation = Propagation.REQUIRED, readOnly = false)
public interface Gstr2GetGstr2BB2bHeaderRepository
		extends CrudRepository<Gstr2GetGstr2BB2bHeaderEntity, Long>,
		JpaSpecificationExecutor<Gstr2GetGstr2BB2bHeaderEntity> {

	@Modifying
	@Query("UPDATE Gstr2GetGstr2BB2bHeaderEntity b SET b.isDelete = true, "
