...
public class Ret1And1AUserAccess4ValidationRule implements ValidationRule {
	...
	public List<ProcessingResult> isValid(Object obj, Object[] row,
		...
		if (obj.toString().trim().length() > ATT_LENGTH) {
			...
			errors.add(new ProcessingResult(APP_VALIDATION, "ER1830",
					" Invalid User Access 4", location));
		}
		return errors;
	}
}