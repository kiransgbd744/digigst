 ...
 *
 */
@Component("TCSFlagGST")
public class TCSFlagGST implements DocRulesValidator<OutwardTransDocument> {
	...
	private static final List<String> SUPPLY_TYPE = ImmutableList
			.of(GSTConstants.TAX, GSTConstants.DTA,GSTConstants.DXP,GSTConstants.SEZWP,GSTConstants.SEZWOP);
