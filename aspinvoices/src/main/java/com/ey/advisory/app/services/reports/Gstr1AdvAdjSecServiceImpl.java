 ...
 * 
 */
@Service("Gstr1AdvAdjSecServiceImpl")
public class Gstr1AdvAdjSecServiceImpl implements Gstr1ASPAdvAdjSavableService {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(Gstr1AdvAdjSecServiceImpl.class);

	@Autowired
	CommonUtility commonUtility;

	@Autowired
	@Qualifier("Gstr1AdvAdjSecTotalDaoImpl")
	...
	@Autowired
	@Qualifier("Gstr1AdvAdjsecSummaryLevelDaoImpl")
	...
	public Workbook findGstr1AdjSavableReports(SearchCriteria criteria,
		...
		if (responseFromViewTrans != null && responseFromViewTrans.size() > 0) {
			...
			String msg = String
					.format("Adv Adj Gstr1_Asp_Processed_TransactionalReport :"
