...
import com.ey.advisory.core.search.SearchCriteria;
	...
	@Service("Gstr1AAspAdvAdjSecServiceImpl")
	public class Gstr1AAspAdvAdjSecServiceImpl
			implements Gstr1AASPAdvAdjSavableService {

		private static final Logger LOGGER = LoggerFactory
				.getLogger(Gstr1AAspAdvAdjSecServiceImpl.class);

		@Autowired
		CommonUtility commonUtility;

		@Autowired
		@Qualifier("Gstr1AAspAdvAdjSecTotalDaoImpl")
		private Gstr1AASPAdvAdjSavableTotalDao gstr1ASPAdvAdjSavableTotalDao;

		@Autowired
		@Qualifier("Gstr1AASPAdvAdjSavableTransactionalDaoImpl")
		private Gstr1AASPAdvAdjSavableTransactionalDao gstr1ASPAdvAdjSavableTransactionalDao;

		@Autowired
		@Qualifier("Gstr1AAspAdvAdjsecSummaryLevelDaoImpl")
		private Gstr1AASPAdvAdjSavableSummaryLevelDao gstr1ASPAdvAdjSavableSummaryLevelDao;
		...
		public Workbook findGstr1AdjSavableReports(SearchCriteria criteria,
			...
			workbook = createWorkbookWithExcelTemplate("ReportTemplates",
					"GSTR-1_ASP_Advance_Adjusted_Savable.xlsx");
