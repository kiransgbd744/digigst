...
@Service("EinvoiceSalesDocRulesValidatorService")
public class EinvoiceSalesDocRulesValidatorService implements 
			DocRulesValidatorService<OutwardTransDocument, String> {

	@Autowired
	@Qualifier("EinvoiceDefaultSalesDocListRulesValidator")
