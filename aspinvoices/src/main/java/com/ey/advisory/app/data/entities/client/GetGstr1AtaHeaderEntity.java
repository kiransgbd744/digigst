...
@Entity
@Table(name = "GETGSTR1_ATA_HEADER")
public class GetGstr1AtaHeaderEntity {

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "GETGSTR1_ATA_HEADER_SEQ", allocationSize = 100)
	...
	protected List<GetGstr1AtaItemEntity> lineItems = new ArrayList<>();
	...
	public List<GetGstr1AtaItemEntity> getLineItems() {
		return lineItems;
	}

	public void setLineItems(List<GetGstr1AtaItemEntity> lineItems) {
