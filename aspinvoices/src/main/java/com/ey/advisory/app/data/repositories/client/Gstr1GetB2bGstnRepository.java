...
@Repository("Gstr1GetB2bGstnRepository")
@Transactional(propagation = Propagation.REQUIRED, readOnly = false)
public interface Gstr1GetB2bGstnRepository
		extends CrudRepository<GetGstr1B2bHeaderEntity, Long> {
	@Modifying
	@Query("UPDATE GetGstr1B2bHeaderEntity b SET b.isDelete = true,b.modifiedBy = 'SYSTEM'  , b.modifiedOn =:modifiedOn  WHERE"
	...
	@Query("SELECT COUNT(*) FROM GetGstr1B2bHeaderEntity "
