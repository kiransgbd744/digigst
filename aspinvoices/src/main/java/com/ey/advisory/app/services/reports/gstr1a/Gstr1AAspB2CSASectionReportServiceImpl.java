...
import com.ey.advisory.core.search.SearchCriteria;
	...
	@Service("Gstr1AAspB2CSASectionReportServiceImpl")
	public class Gstr1AAspB2CSASectionReportServiceImpl implements Gstr1AReviewSummReportsService {

		private static final Logger LOGGER = LoggerFactory.getLogger(Gstr1AAspB2CSASectionReportServiceImpl.class);

		@Autowired
		CommonUtility commonUtility;

		@Autowired
		@Qualifier("Gstr1AAspB2CSASavableTotalSummaryDaoImpl")
...
*/
		@Autowired
		@Qualifier("Gstr1AAspB2CSASavableSummaryLevelDaoImpl")
