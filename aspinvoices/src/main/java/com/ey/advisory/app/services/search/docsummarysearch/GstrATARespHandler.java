...
@Service("GstrATARespHandler")
public class GstrATARespHandler {
	...
	public JsonElement handleATAResp(List<? extends Gstr1SummaryDto> list,
			Gstr1SummaryReqDto gstr1SummaryRequest) {
		
	
	/*Gstr1SummaryReqDto gstr1SummaryRequest*/
	
		List<Gstr1BasicSummarySectionDto> ataEySummary = new ArrayList<>();
		for (Gstr1SummaryDto gstr1Summary : list) {
			ataEySummary = gstr1Summary.getAta().getEySummary();
		}
...
*/				
				...
				JsonElement ataRespBody = gstr1SummaryStructure
				.ataStructure(ataEySummary,gstnList);
