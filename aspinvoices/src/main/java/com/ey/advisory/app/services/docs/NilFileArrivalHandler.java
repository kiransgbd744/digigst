...
import com.ey.advisory.app.services.gstr1fileupload.Gstr1NilNonExtStructuralProcess;
...
@Service("NilFileArrivalHandler")
@Slf4j
public class NilFileArrivalHandler {
	...
	@Autowired
	@Qualifier("Gstr1NilNonExtStructuralProcess")
	private Gstr1NilNonExtStructuralProcess gstr1NilNonExtStructuralProcess;
	...
	public void processNilFile(Message message, AppExecContext context) {
		...
		if (checkHeaderFormat.getValue0()) {
				gstr1NilNonExtStructuralProcess.nilNonExtStructureProcessData(
						listOfNil, updateFileStatus);
			} else {
