 ...
 */
@Entity
@Table(name = "GETGSTR1A_B2B_HEADER")
public class GetGstr1AB2bHeaderEntity {

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "GETGSTR1A_B2B_HEADER_SEQ", allocationSize = 100)
	...
	protected List<GetGstr1AB2bItemEntity> lineItems = new ArrayList<>();
	...
	public String getOrgPeriod() {
		return orgPeriod;
	}

	public void setOrgPeriod(String orgPeriod) {
	...
	public List<GetGstr1AB2bItemEntity> getLineItems() {
		return lineItems;
	}

	public void setLineItems(List<GetGstr1AB2bItemEntity> lineItems) {
