 ...
 *
 */
@Service("Gstr2aImpgSezInvoicesAtGstnImpl")
@Slf4j
public class Gstr2aImpgSezInvoicesAtGstnImpl implements Gstr2aAmdhistInvoicesAtGstn {
	...
	public Long findInvFromGstn(Gstr1GetInvoicesReqDto dto, String groupCode, String type, Long batchId) {
		...
		try {
			...
			throw new APIException("Unexpected error while executing Gstr2a Get ImpgSez");
