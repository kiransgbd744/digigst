...
import com.ey.advisory.core.search.SearchCriteria;
	...
	@Service("Gstr1AAspCDNURASectionReportServiceImpl")
	public class Gstr1AAspCDNURASectionReportServiceImpl
			implements Gstr1AReviewSummReportsService {

		private static final Logger LOGGER = LoggerFactory
				.getLogger(Gstr1AAspCDNURASectionReportServiceImpl.class);

		@Autowired
		CommonUtility commonUtility;

		@Autowired
		@Qualifier("Gstr1AAspCDNURASectionReportDaoImpl")
