...
@Component("GetGstr7SummarySaveStatusService")
public class GetGstr7SummarySaveStatusService {

	@Autowired
	@Qualifier("GetGstr7DetailStatusFetchDaoImpl")
	private GetGstr7DetailStatusFetchDaoImpl gstr7DetailStatusFetchDao;
	...
	public List<Gstr1SummarySaveStatusRespDto> findByCriteria(
		...
		List<Object[]> savedDataList = gstr7DetailStatusFetchDao
				.getDataUploadedStatusDetails(GstinList,
						criteria.getTaxPeriod(),
						criteria.isTransactional()
