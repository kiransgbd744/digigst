 ...
 *
 */
@Repository("Gstr1AGetCdnraGstnRepository")
@Transactional(propagation = Propagation.REQUIRED, readOnly = false)
public interface Gstr1AGetCdnraGstnRepository
		extends CrudRepository<GetGstr1ACdnraHeaderEntity, Long> {
	@Modifying
	@Query("UPDATE GetGstr1ACdnraHeaderEntity b SET b.isDelete = true,b.modifiedBy = 'SYSTEM'  , b.modifiedOn =:modifiedOn  WHERE"
	...
	@Query("SELECT COUNT(*) FROM GetGstr1ACdnraHeaderEntity "
