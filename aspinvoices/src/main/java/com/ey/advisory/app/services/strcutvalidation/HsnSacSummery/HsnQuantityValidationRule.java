 ...
 *
 */
public class HsnQuantityValidationRule implements ValidationRule {
	...
	public List<ProcessingResult> isValid(Object obj, Object[] row,
		...
		if (!isDecimal(obj.toString().trim())) {
			...
			errors.add(new ProcessingResult(APP_VALIDATION, "ER5708",
		...
		if (obj != null) {
			boolean isValid = NumberFomatUtil
					.is133digValidDec(obj.toString().trim());
