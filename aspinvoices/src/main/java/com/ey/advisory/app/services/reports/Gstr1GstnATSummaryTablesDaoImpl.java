...
@Component("Gstr1GstnATSummaryTablesDaoImpl")
public class Gstr1GstnATSummaryTablesDaoImpl
		implements Gstr1GstnSummaryTablesDao {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(Gstr1GstnATSummaryTablesDaoImpl.class);
	...
	private Gstr1GstnAdvanceReceivedDto convertgstnATSummary(Object[] arr) {
		...
		obj.setSerialNo(arr[15] != null ? arr[15].toString() : null);
	...
	private String creategstnATQueryString(String buildQuery) {
		...
		return "SELECT HDR.ID,HDR.GSTIN,HDR.RETURN_PERIOD,SUPPLY_TYPE,"
				...
				+ " 'ADV REC' AS TABLE_TYPE,(ROW_NUMBER () OVER (ORDER BY HDR.GSTIN)) AS  SNO "
				...
				+ "MT.STATE_NAME,POS,ITM.TAX_RATE,HDR.DIFF_PERCENT,BT.IS_FILED";
	}
}
