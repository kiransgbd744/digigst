 ...
 *
 */
@Repository("Gstr1GetCdnrGstnRepository")
@Transactional(propagation = Propagation.REQUIRED, readOnly = false)
public interface Gstr1GetCdnrGstnRepository
		extends CrudRepository<GetGstr1CdnrHeaderEntity, Long> {
	@Modifying
	@Query("UPDATE GetGstr1CdnrHeaderEntity b SET b.isDelete = true,b.modifiedBy = 'SYSTEM'  , b.modifiedOn =:modifiedOn  WHERE"
	...
	@Query("SELECT COUNT(*) FROM GetGstr1CdnrHeaderEntity "
