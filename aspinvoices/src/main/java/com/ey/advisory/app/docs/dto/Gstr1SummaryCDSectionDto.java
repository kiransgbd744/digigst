 ...
 *
 */
public class Gstr1SummaryCDSectionDto {
	...
	public Gstr1SummaryCDSectionDto() {
	}

	public Gstr1SummaryCDSectionDto(String tableSection) {
	 ...
	 * @param cess
	 */
	public Gstr1SummaryCDSectionDto(Integer records, String taxDocType,String tableSection,String docType,
	...
	public Gstr1SummaryCDSectionDto add(Gstr1SummaryCDSectionDto other) {
