...
public class Ret1And1AUserAccess3ValidationRule implements ValidationRule {
	@Override
	public List<ProcessingResult> isValid(Object obj, Object[] row,
		...
		if (obj.toString().trim().length() > ATT_LENGTH) {
			...
			errors.add(new ProcessingResult(APP_VALIDATION, "ER1828",
					" Invalid User Access 3", location));
		}
		return errors;
	}
}