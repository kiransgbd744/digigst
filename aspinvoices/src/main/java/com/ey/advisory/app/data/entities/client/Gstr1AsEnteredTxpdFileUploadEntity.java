...
@Entity
@Table(name = "GSTR1_AS_ENTERED_ADV_ADJUSTMENT")
@Setter
@Getter
@ToString
public class Gstr1AsEnteredTxpdFileUploadEntity {

	@Expose
	@Id
	@SerializedName("id")
	@SequenceGenerator(name = "sequence", sequenceName = "GSTR1_AS_ENTERED_ADV_ADJUSTMENT_SEQ", allocationSize = 100)
