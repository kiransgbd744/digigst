...
@Component("Gstr1AAspCDNURASectionReportDaoImpl")
public class Gstr1AAspCDNURASectionReportDaoImpl
		implements Gstr1AReviewSummaryReportsDao {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(Gstr1AAspCDNURASectionReportDaoImpl.class);
...
//				.findAnswerForMultiSupplyType();
	...
	private static String createApiProcessedQueryString(String buildHeader,
			...
			return "SELECT TRIM(', ' FROM IFNULL(HDR.ERROR_CODES,'') ||','|| "
					...
					+ "ITM.ITM_UQC,ITM.ITM_QTY, ITM.FREE_QTY, "
					...
					+ "THEN 'ASPERROR' WHEN HDR.ASP_INVOICE_STATUS=2 "
					+ "THEN 'ASPPROCESSED' END AS DIGI_GST_STATUS, "
