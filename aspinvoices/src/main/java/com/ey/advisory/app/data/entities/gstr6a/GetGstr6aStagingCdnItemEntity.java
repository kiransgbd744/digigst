 ...
 */
@Entity
@Table(name = "GETGSTR6A_STAGING_CDN_ITEM")
public class GetGstr6aStagingCdnItemEntity {

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "GETGSTR6A_CDN_ITEM_SEQ", allocationSize = 100)
	...
	protected GetGstr6aStagingCdnHeaderEntity header;
	...
	public GetGstr6aStagingCdnHeaderEntity getHeader() {
		return header;
	}

	public void setHeader(GetGstr6aStagingCdnHeaderEntity header) {
		this.header = header;
	}
