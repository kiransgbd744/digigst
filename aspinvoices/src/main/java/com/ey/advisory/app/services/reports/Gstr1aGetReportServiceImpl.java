...
@Service("Gstr1aGetReportServiceImpl")
public class Gstr1aGetReportServiceImpl
		implements Gstr1AGstnErrorReportService {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(Gstr1aGetReportServiceImpl.class);

	@Autowired
	CommonUtility commonUtility;

	@Autowired
	@Qualifier("Gstr1aGetReportDaoImpl")
	private Gstr1aGetDao gstr1aGetDao;

	@Autowired
	@Qualifier("Gstr1GetB2CSSummaryTablesDaoImpl")
	private Gstr1aGetDao gstr1GstnB2CSSummaryTablesDao;

	@Autowired
	@Qualifier("Gstr1GetB2CSASummaryTablesDaoImpl")
	private Gstr1aGetDao gstr1GstnB2CSASummaryTablesDao;

	@Autowired
	@Qualifier("Gstr1GetATSummaryTablesDaoImpl")
	private Gstr1aGetDao gstr1GstnATSummaryTablesDao;

	@Autowired
	@Qualifier("Gstr1GetATASummaryTablesDaoImpl")
	private Gstr1aGetDao gstr1GstnATASummaryTablesDao;

	@Autowired
	@Qualifier("Gstr1GetTXPSummaryTablesDaoImpl")
	private Gstr1aGetDao gstr1GstnTXPSummaryTablesDao;

	@Autowired
	@Qualifier("Gstr1GetTXPASummaryTablesDaoImpl")
	private Gstr1aGetDao gstr1GstnTXPASummaryTablesDao;

	@Autowired
	@Qualifier("Gstr1GetNilNonExemptSummaryTablesDaoImpl")
	private Gstr1aGetDao gstr1GstnNilNonExemptSummaryTablesDao;

	@Autowired
	@Qualifier("Gstr1GetHsnSummaryTablesDaoImpl")
	private Gstr1aGetDao gstr1GstnHsnSummaryTablesDao;

	@Autowired
	@Qualifier("Gstr1GetInvSeriesTablesDaoImpl")
	private Gstr1aGetDao gstr1GstnInvSeriesTablesDao;
	...
	public Workbook findGstnErrorReports(
		...
		workbook = createWorkbookWithExcelTemplate("ReportTemplates",
				"GSTR-1A_Summary_Tables_Saved_Submitted.xlsx");
		...
		if (responseFromTrans != null && responseFromTrans.size() > 0) {
			...
			Worksheet tabSheet = workbook.getWorksheets().get("Transactional Data");
...
*/
		...
		if (responseFromAT != null && responseFromAT.size() > 0) {
			...
			Worksheet tabSheet = workbook.getWorksheets().get("GSTN_Advance Received");
			/*tabSheet.setSelected(true);
			tabSheet.setTabColor(Color.getBlue());*/
			Cells errorDumpCells = tabSheet.getCells();
		...
		if (responseFromATA != null && responseFromATA.size() > 0) {
			...
			Worksheet tabSheet = workbook.getWorksheets().get("Advance Received Amendment");
			/*tabSheet.setSelected(true);
			tabSheet.setTabColor(Color.getBlue());*/
			Cells errorDumpCells = tabSheet.getCells();
		...
		if (responseFromViewTXP != null && responseFromViewTXP.size() > 0) {
			...
			Worksheet tabSheet = workbook.getWorksheets().get("GSTN_Advance Adjusted");
			/*tabSheet.setSelected(true);
			tabSheet.setTabColor(Color.getBlue());*/
			Cells errorDumpCells = tabSheet.getCells();
		...
		if (responseFromViewTXPA != null && responseFromViewTXPA.size() > 0) {
			...
			Worksheet tabSheet = workbook.getWorksheets().get("Advance Adjusted Amendment");
			/*tabSheet.setSelected(true);
			tabSheet.setTabColor(Color.getBlue());*/
			Cells errorDumpCells = tabSheet.getCells();
		...
		if (responseFromViewNil != null && responseFromViewNil.size() > 0) {
			String[] invoiceHeaders = commonUtility
					...
					.split(",");
			Worksheet tabSheet = workbook.getWorksheets().get("GSTN_NIL NON Exempt");
			/*tabSheet.setSelected(true);
			tabSheet.setTabColor(Color.getBlue());*/
			Cells errorDumpCells = tabSheet.getCells();
		...
		if (responseFromViewHsn != null && responseFromViewHsn.size() > 0) {
			String[] invoiceHeaders = commonUtility
					...
					.split(",");
			Worksheet tabSheet = workbook.getWorksheets().get("GSTN_HSN Summary");
			/*tabSheet.setSelected(true);
			tabSheet.setTabColor(Color.getBlue());*/
			Cells errorDumpCells = tabSheet.getCells();
		...
		if (responseFromViewInv != null && responseFromViewInv.size() > 0) {
			...
			Worksheet tabSheet = workbook.getWorksheets().get("GSTN_Invoice Series");
			/*tabSheet.setSelected(true);
			tabSheet.setTabColor(Color.getBlue());*/
			Cells errorDumpCells = tabSheet.getCells();
