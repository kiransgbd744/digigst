 ...
 *
 */
@Service("Annexure1ExptStructure")
public class Annexure1ExptStructure {
	...
	@Autowired
	@Qualifier("Annexure1ExptEYFinalStructure")
	private Annexure1ExptEYFinalStructure exptEYFinalStructure;

	@Autowired
	@Qualifier("Gstr1SummaryDifference")
	private Gstr1SummaryDifference gstr1SummaryDifference;
	
	public JsonElement exptResp(
		...
		List<Annexure1SummaryRespDto> b2bEYList = exptEYFinalStructure
				.getExptEyList(defaultB2cEYList, eySummaryListFromView);
