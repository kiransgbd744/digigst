 ...
 *
 */
@Repository("GetGstr2B2baInvoicesRepository")
@Transactional(propagation = Propagation.REQUIRED, readOnly = false)
public interface GetGstr2B2baInvoicesRepository
    ...
    @Modifying
    @Query("UPDATE GetGstr2aB2baInvoicesHeaderEntity b SET b.isDelete = true , b.modifiedBy = 'SYSTEM'  , b.modifiedOn =:modifiedOn  WHERE"
    ...
    @Query("from GetGstr2aB2baInvoicesHeaderEntity where sgstin=:sgstin and cgstin=:cgstin and invDate=:invDate and invNum=:invNum and invType=:invType")
    List<GetGstr2aB2baInvoicesHeaderEntity> findByInvoiceKey(
    ...
    @Query("SELECT COUNT(*) FROM GetGstr2aB2baInvoicesHeaderEntity "
            + "WHERE cgstin=:gstin AND returnPeriod = :taxperiod and isDelete =false")
    public int gstinCount(@Param("gstin") String gstin,
            @Param("taxperiod") String taxperiod);

    @Modifying
    @Query("UPDATE GetGstr2aB2baInvoicesHeaderEntity b SET b.isDelete = true, b.modifiedOn=:modifiedOn WHERE"
