 ...
 *
 */
@Component("Gstr1AspHsnSummaryDaoImpl")
public class Gstr1AspHsnSummaryDaoImpl {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(Gstr1AspHsnSummaryDaoImpl.class);
	...
	private static String createHsnSummaryQueryString(String buildQuery,
		...
		bufferString.append("SELECT SUPPLIER_GSTIN "
						...
						+ "														END "
						+ "													) GSTIN_REF_ID_TIME "
						+ "												,IFNULL(ITM_QTY, 0) AS ITM_QTY "
						+ "												,IFNULL(TAXABLE_VALUE, 0) AS TOTAL_VALUE "
						+ "												,IFNULL(TAXABLE_VALUE, 0) AS TAXABLE_VALUE "
						+ "												,0 AS IGST_AMT "
						+ "												,0 CGST_AMT "
						+ "												,0 AS SGST_AMT "
						+ "												,0 AS CESS_AMT "
						...
						+ "												,'8' TABLE_SECTION "
						+ "												,IFNULL(TAXABLE_VALUE, 0) ONB_LINE_ITEM_AMT "
						+ "												,0.00 OTHER_VALUES "
						+ "												,0.00 TAX_RATE, "
