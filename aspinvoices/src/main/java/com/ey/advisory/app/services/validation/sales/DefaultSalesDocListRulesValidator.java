...
@Component("DefaultSalesDocListRulesValidator")
public class DefaultSalesDocListRulesValidator
		implements DocListRulesValidator<OutwardTransDocument, String> {
	
	private static final Logger LOGGER = 
			LoggerFactory.getLogger(DefaultSalesDocListRulesValidator.class);
