...
import com.ey.advisory.core.search.SearchCriteria;
	...
	@Service("AspB2CSSectionReportServiceImpl")
	public class AspB2CSSectionReportServiceImpl
			implements Gstr1ReviewSummReportsService {

		private static final Logger LOGGER = LoggerFactory
				.getLogger(AspB2CSSectionReportServiceImpl.class);

		@Autowired
		CommonUtility commonUtility;

		@Autowired
		@Qualifier("AspSecB2CSSavableTotalSummaryDaoImpl")
		private Gstr1ASPB2CSSavableTotalDao gstr1ASPB2CSSavableTotalDao;

		@Autowired
		@Qualifier("AspSecSectionReportDaoImpl")
		private Gstr1ASPB2CSSavableTransactionalDao gstr1ASPB2CSSavableTransactionalDao;

		@Autowired
		@Qualifier("AspSecB2CSSavableSummaryLevelDaoImpl")
