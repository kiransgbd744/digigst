...
@Service("SRFileToNilDetailsConvertion")
public class SRFileToNilDetailsConvertion {
	...
	public List<Gstr1NilNonExemptedAsEnteredEntity> convertSRFileToNilExcelDoc(
			List<Object[]> listOfNil, Gstr1FileStatusEntity fileStatus) {

		List<Gstr1NilNonExemptedAsEnteredEntity> listNil = new ArrayList<>();

		for (Object[] obj : listOfNil) {
			Gstr1NilNonExemptedAsEnteredEntity nil = new Gstr1NilNonExemptedAsEnteredEntity();
	...
	public List<Gstr1NilNonExemptedAsEnteredEntity> convertSRFileToNilNonExmpt(
		...
		for (Gstr1NilNonExemptedAsEnteredEntity obj : strProcessRecords) {
			Gstr1NilNonExemptedAsEnteredEntity nil = new Gstr1NilNonExemptedAsEnteredEntity();
			nil.setId(obj.getId());
	...
	public List<Gstr1NilDetailsEntity> convertSRFileToNNE(
			List<Gstr1NilNonExemptedAsEnteredEntity> busProcessRecords,
			Gstr1FileStatusEntity fileStatus) {

		List<Gstr1NilDetailsEntity> listNil = new ArrayList<>();
		String generateExmptKey = null;
		for (Gstr1NilNonExemptedAsEnteredEntity obj : busProcessRecords) {
			Gstr1NilDetailsEntity nil = new Gstr1NilDetailsEntity();
			nil.setSgstin(obj.getSgstin());
			if (fileStatus != null) {
				nil.setFileId(fileStatus.getId());
			}
	...
	public List<Gstr1NilNonExmptSummaryEntity> convertSRFileToNNEToSummary(
			List<Gstr1NilDetailsEntity> busProcessRecords,
			Gstr1FileStatusEntity fileStatus) {

		List<Gstr1NilNonExmptSummaryEntity> listNil = new ArrayList<>();
		String generateExmptKey = null;
		for (Gstr1NilDetailsEntity obj : busProcessRecords) {
			Gstr1NilNonExmptSummaryEntity nil = new Gstr1NilNonExmptSummaryEntity();
			Gstr1NilNonExmptSummaryEntity non = new Gstr1NilNonExmptSummaryEntity();
			Gstr1NilNonExmptSummaryEntity expt = new Gstr1NilNonExmptSummaryEntity();

			Gstr1NilNonExmptSummaryEntity nil1 = new Gstr1NilNonExmptSummaryEntity();
			Gstr1NilNonExmptSummaryEntity non1 = new Gstr1NilNonExmptSummaryEntity();
			Gstr1NilNonExmptSummaryEntity expt1 = new Gstr1NilNonExmptSummaryEntity();

			Gstr1NilNonExmptSummaryEntity nil2 = new Gstr1NilNonExmptSummaryEntity();
			Gstr1NilNonExmptSummaryEntity non2 = new Gstr1NilNonExmptSummaryEntity();
			Gstr1NilNonExmptSummaryEntity expt2 = new Gstr1NilNonExmptSummaryEntity();

			Gstr1NilNonExmptSummaryEntity nil3 = new Gstr1NilNonExmptSummaryEntity();
			Gstr1NilNonExmptSummaryEntity non3 = new Gstr1NilNonExmptSummaryEntity();
			Gstr1NilNonExmptSummaryEntity expt3 = new Gstr1NilNonExmptSummaryEntity();
			...
			expt3.setAsProcessedId(obj.getId());
	         ...
	         if(!GSTConstants.NA.equalsIgnoreCase(obj.getUqc())){
	        	 ...
	        	 generateExmptKey = genearateKey(obj.getSgstin(),
	 					obj.getReturnPeriod(), obj.getHsn(), obj.getDescription(),
	 					(obj.getUqc().equalsIgnoreCase("NA")) ? "OTH":obj.getUqc().toUpperCase());
				}else{
					generateExmptKey = genearateKey(obj.getSgstin(),
							obj.getReturnPeriod(), obj.getHsn(), obj.getDescription(),
							(obj.getUqc().equalsIgnoreCase("NA")) ? "NA":obj.getUqc().toUpperCase());
	...
	public List<Gstr1NilNonExemptedAsEnteredEntity> convertSRFileToNilExcelDocOld(
			List<Object[]> listOfNil, Gstr1FileStatusEntity fileStatus) {
