 ...
 *
 */
@Repository("GetGstr2aAmdhistRepository")
@Transactional(propagation = Propagation.REQUIRED, readOnly = false)
public interface GetGstr2aAmdhistRepository
        extends CrudRepository<GetGstr2aAmdhistHeaderEntity, Long> {

    @Modifying
    @Query("UPDATE GetGstr2aAmdhistHeaderEntity b SET b.isDelete = true ,b.modifiedBy = 'SYSTEM'  , b.modifiedOn =:modifiedOn   WHERE"
    ...
    @Query("SELECT COUNT(*) FROM GetGstr2aAmdhistHeaderEntity "
