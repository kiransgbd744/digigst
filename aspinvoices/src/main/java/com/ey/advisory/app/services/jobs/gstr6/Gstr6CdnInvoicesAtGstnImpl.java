 ...
 *
 */
@Service("Gstr6CdnInvoicesAtGstnImpl")
@Slf4j
public class Gstr6CdnInvoicesAtGstnImpl implements Gstr6InvoicesAtGstn {
	...
	public Long findInvFromGstn(Gstr6GetInvoicesReqDto dto, String groupCode, String type, Long batchId) {
		...
		try {
			...
			throw new APIException("Unexpected error while executing Gstr6 Get Cdn");
