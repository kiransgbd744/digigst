...
@Service("GstrATRespHandler")
public class GstrATRespHandler {
	...
	public JsonElement handleATResp(List<? extends Gstr1SummaryDto> list,
			Gstr1SummaryReqDto gstr1SummaryRequest) {
		
		List<Gstr1BasicSummarySectionDto> atEySummary = new ArrayList<>();
		for (Gstr1SummaryDto gstr1Summary : list) {
			atEySummary = gstr1Summary.getAt().getEySummary();
		}
...
*/				/**
				...
				JsonElement atRespBody = gstr1SummaryStructure
				.atStructure(atEySummary,gstnList);
