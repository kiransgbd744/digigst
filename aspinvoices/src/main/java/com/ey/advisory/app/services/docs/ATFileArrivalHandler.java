...
@Service("ATFileArrivalHandler")
@Slf4j
public class ATFileArrivalHandler {
	...
	@Autowired
	@Qualifier("Gstr1ARStructuralProcess")
	private Gstr1ARStructuralProcess gstr1ARStructuralProcess;
