...
public class Gstr2GetGstr2BIsdaHeaderEntity {

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "GETGSTR2B_ISDA_HEADER_SEQ", allocationSize = 100)
	...
	protected Gstr2GetGstr2BIsdaItemEntity lineItems;
}
