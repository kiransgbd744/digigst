...
import com.google.common.base.Strings;
	...
	@Component("AspEXPSectionReportDaoImpl")
	public class AspEXPSectionReportDaoImpl implements Gstr1ReviewSummaryReportsDao {

		private static final Logger LOGGER = LoggerFactory.getLogger(AspEXPSectionReportDaoImpl.class);
		...
		private String createApiProcessedQueryString(String buildHeader) {
			...
			return "SELECT TRIM(', ' FROM IFNULL(HDR.ERROR_CODES,'') ||','|| "
					...
					+ "AND HDR.RETURN_TYPE='GSTR1' AND HDR.TAX_DOC_TYPE IN ('EXPORTS') " + buildHeader
