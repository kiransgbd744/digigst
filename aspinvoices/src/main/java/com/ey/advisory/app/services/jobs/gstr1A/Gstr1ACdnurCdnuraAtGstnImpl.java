...
@Slf4j
@Component("gstr1ACdnurCdnuraAtGstnImpl")
public class Gstr1ACdnurCdnuraAtGstnImpl implements Gstr1InvoicesAtGstn {

	@Autowired
	@Qualifier("gstr1ACdnurCdnuraDataAtGstnImpl")
	Gstr1ACdnurCdnuraDataAtGstnImpl gstr1ACdnurCdnuraDataAtGstnImpl;
	...
	public Long findInvFromGstn(Gstr1GetInvoicesReqDto dto,
		...
		try {
			...
			reqId = gstr1ACdnurCdnuraDataAtGstnImpl
			...
			throw new APIException(
					"Unexpected error while executing Gstr1A Get Cdnur/Cdnura");
