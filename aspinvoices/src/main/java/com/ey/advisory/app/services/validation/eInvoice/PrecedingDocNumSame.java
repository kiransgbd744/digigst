 ...
 *
 */
@Component("PrecedingDocNumSame")
public class PrecedingDocNumSame implements DocRulesValidator<OutwardTransDocument> {
			...
			if (!isValidTax(item, items.get(idx))) {
				...
				errors.add(
						new ProcessingResult(APP_VALIDATION, "ER0040",
								" Preceeding Invoice Number should be same across "
