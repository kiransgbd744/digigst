...
@Service("Gstr1aRateReportServiceImpl")
public class Gstr1aRateReportServiceImpl
		implements Gstr1AGstnErrorReportService {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(Gstr1aRateReportServiceImpl.class);
	...
	@Autowired
	@Qualifier("Gstr1aRateHsnSummaryTablesDaoImpl")
