...
@Repository("Gstr2GetGstr2BCdnraHeaderRepository")
@Transactional(propagation = Propagation.REQUIRED, readOnly = false)
public interface Gstr2GetGstr2BCdnraHeaderRepository
		extends CrudRepository<Gstr2GetGstr2BCdnraHeaderEntity, Long>,
		JpaSpecificationExecutor<Gstr2GetGstr2BCdnraHeaderEntity> {

	@Modifying
	@Query("UPDATE Gstr2GetGstr2BCdnraHeaderEntity b SET b.isDelete = true, "
	...
	@Modifying
	@Query("UPDATE Gstr2GetGstr2BCdnraHeaderEntity b SET b.status = 'SAVED', "
	...
	@Query("from Gstr2GetGstr2BCdnraHeaderEntity where docKey=:docKey")
	List<Gstr2GetGstr2BCdnraHeaderEntity> findByInvoiceKey(
			@Param("docKey") String docKey);

	@Modifying
	@Query("UPDATE Gstr2GetGstr2BCdnraHeaderEntity b SET b.isDelete = true, b.modifiedOn =:modifiedOn  WHERE"
			+ " b.isDelete = FALSE AND b.id IN (:totalIds)")
	void updateSameRecords(@Param("totalIds") List<Long> partion,
			@Param("modifiedOn") LocalDateTime modifiedOn);

	@Query("SELECT COUNT(1) FROM Gstr2GetGstr2BCdnraHeaderEntity where "
