...
@AllArgsConstructor
@Entity
@Table(name = "GETGSTR2B_LINKING_B2B_HEADER")
public class Gstr2GetGstr2BLinkingB2bHeaderEntity {

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "GETGSTR2B_B2B_HEADER_SEQ", allocationSize = 100)
	...
	protected List<Gstr2GetGstr2BLinkingB2bItemEntity> lineItems = new ArrayList<>();
}
