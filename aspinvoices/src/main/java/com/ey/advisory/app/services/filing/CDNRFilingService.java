 ...
 *
 */
@Service("CDNRFilingService")
public class CDNRFilingService implements FilingService {
	...
	public B2BFilingDto getFilingData(String gstin, String returnPeriod) {
		...
		List<Object[]> doc = docRepository
				.getCdnrData(returnPeriod, gstin);
