 ...
 *
 */
@Repository("Gstr1GetB2claGstnRepository")
@Transactional(propagation = Propagation.REQUIRED, readOnly = false)
public interface Gstr1GetB2claGstnRepository
		extends CrudRepository<GetGstr1B2claHeaderEntity, Long> {
	@Modifying
	@Query("UPDATE GetGstr1B2claHeaderEntity b SET b.isDelete = true,b.modifiedBy = 'SYSTEM'  , b.modifiedOn =:modifiedOn   WHERE"
	...
	@Query("SELECT COUNT(*) FROM GetGstr1B2claHeaderEntity "
