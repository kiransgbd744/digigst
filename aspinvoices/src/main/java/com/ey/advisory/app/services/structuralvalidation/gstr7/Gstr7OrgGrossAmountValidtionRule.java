 ...
 *
 */
public class Gstr7OrgGrossAmountValidtionRule implements ValidationRule {
	...
	public List<ProcessingResult> isValid(int idx, Object obj, Object[] row,
		...
		if (!isDecimal(obj.toString().trim())) {
			...
			errors.add(new ProcessingResult(APP_VALIDATION, "ER2009",
					"Invalid Original Gross Amount.", location));
		...
		if (result.compareTo(BigDecimal.ZERO) < 0) {
			...
			errors.add(new ProcessingResult(APP_VALIDATION, "ER2010",
					"Only Positive amount allowed.", location));
			return errors;
		}
		return errors;
	}
