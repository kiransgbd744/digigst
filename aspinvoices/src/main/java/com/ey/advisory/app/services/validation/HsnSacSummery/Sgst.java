...
public class Sgst implements B2csBusinessRuleValidator<Gstr1HsnFileUploadEntity> {
	 ...
	 private static DecimalFormat df = new DecimalFormat("0.00");
		...
		public List<ProcessingResult> validate(Gstr1HsnFileUploadEntity document, ProcessingContext context) {
			...
			if(document.getSgst()!=null){
				
			document.setSgst(new BigDecimal(df.format(document.getSgst())));
