...
@Component("Gstr1OutwardVerticalProcessAdvAdjDaoImpl")
public class Gstr1OutwardVerticalProcessAdvAdjDaoImpl
		implements Gstr1OutwardVerticalProcessAdvAdjDao {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(Gstr1OutwardVerticalProcessAdvAdjDaoImpl.class);
