 ...
 *
 */
@Component("Table3H3IHeaderCheckService")
public class Table3H3IHeaderCheckService implements Gstr1HeaderCheckService {
	@Autowired
	...
	public static final String[] EXPECTED_HEADERS = { "ReturnType",
			"RecipientGSTIN", "ReturnPeriod", "TransactionFlag",
			"SupplierGSTINorPAN", "SupplierName", "DifferentialPercentageFlag",
			"Section7ofIGSTFlag", "AutopopulatetoRefund", "POS", "HSNorSAC",
			"TaxableValue", "Rate", "IntegratedTaxAmount", "CentralTaxAmount",
			"StateUTTaxAmount", "CessAmount", "TotalValue",
			"EligibilityIndicator", "AvailableIGST", "AvailableCGST",
			"AvailableSGST", "AvailableCess", "ProfitCentre", "Plant",
			"Division", "Location", "PurchaseOrganisation", "UserAccess1",
