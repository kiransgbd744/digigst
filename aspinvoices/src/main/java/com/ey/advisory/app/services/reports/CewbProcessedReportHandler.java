 ...
 *
 */
@Component("CewbProcessedReportHandler")
public class CewbProcessedReportHandler {
	@Autowired
	@Qualifier("CewbProcessReportsServiceImpl")
	private Gstr1VerticalReportsService gstr1VerticalReportsService;

	public Workbook downloadCewbProcessedReport(
