...
@Service("Gstr1ASPInvSavableServiceImpl")
public class Gstr1ASPInvSavableServiceImpl
		implements Gstr1ASPInvSavableService {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(Gstr1ASPInvSavableServiceImpl.class);

	@Autowired
	CommonUtility commonUtility;

	@Autowired
	@Qualifier("Gstr1ASPInvSavableDaoImpl")
