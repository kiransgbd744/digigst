 ...
 * 
 */
@Component("ITC04ConsolidatedGstnRefidReportDaoImpl")
public class ITC04ConsolidatedGstnRefidReportDaoImpl {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(ITC04ConsolidatedGstnRefidReportDaoImpl.class);
	...
	public List<ItcTotalRecords> getRefidReport(
