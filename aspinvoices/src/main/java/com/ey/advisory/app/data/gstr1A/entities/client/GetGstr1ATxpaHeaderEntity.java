...
@Entity
@Table(name = "GETGSTR1A_TXPA_HEADER")
public class GetGstr1ATxpaHeaderEntity {

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "GETGSTR1_TXPA_HEADER_SEQ", allocationSize = 100)
	...
	protected List<GetGstr1ATxpaItemEntity> lineItems = new ArrayList<>();
	...
	public List<GetGstr1ATxpaItemEntity> getLineItems() {
		return lineItems;
	}

	public void setLineItems(List<GetGstr1ATxpaItemEntity> lineItems) {
