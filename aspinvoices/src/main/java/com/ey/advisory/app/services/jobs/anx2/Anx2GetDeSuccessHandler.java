 ...
 *
 */
@Service("Anx2GetDeSuccessHandler")
@Slf4j
public class Anx2GetDeSuccessHandler implements SuccessHandler {

	@Autowired
	@Qualifier("Anx2DeDataParserImpl")
	private Anx2DeDataParser anx2DataParser;
	...
	@Autowired
	private GetAnx2DeInvoicesRepository headerRepo;
	...
	public void handleSuccess(SuccessResult result, String apiParams) {
		try {
			...
			if (LOGGER.isDebugEnabled()) {
				LOGGER.debug(
						"GET Call is Success for the batchId {} inside Anx2GetDeSuccessHandler.java",
