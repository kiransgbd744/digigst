 ...
 */
@Entity
@Table(name = "GETANX1_B2C_ITEM")
public class GetAnx1B2cInvoicesItemEntity {
	...
	protected GetAnx1B2cInvoicesHeaderEntity header;
	...
	public GetAnx1B2cInvoicesHeaderEntity getHeader() {
		return header;
	}

	public void setHeader(GetAnx1B2cInvoicesHeaderEntity header) {
		this.header = header;
	}
