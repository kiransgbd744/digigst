 ...
 */
	...
	@Service("ITC04AspProcessSavableServiceImpl")
	public class ITC04AspProcessSavableServiceImpl {

		private static final Logger LOGGER = LoggerFactory
				.getLogger(ITC04AspProcessSavableServiceImpl.class);

		@Autowired
		CommonUtility commonUtility;

		@Autowired
		@Qualifier("ITC04AspProcessSavableReportDaoImpl")
		private ITC04AspProcessSavableReportDaoImpl iTC04AspProcessSavableReportDaoImpl;


		public Workbook findAspSavable(Gstr6SummaryRequestDto setDataSecurity,
				PageRequest pageReq) {
			...
			responseFromView = iTC04AspProcessSavableReportDaoImpl
					.getAspUploadedReport(request);
			workbook = createWorkbookWithExcelTemplate("ReportTemplates",
					"ITC04AspSavableRecords.xlsx");
