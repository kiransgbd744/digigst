 ...
 *
 */
@Component("Gstr3bBusinessValidationChain")
public class Gstr3bBusinessValidationChain 
                   implements DocRulesValidatorChain<Gstr3bExcelEntity> {
	private static final Logger LOGGER = 
			LoggerFactory.getLogger(Gstr3bBusinessValidationChain.class);
...
private static final BusinessRuleValidator[] VALIDATORS = {
		new Gstr3bTaxpayeGstin(),
		new Gstr3bReturnPeriod(),
		new Gstr3bDescription(),
		new Gstr3bIgst(),
		new Gstr3bCgst(),
		new Gstr3bSgst(),
		new Gstr3bCess(),
		new Gstr3BSerialNoAndDes()
...
public List<ProcessingResult> validate(Gstr3bExcelEntity document,
	...
	for(BusinessRuleValidator<Gstr3bExcelEntity> 
