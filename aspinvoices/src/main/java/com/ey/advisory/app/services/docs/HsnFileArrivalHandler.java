...
import com.ey.advisory.app.services.gstr1fileupload.Gstr1HsnStructuralProcess;
import com.ey.advisory.app.services.validation.HsnSacSummery.HsnSacValidationChain;
 ...
 *
 */
@Service("HsnFileArrivalHandler")
@Slf4j
public class HsnFileArrivalHandler {
	...
	@Autowired
	@Qualifier("Gstr1HsnStructuralProcess")
	private Gstr1HsnStructuralProcess gstr1HsnStructuralProcess;
