 ...
 */
@Entity
@Table(name = "GETGSTR6_CREDIT_MISMATCH")
@Data
public class Getgstr6CreditMisMatchEntity {
	...
	@Column(name = "IS_CREDIT_MISMATCH")
	private boolean isCreditMissMAtch;
	
	@Column(name = "IS_CREDIT_RECLAIMED")
	private boolean isCreditReclimed;
