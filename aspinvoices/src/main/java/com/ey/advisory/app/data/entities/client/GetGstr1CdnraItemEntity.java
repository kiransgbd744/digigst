...
@Entity
@Table(name = "GETGSTR1_CDNRA_ITEM")
public class GetGstr1CdnraItemEntity {
	...
	private GetGstr1CdnraHeaderEntity document;
	...
	public GetGstr1CdnraHeaderEntity getDocument() {
		return document;
	}

	public void setDocument(GetGstr1CdnraHeaderEntity document) {
