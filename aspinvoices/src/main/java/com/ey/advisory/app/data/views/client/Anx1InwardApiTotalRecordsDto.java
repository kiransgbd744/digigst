...
public class Anx1InwardApiTotalRecordsDto {
	...
	public String toString() {
		return "Anx1InwardApiTotalRecordsDto [UserID=" + UserID
				...
				+ ", ASPErrorDescription=" + ASPErrorDescription
				+ ", ReturnType=" + ReturnType + ", DataCategory="
				+ DataCategory + ", TableNumber=" + TableNumber
				+ ", ASPInformationID=" + ASPInformationID
				+ ", ASPInformationDescription=" + ASPInformationDescription
				+ ", RecordStatus=" + RecordStatus + ", InvoiceValueAsp="
				+ InvoiceValueAsp + "]";
	}
