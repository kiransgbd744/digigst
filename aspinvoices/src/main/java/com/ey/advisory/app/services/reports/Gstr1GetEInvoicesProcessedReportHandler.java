 ...
 *
 */
@Component("Gstr1GetEInvoicesProcessedReportHandler")
public class Gstr1GetEInvoicesProcessedReportHandler {
	@Autowired
	@Qualifier("Gstr1GetEInvoicesProcessedServiceImpl")
	private Gstr1GetEInvoicesProcessedReportsService gstr1GetEInvoicesProcessedReportsService;

	public Workbook downloadProcessedReport(Gstr1EInvReportsReqDto criteria) {
