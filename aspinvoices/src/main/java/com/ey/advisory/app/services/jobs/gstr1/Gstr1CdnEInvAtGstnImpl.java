 ...
 *
 */
@Service("Gstr1CdnEInvAtGstnImpl")
@Slf4j
public class Gstr1CdnEInvAtGstnImpl implements Gstr1InvoicesAtGstn {
	...
	public Long findInvFromGstn(Gstr1GetInvoicesReqDto dto, String groupCode, String type, Long batchId) {
		if (LOGGER.isDebugEnabled()) {
			LOGGER.debug("I am from findCDNRFromGstn Method type: {}", type);
		}
		...
		try {
			...
			throw new APIException("Unexpected error while executing Gstr1 Get Cdnr");
		}
		return reqId;
	}
