package com.ey.advisory.config;
...
@Configuration
@EnableAsync
public class SpringConfigAspInvoices {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(SpringConfigAspInvoices.class);

	@Autowired
	@Qualifier("PropertyLoader")
	private ProfilePropsLoader profilePropsLoader;

	@Bean("VendorEmailPool")
	public ThreadPoolTaskExecutor getProcessTokenURLPool() {
		...
		executor.setThreadNamePrefix("VendorEmailPool-");
		executor.initialize();
		return executor;
	}
