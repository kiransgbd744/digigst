...
@Data
@Entity
@Table(name = "TBL_180_DAYS_REVERSAL_ERR")
public class Reversal180DaysErrorEntity {

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "TBL_180_DAYS_REVERSAL_ERR_SEQ", allocationSize = 100)
