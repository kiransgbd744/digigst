...
@Data
@Entity
@Table(name = "TBL_180_DAYS_REV_RESP_STG")
public class Reversal180DaysResponseStageEntity {

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "TBL_180_DAYS_REV_RESP_STG_SEQ", allocationSize = 100)
