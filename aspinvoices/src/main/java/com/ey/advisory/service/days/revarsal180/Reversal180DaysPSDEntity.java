...
@Data
@Entity
@Table(name = "TBL_180_DAYS_REVERSAL_PSD")
public class Reversal180DaysPSDEntity {

	@Id
	@SequenceGenerator(name = "sequence", sequenceName = "TBL_180_DAYS_REVERSAL_PSD_SEQ", allocationSize = 100)
	...
	private BigDecimal statutoryDeductionAmount;

	@Column(name = "ANY_OTHER_DEDUCTION_AMT")
	private BigDecimal anyOtherDeductionAmount;
	...
	private BigDecimal paidAmounttoSupplier;
	...
	private BigDecimal unpaidAmounttoSupplier;
