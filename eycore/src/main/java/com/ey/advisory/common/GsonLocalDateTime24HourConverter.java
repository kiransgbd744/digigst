...
public class GsonLocalDateTime24HourConverter implements
	...
	public JsonElement serialize(LocalDateTime src, Type typeOfSrc,
		...
		try {
			return new JsonPrimitive(FORMATTER2.format(src));
		} catch (Exception e) {

		}
		try {
			return new JsonPrimitive(FORMATTER3.format(src));
		} catch (Exception e) {

		}
		try {
			return new JsonPrimitive(FORMATTER4.format(src));
		} catch (Exception e) {

		}
		try {
			return new JsonPrimitive(FORMATTER5.format(src));
		} catch (Exception e) {

		}
		try {
			return new JsonPrimitive(FORMATTER6.format(src));
		} catch (Exception e) {

		}
		try {
			return new JsonPrimitive(FORMATTER7.format(src));
		} catch (Exception e) {

		}
		throw new AppException(
				"Exception Occured while serializing date : " + src);
	}
	...
	public LocalDateTime deserialize(JsonElement json, Type typeOfT,
		...
		try {
			return LocalDateTime.parse(json.getAsString(), FORMATTER3);
		} catch (Exception e) {
