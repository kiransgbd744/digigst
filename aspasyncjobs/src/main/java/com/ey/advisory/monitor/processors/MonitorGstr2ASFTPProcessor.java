...
import com.ey.advisory.app.sftp.service.GSTR2ASFTPHandler;
 ...
 *
 */
@Component("MonitorGstr2ASFTPProcessor")
@Slf4j
public class MonitorGstr2ASFTPProcessor
		extends DefaultMultiTenantTaskProcessor {

	@Autowired
	private GSTR2ASFTPHandler srFileArrivalHandler;
