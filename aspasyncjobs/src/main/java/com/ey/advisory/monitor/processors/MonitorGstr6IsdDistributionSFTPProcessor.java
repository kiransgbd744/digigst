...
import com.ey.advisory.app.sftp.service.GSTR6IsdDistributionSFTPHandler;
 ...
 *
 */
@Component("MonitorGstr6IsdDistributionSFTPProcessor")
@Slf4j
public class MonitorGstr6IsdDistributionSFTPProcessor
		extends DefaultMultiTenantTaskProcessor {

	@Autowired
	private GSTR6IsdDistributionSFTPHandler srFileArrivalHandler;
