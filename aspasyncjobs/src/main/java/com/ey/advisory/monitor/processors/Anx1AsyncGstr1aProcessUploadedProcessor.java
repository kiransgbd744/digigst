...
@Slf4j
@Service("Anx1AsyncGstr1aProcessUploadedProcessor")
public class Anx1AsyncGstr1aProcessUploadedProcessor implements TaskProcessor {

	@Autowired
	FileStatusDownloadReportRepository fileStatusDownloadReportRepo;

	@Autowired
	@Qualifier("AsyncProcessedGstr1aReportDownloadServiceImpl")
