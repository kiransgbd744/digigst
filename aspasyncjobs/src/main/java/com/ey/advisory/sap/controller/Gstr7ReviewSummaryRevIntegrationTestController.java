...
@RestController
@Slf4j
public class Gstr7ReviewSummaryRevIntegrationTestController {


	@Autowired
	private Gstr7ReviewSummaryReqRevIntegrationHandler handler;

	@PostMapping(value = "/ui/gstr7ReviewSummaryRequestToErp", produces = {
	...
	public ResponseEntity<String> reviewSummaryRequestToErp(
		...
		try {
			...
			String destinationName = APIConstants.ERP_GSTR7_REVIEW_AND_PROCESSED_SUMMARY;
