...
@Slf4j
@RestController
public class Gstr6SaveCrossITCDetailsTestController {
	...
	@PostMapping(value = "/gstr6SaveCrossItc",  produces = {
	...
	public void submitRefIdStatus(@RequestBody String jsonString) {
		...
		if (jsonString != null && groupCode != null) {
			try {
				gstr6JobHandler.saveCrossItc(jsonString, groupCode, APIConstants.SYSTEM);
				LOGGER.info(
