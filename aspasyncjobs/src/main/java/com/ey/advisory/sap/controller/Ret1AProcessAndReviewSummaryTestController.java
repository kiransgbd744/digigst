 ...
 */
@RestController
public class Ret1AProcessAndReviewSummaryTestController {

	private static Logger LOGGER = LoggerFactory
			.getLogger(Ret1AProcessAndReviewSummaryTestController.class);

	@Autowired
	@Qualifier("Ret1ProcessReviewSummaryHandler")
	private Ret1ProcessReviewSummaryHandler handler;

	@PostMapping(value = "/ret1AProcessAndReviewSummary", produces = {
			MediaType.APPLICATION_JSON_VALUE })
	public ResponseEntity<String> ret1AProcessAndReviewSummary(
		...
		try {
			...
			String destinationName = APIConstants.ERP_RET1A_REVIEW_AND_PROCESSED_SUMMARY;
			...
			if (groupcode != null && destinationName != null
				...
				Integer respcode = handler.processReviewSummryToErp(reqDto,"RET1");
