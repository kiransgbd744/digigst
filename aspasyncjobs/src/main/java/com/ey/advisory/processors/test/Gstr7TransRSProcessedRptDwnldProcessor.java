...
@Slf4j
@Component("Gstr7TransRSProcessedRptDwnldProcessor")
public class Gstr7TransRSProcessedRptDwnldProcessor implements TaskProcessor {

	@Autowired
	FileStatusDownloadReportRepository fileStatusDownloadReportRepo;

	@Autowired
	@Qualifier("Gstr7TransRSProcessedRptDwnldServiceImpl")
		...
		try {
			...
			if (LOGGER.isDebugEnabled()) {
				String msg = String.format(
						"Gstr7TransRSProcessedRptDwnldProcessor Download Job"
			...
			String msg = String.format(
					"Exception in Gstr7TransRSProcessedRptDwnldProcessor");
			LOGGER.error(msg, e);
