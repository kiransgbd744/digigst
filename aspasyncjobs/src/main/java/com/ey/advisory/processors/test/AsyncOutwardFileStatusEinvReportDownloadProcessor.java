...
@Slf4j
@Service("AsyncOutwardFileStatusEinvReportDownloadProcessor")
public class AsyncOutwardFileStatusEinvReportDownloadProcessor
	...
	@Autowired
	@Qualifier("AsyncOutwardFileStatusEinvReportDownloadServiceImpl")
