 ...
 *
 */
@Component("ComprehensiveEinvoiceFileArrivalProcessor")
@Slf4j
public class ComprehensiveEinvoiceFileArrivalProcessor
		implements TaskProcessor {

	@Autowired
	@Qualifier("ComprehensiveSRFileArrivalHandler")
	private ComprehensiveSRFileArrivalHandler srFileArrivalHandler;
