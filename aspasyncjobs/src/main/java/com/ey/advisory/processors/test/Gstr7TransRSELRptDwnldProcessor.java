...
@Slf4j
@Component("Gstr7TransRSELRptDwnldProcessor")
public class Gstr7TransRSELRptDwnldProcessor implements TaskProcessor {
		...
		try {
			...
			if (LOGGER.isDebugEnabled()) {
				String msg = String.format(
						"Gstr7TransRSELRptDwnldProcessor Download Job"
			...
			String msg = String.format(
					"Exception in Gstr7TransRSELRptDwnldProcessor");
			LOGGER.error(msg, e);
