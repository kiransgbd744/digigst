...
@Slf4j
@Service("ConsolidatedSupplierImsReportProcessor")
public class ConsolidatedSupplierImsReportProcessor implements TaskProcessor {
	...
	@Autowired
	@Qualifier("ConsolidatedSupplierImsAsyncReportServiceImpl")
		...
		try {
			...
			if (LOGGER.isDebugEnabled()) {
				String msg = String.format(
						"Inside Einvoice Summary Async Report Download processor with Report id : %d",
						id);
				LOGGER.debug(msg);
			}
