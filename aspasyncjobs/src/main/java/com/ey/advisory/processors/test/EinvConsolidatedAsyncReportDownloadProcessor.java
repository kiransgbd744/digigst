 ...
 */
@Slf4j
@Service("EinvConsolidatedAsyncReportDownloadProcessor")
public class EinvConsolidatedAsyncReportDownloadProcessor
	...
	@Autowired
	@Qualifier("EinvReconAsyncReportDownloadServiceImpl")
	...
	public void execute(Message message, AppExecContext context) {
		...
		if (LOGGER.isDebugEnabled()) {
			String msg = String.format(
					"Inside Einvoice Consolidated Async Report Download processor with Report id : %d",
					id);
			LOGGER.debug(msg);
		}
