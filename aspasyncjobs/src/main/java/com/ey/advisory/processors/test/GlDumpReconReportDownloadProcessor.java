...
@Slf4j
@Service("GlDumpReconReportDownloadProcessor")
public class GlDumpReconReportDownloadProcessor implements TaskProcessor {

	@Autowired
	FileStatusDownloadReportRepository fileStatusDownloadReportRepo;

	@Autowired
	@Qualifier("GlReconDumpAsyncReportDownloadServiceImpl")
