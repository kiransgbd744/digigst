...
import com.ey.advisory.app.services.search.filestatussearch.Drc01CommReportDownloadService;
...
@Slf4j
@Component("Drc01bCommReportDownloadProcessor")
public class Drc01bCommReportDownloadProcessor implements TaskProcessor {
	...
	@Autowired
	@Qualifier("Drc01bCommDownloadSummaryServiceImpl")
	private Drc01CommReportDownloadService asyncReportDownloadService;
	...
	public void execute(Message message, AppExecContext context) {
		...
		try {
			...
			drc01AutoGetCallDetailsRepo.updateStatus(ReportStatusConstants.REPORT_GENERATION_INPROGRESS,id,LocalDateTime.now());
