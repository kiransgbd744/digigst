...
@Slf4j
@Component("Drc01cReportDownloadProcessor")
public class Drc01cReportDownloadProcessor implements TaskProcessor {

	@Autowired
	FileStatusDownloadReportRepository fileStatusDownloadReportRepo;

	@Autowired
	@Qualifier("AsyncDrc01cDownloadSummaryServiceImpl")
	...
	public void execute(Message message, AppExecContext context) {
		...
		try {
			...
			String msg = String.format(
					"Exception occured during Drc01c Summary report generation.");
			LOGGER.error(msg, ex);
