...
@Slf4j
@Service("AsyncGstr6ProcessedReportDownloadProcessor")
public class AsyncGstr6ProcessedReportDownloadProcessor
	...
	@Autowired
	@Qualifier("AsyncGstr6ProcessReportDownloadServiceImpl")
