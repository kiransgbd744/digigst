...
import com.ey.advisory.app.services.search.filestatussearch.MainClassGstr2APopUp;
/*import com.ey.advisory.app.services.search.filestatussearch.MainClassGstr2APopUp;*/
...
@Slf4j
@Service("AsyncGstr2aPopUpReportDownloadProcessor")
public class AsyncGstr2aPopUpReportDownloadProcessor
    ...
    @Autowired
	@Qualifier("MainClassGstr2APopUp")
	MainClassGstr2APopUp mainClassGstr2APopUp;
	@Override
	public void execute(Message message, AppExecContext context) {
		...
		try {
			...
			mainClassGstr2APopUp.generateReports(id);
