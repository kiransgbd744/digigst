...
@Slf4j
@Service("Gstr2ProcessedReconTypeTaggingReportProcessor")
public class Gstr2ProcessedReconTypeTaggingReportProcessor
	...
	public void execute(Message message, AppExecContext context) {
		...
		if (LOGGER.isDebugEnabled()) {
			String msg = String.format(
					"Inside Gstr2ProcessedReconTypeTaggingReportProcessor"
							+ " with Report id : %d",
					id);
			LOGGER.debug(msg);
		}
		...
		try {
			...
			String msg = "Gstr2ProcessedReconTypeTaggingReportProcessor - "
