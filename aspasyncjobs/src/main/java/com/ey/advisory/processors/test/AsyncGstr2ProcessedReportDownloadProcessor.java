...
import lombok.extern.slf4j.Slf4j;
	...
	@Slf4j
	@Service("AsyncGstr2ProcessedReportDownloadProcessor")
	public class AsyncGstr2ProcessedReportDownloadProcessor implements TaskProcessor {

		@Autowired
		FileStatusDownloadReportRepository fileStatusDownloadReportRepo;

		@Autowired
		@Qualifier("AsyncGstr2ProcessedReportDownloadServiceImpl")
