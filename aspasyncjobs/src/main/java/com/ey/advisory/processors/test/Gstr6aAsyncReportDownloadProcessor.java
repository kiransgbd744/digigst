...
@Slf4j
@Service("Gstr6aAsyncReportDownloadProcessor")
public class Gstr6aAsyncReportDownloadProcessor implements TaskProcessor {

	@Autowired
	FileStatusDownloadReportRepository fileStatusDownloadReportRepo;

	@Autowired
	@Qualifier("Gstr6aAsyncReportDownloadServiceImpl")
	...
	public void execute(Message message, AppExecContext context) {
		...
		if (LOGGER.isDebugEnabled()) {
			String msg = String.format(
					"Inside Gstr6a Async Report Download processor with Report id : %d",
					id);
			LOGGER.debug(msg);
		}
