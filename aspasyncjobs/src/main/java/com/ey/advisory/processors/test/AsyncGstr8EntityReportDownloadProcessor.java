...
@Slf4j
@Service("AsyncGstr8EntityReportDownloadProcessor")
public class AsyncGstr8EntityReportDownloadProcessor implements TaskProcessor {

	@Autowired
	FileStatusDownloadReportRepository fileStatusDownloadReportRepo;

	@Autowired
	@Qualifier("AsyncGstr8EntityReportDownloadServiceImpl")
