 ...
 */
@Slf4j
@Component("GSTR2AResponseUploadProcessor")
public class GSTR2AResponseUploadProcessor implements TaskProcessor {
	...
	@Autowired
	@Qualifier("GSTR2AAutoReconRespUploadServiceImpl")
