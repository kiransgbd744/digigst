 ...
 */
@Slf4j
@Service("Gstr1StockTransferAsyncReportProcessor")
public class Gstr1StockTransferAsyncReportProcessor implements TaskProcessor {

	@Autowired
	FileStatusDownloadReportRepository fileStatusDownloadReportRepo;

	@Autowired
	@Qualifier("StockTransferAsyncReportServiceImpl")
		...
		try {
			...
			if (LOGGER.isDebugEnabled()) {
				String msg = String.format(
						"Inside StockTransfer Async Report Download processor with Report id : %d",
						id);
				LOGGER.debug(msg);
			}
