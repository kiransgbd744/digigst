 ...
 */
@Slf4j
@Service("EinvoiceDetailedLineItemReportProcessor")
public class EinvoiceDetailedLineItemReportProcessor implements TaskProcessor {
	...
	@Autowired
	@Qualifier("EinvoiceDetailedLineItemAsyncReportServiceImpl")
		...
		try {
			...
			if (LOGGER.isDebugEnabled()) {
				String msg = String.format(
						"Inside Einvoice Detailed Line Item Async Report Download processor with Report id : %d",
						id);
				LOGGER.debug(msg);
			}
