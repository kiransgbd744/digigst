 ...
 */
@Slf4j
@Service("AsyncGstr2aFYConsolidatedReportDownloadProcessor")
public class AsyncGstr2aFYConsolidatedReportDownloadProcessor
	...
	@Autowired
	@Qualifier("AsyncGstr2aFYProcessReportDownloadServiceImpl")
