...
import com.ey.advisory.app.services.reports.Gstr1AB2BSectionReportHandler;
 ...
 */
@Slf4j
@Service("GSTR1ASectionWiseReportDownloadProcessor")
public class GSTR1ASectionWiseReportDownloadProcessor implements TaskProcessor {

	@Autowired
	FileStatusDownloadReportRepository fileStatusDownloadReportRepo;
	
	@Autowired
	@Qualifier("Gstr1AB2BSectionReportHandler")
	private Gstr1AB2BSectionReportHandler gstr1B2BSectionReportHandler;


	/*
	 * @Autowired
	 * 
	 * @Qualifier("Gstr1B2BSectionReportHandler") private
	 * Gstr1B2BSectionReportHandler gstr1B2BSectionReportHandler;
	 */
	...
	public void execute(Message message, AppExecContext context) {
		...
		if (LOGGER.isDebugEnabled()) {
			String msg = String.format(
					"Inside GSTR1ASectionWiseReportDownloadProcessor : %s",
					criteria.toString());
			LOGGER.debug(msg);
		}
		...
		if (LOGGER.isDebugEnabled()) {
			String msg = String.format(
					"Inside GSTR1ASectionWiseReportDownloadProcessor with Report id : %d",
					id);
			LOGGER.debug(msg);
		}
