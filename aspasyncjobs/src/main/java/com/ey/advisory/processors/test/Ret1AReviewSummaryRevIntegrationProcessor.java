 ...
 *
 */
@Service("Ret1AReviewSummaryRevIntegrationProcessor")
public class Ret1AReviewSummaryRevIntegrationProcessor implements TaskProcessor {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(Ret1AReviewSummaryRevIntegrationProcessor.class);
	@Autowired
	...
	public void execute(Message message, AppExecContext context) {
		...
		if (groupcode != null && destinationName != null && entityId != null
				&& gstin != null) {
			Integer respCode = handler.processReviewSummryToErp(dto,"RET1A");
