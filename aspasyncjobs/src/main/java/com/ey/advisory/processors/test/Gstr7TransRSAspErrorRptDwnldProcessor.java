...
@Slf4j
@Component("Gstr7TransRSAspErrorRptDwnldProcessor")
public class Gstr7TransRSAspErrorRptDwnldProcessor implements TaskProcessor {

	@Autowired
	FileStatusDownloadReportRepository fileStatusDownloadReportRepo;

	@Autowired
	@Qualifier("Gstr7TransRSAspErrorRptDwnldServiceImpl")
		...
		try {
			...
			if (LOGGER.isDebugEnabled()) {
				String msg = String.format(
						"Gstr7TransRSAspErrorRptDwnldProcessor Download Job"
			...
			String msg = String.format(
					"Exception in Gstr7TransRSAspErrorRptDwnldProcessor");
			LOGGER.error(msg, e);
