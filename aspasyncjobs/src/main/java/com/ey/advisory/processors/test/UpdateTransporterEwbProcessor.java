 ...
 */
@Slf4j
@Service("UpdateTransporterEwbProcessor")
public class UpdateTransporterEwbProcessor implements TaskProcessor{
	...
	public void execute(Message message, AppExecContext context) {
		...
		UpdateEWBTransporterReqDto req = gson.fromJson(reqObj,
		...
		ewbService.updateTransporter(req, req.getGstin(), updateDb, erpPush);
