 ...
 */
	...
	@Slf4j
	@Service("Gstr2ConsolidatedDigistErrorReportProcessor")
	public class Gstr2ConsolidatedDigistErrorReportProcessor implements TaskProcessor {

		@Autowired
		FileStatusDownloadReportRepository fileStatusDownloadReportRepo;

		@Autowired
		@Qualifier("Gstr2ConsolidatedDigistErrorReportServiceImpl")
		...
		public void execute(Message message, AppExecContext context) {
			...
			if (LOGGER.isDebugEnabled()) {
				String msg = String.format(
						"Inside Gstr2ConsolidatedDigistErrorReportProcessor"
						+ " with Report id : %d",
						id);
				LOGGER.debug(msg);
			}
			...
			try {
				...
				String msg = "Gstr2ConsolidatedDigistErrorReportProcessor - "
