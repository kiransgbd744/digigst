 ...
 *
 */
@Service("Gstr1AReturnStatusProcessor")
@Slf4j
public class Gstr1AReturnStatusProcessor implements TaskProcessor {
	...
	public void execute(Message message, AppExecContext context) {
		...
		if (jsonReq != null && groupcode != null) {
			if (LOGGER.isDebugEnabled()) {
				LOGGER.debug("Pooling Gstr1 ReturnStatus- Request is {} ",
						jsonReq);
			}
			Gson gson = new Gson();
