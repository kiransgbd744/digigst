 ...
 */
@Slf4j
@Service("EinvoiceNestedReportProcessor")
public class EinvoiceNestedReportProcessor implements TaskProcessor {
	...
	@Autowired
	@Qualifier("EinvoiceNestedAsyncReportServiceImpl")
		...
		try {
			...
			if (LOGGER.isDebugEnabled()) {
				String msg = String.format(
						"Inside Einvoice Nested Async Report Download processor with Report id : %d",
						id);
				LOGGER.debug(msg);
			}
