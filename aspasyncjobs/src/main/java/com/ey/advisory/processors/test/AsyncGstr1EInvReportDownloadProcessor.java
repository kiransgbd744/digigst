 ...
 */
@Slf4j
@Service("AsyncGstr1EInvReportDownloadProcessor")
public class AsyncGstr1EInvReportDownloadProcessor implements TaskProcessor {

	@Autowired
	FileStatusDownloadReportRepository fileStatusDownloadReportRepo;

	@Autowired
	@Qualifier("AsyncGstr1EInvReportDownloadServiceImpl")
