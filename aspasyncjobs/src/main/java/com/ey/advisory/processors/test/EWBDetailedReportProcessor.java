 ...
 */
@Slf4j
@Service("EWBDetailedReportProcessor")
public class EWBDetailedReportProcessor implements TaskProcessor {
	...
	@Autowired
	@Qualifier("EWBDetailedAsyncReportServiceImpl")
		...
		try {
			...
			if (LOGGER.isDebugEnabled()) {
				String msg = String.format(
						"Inside EWB Detailed Async Report Download processor with Report id : %d",
						id);
				LOGGER.debug(msg);
			}
