...
@Slf4j
@Service("EinvoiceSummaryReportProcessor")
public class EinvoiceSummaryReportProcessor implements TaskProcessor {
	...
	@Autowired
	@Qualifier("EinvoiceSummaryAsyncReportServiceImpl")
