...
@Slf4j
@Service("DetailedSupplierImsReportProcessor")
public class DetailedSupplierImsReportProcessor implements TaskProcessor {
	...
	@Autowired
	@Qualifier("DetailedSupplierImsReportServiceImpl")
