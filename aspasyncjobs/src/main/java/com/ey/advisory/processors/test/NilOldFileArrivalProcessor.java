...
import com.ey.advisory.app.services.docs.NilNonExmptOldFileArrivalHandler;
...
@Component("NilOldFileArrivalProcessor")
@Slf4j
public class NilOldFileArrivalProcessor implements TaskProcessor {
	@Autowired
	@Qualifier("NilNonExmptOldFileArrivalHandler")
	private NilNonExmptOldFileArrivalHandler nilFileArrivalHandler;
