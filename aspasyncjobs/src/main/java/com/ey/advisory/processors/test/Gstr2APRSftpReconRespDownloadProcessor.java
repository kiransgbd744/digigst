 ...
 */
@Slf4j
@Component("Gstr2APRSftpReconRespDownloadProcessor")
public class Gstr2APRSftpReconRespDownloadProcessor implements TaskProcessor {
	...
	public void execute(Message message, AppExecContext context) {
		...
		if (LOGGER.isDebugEnabled()) {
			String msg = String.format(
					"Gstr2APRSftpReconRespDownloadProcessor Upload Job"
		...
		try {
			...
			LOGGER.error("Exception in Gstr2APRSftpReconRespDownloadProcessor ",
					e.getMessage());
			fileStatusDownloadReportRepo.updateStatus(id, 
