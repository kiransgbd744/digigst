 ...
 */
@Slf4j
@Service("Gstr1ShippingBillAsyncReportProcessor")
public class Gstr1ShippingBillAsyncReportProcessor implements TaskProcessor {

	@Autowired
	FileStatusDownloadReportRepository fileStatusDownloadReportRepo;

	@Autowired
	@Qualifier("AsyncInvoiceManagementDownloadServiceImpl")
		...
		try {
			...
			if (LOGGER.isDebugEnabled()) {
				String msg = String.format(
						"Inside Shipping Bill Async Report Download processor with Report id : %d",
						id);
				LOGGER.debug(msg);
			}
