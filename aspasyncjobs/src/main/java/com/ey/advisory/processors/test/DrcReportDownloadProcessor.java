...
@Slf4j
@Component("DrcReportDownloadProcessor")
public class DrcReportDownloadProcessor implements TaskProcessor {

	@Autowired
	FileStatusDownloadReportRepository fileStatusDownloadReportRepo;

	@Autowired
	@Qualifier("AsyncDrcDownloadSummaryServiceImpl")
	...
	public void execute(Message message, AppExecContext context) {
		...
		try {
			...
			String msg = String.format(
					"Exception occured during Drc Summary report generation.");
			LOGGER.error(msg, ex);
