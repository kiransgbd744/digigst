 ...
 */
@Slf4j
@Service("Gstr6IsdAnxAsyncReportProcessor")
public class Gstr6IsdAnxAsyncReportProcessor implements TaskProcessor {

	@Autowired
	FileStatusDownloadReportRepository downloadRepository;

	@Autowired
	@Qualifier("Gstr6IsdAnxAsyncReportServiceImpl")
		...
		try {
			...
			if (LOGGER.isDebugEnabled()) {
				String msg = String.format(
						"Inside GSTR6 ISD ANX Async Report Download processor with Report id : %d",
						id);
				LOGGER.debug(msg);
			}
