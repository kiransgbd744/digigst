...
import lombok.extern.slf4j.Slf4j;
	...
	@Slf4j
	@Service("AsyncProcessedReportDownloadProcessor")
	public class AsyncProcessedReportDownloadProcessor implements TaskProcessor {

		@Autowired
		FileStatusDownloadReportRepository fileStatusDownloadReportRepo;

		@Autowired
		@Qualifier("AsyncProcessedReportDownloadServiceImpl")
