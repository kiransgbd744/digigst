 ...
 */
@Slf4j
@Component("Gstr2APRAutoReconRespDownloadProcessor")
public class Gstr2APRAutoReconRespDownloadProcessor implements TaskProcessor {
	...
	public void execute(Message message, AppExecContext context) {
		...
		if (LOGGER.isDebugEnabled()) {
			String msg = String.format(
					"Gstr2APRAutoReconRespDownloadProcessor Upload Job"
		...
		try {
			...
			LOGGER.error("Exception in Gstr2APRAutoReconRespDownloadProcessor ",
					e.getMessage());
			fileStatusDownloadReportRepo.updateStatus(id, 
