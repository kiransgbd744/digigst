...
@Component("TaxPayerLogoutReqEncryptor")
public class TaxPayerLogoutReqEncryptor implements APIReqPartsEncryptor {

	private static final Logger LOGGER = LoggerFactory
			.getLogger(TaxPayerLogoutReqEncryptor.class);
	...
	public APIReqParts encrypt(
		...
		try {
			if (LOGGER.isDebugEnabled()) {
				String msg = "About to encrypt the LOGOUT Request...";
				LOGGER.debug(msg);
			}
