...
@Component("APIGSPAuthTokenResponseDecryptor")
public class APIGSPAuthTokenResponseDecryptor implements APIResponseDecryptor {
	...
	public APIResponse decrypt(
		...
		// Get the Expiry in minutes. If the 'expiry' element is not present,
		...
		/*int expiryMin = (jsonObject.get("expiry") != null) ?
		...
		GSTNAPIAuthTokenResponse apiResp = 
				new GSTNAPIAuthTokenResponse(sek, sk, authToken, expiryMin);		
